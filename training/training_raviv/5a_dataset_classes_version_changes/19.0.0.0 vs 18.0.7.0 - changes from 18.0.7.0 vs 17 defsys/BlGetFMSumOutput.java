...
public class BlGetFMSumOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[5] = new FmlField("FM_TYPE", FmlField.TYPE_STRING, 4, null, 5, 600);
    ...
    /**
     * Retrieves the value of the 'FM_TYPE' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 600).
     * @return Value of 'FM_TYPE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_FM_TYPE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[5].getValue(nIndex));
    }

    /**
     * Retrieves number of values defined for 'FM_TYPE' field in the FML buffer.
     *
     * @return Number of values defined for 'FM_TYPE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_FM_TYPE_size() throws FMLManipulationException {
