...
public class ArSvBanSvcOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[43] = new FmlField("PSRVFTRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 43, 1);
            this.fmlBuffer[44] = new FmlField("PSRVFTRBUFROWID", FmlField.TYPE_STRING, 19, null, 44, 200);
            this.fmlBuffer[45] = new FmlField("PSRVFTRBUFSOC", FmlField.TYPE_STRING, 10, null, 45, 200);
            this.fmlBuffer[46] = new FmlField("PSRVFTRBUFSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 46, 200);
            this.fmlBuffer[47] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 47, 200);
            this.fmlBuffer[48] = new FmlField("MPS_FTR_CODE", FmlField.TYPE_STRING, 7, null, 48, 200);
            this.fmlBuffer[49] = new FmlField("FTR_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 49, 200);
            this.fmlBuffer[50] = new FmlField("FTR_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 50, 200);
            this.fmlBuffer[51] = new FmlField("FTR_EFF_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 51, 200);
            this.fmlBuffer[52] = new FmlField("FTR_EXP_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 52, 200);
            this.fmlBuffer[53] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 53, 200);
            this.fmlBuffer[54] = new FmlField("FTR_MODE", FmlField.TYPE_BYTE, -1, null, 54, 200);
            this.fmlBuffer[55] = new FmlField("PSRVFTRBUFSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 55, 200);
            this.fmlBuffer[56] = new FmlField("FTR_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 56, 200);
            this.fmlBuffer[57] = new FmlField("FTR_ADD_PARAM", FmlField.TYPE_STRING, 301, null, 57, 200);
            this.fmlBuffer[58] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, null, 58, 200);
            this.fmlBuffer[59] = new FmlField("PSRVFTRBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 59, 200);
            this.fmlBuffer[60] = new FmlField("PSRVFTRBUFCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 60, 200);
            this.fmlBuffer[61] = new FmlField("FTR_SPECIAL_TELNO", FmlField.TYPE_STRING, 21, null, 61, 200);
            this.fmlBuffer[62] = new FmlField("SWITCH_ACT_NEEDED", FmlField.TYPE_BYTE, -1, null, 62, 200);
            this.fmlBuffer[63] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, null, 63, 200);
            this.fmlBuffer[64] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, null, 64, 200);
            this.fmlBuffer[65] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 65, 200);
            this.fmlBuffer[66] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, null, 66, 200);
            this.fmlBuffer[67] = new FmlField("MANUAL_RC_RATE", FmlField.TYPE_DOUBLE, -1, null, 67, 200);
            this.fmlBuffer[68] = new FmlField("MANUAL_RC_EXP_DATE", FmlField.TYPE_STRING, 9, null, 68, 200);
