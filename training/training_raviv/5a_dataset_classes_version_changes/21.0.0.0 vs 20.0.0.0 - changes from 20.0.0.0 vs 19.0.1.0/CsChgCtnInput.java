...
public class CsChgCtnInput extends ServiceInput {
    ...
    public CsChgCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[177] = new FmlField("PNEWCTNROWID", FmlField.TYPE_STRING, 19, null, 177, 1);
            this.fmlBuffer[178] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 178, 1);
            this.fmlBuffer[179] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 179, 1);
            this.fmlBuffer[180] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 180, 1);
            this.fmlBuffer[181] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 181, 1);
            this.fmlBuffer[182] = new FmlField("PNEWCTNOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 182, 1);
            this.fmlBuffer[183] = new FmlField("PNEWCTNAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 183, 1);
            this.fmlBuffer[184] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 184, 1);
            this.fmlBuffer[185] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 185, 1);
            this.fmlBuffer[186] = new FmlField("PNEWCTNEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 186, 1);
            this.fmlBuffer[187] = new FmlField("INIT_ACTIVATION_DATE", FmlField.TYPE_STRING, 9, null, 187, 1);
            this.fmlBuffer[188] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 188, 1);
            this.fmlBuffer[189] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 189, 1);
            this.fmlBuffer[190] = new FmlField("ORIGINAL_INIT_DATE", FmlField.TYPE_STRING, 15, null, 190, 1);
            this.fmlBuffer[191] = new FmlField("SUB_STATUS_LAST_ACT", FmlField.TYPE_STRING, 4, null, 191, 1);
            this.fmlBuffer[192] = new FmlField("SUB_STATUS_RSN_CODE", FmlField.TYPE_STRING, 5, null, 192, 1);
            this.fmlBuffer[193] = new FmlField("PNEWCTNPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 193, 1);
            this.fmlBuffer[194] = new FmlField("CUSTOMER_BAN", FmlField.TYPE_INTEGER, -1, null, 194, 1);
            this.fmlBuffer[195] = new FmlField("CTN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 195, 1);
            this.fmlBuffer[196] = new FmlField("REQ_ST_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 196, 1);
            this.fmlBuffer[197] = new FmlField("REQ_END_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 197, 1);
            this.fmlBuffer[198] = new FmlField("COMMIT_START_DATE", FmlField.TYPE_STRING, 9, null, 198, 1);
            this.fmlBuffer[199] = new FmlField("COMMIT_END_DATE", FmlField.TYPE_STRING, 9, null, 199, 1);
            this.fmlBuffer[200] = new FmlField("COMMIT_REASON_CODE", FmlField.TYPE_STRING, 4, null, 200, 1);
            this.fmlBuffer[201] = new FmlField("PNEWCTNCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 201, 1);
            this.fmlBuffer[202] = new FmlField("PNEWCTNSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 202, 1);
            this.fmlBuffer[203] = new FmlField("CONTRACT_NO", FmlField.TYPE_STRING, 11, null, 203, 1);
            this.fmlBuffer[204] = new FmlField("CNT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 204, 1);
            this.fmlBuffer[205] = new FmlField("PNEWCTNDEALER_CODE", FmlField.TYPE_STRING, 6, null, 205, 1);
            this.fmlBuffer[206] = new FmlField("ORG_DEALER_CODE", FmlField.TYPE_STRING, 6, null, 206, 1);
            this.fmlBuffer[207] = new FmlField("PNEWCTNSALES_AGENT", FmlField.TYPE_STRING, 6, null, 207, 1);
            this.fmlBuffer[208] = new FmlField("ORG_SALES_AGENT", FmlField.TYPE_STRING, 6, null, 208, 1);
            this.fmlBuffer[209] = new FmlField("REQ_DEPOSIT_AMT", FmlField.TYPE_DOUBLE, -1, null, 209, 1);
            this.fmlBuffer[210] = new FmlField("LEADING_NUMBER", FmlField.TYPE_STRING, 21, null, 210, 1);
            this.fmlBuffer[211] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, null, 211, 1);
            this.fmlBuffer[212] = new FmlField("NEXT_CTN", FmlField.TYPE_STRING, 21, null, 212, 1);
            this.fmlBuffer[213] = new FmlField("NEXT_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 213, 1);
            this.fmlBuffer[214] = new FmlField("PRV_CTN", FmlField.TYPE_STRING, 21, null, 214, 1);
            this.fmlBuffer[215] = new FmlField("PRV_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 215, 1);
            this.fmlBuffer[216] = new FmlField("NEXT_BAN", FmlField.TYPE_INTEGER, -1, null, 216, 1);
            this.fmlBuffer[217] = new FmlField("NEXT_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 217, 1);
            this.fmlBuffer[218] = new FmlField("PRV_BAN", FmlField.TYPE_INTEGER, -1, null, 218, 1);
            this.fmlBuffer[219] = new FmlField("PRV_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 219, 1);
            this.fmlBuffer[220] = new FmlField("SUB_STS_ISSUE_DATE", FmlField.TYPE_STRING, 9, null, 220, 1);
            this.fmlBuffer[221] = new FmlField("ACTIVATE_WAIVE_RSN", FmlField.TYPE_STRING, 7, null, 221, 1);
            this.fmlBuffer[222] = new FmlField("EARLIEST_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 222, 1);
            this.fmlBuffer[223] = new FmlField("SUB_ACTV_LOCATION", FmlField.TYPE_STRING, 5, null, 223, 1);
            this.fmlBuffer[224] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 224, 1);
            this.fmlBuffer[225] = new FmlField("CUST_WATCH_DATE", FmlField.TYPE_STRING, 9, null, 225, 1);
            this.fmlBuffer[226] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 226, 1);
            this.fmlBuffer[227] = new FmlField("CREDIT_WATCH_PIN_CD", FmlField.TYPE_SHORT, -1, null, 227, 1);
            this.fmlBuffer[228] = new FmlField("SUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 228, 1);
            this.fmlBuffer[229] = new FmlField("LIMIT_RESERVED_DAYS", FmlField.TYPE_SHORT, -1, null, 229, 1);
            this.fmlBuffer[230] = new FmlField("FF_EXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 230, 1);
            this.fmlBuffer[231] = new FmlField("FLEX_IND", FmlField.TYPE_BYTE, -1, null, 231, 1);
            this.fmlBuffer[232] = new FmlField("DUO_IND", FmlField.TYPE_BYTE, -1, null, 232, 1);
            this.fmlBuffer[233] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, null, 233, 1);
            this.fmlBuffer[234] = new FmlField("SUB_DEPARTMENT_CD", FmlField.TYPE_STRING, 5, null, 234, 1);
            this.fmlBuffer[235] = new FmlField("LAST_SUBS_DISC_DT", FmlField.TYPE_STRING, 9, null, 235, 1);
            this.fmlBuffer[236] = new FmlField("LAST_SUBS_DISC_DT_UD", FmlField.TYPE_STRING, 9, null, 236, 1);
            this.fmlBuffer[237] = new FmlField("LAST_SUBSCR_DISC_SN", FmlField.TYPE_SHORT, -1, null, 237, 1);
            this.fmlBuffer[238] = new FmlField("LAST_SUBSCR_DISC_SN_UD", FmlField.TYPE_SHORT, -1, null, 238, 1);
            this.fmlBuffer[239] = new FmlField("PNI", FmlField.TYPE_STRING, 11, null, 239, 1);
            this.fmlBuffer[240] = new FmlField("RMS_REF_STORE_ID", FmlField.TYPE_STRING, 5, null, 240, 1);
            this.fmlBuffer[241] = new FmlField("RMS_REF_TYPE", FmlField.TYPE_BYTE, -1, null, 241, 1);
            this.fmlBuffer[242] = new FmlField("RMS_REF_OD", FmlField.TYPE_INTEGER, -1, null, 242, 1);
            this.fmlBuffer[243] = new FmlField("DLR_ACT_FEE", FmlField.TYPE_DOUBLE, -1, null, 243, 1);
            this.fmlBuffer[244] = new FmlField("PREP_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 244, 1);
            this.fmlBuffer[245] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 245, 1);
            this.fmlBuffer[246] = new FmlField("SUB_LANG", FmlField.TYPE_STRING, 3, null, 246, 1);
            this.fmlBuffer[247] = new FmlField("SMS_RCV_STYLE_CODE", FmlField.TYPE_STRING, 3, null, 247, 1);
            this.fmlBuffer[248] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 248, 1);
            this.fmlBuffer[249] = new FmlField("ALLOW_ADVERTISING_IND", FmlField.TYPE_BYTE, -1, null, 249, 1);
            this.fmlBuffer[250] = new FmlField("IVR_WRONG_ACCESS_NO", FmlField.TYPE_SHORT, -1, null, 250, 1);
            this.fmlBuffer[251] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, NinjaConfigurationReferenceTable.getThresholdAmt(), 251, 1);
            this.fmlBuffer[252] = new FmlField("PUBLISH_LEVEL", FmlField.TYPE_STRING, 31, null, 252, 1);
            this.fmlBuffer[253] = new FmlField("AUTO_RELEASE_IND", FmlField.TYPE_BYTE, -1, null, 253, 1);
            this.fmlBuffer[254] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, null, 254, 1);
            this.fmlBuffer[255] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, null, 255, 1);
            this.fmlBuffer[256] = new FmlField("OPERATOR_CW_LMT", FmlField.TYPE_DOUBLE, -1, null, 256, 1);
            this.fmlBuffer[257] = new FmlField("SEND_SMS_FOR_MATCH", FmlField.TYPE_BYTE, -1, null, 257, 1);
            this.fmlBuffer[258] = new FmlField("CPS_STATUS", FmlField.TYPE_BYTE, -1, null, 258, 1);
            this.fmlBuffer[259] = new FmlField("CPS_TRANSACTION", FmlField.TYPE_SHORT, -1, null, 259, 1);
            this.fmlBuffer[260] = new FmlField("CPS_TYPE", FmlField.TYPE_SHORT, -1, null, 260, 1);
            this.fmlBuffer[261] = new FmlField("ISP_PASS", FmlField.TYPE_STRING, 31, null, 261, 1);
            this.fmlBuffer[262] = new FmlField("ISP_TYPE", FmlField.TYPE_STRING, 3, null, 262, 1);
            this.fmlBuffer[263] = new FmlField("OPERATOR_TMP_DATE", FmlField.TYPE_STRING, 9, null, 263, 1);
            this.fmlBuffer[264] = new FmlField("OPERATOR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, null, 264, 1);
            this.fmlBuffer[265] = new FmlField("SUB_ORG_CD", FmlField.TYPE_STRING, 11, null, 265, 1);
            this.fmlBuffer[266] = new FmlField("ORG_MEMBER_NO", FmlField.TYPE_STRING, 21, null, 266, 1);
            this.fmlBuffer[267] = new FmlField("FIXED_AS_GSM_IND", FmlField.TYPE_BYTE, -1, null, 267, 1);
            this.fmlBuffer[268] = new FmlField("EARLY_PORT_OUT", FmlField.TYPE_BYTE, -1, null, 268, 1);
            this.fmlBuffer[269] = new FmlField("EARLY_PO_WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 269, 1);
            this.fmlBuffer[270] = new FmlField("EARLY_PO_WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 270, 1);
            this.fmlBuffer[271] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 271, 1);
            this.fmlBuffer[272] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 272, 1);
            this.fmlBuffer[273] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 273, 1);
            this.fmlBuffer[274] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 274, 1);
            this.fmlBuffer[275] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 275, 1);
            this.fmlBuffer[276] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 276, 1);
            this.fmlBuffer[277] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 277, 1);
            ...
            this.fmlBuffer[371] = new FmlField("PCHGCTNRECBAN", FmlField.TYPE_INTEGER, -1, null, 371, 1);
            this.fmlBuffer[372] = new FmlField("OLD_CTN", FmlField.TYPE_STRING, 21, null, 372, 1);
            this.fmlBuffer[373] = new FmlField("PCHGCTNRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 373, 1);
            this.fmlBuffer[374] = new FmlField("PCHGCTNRECACTIVITY_DATE", FmlField.TYPE_STRING, 9, null, 374, 1);
            this.fmlBuffer[375] = new FmlField("OTHER_NL", FmlField.TYPE_STRING, 4, null, 375, 1);
            this.fmlBuffer[376] = new FmlField("INT_ORDER_ID_OF_TEMP_MSISDN", FmlField.TYPE_DOUBLE, -1, null, 376, 1);
            this.fmlBuffer[377] = new FmlField("ACTIVITY_CTN_FEE", FmlField.TYPE_DOUBLE, -1, null, 377, 1);
            this.fmlBuffer[378] = new FmlField("NUMBER_LOCATION", FmlField.TYPE_STRING, 4, null, 378, 1);
            this.fmlBuffer[379] = new FmlField("DEPOSITTERMSIND", FmlField.TYPE_BYTE, -1, null, 379, 1);
            this.fmlBuffer[380] = new FmlField("WAIVING_IND", FmlField.TYPE_BYTE, -1, null, 380, 1);
            this.fmlBuffer[381] = new FmlField("WAIVING_REASON_CODE", FmlField.TYPE_STRING, 5, null, 381, 1);
            this.fmlBuffer[382] = new FmlField("PINSTLBUFROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 382, 1);
            this.fmlBuffer[383] = new FmlField("INSTALLMENT_AMT", FmlField.TYPE_DOUBLE, -1, null, 383, 12);
            this.fmlBuffer[384] = new FmlField("INSTALLMENT_DATE", FmlField.TYPE_STRING, 9, null, 384, 12);
            this.fmlBuffer[385] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 385, 1);
            this.fmlBuffer[386] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 386, 2);
            this.fmlBuffer[387] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 387, 2);
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            fmlBuffer = new FmlField[386];
    
            //// Get default values from DB
            //synchronized (this.defaultValuesPopulated) {
            //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
            //        defaultValues = getDefaultValues("csChgCtn", 386);
            //        this.defaultValuesPopulated = Boolean.TRUE;
            //    }
            //}
            ...
            this.fmlBuffer[175] = new FmlField("PNEWCTNROWID", FmlField.TYPE_STRING, 19, null, 175, 1);
            this.fmlBuffer[176] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 176, 1);
            this.fmlBuffer[177] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 177, 1);
            this.fmlBuffer[178] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 178, 1);
            this.fmlBuffer[179] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 179, 1);
            this.fmlBuffer[180] = new FmlField("PNEWCTNOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 180, 1);
            this.fmlBuffer[181] = new FmlField("PNEWCTNAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 181, 1);
            this.fmlBuffer[182] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 182, 1);
            this.fmlBuffer[183] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 183, 1);
            this.fmlBuffer[184] = new FmlField("PNEWCTNEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 184, 1);
            this.fmlBuffer[185] = new FmlField("INIT_ACTIVATION_DATE", FmlField.TYPE_STRING, 9, null, 185, 1);
            this.fmlBuffer[186] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 186, 1);
            this.fmlBuffer[187] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 187, 1);
            this.fmlBuffer[188] = new FmlField("ORIGINAL_INIT_DATE", FmlField.TYPE_STRING, 15, null, 188, 1);
            this.fmlBuffer[189] = new FmlField("SUB_STATUS_LAST_ACT", FmlField.TYPE_STRING, 4, null, 189, 1);
            this.fmlBuffer[190] = new FmlField("SUB_STATUS_RSN_CODE", FmlField.TYPE_STRING, 5, null, 190, 1);
            this.fmlBuffer[191] = new FmlField("PNEWCTNPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 191, 1);
            this.fmlBuffer[192] = new FmlField("CUSTOMER_BAN", FmlField.TYPE_INTEGER, -1, null, 192, 1);
            this.fmlBuffer[193] = new FmlField("CTN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 193, 1);
            this.fmlBuffer[194] = new FmlField("REQ_ST_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 194, 1);
            this.fmlBuffer[195] = new FmlField("REQ_END_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 195, 1);
            this.fmlBuffer[196] = new FmlField("COMMIT_START_DATE", FmlField.TYPE_STRING, 9, null, 196, 1);
            this.fmlBuffer[197] = new FmlField("COMMIT_END_DATE", FmlField.TYPE_STRING, 9, null, 197, 1);
            this.fmlBuffer[198] = new FmlField("COMMIT_REASON_CODE", FmlField.TYPE_STRING, 4, null, 198, 1);
            this.fmlBuffer[199] = new FmlField("PNEWCTNCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 199, 1);
            this.fmlBuffer[200] = new FmlField("PNEWCTNSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 200, 1);
            this.fmlBuffer[201] = new FmlField("CONTRACT_NO", FmlField.TYPE_STRING, 11, null, 201, 1);
            this.fmlBuffer[202] = new FmlField("CNT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 202, 1);
            this.fmlBuffer[203] = new FmlField("PNEWCTNDEALER_CODE", FmlField.TYPE_STRING, 6, null, 203, 1);
            this.fmlBuffer[204] = new FmlField("ORG_DEALER_CODE", FmlField.TYPE_STRING, 6, null, 204, 1);
            this.fmlBuffer[205] = new FmlField("PNEWCTNSALES_AGENT", FmlField.TYPE_STRING, 6, null, 205, 1);
            this.fmlBuffer[206] = new FmlField("ORG_SALES_AGENT", FmlField.TYPE_STRING, 6, null, 206, 1);
            this.fmlBuffer[207] = new FmlField("REQ_DEPOSIT_AMT", FmlField.TYPE_DOUBLE, -1, null, 207, 1);
            this.fmlBuffer[208] = new FmlField("LEADING_NUMBER", FmlField.TYPE_STRING, 21, null, 208, 1);
            this.fmlBuffer[209] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, null, 209, 1);
            this.fmlBuffer[210] = new FmlField("NEXT_CTN", FmlField.TYPE_STRING, 21, null, 210, 1);
            this.fmlBuffer[211] = new FmlField("NEXT_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 211, 1);
            this.fmlBuffer[212] = new FmlField("PRV_CTN", FmlField.TYPE_STRING, 21, null, 212, 1);
            this.fmlBuffer[213] = new FmlField("PRV_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 213, 1);
            this.fmlBuffer[214] = new FmlField("NEXT_BAN", FmlField.TYPE_INTEGER, -1, null, 214, 1);
            this.fmlBuffer[215] = new FmlField("NEXT_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 215, 1);
            this.fmlBuffer[216] = new FmlField("PRV_BAN", FmlField.TYPE_INTEGER, -1, null, 216, 1);
            this.fmlBuffer[217] = new FmlField("PRV_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 217, 1);
            this.fmlBuffer[218] = new FmlField("SUB_STS_ISSUE_DATE", FmlField.TYPE_STRING, 9, null, 218, 1);
            this.fmlBuffer[219] = new FmlField("ACTIVATE_WAIVE_RSN", FmlField.TYPE_STRING, 7, null, 219, 1);
            this.fmlBuffer[220] = new FmlField("EARLIEST_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 220, 1);
            this.fmlBuffer[221] = new FmlField("SUB_ACTV_LOCATION", FmlField.TYPE_STRING, 5, null, 221, 1);
            this.fmlBuffer[222] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 222, 1);
            this.fmlBuffer[223] = new FmlField("CUST_WATCH_DATE", FmlField.TYPE_STRING, 9, null, 223, 1);
            this.fmlBuffer[224] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 224, 1);
            this.fmlBuffer[225] = new FmlField("CREDIT_WATCH_PIN_CD", FmlField.TYPE_SHORT, -1, null, 225, 1);
            this.fmlBuffer[226] = new FmlField("SUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 226, 1);
            this.fmlBuffer[227] = new FmlField("LIMIT_RESERVED_DAYS", FmlField.TYPE_SHORT, -1, null, 227, 1);
            this.fmlBuffer[228] = new FmlField("FF_EXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 228, 1);
            this.fmlBuffer[229] = new FmlField("FLEX_IND", FmlField.TYPE_BYTE, -1, null, 229, 1);
            this.fmlBuffer[230] = new FmlField("DUO_IND", FmlField.TYPE_BYTE, -1, null, 230, 1);
            this.fmlBuffer[231] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, null, 231, 1);
            this.fmlBuffer[232] = new FmlField("SUB_DEPARTMENT_CD", FmlField.TYPE_STRING, 5, null, 232, 1);
            this.fmlBuffer[233] = new FmlField("LAST_SUBS_DISC_DT", FmlField.TYPE_STRING, 9, null, 233, 1);
            this.fmlBuffer[234] = new FmlField("LAST_SUBS_DISC_DT_UD", FmlField.TYPE_STRING, 9, null, 234, 1);
            this.fmlBuffer[235] = new FmlField("LAST_SUBSCR_DISC_SN", FmlField.TYPE_SHORT, -1, null, 235, 1);
            this.fmlBuffer[236] = new FmlField("LAST_SUBSCR_DISC_SN_UD", FmlField.TYPE_SHORT, -1, null, 236, 1);
            this.fmlBuffer[237] = new FmlField("PNI", FmlField.TYPE_STRING, 11, null, 237, 1);
            this.fmlBuffer[238] = new FmlField("RMS_REF_STORE_ID", FmlField.TYPE_STRING, 5, null, 238, 1);
            this.fmlBuffer[239] = new FmlField("RMS_REF_TYPE", FmlField.TYPE_BYTE, -1, null, 239, 1);
            this.fmlBuffer[240] = new FmlField("RMS_REF_OD", FmlField.TYPE_INTEGER, -1, null, 240, 1);
            this.fmlBuffer[241] = new FmlField("DLR_ACT_FEE", FmlField.TYPE_DOUBLE, -1, null, 241, 1);
            this.fmlBuffer[242] = new FmlField("PREP_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 242, 1);
            this.fmlBuffer[243] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 243, 1);
            this.fmlBuffer[244] = new FmlField("SUB_LANG", FmlField.TYPE_STRING, 3, null, 244, 1);
            this.fmlBuffer[245] = new FmlField("SMS_RCV_STYLE_CODE", FmlField.TYPE_STRING, 3, null, 245, 1);
            this.fmlBuffer[246] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 246, 1);
            this.fmlBuffer[247] = new FmlField("ALLOW_ADVERTISING_IND", FmlField.TYPE_BYTE, -1, null, 247, 1);
            this.fmlBuffer[248] = new FmlField("IVR_WRONG_ACCESS_NO", FmlField.TYPE_SHORT, -1, null, 248, 1);
            this.fmlBuffer[249] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, NinjaConfigurationReferenceTable.getThresholdAmt(), 249, 1);
            this.fmlBuffer[250] = new FmlField("PUBLISH_LEVEL", FmlField.TYPE_STRING, 31, null, 250, 1);
            this.fmlBuffer[251] = new FmlField("AUTO_RELEASE_IND", FmlField.TYPE_BYTE, -1, null, 251, 1);
            this.fmlBuffer[252] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, null, 252, 1);
            this.fmlBuffer[253] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, null, 253, 1);
            this.fmlBuffer[254] = new FmlField("OPERATOR_CW_LMT", FmlField.TYPE_DOUBLE, -1, null, 254, 1);
            this.fmlBuffer[255] = new FmlField("SEND_SMS_FOR_MATCH", FmlField.TYPE_BYTE, -1, null, 255, 1);
            this.fmlBuffer[256] = new FmlField("CPS_STATUS", FmlField.TYPE_BYTE, -1, null, 256, 1);
            this.fmlBuffer[257] = new FmlField("CPS_TRANSACTION", FmlField.TYPE_SHORT, -1, null, 257, 1);
            this.fmlBuffer[258] = new FmlField("CPS_TYPE", FmlField.TYPE_SHORT, -1, null, 258, 1);
            this.fmlBuffer[259] = new FmlField("ISP_PASS", FmlField.TYPE_STRING, 31, null, 259, 1);
            this.fmlBuffer[260] = new FmlField("ISP_TYPE", FmlField.TYPE_STRING, 3, null, 260, 1);
            this.fmlBuffer[261] = new FmlField("OPERATOR_TMP_DATE", FmlField.TYPE_STRING, 9, null, 261, 1);
            this.fmlBuffer[262] = new FmlField("OPERATOR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, null, 262, 1);
            this.fmlBuffer[263] = new FmlField("SUB_ORG_CD", FmlField.TYPE_STRING, 11, null, 263, 1);
            this.fmlBuffer[264] = new FmlField("ORG_MEMBER_NO", FmlField.TYPE_STRING, 21, null, 264, 1);
            this.fmlBuffer[265] = new FmlField("FIXED_AS_GSM_IND", FmlField.TYPE_BYTE, -1, null, 265, 1);
            this.fmlBuffer[266] = new FmlField("EARLY_PORT_OUT", FmlField.TYPE_BYTE, -1, null, 266, 1);
            this.fmlBuffer[267] = new FmlField("EARLY_PO_WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 267, 1);
            this.fmlBuffer[268] = new FmlField("EARLY_PO_WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 268, 1);
            this.fmlBuffer[269] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 269, 1);
            this.fmlBuffer[270] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 270, 1);
            this.fmlBuffer[271] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 271, 1);
            ...
            this.fmlBuffer[274] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 274, 1);
            this.fmlBuffer[275] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 275, 1);
            ...
            this.fmlBuffer[369] = new FmlField("PCHGCTNRECBAN", FmlField.TYPE_INTEGER, -1, null, 369, 1);
            this.fmlBuffer[370] = new FmlField("OLD_CTN", FmlField.TYPE_STRING, 21, null, 370, 1);
            this.fmlBuffer[371] = new FmlField("PCHGCTNRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 371, 1);
            this.fmlBuffer[372] = new FmlField("PCHGCTNRECACTIVITY_DATE", FmlField.TYPE_STRING, 9, null, 372, 1);
            this.fmlBuffer[373] = new FmlField("OTHER_NL", FmlField.TYPE_STRING, 4, null, 373, 1);
            this.fmlBuffer[374] = new FmlField("INT_ORDER_ID_OF_TEMP_MSISDN", FmlField.TYPE_DOUBLE, -1, null, 374, 1);
            this.fmlBuffer[375] = new FmlField("ACTIVITY_CTN_FEE", FmlField.TYPE_DOUBLE, -1, null, 375, 1);
            this.fmlBuffer[376] = new FmlField("NUMBER_LOCATION", FmlField.TYPE_STRING, 4, null, 376, 1);
            this.fmlBuffer[377] = new FmlField("DEPOSITTERMSIND", FmlField.TYPE_BYTE, -1, null, 377, 1);
            this.fmlBuffer[378] = new FmlField("WAIVING_IND", FmlField.TYPE_BYTE, -1, null, 378, 1);
            this.fmlBuffer[379] = new FmlField("WAIVING_REASON_CODE", FmlField.TYPE_STRING, 5, null, 379, 1);
            this.fmlBuffer[380] = new FmlField("PINSTLBUFROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 380, 1);
            this.fmlBuffer[381] = new FmlField("INSTALLMENT_AMT", FmlField.TYPE_DOUBLE, -1, null, 381, 12);
            this.fmlBuffer[382] = new FmlField("INSTALLMENT_DATE", FmlField.TYPE_STRING, 9, null, 382, 12);
            this.fmlBuffer[383] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 383, 1);
            this.fmlBuffer[384] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 384, 2);
            this.fmlBuffer[385] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 385, 2);
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsChgCtnOutput class");
        }
    }
    ...
    public Integer get_DL_UPDATE_STAMP() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[185].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_DL_UPDATE_STAMP(Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[185].setValue(0, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public String get_SUB_STATUS() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[188].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_SUB_STATUS(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[188].setValue(0, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_CUSTOMER_BAN() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[194].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public String get_PNEWCTNSUSP_RC_RATE_TYPE() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[202].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_PNEWCTNSUSP_RC_RATE_TYPE(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[202].setValue(0, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Double get_DLR_ACT_FEE() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[243].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_CPS_TYPE(Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[260].setValue(0, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public String get_EARLY_PORT_OUT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[268].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_EARLY_PORT_OUT(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[268].setValue(0, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Double get_INT_ORDER_ID_OF_TEMP_MSISDN() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[376].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[374].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsChgCtnOutput class");
        }
    }
    ...
    public Double get_ACTIVITY_CTN_FEE() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[377].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[375].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsChgCtnOutput class");
        }
    }
    ...
    public String get_WAIVING_IND() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[380].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_WAIVING_IND(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[380].setValue(0, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_PFTRDEPBUFROWCOUNT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Integer) this.fmlBuffer[383].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsChgCtnOutput class");
        }
    }
    ...
    public Double get_DEPOSIT_AMOUNT(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Double) this.fmlBuffer[385].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsChgCtnOutput class");
        }
    }
