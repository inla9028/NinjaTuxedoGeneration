...
public class ArLsDefAgrOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        if ("30.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer = new FmlField[76];
            ...
            this.fmlBuffer[53] = new FmlField("PRMT_ROWID", FmlField.TYPE_STRING, 19, null, 53, 600);
            this.fmlBuffer[54] = new FmlField("PT_DURATION", FmlField.TYPE_SHORT, -1, null, 54, 600);
            this.fmlBuffer[55] = new FmlField("DURATION_IND", FmlField.TYPE_BYTE, -1, null, 55, 600);
            this.fmlBuffer[56] = new FmlField("PP_IND", FmlField.TYPE_BYTE, -1, null, 56, 600);
            this.fmlBuffer[57] = new FmlField("AUTO_RENEWAL_IND", FmlField.TYPE_BYTE, -1, null, 57, 600);
            this.fmlBuffer[58] = new FmlField("CUT_DATE", FmlField.TYPE_STRING, 9, null, 58, 600);
            this.fmlBuffer[59] = new FmlField("TRS_ROWID", FmlField.TYPE_STRING, 19, null, 59, 600);
            this.fmlBuffer[60] = new FmlField("TRS_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 60, 600);
            this.fmlBuffer[61] = new FmlField("TRS_SOC", FmlField.TYPE_STRING, 10, null, 61, 600);
            this.fmlBuffer[62] = new FmlField("CALL_TYPE_CODE", FmlField.TYPE_BYTE, -1, null, 62, 600);
            this.fmlBuffer[63] = new FmlField("TOLL_RS_DESC", FmlField.TYPE_STRING, 31, null, 63, 600);
            this.fmlBuffer[64] = new FmlField("SUBLN_ROWID", FmlField.TYPE_STRING, 19, null, 64, 600);
            this.fmlBuffer[65] = new FmlField("FULL_AMT", FmlField.TYPE_DOUBLE, -1, null, 65, 600);
            this.fmlBuffer[66] = new FmlField("FIRST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 66, 600);
            this.fmlBuffer[67] = new FmlField("OTHER_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 67, 600);
            this.fmlBuffer[68] = new FmlField("LAST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 68, 600);
            this.fmlBuffer[69] = new FmlField("NO_OF_INSTALLMENTS", FmlField.TYPE_SHORT, -1, null, 69, 600);
            this.fmlBuffer[70] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 70, 600);
            this.fmlBuffer[71] = new FmlField("DCI_ERROR_CODE", FmlField.TYPE_INTEGER, -1, null, 71, 1);
            this.fmlBuffer[72] = new FmlField("DCI_ERROR_TYPE", FmlField.TYPE_SHORT, -1, null, 72, 1);
            this.fmlBuffer[73] = new FmlField("DCI_ERROR_TEXT", FmlField.TYPE_STRING, 81, null, 73, 1);
            this.fmlBuffer[74] = new FmlField("DCI_ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 74, 1);
            this.fmlBuffer[75] = new FmlField("DCI_MORE_ROWS", FmlField.TYPE_SHORT, -1, null, 75, 1);
            ...
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by ArLsDefAgrOutput class");
        }
    }
    ...
    public Double get_FULL_AMT(int nIndex) throws FMLManipulationException {
        if ("30.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[65].getValue(nIndex));
        } else if ("31.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Double get_FIRST_INSTALL_RATE(int nIndex) throws FMLManipulationException {
        if ("30.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Double) this.fmlBuffer[67].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by ArLsDefAgrOutput class");
        }
    }
    ...
    public Integer get_NO_OF_INSTALLMENTS(int nIndex) throws FMLManipulationException {
        if ("30.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[69].getValue(nIndex)));
        } else if ("31.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[70].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by ArLsDefAgrOutput class");
        }
    }
