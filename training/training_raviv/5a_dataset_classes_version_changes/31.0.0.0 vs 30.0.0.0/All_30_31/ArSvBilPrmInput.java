...
public class ArSvBilPrmInput extends ServiceInput {
    ...
    public ArSvBilPrmInput() throws EnvironmentException, FMLManipulationException {
        ...
        if ("30.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[30] = new FmlField("P1", FmlField.TYPE_STRING, 51, null, 30, 1);
            this.fmlBuffer[31] = new FmlField("P2", FmlField.TYPE_STRING, 51, null, 31, 1);
            this.fmlBuffer[32] = new FmlField("P3", FmlField.TYPE_STRING, 51, null, 32, 1);
            this.fmlBuffer[33] = new FmlField("P4", FmlField.TYPE_STRING, 51, null, 33, 1);
            this.fmlBuffer[34] = new FmlField("P5", FmlField.TYPE_STRING, 51, null, 34, 1);
            this.fmlBuffer[35] = new FmlField("P6", FmlField.TYPE_STRING, 51, null, 35, 1);
            this.fmlBuffer[36] = new FmlField("P7", FmlField.TYPE_STRING, 51, null, 36, 1);
            this.fmlBuffer[37] = new FmlField("P8", FmlField.TYPE_STRING, 51, null, 37, 1);
            this.fmlBuffer[38] = new FmlField("P9", FmlField.TYPE_STRING, 51, null, 38, 1);
            this.fmlBuffer[39] = new FmlField("P10", FmlField.TYPE_STRING, 51, null, 39, 1);
            ...
            this.fmlBuffer[46] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 46, 1);
            this.fmlBuffer[47] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 47, 20);
            this.fmlBuffer[48] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 48, 20);
            this.fmlBuffer[49] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 49, 20);
            this.fmlBuffer[50] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 50, 20);
            this.fmlBuffer[51] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 51, 20);
            this.fmlBuffer[52] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 52, 20);
            this.fmlBuffer[53] = new FmlField("LNKRECBAN", FmlField.TYPE_INTEGER, -1, null, 53, 20);
            this.fmlBuffer[54] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 54, 20);
            this.fmlBuffer[55] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 55, 20);
            this.fmlBuffer[56] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 56, 20);
            this.fmlBuffer[57] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 57, 20);
            this.fmlBuffer[58] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 58, 20);
            this.fmlBuffer[59] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 59, 20);
            this.fmlBuffer[60] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 60, 20);
            this.fmlBuffer[61] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 61, 20);
            this.fmlBuffer[62] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 62, 20);
            this.fmlBuffer[63] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 63, 20);
            this.fmlBuffer[64] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 64, 20);
            this.fmlBuffer[65] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 65, 20);
            this.fmlBuffer[66] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 66, 20);
            this.fmlBuffer[67] = new FmlField("ROWID", FmlField.TYPE_STRING, 19, null, 67, 20);
            this.fmlBuffer[68] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 68, 20);
            this.fmlBuffer[69] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 69, 20);
            this.fmlBuffer[70] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 70, 20);
            this.fmlBuffer[71] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 71, 20);
            this.fmlBuffer[72] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 72, 20);
            this.fmlBuffer[73] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 73, 20);
            this.fmlBuffer[74] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 74, 20);
            this.fmlBuffer[75] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 75, 20);
            this.fmlBuffer[76] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 76, 20);
            this.fmlBuffer[77] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 77, 20);
            this.fmlBuffer[78] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 78, 20);
            this.fmlBuffer[79] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 79, 20);
            this.fmlBuffer[80] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 80, 20);
            this.fmlBuffer[81] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 81, 20);
            this.fmlBuffer[82] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 82, 20);
            this.fmlBuffer[83] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 51, null, 83, 20);
            this.fmlBuffer[84] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 84, 20);
            this.fmlBuffer[85] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 85, 20);
            this.fmlBuffer[86] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 86, 20);
            this.fmlBuffer[87] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 87, 20);
            this.fmlBuffer[88] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 88, 20);
            this.fmlBuffer[89] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 89, 20);
            this.fmlBuffer[90] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 90, 20);
            this.fmlBuffer[91] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 91, 20);
            this.fmlBuffer[92] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 92, 20);
            this.fmlBuffer[93] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 93, 20);
            this.fmlBuffer[94] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 94, 20);
            this.fmlBuffer[95] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 95, 20);
            this.fmlBuffer[96] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 96, 20);
            this.fmlBuffer[97] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 97, 20);
            this.fmlBuffer[98] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 98, 20);
            this.fmlBuffer[99] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 99, 20);
            this.fmlBuffer[100] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 100, 20);
            this.fmlBuffer[101] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 101, 20);
            this.fmlBuffer[102] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 102, 20);
            this.fmlBuffer[103] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 103, 20);
            this.fmlBuffer[104] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 104, 20);
            this.fmlBuffer[105] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 105, 20);
            this.fmlBuffer[106] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 106, 20);
            this.fmlBuffer[107] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 107, 20);
            this.fmlBuffer[108] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 108, 20);
            this.fmlBuffer[109] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 109, 20);
            this.fmlBuffer[110] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 110, 20);
            this.fmlBuffer[111] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 111, 20);
            this.fmlBuffer[112] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 112, 20);
            this.fmlBuffer[113] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 113, 20);
            this.fmlBuffer[114] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 114, 20);
            this.fmlBuffer[115] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 115, 20);
            this.fmlBuffer[116] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 116, 20);
            this.fmlBuffer[117] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 117, 20);
            this.fmlBuffer[118] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 118, 20);
            this.fmlBuffer[119] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 119, 20);
            this.fmlBuffer[120] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 120, 20);
            this.fmlBuffer[121] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 121, 20);
            this.fmlBuffer[122] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 122, 20);
            this.fmlBuffer[123] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 123, 20);
            this.fmlBuffer[124] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 124, 20);
            this.fmlBuffer[125] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 125, 20);
            this.fmlBuffer[126] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 126, 20);
            this.fmlBuffer[127] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 127, 20);
            this.fmlBuffer[128] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 128, 20);
            this.fmlBuffer[129] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 129, 20);
            this.fmlBuffer[130] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 130, 20);
            this.fmlBuffer[131] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 131, 20);
            this.fmlBuffer[132] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 132, 20);
            this.fmlBuffer[133] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 133, 20);
            this.fmlBuffer[134] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 134, 20);
            this.fmlBuffer[135] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 135, 20);
            this.fmlBuffer[136] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 136, 20);
            this.fmlBuffer[137] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 137, 20);
            this.fmlBuffer[138] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 138, 20);
            this.fmlBuffer[139] = new FmlField("PSVBLPRMBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 139, 1);
            this.fmlBuffer[140] = new FmlField("BPMODE", FmlField.TYPE_BYTE, -1, null, 140, 20);
            this.fmlBuffer[141] = new FmlField("BPSEQNO", FmlField.TYPE_INTEGER, -1, null, 141, 20);
            this.fmlBuffer[142] = new FmlField("BPEFFDATE", FmlField.TYPE_STRING, 9, null, 142, 20);
            this.fmlBuffer[143] = new FmlField("BPEXPDATE", FmlField.TYPE_STRING, 9, null, 143, 20);
            this.fmlBuffer[144] = new FmlField("BPFORMAT", FmlField.TYPE_STRING, 3, null, 144, 20);
            this.fmlBuffer[145] = new FmlField("BPMEDIA", FmlField.TYPE_STRING, 3, null, 145, 20);
            this.fmlBuffer[146] = new FmlField("BPPRINTCATEGORY", FmlField.TYPE_STRING, 3, null, 146, 20);
            this.fmlBuffer[147] = new FmlField("BPNOOFCOPIES", FmlField.TYPE_SHORT, -1, null, 147, 20);
            this.fmlBuffer[148] = new FmlField("BP_LANGUAGE", FmlField.TYPE_STRING, 3, null, 148, 20);
            this.fmlBuffer[149] = new FmlField("BP_CALL_DETAILS_MEDIA", FmlField.TYPE_BYTE, -1, null, 149, 20);
            ...
            //synchronized (this.defaultValuesPopulated) {
            //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
            //        defaultValues = getDefaultValues("arSvBilPrm", 152);
            //        this.defaultValuesPopulated = Boolean.TRUE;
            //    }
            //}
    ...
    public Integer get_CONV_RUN_NO(int nIndex) throws FMLManipulationException {
        if ("30.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[87].getValue(nIndex)));
        } else if ("31.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_CONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        if ("30.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[87].setValue(nIndex, TypeConverter.integerToShort(value));
        } else if ("31.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_ADDRESSRECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        if ("30.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[103].setValue(nIndex, TypeConverter.integerToShort(value));
        } else if ("31.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_ADDRESSRECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        if ("30.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[123].getValue(nIndex)));
        } else if ("31.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_ADDRESSRECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        if ("30.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[123].setValue(nIndex, TypeConverter.integerToShort(value));
        } else if ("31.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[124].setValue(nIndex, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by ArSvBilPrmOutput class");
        }
    }
    ...
    public Integer get_PSVBLPRMBUFROWCOUNT() throws FMLManipulationException {
        if ("30.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[139].getValue(0));
        } else if ("31.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_BPNOOFCOPIES(int nIndex) throws FMLManipulationException {
        if ("30.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[148].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by ArSvBilPrmOutput class");
        }
    }
    ...
    public void set_BPNOOFCOPIES(int nIndex, Integer value) throws FMLManipulationException {
        if ("30.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[148].setValue(nIndex, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by ArSvBilPrmOutput class");
        }
    }
    ...
    private void set_ROW_COUNT(Integer value) throws FMLManipulationException {
        if ("30.0.0.0".equals(this.getNinjaVersion())) {
            throw new FMLManipulationException("Method not supported in version 30.0.0.0");
        } else if ("31.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[23].setValue(0, value);
