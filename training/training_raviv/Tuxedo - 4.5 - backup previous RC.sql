...
SELECT '28.0.0.0.drop1' AS "NINJA_VERSION", a.svc_name, a.in_use, a.conversational,
       a.fields_shared_with_csapiban, a.comments
  FROM tux_services_versions a
 WHERE a.ninja_version = '28.0.0.0'
;

-- 2. Copy TUX FML BUFFERS
INSERT INTO tux_fml_buffers_versions
SELECT '28.0.0.0.drop1' AS "NINJA_VERSION", a.svc_name, a.buffer_type, a.field_name,
...
SELECT a.ninja_version, COUNT(1) AS "COUNT"
  FROM tux_services_versions a
 WHERE a.ninja_version IN ( '28.0.0.0', '28.0.0.0.drop1' )
