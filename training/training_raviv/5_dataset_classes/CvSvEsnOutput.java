...
public class CvSvEsnOutput extends ServiceOutput {
    ...
    public void populateCvFolder(CsApiBanOutput csApiBanOutput) throws FMLManipulationException {
        ...
        for (int i = 0, n = csApiBanOutput.get_PHYDEVARRAYEXPIRATION_DATE_size(); i < n; ++i) {
            this.set_EXPIRATION_DATE(i, csApiBanOutput.get_PHYDEVARRAYEXPIRATION_DATE(i));
        }
        for (int i = 0, n = csApiBanOutput.get_PHYDEVARRAYEFFECTIVE_DATE_size(); i < n; ++i) {
            this.set_EFFECTIVE_DATE(i, csApiBanOutput.get_PHYDEVARRAYEFFECTIVE_DATE(i));
        }
        for (int i = 0, n = csApiBanOutput.get_PHYDEVARRAYDEALER_CODE_size(); i < n; ++i) {
