...
public class GnChgDiscInput extends ServiceInput {
    ...
    public GnChgDiscInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[27] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 27, 50);
        this.fmlBuffer[28] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 28, 50);
        this.fmlBuffer[29] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 29, 50);
        this.fmlBuffer[30] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 30, 50);
        this.fmlBuffer[31] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 31, 50);
        this.fmlBuffer[32] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 32, 50);
        this.fmlBuffer[33] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 33, 50);
        this.fmlBuffer[34] = new FmlField("P1", FmlField.TYPE_STRING, 51, null, 34, 50);
        this.fmlBuffer[35] = new FmlField("P2", FmlField.TYPE_STRING, 51, null, 35, 50);
        this.fmlBuffer[36] = new FmlField("P3", FmlField.TYPE_STRING, 51, null, 36, 50);
        this.fmlBuffer[37] = new FmlField("P4", FmlField.TYPE_STRING, 51, null, 37, 50);
        this.fmlBuffer[38] = new FmlField("P5", FmlField.TYPE_STRING, 51, null, 38, 50);
        this.fmlBuffer[39] = new FmlField("P6", FmlField.TYPE_STRING, 51, null, 39, 50);
        this.fmlBuffer[40] = new FmlField("P7", FmlField.TYPE_STRING, 51, null, 40, 50);
        this.fmlBuffer[41] = new FmlField("P8", FmlField.TYPE_STRING, 51, null, 41, 50);
        this.fmlBuffer[42] = new FmlField("P9", FmlField.TYPE_STRING, 51, null, 42, 50);
        this.fmlBuffer[43] = new FmlField("P10", FmlField.TYPE_STRING, 51, null, 43, 50);
        this.fmlBuffer[44] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 44, 50);
        this.fmlBuffer[45] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 45, 50);
        this.fmlBuffer[46] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 46, 50);
        this.fmlBuffer[47] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 47, 50);
        this.fmlBuffer[48] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 48, 50);
        this.fmlBuffer[49] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 49, 50);
    }
