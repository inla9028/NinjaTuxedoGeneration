...
public class ArGtCstBanOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[286];
        ...
        this.fmlBuffer[185] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 185, 20);
        this.fmlBuffer[186] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 186, 20);
        this.fmlBuffer[187] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 187, 20);
        this.fmlBuffer[188] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 188, 20);
        this.fmlBuffer[189] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 189, 20);
        this.fmlBuffer[190] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 190, 20);
        this.fmlBuffer[191] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 191, 20);
        this.fmlBuffer[192] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 192, 20);
        this.fmlBuffer[193] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 193, 20);
        this.fmlBuffer[194] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 194, 20);
        this.fmlBuffer[195] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 195, 20);
        this.fmlBuffer[196] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 196, 20);
        this.fmlBuffer[197] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 197, 20);
        this.fmlBuffer[198] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 198, 20);
        this.fmlBuffer[199] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 199, 20);
        this.fmlBuffer[200] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 200, 20);
        this.fmlBuffer[201] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 201, 20);
        this.fmlBuffer[202] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 202, 20);
        this.fmlBuffer[203] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 203, 20);
        this.fmlBuffer[204] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 204, 20);
        this.fmlBuffer[205] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 205, 20);
        this.fmlBuffer[206] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 206, 20);
        this.fmlBuffer[207] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 207, 20);
        this.fmlBuffer[208] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 208, 20);
        this.fmlBuffer[209] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 209, 20);
        this.fmlBuffer[210] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 210, 20);
        this.fmlBuffer[211] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 211, 20);
        this.fmlBuffer[212] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 212, 20);
        this.fmlBuffer[213] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 213, 20);
        this.fmlBuffer[214] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 214, 20);
        this.fmlBuffer[215] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 215, 20);
        this.fmlBuffer[216] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 216, 20);
        this.fmlBuffer[217] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 217, 20);
        this.fmlBuffer[218] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 218, 20);
        this.fmlBuffer[219] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 219, 20);
        this.fmlBuffer[220] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 220, 20);
        this.fmlBuffer[221] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 221, 20);
        this.fmlBuffer[222] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 222, 20);
        this.fmlBuffer[223] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 223, 20);
        this.fmlBuffer[224] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 224, 20);
        this.fmlBuffer[225] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 225, 20);
        this.fmlBuffer[226] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 226, 20);
        this.fmlBuffer[227] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 227, 20);
        this.fmlBuffer[228] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 228, 20);
        this.fmlBuffer[229] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 229, 20);
        this.fmlBuffer[230] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 230, 20);
        this.fmlBuffer[231] = new FmlField("MEMO_1VROWID", FmlField.TYPE_STRING, 19, null, 231, 4);
        this.fmlBuffer[232] = new FmlField("MEMO_BAN", FmlField.TYPE_INTEGER, -1, null, 232, 4);
        this.fmlBuffer[233] = new FmlField("MEMO_ID", FmlField.TYPE_INTEGER, -1, null, 233, 4);
        this.fmlBuffer[234] = new FmlField("MEMO_1VSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 234, 4);
        this.fmlBuffer[235] = new FmlField("MEMO_DATE", FmlField.TYPE_STRING, 15, null, 235, 4);
        this.fmlBuffer[236] = new FmlField("MEMO_TYPE", FmlField.TYPE_STRING, 5, null, 236, 4);
        this.fmlBuffer[237] = new FmlField("MEMO_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 237, 4);
        this.fmlBuffer[238] = new FmlField("MEMO_SYSTEM_TXT", FmlField.TYPE_STRING, 181, null, 238, 4);
        this.fmlBuffer[239] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 239, 4);
        this.fmlBuffer[240] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 240, 4);
        this.fmlBuffer[241] = new FmlField("MEMO_MANUAL_TXT_TRUNC", FmlField.TYPE_STRING, 241, null, 241, 4);
        this.fmlBuffer[242] = new FmlField("MEMO_SYS_DATE", FmlField.TYPE_STRING, 15, null, 242, 4);
        this.fmlBuffer[243] = new FmlField("USER_ID", FmlField.TYPE_INTEGER, -1, null, 243, 4);
        this.fmlBuffer[244] = new FmlField("USER_SHORT_NAME", FmlField.TYPE_STRING, 21, null, 244, 4);
        this.fmlBuffer[245] = new FmlField("XX_ROWID", FmlField.TYPE_STRING, 19, null, 245, 4);
        this.fmlBuffer[246] = new FmlField("MEMTP_MEMO_CATEGORY", FmlField.TYPE_STRING, 5, null, 246, 4);
        this.fmlBuffer[247] = new FmlField("MEMTP_MEMO_DESCRIPTION", FmlField.TYPE_STRING, 21, null, 247, 4);
        this.fmlBuffer[248] = new FmlField("USER_TEXT_LEN", FmlField.TYPE_INTEGER, -1, null, 248, 4);
        this.fmlBuffer[249] = new FmlField("MEMO_COUNT", FmlField.TYPE_INTEGER, -1, null, 249, 1);
        this.fmlBuffer[250] = new FmlField("PPBLGTCYCRECROWID", FmlField.TYPE_STRING, 19, null, 250, 1);
        this.fmlBuffer[251] = new FmlField("CYCLE_CODE", FmlField.TYPE_SHORT, -1, null, 251, 1);
        this.fmlBuffer[252] = new FmlField("PPBLGTCYCRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 252, 1);
        this.fmlBuffer[253] = new FmlField("PPBLGTCYCRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 253, 1);
        this.fmlBuffer[254] = new FmlField("PPBLGTCYCRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 254, 1);
        this.fmlBuffer[255] = new FmlField("PPBLGTCYCRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 255, 1);
        this.fmlBuffer[256] = new FmlField("PPBLGTCYCRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 256, 1);
        this.fmlBuffer[257] = new FmlField("PPBLGTCYCRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 257, 1);
        this.fmlBuffer[258] = new FmlField("PPBLGTCYCRECCYCLE_FREQUENCY", FmlField.TYPE_SHORT, -1, null, 258, 1);
        this.fmlBuffer[259] = new FmlField("CYCLE_DESC", FmlField.TYPE_STRING, 31, null, 259, 1);
        this.fmlBuffer[260] = new FmlField("CYCLE_FIRST_MONTH", FmlField.TYPE_SHORT, -1, null, 260, 1);
        this.fmlBuffer[261] = new FmlField("CYCLE_CLOSE_DAY", FmlField.TYPE_SHORT, -1, null, 261, 1);
        this.fmlBuffer[262] = new FmlField("CYCLE_POPULATION_CD", FmlField.TYPE_BYTE, -1, null, 262, 1);
        this.fmlBuffer[263] = new FmlField("CYCLE_BILL_DAY", FmlField.TYPE_SHORT, -1, null, 263, 1);
        this.fmlBuffer[264] = new FmlField("CYCLE_DUE_DAY", FmlField.TYPE_SHORT, -1, null, 264, 1);
        this.fmlBuffer[265] = new FmlField("ALLOCATION_IND", FmlField.TYPE_BYTE, -1, null, 265, 1);
        this.fmlBuffer[266] = new FmlField("PBS_INFO_LINK_IND", FmlField.TYPE_BYTE, -1, null, 266, 1);
        this.fmlBuffer[267] = new FmlField("SECOND_POPULATION_CD", FmlField.TYPE_BYTE, -1, null, 267, 1);
        this.fmlBuffer[268] = new FmlField("PCNTRTINFROWID", FmlField.TYPE_STRING, 19, null, 268, 1);
        this.fmlBuffer[269] = new FmlField("PCNTRTINFSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 269, 1);
        this.fmlBuffer[270] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 270, 1);
        this.fmlBuffer[271] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 271, 1);
        this.fmlBuffer[272] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 272, 1);
        this.fmlBuffer[273] = new FmlField("PW_DESCRIPTION", FmlField.TYPE_STRING, 21, null, 273, 1);
        this.fmlBuffer[274] = new FmlField("MOREROWS", FmlField.TYPE_SHORT, -1, null, 274, 1);
        this.fmlBuffer[275] = new FmlField("CTNSTSCOUNTROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 275, 1);
        this.fmlBuffer[276] = new FmlField("PRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 276, 10);
        this.fmlBuffer[277] = new FmlField("CTN_RESERVED", FmlField.TYPE_INTEGER, -1, null, 277, 10);
        this.fmlBuffer[278] = new FmlField("CTN_OPEN", FmlField.TYPE_INTEGER, -1, null, 278, 10);
        this.fmlBuffer[279] = new FmlField("CTN_SUSPENDED", FmlField.TYPE_INTEGER, -1, null, 279, 10);
        this.fmlBuffer[280] = new FmlField("CTN_CANCELLED", FmlField.TYPE_INTEGER, -1, null, 280, 10);
        this.fmlBuffer[281] = new FmlField("FUTURE_REQ_COUNT", FmlField.TYPE_INTEGER, -1, null, 281, 1);
        this.fmlBuffer[282] = new FmlField("FU_COUNT", FmlField.TYPE_INTEGER, -1, null, 282, 1);
        this.fmlBuffer[283] = new FmlField("LINKED_IND", FmlField.TYPE_BYTE, -1, null, 283, 1);
        this.fmlBuffer[284] = new FmlField("BP_LANGUAGE", FmlField.TYPE_STRING, 3, null, 284, 1);
        this.fmlBuffer[285] = new FmlField("FNF_FAMILIES_COUNT", FmlField.TYPE_INTEGER, -1, null, 285, 1);
    }
    ...
    public String get_ADR_UP_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[186].getValue(nIndex)));
    }
    ...
    public Integer get_ADDRESS_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[189].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[192].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[195].getValue(nIndex)));
    }
    ...
    public String get_ADR_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[196].getValue(nIndex)));
    }
    ...
    public Integer get_ADDRESSRECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[215].getValue(nIndex)));
    }
    ...
    public Integer get_MEMO_BAN(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[232].getValue(nIndex));
    }
    ...
    public Double get_MEMO_AMT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[240].getValue(nIndex));
    }
    ...
    public Integer get_USER_TEXT_LEN(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[248].getValue(nIndex));
    }
    ...
    public Integer get_FNF_FAMILIES_COUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[285].getValue(0));
    }
}