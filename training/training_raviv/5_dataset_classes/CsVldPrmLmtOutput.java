 ...
 */
public class CsVldPrmLmtOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsVldPrmLmtOutput.
     *
     * @throws FMLManipulationException
     */
    public CsVldPrmLmtOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsVldPrmLmtOutput() {
    }

    /**
     * Creates a new instance of CsVldPrmLmtOutput.
     *
     * @param ds Output dataset from CsVldPrmLmt service.
     * @throws FMLManipulationException
     */
    public CsVldPrmLmtOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[16] = new FmlField("LIMIT", FmlField.TYPE_SHORT, -1, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("LIMIT_PERIOD", FmlField.TYPE_INTEGER, -1, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("ACTUALPROMNUM", FmlField.TYPE_INTEGER, -1, null, 18, 1);
    }
    ...
    /**
     * Retrieves the value of the 'LIMIT' field in the FML buffer.
     *
     * @return Value of 'LIMIT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_LIMIT() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[16].getValue(0)));
    }

    /**
     * Retrieves the value of the 'LIMIT_PERIOD' field in the FML buffer.
     *
     * @return Value of 'LIMIT_PERIOD' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_LIMIT_PERIOD() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[17].getValue(0));
    }

    /**
     * Retrieves the value of the 'ACTUALPROMNUM' field in the FML buffer.
     *
     * @return Value of 'ACTUALPROMNUM' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_ACTUALPROMNUM() throws FMLManipulationException {
