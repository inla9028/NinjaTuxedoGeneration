...
public class CsApiBanInput extends ServiceInput {
    ...
    public CsApiBanInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[274] = new FmlField("SOC_QUANTITY", FmlField.TYPE_SHORT, -1, null, 274, 50);
        ...
        this.fmlBuffer[369] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 369, 20);
        this.fmlBuffer[370] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 370, 20);
        this.fmlBuffer[371] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 371, 20);
        this.fmlBuffer[372] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 372, 20);
        this.fmlBuffer[373] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 373, 20);
        this.fmlBuffer[374] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 374, 20);
        this.fmlBuffer[375] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 375, 20);
        this.fmlBuffer[376] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 376, 20);
        this.fmlBuffer[377] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 377, 20);
        this.fmlBuffer[378] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 378, 20);
        this.fmlBuffer[379] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 379, 20);
        this.fmlBuffer[380] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 380, 20);
        this.fmlBuffer[381] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 381, 20);
        this.fmlBuffer[382] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 382, 20);
        this.fmlBuffer[383] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 383, 20);
        this.fmlBuffer[384] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 384, 20);
        this.fmlBuffer[385] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 385, 20);
        this.fmlBuffer[386] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 386, 20);
        this.fmlBuffer[387] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 387, 20);
        this.fmlBuffer[388] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 388, 20);
        this.fmlBuffer[389] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 389, 20);
        this.fmlBuffer[390] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 390, 20);
        this.fmlBuffer[391] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 391, 20);
        this.fmlBuffer[392] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 392, 20);
        this.fmlBuffer[393] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 393, 20);
        this.fmlBuffer[394] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 394, 20);
        this.fmlBuffer[395] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 395, 20);
        this.fmlBuffer[396] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 396, 20);
        this.fmlBuffer[397] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 397, 20);
        this.fmlBuffer[398] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 398, 20);
        this.fmlBuffer[399] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 399, 20);
        this.fmlBuffer[400] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 400, 20);
        this.fmlBuffer[401] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 401, 20);
        this.fmlBuffer[402] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 402, 20);
        this.fmlBuffer[403] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 403, 20);
        this.fmlBuffer[404] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 404, 20);
        this.fmlBuffer[405] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 405, 20);
        this.fmlBuffer[406] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 406, 20);
        this.fmlBuffer[407] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 407, 20);
        this.fmlBuffer[408] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 408, 20);
        this.fmlBuffer[409] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 409, 20);
        this.fmlBuffer[410] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 410, 20);
        this.fmlBuffer[411] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 411, 20);
        this.fmlBuffer[412] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 412, 20);
        this.fmlBuffer[413] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 413, 20);
        this.fmlBuffer[414] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 414, 20);
        this.fmlBuffer[415] = new FmlField("PESNBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 415, 1);
        this.fmlBuffer[416] = new FmlField("EQUIPMENT_NO", FmlField.TYPE_STRING, 21, null, 416, 50);
        this.fmlBuffer[417] = new FmlField("PHD_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 417, 50);
        this.fmlBuffer[418] = new FmlField("EQUIPMENT_LEVEL", FmlField.TYPE_SHORT, -1, null, 418, 50);
        this.fmlBuffer[419] = new FmlField("IMSI", FmlField.TYPE_STRING, 16, null, 419, 50);
        this.fmlBuffer[420] = new FmlField("PHYDEVARRAYEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 420, 50);
        this.fmlBuffer[421] = new FmlField("PHYDEVARRAYEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 421, 50);
        this.fmlBuffer[422] = new FmlField("OWNERSHIP_CODE", FmlField.TYPE_STRING, 3, null, 422, 50);
        this.fmlBuffer[423] = new FmlField("SW_STATE_IND", FmlField.TYPE_BYTE, -1, null, 423, 50);
        this.fmlBuffer[424] = new FmlField("LAST_SW_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 424, 50);
        this.fmlBuffer[425] = new FmlField("NEXT_ACTV_CODE", FmlField.TYPE_BYTE, -1, null, 425, 50);
        this.fmlBuffer[426] = new FmlField("NEXT_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 426, 50);
        this.fmlBuffer[427] = new FmlField("NEXT_ACTV_ISSUE_DT", FmlField.TYPE_STRING, 9, null, 427, 50);
        this.fmlBuffer[428] = new FmlField("DEVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 428, 50);
        this.fmlBuffer[429] = new FmlField("ESN_MODE", FmlField.TYPE_BYTE, -1, null, 429, 50);
        this.fmlBuffer[430] = new FmlField("ITEM_ID", FmlField.TYPE_STRING, 16, null, 430, 50);
        this.fmlBuffer[431] = new FmlField("POOL", FmlField.TYPE_STRING, 3, null, 431, 50);
        this.fmlBuffer[432] = new FmlField("LOCATION_ID", FmlField.TYPE_STRING, 5, null, 432, 50);
        this.fmlBuffer[433] = new FmlField("ACTIVITY_CODE", FmlField.TYPE_STRING, 5, null, 433, 50);
        this.fmlBuffer[434] = new FmlField("ACTIVITY_DATE", FmlField.TYPE_STRING, 15, null, 434, 50);
        this.fmlBuffer[435] = new FmlField("OPERATION_STATUS", FmlField.TYPE_BYTE, -1, null, 435, 50);
        this.fmlBuffer[436] = new FmlField("ITEM_OWNERSHIP", FmlField.TYPE_BYTE, -1, null, 436, 50);
        this.fmlBuffer[437] = new FmlField("ITEM_OWNERSHIP_DT", FmlField.TYPE_STRING, 15, null, 437, 50);
        this.fmlBuffer[438] = new FmlField("CURR_POSSESSION", FmlField.TYPE_BYTE, -1, null, 438, 50);
        this.fmlBuffer[439] = new FmlField("CURR_POSSESSION_DT", FmlField.TYPE_STRING, 15, null, 439, 50);
        this.fmlBuffer[440] = new FmlField("MISSING_IND", FmlField.TYPE_BYTE, -1, null, 440, 50);
        this.fmlBuffer[441] = new FmlField("IN_REPAIR_IND", FmlField.TYPE_BYTE, -1, null, 441, 50);
        this.fmlBuffer[442] = new FmlField("IN_TRANSIT_IND", FmlField.TYPE_BYTE, -1, null, 442, 50);
        this.fmlBuffer[443] = new FmlField("COMITED_TO_POS_IND", FmlField.TYPE_BYTE, -1, null, 443, 50);
        this.fmlBuffer[444] = new FmlField("COMITED_DATE", FmlField.TYPE_STRING, 15, null, 444, 50);
        this.fmlBuffer[445] = new FmlField("ACTIVITY_REASON", FmlField.TYPE_STRING, 4, null, 445, 50);
        this.fmlBuffer[446] = new FmlField("UPGRADE_IND", FmlField.TYPE_BYTE, -1, null, 446, 50);
        this.fmlBuffer[447] = new FmlField("EXPECTED_RTRN_DATE", FmlField.TYPE_STRING, 15, null, 447, 50);
        this.fmlBuffer[448] = new FmlField("POLICE_REPORT_NO", FmlField.TYPE_STRING, 16, null, 448, 50);
        this.fmlBuffer[449] = new FmlField("POLICE_REPORT_DATE", FmlField.TYPE_STRING, 15, null, 449, 50);
        this.fmlBuffer[450] = new FmlField("POLICE_STATION", FmlField.TYPE_STRING, 31, null, 450, 50);
        this.fmlBuffer[451] = new FmlField("PUK", FmlField.TYPE_INTEGER, -1, null, 451, 50);
        this.fmlBuffer[452] = new FmlField("PUK2", FmlField.TYPE_INTEGER, -1, null, 452, 50);
        this.fmlBuffer[453] = new FmlField("FIRST_USED_DATE", FmlField.TYPE_STRING, 15, null, 453, 50);
        this.fmlBuffer[454] = new FmlField("SIM_STATUS", FmlField.TYPE_BYTE, -1, null, 454, 50);
        this.fmlBuffer[455] = new FmlField("SUSPEND_IND", FmlField.TYPE_BYTE, -1, null, 455, 50);
        this.fmlBuffer[456] = new FmlField("SUSPEND_DATE", FmlField.TYPE_STRING, 15, null, 456, 50);
        this.fmlBuffer[457] = new FmlField("SENT_TO_AUC_IND", FmlField.TYPE_BYTE, -1, null, 457, 50);
        this.fmlBuffer[458] = new FmlField("HLR_CD", FmlField.TYPE_STRING, 4, null, 458, 50);
        this.fmlBuffer[459] = new FmlField("K4ID", FmlField.TYPE_STRING, 41, null, 459, 50);
        this.fmlBuffer[460] = new FmlField("PHYDEVARRAYDEALER_CODE", FmlField.TYPE_STRING, 6, null, 460, 50);
        this.fmlBuffer[461] = new FmlField("PSOCFTRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 461, 1);
        this.fmlBuffer[462] = new FmlField("PSOCFTRBUFROWID", FmlField.TYPE_STRING, 19, null, 462, 500);
        this.fmlBuffer[463] = new FmlField("PSOCFTRBUFSOC", FmlField.TYPE_STRING, 10, null, 463, 500);
        this.fmlBuffer[464] = new FmlField("PSOCFTRBUFSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 464, 500);
        this.fmlBuffer[465] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 465, 500);
        this.fmlBuffer[466] = new FmlField("MPS_FTR_CODE", FmlField.TYPE_STRING, 7, null, 466, 500);
        this.fmlBuffer[467] = new FmlField("FTR_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 467, 500);
        this.fmlBuffer[468] = new FmlField("FTR_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 468, 500);
        this.fmlBuffer[469] = new FmlField("FTR_EFF_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 469, 500);
        this.fmlBuffer[470] = new FmlField("FTR_EXP_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 470, 500);
        this.fmlBuffer[471] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 471, 500);
        this.fmlBuffer[472] = new FmlField("FTR_MODE", FmlField.TYPE_BYTE, -1, null, 472, 500);
        this.fmlBuffer[473] = new FmlField("PSOCFTRBUFSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 473, 500);
        this.fmlBuffer[474] = new FmlField("FTR_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 474, 500);
        this.fmlBuffer[475] = new FmlField("FTR_ADD_PARAM", FmlField.TYPE_STRING, 301, null, 475, 500);
        this.fmlBuffer[476] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, null, 476, 500);
        this.fmlBuffer[477] = new FmlField("PSOCFTRBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 477, 500);
        this.fmlBuffer[478] = new FmlField("PSOCFTRBUFCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 478, 500);
        this.fmlBuffer[479] = new FmlField("FTR_SPECIAL_TELNO", FmlField.TYPE_STRING, 21, null, 479, 500);
        this.fmlBuffer[480] = new FmlField("SWITCH_ACT_NEEDED", FmlField.TYPE_BYTE, -1, null, 480, 500);
        this.fmlBuffer[481] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, null, 481, 500);
        this.fmlBuffer[482] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, null, 482, 500);
        this.fmlBuffer[483] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 483, 500);
        this.fmlBuffer[484] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, null, 484, 500);
        this.fmlBuffer[485] = new FmlField("MANUAL_RC_RATE", FmlField.TYPE_DOUBLE, -1, null, 485, 500);
        this.fmlBuffer[486] = new FmlField("MANUAL_RC_EXP_DATE", FmlField.TYPE_STRING, 9, null, 486, 500);
        this.fmlBuffer[487] = new FmlField("MANUAL_RC_EFF_DATE", FmlField.TYPE_STRING, 9, null, 487, 500);
        this.fmlBuffer[488] = new FmlField("PNPINFOBUFFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 488, 1);
        this.fmlBuffer[489] = new FmlField("NPNUMINFORECROWID", FmlField.TYPE_STRING, 19, null, 489, 500);
        this.fmlBuffer[490] = new FmlField("PORT_NUMBER", FmlField.TYPE_STRING, 21, null, 490, 500);
        this.fmlBuffer[491] = new FmlField("NPNUMINFORECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 491, 500);
        this.fmlBuffer[492] = new FmlField("NPNUMINFORECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 492, 500);
        this.fmlBuffer[493] = new FmlField("NPNUMINFORECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 493, 500);
        this.fmlBuffer[494] = new FmlField("NPNUMINFORECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 494, 500);
        this.fmlBuffer[495] = new FmlField("NPNUMINFORECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 495, 500);
        this.fmlBuffer[496] = new FmlField("NPNUMINFORECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 496, 500);
        this.fmlBuffer[497] = new FmlField("NPNUMINFORECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 497, 500);
        this.fmlBuffer[498] = new FmlField("NPNUMINFORECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 498, 500);
        this.fmlBuffer[499] = new FmlField("INT_ORDER_ID", FmlField.TYPE_DOUBLE, -1, null, 499, 500);
        this.fmlBuffer[500] = new FmlField("ORG_CUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 500, 500);
        this.fmlBuffer[501] = new FmlField("PORT_IND", FmlField.TYPE_BYTE, -1, null, 501, 500);
        this.fmlBuffer[502] = new FmlField("NUMBER_TYPE", FmlField.TYPE_BYTE, -1, null, 502, 500);
        this.fmlBuffer[503] = new FmlField("PORT_REQUEST_DATE", FmlField.TYPE_STRING, 15, null, 503, 500);
        this.fmlBuffer[504] = new FmlField("ORG_OPERATOR", FmlField.TYPE_STRING, 6, null, 504, 500);
        this.fmlBuffer[505] = new FmlField("NPNUMINFORECSUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 505, 500);
        this.fmlBuffer[506] = new FmlField("LAST_INT_ORD_ID", FmlField.TYPE_DOUBLE, -1, null, 506, 500);
        this.fmlBuffer[507] = new FmlField("FUNCTION_PORT_IND", FmlField.TYPE_BYTE, -1, null, 507, 500);
        this.fmlBuffer[508] = new FmlField("PASSIVE_IND", FmlField.TYPE_BYTE, -1, null, 508, 500);
        this.fmlBuffer[509] = new FmlField("AUTO_CONFIRM", FmlField.TYPE_BYTE, -1, null, 509, 500);
        this.fmlBuffer[510] = new FmlField("TEMPORARY_MSISDN", FmlField.TYPE_STRING, 21, null, 510, 500);
        this.fmlBuffer[511] = new FmlField("HANDLE_MODE", FmlField.TYPE_BYTE, -1, null, 511, 500);
        this.fmlBuffer[512] = new FmlField("SEND_IND", FmlField.TYPE_BYTE, -1, null, 512, 500);
        this.fmlBuffer[513] = new FmlField("ORDID_STR", FmlField.TYPE_STRING, 21, null, 513, 500);
        this.fmlBuffer[514] = new FmlField("LAST_ORDID_STR", FmlField.TYPE_STRING, 21, null, 514, 500);
        this.fmlBuffer[515] = new FmlField("ICC", FmlField.TYPE_STRING, 61, null, 515, 500);
        this.fmlBuffer[516] = new FmlField("CUSTOMER_NAME", FmlField.TYPE_STRING, 255, null, 516, 500);
        this.fmlBuffer[517] = new FmlField("NPINFOBUFFCUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 517, 500);
        this.fmlBuffer[518] = new FmlField("SERVICE_PROVIDER", FmlField.TYPE_STRING, 6, null, 518, 500);
        this.fmlBuffer[519] = new FmlField("RSNCODE", FmlField.TYPE_STRING, 5, null, 519, 1);
    }
    ...
    public Integer get_SOC_QUANTITY(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[274].getValue(nIndex)));
    }
    ...
    public void set_SOC_QUANTITY(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[274].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public String get_ADR_MODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[369].getValue(nIndex)));
    }
    ...
    public void set_ADR_MODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[369].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_ADDRESS_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[373].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[376].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[379].getValue(nIndex)));
    }
    ...
    public void set_ADDRESSRECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[379].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_PHD_SEQ_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[417].getValue(nIndex));
    }
    ...
    public Integer get_EQUIPMENT_LEVEL(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[418].getValue(nIndex)));
    }
    ...
    public void set_EQUIPMENT_LEVEL(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[418].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public String get_UPGRADE_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[446].getValue(nIndex)));
    }
    ...
    public void set_UPGRADE_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[446].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PUK(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[451].getValue(nIndex));
    }
    ...
    public String get_SIM_STATUS(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[454].getValue(nIndex)));
    }
    ...
    public void set_SIM_STATUS(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[454].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PSOCFTRBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[461].getValue(0));
    }
    ...
    public void set_PSOCFTRBUFROWCOUNT(Integer value) throws FMLManipulationException {
        this.fmlBuffer[461].setValue(0, value);
    }
    ...
    public String get_FTR_EFF_RSN_CODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[469].getValue(nIndex)));
    }
    ...
    public void set_FTR_EFF_RSN_CODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[469].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_SERVICE_FTR_SEQ_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[471].getValue(nIndex));
    }
    ...
    public Integer get_PSOCFTRBUFCAMPAIGN_SEQ(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[478].getValue(nIndex));
    }
    ...
    public String get_SWITCH_ACT_NEEDED(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[480].getValue(nIndex)));
    }
    ...
    public void set_SWITCH_ACT_NEEDED(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[480].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_MANUAL_RC_RATE(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[485].getValue(nIndex));
    }
    ...
    public String get_MANUAL_RC_EXP_DATE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[486].getValue(nIndex));
    }
    ...
    public String get_MANUAL_RC_EFF_DATE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[487].getValue(nIndex));
    }
    ...
    public Integer get_PNPINFOBUFFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[488].getValue(0));
    }
    ...
    public void set_PNPINFOBUFFROWCOUNT(Integer value) throws FMLManipulationException {
        this.fmlBuffer[488].setValue(0, value);
    }
    ...
    public Integer get_NPNUMINFORECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[494].getValue(nIndex));
    }
    ...
    public Integer get_NPNUMINFORECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[497].getValue(nIndex)));
    }
    ...
    public void set_NPNUMINFORECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[497].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_INT_ORDER_ID(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[499].getValue(nIndex));
    }
    ...
    public String get_PORT_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[501].getValue(nIndex)));
    }
    ...
    public void set_PORT_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[501].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_NUMBER_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[502].getValue(nIndex)));
    }
    ...
    public void set_NUMBER_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[502].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_ORG_OPERATOR(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[504].getValue(nIndex));
    }
    ...
    public void set_ORG_OPERATOR(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[504].setValue(nIndex, value);
    }
    ...
    public Integer get_NPNUMINFORECSUBSCRIBER_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[505].getValue(nIndex));
    }
    ...
    public Double get_LAST_INT_ORD_ID(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[506].getValue(nIndex));
    }
    ...
    public String get_FUNCTION_PORT_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[507].getValue(nIndex)));
    }
    ...
    public void set_FUNCTION_PORT_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[507].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_PASSIVE_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[508].getValue(nIndex)));
    }
    ...
    public void set_PASSIVE_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[508].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_TEMPORARY_MSISDN(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[510].getValue(nIndex));
    }
    ...
    public void set_TEMPORARY_MSISDN(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[510].setValue(nIndex, value);
    }
    ...
    public String get_SEND_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[512].getValue(nIndex)));
    }
    ...
    public void set_SEND_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[512].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_ORDID_STR(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[513].getValue(nIndex));
    }
    ...
    public void set_ORDID_STR(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[513].setValue(nIndex, value);
    }
    ...
    public String get_LAST_ORDID_STR(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[514].getValue(nIndex));
    }
    ...
    public void set_LAST_ORDID_STR(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[514].setValue(nIndex, value);
    }
    ...
    public String get_RSNCODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[519].getValue(0));
    }
    ...
    public void set_RSNCODE(String value) throws FMLManipulationException {
        this.fmlBuffer[519].setValue(0, value);
    }
}