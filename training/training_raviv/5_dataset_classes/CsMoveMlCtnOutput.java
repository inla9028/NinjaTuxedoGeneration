 ...
 */
public class CsMoveMlCtnOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsMoveMlCtnOutput.
     *
     * @throws FMLManipulationException
     */
    public CsMoveMlCtnOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsMoveMlCtnOutput() {
    }

    /**
     * Creates a new instance of CsMoveMlCtnOutput.
     *
     * @param ds Output dataset from CsMoveMlCtn service.
     * @throws FMLManipulationException
     */
    public CsMoveMlCtnOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[27];
        ...
        this.fmlBuffer[23] = new FmlField("SOURCE_BAN_LAST_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 23, 1);
        this.fmlBuffer[24] = new FmlField("SOURCE_BAN_LAST_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 24, 1);
        this.fmlBuffer[25] = new FmlField("ERRCOUNT", FmlField.TYPE_INTEGER, -1, null, 25, 1);
        this.fmlBuffer[26] = new FmlField("VLDCOUNT", FmlField.TYPE_INTEGER, -1, null, 26, 1);
    }
    ...
    /**
     * Retrieves the value of the 'ERRCOUNT' field in the FML buffer.
     *
     * @return Value of 'ERRCOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_ERRCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[25].getValue(0));
    }

    /**
     * Retrieves the value of the 'VLDCOUNT' field in the FML buffer.
     *
     * @return Value of 'VLDCOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_VLDCOUNT() throws FMLManipulationException {
