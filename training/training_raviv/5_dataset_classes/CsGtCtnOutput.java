...
public class CsGtCtnOutput extends ServiceOutput implements SubscriptionPortOrderInfo {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[356];
        ...
        this.fmlBuffer[144] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 144, 20);
        this.fmlBuffer[145] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 145, 20);
        this.fmlBuffer[146] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 146, 20);
        this.fmlBuffer[147] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 147, 20);
        this.fmlBuffer[148] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 148, 20);
        this.fmlBuffer[149] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 149, 20);
        this.fmlBuffer[150] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 150, 20);
        this.fmlBuffer[151] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 151, 20);
        this.fmlBuffer[152] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 152, 20);
        this.fmlBuffer[153] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 153, 20);
        this.fmlBuffer[154] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 154, 20);
        this.fmlBuffer[155] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 155, 20);
        this.fmlBuffer[156] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 156, 20);
        this.fmlBuffer[157] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 157, 20);
        this.fmlBuffer[158] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 158, 20);
        this.fmlBuffer[159] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 159, 20);
        this.fmlBuffer[160] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 160, 20);
        this.fmlBuffer[161] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 161, 20);
        this.fmlBuffer[162] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 162, 20);
        this.fmlBuffer[163] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 163, 20);
        this.fmlBuffer[164] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 164, 20);
        this.fmlBuffer[165] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 165, 20);
        this.fmlBuffer[166] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 166, 20);
        this.fmlBuffer[167] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 167, 20);
        this.fmlBuffer[168] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 168, 20);
        this.fmlBuffer[169] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 169, 20);
        this.fmlBuffer[170] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 170, 20);
        this.fmlBuffer[171] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 171, 20);
        this.fmlBuffer[172] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 172, 20);
        this.fmlBuffer[173] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 173, 20);
        this.fmlBuffer[174] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 174, 20);
        this.fmlBuffer[175] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 175, 20);
        this.fmlBuffer[176] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 176, 20);
        this.fmlBuffer[177] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 177, 20);
        this.fmlBuffer[178] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 178, 20);
        this.fmlBuffer[179] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 179, 20);
        this.fmlBuffer[180] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 180, 20);
        this.fmlBuffer[181] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 181, 20);
        this.fmlBuffer[182] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 182, 20);
        this.fmlBuffer[183] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 183, 20);
        this.fmlBuffer[184] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 184, 20);
        this.fmlBuffer[185] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 185, 20);
        this.fmlBuffer[186] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 186, 20);
        this.fmlBuffer[187] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 187, 20);
        this.fmlBuffer[188] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 188, 20);
        this.fmlBuffer[189] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 189, 20);
        this.fmlBuffer[190] = new FmlField("FUTURE_REQ_COUNT", FmlField.TYPE_INTEGER, -1, null, 190, 1);
        this.fmlBuffer[191] = new FmlField("LINKED_IND", FmlField.TYPE_BYTE, -1, null, 191, 1);
        this.fmlBuffer[192] = new FmlField("PCONTRACTROWID", FmlField.TYPE_STRING, 19, null, 192, 1);
        this.fmlBuffer[193] = new FmlField("PCONTRACTBAN", FmlField.TYPE_INTEGER, -1, null, 193, 1);
        this.fmlBuffer[194] = new FmlField("PCONTRACTSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 194, 1);
        this.fmlBuffer[195] = new FmlField("PCONTRACTCNT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 195, 1);
        this.fmlBuffer[196] = new FmlField("PCONTRACTSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 196, 1);
        this.fmlBuffer[197] = new FmlField("PCONTRACTSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 197, 1);
        this.fmlBuffer[198] = new FmlField("PCONTRACTOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 198, 1);
        this.fmlBuffer[199] = new FmlField("PCONTRACTAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 199, 1);
        this.fmlBuffer[200] = new FmlField("PCONTRACTDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 200, 1);
        this.fmlBuffer[201] = new FmlField("PCONTRACTDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 201, 1);
        this.fmlBuffer[202] = new FmlField("ENTRY_EFF_DATE", FmlField.TYPE_STRING, 9, null, 202, 1);
        this.fmlBuffer[203] = new FmlField("PCONTRACTCONTRACT_NO", FmlField.TYPE_STRING, 11, null, 203, 1);
        this.fmlBuffer[204] = new FmlField("PCONTRACTCOMMIT_START_DATE", FmlField.TYPE_STRING, 9, null, 204, 1);
        this.fmlBuffer[205] = new FmlField("PCONTRACTCOMMIT_END_DATE", FmlField.TYPE_STRING, 9, null, 205, 1);
        this.fmlBuffer[206] = new FmlField("COMMIT_REASON_CD", FmlField.TYPE_STRING, 4, null, 206, 1);
        this.fmlBuffer[207] = new FmlField("PCONTRACTCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 207, 1);
        this.fmlBuffer[208] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 208, 1);
        this.fmlBuffer[209] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 209, 1);
        this.fmlBuffer[210] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 210, 1);
        this.fmlBuffer[211] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 211, 1);
        this.fmlBuffer[212] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 212, 1);
        this.fmlBuffer[213] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 213, 1);
        this.fmlBuffer[214] = new FmlField("PNPINFOBUFFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 214, 1);
        this.fmlBuffer[215] = new FmlField("NPNUMINFORECROWID", FmlField.TYPE_STRING, 19, null, 215, 500);
        this.fmlBuffer[216] = new FmlField("PORT_NUMBER", FmlField.TYPE_STRING, 21, null, 216, 500);
        this.fmlBuffer[217] = new FmlField("NPNUMINFORECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 217, 500);
        this.fmlBuffer[218] = new FmlField("NPNUMINFORECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 218, 500);
        this.fmlBuffer[219] = new FmlField("NPNUMINFORECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 219, 500);
        this.fmlBuffer[220] = new FmlField("NPNUMINFORECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 220, 500);
        this.fmlBuffer[221] = new FmlField("NPNUMINFORECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 221, 500);
        this.fmlBuffer[222] = new FmlField("NPNUMINFORECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 222, 500);
        this.fmlBuffer[223] = new FmlField("NPNUMINFORECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 223, 500);
        this.fmlBuffer[224] = new FmlField("EXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 224, 500);
        this.fmlBuffer[225] = new FmlField("INT_ORDER_ID", FmlField.TYPE_DOUBLE, -1, null, 225, 500);
        this.fmlBuffer[226] = new FmlField("ORG_CUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 226, 500);
        this.fmlBuffer[227] = new FmlField("PORT_IND", FmlField.TYPE_BYTE, -1, null, 227, 500);
        this.fmlBuffer[228] = new FmlField("NUMBER_TYPE", FmlField.TYPE_BYTE, -1, null, 228, 500);
        this.fmlBuffer[229] = new FmlField("PORT_REQUEST_DATE", FmlField.TYPE_STRING, 15, null, 229, 500);
        this.fmlBuffer[230] = new FmlField("ORG_OPERATOR", FmlField.TYPE_STRING, 6, null, 230, 500);
        this.fmlBuffer[231] = new FmlField("NPNUMINFORECSUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 231, 500);
        this.fmlBuffer[232] = new FmlField("LAST_INT_ORD_ID", FmlField.TYPE_DOUBLE, -1, null, 232, 500);
        this.fmlBuffer[233] = new FmlField("FUNCTION_PORT_IND", FmlField.TYPE_BYTE, -1, null, 233, 500);
        this.fmlBuffer[234] = new FmlField("PASSIVE_IND", FmlField.TYPE_BYTE, -1, null, 234, 500);
        this.fmlBuffer[235] = new FmlField("AUTO_CONFIRM", FmlField.TYPE_BYTE, -1, null, 235, 500);
        this.fmlBuffer[236] = new FmlField("TEMPORARY_MSISDN", FmlField.TYPE_STRING, 21, null, 236, 500);
        this.fmlBuffer[237] = new FmlField("HANDLE_MODE", FmlField.TYPE_BYTE, -1, null, 237, 500);
        this.fmlBuffer[238] = new FmlField("SEND_IND", FmlField.TYPE_BYTE, -1, null, 238, 500);
        this.fmlBuffer[239] = new FmlField("ORDID_STR", FmlField.TYPE_STRING, 21, null, 239, 500);
        this.fmlBuffer[240] = new FmlField("LAST_ORDID_STR", FmlField.TYPE_STRING, 21, null, 240, 500);
        this.fmlBuffer[241] = new FmlField("ICC", FmlField.TYPE_STRING, 61, null, 241, 500);
        this.fmlBuffer[242] = new FmlField("CUSTOMER_NAME", FmlField.TYPE_STRING, 255, null, 242, 500);
        this.fmlBuffer[243] = new FmlField("NPINFOBUFFCUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 243, 500);
        this.fmlBuffer[244] = new FmlField("SERVICE_PROVIDER", FmlField.TYPE_STRING, 6, null, 244, 500);
        this.fmlBuffer[245] = new FmlField("PNPADDINFOBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 245, 1);
        this.fmlBuffer[246] = new FmlField("CURR_SERV_OPER", FmlField.TYPE_STRING, 6, null, 246, 500);
        this.fmlBuffer[247] = new FmlField("NPTRXDETRECROWID", FmlField.TYPE_STRING, 19, null, 247, 500);
        this.fmlBuffer[248] = new FmlField("TRX_CODE", FmlField.TYPE_SHORT, -1, null, 248, 500);
        this.fmlBuffer[249] = new FmlField("NPTRXDETRECINT_ORDER_ID", FmlField.TYPE_DOUBLE, -1, null, 249, 500);
        this.fmlBuffer[250] = new FmlField("TRX_SOURCE", FmlField.TYPE_STRING, 4, null, 250, 500);
        this.fmlBuffer[251] = new FmlField("NPTRXDETRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 251, 500);
        this.fmlBuffer[252] = new FmlField("NPTRXDETRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 252, 500);
        this.fmlBuffer[253] = new FmlField("NPTRXDETRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 253, 500);
        this.fmlBuffer[254] = new FmlField("NPTRXDETRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 254, 500);
        this.fmlBuffer[255] = new FmlField("NPTRXDETRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 255, 500);
        this.fmlBuffer[256] = new FmlField("NPTRXDETRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 256, 500);
        this.fmlBuffer[257] = new FmlField("EXT_UNIQUE_ID", FmlField.TYPE_STRING, 13, null, 257, 500);
        this.fmlBuffer[258] = new FmlField("INT_TRX_SEQ", FmlField.TYPE_INTEGER, -1, null, 258, 500);
        this.fmlBuffer[259] = new FmlField("INITI_ORDER_SEQ", FmlField.TYPE_INTEGER, -1, null, 259, 500);
        this.fmlBuffer[260] = new FmlField("CONT_CATEGORY", FmlField.TYPE_STRING, 4, null, 260, 500);
        this.fmlBuffer[261] = new FmlField("EXT_ORDER_ID", FmlField.TYPE_DOUBLE, -1, null, 261, 500);
        this.fmlBuffer[262] = new FmlField("TRX_DATETIME", FmlField.TYPE_STRING, 15, null, 262, 500);
        this.fmlBuffer[263] = new FmlField("TRX_STATUS", FmlField.TYPE_BYTE, -1, null, 263, 500);
        this.fmlBuffer[264] = new FmlField("TRX_STS_DATE", FmlField.TYPE_STRING, 15, null, 264, 500);
        this.fmlBuffer[265] = new FmlField("NPTRXDETRECCUSTOMER_NAME", FmlField.TYPE_STRING, 255, null, 265, 500);
        this.fmlBuffer[266] = new FmlField("NPTRXDETRECCUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 266, 500);
        this.fmlBuffer[267] = new FmlField("NPTRXDETRECNUMBER_TYPE", FmlField.TYPE_STRING, 255, null, 267, 500);
        this.fmlBuffer[268] = new FmlField("NEW_NUM_TYPE", FmlField.TYPE_STRING, 255, null, 268, 500);
        this.fmlBuffer[269] = new FmlField("MAIN_NUMBER", FmlField.TYPE_STRING, 21, null, 269, 500);
        this.fmlBuffer[270] = new FmlField("ADDITIONAL_NUMBER_1", FmlField.TYPE_STRING, 255, null, 270, 500);
        this.fmlBuffer[271] = new FmlField("ADDITIONAL_NUMBER_2", FmlField.TYPE_STRING, 255, null, 271, 500);
        this.fmlBuffer[272] = new FmlField("ADDITIONAL_NUMBER_3", FmlField.TYPE_STRING, 255, null, 272, 500);
        this.fmlBuffer[273] = new FmlField("ADDITIONAL_NUMBER_4", FmlField.TYPE_STRING, 255, null, 273, 500);
        this.fmlBuffer[274] = new FmlField("ADDITIONAL_NUMBER_5", FmlField.TYPE_STRING, 255, null, 274, 500);
        this.fmlBuffer[275] = new FmlField("ADDITIONAL_NUMBER_6", FmlField.TYPE_STRING, 255, null, 275, 500);
        this.fmlBuffer[276] = new FmlField("ADDITIONAL_NUMBER_7", FmlField.TYPE_STRING, 255, null, 276, 500);
        this.fmlBuffer[277] = new FmlField("ADDITIONAL_NUMBER_8", FmlField.TYPE_STRING, 255, null, 277, 500);
        this.fmlBuffer[278] = new FmlField("ADDITIONAL_NUMBER_9", FmlField.TYPE_STRING, 255, null, 278, 500);
        this.fmlBuffer[279] = new FmlField("ADDITIONAL_NUMBER_10", FmlField.TYPE_STRING, 255, null, 279, 500);
        this.fmlBuffer[280] = new FmlField("PRIMARY_NUM", FmlField.TYPE_STRING, 21, null, 280, 500);
        this.fmlBuffer[281] = new FmlField("REQUEST_EXEC_DATE", FmlField.TYPE_STRING, 15, null, 281, 500);
        this.fmlBuffer[282] = new FmlField("CONF_EXEC_DATE", FmlField.TYPE_STRING, 15, null, 282, 500);
        this.fmlBuffer[283] = new FmlField("CONF_STATUS", FmlField.TYPE_STRING, 4, null, 283, 500);
        this.fmlBuffer[284] = new FmlField("ERROR_UNIQ_ID", FmlField.TYPE_INTEGER, -1, null, 284, 500);
        this.fmlBuffer[285] = new FmlField("SERIES_UNIQ_ID", FmlField.TYPE_INTEGER, -1, null, 285, 500);
        this.fmlBuffer[286] = new FmlField("NPTRXDETRECCURR_SERV_OPER", FmlField.TYPE_STRING, 6, null, 286, 500);
        this.fmlBuffer[287] = new FmlField("RECIP_SERV_OPER", FmlField.TYPE_STRING, 6, null, 287, 500);
        this.fmlBuffer[288] = new FmlField("CURR_NET_OPER", FmlField.TYPE_STRING, 6, null, 288, 500);
        this.fmlBuffer[289] = new FmlField("RECIP_NET_OPER", FmlField.TYPE_STRING, 6, null, 289, 500);
        this.fmlBuffer[290] = new FmlField("INITI_ORDER_TP", FmlField.TYPE_STRING, 6, null, 290, 500);
        this.fmlBuffer[291] = new FmlField("TEXT_COMMENT", FmlField.TYPE_STRING, 256, null, 291, 500);
        this.fmlBuffer[292] = new FmlField("DELAY_IND", FmlField.TYPE_BYTE, -1, null, 292, 500);
        this.fmlBuffer[293] = new FmlField("FILE_NAME", FmlField.TYPE_STRING, 256, null, 293, 500);
        this.fmlBuffer[294] = new FmlField("MUNICIPALITY", FmlField.TYPE_STRING, 4, null, 294, 500);
        this.fmlBuffer[295] = new FmlField("EXT_TRX_STS", FmlField.TYPE_STRING, 11, null, 295, 500);
        this.fmlBuffer[296] = new FmlField("LAST_TRX_STS", FmlField.TYPE_STRING, 11, null, 296, 500);
        this.fmlBuffer[297] = new FmlField("INITI_TIMESTAMP", FmlField.TYPE_STRING, 15, null, 297, 500);
        this.fmlBuffer[298] = new FmlField("OTHER_OPERATOR", FmlField.TYPE_STRING, 6, null, 298, 500);
        this.fmlBuffer[299] = new FmlField("POINT_OF_CONNECTION", FmlField.TYPE_STRING, 61, null, 299, 500);
        this.fmlBuffer[300] = new FmlField("RANGE_UPD_TP", FmlField.TYPE_BYTE, -1, null, 300, 500);
        this.fmlBuffer[301] = new FmlField("CSNPSPC", FmlField.TYPE_STRING, 7, null, 301, 500);
        this.fmlBuffer[302] = new FmlField("ROUTING_INFO", FmlField.TYPE_STRING, 9, null, 302, 500);
        this.fmlBuffer[303] = new FmlField("RATING_TP", FmlField.TYPE_STRING, 5, null, 303, 500);
        this.fmlBuffer[304] = new FmlField("MAN_AUT", FmlField.TYPE_BYTE, -1, null, 304, 500);
        this.fmlBuffer[305] = new FmlField("TERM_CONF_DATE", FmlField.TYPE_STRING, 9, null, 305, 500);
        this.fmlBuffer[306] = new FmlField("NPTRXDETRECSERVICE_PROVIDER", FmlField.TYPE_STRING, 6, null, 306, 500);
        this.fmlBuffer[307] = new FmlField("NP_CARD_STS", FmlField.TYPE_STRING, 13, null, 307, 500);
        this.fmlBuffer[308] = new FmlField("CHARGING_INFO", FmlField.TYPE_STRING, 9, null, 308, 500);
        this.fmlBuffer[309] = new FmlField("DIRECTORY_INFO", FmlField.TYPE_STRING, 14, null, 309, 500);
        this.fmlBuffer[310] = new FmlField("NUM_PORTED_IND", FmlField.TYPE_BYTE, -1, null, 310, 500);
        this.fmlBuffer[311] = new FmlField("PORTING_CASE", FmlField.TYPE_STRING, 61, null, 311, 500);
        this.fmlBuffer[312] = new FmlField("PORTING_TP", FmlField.TYPE_STRING, 61, null, 312, 500);
        this.fmlBuffer[313] = new FmlField("RANGE", FmlField.TYPE_STRING, 18, null, 313, 500);
        this.fmlBuffer[314] = new FmlField("SERIES_COUNT", FmlField.TYPE_STRING, 4, null, 314, 500);
        this.fmlBuffer[315] = new FmlField("EIDNODSIGN", FmlField.TYPE_STRING, 7, null, 315, 500);
        this.fmlBuffer[316] = new FmlField("EIDNTYP", FmlField.TYPE_STRING, 5, null, 316, 500);
        this.fmlBuffer[317] = new FmlField("EIDNTYPNUMB", FmlField.TYPE_STRING, 5, null, 317, 500);
        this.fmlBuffer[318] = new FmlField("NEIDNODSIGN", FmlField.TYPE_STRING, 7, null, 318, 500);
        this.fmlBuffer[319] = new FmlField("NEIDNTYP", FmlField.TYPE_STRING, 5, null, 319, 500);
        this.fmlBuffer[320] = new FmlField("NEIDNTYPNUMB", FmlField.TYPE_STRING, 5, null, 320, 500);
        this.fmlBuffer[321] = new FmlField("CONTACT_NAME", FmlField.TYPE_STRING, 255, null, 321, 500);
        this.fmlBuffer[322] = new FmlField("CONTACT_NUMBER", FmlField.TYPE_STRING, 255, null, 322, 500);
        this.fmlBuffer[323] = new FmlField("CONTACT_EMAIL", FmlField.TYPE_STRING, 255, null, 323, 500);
        this.fmlBuffer[324] = new FmlField("ERROR_CONTACT_NAME", FmlField.TYPE_STRING, 255, null, 324, 500);
        this.fmlBuffer[325] = new FmlField("ERROR_CONTACT_NUMBER", FmlField.TYPE_STRING, 255, null, 325, 500);
        this.fmlBuffer[326] = new FmlField("ERROR_CONTACT_EMAIL", FmlField.TYPE_STRING, 255, null, 326, 500);
        this.fmlBuffer[327] = new FmlField("TEXT_1", FmlField.TYPE_STRING, 255, null, 327, 500);
        this.fmlBuffer[328] = new FmlField("TEXT_2", FmlField.TYPE_STRING, 255, null, 328, 500);
        this.fmlBuffer[329] = new FmlField("TEXT_3", FmlField.TYPE_STRING, 255, null, 329, 500);
        this.fmlBuffer[330] = new FmlField("TEXT_4", FmlField.TYPE_STRING, 255, null, 330, 500);
        this.fmlBuffer[331] = new FmlField("TEXT_5", FmlField.TYPE_STRING, 255, null, 331, 500);
        this.fmlBuffer[332] = new FmlField("TEXT_6", FmlField.TYPE_STRING, 255, null, 332, 500);
        this.fmlBuffer[333] = new FmlField("TEXT_7", FmlField.TYPE_STRING, 255, null, 333, 500);
        this.fmlBuffer[334] = new FmlField("TEXT_8", FmlField.TYPE_STRING, 255, null, 334, 500);
        this.fmlBuffer[335] = new FmlField("TEXT_9", FmlField.TYPE_STRING, 255, null, 335, 500);
        this.fmlBuffer[336] = new FmlField("TEXT_10", FmlField.TYPE_STRING, 255, null, 336, 500);
        this.fmlBuffer[337] = new FmlField("RPSP", FmlField.TYPE_STRING, 255, null, 337, 500);
        this.fmlBuffer[338] = new FmlField("TRX_SENT_DATETIME", FmlField.TYPE_STRING, 15, null, 338, 500);
        this.fmlBuffer[339] = new FmlField("ORIGINATING_NUMBER", FmlField.TYPE_STRING, 255, null, 339, 500);
        this.fmlBuffer[340] = new FmlField("NPTRXDETRECICC", FmlField.TYPE_STRING, 61, null, 340, 500);
        this.fmlBuffer[341] = new FmlField("COORDINATION_IND", FmlField.TYPE_BYTE, -1, null, 341, 500);
        this.fmlBuffer[342] = new FmlField("PORT_ENDED", FmlField.TYPE_SHORT, -1, null, 342, 500);
        this.fmlBuffer[343] = new FmlField("PORT_ENDED_MAIN", FmlField.TYPE_SHORT, -1, null, 343, 500);
        this.fmlBuffer[344] = new FmlField("PORT_ENDED_ADDITIONAL1", FmlField.TYPE_SHORT, -1, null, 344, 500);
        this.fmlBuffer[345] = new FmlField("PORT_ENDED_ADDITIONAL2", FmlField.TYPE_SHORT, -1, null, 345, 500);
        this.fmlBuffer[346] = new FmlField("PORT_ENDED_ADDITIONAL3", FmlField.TYPE_SHORT, -1, null, 346, 500);
        this.fmlBuffer[347] = new FmlField("PORT_ENDED_ADDITIONAL4", FmlField.TYPE_SHORT, -1, null, 347, 500);
        this.fmlBuffer[348] = new FmlField("PORT_ENDED_ADDITIONAL5", FmlField.TYPE_SHORT, -1, null, 348, 500);
        this.fmlBuffer[349] = new FmlField("PORT_ENDED_ADDITIONAL6", FmlField.TYPE_SHORT, -1, null, 349, 500);
        this.fmlBuffer[350] = new FmlField("PORT_ENDED_ADDITIONAL7", FmlField.TYPE_SHORT, -1, null, 350, 500);
        this.fmlBuffer[351] = new FmlField("PORT_ENDED_ADDITIONAL8", FmlField.TYPE_SHORT, -1, null, 351, 500);
        this.fmlBuffer[352] = new FmlField("PORT_ENDED_ADDITIONAL9", FmlField.TYPE_SHORT, -1, null, 352, 500);
        this.fmlBuffer[353] = new FmlField("PORT_ENDED_ADDITIONAL10", FmlField.TYPE_SHORT, -1, null, 353, 500);
        this.fmlBuffer[354] = new FmlField("DTSP", FmlField.TYPE_STRING, 4, null, 354, 500);
        this.fmlBuffer[355] = new FmlField("RTSP", FmlField.TYPE_STRING, 4, null, 355, 500);
    }
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[154].getValue(nIndex)));
    }
    ...
    public Integer get_NPNUMINFORECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[220].getValue(nIndex));
    }
    ...
    public Integer get_NPNUMINFORECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[223].getValue(nIndex)));
    }
    ...
    public Double get_INT_ORDER_ID(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[225].getValue(nIndex));
    }
    ...
    public Integer get_NPNUMINFORECSUBSCRIBER_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[231].getValue(nIndex));
    }
    ...
    public Double get_LAST_INT_ORD_ID(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[232].getValue(nIndex));
    }
    ...
    public String get_SEND_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[238].getValue(nIndex)));
    }
    ...
    public Integer get_TRX_CODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[248].getValue(nIndex)));
    }
    ...
    public Double get_NPTRXDETRECINT_ORDER_ID(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[249].getValue(nIndex));
    }
    ...
    public Integer get_NPTRXDETRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[256].getValue(nIndex)));
    }
    ...
    public Double get_EXT_ORDER_ID(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[261].getValue(nIndex));
    }
