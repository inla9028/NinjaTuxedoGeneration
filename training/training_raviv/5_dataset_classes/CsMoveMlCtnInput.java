...
public class CsMoveMlCtnInput extends ServiceInput {
    ...
    public CsMoveMlCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csMoveMlCtn", 50);
        ...
        this.fmlBuffer[47] = new FmlField("ACTIVITY_DATE", FmlField.TYPE_STRING, 9, null, 47, 1);
        this.fmlBuffer[48] = new FmlField("SOURCE_BAN_LAST_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 48, 1);
        this.fmlBuffer[49] = new FmlField("SOURCE_BAN_LAST_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 49, 1);
    }
