 ...
 */
public class CsActvLoanInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsActvLoanInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsActvLoanInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csActvLoan", 48);
        ...
        this.fmlBuffer[17] = new FmlField("SUBNO", FmlField.TYPE_STRING, 21, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("SOC", FmlField.TYPE_STRING, 10, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("LOANSEQNO", FmlField.TYPE_INTEGER, -1, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("LOANEXPDATE", FmlField.TYPE_STRING, 9, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("ACTIVITYDATE", FmlField.TYPE_STRING, 9, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("LOANSUBID", FmlField.TYPE_INTEGER, -1, null, 22, 1);
        this.fmlBuffer[23] = new FmlField("ONHOLDLOANSEQNO", FmlField.TYPE_INTEGER, -1, null, 23, 1);
        this.fmlBuffer[24] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 24, 1);
        this.fmlBuffer[25] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 25, 50);
        this.fmlBuffer[26] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 26, 50);
        this.fmlBuffer[27] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 27, 50);
        this.fmlBuffer[28] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 28, 50);
        this.fmlBuffer[29] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 29, 50);
        this.fmlBuffer[30] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 30, 50);
        this.fmlBuffer[31] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 31, 50);
        this.fmlBuffer[32] = new FmlField("P1", FmlField.TYPE_STRING, 21, null, 32, 50);
        this.fmlBuffer[33] = new FmlField("P2", FmlField.TYPE_STRING, 21, null, 33, 50);
        this.fmlBuffer[34] = new FmlField("P3", FmlField.TYPE_STRING, 21, null, 34, 50);
        this.fmlBuffer[35] = new FmlField("P4", FmlField.TYPE_STRING, 21, null, 35, 50);
        this.fmlBuffer[36] = new FmlField("P5", FmlField.TYPE_STRING, 21, null, 36, 50);
        this.fmlBuffer[37] = new FmlField("P6", FmlField.TYPE_STRING, 21, null, 37, 50);
        this.fmlBuffer[38] = new FmlField("P7", FmlField.TYPE_STRING, 21, null, 38, 50);
        this.fmlBuffer[39] = new FmlField("P8", FmlField.TYPE_STRING, 21, null, 39, 50);
        this.fmlBuffer[40] = new FmlField("P9", FmlField.TYPE_STRING, 21, null, 40, 50);
        this.fmlBuffer[41] = new FmlField("P10", FmlField.TYPE_STRING, 21, null, 41, 50);
        this.fmlBuffer[42] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 42, 50);
        this.fmlBuffer[43] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 43, 50);
        this.fmlBuffer[44] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 44, 50);
        this.fmlBuffer[45] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 45, 50);
        this.fmlBuffer[46] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 46, 50);
        this.fmlBuffer[47] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 47, 50);
    }
    ...
    /**
     * Retrieves the value of the 'SUBNO' field in the FML buffer.
     *
     * @return Value of 'SUBNO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_SUBNO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[17].getValue(0));
    }

    /**
     * Sets the value of the 'SUBNO' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_SUBNO(String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'LOANEXPDATE' field in the FML buffer.
     *
     * @return Value of 'LOANEXPDATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_LOANEXPDATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[20].getValue(0));
    }

    /**
     * Sets the value of the 'LOANEXPDATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @throws FMLManipulationException
     */
    public void set_LOANEXPDATE(String value) throws FMLManipulationException {
        this.fmlBuffer[20].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'ACTIVITYDATE' field in the FML buffer.
     *
     * @return Value of 'ACTIVITYDATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_ACTIVITYDATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[21].getValue(0));
    }

    /**
     * Sets the value of the 'ACTIVITYDATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @throws FMLManipulationException
     */
    public void set_ACTIVITYDATE(String value) throws FMLManipulationException {
        this.fmlBuffer[21].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'LOANSUBID' field in the FML buffer.
     *
     * @return Value of 'LOANSUBID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_LOANSUBID() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[22].getValue(0));
    }

    /**
     * Sets the value of the 'LOANSUBID' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_LOANSUBID(Integer value) throws FMLManipulationException {
        this.fmlBuffer[22].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'ONHOLDLOANSEQNO' field in the FML buffer.
     *
     * @return Value of 'ONHOLDLOANSEQNO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_ONHOLDLOANSEQNO() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[23].getValue(0));
    }

    /**
     * Sets the value of the 'ONHOLDLOANSEQNO' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_ONHOLDLOANSEQNO(Integer value) throws FMLManipulationException {
