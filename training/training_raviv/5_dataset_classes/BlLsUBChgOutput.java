...
public class BlLsUBChgOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[60] = new FmlField("QUANTITY", FmlField.TYPE_SHORT, -1, null, 60, 600);
        ...
        this.fmlBuffer[102] = new FmlField("BLADJDISCOUNT_PCT", FmlField.TYPE_DOUBLE, -1, null, 102, 500);
        ...
        this.fmlBuffer[121] = new FmlField("BLADJQUANTITY", FmlField.TYPE_SHORT, -1, null, 121, 500);
    ...
    public Integer get_BLADJQUANTITY(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[121].getValue(nIndex)));
    }
