...
public class ClGtColInfoOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[219];
        ...
        this.fmlBuffer[161] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 161, 20);
        this.fmlBuffer[162] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 162, 20);
        this.fmlBuffer[163] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 163, 20);
        this.fmlBuffer[164] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 164, 20);
        this.fmlBuffer[165] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 165, 20);
        this.fmlBuffer[166] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 166, 20);
        this.fmlBuffer[167] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 167, 20);
        this.fmlBuffer[168] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 168, 20);
        this.fmlBuffer[169] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 169, 20);
        this.fmlBuffer[170] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 170, 20);
        this.fmlBuffer[171] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 171, 20);
        this.fmlBuffer[172] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 172, 20);
        this.fmlBuffer[173] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 173, 20);
        this.fmlBuffer[174] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 174, 20);
        this.fmlBuffer[175] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 175, 20);
        this.fmlBuffer[176] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 176, 20);
        this.fmlBuffer[177] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 177, 20);
        this.fmlBuffer[178] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 178, 20);
        this.fmlBuffer[179] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 179, 20);
        this.fmlBuffer[180] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 180, 20);
        this.fmlBuffer[181] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 181, 20);
        this.fmlBuffer[182] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 182, 20);
        this.fmlBuffer[183] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 183, 20);
        this.fmlBuffer[184] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 184, 20);
        this.fmlBuffer[185] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 185, 20);
        this.fmlBuffer[186] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 186, 20);
        this.fmlBuffer[187] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 187, 20);
        this.fmlBuffer[188] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 188, 20);
        this.fmlBuffer[189] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 189, 20);
        this.fmlBuffer[190] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 190, 20);
        this.fmlBuffer[191] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 191, 20);
        this.fmlBuffer[192] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 192, 20);
        this.fmlBuffer[193] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 193, 20);
        this.fmlBuffer[194] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 194, 20);
        this.fmlBuffer[195] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 195, 20);
        this.fmlBuffer[196] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 196, 20);
        this.fmlBuffer[197] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 197, 20);
        this.fmlBuffer[198] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 198, 20);
        this.fmlBuffer[199] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 199, 20);
        this.fmlBuffer[200] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 200, 20);
        this.fmlBuffer[201] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 201, 20);
        this.fmlBuffer[202] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 202, 20);
        this.fmlBuffer[203] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 203, 20);
        this.fmlBuffer[204] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 204, 20);
        this.fmlBuffer[205] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 205, 20);
        this.fmlBuffer[206] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 206, 20);
        this.fmlBuffer[207] = new FmlField("PBANPYMROWID", FmlField.TYPE_STRING, 19, null, 207, 1);
        this.fmlBuffer[208] = new FmlField("PBANPYMBAN", FmlField.TYPE_INTEGER, -1, null, 208, 1);
        this.fmlBuffer[209] = new FmlField("ENT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 209, 1);
        this.fmlBuffer[210] = new FmlField("DEPOSIT_DATE", FmlField.TYPE_STRING, 9, null, 210, 1);
        this.fmlBuffer[211] = new FmlField("ORIGINAL_AMT", FmlField.TYPE_DOUBLE, -1, null, 211, 1);
        this.fmlBuffer[212] = new FmlField("CUSTOMER_PYM_DATE", FmlField.TYPE_STRING, 9, null, 212, 1);
        this.fmlBuffer[213] = new FmlField("PACT_ROWID", FmlField.TYPE_STRING, 19, null, 213, 1);
        this.fmlBuffer[214] = new FmlField("ACTV_SEQ_NO", FmlField.TYPE_SHORT, -1, null, 214, 1);
        this.fmlBuffer[215] = new FmlField("ACTV_CODE", FmlField.TYPE_STRING, 5, null, 215, 1);
        this.fmlBuffer[216] = new FmlField("ACTV_AMT", FmlField.TYPE_DOUBLE, -1, null, 216, 1);
        this.fmlBuffer[217] = new FmlField("PAYMENT_METHOD", FmlField.TYPE_STRING, 3, null, 217, 1);
        this.fmlBuffer[218] = new FmlField("PAYMENT_SUB_METHOD", FmlField.TYPE_STRING, 3, null, 218, 1);
    }
    ...
    public Integer get_ACTV_SEQ_NO() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[214].getValue(0)));
    }
