 ...
 */
public class CsSuspCtnInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsSuspCtnInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsSuspCtnInput() throws EnvironmentException, FMLManipulationException {
        // Initialise FML buffer
        fmlBuffer = new FmlField[53];

        //// Get default values from DB
        //synchronized (this.defaultValuesPopulated) {
        //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
        //        defaultValues = getDefaultValues("csSuspCtn", 53);
        ...
        this.fmlBuffer[29] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 29, 1);
        this.fmlBuffer[30] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 30, 2);
        this.fmlBuffer[31] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 31, 2);
        this.fmlBuffer[32] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 32, 2);
        this.fmlBuffer[33] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 33, 2);
        this.fmlBuffer[34] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 34, 2);
        this.fmlBuffer[35] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 35, 2);
        this.fmlBuffer[36] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 36, 2);
        this.fmlBuffer[37] = new FmlField("P1", FmlField.TYPE_STRING, 51, null, 37, 2);
        this.fmlBuffer[38] = new FmlField("P2", FmlField.TYPE_STRING, 51, null, 38, 2);
        this.fmlBuffer[39] = new FmlField("P3", FmlField.TYPE_STRING, 51, null, 39, 2);
        this.fmlBuffer[40] = new FmlField("P4", FmlField.TYPE_STRING, 51, null, 40, 2);
        this.fmlBuffer[41] = new FmlField("P5", FmlField.TYPE_STRING, 51, null, 41, 2);
        this.fmlBuffer[42] = new FmlField("P6", FmlField.TYPE_STRING, 51, null, 42, 2);
        this.fmlBuffer[43] = new FmlField("P7", FmlField.TYPE_STRING, 51, null, 43, 2);
        this.fmlBuffer[44] = new FmlField("P8", FmlField.TYPE_STRING, 51, null, 44, 2);
        this.fmlBuffer[45] = new FmlField("P9", FmlField.TYPE_STRING, 51, null, 45, 2);
        this.fmlBuffer[46] = new FmlField("P10", FmlField.TYPE_STRING, 51, null, 46, 2);
        this.fmlBuffer[47] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 47, 2);
        this.fmlBuffer[48] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 48, 2);
        this.fmlBuffer[49] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 49, 2);
        this.fmlBuffer[50] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 50, 2);
        this.fmlBuffer[51] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 51, 2);
        this.fmlBuffer[52] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 52, 2);
    }
    ...
    public Double get_CHARGE_AMT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[49].getValue(nIndex));
    }
