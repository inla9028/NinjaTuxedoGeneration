...
public class ArGtCstBanInput extends ServiceInput {
    ...
    public ArGtCstBanInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[16] = new FmlField("CUSTID", FmlField.TYPE_INTEGER, -1, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("ROWID", FmlField.TYPE_STRING, 19, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("PBANKEYROWID", FmlField.TYPE_STRING, 19, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 22, 1);
        this.fmlBuffer[23] = new FmlField("PGTPARAMRECBAN", FmlField.TYPE_INTEGER, -1, null, 23, 1);
        this.fmlBuffer[24] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 24, 1);
        this.fmlBuffer[25] = new FmlField("LINK_TYPE_STR", FmlField.TYPE_STRING, 21, null, 25, 1);
        this.fmlBuffer[26] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 26, 1);
        this.fmlBuffer[27] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 27, 1);
    }
