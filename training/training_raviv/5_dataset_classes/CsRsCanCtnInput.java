...
public class CsRsCanCtnInput extends ServiceInput {
    ...
    public CsRsCanCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csRsCanCtn", 403);
        ...
        this.fmlBuffer[351] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 351, 20);
        this.fmlBuffer[352] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 352, 20);
        this.fmlBuffer[353] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 353, 20);
        this.fmlBuffer[354] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 354, 20);
        this.fmlBuffer[355] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 355, 20);
        this.fmlBuffer[356] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 356, 20);
        this.fmlBuffer[357] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 357, 20);
        this.fmlBuffer[358] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 358, 20);
        this.fmlBuffer[359] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 359, 20);
        this.fmlBuffer[360] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 360, 20);
        this.fmlBuffer[361] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 361, 20);
        this.fmlBuffer[362] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 362, 20);
        this.fmlBuffer[363] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 363, 20);
        this.fmlBuffer[364] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 364, 20);
        this.fmlBuffer[365] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 365, 20);
        this.fmlBuffer[366] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 366, 20);
        this.fmlBuffer[367] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 367, 20);
        this.fmlBuffer[368] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 368, 20);
        this.fmlBuffer[369] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 369, 20);
        this.fmlBuffer[370] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 370, 20);
        this.fmlBuffer[371] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 371, 20);
        this.fmlBuffer[372] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 372, 20);
        this.fmlBuffer[373] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 373, 20);
        this.fmlBuffer[374] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 374, 20);
        this.fmlBuffer[375] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 375, 20);
        this.fmlBuffer[376] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 376, 20);
        this.fmlBuffer[377] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 377, 20);
        this.fmlBuffer[378] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 378, 20);
        this.fmlBuffer[379] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 379, 20);
        this.fmlBuffer[380] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 380, 20);
        this.fmlBuffer[381] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 381, 20);
        this.fmlBuffer[382] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 382, 20);
        this.fmlBuffer[383] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 383, 20);
        this.fmlBuffer[384] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 384, 20);
        this.fmlBuffer[385] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 385, 20);
        this.fmlBuffer[386] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 386, 20);
        this.fmlBuffer[387] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 387, 20);
        this.fmlBuffer[388] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 388, 20);
        this.fmlBuffer[389] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 389, 20);
        this.fmlBuffer[390] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 390, 20);
        this.fmlBuffer[391] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 391, 20);
        this.fmlBuffer[392] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 392, 20);
        this.fmlBuffer[393] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 393, 20);
        this.fmlBuffer[394] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 394, 20);
        this.fmlBuffer[395] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 395, 20);
        this.fmlBuffer[396] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 396, 20);
        this.fmlBuffer[397] = new FmlField("PINSTLBUFROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 397, 1);
        this.fmlBuffer[398] = new FmlField("INSTALLMENT_AMT", FmlField.TYPE_DOUBLE, -1, null, 398, 12);
        this.fmlBuffer[399] = new FmlField("INSTALLMENT_DATE", FmlField.TYPE_STRING, 9, null, 399, 12);
        this.fmlBuffer[400] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 400, 1);
        this.fmlBuffer[401] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 401, 2);
        this.fmlBuffer[402] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 402, 2);
    }
    ...
    public Integer get_ADDRESS_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[355].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[358].getValue(nIndex));
    }
    ...
    public String get_ADR_STATUS(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[363].getValue(nIndex)));
    }
    ...
    public void set_ADR_STATUS(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[363].setValue(nIndex, TypeConverter.stringToByte(value));
    }
