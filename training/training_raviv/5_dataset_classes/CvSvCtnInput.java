...
public class CvSvCtnInput extends ServiceInput implements Conversable {
    ...
    public CvSvCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("cvSvCtn", 119);
        ...
        this.fmlBuffer[110] = new FmlField("INTERNAL_CIRCUIT_ID", FmlField.TYPE_STRING, 21, null, 110, 1);
        this.fmlBuffer[111] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 111, 1);
        this.fmlBuffer[112] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 112, 1);
        this.fmlBuffer[113] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 113, 1);
        this.fmlBuffer[114] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 114, 1);
        this.fmlBuffer[115] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 115, 1);
        this.fmlBuffer[116] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 116, 1);
        this.fmlBuffer[117] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 117, 1);
        this.fmlBuffer[118] = new FmlField("ACT_COMPLETE_DATE", FmlField.TYPE_STRING, 9, null, 118, 1);
    }
