...
public class CsActvCtnInput extends ServiceInput {
    ...
    public CsActvCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[52] = new FmlField("SOC_QUANTITY", FmlField.TYPE_SHORT, -1, null, 52, 50);
        ...
        this.fmlBuffer[85] = new FmlField("PAGRRECSOC_QUANTITY", FmlField.TYPE_SHORT, -1, null, 85, 1);
        ...
        this.fmlBuffer[150] = new FmlField("ACTIVITY_DATE", FmlField.TYPE_STRING, 15, null, 150, 50);
        ...
        this.fmlBuffer[296] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 296, 1);
        this.fmlBuffer[297] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 297, 20);
        this.fmlBuffer[298] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 298, 20);
        this.fmlBuffer[299] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 299, 20);
        this.fmlBuffer[300] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 300, 20);
        this.fmlBuffer[301] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 301, 20);
        this.fmlBuffer[302] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 302, 20);
        this.fmlBuffer[303] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 303, 20);
        this.fmlBuffer[304] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 304, 20);
        this.fmlBuffer[305] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 305, 20);
        this.fmlBuffer[306] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 306, 20);
        this.fmlBuffer[307] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 307, 20);
        this.fmlBuffer[308] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 308, 20);
        this.fmlBuffer[309] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 309, 20);
        this.fmlBuffer[310] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 310, 20);
        this.fmlBuffer[311] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 311, 20);
        this.fmlBuffer[312] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 312, 20);
        this.fmlBuffer[313] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 313, 20);
        this.fmlBuffer[314] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 314, 20);
        this.fmlBuffer[315] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 315, 20);
        this.fmlBuffer[316] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 316, 20);
        this.fmlBuffer[317] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 317, 20);
        this.fmlBuffer[318] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 318, 20);
        this.fmlBuffer[319] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 319, 20);
        this.fmlBuffer[320] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 320, 20);
        this.fmlBuffer[321] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 321, 20);
        this.fmlBuffer[322] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 322, 20);
        this.fmlBuffer[323] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 323, 20);
        this.fmlBuffer[324] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 324, 20);
        this.fmlBuffer[325] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 325, 20);
        this.fmlBuffer[326] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 326, 20);
        this.fmlBuffer[327] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 327, 20);
        this.fmlBuffer[328] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 328, 20);
        this.fmlBuffer[329] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 329, 20);
        this.fmlBuffer[330] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 330, 20);
        this.fmlBuffer[331] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 331, 20);
        this.fmlBuffer[332] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 332, 20);
        this.fmlBuffer[333] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 51, null, 333, 20);
        this.fmlBuffer[334] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 334, 20);
        this.fmlBuffer[335] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 335, 20);
        this.fmlBuffer[336] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 336, 20);
        this.fmlBuffer[337] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 337, 20);
        this.fmlBuffer[338] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 338, 20);
        this.fmlBuffer[339] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 339, 20);
        this.fmlBuffer[340] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 340, 20);
        this.fmlBuffer[341] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 341, 20);
        this.fmlBuffer[342] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 342, 20);
        this.fmlBuffer[343] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 343, 20);
        this.fmlBuffer[344] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 344, 20);
        this.fmlBuffer[345] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 345, 20);
        this.fmlBuffer[346] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 346, 20);
        this.fmlBuffer[347] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 347, 20);
        this.fmlBuffer[348] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 348, 20);
        this.fmlBuffer[349] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 349, 20);
        this.fmlBuffer[350] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 350, 20);
        this.fmlBuffer[351] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 351, 20);
        this.fmlBuffer[352] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 352, 20);
        this.fmlBuffer[353] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 353, 20);
        this.fmlBuffer[354] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 354, 20);
        this.fmlBuffer[355] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 355, 20);
        this.fmlBuffer[356] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 356, 20);
        this.fmlBuffer[357] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 357, 20);
        this.fmlBuffer[358] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 358, 20);
        this.fmlBuffer[359] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 359, 20);
        this.fmlBuffer[360] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 360, 20);
        this.fmlBuffer[361] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 361, 20);
        this.fmlBuffer[362] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 362, 20);
        this.fmlBuffer[363] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 363, 20);
        this.fmlBuffer[364] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 364, 20);
        this.fmlBuffer[365] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 365, 20);
        this.fmlBuffer[366] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 366, 20);
        this.fmlBuffer[367] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 367, 20);
        this.fmlBuffer[368] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 368, 20);
        this.fmlBuffer[369] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 369, 20);
        this.fmlBuffer[370] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 370, 20);
        this.fmlBuffer[371] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 371, 20);
        this.fmlBuffer[372] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 372, 20);
        this.fmlBuffer[373] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 373, 20);
        this.fmlBuffer[374] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 374, 20);
        this.fmlBuffer[375] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 375, 20);
        this.fmlBuffer[376] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 376, 20);
        this.fmlBuffer[377] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 377, 20);
        this.fmlBuffer[378] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 378, 20);
        this.fmlBuffer[379] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 379, 20);
        this.fmlBuffer[380] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 380, 20);
        this.fmlBuffer[381] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 381, 20);
        this.fmlBuffer[382] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 382, 20);
        this.fmlBuffer[383] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 383, 20);
        this.fmlBuffer[384] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 384, 20);
        this.fmlBuffer[385] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 385, 20);
        this.fmlBuffer[386] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 386, 20);
        this.fmlBuffer[387] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 387, 20);
        this.fmlBuffer[388] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 388, 20);
        this.fmlBuffer[389] = new FmlField("PINSTLBUFROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 389, 1);
        this.fmlBuffer[390] = new FmlField("INSTALLMENT_AMT", FmlField.TYPE_DOUBLE, -1, null, 390, 12);
        this.fmlBuffer[391] = new FmlField("INSTALLMENT_DATE", FmlField.TYPE_STRING, 9, null, 391, 12);
        ...
        this.fmlBuffer[395] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 395, 1);
        this.fmlBuffer[396] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 396, 1);
        this.fmlBuffer[397] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 397, 1);
        this.fmlBuffer[398] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 398, 1);
        this.fmlBuffer[399] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 399, 1);
        this.fmlBuffer[400] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 400, 1);
        this.fmlBuffer[401] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 401, 1);
        this.fmlBuffer[402] = new FmlField("ACT_COMPLETE_DATE", FmlField.TYPE_STRING, 9, null, 402, 1);
        this.fmlBuffer[403] = new FmlField("PARINPBAN", FmlField.TYPE_INTEGER, -1, null, 403, 1);
        this.fmlBuffer[404] = new FmlField("PARTITION_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 404, 1);
        this.fmlBuffer[405] = new FmlField("PARINPSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 405, 1);
        this.fmlBuffer[406] = new FmlField("PARINPSUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 406, 1);
        this.fmlBuffer[407] = new FmlField("REQUIREMENT_DATE", FmlField.TYPE_STRING, 9, null, 407, 1);
        this.fmlBuffer[408] = new FmlField("ACTIVATION_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 408, 1);
        this.fmlBuffer[409] = new FmlField("PREPAYMENT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 409, 1);
        this.fmlBuffer[410] = new FmlField("PREP_ACTV_AMT", FmlField.TYPE_DOUBLE, -1, null, 410, 1);
        this.fmlBuffer[411] = new FmlField("RC_ONLY_IND", FmlField.TYPE_BYTE, -1, null, 411, 1);
        this.fmlBuffer[412] = new FmlField("PARINPDEALER_CODE", FmlField.TYPE_STRING, 6, null, 412, 1);
        this.fmlBuffer[413] = new FmlField("ACTV_EXMP_IND", FmlField.TYPE_BYTE, -1, null, 413, 1);
        this.fmlBuffer[414] = new FmlField("PREP_EXMP_IND", FmlField.TYPE_BYTE, -1, null, 414, 1);
        this.fmlBuffer[415] = new FmlField("SOURCE_APPL_CODE", FmlField.TYPE_BYTE, -1, null, 415, 1);
        this.fmlBuffer[416] = new FmlField("PARINPFEATURE_CODE", FmlField.TYPE_STRING, 7, null, 416, 1);
        this.fmlBuffer[417] = new FmlField("PARINPSOC", FmlField.TYPE_STRING, 10, null, 417, 1);
        this.fmlBuffer[418] = new FmlField("SOC_DATE", FmlField.TYPE_STRING, 9, null, 418, 1);
        this.fmlBuffer[419] = new FmlField("CAS_PT_REQ", FmlField.TYPE_BYTE, -1, null, 419, 1);
    }
    ...
    public void set_SOC_QUANTITY(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[52].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_FOREIGN_SEQ_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[307].getValue(nIndex));
    }
    ...
    public Integer get_NAME_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[318].getValue(nIndex));
    }
    ...
    public Integer get_NAMERECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[324].getValue(nIndex)));
    }
    ...
    public void set_NAMERECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[324].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_KOB(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[334].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[350].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[373].getValue(nIndex)));
    }
    ...
    public void set_ADDRESSRECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[373].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public String get_DELIVERY_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[401].getValue(0)));
    }
    ...
    public void set_DELIVERY_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[401].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_ACT_COMPLETE_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[402].getValue(0));
    }
    ...
    public Integer get_PARINPBAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[403].getValue(0));
    }
    ...
    public Double get_ACTIVATION_AMOUNT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[408].getValue(0));
    }
    ...
    public Double get_PREPAYMENT_AMOUNT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[409].getValue(0));
    }
    ...
    public String get_RC_ONLY_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[411].getValue(0)));
    }
    ...
    public void set_RC_ONLY_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[411].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_PREP_EXMP_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[414].getValue(0)));
    }
    ...
    public void set_PREP_EXMP_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[414].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_CAS_PT_REQ() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[419].getValue(0)));
    }
    ...
    public void set_CAS_PT_REQ(String value) throws FMLManipulationException {
        this.fmlBuffer[419].setValue(0, TypeConverter.stringToByte(value));
    }
}