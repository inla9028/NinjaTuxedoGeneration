 ...
 */
public class ClUHldAutoOutput extends ServiceOutput {

    /**
     * Creates a new instance of ClUHldAutoOutput.
     *
     * @throws FMLManipulationException
     */
    public ClUHldAutoOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public ClUHldAutoOutput() {
    }

    /**
     * Creates a new instance of ClUHldAutoOutput.
     *
     * @param ds Output dataset from ClUHldAuto service.
     * @throws FMLManipulationException
     */
    public ClUHldAutoOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[16] = new FmlField("COL_WAIVER_DATE", FmlField.TYPE_STRING, 9, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("HOLD_AUTOMATIC_TREATMENT", FmlField.TYPE_BYTE, -1, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("COL_TREATMENT_STATUS", FmlField.TYPE_BYTE, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("HOLD_COLL_REASON", FmlField.TYPE_STRING, 7, null, 19, 1);
    }
