 ...
 */
public class BlBiBuildInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of BlBiBuildInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public BlBiBuildInput() throws EnvironmentException, FMLManipulationException {
        // Initialise FML buffer
        fmlBuffer = new FmlField[23];

        //// Get default values from DB
        //synchronized (this.defaultValuesPopulated) {
        //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
        //        defaultValues = getDefaultValues("blBiBuild", 23);
        ...
        this.fmlBuffer[17] = new FmlField("BILL_SEQ_NO", FmlField.TYPE_SHORT, -1, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("BILL_RUN_YEAR", FmlField.TYPE_SHORT, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("BILL_RUN_MONTH", FmlField.TYPE_SHORT, -1, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("BILL_CYCLE_CODE", FmlField.TYPE_SHORT, -1, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("FORMAT_CODE", FmlField.TYPE_STRING, 3, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("DOCUMENT_ID", FmlField.TYPE_STRING, 14, null, 22, 1);
    }
    ...
    public void set_BILL_SEQ_NO(Integer value) throws FMLManipulationException {
        this.fmlBuffer[17].setValue(0, TypeConverter.integerToShort(value));
    }

    /**
     * Retrieves the value of the 'BILL_RUN_YEAR' field in the FML buffer.
     *
     * @return Value of 'BILL_RUN_YEAR' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_BILL_RUN_YEAR() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[18].getValue(0)));
    }

    /**
     * Sets the value of the 'BILL_RUN_YEAR' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_BILL_RUN_YEAR(Integer value) throws FMLManipulationException {
        this.fmlBuffer[18].setValue(0, TypeConverter.integerToShort(value));
    }

    /**
     * Retrieves the value of the 'BILL_RUN_MONTH' field in the FML buffer.
     *
     * @return Value of 'BILL_RUN_MONTH' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_BILL_RUN_MONTH() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[19].getValue(0)));
    }

    /**
     * Sets the value of the 'BILL_RUN_MONTH' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_BILL_RUN_MONTH(Integer value) throws FMLManipulationException {
        this.fmlBuffer[19].setValue(0, TypeConverter.integerToShort(value));
    }

    /**
     * Retrieves the value of the 'BILL_CYCLE_CODE' field in the FML buffer.
     *
     * @return Value of 'BILL_CYCLE_CODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_BILL_CYCLE_CODE() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[20].getValue(0)));
    }

    /**
     * Sets the value of the 'BILL_CYCLE_CODE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_BILL_CYCLE_CODE(Integer value) throws FMLManipulationException {
        this.fmlBuffer[20].setValue(0, TypeConverter.integerToShort(value));
    }

    /**
     * Retrieves the value of the 'FORMAT_CODE' field in the FML buffer.
     *
     * @return Value of 'FORMAT_CODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_FORMAT_CODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[21].getValue(0));
    }

    /**
     * Sets the value of the 'FORMAT_CODE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 3.
     * @throws FMLManipulationException
     */
    public void set_FORMAT_CODE(String value) throws FMLManipulationException {
