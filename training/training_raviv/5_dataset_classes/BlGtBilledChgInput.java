 ...
 */
public class BlGtBilledChgInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of BlGtBilledChgInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public BlGtBilledChgInput() throws EnvironmentException, FMLManipulationException {
        // Initialise FML buffer
        fmlBuffer = new FmlField[26];

        //// Get default values from DB
        //synchronized (this.defaultValuesPopulated) {
        //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
        //        defaultValues = getDefaultValues("blGtBilledChg", 26);
        ...
        this.fmlBuffer[18] = new FmlField("BILL_SEQ_NO", FmlField.TYPE_SHORT, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("FTR_REVENUE_CODE", FmlField.TYPE_STRING, 4, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("PBILLEDCHGKEYRUN_DATE", FmlField.TYPE_STRING, 9, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("SUB_MKT_CD", FmlField.TYPE_STRING, 4, null, 22, 1);
        this.fmlBuffer[23] = new FmlField("PAGE", FmlField.TYPE_INTEGER, -1, null, 23, 1);
        this.fmlBuffer[24] = new FmlField("BUFFERSIZE", FmlField.TYPE_INTEGER, -1, null, 24, 1);
        this.fmlBuffer[25] = new FmlField("BAN_LEVEL_IND", FmlField.TYPE_BYTE, -1, null, 25, 1);
    }
    ...
    /**
     * Retrieves the value of the 'PBILLEDCHGKEYRUN_DATE' field in the FML buffer.
     *
     * @return Value of 'PBILLEDCHGKEYRUN_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PBILLEDCHGKEYRUN_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[21].getValue(0));
    }

    /**
     * Sets the value of the 'PBILLEDCHGKEYRUN_DATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @throws FMLManipulationException
     */
    public void set_PBILLEDCHGKEYRUN_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[21].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'SUB_MKT_CD' field in the FML buffer.
     *
     * @return Value of 'SUB_MKT_CD' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_SUB_MKT_CD() throws FMLManipulationException {
        return ((String) this.fmlBuffer[22].getValue(0));
    }

    /**
     * Sets the value of the 'SUB_MKT_CD' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_SUB_MKT_CD(String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'BUFFERSIZE' field in the FML buffer.
     *
     * @return Value of 'BUFFERSIZE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_BUFFERSIZE() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[24].getValue(0));
    }

    /**
     * Sets the value of the 'BUFFERSIZE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_BUFFERSIZE(Integer value) throws FMLManipulationException {
        this.fmlBuffer[24].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'BAN_LEVEL_IND' field in the FML buffer.
     *
     * @return Value of 'BAN_LEVEL_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_BAN_LEVEL_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[25].getValue(0)));
    }

    /**
     * Sets the value of the 'BAN_LEVEL_IND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_BAN_LEVEL_IND(String value) throws FMLManipulationException {
