...
public class CvSvNmAdrOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[94];
        ...
        this.fmlBuffer[48] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 48, 20);
        this.fmlBuffer[49] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 49, 20);
        this.fmlBuffer[50] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 50, 20);
        this.fmlBuffer[51] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 51, 20);
        this.fmlBuffer[52] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 52, 20);
        this.fmlBuffer[53] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 53, 20);
        this.fmlBuffer[54] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 54, 20);
        this.fmlBuffer[55] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 55, 20);
        this.fmlBuffer[56] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 56, 20);
        this.fmlBuffer[57] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 57, 20);
        this.fmlBuffer[58] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 58, 20);
        this.fmlBuffer[59] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 59, 20);
        this.fmlBuffer[60] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 60, 20);
        this.fmlBuffer[61] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 61, 20);
        this.fmlBuffer[62] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 62, 20);
        this.fmlBuffer[63] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 63, 20);
        this.fmlBuffer[64] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 64, 20);
        this.fmlBuffer[65] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 65, 20);
        this.fmlBuffer[66] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 66, 20);
        this.fmlBuffer[67] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 67, 20);
        this.fmlBuffer[68] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 68, 20);
        this.fmlBuffer[69] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 69, 20);
        this.fmlBuffer[70] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 70, 20);
        this.fmlBuffer[71] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 71, 20);
        this.fmlBuffer[72] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 72, 20);
        this.fmlBuffer[73] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 73, 20);
        this.fmlBuffer[74] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 74, 20);
        this.fmlBuffer[75] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 75, 20);
        this.fmlBuffer[76] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 76, 20);
        this.fmlBuffer[77] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 77, 20);
        this.fmlBuffer[78] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 78, 20);
        this.fmlBuffer[79] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 79, 20);
        this.fmlBuffer[80] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 80, 20);
        this.fmlBuffer[81] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 81, 20);
        this.fmlBuffer[82] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 82, 20);
        this.fmlBuffer[83] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 83, 20);
        this.fmlBuffer[84] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 84, 20);
        this.fmlBuffer[85] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 85, 20);
        this.fmlBuffer[86] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 86, 20);
        this.fmlBuffer[87] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 87, 20);
        this.fmlBuffer[88] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 88, 20);
        this.fmlBuffer[89] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 89, 20);
        this.fmlBuffer[90] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 90, 20);
        this.fmlBuffer[91] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 91, 20);
        this.fmlBuffer[92] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 92, 20);
        this.fmlBuffer[93] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 93, 20);
    }
