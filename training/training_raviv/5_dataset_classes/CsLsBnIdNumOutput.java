 ...
 */
public class CsLsBnIdNumOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsLsBnIdNumOutput.
     *
     * @throws FMLManipulationException
     */
    public CsLsBnIdNumOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsLsBnIdNumOutput() {
    }

    /**
     * Creates a new instance of CsLsBnIdNumOutput.
     *
     * @param ds Output dataset from CsLsBnIdNum service.
     * @throws FMLManipulationException
     */
    public CsLsBnIdNumOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[60];
        ...
        this.fmlBuffer[19] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 19, 1000);
        this.fmlBuffer[20] = new FmlField("ACCOUNT_TYPE", FmlField.TYPE_BYTE, -1, null, 20, 1000);
        this.fmlBuffer[21] = new FmlField("BAN_STATUS", FmlField.TYPE_BYTE, -1, null, 21, 1000);
        this.fmlBuffer[22] = new FmlField("STATUS_LAST_DATE", FmlField.TYPE_STRING, 9, null, 22, 1000);
        this.fmlBuffer[23] = new FmlField("BL_HIER_BAN_IND", FmlField.TYPE_BYTE, -1, null, 23, 1000);
        this.fmlBuffer[24] = new FmlField("VIP_IND", FmlField.TYPE_BYTE, -1, null, 24, 1000);
        this.fmlBuffer[25] = new FmlField("ACCOUNT_SUB_TYPE", FmlField.TYPE_STRING, 3, null, 25, 1000);
        this.fmlBuffer[26] = new FmlField("BILL_CYCLE", FmlField.TYPE_SHORT, -1, null, 26, 1000);
        this.fmlBuffer[27] = new FmlField("START_SERVICE_DATE", FmlField.TYPE_STRING, 9, null, 27, 1000);
        this.fmlBuffer[28] = new FmlField("AR_BALANCE", FmlField.TYPE_DOUBLE, -1, null, 28, 1000);
        this.fmlBuffer[29] = new FmlField("BL_BILL_PROD_IND", FmlField.TYPE_BYTE, -1, null, 29, 1000);
        this.fmlBuffer[30] = new FmlField("CURR_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 30, 1000);
        ...
        this.fmlBuffer[33] = new FmlField("PCSSUBARRMOREROWS", FmlField.TYPE_SHORT, -1, null, 33, 1);
        this.fmlBuffer[34] = new FmlField("PCSSUBARRROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 34, 1);
        this.fmlBuffer[35] = new FmlField("ATTRSUBROWID", FmlField.TYPE_STRING, 19, null, 35, 1000);
        this.fmlBuffer[36] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 36, 1000);
        this.fmlBuffer[37] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 37, 1000);
        this.fmlBuffer[38] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, null, 38, 1000);
        this.fmlBuffer[39] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 39, 1000);
        this.fmlBuffer[40] = new FmlField("PCSBANADDRMOREROWS", FmlField.TYPE_SHORT, -1, null, 40, 1);
        this.fmlBuffer[41] = new FmlField("PCSBANADDRROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 41, 1);
        this.fmlBuffer[42] = new FmlField("O_ATTRADDRROWID", FmlField.TYPE_STRING, 19, null, 42, 1000);
        this.fmlBuffer[43] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 43, 1000);
        this.fmlBuffer[44] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 44, 1000);
        this.fmlBuffer[45] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 45, 1000);
        this.fmlBuffer[46] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 46, 1000);
        this.fmlBuffer[47] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 47, 1000);
        this.fmlBuffer[48] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 48, 1000);
        this.fmlBuffer[49] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 49, 1000);
        this.fmlBuffer[50] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 50, 1000);
        this.fmlBuffer[51] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 51, 1000);
        this.fmlBuffer[52] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 52, 1000);
        this.fmlBuffer[53] = new FmlField("PCSCOMPREGROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 53, 1);
        this.fmlBuffer[54] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 51, null, 54, 1000);
        this.fmlBuffer[55] = new FmlField("DCI_ERROR_CODE", FmlField.TYPE_INTEGER, -1, null, 55, 1);
        this.fmlBuffer[56] = new FmlField("DCI_ERROR_TYPE", FmlField.TYPE_SHORT, -1, null, 56, 1);
        this.fmlBuffer[57] = new FmlField("DCI_ERROR_TEXT", FmlField.TYPE_STRING, 81, null, 57, 1);
        this.fmlBuffer[58] = new FmlField("DCI_ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 58, 1);
        this.fmlBuffer[59] = new FmlField("DCI_MORE_ROWS", FmlField.TYPE_SHORT, -1, null, 59, 1);
    }
    ...
    /**
     * Retrieves the value of the 'PCSSUBARRMOREROWS' field in the FML buffer.
     *
     * @return Value of 'PCSSUBARRMOREROWS' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PCSSUBARRMOREROWS() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[33].getValue(0)));
    }

    /**
     * Retrieves the value of the 'PCSSUBARRROWCOUNT' field in the FML buffer.
     *
     * @return Value of 'PCSSUBARRROWCOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PCSSUBARRROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[34].getValue(0));
    }

    /**
     * Retrieves the value of the 'ATTRSUBROWID' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 1000).
     * @return Value of 'ATTRSUBROWID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_ATTRSUBROWID(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[35].getValue(nIndex));
    }

    /**
     * Retrieves number of values defined for 'ATTRSUBROWID' field in the FML buffer.
     *
     * @return Number of values defined for 'ATTRSUBROWID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_ATTRSUBROWID_size() throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'PCSBANADDRMOREROWS' field in the FML buffer.
     *
     * @return Value of 'PCSBANADDRMOREROWS' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PCSBANADDRMOREROWS() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[40].getValue(0)));
    }

    /**
     * Retrieves the value of the 'PCSBANADDRROWCOUNT' field in the FML buffer.
     *
     * @return Value of 'PCSBANADDRROWCOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PCSBANADDRROWCOUNT() throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'PCSCOMPREGROWCOUNT' field in the FML buffer.
     *
     * @return Value of 'PCSCOMPREGROWCOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PCSCOMPREGROWCOUNT() throws FMLManipulationException {
