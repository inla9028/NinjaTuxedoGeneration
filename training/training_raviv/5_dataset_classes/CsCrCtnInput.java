...
public class CsCrCtnInput extends ServiceInput {
    ...
    public CsCrCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[389] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 389, 1);
        this.fmlBuffer[390] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 390, 1);
        this.fmlBuffer[391] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 391, 1);
        this.fmlBuffer[392] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 392, 1);
        this.fmlBuffer[393] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 393, 1);
        this.fmlBuffer[394] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 394, 1);
        this.fmlBuffer[395] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 395, 1);
        this.fmlBuffer[396] = new FmlField("ACT_COMPLETE_DATE", FmlField.TYPE_STRING, 9, null, 396, 1);
        this.fmlBuffer[397] = new FmlField("PNPINFOBUFFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 397, 1);
        this.fmlBuffer[398] = new FmlField("NPNUMINFORECROWID", FmlField.TYPE_STRING, 19, null, 398, 500);
        this.fmlBuffer[399] = new FmlField("PORT_NUMBER", FmlField.TYPE_STRING, 21, null, 399, 500);
        this.fmlBuffer[400] = new FmlField("NPNUMINFORECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 400, 500);
        this.fmlBuffer[401] = new FmlField("NPNUMINFORECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 401, 500);
        this.fmlBuffer[402] = new FmlField("NPNUMINFORECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 402, 500);
        this.fmlBuffer[403] = new FmlField("NPNUMINFORECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 403, 500);
        this.fmlBuffer[404] = new FmlField("NPNUMINFORECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 404, 500);
        this.fmlBuffer[405] = new FmlField("NPNUMINFORECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 405, 500);
        this.fmlBuffer[406] = new FmlField("NPNUMINFORECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 406, 500);
        this.fmlBuffer[407] = new FmlField("NPNUMINFORECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 407, 500);
        this.fmlBuffer[408] = new FmlField("INT_ORDER_ID", FmlField.TYPE_DOUBLE, -1, null, 408, 500);
        this.fmlBuffer[409] = new FmlField("ORG_CUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 409, 500);
        this.fmlBuffer[410] = new FmlField("PORT_IND", FmlField.TYPE_BYTE, -1, null, 410, 500);
        this.fmlBuffer[411] = new FmlField("NUMBER_TYPE", FmlField.TYPE_BYTE, -1, null, 411, 500);
        this.fmlBuffer[412] = new FmlField("PORT_REQUEST_DATE", FmlField.TYPE_STRING, 15, null, 412, 500);
        this.fmlBuffer[413] = new FmlField("ORG_OPERATOR", FmlField.TYPE_STRING, 6, null, 413, 500);
        this.fmlBuffer[414] = new FmlField("NPNUMINFORECSUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 414, 500);
        this.fmlBuffer[415] = new FmlField("LAST_INT_ORD_ID", FmlField.TYPE_DOUBLE, -1, null, 415, 500);
        this.fmlBuffer[416] = new FmlField("FUNCTION_PORT_IND", FmlField.TYPE_BYTE, -1, null, 416, 500);
        this.fmlBuffer[417] = new FmlField("PASSIVE_IND", FmlField.TYPE_BYTE, -1, null, 417, 500);
        this.fmlBuffer[418] = new FmlField("AUTO_CONFIRM", FmlField.TYPE_BYTE, -1, null, 418, 500);
        this.fmlBuffer[419] = new FmlField("TEMPORARY_MSISDN", FmlField.TYPE_STRING, 21, null, 419, 500);
        this.fmlBuffer[420] = new FmlField("HANDLE_MODE", FmlField.TYPE_BYTE, -1, null, 420, 500);
        this.fmlBuffer[421] = new FmlField("SEND_IND", FmlField.TYPE_BYTE, -1, null, 421, 500);
        this.fmlBuffer[422] = new FmlField("ORDID_STR", FmlField.TYPE_STRING, 21, null, 422, 500);
        this.fmlBuffer[423] = new FmlField("LAST_ORDID_STR", FmlField.TYPE_STRING, 21, null, 423, 500);
        this.fmlBuffer[424] = new FmlField("ICC", FmlField.TYPE_STRING, 61, null, 424, 500);
        this.fmlBuffer[425] = new FmlField("CUSTOMER_NAME", FmlField.TYPE_STRING, 255, null, 425, 500);
        this.fmlBuffer[426] = new FmlField("NPINFOBUFFCUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 426, 500);
        this.fmlBuffer[427] = new FmlField("SERVICE_PROVIDER", FmlField.TYPE_STRING, 6, null, 427, 500);
        this.fmlBuffer[428] = new FmlField("MUNICIPALITY", FmlField.TYPE_STRING, 4, null, 428, 1);
        this.fmlBuffer[429] = new FmlField("RECIP_SERV_OPER", FmlField.TYPE_STRING, 6, null, 429, 1);
        this.fmlBuffer[430] = new FmlField("POINT_OF_CONNECTION", FmlField.TYPE_STRING, 61, null, 430, 1);
        this.fmlBuffer[431] = new FmlField("CSNPSPC", FmlField.TYPE_STRING, 7, null, 431, 1);
        this.fmlBuffer[432] = new FmlField("EIDNODSIGN", FmlField.TYPE_STRING, 7, null, 432, 1);
        this.fmlBuffer[433] = new FmlField("NPEIDNTYP", FmlField.TYPE_STRING, 5, null, 433, 1);
        this.fmlBuffer[434] = new FmlField("EIDNTYPNUMB", FmlField.TYPE_STRING, 5, null, 434, 1);
        this.fmlBuffer[435] = new FmlField("NPNEIDNODSIGN", FmlField.TYPE_STRING, 7, null, 435, 1);
        this.fmlBuffer[436] = new FmlField("NEIDNTYP", FmlField.TYPE_STRING, 5, null, 436, 1);
        this.fmlBuffer[437] = new FmlField("NEIDNTYPNUMB", FmlField.TYPE_STRING, 5, null, 437, 1);
        this.fmlBuffer[438] = new FmlField("CURR_SERV_OPER", FmlField.TYPE_STRING, 6, null, 438, 1);
    }
    ...
    public Integer get_PNPINFOBUFFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[397].getValue(0));
    }
    ...
    public Integer get_NPNUMINFORECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[406].getValue(nIndex)));
    }
    ...
    public void set_NPNUMINFORECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[406].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_NPNUMINFORECSUBSCRIBER_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[414].getValue(nIndex));
    }
    ...
    public Double get_LAST_INT_ORD_ID(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[415].getValue(nIndex));
    }
    ...
    public String get_MUNICIPALITY() throws FMLManipulationException {
        return ((String) this.fmlBuffer[428].getValue(0));
    }
    ...
    public void set_MUNICIPALITY(String value) throws FMLManipulationException {
        this.fmlBuffer[428].setValue(0, value);
    }
    ...
    public String get_RECIP_SERV_OPER() throws FMLManipulationException {
        return ((String) this.fmlBuffer[429].getValue(0));
    }
    ...
    public void set_RECIP_SERV_OPER(String value) throws FMLManipulationException {
        this.fmlBuffer[429].setValue(0, value);
    }
