 ...
 */
public class CsGetCtnNmInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsGetCtnNmInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsGetCtnNmInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csGetCtnNm", 28);
        ...
        this.fmlBuffer[16] = new FmlField("NL", FmlField.TYPE_STRING, 4, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("NGP", FmlField.TYPE_STRING, 4, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("CTN_PATTERN", FmlField.TYPE_STRING, 21, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("FROM_CTN", FmlField.TYPE_STRING, 21, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("CTN_STATUS", FmlField.TYPE_STRING, 3, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("RMS_LOCATION", FmlField.TYPE_STRING, 5, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("HLR", FmlField.TYPE_STRING, 5, null, 22, 1);
        this.fmlBuffer[23] = new FmlField("NUMBER_LENGTH", FmlField.TYPE_INTEGER, -1, NinjaConfigurationReferenceTable.getDefaultNumberLength(), 23, 1);
        this.fmlBuffer[24] = new FmlField("PRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 24, 1);
        this.fmlBuffer[25] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, null, 25, 1);
        this.fmlBuffer[26] = new FmlField("TO_CTN", FmlField.TYPE_STRING, 21, null, 26, 1);
        this.fmlBuffer[27] = new FmlField("PAGESIZE", FmlField.TYPE_INTEGER, -1, null, 27, 1);
    }
     ...
     * @throws FMLManipulationException
     */
    public void set_NL(String value) throws FMLManipulationException {
    ...
    /**
     * Sets the value of the 'CTN_STATUS' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 3.
     * @throws FMLManipulationException
     */
    public void set_CTN_STATUS(String value) throws FMLManipulationException {
        this.fmlBuffer[20].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'RMS_LOCATION' field in the FML buffer.
     *
     * @return Value of 'RMS_LOCATION' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_RMS_LOCATION() throws FMLManipulationException {
        return ((String) this.fmlBuffer[21].getValue(0));
    }

    /**
     * Sets the value of the 'RMS_LOCATION' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 5.
     * @throws FMLManipulationException
     */
    public void set_RMS_LOCATION(String value) throws FMLManipulationException {
        this.fmlBuffer[21].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'HLR' field in the FML buffer.
     *
     * @return Value of 'HLR' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_HLR() throws FMLManipulationException {
        return ((String) this.fmlBuffer[22].getValue(0));
    }

    /**
     * Sets the value of the 'HLR' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 5.
     * @throws FMLManipulationException
     */
    public void set_HLR(String value) throws FMLManipulationException {
        this.fmlBuffer[22].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'NUMBER_LENGTH' field in the FML buffer.
     *
     * @return Value of 'NUMBER_LENGTH' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_NUMBER_LENGTH() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[23].getValue(0));
    }

    /**
     * Sets the value of the 'NUMBER_LENGTH' field in the FML buffer.
     *
     * @param value Default value: :NinjaConfigurationReferenceTable.getDefaultNumberLength().
     * @throws FMLManipulationException
     */
    public void set_NUMBER_LENGTH(Integer value) throws FMLManipulationException {
