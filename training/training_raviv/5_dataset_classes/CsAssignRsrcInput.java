 ...
 */
public class CsAssignRsrcInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsAssignRsrcInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsAssignRsrcInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csAssignRsrc", 22);
        ...
        this.fmlBuffer[16] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("RESOURCE_NAME", FmlField.TYPE_STRING, 101, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("MANUAL_IND", FmlField.TYPE_BYTE, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("RESOURCE_NUMBER", FmlField.TYPE_STRING, 51, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("OLD_RESOURCE_NUMBER", FmlField.TYPE_STRING, 51, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("REUSE_IND", FmlField.TYPE_BYTE, -1, null, 21, 1);
    }
    ...
    /**
     * Retrieves the value of the 'RESOURCE_NAME' field in the FML buffer.
     *
     * @return Value of 'RESOURCE_NAME' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_RESOURCE_NAME() throws FMLManipulationException {
        return ((String) this.fmlBuffer[17].getValue(0));
    }

    /**
     * Sets the value of the 'RESOURCE_NAME' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 101.
     * @throws FMLManipulationException
     */
    public void set_RESOURCE_NAME(String value) throws FMLManipulationException {
        this.fmlBuffer[17].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'MANUAL_IND' field in the FML buffer.
     *
     * @return Value of 'MANUAL_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_MANUAL_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[18].getValue(0)));
    }

    /**
     * Sets the value of the 'MANUAL_IND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_MANUAL_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[18].setValue(0, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves the value of the 'RESOURCE_NUMBER' field in the FML buffer.
     *
     * @return Value of 'RESOURCE_NUMBER' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_RESOURCE_NUMBER() throws FMLManipulationException {
        return ((String) this.fmlBuffer[19].getValue(0));
    }

    /**
     * Sets the value of the 'RESOURCE_NUMBER' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 51.
     * @throws FMLManipulationException
     */
    public void set_RESOURCE_NUMBER(String value) throws FMLManipulationException {
        this.fmlBuffer[19].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'OLD_RESOURCE_NUMBER' field in the FML buffer.
     *
     * @return Value of 'OLD_RESOURCE_NUMBER' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_OLD_RESOURCE_NUMBER() throws FMLManipulationException {
        return ((String) this.fmlBuffer[20].getValue(0));
    }

    /**
     * Sets the value of the 'OLD_RESOURCE_NUMBER' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 51.
     * @throws FMLManipulationException
     */
    public void set_OLD_RESOURCE_NUMBER(String value) throws FMLManipulationException {
        this.fmlBuffer[20].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'REUSE_IND' field in the FML buffer.
     *
     * @return Value of 'REUSE_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_REUSE_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[21].getValue(0)));
    }

    /**
     * Sets the value of the 'REUSE_IND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_REUSE_IND(String value) throws FMLManipulationException {
