...
public class CvSvCtnAgrInput extends ServiceInput implements Conversable {
    ...
    public CvSvCtnAgrInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[49] = new FmlField("SOC_QUANTITY", FmlField.TYPE_SHORT, -1, null, 49, 50);
        this.fmlBuffer[50] = new FmlField("BILL_TEXT", FmlField.TYPE_STRING, 41, null, 50, 50);
        this.fmlBuffer[51] = new FmlField("FULL_AMT", FmlField.TYPE_DOUBLE, -1, null, 51, 50);
        this.fmlBuffer[52] = new FmlField("FIRST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 52, 50);
        this.fmlBuffer[53] = new FmlField("OTHER_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 53, 50);
        this.fmlBuffer[54] = new FmlField("LAST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 54, 50);
        this.fmlBuffer[55] = new FmlField("NO_OF_INSTALLMENTS", FmlField.TYPE_SHORT, -1, null, 55, 50);
        this.fmlBuffer[56] = new FmlField("PSOCFTRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 56, 1);
        this.fmlBuffer[57] = new FmlField("PSOCFTRBUFROWID", FmlField.TYPE_STRING, 19, null, 57, 500);
        this.fmlBuffer[58] = new FmlField("PSOCFTRBUFSOC", FmlField.TYPE_STRING, 10, null, 58, 500);
        this.fmlBuffer[59] = new FmlField("PSOCFTRBUFSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 59, 500);
        this.fmlBuffer[60] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 60, 500);
        this.fmlBuffer[61] = new FmlField("MPS_FTR_CODE", FmlField.TYPE_STRING, 7, null, 61, 500);
        this.fmlBuffer[62] = new FmlField("FTR_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 62, 500);
        this.fmlBuffer[63] = new FmlField("FTR_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 63, 500);
        this.fmlBuffer[64] = new FmlField("FTR_EFF_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 64, 500);
        this.fmlBuffer[65] = new FmlField("FTR_EXP_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 65, 500);
        this.fmlBuffer[66] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 66, 500);
        this.fmlBuffer[67] = new FmlField("FTR_MODE", FmlField.TYPE_BYTE, -1, null, 67, 500);
        this.fmlBuffer[68] = new FmlField("PSOCFTRBUFSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 68, 500);
        this.fmlBuffer[69] = new FmlField("FTR_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 69, 500);
        this.fmlBuffer[70] = new FmlField("FTR_ADD_PARAM", FmlField.TYPE_STRING, 301, null, 70, 500);
        this.fmlBuffer[71] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, null, 71, 500);
        this.fmlBuffer[72] = new FmlField("PSOCFTRBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 72, 500);
        this.fmlBuffer[73] = new FmlField("PSOCFTRBUFCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 73, 500);
        this.fmlBuffer[74] = new FmlField("FTR_SPECIAL_TELNO", FmlField.TYPE_STRING, 21, null, 74, 500);
        this.fmlBuffer[75] = new FmlField("SWITCH_ACT_NEEDED", FmlField.TYPE_BYTE, -1, null, 75, 500);
        this.fmlBuffer[76] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, null, 76, 500);
        this.fmlBuffer[77] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, null, 77, 500);
        this.fmlBuffer[78] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 78, 500);
        this.fmlBuffer[79] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, null, 79, 500);
        this.fmlBuffer[80] = new FmlField("MANUAL_RC_RATE", FmlField.TYPE_DOUBLE, -1, null, 80, 500);
        this.fmlBuffer[81] = new FmlField("MANUAL_RC_EXP_DATE", FmlField.TYPE_STRING, 9, null, 81, 500);
        this.fmlBuffer[82] = new FmlField("MANUAL_RC_EFF_DATE", FmlField.TYPE_STRING, 9, null, 82, 500);
        this.fmlBuffer[83] = new FmlField("PCSFRNDFMLROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 83, 1);
        this.fmlBuffer[84] = new FmlField("ACTIONIND", FmlField.TYPE_BYTE, -1, null, 84, 10000);
        this.fmlBuffer[85] = new FmlField("PCSFANDFRECROWID", FmlField.TYPE_STRING, 19, null, 85, 10000);
        this.fmlBuffer[86] = new FmlField("PCSFANDFRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 86, 10000);
        this.fmlBuffer[87] = new FmlField("PCSFANDFRECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 87, 10000);
        this.fmlBuffer[88] = new FmlField("PERSONAL_TEL", FmlField.TYPE_STRING, 21, null, 88, 10000);
        this.fmlBuffer[89] = new FmlField("PERSONAL_TEL_TO", FmlField.TYPE_STRING, 21, null, 89, 10000);
        this.fmlBuffer[90] = new FmlField("FF_SOC", FmlField.TYPE_STRING, 10, null, 90, 10000);
        this.fmlBuffer[91] = new FmlField("PLAN_CODE", FmlField.TYPE_STRING, 10, null, 91, 10000);
        this.fmlBuffer[92] = new FmlField("DISCOUNT_TYPE", FmlField.TYPE_BYTE, -1, null, 92, 10000);
        this.fmlBuffer[93] = new FmlField("START_HOUR", FmlField.TYPE_STRING, 7, null, 93, 10000);
        this.fmlBuffer[94] = new FmlField("DURATION", FmlField.TYPE_DOUBLE, -1, null, 94, 10000);
        this.fmlBuffer[95] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 95, 1);
        this.fmlBuffer[96] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 96, 2);
        this.fmlBuffer[97] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 97, 2);
        this.fmlBuffer[98] = new FmlField("PNPINFOBUFFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 98, 1);
        this.fmlBuffer[99] = new FmlField("NPNUMINFORECROWID", FmlField.TYPE_STRING, 19, null, 99, 500);
        this.fmlBuffer[100] = new FmlField("PORT_NUMBER", FmlField.TYPE_STRING, 21, null, 100, 500);
        this.fmlBuffer[101] = new FmlField("NPNUMINFORECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 101, 500);
        this.fmlBuffer[102] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 102, 500);
        this.fmlBuffer[103] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 103, 500);
        this.fmlBuffer[104] = new FmlField("NPNUMINFORECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 104, 500);
        this.fmlBuffer[105] = new FmlField("NPNUMINFORECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 105, 500);
        this.fmlBuffer[106] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 106, 500);
        this.fmlBuffer[107] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 107, 500);
        this.fmlBuffer[108] = new FmlField("NPNUMINFORECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 108, 500);
        this.fmlBuffer[109] = new FmlField("INT_ORDER_ID", FmlField.TYPE_DOUBLE, -1, null, 109, 500);
        this.fmlBuffer[110] = new FmlField("ORG_CUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 110, 500);
        this.fmlBuffer[111] = new FmlField("PORT_IND", FmlField.TYPE_BYTE, -1, null, 111, 500);
        this.fmlBuffer[112] = new FmlField("NUMBER_TYPE", FmlField.TYPE_BYTE, -1, null, 112, 500);
        this.fmlBuffer[113] = new FmlField("PORT_REQUEST_DATE", FmlField.TYPE_STRING, 15, null, 113, 500);
        this.fmlBuffer[114] = new FmlField("ORG_OPERATOR", FmlField.TYPE_STRING, 6, null, 114, 500);
        this.fmlBuffer[115] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 115, 500);
        this.fmlBuffer[116] = new FmlField("LAST_INT_ORD_ID", FmlField.TYPE_DOUBLE, -1, null, 116, 500);
        this.fmlBuffer[117] = new FmlField("FUNCTION_PORT_IND", FmlField.TYPE_BYTE, -1, null, 117, 500);
        this.fmlBuffer[118] = new FmlField("PASSIVE_IND", FmlField.TYPE_BYTE, -1, null, 118, 500);
        this.fmlBuffer[119] = new FmlField("AUTO_CONFIRM", FmlField.TYPE_BYTE, -1, null, 119, 500);
        this.fmlBuffer[120] = new FmlField("TEMPORARY_MSISDN", FmlField.TYPE_STRING, 21, null, 120, 500);
        this.fmlBuffer[121] = new FmlField("HANDLE_MODE", FmlField.TYPE_BYTE, -1, null, 121, 500);
        this.fmlBuffer[122] = new FmlField("SEND_IND", FmlField.TYPE_BYTE, -1, null, 122, 500);
        this.fmlBuffer[123] = new FmlField("ORDID_STR", FmlField.TYPE_STRING, 21, null, 123, 500);
        this.fmlBuffer[124] = new FmlField("LAST_ORDID_STR", FmlField.TYPE_STRING, 21, null, 124, 500);
        this.fmlBuffer[125] = new FmlField("ICC", FmlField.TYPE_STRING, 61, null, 125, 500);
        this.fmlBuffer[126] = new FmlField("CUSTOMER_NAME", FmlField.TYPE_STRING, 255, null, 126, 500);
        this.fmlBuffer[127] = new FmlField("NPINFOBUFFCUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 127, 500);
        this.fmlBuffer[128] = new FmlField("SERVICE_PROVIDER", FmlField.TYPE_STRING, 6, null, 128, 500);
        this.fmlBuffer[129] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 129, 1);
        this.fmlBuffer[130] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 130, 1);
        this.fmlBuffer[131] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 131, 1);
        this.fmlBuffer[132] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 132, 1);
        this.fmlBuffer[133] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 133, 1);
        this.fmlBuffer[134] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 134, 1);
        this.fmlBuffer[135] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 135, 1);
        this.fmlBuffer[136] = new FmlField("ACT_COMPLETE_DATE", FmlField.TYPE_STRING, 9, null, 136, 1);
    }
    ...
    public void set_NO_OF_INSTALLMENTS(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[55].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_DURATION(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[94].getValue(nIndex));
    }
    ...
    public void set_DL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[107].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_INT_ORDER_ID(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[109].getValue(nIndex));
    }
