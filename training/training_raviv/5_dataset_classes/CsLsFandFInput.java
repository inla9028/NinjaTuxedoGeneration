 ...
 */
public class CsLsFandFInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsLsFandFInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsLsFandFInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csLsFandF", 20);
        ...
        this.fmlBuffer[18] = new FmlField("DISC_TYPE", FmlField.TYPE_BYTE, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("EFF_IND", FmlField.TYPE_BYTE, -1, null, 19, 1);
    }
    ...
    /**
     * Retrieves the value of the 'DISC_TYPE' field in the FML buffer.
     *
     * @return Value of 'DISC_TYPE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_DISC_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[18].getValue(0)));
    }

    /**
     * Sets the value of the 'DISC_TYPE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_DISC_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[18].setValue(0, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves the value of the 'EFF_IND' field in the FML buffer.
     *
     * @return Value of 'EFF_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_EFF_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[19].getValue(0)));
    }

    /**
     * Sets the value of the 'EFF_IND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_EFF_IND(String value) throws FMLManipulationException {
