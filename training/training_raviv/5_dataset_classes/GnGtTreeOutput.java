...
public class GnGtTreeOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[51];
        ...
        this.fmlBuffer[28] = new FmlField("TML_IND", FmlField.TYPE_BYTE, -1, null, 28, 1000);
        this.fmlBuffer[29] = new FmlField("COMPNAME1", FmlField.TYPE_STRING, 61, null, 29, 1000);
        this.fmlBuffer[30] = new FmlField("COMPNAME2", FmlField.TYPE_STRING, 61, null, 30, 1000);
        this.fmlBuffer[31] = new FmlField("ACCOUNT_TYPE", FmlField.TYPE_BYTE, -1, null, 31, 1000);
        this.fmlBuffer[32] = new FmlField("ACCOUNT_SUB_TYPE", FmlField.TYPE_STRING, 3, null, 32, 1000);
        this.fmlBuffer[33] = new FmlField("NEXT_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 33, 1000);
        this.fmlBuffer[34] = new FmlField("NEXT_CONF_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 34, 1000);
        this.fmlBuffer[35] = new FmlField("CURR_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 35, 1000);
        this.fmlBuffer[36] = new FmlField("BAN_STATUS", FmlField.TYPE_BYTE, -1, null, 36, 1000);
        this.fmlBuffer[37] = new FmlField("UTC_PLAN_CODE", FmlField.TYPE_STRING, 10, null, 37, 1000);
        this.fmlBuffer[38] = new FmlField("DEFAULT_UTC_IND", FmlField.TYPE_BYTE, -1, null, 38, 1000);
        this.fmlBuffer[39] = new FmlField("DISCOUNT_GROUP_CODE", FmlField.TYPE_STRING, 7, null, 39, 1000);
        this.fmlBuffer[40] = new FmlField("DEFAULT_DISCOUNT_IND", FmlField.TYPE_BYTE, -1, null, 40, 1000);
        this.fmlBuffer[41] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 41, 1000);
        this.fmlBuffer[42] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 42, 1000);
        this.fmlBuffer[43] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 43, 1000);
        this.fmlBuffer[44] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 44, 1000);
        this.fmlBuffer[45] = new FmlField("TREEDISCROWID", FmlField.TYPE_STRING, 19, null, 45, 1);
        this.fmlBuffer[46] = new FmlField("TREEDISCDISCOUNT_GROUP_CODE", FmlField.TYPE_STRING, 7, null, 46, 1);
        this.fmlBuffer[47] = new FmlField("DISC_GROUP_DESC", FmlField.TYPE_STRING, 41, null, 47, 1);
        this.fmlBuffer[48] = new FmlField("TREEDISCTREE_LEVEL", FmlField.TYPE_SHORT, -1, null, 48, 1);
        this.fmlBuffer[49] = new FmlField("POTENTIAL_SUBS_NO", FmlField.TYPE_INTEGER, -1, null, 49, 1);
        this.fmlBuffer[50] = new FmlField("LAST_POTENT_DATE", FmlField.TYPE_STRING, 9, null, 50, 1);
    }
