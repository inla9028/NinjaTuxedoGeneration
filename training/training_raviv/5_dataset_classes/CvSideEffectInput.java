 ...
 */
public class CvSideEffectInput extends ServiceInput implements Conversable {
    ...
    static {
        ...
        fieldsNotToBeDirectlyCopied.add("SUSP_RC_RATE_TYPE");
    }


    /**
     * Creates a new instance of CvSideEffectInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CvSideEffectInput() throws EnvironmentException, FMLManipulationException {
        // Initialise FML buffer
        fmlBuffer = new FmlField[46];

        //// Get default values from DB
        //synchronized (this.defaultValuesPopulated) {
        //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
        //        defaultValues = getDefaultValues("cvSideEffect", 46);
    ...
    public void populateCsApiBan(CsApiBanInput csApiBanInput) throws FMLManipulationException {
        ...
        for (int i = 0, n = this.get_SUSP_RC_RATE_TYPE_size(); i < n; ++i) {
            csApiBanInput.set_PEFCSMACTVBUFSUSP_RC_RATE_TYPE(i, this.get_SUSP_RC_RATE_TYPE(i));
        }
