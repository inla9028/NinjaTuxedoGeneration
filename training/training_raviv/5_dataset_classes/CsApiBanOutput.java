...
public class CsApiBanOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[220];
        ...
        this.fmlBuffer[156] = new FmlField("PSOCFTRBUFROWID", FmlField.TYPE_STRING, 19, null, 156, 500);
        this.fmlBuffer[157] = new FmlField("PSOCFTRBUFSOC", FmlField.TYPE_STRING, 10, null, 157, 500);
        this.fmlBuffer[158] = new FmlField("PSOCFTRBUFSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 158, 500);
        this.fmlBuffer[159] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 159, 500);
        this.fmlBuffer[160] = new FmlField("MPS_FTR_CODE", FmlField.TYPE_STRING, 7, null, 160, 500);
        this.fmlBuffer[161] = new FmlField("FTR_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 161, 500);
        this.fmlBuffer[162] = new FmlField("FTR_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 162, 500);
        this.fmlBuffer[163] = new FmlField("FTR_EFF_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 163, 500);
        this.fmlBuffer[164] = new FmlField("FTR_EXP_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 164, 500);
        this.fmlBuffer[165] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 165, 500);
        this.fmlBuffer[166] = new FmlField("FTR_MODE", FmlField.TYPE_BYTE, -1, null, 166, 500);
        this.fmlBuffer[167] = new FmlField("PSOCFTRBUFSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 167, 500);
        this.fmlBuffer[168] = new FmlField("FTR_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 168, 500);
        this.fmlBuffer[169] = new FmlField("FTR_ADD_PARAM", FmlField.TYPE_STRING, 301, null, 169, 500);
        this.fmlBuffer[170] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, null, 170, 500);
        this.fmlBuffer[171] = new FmlField("PSOCFTRBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 171, 500);
        this.fmlBuffer[172] = new FmlField("PSOCFTRBUFCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 172, 500);
        this.fmlBuffer[173] = new FmlField("FTR_SPECIAL_TELNO", FmlField.TYPE_STRING, 21, null, 173, 500);
        this.fmlBuffer[174] = new FmlField("SWITCH_ACT_NEEDED", FmlField.TYPE_BYTE, -1, null, 174, 500);
        this.fmlBuffer[175] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, null, 175, 500);
        this.fmlBuffer[176] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, null, 176, 500);
        this.fmlBuffer[177] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 177, 500);
        this.fmlBuffer[178] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, null, 178, 500);
        this.fmlBuffer[179] = new FmlField("MANUAL_RC_RATE", FmlField.TYPE_DOUBLE, -1, null, 179, 500);
        this.fmlBuffer[180] = new FmlField("MANUAL_RC_EXP_DATE", FmlField.TYPE_STRING, 9, null, 180, 500);
        this.fmlBuffer[181] = new FmlField("MANUAL_RC_EFF_DATE", FmlField.TYPE_STRING, 9, null, 181, 500);
        this.fmlBuffer[182] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 182, 1);
        this.fmlBuffer[183] = new FmlField("MSISDN", FmlField.TYPE_STRING, 21, null, 183, 100);
        this.fmlBuffer[184] = new FmlField("NL", FmlField.TYPE_STRING, 4, null, 184, 100);
        this.fmlBuffer[185] = new FmlField("CODE", FmlField.TYPE_INTEGER, -1, null, 185, 100);
        this.fmlBuffer[186] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 186, 100);
        this.fmlBuffer[187] = new FmlField("GSMBUFFEATURE_CODE", FmlField.TYPE_STRING, 7, null, 187, 100);
        this.fmlBuffer[188] = new FmlField("ERRORDESC", FmlField.TYPE_STRING, 2001, null, 188, 1);
        this.fmlBuffer[189] = new FmlField("PNPINFOBUFFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 189, 1);
        this.fmlBuffer[190] = new FmlField("NPNUMINFORECROWID", FmlField.TYPE_STRING, 19, null, 190, 500);
        this.fmlBuffer[191] = new FmlField("PORT_NUMBER", FmlField.TYPE_STRING, 21, null, 191, 500);
        this.fmlBuffer[192] = new FmlField("NPNUMINFORECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 192, 500);
        this.fmlBuffer[193] = new FmlField("NPNUMINFORECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 193, 500);
        this.fmlBuffer[194] = new FmlField("NPNUMINFORECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 194, 500);
        this.fmlBuffer[195] = new FmlField("NPNUMINFORECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 195, 500);
        this.fmlBuffer[196] = new FmlField("NPNUMINFORECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 196, 500);
        this.fmlBuffer[197] = new FmlField("NPNUMINFORECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 197, 500);
        this.fmlBuffer[198] = new FmlField("NPNUMINFORECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 198, 500);
        this.fmlBuffer[199] = new FmlField("NPNUMINFORECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 199, 500);
        this.fmlBuffer[200] = new FmlField("INT_ORDER_ID", FmlField.TYPE_DOUBLE, -1, null, 200, 500);
        this.fmlBuffer[201] = new FmlField("ORG_CUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 201, 500);
        this.fmlBuffer[202] = new FmlField("PORT_IND", FmlField.TYPE_BYTE, -1, null, 202, 500);
        this.fmlBuffer[203] = new FmlField("NUMBER_TYPE", FmlField.TYPE_BYTE, -1, null, 203, 500);
        this.fmlBuffer[204] = new FmlField("PORT_REQUEST_DATE", FmlField.TYPE_STRING, 15, null, 204, 500);
        this.fmlBuffer[205] = new FmlField("ORG_OPERATOR", FmlField.TYPE_STRING, 6, null, 205, 500);
        this.fmlBuffer[206] = new FmlField("NPNUMINFORECSUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 206, 500);
        this.fmlBuffer[207] = new FmlField("LAST_INT_ORD_ID", FmlField.TYPE_DOUBLE, -1, null, 207, 500);
        this.fmlBuffer[208] = new FmlField("FUNCTION_PORT_IND", FmlField.TYPE_BYTE, -1, null, 208, 500);
        this.fmlBuffer[209] = new FmlField("PASSIVE_IND", FmlField.TYPE_BYTE, -1, null, 209, 500);
        this.fmlBuffer[210] = new FmlField("AUTO_CONFIRM", FmlField.TYPE_BYTE, -1, null, 210, 500);
        this.fmlBuffer[211] = new FmlField("TEMPORARY_MSISDN", FmlField.TYPE_STRING, 21, null, 211, 500);
        this.fmlBuffer[212] = new FmlField("HANDLE_MODE", FmlField.TYPE_BYTE, -1, null, 212, 500);
        this.fmlBuffer[213] = new FmlField("SEND_IND", FmlField.TYPE_BYTE, -1, null, 213, 500);
        this.fmlBuffer[214] = new FmlField("ORDID_STR", FmlField.TYPE_STRING, 21, null, 214, 500);
        this.fmlBuffer[215] = new FmlField("LAST_ORDID_STR", FmlField.TYPE_STRING, 21, null, 215, 500);
        this.fmlBuffer[216] = new FmlField("ICC", FmlField.TYPE_STRING, 61, null, 216, 500);
        this.fmlBuffer[217] = new FmlField("CUSTOMER_NAME", FmlField.TYPE_STRING, 255, null, 217, 500);
        this.fmlBuffer[218] = new FmlField("NPINFOBUFFCUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 218, 500);
        this.fmlBuffer[219] = new FmlField("SERVICE_PROVIDER", FmlField.TYPE_STRING, 6, null, 219, 500);
    }
    ...
    public Integer get_NPNUMINFORECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[195].getValue(nIndex));
    }
    ...
    public Integer get_NPNUMINFORECSUBSCRIBER_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[206].getValue(nIndex));
    }
    ...
    public Double get_LAST_INT_ORD_ID(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[207].getValue(nIndex));
    }
