 ...
 */
public class CsSrchAdNmOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsSrchAdNmOutput.
     *
     * @throws FMLManipulationException
     */
    public CsSrchAdNmOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsSrchAdNmOutput() {
    }

    /**
     * Creates a new instance of CsSrchAdNmOutput.
     *
     * @param ds Output dataset from CsSrchAdNm service.
     * @throws FMLManipulationException
     */
    public CsSrchAdNmOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[20] = new FmlField("BILL_CYCLE", FmlField.TYPE_SHORT, -1, null, 20, 100);
        this.fmlBuffer[21] = new FmlField("ACCOUNT_TYPE", FmlField.TYPE_BYTE, -1, null, 21, 100);
        this.fmlBuffer[22] = new FmlField("ACCOUNT_SUB_TYPE", FmlField.TYPE_STRING, 3, null, 22, 100);
        this.fmlBuffer[23] = new FmlField("BAN_STATUS", FmlField.TYPE_BYTE, -1, null, 23, 100);
        this.fmlBuffer[24] = new FmlField("STATUS_LAST_DATE", FmlField.TYPE_STRING, 9, null, 24, 100);
        this.fmlBuffer[25] = new FmlField("START_SERVICE_DATE", FmlField.TYPE_STRING, 9, null, 25, 100);
        this.fmlBuffer[26] = new FmlField("AR_BALANCE", FmlField.TYPE_DOUBLE, -1, null, 26, 100);
        this.fmlBuffer[27] = new FmlField("BL_BILL_PROD_IND", FmlField.TYPE_BYTE, -1, null, 27, 100);
        this.fmlBuffer[28] = new FmlField("CURR_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 28, 100);
        this.fmlBuffer[29] = new FmlField("NEXT_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 29, 100);
        this.fmlBuffer[30] = new FmlField("NEXT_CONF_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 30, 100);
        this.fmlBuffer[31] = new FmlField("BL_HIER_BAN_IND", FmlField.TYPE_BYTE, -1, null, 31, 100);
        this.fmlBuffer[32] = new FmlField("VIP_IND", FmlField.TYPE_BYTE, -1, null, 32, 100);
        this.fmlBuffer[33] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 33, 100);
        this.fmlBuffer[34] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 34, 100);
        this.fmlBuffer[35] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, null, 35, 100);
        this.fmlBuffer[36] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 36, 100);
        this.fmlBuffer[37] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 37, 100);
        this.fmlBuffer[38] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 38, 100);
        this.fmlBuffer[39] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 39, 100);
        this.fmlBuffer[40] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 40, 100);
        this.fmlBuffer[41] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 41, 100);
        this.fmlBuffer[42] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 42, 100);
        this.fmlBuffer[43] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 43, 100);
        this.fmlBuffer[44] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 44, 100);
        this.fmlBuffer[45] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 45, 100);
        this.fmlBuffer[46] = new FmlField("INIT_ACTIVATION_DATE", FmlField.TYPE_STRING, 9, null, 46, 100);
        this.fmlBuffer[47] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 47, 100);
    }
