 ...
 */
public class CsGtSimNrInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsGtSimNrInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsGtSimNrInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csGtSimNr", 20);
        ...
        this.fmlBuffer[16] = new FmlField("LOCATION_ID", FmlField.TYPE_STRING, 5, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("FROM_SIM", FmlField.TYPE_STRING, 21, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("TO_SIM", FmlField.TYPE_STRING, 21, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("FIRST_PAGE", FmlField.TYPE_BYTE, -1, null, 19, 1);
    }
    ...
    /**
     * Retrieves the value of the 'FROM_SIM' field in the FML buffer.
     *
     * @return Value of 'FROM_SIM' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_FROM_SIM() throws FMLManipulationException {
        return ((String) this.fmlBuffer[17].getValue(0));
    }

    /**
     * Sets the value of the 'FROM_SIM' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_FROM_SIM(String value) throws FMLManipulationException {
        this.fmlBuffer[17].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'TO_SIM' field in the FML buffer.
     *
     * @return Value of 'TO_SIM' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_TO_SIM() throws FMLManipulationException {
        return ((String) this.fmlBuffer[18].getValue(0));
    }

    /**
     * Sets the value of the 'TO_SIM' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_TO_SIM(String value) throws FMLManipulationException {
        this.fmlBuffer[18].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'FIRST_PAGE' field in the FML buffer.
     *
     * @return Value of 'FIRST_PAGE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_FIRST_PAGE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[19].getValue(0)));
    }

    /**
     * Sets the value of the 'FIRST_PAGE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_FIRST_PAGE(String value) throws FMLManipulationException {
