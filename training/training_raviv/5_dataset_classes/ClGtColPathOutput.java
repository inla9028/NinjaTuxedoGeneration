...
public class ClGtColPathOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[37] = new FmlField("CRD_LMT_FROM_PCT", FmlField.TYPE_DOUBLE, -1, null, 37, 100);
        this.fmlBuffer[38] = new FmlField("CRD_LMT_TO_PCT", FmlField.TYPE_DOUBLE, -1, null, 38, 100);
    }
    ...
    /**
     * Retrieves the value of the 'CRD_LMT_FROM_PCT' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'CRD_LMT_FROM_PCT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Double get_CRD_LMT_FROM_PCT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[37].getValue(nIndex));
    }

    /**
     * Retrieves number of values defined for 'CRD_LMT_FROM_PCT' field in the FML buffer.
     *
     * @return Number of values defined for 'CRD_LMT_FROM_PCT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_CRD_LMT_FROM_PCT_size() throws FMLManipulationException {
        return (this.fmlBuffer[37].getCount());
    }

    /**
     * Retrieves the value of the 'CRD_LMT_TO_PCT' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'CRD_LMT_TO_PCT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Double get_CRD_LMT_TO_PCT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[38].getValue(nIndex));
    }

    /**
     * Retrieves number of values defined for 'CRD_LMT_TO_PCT' field in the FML buffer.
     *
     * @return Number of values defined for 'CRD_LMT_TO_PCT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_CRD_LMT_TO_PCT_size() throws FMLManipulationException {
