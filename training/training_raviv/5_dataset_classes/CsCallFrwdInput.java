...
public class CsCallFrwdInput extends ServiceInput {
    ...
    public CsCallFrwdInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[32] = new FmlField("P1", FmlField.TYPE_STRING, 51, null, 32, 1);
        this.fmlBuffer[33] = new FmlField("P2", FmlField.TYPE_STRING, 51, null, 33, 1);
        this.fmlBuffer[34] = new FmlField("P3", FmlField.TYPE_STRING, 51, null, 34, 1);
        this.fmlBuffer[35] = new FmlField("P4", FmlField.TYPE_STRING, 51, null, 35, 1);
        this.fmlBuffer[36] = new FmlField("P5", FmlField.TYPE_STRING, 51, null, 36, 1);
        this.fmlBuffer[37] = new FmlField("P6", FmlField.TYPE_STRING, 51, null, 37, 1);
        this.fmlBuffer[38] = new FmlField("P7", FmlField.TYPE_STRING, 51, null, 38, 1);
        this.fmlBuffer[39] = new FmlField("P8", FmlField.TYPE_STRING, 51, null, 39, 1);
        this.fmlBuffer[40] = new FmlField("P9", FmlField.TYPE_STRING, 51, null, 40, 1);
        this.fmlBuffer[41] = new FmlField("P10", FmlField.TYPE_STRING, 51, null, 41, 1);
