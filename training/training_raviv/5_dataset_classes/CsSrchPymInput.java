 ...
 */
public class CsSrchPymInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsSrchPymInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsSrchPymInput() throws EnvironmentException, FMLManipulationException {
        // Initialise FML buffer
        fmlBuffer = new FmlField[27];

        //// Get default values from DB
        //synchronized (this.defaultValuesPopulated) {
        //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
        //        defaultValues = getDefaultValues("csSrchPym", 27);
        ...
        this.fmlBuffer[18] = new FmlField("ENT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("FROM_DEPOSIT_DATE", FmlField.TYPE_STRING, 9, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("TO_DEPOSIT_DATE", FmlField.TYPE_STRING, 9, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("FROM_ORIGINAL_AMT", FmlField.TYPE_DOUBLE, -1, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("TO_ORIGINAL_AMT", FmlField.TYPE_DOUBLE, -1, null, 22, 1);
        this.fmlBuffer[23] = new FmlField("NOT_HANDLED_IND", FmlField.TYPE_BYTE, -1, null, 23, 1);
        this.fmlBuffer[24] = new FmlField("PAGE_NO", FmlField.TYPE_INTEGER, -1, null, 24, 1);
        this.fmlBuffer[25] = new FmlField("PAGESIZE", FmlField.TYPE_INTEGER, -1, null, 25, 1);
        this.fmlBuffer[26] = new FmlField("CUSTOMER_PYM_DATE", FmlField.TYPE_STRING, 9, null, 26, 1);
    }
    ...
    /**
     * Retrieves the value of the 'FROM_DEPOSIT_DATE' field in the FML buffer.
     *
     * @return Value of 'FROM_DEPOSIT_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_FROM_DEPOSIT_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[19].getValue(0));
    }

    /**
     * Sets the value of the 'FROM_DEPOSIT_DATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @throws FMLManipulationException
     */
    public void set_FROM_DEPOSIT_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[19].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'TO_DEPOSIT_DATE' field in the FML buffer.
     *
     * @return Value of 'TO_DEPOSIT_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_TO_DEPOSIT_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[20].getValue(0));
    }

    /**
     * Sets the value of the 'TO_DEPOSIT_DATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @throws FMLManipulationException
     */
    public void set_TO_DEPOSIT_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[20].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'FROM_ORIGINAL_AMT' field in the FML buffer.
     *
     * @return Value of 'FROM_ORIGINAL_AMT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Double get_FROM_ORIGINAL_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[21].getValue(0));
    }

    /**
     * Sets the value of the 'FROM_ORIGINAL_AMT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_FROM_ORIGINAL_AMT(Double value) throws FMLManipulationException {
        this.fmlBuffer[21].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'TO_ORIGINAL_AMT' field in the FML buffer.
     *
     * @return Value of 'TO_ORIGINAL_AMT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Double get_TO_ORIGINAL_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[22].getValue(0));
    }

    /**
     * Sets the value of the 'TO_ORIGINAL_AMT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_TO_ORIGINAL_AMT(Double value) throws FMLManipulationException {
        this.fmlBuffer[22].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'NOT_HANDLED_IND' field in the FML buffer.
     *
     * @return Value of 'NOT_HANDLED_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_NOT_HANDLED_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[23].getValue(0)));
    }

    /**
     * Sets the value of the 'NOT_HANDLED_IND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_NOT_HANDLED_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[23].setValue(0, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves the value of the 'PAGE_NO' field in the FML buffer.
     *
     * @return Value of 'PAGE_NO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PAGE_NO() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[24].getValue(0));
    }

    /**
     * Sets the value of the 'PAGE_NO' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PAGE_NO(Integer value) throws FMLManipulationException {
    ...
    /**
     * Sets the value of the 'PAGESIZE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PAGESIZE(Integer value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_CUSTOMER_PYM_DATE(String value) throws FMLManipulationException {
