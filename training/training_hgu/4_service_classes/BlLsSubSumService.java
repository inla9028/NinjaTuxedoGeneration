 ...
 * @author  Ninja
 */
public class BlLsSubSumService extends TuxedoService implements TuxedoExecutable {
     ...
     */
    public BlLsSubSumInput getInput() throws FMLManipulationException{
        if (this.input == null) {
     ...
     */
    @Override
    protected BlLsSubSumOutput toOutput(final Result result) throws FMLManipulationException {
        return new BlLsSubSumOutput(result);
    }
     ...
     */
    private BlLsSubSumOutput setOutput(final BlLsSubSumOutput output) {
        this.output = output;
