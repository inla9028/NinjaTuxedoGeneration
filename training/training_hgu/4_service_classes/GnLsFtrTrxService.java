...
public class GnLsFtrTrxService extends TuxedoService implements TuxedoExecutable {
     ...
     */
    public GnLsFtrTrxInput getInput() throws FMLManipulationException{
        if (this.input == null) {
     ...
     */
    @Override
    protected GnLsFtrTrxOutput toOutput(final Result result) throws FMLManipulationException {
        return new GnLsFtrTrxOutput(result);
    }
     ...
     */
    private GnLsFtrTrxOutput setOutput(final GnLsFtrTrxOutput output) {
        this.output = output;
