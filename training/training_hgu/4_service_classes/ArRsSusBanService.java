...
public class ArRsSusBanService extends TuxedoService implements TuxedoExecutable {
     ...
     */
    public ArRsSusBanInput getInput() throws FMLManipulationException{
        if (this.input == null) {
     ...
     */
    @Override
    protected ArRsSusBanOutput toOutput(final Result result) throws FMLManipulationException {
        return new ArRsSusBanOutput(result);
    }
     ...
     */
    private ArRsSusBanOutput setOutput(final ArRsSusBanOutput output) {
        this.output = output;
