...
public class ArSvBilPrmService extends TuxedoService implements TuxedoExecutable {
     ...
     */
    public ArSvBilPrmInput getInput() throws FMLManipulationException{
        if (this.input == null) {
     ...
     */
    @Override
    protected ArSvBilPrmOutput toOutput(final Result result) throws FMLManipulationException {
        return new ArSvBilPrmOutput(result);
    }
     ...
     */
    private ArSvBilPrmOutput setOutput(final ArSvBilPrmOutput output) {
        this.output = output;
