...
public class ArLsDefAgrService extends TuxedoService implements TuxedoExecutable {
     ...
     */
    public ArLsDefAgrInput getInput() throws FMLManipulationException{
        if (this.input == null) {
     ...
     */
    @Override
    protected ArLsDefAgrOutput toOutput(final Result result) throws FMLManipulationException {
        return new ArLsDefAgrOutput(result);
    }
     ...
     */
    private ArLsDefAgrOutput setOutput(final ArLsDefAgrOutput output) {
        this.output = output;
