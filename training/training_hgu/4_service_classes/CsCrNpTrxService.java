...
public class CsCrNpTrxService extends TuxedoService implements TuxedoExecutable {
     ...
     */
    public CsCrNpTrxInput getInput() throws FMLManipulationException{
        if (this.input == null) {
     ...
     */
    @Override
    protected CsCrNpTrxOutput toOutput(final Result result) throws FMLManipulationException {
        return new CsCrNpTrxOutput(result);
    }
     ...
     */
    private CsCrNpTrxOutput setOutput(final CsCrNpTrxOutput output) {
        this.output = output;
