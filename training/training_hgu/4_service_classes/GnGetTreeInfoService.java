...
public class GnGetTreeInfoService extends TuxedoService implements TuxedoExecutable {
     ...
     */
    public GnGetTreeInfoInput getInput() throws FMLManipulationException{
        if (this.input == null) {
     ...
     */
    @Override
    protected GnGetTreeInfoOutput toOutput(final Result result) throws FMLManipulationException {
        return new GnGetTreeInfoOutput(result);
    }
     ...
     */
    private GnGetTreeInfoOutput setOutput(final GnGetTreeInfoOutput output) {
        this.output = output;
