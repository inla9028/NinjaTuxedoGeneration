 ...
 * @author  Ninja
 */
public class CsLsCtnEsnService extends TuxedoService implements TuxedoExecutable {
     ...
     */
    public CsLsCtnEsnInput getInput() throws FMLManipulationException{
        if (this.input == null) {
     ...
     */
    @Override
    protected CsLsCtnEsnOutput toOutput(final Result result) throws FMLManipulationException {
        return new CsLsCtnEsnOutput(result);
    }
     ...
     */
    private CsLsCtnEsnOutput setOutput(final CsLsCtnEsnOutput output) {
        this.output = output;
