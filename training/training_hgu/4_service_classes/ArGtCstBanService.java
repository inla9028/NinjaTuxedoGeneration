...
public class ArGtCstBanService extends TuxedoService implements TuxedoExecutable {
     ...
     */
    public ArGtCstBanInput getInput() throws FMLManipulationException{
        if (this.input == null) {
     ...
     */
    @Override
    protected ArGtCstBanOutput toOutput(final Result result) throws FMLManipulationException {
        return new ArGtCstBanOutput(result);
    }
     ...
     */
    private ArGtCstBanOutput setOutput(final ArGtCstBanOutput output) {
        this.output = output;
