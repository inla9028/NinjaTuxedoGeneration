 ...
 */
public class CsGtLeadNoInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsGtLeadNoInput
     *
     * @throws FMLManipulationException
     */
    public CsGtLeadNoInput() throws FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csGtLeadNo", 22);
        ...
        this.fmlBuffer[16] = new FmlField("INPUTMODE", FmlField.TYPE_BYTE, -1, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("SUBNO", FmlField.TYPE_STRING, 21, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("ORGCODE", FmlField.TYPE_STRING, 10, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("EFFECTIVEDATE", FmlField.TYPE_STRING, 9, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("NLID", FmlField.TYPE_STRING, 4, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("PABXID", FmlField.TYPE_STRING, 13, null, 21, 1);
    }
    ...
    /**
     * Retrieves the value of the 'INPUTMODE' field in the FML buffer.
     *
     * @return Value of 'INPUTMODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_INPUTMODE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[16].getValue(0)));
    }

    /**
     * Sets the value of the 'INPUTMODE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_INPUTMODE(String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'NLID' field in the FML buffer.
     *
     * @return Value of 'NLID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_NLID() throws FMLManipulationException {
        return ((String) this.fmlBuffer[20].getValue(0));
    }

    /**
     * Sets the value of the 'NLID' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_NLID(String value) throws FMLManipulationException {
        this.fmlBuffer[20].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PABXID' field in the FML buffer.
     *
     * @return Value of 'PABXID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PABXID() throws FMLManipulationException {
        return ((String) this.fmlBuffer[21].getValue(0));
    }

    /**
     * Sets the value of the 'PABXID' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 13.
     * @throws FMLManipulationException
     */
    public void set_PABXID(String value) throws FMLManipulationException {
