 ...
 */
public class CsLsDlrPabxNlOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsLsDlrPabxNlOutput.
     *
     * @throws FMLManipulationException
     */
    public CsLsDlrPabxNlOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsLsDlrPabxNlOutput() {
    }

    /**
     * Creates a new instance of CsLsDlrPabxNlOutput.
     *
     * @param ds Output dataset from CsLsDlrPabxNl service.
     * @throws FMLManipulationException
     */
    public CsLsDlrPabxNlOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[4] = new FmlField("NL_ID", FmlField.TYPE_STRING, 4, null, 4, 600);
        this.fmlBuffer[5] = new FmlField("NL_DSC", FmlField.TYPE_STRING, 31, null, 5, 600);
        this.fmlBuffer[6] = new FmlField("TOTALCOUNT", FmlField.TYPE_INTEGER, -1, null, 6, 1);
    }
    ...
    /**
     * Retrieves the value of the 'NL_ID' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 600).
     * @return Value of 'NL_ID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_NL_ID(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[4].getValue(nIndex));
    }

    /**
     * Retrieves number of values defined for 'NL_ID' field in the FML buffer.
     *
     * @return Number of values defined for 'NL_ID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_NL_ID_size() throws FMLManipulationException {
