...
public class CsLsSrvFtrOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[37] = new FmlField("MANUAL_RC_EFF_DATE", FmlField.TYPE_STRING, 9, null, 37, 400);
        this.fmlBuffer[38] = new FmlField("FTR_ADD_SW_PRM_TRUNC", FmlField.TYPE_STRING, 301, null, 38, 400);
        this.fmlBuffer[39] = new FmlField("FTR_ADD_SW_PRM_LEN", FmlField.TYPE_INTEGER, -1, null, 39, 400);
        this.fmlBuffer[40] = new FmlField("FEATURE_DESC", FmlField.TYPE_STRING, 101, null, 40, 400);
        this.fmlBuffer[41] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, null, 41, 400);
        this.fmlBuffer[42] = new FmlField("RC_INFO_IND", FmlField.TYPE_BYTE, -1, null, 42, 400);
        this.fmlBuffer[43] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, null, 43, 400);
        this.fmlBuffer[44] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 44, 400);
        this.fmlBuffer[45] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, null, 45, 400);
    }
