...
public class CsActvCtnInput extends ServiceInput {
    ...
    public CsActvCtnInput() throws FMLManipulationException {
        ...
        this.fmlBuffer[343] = new FmlField("TPID", FmlField.TYPE_STRING, 37, null, 343, 20);
        this.fmlBuffer[344] = new FmlField("E_FAKTURA_REF", FmlField.TYPE_INTEGER, -1, null, 344, 20);
        this.fmlBuffer[345] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 345, 20);
        this.fmlBuffer[346] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 346, 20);
        this.fmlBuffer[347] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 347, 20);
        this.fmlBuffer[348] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 348, 20);
        this.fmlBuffer[349] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 349, 20);
        this.fmlBuffer[350] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 350, 20);
        this.fmlBuffer[351] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 351, 20);
        this.fmlBuffer[352] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 352, 20);
        this.fmlBuffer[353] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 353, 20);
        this.fmlBuffer[354] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 354, 20);
        this.fmlBuffer[355] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 355, 20);
        this.fmlBuffer[356] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 356, 20);
        this.fmlBuffer[357] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 357, 20);
        this.fmlBuffer[358] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 358, 20);
        this.fmlBuffer[359] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 359, 20);
        this.fmlBuffer[360] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 360, 20);
        this.fmlBuffer[361] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 361, 20);
        this.fmlBuffer[362] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 362, 20);
        this.fmlBuffer[363] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 363, 20);
        this.fmlBuffer[364] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 364, 20);
        this.fmlBuffer[365] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 365, 20);
        this.fmlBuffer[366] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 366, 20);
        this.fmlBuffer[367] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 367, 20);
        this.fmlBuffer[368] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 368, 20);
        this.fmlBuffer[369] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 369, 20);
        this.fmlBuffer[370] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 370, 20);
        this.fmlBuffer[371] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 371, 20);
        this.fmlBuffer[372] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 372, 20);
        this.fmlBuffer[373] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 373, 20);
        this.fmlBuffer[374] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 374, 20);
        this.fmlBuffer[375] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 375, 20);
        this.fmlBuffer[376] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 376, 20);
        this.fmlBuffer[377] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 377, 20);
        this.fmlBuffer[378] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 378, 20);
        this.fmlBuffer[379] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 379, 20);
        this.fmlBuffer[380] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 380, 20);
        this.fmlBuffer[381] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 381, 20);
        this.fmlBuffer[382] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 382, 20);
        this.fmlBuffer[383] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 383, 20);
        this.fmlBuffer[384] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 384, 20);
        this.fmlBuffer[385] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 385, 20);
        this.fmlBuffer[386] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 386, 20);
        this.fmlBuffer[387] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 387, 20);
        this.fmlBuffer[388] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 388, 20);
        this.fmlBuffer[389] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 389, 20);
        this.fmlBuffer[390] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 390, 20);
        this.fmlBuffer[391] = new FmlField("PINSTLBUFROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 391, 1);
        this.fmlBuffer[392] = new FmlField("INSTALLMENT_AMT", FmlField.TYPE_DOUBLE, -1, null, 392, 12);
        this.fmlBuffer[393] = new FmlField("INSTALLMENT_DATE", FmlField.TYPE_STRING, 9, null, 393, 12);
        this.fmlBuffer[394] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 394, 1);
        this.fmlBuffer[395] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 395, 2);
        this.fmlBuffer[396] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 396, 2);
        this.fmlBuffer[397] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 397, 1);
        this.fmlBuffer[398] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 398, 1);
        this.fmlBuffer[399] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 399, 1);
        this.fmlBuffer[400] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 400, 1);
        this.fmlBuffer[401] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 401, 1);
        this.fmlBuffer[402] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 402, 1);
        this.fmlBuffer[403] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 403, 1);
        this.fmlBuffer[404] = new FmlField("ACT_COMPLETE_DATE", FmlField.TYPE_STRING, 9, null, 404, 1);
        this.fmlBuffer[405] = new FmlField("PARINPBAN", FmlField.TYPE_INTEGER, -1, null, 405, 1);
        this.fmlBuffer[406] = new FmlField("PARTITION_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 406, 1);
        this.fmlBuffer[407] = new FmlField("PARINPSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 407, 1);
        this.fmlBuffer[408] = new FmlField("PARINPSUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 408, 1);
        this.fmlBuffer[409] = new FmlField("REQUIREMENT_DATE", FmlField.TYPE_STRING, 9, null, 409, 1);
        this.fmlBuffer[410] = new FmlField("ACTIVATION_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 410, 1);
        this.fmlBuffer[411] = new FmlField("PREPAYMENT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 411, 1);
        this.fmlBuffer[412] = new FmlField("PREP_ACTV_AMT", FmlField.TYPE_DOUBLE, -1, null, 412, 1);
        this.fmlBuffer[413] = new FmlField("RC_ONLY_IND", FmlField.TYPE_BYTE, -1, null, 413, 1);
        this.fmlBuffer[414] = new FmlField("PARINPDEALER_CODE", FmlField.TYPE_STRING, 6, null, 414, 1);
        this.fmlBuffer[415] = new FmlField("ACTV_EXMP_IND", FmlField.TYPE_BYTE, -1, null, 415, 1);
        this.fmlBuffer[416] = new FmlField("PREP_EXMP_IND", FmlField.TYPE_BYTE, -1, null, 416, 1);
        this.fmlBuffer[417] = new FmlField("SOURCE_APPL_CODE", FmlField.TYPE_BYTE, -1, null, 417, 1);
        this.fmlBuffer[418] = new FmlField("PARINPFEATURE_CODE", FmlField.TYPE_STRING, 7, null, 418, 1);
        this.fmlBuffer[419] = new FmlField("PARINPSOC", FmlField.TYPE_STRING, 10, null, 419, 1);
        this.fmlBuffer[420] = new FmlField("SOC_DATE", FmlField.TYPE_STRING, 9, null, 420, 1);
        this.fmlBuffer[421] = new FmlField("CAS_PT_REQ", FmlField.TYPE_BYTE, -1, null, 421, 1);
    }
    ...
    public String get_CO_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[374].getValue(nIndex)));
    }
    ...
    public void set_CO_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[374].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_ADDRESSRECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[375].getValue(nIndex)));
    }
    ...
    public void set_ADDRESSRECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[375].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_INSTALLMENT_AMT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[392].getValue(nIndex));
    }
    ...
    public Integer get_PFTRDEPBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[394].getValue(0));
    }
    ...
    public Double get_DEPOSIT_AMOUNT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[396].getValue(nIndex));
    }
    ...
    public String get_DELIVERY_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[403].getValue(0)));
    }
    ...
    public void set_DELIVERY_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[403].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PARINPBAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[405].getValue(0));
    }
    ...
    public Integer get_PARTITION_ROOT_BAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[406].getValue(0));
    }
    ...
    public Double get_PREPAYMENT_AMOUNT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[411].getValue(0));
    }
    ...
    public Double get_PREP_ACTV_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[412].getValue(0));
    }
    ...
    public String get_SOURCE_APPL_CODE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[417].getValue(0)));
    }
    ...
    public void set_SOURCE_APPL_CODE(String value) throws FMLManipulationException {
        this.fmlBuffer[417].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_CAS_PT_REQ() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[421].getValue(0)));
    }
    ...
    public void set_CAS_PT_REQ(String value) throws FMLManipulationException {
        this.fmlBuffer[421].setValue(0, TypeConverter.stringToByte(value));
    }
}