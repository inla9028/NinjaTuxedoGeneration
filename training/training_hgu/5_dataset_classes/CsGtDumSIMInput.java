...
public class CsGtDumSIMInput extends ServiceInput {
    ...
    public CsGtDumSIMInput() throws FMLManipulationException {
        ...
        this.fmlBuffer[18] = new FmlField("ACCTYPE", FmlField.TYPE_BYTE, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("ACCSUBTYPE", FmlField.TYPE_STRING, 3, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("REQ_BUF_SIZE", FmlField.TYPE_INTEGER, -1, null, 20, 1);
        ...
        this.fmlBuffer[23] = new FmlField("SERIAL_NUMBER", FmlField.TYPE_STRING, 21, null, 23, 600);
        this.fmlBuffer[24] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 24, 600);
        this.fmlBuffer[25] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 25, 600);
        this.fmlBuffer[26] = new FmlField("SITINVBUFOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 26, 600);
        this.fmlBuffer[27] = new FmlField("SITINVBUFAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 27, 600);
        this.fmlBuffer[28] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 28, 600);
        this.fmlBuffer[29] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 29, 600);
        this.fmlBuffer[30] = new FmlField("ACT_ISSUE_DATE", FmlField.TYPE_STRING, 15, null, 30, 600);
        this.fmlBuffer[31] = new FmlField("ITEM_ID", FmlField.TYPE_STRING, 16, null, 31, 600);
        this.fmlBuffer[32] = new FmlField("POOL", FmlField.TYPE_STRING, 3, null, 32, 600);
        this.fmlBuffer[33] = new FmlField("SITINVBUFLOCATION_ID", FmlField.TYPE_STRING, 5, null, 33, 600);
        this.fmlBuffer[34] = new FmlField("DOCUMENT_LOC_ID", FmlField.TYPE_STRING, 5, null, 34, 600);
        this.fmlBuffer[35] = new FmlField("DOCUMENT_TYPE", FmlField.TYPE_BYTE, -1, null, 35, 600);
        this.fmlBuffer[36] = new FmlField("DOCUMENT_OID", FmlField.TYPE_INTEGER, -1, null, 36, 600);
        this.fmlBuffer[37] = new FmlField("ACTIVITY_CODE", FmlField.TYPE_STRING, 5, null, 37, 600);
        this.fmlBuffer[38] = new FmlField("ACTIVITY_DATE", FmlField.TYPE_STRING, 15, null, 38, 600);
        this.fmlBuffer[39] = new FmlField("OPERATION_STATUS", FmlField.TYPE_BYTE, -1, null, 39, 600);
        this.fmlBuffer[40] = new FmlField("ITEM_OWNERSHIP", FmlField.TYPE_BYTE, -1, null, 40, 600);
        this.fmlBuffer[41] = new FmlField("ITEM_OWNERSHIP_DT", FmlField.TYPE_STRING, 15, null, 41, 600);
        this.fmlBuffer[42] = new FmlField("CURR_POSSESSION", FmlField.TYPE_BYTE, -1, null, 42, 600);
        this.fmlBuffer[43] = new FmlField("CURR_POSSESSION_DT", FmlField.TYPE_STRING, 15, null, 43, 600);
        this.fmlBuffer[44] = new FmlField("MISSING_IND", FmlField.TYPE_BYTE, -1, null, 44, 600);
        this.fmlBuffer[45] = new FmlField("IN_REPAIR_IND", FmlField.TYPE_BYTE, -1, null, 45, 600);
        this.fmlBuffer[46] = new FmlField("IN_TRANSIT_IND", FmlField.TYPE_BYTE, -1, null, 46, 600);
        this.fmlBuffer[47] = new FmlField("COMITED_TO_POS_IND", FmlField.TYPE_BYTE, -1, null, 47, 600);
        this.fmlBuffer[48] = new FmlField("COMITED_DATE", FmlField.TYPE_STRING, 15, null, 48, 600);
        this.fmlBuffer[49] = new FmlField("POS_DOCUMENT_LOCID", FmlField.TYPE_STRING, 5, null, 49, 600);
        this.fmlBuffer[50] = new FmlField("POS_DOCUMENT_TYPE", FmlField.TYPE_BYTE, -1, null, 50, 600);
        this.fmlBuffer[51] = new FmlField("POS_DOCUMENT_OID", FmlField.TYPE_INTEGER, -1, null, 51, 600);
        this.fmlBuffer[52] = new FmlField("ACTIVITY_REASON", FmlField.TYPE_STRING, 4, null, 52, 600);
        this.fmlBuffer[53] = new FmlField("LAST_COUNTED_DATE", FmlField.TYPE_STRING, 15, null, 53, 600);
        this.fmlBuffer[54] = new FmlField("UPGRADE_IND", FmlField.TYPE_BYTE, -1, null, 54, 600);
        this.fmlBuffer[55] = new FmlField("EXPECTED_RTRN_DATE", FmlField.TYPE_STRING, 15, null, 55, 600);
        this.fmlBuffer[56] = new FmlField("REPAIR_LOCATION_ID", FmlField.TYPE_STRING, 5, null, 56, 600);
        this.fmlBuffer[57] = new FmlField("INITIAL_BOOK_VALUE", FmlField.TYPE_DOUBLE, -1, null, 57, 600);
        this.fmlBuffer[58] = new FmlField("INITIAL_DPR_DATE", FmlField.TYPE_STRING, 9, null, 58, 600);
        this.fmlBuffer[59] = new FmlField("INI_NO_MONTHS_TO_DPR", FmlField.TYPE_SHORT, -1, null, 59, 600);
        this.fmlBuffer[60] = new FmlField("LAST_DPR_DATE", FmlField.TYPE_STRING, 15, null, 60, 600);
        this.fmlBuffer[61] = new FmlField("CURRENT_BOOK_VALUE", FmlField.TYPE_DOUBLE, -1, null, 61, 600);
        this.fmlBuffer[62] = new FmlField("CUR_NO_MONTHS_TO_DPR", FmlField.TYPE_SHORT, -1, null, 62, 600);
        this.fmlBuffer[63] = new FmlField("POLICE_REPORT_NO", FmlField.TYPE_STRING, 16, null, 63, 600);
        this.fmlBuffer[64] = new FmlField("POLICE_REPORT_DATE", FmlField.TYPE_STRING, 15, null, 64, 600);
        this.fmlBuffer[65] = new FmlField("POLICE_STATION", FmlField.TYPE_STRING, 31, null, 65, 600);
        this.fmlBuffer[66] = new FmlField("MSN", FmlField.TYPE_STRING, 11, null, 66, 600);
        this.fmlBuffer[67] = new FmlField("PUK", FmlField.TYPE_INTEGER, -1, null, 67, 600);
        this.fmlBuffer[68] = new FmlField("PACKAGE_ID", FmlField.TYPE_INTEGER, -1, null, 68, 600);
        this.fmlBuffer[69] = new FmlField("PACKAGE_MSISDN", FmlField.TYPE_STRING, 21, null, 69, 600);
        this.fmlBuffer[70] = new FmlField("PUK2", FmlField.TYPE_INTEGER, -1, null, 70, 600);
        this.fmlBuffer[71] = new FmlField("IMSI", FmlField.TYPE_STRING, 16, null, 71, 600);
        this.fmlBuffer[72] = new FmlField("KI", FmlField.TYPE_STRING, 33, null, 72, 600);
        this.fmlBuffer[73] = new FmlField("FIRST_USED_DATE", FmlField.TYPE_STRING, 15, null, 73, 600);
        this.fmlBuffer[74] = new FmlField("SIM_STATUS", FmlField.TYPE_BYTE, -1, null, 74, 600);
        this.fmlBuffer[75] = new FmlField("SUSPEND_IND", FmlField.TYPE_BYTE, -1, null, 75, 600);
        this.fmlBuffer[76] = new FmlField("SUSPEND_DATE", FmlField.TYPE_STRING, 15, null, 76, 600);
        this.fmlBuffer[77] = new FmlField("INITIAL_PIN", FmlField.TYPE_SHORT, -1, null, 77, 600);
        this.fmlBuffer[78] = new FmlField("SENT_TO_AUC_IND", FmlField.TYPE_BYTE, -1, null, 78, 600);
        this.fmlBuffer[79] = new FmlField("HLR_CD", FmlField.TYPE_STRING, 4, null, 79, 600);
        this.fmlBuffer[80] = new FmlField("INITIAL_PIN2", FmlField.TYPE_SHORT, -1, null, 80, 600);
        this.fmlBuffer[81] = new FmlField("K4ID", FmlField.TYPE_STRING, 41, null, 81, 600);
        this.fmlBuffer[82] = new FmlField("MATCHING_ID", FmlField.TYPE_STRING, 129, null, 82, 600);
        this.fmlBuffer[83] = new FmlField("SIM_TYPE", FmlField.TYPE_STRING, 4, null, 83, 600);
    }
    ...
    /**
     * Retrieves the value of the 'ACCTYPE' field in the FML buffer.
     *
     * @return Value of 'ACCTYPE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_ACCTYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[18].getValue(0)));
    }

    /**
     * Sets the value of the 'ACCTYPE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_ACCTYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[18].setValue(0, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves the value of the 'ACCSUBTYPE' field in the FML buffer.
     *
     * @return Value of 'ACCSUBTYPE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_ACCSUBTYPE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[19].getValue(0));
    }

    /**
     * Sets the value of the 'ACCSUBTYPE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 3.
     * @throws FMLManipulationException
     */
    public void set_ACCSUBTYPE(String value) throws FMLManipulationException {
    ...
    public void set_UPGRADE_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[54].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_INI_NO_MONTHS_TO_DPR(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[59].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_CURRENT_BOOK_VALUE(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[61].getValue(nIndex));
    }
    ...
    public Integer get_CUR_NO_MONTHS_TO_DPR(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[62].getValue(nIndex)));
    }
    ...
    public void set_CUR_NO_MONTHS_TO_DPR(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[62].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public void set_SIM_STATUS(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[74].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_INITIAL_PIN(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[77].getValue(nIndex)));
    }
    ...
    public void set_INITIAL_PIN(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[77].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_INITIAL_PIN2(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[80].getValue(nIndex)));
    }
    ...
    public void set_INITIAL_PIN2(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[80].setValue(nIndex, TypeConverter.integerToShort(value));
    }
