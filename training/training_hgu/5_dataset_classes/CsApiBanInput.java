...
public class CsApiBanInput extends ServiceInput {
    ...
    public CsApiBanInput() throws FMLManipulationException {
        ...
        this.fmlBuffer[112] = new FmlField("ORG_CODE", FmlField.TYPE_STRING, 10, null, 112, 1);
        ...
        this.fmlBuffer[135] = new FmlField("CS_CREDIT_CLASS", FmlField.TYPE_BYTE, -1, null, 135, 1);
        this.fmlBuffer[136] = new FmlField("CS_APPROVED_CTN_QTY", FmlField.TYPE_SHORT, -1, null, 136, 1);
        this.fmlBuffer[137] = new FmlField("CAS_ORDER_NUMBER", FmlField.TYPE_INTEGER, -1, null, 137, 1);
        this.fmlBuffer[138] = new FmlField("PCTNAGRPRMRECBAN", FmlField.TYPE_INTEGER, -1, null, 138, 1);
        this.fmlBuffer[139] = new FmlField("BAN_ROWID", FmlField.TYPE_STRING, 19, null, 139, 1);
        this.fmlBuffer[140] = new FmlField("PCTNAGRPRMRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 140, 1);
        this.fmlBuffer[141] = new FmlField("CUSTOMER_ROWID", FmlField.TYPE_STRING, 19, null, 141, 1);
        this.fmlBuffer[142] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 142, 1);
        this.fmlBuffer[143] = new FmlField("CTN_ROWID", FmlField.TYPE_STRING, 19, null, 143, 1);
        this.fmlBuffer[144] = new FmlField("PCTNRECROWID", FmlField.TYPE_STRING, 19, null, 144, 1);
        this.fmlBuffer[145] = new FmlField("PCTNRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 145, 1);
        this.fmlBuffer[146] = new FmlField("PCTNRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 146, 1);
        this.fmlBuffer[147] = new FmlField("PCTNRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 147, 1);
        this.fmlBuffer[148] = new FmlField("PCTNRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 148, 1);
        this.fmlBuffer[149] = new FmlField("PCTNRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 149, 1);
        this.fmlBuffer[150] = new FmlField("PCTNRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 150, 1);
        this.fmlBuffer[151] = new FmlField("PCTNRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 151, 1);
        this.fmlBuffer[152] = new FmlField("PCTNRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 152, 1);
        this.fmlBuffer[153] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 153, 1);
        this.fmlBuffer[154] = new FmlField("INIT_ACTIVATION_DATE", FmlField.TYPE_STRING, 9, null, 154, 1);
        this.fmlBuffer[155] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 155, 1);
        this.fmlBuffer[156] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 156, 1);
        this.fmlBuffer[157] = new FmlField("ORIGINAL_INIT_DATE", FmlField.TYPE_STRING, 15, null, 157, 1);
        this.fmlBuffer[158] = new FmlField("SUB_STATUS_LAST_ACT", FmlField.TYPE_STRING, 4, null, 158, 1);
        this.fmlBuffer[159] = new FmlField("SUB_STATUS_RSN_CODE", FmlField.TYPE_STRING, 5, null, 159, 1);
        this.fmlBuffer[160] = new FmlField("PRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 160, 1);
        this.fmlBuffer[161] = new FmlField("CUSTOMER_BAN", FmlField.TYPE_INTEGER, -1, null, 161, 1);
        this.fmlBuffer[162] = new FmlField("CTN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 162, 1);
        this.fmlBuffer[163] = new FmlField("REQ_ST_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 163, 1);
        this.fmlBuffer[164] = new FmlField("REQ_END_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 164, 1);
        this.fmlBuffer[165] = new FmlField("COMMIT_START_DATE", FmlField.TYPE_STRING, 9, null, 165, 1);
        this.fmlBuffer[166] = new FmlField("COMMIT_END_DATE", FmlField.TYPE_STRING, 9, null, 166, 1);
        this.fmlBuffer[167] = new FmlField("COMMIT_REASON_CODE", FmlField.TYPE_STRING, 4, null, 167, 1);
        this.fmlBuffer[168] = new FmlField("COMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 168, 1);
        this.fmlBuffer[169] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 169, 1);
        this.fmlBuffer[170] = new FmlField("CONTRACT_NO", FmlField.TYPE_STRING, 11, null, 170, 1);
        this.fmlBuffer[171] = new FmlField("CNT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 171, 1);
        this.fmlBuffer[172] = new FmlField("PCTNRECDEALER_CODE", FmlField.TYPE_STRING, 6, null, 172, 1);
        this.fmlBuffer[173] = new FmlField("ORG_DEALER_CODE", FmlField.TYPE_STRING, 6, null, 173, 1);
        this.fmlBuffer[174] = new FmlField("PCTNRECSALES_AGENT", FmlField.TYPE_STRING, 6, null, 174, 1);
        this.fmlBuffer[175] = new FmlField("ORG_SALES_AGENT", FmlField.TYPE_STRING, 6, null, 175, 1);
        this.fmlBuffer[176] = new FmlField("REQ_DEPOSIT_AMT", FmlField.TYPE_DOUBLE, -1, null, 176, 1);
        this.fmlBuffer[177] = new FmlField("LEADING_NUMBER", FmlField.TYPE_STRING, 21, null, 177, 1);
        this.fmlBuffer[178] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, null, 178, 1);
        this.fmlBuffer[179] = new FmlField("NEXT_CTN", FmlField.TYPE_STRING, 21, null, 179, 1);
        this.fmlBuffer[180] = new FmlField("NEXT_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 180, 1);
        this.fmlBuffer[181] = new FmlField("PRV_CTN", FmlField.TYPE_STRING, 21, null, 181, 1);
        this.fmlBuffer[182] = new FmlField("PRV_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 182, 1);
        this.fmlBuffer[183] = new FmlField("NEXT_BAN", FmlField.TYPE_INTEGER, -1, null, 183, 1);
        this.fmlBuffer[184] = new FmlField("NEXT_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 184, 1);
        this.fmlBuffer[185] = new FmlField("PRV_BAN", FmlField.TYPE_INTEGER, -1, null, 185, 1);
        this.fmlBuffer[186] = new FmlField("PRV_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 186, 1);
        this.fmlBuffer[187] = new FmlField("SUB_STS_ISSUE_DATE", FmlField.TYPE_STRING, 9, null, 187, 1);
        this.fmlBuffer[188] = new FmlField("ACTIVATE_WAIVE_RSN", FmlField.TYPE_STRING, 7, null, 188, 1);
        this.fmlBuffer[189] = new FmlField("EARLIEST_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 189, 1);
        this.fmlBuffer[190] = new FmlField("SUB_ACTV_LOCATION", FmlField.TYPE_STRING, 5, null, 190, 1);
        this.fmlBuffer[191] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 191, 1);
        this.fmlBuffer[192] = new FmlField("CUST_WATCH_DATE", FmlField.TYPE_STRING, 9, null, 192, 1);
        this.fmlBuffer[193] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 193, 1);
        this.fmlBuffer[194] = new FmlField("CREDIT_WATCH_PIN_CD", FmlField.TYPE_SHORT, -1, null, 194, 1);
        this.fmlBuffer[195] = new FmlField("SUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 195, 1);
        this.fmlBuffer[196] = new FmlField("LIMIT_RESERVED_DAYS", FmlField.TYPE_SHORT, -1, null, 196, 1);
        this.fmlBuffer[197] = new FmlField("FF_EXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 197, 1);
        this.fmlBuffer[198] = new FmlField("FLEX_IND", FmlField.TYPE_BYTE, -1, null, 198, 1);
        this.fmlBuffer[199] = new FmlField("DUO_IND", FmlField.TYPE_BYTE, -1, null, 199, 1);
        this.fmlBuffer[200] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, null, 200, 1);
        this.fmlBuffer[201] = new FmlField("SUB_DEPARTMENT_CD", FmlField.TYPE_STRING, 5, null, 201, 1);
        this.fmlBuffer[202] = new FmlField("LAST_SUBS_DISC_DT", FmlField.TYPE_STRING, 9, null, 202, 1);
        this.fmlBuffer[203] = new FmlField("LAST_SUBS_DISC_DT_UD", FmlField.TYPE_STRING, 9, null, 203, 1);
        this.fmlBuffer[204] = new FmlField("LAST_SUBSCR_DISC_SN", FmlField.TYPE_SHORT, -1, null, 204, 1);
        this.fmlBuffer[205] = new FmlField("LAST_SUBSCR_DISC_SN_UD", FmlField.TYPE_SHORT, -1, null, 205, 1);
        this.fmlBuffer[206] = new FmlField("PNI", FmlField.TYPE_STRING, 11, null, 206, 1);
        this.fmlBuffer[207] = new FmlField("RMS_REF_STORE_ID", FmlField.TYPE_STRING, 5, null, 207, 1);
        this.fmlBuffer[208] = new FmlField("RMS_REF_TYPE", FmlField.TYPE_BYTE, -1, null, 208, 1);
        this.fmlBuffer[209] = new FmlField("RMS_REF_OD", FmlField.TYPE_INTEGER, -1, null, 209, 1);
        this.fmlBuffer[210] = new FmlField("DLR_ACT_FEE", FmlField.TYPE_DOUBLE, -1, null, 210, 1);
        this.fmlBuffer[211] = new FmlField("PREP_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 211, 1);
        this.fmlBuffer[212] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 212, 1);
        this.fmlBuffer[213] = new FmlField("SUB_LANG", FmlField.TYPE_STRING, 3, null, 213, 1);
        this.fmlBuffer[214] = new FmlField("SMS_RCV_STYLE_CODE", FmlField.TYPE_STRING, 3, null, 214, 1);
        this.fmlBuffer[215] = new FmlField("PCTNRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 215, 1);
        this.fmlBuffer[216] = new FmlField("PCTNRECALLOW_ADVERTISING_IND", FmlField.TYPE_BYTE, -1, null, 216, 1);
        this.fmlBuffer[217] = new FmlField("IVR_WRONG_ACCESS_NO", FmlField.TYPE_SHORT, -1, null, 217, 1);
        this.fmlBuffer[218] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, NinjaConfigurationReferenceTable.getThresholdAmt(), 218, 1);
        this.fmlBuffer[219] = new FmlField("PUBLISH_LEVEL", FmlField.TYPE_STRING, 31, null, 219, 1);
        this.fmlBuffer[220] = new FmlField("AUTO_RELEASE_IND", FmlField.TYPE_BYTE, -1, null, 220, 1);
        this.fmlBuffer[221] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, null, 221, 1);
        this.fmlBuffer[222] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, null, 222, 1);
        this.fmlBuffer[223] = new FmlField("OPERATOR_CW_LMT", FmlField.TYPE_DOUBLE, -1, null, 223, 1);
        this.fmlBuffer[224] = new FmlField("SEND_SMS_FOR_MATCH", FmlField.TYPE_BYTE, -1, null, 224, 1);
        this.fmlBuffer[225] = new FmlField("CPS_STATUS", FmlField.TYPE_BYTE, -1, null, 225, 1);
        this.fmlBuffer[226] = new FmlField("CPS_TRANSACTION", FmlField.TYPE_SHORT, -1, null, 226, 1);
        this.fmlBuffer[227] = new FmlField("CPS_TYPE", FmlField.TYPE_SHORT, -1, null, 227, 1);
        this.fmlBuffer[228] = new FmlField("ISP_PASS", FmlField.TYPE_STRING, 31, null, 228, 1);
        this.fmlBuffer[229] = new FmlField("ISP_TYPE", FmlField.TYPE_STRING, 3, null, 229, 1);
        this.fmlBuffer[230] = new FmlField("OPERATOR_TMP_DATE", FmlField.TYPE_STRING, 9, null, 230, 1);
        this.fmlBuffer[231] = new FmlField("OPERATOR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, null, 231, 1);
        this.fmlBuffer[232] = new FmlField("SUB_ORG_CD", FmlField.TYPE_STRING, 11, null, 232, 1);
        this.fmlBuffer[233] = new FmlField("ORG_MEMBER_NO", FmlField.TYPE_STRING, 21, null, 233, 1);
        this.fmlBuffer[234] = new FmlField("FIXED_AS_GSM_IND", FmlField.TYPE_BYTE, -1, null, 234, 1);
        this.fmlBuffer[235] = new FmlField("EARLY_PORT_OUT", FmlField.TYPE_BYTE, -1, null, 235, 1);
        this.fmlBuffer[236] = new FmlField("EARLY_PO_WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 236, 1);
        this.fmlBuffer[237] = new FmlField("EARLY_PO_WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 237, 1);
        this.fmlBuffer[238] = new FmlField("INTERNAL_CIRCUIT_ID", FmlField.TYPE_STRING, 21, null, 238, 1);
        this.fmlBuffer[239] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 239, 1);
        this.fmlBuffer[240] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 240, 1);
        this.fmlBuffer[241] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 241, 1);
        this.fmlBuffer[242] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 242, 1);
        this.fmlBuffer[243] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 243, 1);
        this.fmlBuffer[244] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 244, 1);
        this.fmlBuffer[245] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 245, 1);
        this.fmlBuffer[246] = new FmlField("ACT_COMPLETE_DATE", FmlField.TYPE_STRING, 9, null, 246, 1);
        this.fmlBuffer[247] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 247, 1);
        this.fmlBuffer[248] = new FmlField("PAGRSOCBUFROWID", FmlField.TYPE_STRING, 19, null, 248, 50);
        this.fmlBuffer[249] = new FmlField("SOC", FmlField.TYPE_STRING, 10, null, 249, 50);
        this.fmlBuffer[250] = new FmlField("SOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 250, 50);
        this.fmlBuffer[251] = new FmlField("COMMITMENT_END_DATE", FmlField.TYPE_STRING, 9, null, 251, 50);
        this.fmlBuffer[252] = new FmlField("SERVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 252, 50);
        this.fmlBuffer[253] = new FmlField("PAGRSOCBUFEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 253, 50);
        this.fmlBuffer[254] = new FmlField("EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 254, 50);
        this.fmlBuffer[255] = new FmlField("SOC_LEVEL_CODE", FmlField.TYPE_BYTE, -1, null, 255, 50);
        this.fmlBuffer[256] = new FmlField("PAGRSOCBUFDEALER_CODE", FmlField.TYPE_STRING, 6, null, 256, 50);
        this.fmlBuffer[257] = new FmlField("PAGRSOCBUFSALES_AGENT", FmlField.TYPE_STRING, 6, null, 257, 50);
        this.fmlBuffer[258] = new FmlField("SRV_MODE", FmlField.TYPE_BYTE, -1, null, 258, 50);
        this.fmlBuffer[259] = new FmlField("SRV_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 259, 50);
        this.fmlBuffer[260] = new FmlField("SOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 260, 50);
        this.fmlBuffer[261] = new FmlField("SRV_TRX_ID", FmlField.TYPE_INTEGER, -1, null, 261, 50);
        this.fmlBuffer[262] = new FmlField("CAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 262, 50);
        this.fmlBuffer[263] = new FmlField("CAMPAIGN", FmlField.TYPE_STRING, 10, null, 263, 50);
        this.fmlBuffer[264] = new FmlField("PAGRSOCBUFCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 264, 50);
        this.fmlBuffer[265] = new FmlField("PAGRSOCBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 265, 50);
        this.fmlBuffer[266] = new FmlField("LOAN_VER_NO", FmlField.TYPE_INTEGER, -1, null, 266, 50);
        this.fmlBuffer[267] = new FmlField("LOAN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 267, 50);
        this.fmlBuffer[268] = new FmlField("SOC_ACTV_FEE", FmlField.TYPE_DOUBLE, -1, null, 268, 50);
        this.fmlBuffer[269] = new FmlField("PROMOTIONAL_SOC", FmlField.TYPE_STRING, 10, null, 269, 50);
        this.fmlBuffer[270] = new FmlField("REASON_CODE", FmlField.TYPE_STRING, 5, null, 270, 50);
        this.fmlBuffer[271] = new FmlField("SOC_START_RC_DATE", FmlField.TYPE_STRING, 9, null, 271, 50);
        this.fmlBuffer[272] = new FmlField("RC_DATE_COPY_IND", FmlField.TYPE_BYTE, -1, null, 272, 50);
        this.fmlBuffer[273] = new FmlField("LOAN_SUB_ID", FmlField.TYPE_INTEGER, -1, null, 273, 50);
        this.fmlBuffer[274] = new FmlField("SOC_QUANTITY", FmlField.TYPE_INTEGER, -1, null, 274, 50);
        this.fmlBuffer[275] = new FmlField("BILL_TEXT", FmlField.TYPE_STRING, 41, null, 275, 50);
        this.fmlBuffer[276] = new FmlField("FULL_AMT", FmlField.TYPE_DOUBLE, -1, null, 276, 50);
        this.fmlBuffer[277] = new FmlField("FIRST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 277, 50);
        this.fmlBuffer[278] = new FmlField("OTHER_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 278, 50);
        this.fmlBuffer[279] = new FmlField("LAST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 279, 50);
        this.fmlBuffer[280] = new FmlField("NO_OF_INSTALLMENTS", FmlField.TYPE_SHORT, -1, null, 280, 50);
        this.fmlBuffer[281] = new FmlField("PAGRFRNDFMLROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 281, 1);
        this.fmlBuffer[282] = new FmlField("ACTIONIND", FmlField.TYPE_BYTE, -1, null, 282, 10000);
        this.fmlBuffer[283] = new FmlField("PCSFANDFRECROWID", FmlField.TYPE_STRING, 19, null, 283, 10000);
        this.fmlBuffer[284] = new FmlField("PCSFANDFRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 284, 10000);
        this.fmlBuffer[285] = new FmlField("PCSFANDFRECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 285, 10000);
        this.fmlBuffer[286] = new FmlField("PERSONAL_TEL", FmlField.TYPE_STRING, 21, null, 286, 10000);
        this.fmlBuffer[287] = new FmlField("PERSONAL_TEL_TO", FmlField.TYPE_STRING, 21, null, 287, 10000);
        this.fmlBuffer[288] = new FmlField("FF_SOC", FmlField.TYPE_STRING, 10, null, 288, 10000);
        this.fmlBuffer[289] = new FmlField("PLAN_CODE", FmlField.TYPE_STRING, 10, null, 289, 10000);
        this.fmlBuffer[290] = new FmlField("DISCOUNT_TYPE", FmlField.TYPE_BYTE, -1, null, 290, 10000);
        this.fmlBuffer[291] = new FmlField("START_HOUR", FmlField.TYPE_STRING, 7, null, 291, 10000);
        this.fmlBuffer[292] = new FmlField("DURATION", FmlField.TYPE_DOUBLE, -1, null, 292, 10000);
        this.fmlBuffer[293] = new FmlField("PAGRFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 293, 1);
        this.fmlBuffer[294] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 294, 2);
        this.fmlBuffer[295] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 295, 2);
        this.fmlBuffer[296] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 296, 1);
        this.fmlBuffer[297] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 297, 50);
        this.fmlBuffer[298] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 298, 50);
        this.fmlBuffer[299] = new FmlField("PEFCSMACTVBUFSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 299, 50);
        this.fmlBuffer[300] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 300, 50);
        this.fmlBuffer[301] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 301, 50);
        this.fmlBuffer[302] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 302, 50);
        this.fmlBuffer[303] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 303, 50);
        this.fmlBuffer[304] = new FmlField("P1", FmlField.TYPE_STRING, 51, null, 304, 50);
        this.fmlBuffer[305] = new FmlField("P2", FmlField.TYPE_STRING, 51, null, 305, 50);
        this.fmlBuffer[306] = new FmlField("P3", FmlField.TYPE_STRING, 51, null, 306, 50);
        this.fmlBuffer[307] = new FmlField("P4", FmlField.TYPE_STRING, 51, null, 307, 50);
        this.fmlBuffer[308] = new FmlField("P5", FmlField.TYPE_STRING, 51, null, 308, 50);
        this.fmlBuffer[309] = new FmlField("P6", FmlField.TYPE_STRING, 51, null, 309, 50);
        this.fmlBuffer[310] = new FmlField("P7", FmlField.TYPE_STRING, 51, null, 310, 50);
        this.fmlBuffer[311] = new FmlField("P8", FmlField.TYPE_STRING, 51, null, 311, 50);
        this.fmlBuffer[312] = new FmlField("P9", FmlField.TYPE_STRING, 51, null, 312, 50);
        this.fmlBuffer[313] = new FmlField("P10", FmlField.TYPE_STRING, 51, null, 313, 50);
        this.fmlBuffer[314] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 314, 50);
        this.fmlBuffer[315] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 315, 50);
        this.fmlBuffer[316] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 316, 50);
        this.fmlBuffer[317] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 317, 50);
        this.fmlBuffer[318] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 318, 50);
        this.fmlBuffer[319] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 319, 50);
        this.fmlBuffer[320] = new FmlField("PSRVTPINPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 320, 1);
        this.fmlBuffer[321] = new FmlField("TUXSRVTP", FmlField.TYPE_BYTE, -1, null, 321, 25);
        this.fmlBuffer[322] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 322, 1);
        this.fmlBuffer[323] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 323, 20);
        this.fmlBuffer[324] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 324, 20);
        this.fmlBuffer[325] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 325, 20);
        this.fmlBuffer[326] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 326, 20);
        this.fmlBuffer[327] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 327, 20);
        this.fmlBuffer[328] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 328, 20);
        this.fmlBuffer[329] = new FmlField("LNKRECBAN", FmlField.TYPE_INTEGER, -1, null, 329, 20);
        this.fmlBuffer[330] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 330, 20);
        this.fmlBuffer[331] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 331, 20);
        this.fmlBuffer[332] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 332, 20);
        this.fmlBuffer[333] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 333, 20);
        this.fmlBuffer[334] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 334, 20);
        this.fmlBuffer[335] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 335, 20);
        this.fmlBuffer[336] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 336, 20);
        this.fmlBuffer[337] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 337, 20);
        this.fmlBuffer[338] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 338, 20);
        this.fmlBuffer[339] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 339, 20);
        this.fmlBuffer[340] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 340, 20);
        this.fmlBuffer[341] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 341, 20);
        this.fmlBuffer[342] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 342, 20);
        this.fmlBuffer[343] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 343, 20);
        this.fmlBuffer[344] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 344, 20);
        this.fmlBuffer[345] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 345, 20);
        this.fmlBuffer[346] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 346, 20);
        this.fmlBuffer[347] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 347, 20);
        this.fmlBuffer[348] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 348, 20);
        this.fmlBuffer[349] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 349, 20);
        this.fmlBuffer[350] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 350, 20);
        this.fmlBuffer[351] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 351, 20);
        this.fmlBuffer[352] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 352, 20);
        this.fmlBuffer[353] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 353, 20);
        this.fmlBuffer[354] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 354, 20);
        this.fmlBuffer[355] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 355, 20);
        this.fmlBuffer[356] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 356, 20);
        this.fmlBuffer[357] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 357, 20);
        this.fmlBuffer[358] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 358, 20);
        this.fmlBuffer[359] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 51, null, 359, 20);
        this.fmlBuffer[360] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 360, 20);
        this.fmlBuffer[361] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 361, 20);
        this.fmlBuffer[362] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 362, 20);
        this.fmlBuffer[363] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 363, 20);
        this.fmlBuffer[364] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 364, 20);
        this.fmlBuffer[365] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 365, 20);
        this.fmlBuffer[366] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 366, 20);
        this.fmlBuffer[367] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 367, 20);
        this.fmlBuffer[368] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 368, 20);
        this.fmlBuffer[369] = new FmlField("TPID", FmlField.TYPE_STRING, 37, null, 369, 20);
        this.fmlBuffer[370] = new FmlField("E_FAKTURA_REF", FmlField.TYPE_INTEGER, -1, null, 370, 20);
        this.fmlBuffer[371] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 371, 20);
        this.fmlBuffer[372] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 372, 20);
        this.fmlBuffer[373] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 373, 20);
        this.fmlBuffer[374] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 374, 20);
        this.fmlBuffer[375] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 375, 20);
        this.fmlBuffer[376] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 376, 20);
        this.fmlBuffer[377] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 377, 20);
        this.fmlBuffer[378] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 378, 20);
        this.fmlBuffer[379] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 379, 20);
        this.fmlBuffer[380] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 380, 20);
        this.fmlBuffer[381] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 381, 20);
        this.fmlBuffer[382] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 382, 20);
        this.fmlBuffer[383] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 383, 20);
        this.fmlBuffer[384] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 384, 20);
        this.fmlBuffer[385] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 385, 20);
        this.fmlBuffer[386] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 386, 20);
        this.fmlBuffer[387] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 387, 20);
        this.fmlBuffer[388] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 388, 20);
        this.fmlBuffer[389] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 389, 20);
        this.fmlBuffer[390] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 390, 20);
        this.fmlBuffer[391] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 391, 20);
        this.fmlBuffer[392] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 392, 20);
        this.fmlBuffer[393] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 393, 20);
        this.fmlBuffer[394] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 394, 20);
        this.fmlBuffer[395] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 395, 20);
        this.fmlBuffer[396] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 396, 20);
        this.fmlBuffer[397] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 397, 20);
        this.fmlBuffer[398] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 398, 20);
        this.fmlBuffer[399] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 399, 20);
        this.fmlBuffer[400] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 400, 20);
        this.fmlBuffer[401] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 401, 20);
        this.fmlBuffer[402] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 402, 20);
        this.fmlBuffer[403] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 403, 20);
        this.fmlBuffer[404] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 404, 20);
        this.fmlBuffer[405] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 405, 20);
        this.fmlBuffer[406] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 406, 20);
        this.fmlBuffer[407] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 407, 20);
        this.fmlBuffer[408] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 408, 20);
        this.fmlBuffer[409] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 409, 20);
        this.fmlBuffer[410] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 410, 20);
        this.fmlBuffer[411] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 411, 20);
        this.fmlBuffer[412] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 412, 20);
        this.fmlBuffer[413] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 413, 20);
        this.fmlBuffer[414] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 414, 20);
        this.fmlBuffer[415] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 415, 20);
        this.fmlBuffer[416] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 416, 20);
        this.fmlBuffer[417] = new FmlField("PESNBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 417, 1);
        this.fmlBuffer[418] = new FmlField("EQUIPMENT_NO", FmlField.TYPE_STRING, 21, null, 418, 50);
        this.fmlBuffer[419] = new FmlField("PHD_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 419, 50);
        this.fmlBuffer[420] = new FmlField("EQUIPMENT_LEVEL", FmlField.TYPE_SHORT, -1, null, 420, 50);
        this.fmlBuffer[421] = new FmlField("IMSI", FmlField.TYPE_STRING, 16, null, 421, 50);
        this.fmlBuffer[422] = new FmlField("PHYDEVARRAYEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 422, 50);
        this.fmlBuffer[423] = new FmlField("PHYDEVARRAYEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 423, 50);
        this.fmlBuffer[424] = new FmlField("OWNERSHIP_CODE", FmlField.TYPE_STRING, 3, null, 424, 50);
        this.fmlBuffer[425] = new FmlField("SW_STATE_IND", FmlField.TYPE_BYTE, -1, null, 425, 50);
        this.fmlBuffer[426] = new FmlField("LAST_SW_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 426, 50);
        this.fmlBuffer[427] = new FmlField("NEXT_ACTV_CODE", FmlField.TYPE_BYTE, -1, null, 427, 50);
        this.fmlBuffer[428] = new FmlField("NEXT_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 428, 50);
        this.fmlBuffer[429] = new FmlField("NEXT_ACTV_ISSUE_DT", FmlField.TYPE_STRING, 9, null, 429, 50);
        this.fmlBuffer[430] = new FmlField("DEVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 430, 50);
        this.fmlBuffer[431] = new FmlField("ESN_MODE", FmlField.TYPE_BYTE, -1, null, 431, 50);
        this.fmlBuffer[432] = new FmlField("ITEM_ID", FmlField.TYPE_STRING, 16, null, 432, 50);
        this.fmlBuffer[433] = new FmlField("POOL", FmlField.TYPE_STRING, 3, null, 433, 50);
        this.fmlBuffer[434] = new FmlField("LOCATION_ID", FmlField.TYPE_STRING, 5, null, 434, 50);
        this.fmlBuffer[435] = new FmlField("ACTIVITY_CODE", FmlField.TYPE_STRING, 5, null, 435, 50);
        this.fmlBuffer[436] = new FmlField("ACTIVITY_DATE", FmlField.TYPE_STRING, 15, null, 436, 50);
        this.fmlBuffer[437] = new FmlField("OPERATION_STATUS", FmlField.TYPE_BYTE, -1, null, 437, 50);
        this.fmlBuffer[438] = new FmlField("ITEM_OWNERSHIP", FmlField.TYPE_BYTE, -1, null, 438, 50);
        this.fmlBuffer[439] = new FmlField("ITEM_OWNERSHIP_DT", FmlField.TYPE_STRING, 15, null, 439, 50);
        this.fmlBuffer[440] = new FmlField("CURR_POSSESSION", FmlField.TYPE_BYTE, -1, null, 440, 50);
        this.fmlBuffer[441] = new FmlField("CURR_POSSESSION_DT", FmlField.TYPE_STRING, 15, null, 441, 50);
        this.fmlBuffer[442] = new FmlField("MISSING_IND", FmlField.TYPE_BYTE, -1, null, 442, 50);
        this.fmlBuffer[443] = new FmlField("IN_REPAIR_IND", FmlField.TYPE_BYTE, -1, null, 443, 50);
        this.fmlBuffer[444] = new FmlField("IN_TRANSIT_IND", FmlField.TYPE_BYTE, -1, null, 444, 50);
        this.fmlBuffer[445] = new FmlField("COMITED_TO_POS_IND", FmlField.TYPE_BYTE, -1, null, 445, 50);
        this.fmlBuffer[446] = new FmlField("COMITED_DATE", FmlField.TYPE_STRING, 15, null, 446, 50);
        this.fmlBuffer[447] = new FmlField("ACTIVITY_REASON", FmlField.TYPE_STRING, 4, null, 447, 50);
        this.fmlBuffer[448] = new FmlField("UPGRADE_IND", FmlField.TYPE_BYTE, -1, null, 448, 50);
        this.fmlBuffer[449] = new FmlField("EXPECTED_RTRN_DATE", FmlField.TYPE_STRING, 15, null, 449, 50);
        this.fmlBuffer[450] = new FmlField("POLICE_REPORT_NO", FmlField.TYPE_STRING, 16, null, 450, 50);
        this.fmlBuffer[451] = new FmlField("POLICE_REPORT_DATE", FmlField.TYPE_STRING, 15, null, 451, 50);
        this.fmlBuffer[452] = new FmlField("POLICE_STATION", FmlField.TYPE_STRING, 31, null, 452, 50);
        this.fmlBuffer[453] = new FmlField("PUK", FmlField.TYPE_INTEGER, -1, null, 453, 50);
        this.fmlBuffer[454] = new FmlField("PUK2", FmlField.TYPE_INTEGER, -1, null, 454, 50);
        this.fmlBuffer[455] = new FmlField("FIRST_USED_DATE", FmlField.TYPE_STRING, 15, null, 455, 50);
        this.fmlBuffer[456] = new FmlField("SIM_STATUS", FmlField.TYPE_BYTE, -1, null, 456, 50);
        this.fmlBuffer[457] = new FmlField("SUSPEND_IND", FmlField.TYPE_BYTE, -1, null, 457, 50);
        this.fmlBuffer[458] = new FmlField("SUSPEND_DATE", FmlField.TYPE_STRING, 15, null, 458, 50);
        this.fmlBuffer[459] = new FmlField("SENT_TO_AUC_IND", FmlField.TYPE_BYTE, -1, null, 459, 50);
        this.fmlBuffer[460] = new FmlField("HLR_CD", FmlField.TYPE_STRING, 4, null, 460, 50);
        this.fmlBuffer[461] = new FmlField("K4ID", FmlField.TYPE_STRING, 41, null, 461, 50);
        this.fmlBuffer[462] = new FmlField("PHYDEVARRAYDEALER_CODE", FmlField.TYPE_STRING, 6, null, 462, 50);
        this.fmlBuffer[463] = new FmlField("PSOCFTRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 463, 1);
        this.fmlBuffer[464] = new FmlField("PSOCFTRBUFROWID", FmlField.TYPE_STRING, 19, null, 464, 500);
        this.fmlBuffer[465] = new FmlField("PSOCFTRBUFSOC", FmlField.TYPE_STRING, 10, null, 465, 500);
        this.fmlBuffer[466] = new FmlField("PSOCFTRBUFSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 466, 500);
        this.fmlBuffer[467] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 467, 500);
        this.fmlBuffer[468] = new FmlField("MPS_FTR_CODE", FmlField.TYPE_STRING, 7, null, 468, 500);
        this.fmlBuffer[469] = new FmlField("FTR_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 469, 500);
        this.fmlBuffer[470] = new FmlField("FTR_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 470, 500);
        this.fmlBuffer[471] = new FmlField("FTR_EFF_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 471, 500);
        this.fmlBuffer[472] = new FmlField("FTR_EXP_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 472, 500);
        this.fmlBuffer[473] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 473, 500);
        this.fmlBuffer[474] = new FmlField("FTR_MODE", FmlField.TYPE_BYTE, -1, null, 474, 500);
        this.fmlBuffer[475] = new FmlField("PSOCFTRBUFSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 475, 500);
        this.fmlBuffer[476] = new FmlField("FTR_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 476, 500);
        this.fmlBuffer[477] = new FmlField("FTR_ADD_PARAM", FmlField.TYPE_STRING, 301, null, 477, 500);
        this.fmlBuffer[478] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, null, 478, 500);
        this.fmlBuffer[479] = new FmlField("PSOCFTRBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 479, 500);
        this.fmlBuffer[480] = new FmlField("PSOCFTRBUFCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 480, 500);
        this.fmlBuffer[481] = new FmlField("FTR_SPECIAL_TELNO", FmlField.TYPE_STRING, 21, null, 481, 500);
        this.fmlBuffer[482] = new FmlField("SWITCH_ACT_NEEDED", FmlField.TYPE_BYTE, -1, null, 482, 500);
        this.fmlBuffer[483] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, null, 483, 500);
        this.fmlBuffer[484] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, null, 484, 500);
        this.fmlBuffer[485] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 485, 500);
        this.fmlBuffer[486] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, null, 486, 500);
        this.fmlBuffer[487] = new FmlField("MANUAL_RC_RATE", FmlField.TYPE_DOUBLE, -1, null, 487, 500);
        this.fmlBuffer[488] = new FmlField("MANUAL_RC_EXP_DATE", FmlField.TYPE_STRING, 9, null, 488, 500);
        this.fmlBuffer[489] = new FmlField("MANUAL_RC_EFF_DATE", FmlField.TYPE_STRING, 9, null, 489, 500);
        this.fmlBuffer[490] = new FmlField("PNPINFOBUFFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 490, 1);
        this.fmlBuffer[491] = new FmlField("NPNUMINFORECROWID", FmlField.TYPE_STRING, 19, null, 491, 500);
        this.fmlBuffer[492] = new FmlField("PORT_NUMBER", FmlField.TYPE_STRING, 21, null, 492, 500);
        this.fmlBuffer[493] = new FmlField("NPNUMINFORECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 493, 500);
        this.fmlBuffer[494] = new FmlField("NPNUMINFORECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 494, 500);
        this.fmlBuffer[495] = new FmlField("NPNUMINFORECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 495, 500);
        this.fmlBuffer[496] = new FmlField("NPNUMINFORECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 496, 500);
        this.fmlBuffer[497] = new FmlField("NPNUMINFORECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 497, 500);
        this.fmlBuffer[498] = new FmlField("NPNUMINFORECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 498, 500);
        this.fmlBuffer[499] = new FmlField("NPNUMINFORECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 499, 500);
        this.fmlBuffer[500] = new FmlField("NPNUMINFORECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 500, 500);
        this.fmlBuffer[501] = new FmlField("INT_ORDER_ID", FmlField.TYPE_DOUBLE, -1, null, 501, 500);
        this.fmlBuffer[502] = new FmlField("ORG_CUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 502, 500);
        this.fmlBuffer[503] = new FmlField("PORT_IND", FmlField.TYPE_BYTE, -1, null, 503, 500);
        this.fmlBuffer[504] = new FmlField("NUMBER_TYPE", FmlField.TYPE_BYTE, -1, null, 504, 500);
        this.fmlBuffer[505] = new FmlField("PORT_REQUEST_DATE", FmlField.TYPE_STRING, 15, null, 505, 500);
        this.fmlBuffer[506] = new FmlField("ORG_OPERATOR", FmlField.TYPE_STRING, 6, null, 506, 500);
        this.fmlBuffer[507] = new FmlField("NPNUMINFORECSUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 507, 500);
        this.fmlBuffer[508] = new FmlField("LAST_INT_ORD_ID", FmlField.TYPE_DOUBLE, -1, null, 508, 500);
        this.fmlBuffer[509] = new FmlField("FUNCTION_PORT_IND", FmlField.TYPE_BYTE, -1, null, 509, 500);
        this.fmlBuffer[510] = new FmlField("PASSIVE_IND", FmlField.TYPE_BYTE, -1, null, 510, 500);
        this.fmlBuffer[511] = new FmlField("AUTO_CONFIRM", FmlField.TYPE_BYTE, -1, null, 511, 500);
        this.fmlBuffer[512] = new FmlField("TEMPORARY_MSISDN", FmlField.TYPE_STRING, 21, null, 512, 500);
        this.fmlBuffer[513] = new FmlField("HANDLE_MODE", FmlField.TYPE_BYTE, -1, null, 513, 500);
        this.fmlBuffer[514] = new FmlField("SEND_IND", FmlField.TYPE_BYTE, -1, null, 514, 500);
        this.fmlBuffer[515] = new FmlField("ORDID_STR", FmlField.TYPE_STRING, 21, null, 515, 500);
        this.fmlBuffer[516] = new FmlField("LAST_ORDID_STR", FmlField.TYPE_STRING, 21, null, 516, 500);
        this.fmlBuffer[517] = new FmlField("ICC", FmlField.TYPE_STRING, 61, null, 517, 500);
        this.fmlBuffer[518] = new FmlField("CUSTOMER_NAME", FmlField.TYPE_STRING, 255, null, 518, 500);
        this.fmlBuffer[519] = new FmlField("NPINFOBUFFCUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 519, 500);
        this.fmlBuffer[520] = new FmlField("SERVICE_PROVIDER", FmlField.TYPE_STRING, 6, null, 520, 500);
        this.fmlBuffer[521] = new FmlField("RSNCODE", FmlField.TYPE_STRING, 5, null, 521, 1);
    }
    ...
    /**
     * Retrieves the value of the 'HELD_SUB_LETTER_IND' field in the FML buffer.
     *
     * @return Value of 'HELD_SUB_LETTER_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_HELD_SUB_LETTER_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[131].getValue(0)));
    }

    /**
     * Sets the value of the 'HELD_SUB_LETTER_IND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_HELD_SUB_LETTER_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[131].setValue(0, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves the value of the 'HELD_SUB_LTR_EXP_DATE' field in the FML buffer.
     *
     * @return Value of 'HELD_SUB_LTR_EXP_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_HELD_SUB_LTR_EXP_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[132].getValue(0));
    }

    /**
     * Sets the value of the 'HELD_SUB_LTR_EXP_DATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @throws FMLManipulationException
     */
    public void set_HELD_SUB_LTR_EXP_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[132].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'CURRENCY_TYPE' field in the FML buffer.
     *
     * @return Value of 'CURRENCY_TYPE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_CURRENCY_TYPE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[133].getValue(0));
    }

    /**
     * Sets the value of the 'CURRENCY_TYPE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_CURRENCY_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[133].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'COUNTERPART_ID' field in the FML buffer.
     *
     * @return Value of 'COUNTERPART_ID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_COUNTERPART_ID() throws FMLManipulationException {
        return ((String) this.fmlBuffer[134].getValue(0));
    }

    /**
     * Sets the value of the 'COUNTERPART_ID' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_COUNTERPART_ID(String value) throws FMLManipulationException {
    ...
    public Integer get_CS_APPROVED_CTN_QTY() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[136].getValue(0)));
    }
    ...
    public void set_CS_APPROVED_CTN_QTY(Integer value) throws FMLManipulationException {
        this.fmlBuffer[136].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_PCTNRECOPERATOR_ID() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[149].getValue(0));
    }
    ...
    public Integer get_PCTNRECDL_UPDATE_STAMP() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[152].getValue(0)));
    }
    ...
    public void set_PCTNRECDL_UPDATE_STAMP(Integer value) throws FMLManipulationException {
        this.fmlBuffer[152].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_SUB_STATUS() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[155].getValue(0)));
    }
    ...
    public void set_SUB_STATUS(String value) throws FMLManipulationException {
        this.fmlBuffer[155].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_CUSTOMER_BAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[161].getValue(0));
    }
    ...
    public Integer get_COMMIT_ORIG_NO_MONTH() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[168].getValue(0)));
    }
    ...
    public void set_COMMIT_ORIG_NO_MONTH(Integer value) throws FMLManipulationException {
        this.fmlBuffer[168].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_SUSP_RC_RATE_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[169].getValue(0)));
    }
    ...
    public void set_SUSP_RC_RATE_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[169].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_CNT_SEQ_NO() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[171].getValue(0));
    }
    ...
    public String get_PABX_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[178].getValue(0)));
    }
    ...
    public void set_PABX_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[178].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_NEXT_BAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[183].getValue(0));
    }
    ...
    public Double get_CUST_WATCH_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[191].getValue(0));
    }
    ...
    public Double get_BASIC_WATCH_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[193].getValue(0));
    }
    ...
    public Integer get_LIMIT_RESERVED_DAYS() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[196].getValue(0)));
    }
    ...
    public void set_LIMIT_RESERVED_DAYS(Integer value) throws FMLManipulationException {
        this.fmlBuffer[196].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_FLEX_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[198].getValue(0)));
    }
    ...
    public void set_FLEX_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[198].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_DUO_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[199].getValue(0)));
    }
    ...
    public void set_DUO_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[199].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_DLR_ACT_FEE() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[210].getValue(0));
    }
    ...
    public Integer get_IVR_WRONG_ACCESS_NO() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[217].getValue(0)));
    }
    ...
    public void set_IVR_WRONG_ACCESS_NO(Integer value) throws FMLManipulationException {
        this.fmlBuffer[217].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_OPERATOR_CW_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[223].getValue(0));
    }
    ...
    public String get_SEND_SMS_FOR_MATCH() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[224].getValue(0)));
    }
    ...
    public void set_SEND_SMS_FOR_MATCH(String value) throws FMLManipulationException {
        this.fmlBuffer[224].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_CPS_STATUS() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[225].getValue(0)));
    }
    ...
    public void set_CPS_STATUS(String value) throws FMLManipulationException {
        this.fmlBuffer[225].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_SOC_LEVEL_CODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[255].getValue(nIndex)));
    }
    ...
    public void set_SOC_LEVEL_CODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[255].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_SRV_MODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[258].getValue(nIndex)));
    }
    ...
    public void set_SRV_MODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[258].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_CAMPAIGN_SEQ(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[262].getValue(nIndex));
    }
    ...
    public Integer get_PAGRSOCBUFCOMMIT_ORIG_NO_MONTH(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[264].getValue(nIndex)));
    }
    ...
    public void set_PAGRSOCBUFCOMMIT_ORIG_NO_MONTH(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[264].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_LOAN_VER_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[266].getValue(nIndex));
    }
    ...
    public Integer get_LOAN_SEQ_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[267].getValue(nIndex));
    }
    ...
    public Double get_SOC_ACTV_FEE(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[268].getValue(nIndex));
    }
    ...
    public String get_RC_DATE_COPY_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[272].getValue(nIndex)));
    }
    ...
    public void set_RC_DATE_COPY_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[272].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_FIRST_INSTALL_RATE(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[277].getValue(nIndex));
    }
    ...
    public Double get_LAST_INSTALL_RATE(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[279].getValue(nIndex));
    }
    ...
    public Integer get_NO_OF_INSTALLMENTS(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[280].getValue(nIndex)));
    }
    ...
    public void set_NO_OF_INSTALLMENTS(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[280].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_PAGRFRNDFMLROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[281].getValue(0));
    }
    ...
    public Double get_DURATION(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[292].getValue(nIndex));
    }
    ...
    public Integer get_PAGRFTRDEPBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[293].getValue(0));
    }
    ...
    public Integer get_ROW_COUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[296].getValue(0));
    }
    ...
    public Integer get_PSRVTPINPBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[320].getValue(0));
    }
    ...
    public void set_PSRVTPINPBUFROWCOUNT(Integer value) throws FMLManipulationException {
        this.fmlBuffer[320].setValue(0, value);
    }
    ...
    public Integer get_PNAMEADRBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[322].getValue(0));
    }
    ...
    public Double get_KOB(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[360].getValue(nIndex));
    }
    ...
    public Integer get_E_FAKTURA_REF(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[370].getValue(nIndex));
    }
    ...
    public String get_ADR_MODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[371].getValue(nIndex)));
    }
    ...
    public void set_ADR_MODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[371].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_ADR_UP_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[372].getValue(nIndex)));
    }
    ...
    public void set_ADR_UP_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[372].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_ADDRESS_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[375].getValue(nIndex));
    }
    ...
    public Integer get_PESNBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[417].getValue(0));
    }
    ...
    public Integer get_PHD_SEQ_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[419].getValue(nIndex));
    }
    ...
    public Integer get_EQUIPMENT_LEVEL(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[420].getValue(nIndex)));
    }
    ...
    public void set_EQUIPMENT_LEVEL(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[420].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public String get_SW_STATE_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[425].getValue(nIndex)));
    }
    ...
    public void set_SW_STATE_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[425].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_DEVICE_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[430].getValue(nIndex)));
    }
    ...
    public void set_DEVICE_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[430].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_ESN_MODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[431].getValue(nIndex)));
    }
    ...
    public void set_ESN_MODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[431].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_OPERATION_STATUS(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[437].getValue(nIndex)));
    }
    ...
    public void set_OPERATION_STATUS(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[437].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_MISSING_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[442].getValue(nIndex)));
    }
    ...
    public void set_MISSING_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[442].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_IN_TRANSIT_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[444].getValue(nIndex)));
    }
    ...
    public void set_IN_TRANSIT_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[444].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_COMITED_TO_POS_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[445].getValue(nIndex)));
    }
    ...
    public void set_COMITED_TO_POS_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[445].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_UPGRADE_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[448].getValue(nIndex)));
    }
    ...
    public void set_UPGRADE_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[448].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PUK(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[453].getValue(nIndex));
    }
    ...
    public String get_SUSPEND_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[457].getValue(nIndex)));
    }
    ...
    public void set_SUSPEND_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[457].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_SENT_TO_AUC_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[459].getValue(nIndex)));
    }
    ...
    public void set_SENT_TO_AUC_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[459].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PSOCFTRBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[463].getValue(0));
    }
    ...
    public void set_PSOCFTRBUFROWCOUNT(Integer value) throws FMLManipulationException {
        this.fmlBuffer[463].setValue(0, value);
    }
    ...
    public String get_MPS_FTR_CODE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[468].getValue(nIndex));
    }
    ...
    public void set_MPS_FTR_CODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[468].setValue(nIndex, value);
    }
    ...
    public String get_FTR_EFF_RSN_CODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[471].getValue(nIndex)));
    }
    ...
    public void set_FTR_EFF_RSN_CODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[471].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_FTR_EXP_RSN_CODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[472].getValue(nIndex)));
    }
    ...
    public void set_FTR_EXP_RSN_CODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[472].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_SERVICE_FTR_SEQ_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[473].getValue(nIndex));
    }
    ...
    public String get_FTR_MODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[474].getValue(nIndex)));
    }
    ...
    public void set_FTR_MODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[474].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PSOCFTRBUFSOC_SEQ_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[475].getValue(nIndex));
    }
    ...
    public String get_FTR_SUB_MODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[476].getValue(nIndex)));
    }
    ...
    public void set_FTR_SUB_MODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[476].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_PSOCFTRBUFPRODUCT_TYPE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[479].getValue(nIndex));
    }
    ...
    public Integer get_PSOCFTRBUFCAMPAIGN_SEQ(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[480].getValue(nIndex));
    }
    ...
    public String get_MSISDN_CRITERIA(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[484].getValue(nIndex)));
    }
    ...
    public void set_MSISDN_CRITERIA(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[484].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_MANUAL_RC_RATE(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[487].getValue(nIndex));
    }
    ...
    public void set_MANUAL_RC_RATE(int nIndex, Double value) throws FMLManipulationException {
        this.fmlBuffer[487].setValue(nIndex, value);
    }
    ...
    public Integer get_PNPINFOBUFFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[490].getValue(0));
    }
    ...
    public void set_PNPINFOBUFFROWCOUNT(Integer value) throws FMLManipulationException {
        this.fmlBuffer[490].setValue(0, value);
    }
    ...
    public String get_NPNUMINFORECROWID(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[491].getValue(nIndex));
    }
    ...
    public String get_PORT_NUMBER(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[492].getValue(nIndex));
    }
    ...
    public void set_PORT_NUMBER(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[492].setValue(nIndex, value);
    }
    ...
    public Integer get_NPNUMINFORECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[496].getValue(nIndex));
    }
    ...
    public Integer get_NPNUMINFORECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[499].getValue(nIndex)));
    }
    ...
    public void set_NPNUMINFORECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[499].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_INT_ORDER_ID(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[501].getValue(nIndex));
    }
    ...
    public String get_PORT_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[503].getValue(nIndex)));
    }
    ...
    public void set_PORT_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[503].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_NUMBER_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[504].getValue(nIndex)));
    }
    ...
    public void set_NUMBER_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[504].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public int get_NUMBER_TYPE_size() throws FMLManipulationException {
        return (this.fmlBuffer[504].getCount());
    }
    ...
    public String get_PORT_REQUEST_DATE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[505].getValue(nIndex));
    }
    ...
    public void set_PORT_REQUEST_DATE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[505].setValue(nIndex, value);
    }
    ...
    public int get_PORT_REQUEST_DATE_size() throws FMLManipulationException {
        return (this.fmlBuffer[505].getCount());
    }
    ...
    public String get_ORG_OPERATOR(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[506].getValue(nIndex));
    }
    ...
    public void set_ORG_OPERATOR(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[506].setValue(nIndex, value);
    }
    ...
    public int get_ORG_OPERATOR_size() throws FMLManipulationException {
        return (this.fmlBuffer[506].getCount());
    }
    ...
    public Integer get_NPNUMINFORECSUBSCRIBER_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[507].getValue(nIndex));
    }
    ...
    public void set_NPNUMINFORECSUBSCRIBER_ID(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[507].setValue(nIndex, value);
    }
    ...
    public int get_NPNUMINFORECSUBSCRIBER_ID_size() throws FMLManipulationException {
        return (this.fmlBuffer[507].getCount());
    }
    ...
    public Double get_LAST_INT_ORD_ID(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[508].getValue(nIndex));
    }
    ...
    public void set_LAST_INT_ORD_ID(int nIndex, Double value) throws FMLManipulationException {
        this.fmlBuffer[508].setValue(nIndex, value);
    }
    ...
    public int get_LAST_INT_ORD_ID_size() throws FMLManipulationException {
        return (this.fmlBuffer[508].getCount());
    }
    ...
    public String get_FUNCTION_PORT_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[509].getValue(nIndex)));
    }
    ...
    public void set_FUNCTION_PORT_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[509].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public int get_FUNCTION_PORT_IND_size() throws FMLManipulationException {
        return (this.fmlBuffer[509].getCount());
    }
    ...
    public String get_PASSIVE_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[510].getValue(nIndex)));
    }
    ...
    public void set_PASSIVE_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[510].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public int get_PASSIVE_IND_size() throws FMLManipulationException {
        return (this.fmlBuffer[510].getCount());
    }
    ...
    public String get_AUTO_CONFIRM(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[511].getValue(nIndex)));
    }
    ...
    public void set_AUTO_CONFIRM(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[511].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public int get_AUTO_CONFIRM_size() throws FMLManipulationException {
        return (this.fmlBuffer[511].getCount());
    }
    ...
    public String get_TEMPORARY_MSISDN(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[512].getValue(nIndex));
    }
    ...
    public void set_TEMPORARY_MSISDN(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[512].setValue(nIndex, value);
    }
    ...
    public int get_TEMPORARY_MSISDN_size() throws FMLManipulationException {
        return (this.fmlBuffer[512].getCount());
    }
    ...
    public String get_HANDLE_MODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[513].getValue(nIndex)));
    }
    ...
    public void set_HANDLE_MODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[513].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public int get_HANDLE_MODE_size() throws FMLManipulationException {
        return (this.fmlBuffer[513].getCount());
    }
    ...
    public String get_SEND_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[514].getValue(nIndex)));
    }
    ...
    public void set_SEND_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[514].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public int get_SEND_IND_size() throws FMLManipulationException {
        return (this.fmlBuffer[514].getCount());
    }
    ...
    public String get_ORDID_STR(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[515].getValue(nIndex));
    }
    ...
    public void set_ORDID_STR(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[515].setValue(nIndex, value);
    }
    ...
    public int get_ORDID_STR_size() throws FMLManipulationException {
        return (this.fmlBuffer[515].getCount());
    }
    ...
    public String get_LAST_ORDID_STR(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[516].getValue(nIndex));
    }
    ...
    public void set_LAST_ORDID_STR(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[516].setValue(nIndex, value);
    }
    ...
    public int get_LAST_ORDID_STR_size() throws FMLManipulationException {
        return (this.fmlBuffer[516].getCount());
    }
    ...
    public String get_ICC(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[517].getValue(nIndex));
    }
    ...
    public void set_ICC(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[517].setValue(nIndex, value);
    }
    ...
    public int get_ICC_size() throws FMLManipulationException {
        return (this.fmlBuffer[517].getCount());
    }
    ...
    public String get_CUSTOMER_NAME(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[518].getValue(nIndex));
    }
    ...
    public void set_CUSTOMER_NAME(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[518].setValue(nIndex, value);
    }
    ...
    public int get_CUSTOMER_NAME_size() throws FMLManipulationException {
        return (this.fmlBuffer[518].getCount());
    }
    ...
    public String get_NPINFOBUFFCUSTOMER_ID(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[519].getValue(nIndex));
    }
    ...
    public void set_NPINFOBUFFCUSTOMER_ID(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[519].setValue(nIndex, value);
    }
    ...
    public int get_NPINFOBUFFCUSTOMER_ID_size() throws FMLManipulationException {
        return (this.fmlBuffer[519].getCount());
    }
    ...
    public String get_SERVICE_PROVIDER(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[520].getValue(nIndex));
    }
    ...
    public void set_SERVICE_PROVIDER(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[520].setValue(nIndex, value);
    }
    ...
    public int get_SERVICE_PROVIDER_size() throws FMLManipulationException {
        return (this.fmlBuffer[520].getCount());
    }
    ...
    public String get_RSNCODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[521].getValue(0));
    }
    ...
    public void set_RSNCODE(String value) throws FMLManipulationException {
        this.fmlBuffer[521].setValue(0, value);
    }
}