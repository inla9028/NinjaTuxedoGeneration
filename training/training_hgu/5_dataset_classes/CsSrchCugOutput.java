 ...
 */
public class CsSrchCugOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsSrchCugOutput.
     *
     * @throws FMLManipulationException
     */
    public CsSrchCugOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsSrchCugOutput() {
    }

    /**
     * Creates a new instance of CsSrchCugOutput.
     *
     * @param ds Output dataset from CsSrchCug service.
     * @throws FMLManipulationException
     */
    public CsSrchCugOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[16] = new FmlField("TOTALCOUNT", FmlField.TYPE_INTEGER, -1, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("MOREROWS", FmlField.TYPE_SHORT, -1, null, 17, 1);
        ...
        this.fmlBuffer[20] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 20, 50);
        this.fmlBuffer[21] = new FmlField("ACCOUNT_TYPE", FmlField.TYPE_BYTE, -1, null, 21, 50);
        this.fmlBuffer[22] = new FmlField("BAN_STATUS", FmlField.TYPE_BYTE, -1, null, 22, 50);
        this.fmlBuffer[23] = new FmlField("STATUS_LAST_DATE", FmlField.TYPE_STRING, 9, null, 23, 50);
        this.fmlBuffer[24] = new FmlField("BL_HIER_BAN_IND", FmlField.TYPE_BYTE, -1, null, 24, 50);
        this.fmlBuffer[25] = new FmlField("VIP_IND", FmlField.TYPE_BYTE, -1, null, 25, 50);
        this.fmlBuffer[26] = new FmlField("ACCOUNT_SUB_TYPE", FmlField.TYPE_STRING, 3, null, 26, 50);
        this.fmlBuffer[27] = new FmlField("BILL_CYCLE", FmlField.TYPE_SHORT, -1, null, 27, 50);
        this.fmlBuffer[28] = new FmlField("START_SERVICE_DATE", FmlField.TYPE_STRING, 9, null, 28, 50);
        this.fmlBuffer[29] = new FmlField("AR_BALANCE", FmlField.TYPE_DOUBLE, -1, null, 29, 50);
        this.fmlBuffer[30] = new FmlField("BL_BILL_PROD_IND", FmlField.TYPE_BYTE, -1, null, 30, 50);
        this.fmlBuffer[31] = new FmlField("CURR_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 31, 50);
        this.fmlBuffer[32] = new FmlField("NEXT_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 32, 50);
        this.fmlBuffer[33] = new FmlField("NEXT_CONF_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 33, 50);
        this.fmlBuffer[34] = new FmlField("SUBS_ROWID", FmlField.TYPE_STRING, 19, null, 34, 50);
        this.fmlBuffer[35] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 35, 50);
        this.fmlBuffer[36] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 36, 50);
        this.fmlBuffer[37] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, null, 37, 50);
        this.fmlBuffer[38] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 38, 50);
        this.fmlBuffer[39] = new FmlField("ADR_ROWID", FmlField.TYPE_STRING, 19, null, 39, 50);
        this.fmlBuffer[40] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 40, 50);
        this.fmlBuffer[41] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 41, 50);
        this.fmlBuffer[42] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 42, 50);
        this.fmlBuffer[43] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 43, 50);
        this.fmlBuffer[44] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 44, 50);
        this.fmlBuffer[45] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 45, 50);
        this.fmlBuffer[46] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 46, 50);
        this.fmlBuffer[47] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 47, 50);
        this.fmlBuffer[48] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 48, 50);
        this.fmlBuffer[49] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 49, 50);
    }
