...
public class GnUpLnkEntInput extends ServiceInput {
    ...
    public GnUpLnkEntInput() throws FMLManipulationException {
        ...
        this.fmlBuffer[75] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 51, null, 75, 1);
        ...
        this.fmlBuffer[85] = new FmlField("TPID", FmlField.TYPE_STRING, 37, null, 85, 1);
        this.fmlBuffer[86] = new FmlField("E_FAKTURA_REF", FmlField.TYPE_INTEGER, -1, null, 86, 1);
        this.fmlBuffer[87] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 87, 1);
        this.fmlBuffer[88] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 88, 1);
        this.fmlBuffer[89] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 89, 1);
        this.fmlBuffer[90] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 90, 1);
        this.fmlBuffer[91] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 91, 1);
        this.fmlBuffer[92] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 92, 1);
        this.fmlBuffer[93] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 93, 1);
        this.fmlBuffer[94] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 94, 1);
        this.fmlBuffer[95] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 95, 1);
        this.fmlBuffer[96] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 96, 1);
        this.fmlBuffer[97] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 97, 1);
        this.fmlBuffer[98] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 98, 1);
        this.fmlBuffer[99] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 99, 1);
        this.fmlBuffer[100] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 100, 1);
        this.fmlBuffer[101] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 101, 1);
        this.fmlBuffer[102] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 102, 1);
        this.fmlBuffer[103] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 103, 1);
        this.fmlBuffer[104] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 104, 1);
        this.fmlBuffer[105] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 105, 1);
        this.fmlBuffer[106] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 106, 1);
        this.fmlBuffer[107] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 107, 1);
        this.fmlBuffer[108] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 108, 1);
        this.fmlBuffer[109] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 109, 1);
        this.fmlBuffer[110] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 110, 1);
        this.fmlBuffer[111] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 111, 1);
        this.fmlBuffer[112] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 112, 1);
        this.fmlBuffer[113] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 113, 1);
        this.fmlBuffer[114] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 114, 1);
        this.fmlBuffer[115] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 115, 1);
        this.fmlBuffer[116] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 116, 1);
        this.fmlBuffer[117] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 117, 1);
        this.fmlBuffer[118] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 118, 1);
        this.fmlBuffer[119] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 119, 1);
        this.fmlBuffer[120] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 120, 1);
        this.fmlBuffer[121] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 121, 1);
        this.fmlBuffer[122] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 122, 1);
        this.fmlBuffer[123] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 123, 1);
        this.fmlBuffer[124] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 124, 1);
        this.fmlBuffer[125] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 125, 1);
        this.fmlBuffer[126] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 126, 1);
        this.fmlBuffer[127] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 127, 1);
        this.fmlBuffer[128] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 128, 1);
        this.fmlBuffer[129] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 129, 1);
        this.fmlBuffer[130] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 130, 1);
        this.fmlBuffer[131] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 131, 1);
        this.fmlBuffer[132] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 132, 1);
    }
     ...
     * @throws FMLManipulationException
     */
    public String get_TPID() throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_TPID(String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public Integer get_E_FAKTURA_REF() throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_E_FAKTURA_REF(Integer value) throws FMLManipulationException {
    ...
    public Integer get_ADDRESSRECOPERATOR_ID() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[94].getValue(0));
    }
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[97].getValue(0)));
    }
    ...
    public void set_ADDRESSRECDL_UPDATE_STAMP(Integer value) throws FMLManipulationException {
        this.fmlBuffer[97].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_ADR_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[98].getValue(0)));
    }
    ...
    public void set_ADR_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[98].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public void set_ADR_STATUS(String value) throws FMLManipulationException {
        this.fmlBuffer[99].setValue(0, TypeConverter.stringToByte(value));
    }
