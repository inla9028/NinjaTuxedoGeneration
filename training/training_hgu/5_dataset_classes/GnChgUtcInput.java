 ...
 */
public class GnChgUtcInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of GnChgUtcInput
     *
     * @throws FMLManipulationException
     */
    public GnChgUtcInput() throws FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("gnChgUtc", 24);
        ...
        this.fmlBuffer[20] = new FmlField("ROWID", FmlField.TYPE_STRING, 19, null, 20, 100);
        this.fmlBuffer[21] = new FmlField("UTC_PLAN_CODE", FmlField.TYPE_STRING, 10, null, 21, 100);
        this.fmlBuffer[22] = new FmlField("TREE_LEVEL", FmlField.TYPE_SHORT, -1, null, 22, 100);
        this.fmlBuffer[23] = new FmlField("CTN", FmlField.TYPE_STRING, 21, null, 23, 100);
    }
    ...
    /**
     * Sets the value of the 'UTC_PLAN_CODE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 10.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_UTC_PLAN_CODE(int nIndex, String value) throws FMLManipulationException {
