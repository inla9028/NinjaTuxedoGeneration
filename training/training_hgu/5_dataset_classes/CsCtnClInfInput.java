 ...
 */
public class CsCtnClInfInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsCtnClInfInput
     *
     * @throws FMLManipulationException
     */
    public CsCtnClInfInput() throws FMLManipulationException {
        // Initialise FML buffer
        fmlBuffer = new FmlField[40];

        //// Get default values from DB
        //synchronized (this.defaultValuesPopulated) {
        //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
        //        defaultValues = getDefaultValues("csCtnClInf", 40);
