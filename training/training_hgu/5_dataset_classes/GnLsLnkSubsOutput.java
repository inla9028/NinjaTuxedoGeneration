 ...
 */
public class GnLsLnkSubsOutput extends ServiceOutput {

    /**
     * Creates a new instance of GnLsLnkSubsOutput.
     *
     * @throws FMLManipulationException
     */
    public GnLsLnkSubsOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public GnLsLnkSubsOutput() {
    }

    /**
     * Creates a new instance of GnLsLnkSubsOutput.
     *
     * @param ds Output dataset from GnLsLnkSubs service.
     * @throws FMLManipulationException
     */
    public GnLsLnkSubsOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[16] = new FmlField("SUBSCOUNT", FmlField.TYPE_INTEGER, -1, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("ROWID", FmlField.TYPE_STRING, 19, null, 17, 1000);
        this.fmlBuffer[18] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 18, 1000);
        this.fmlBuffer[19] = new FmlField("CUSTOMER_BAN", FmlField.TYPE_INTEGER, -1, null, 19, 1000);
        this.fmlBuffer[20] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 20, 1000);
        this.fmlBuffer[21] = new FmlField("PRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 21, 1000);
        this.fmlBuffer[22] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 22, 1000);
        this.fmlBuffer[23] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 23, 1000);
    }
    ...
    /**
     * Retrieves the value of the 'SUBSCOUNT' field in the FML buffer.
     *
     * @return Value of 'SUBSCOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_SUBSCOUNT() throws FMLManipulationException {
