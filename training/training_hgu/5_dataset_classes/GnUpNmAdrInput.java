 ...
 */
public class GnUpNmAdrInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of GnUpNmAdrInput
     *
     * @throws FMLManipulationException
     */
    public GnUpNmAdrInput() throws FMLManipulationException {
        // Initialise FML buffer
        fmlBuffer = new FmlField[141];

        //// Get default values from DB
        //synchronized (this.defaultValuesPopulated) {
        //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
        //        defaultValues = getDefaultValues("gnUpNmAdr", 141);
        ...
        this.fmlBuffer[22] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 22, 1);
        this.fmlBuffer[23] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 23, 50);
        this.fmlBuffer[24] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 24, 50);
        this.fmlBuffer[25] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 25, 50);
        this.fmlBuffer[26] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 26, 50);
        this.fmlBuffer[27] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 27, 50);
        this.fmlBuffer[28] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 28, 50);
        this.fmlBuffer[29] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 29, 50);
        this.fmlBuffer[30] = new FmlField("P1", FmlField.TYPE_STRING, 51, null, 30, 50);
        this.fmlBuffer[31] = new FmlField("P2", FmlField.TYPE_STRING, 51, null, 31, 50);
        this.fmlBuffer[32] = new FmlField("P3", FmlField.TYPE_STRING, 51, null, 32, 50);
        this.fmlBuffer[33] = new FmlField("P4", FmlField.TYPE_STRING, 51, null, 33, 50);
        this.fmlBuffer[34] = new FmlField("P5", FmlField.TYPE_STRING, 51, null, 34, 50);
        this.fmlBuffer[35] = new FmlField("P6", FmlField.TYPE_STRING, 51, null, 35, 50);
        this.fmlBuffer[36] = new FmlField("P7", FmlField.TYPE_STRING, 51, null, 36, 50);
        this.fmlBuffer[37] = new FmlField("P8", FmlField.TYPE_STRING, 51, null, 37, 50);
        this.fmlBuffer[38] = new FmlField("P9", FmlField.TYPE_STRING, 51, null, 38, 50);
        this.fmlBuffer[39] = new FmlField("P10", FmlField.TYPE_STRING, 51, null, 39, 50);
        this.fmlBuffer[40] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 40, 50);
        this.fmlBuffer[41] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 41, 50);
        this.fmlBuffer[42] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 42, 50);
        this.fmlBuffer[43] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 43, 50);
        this.fmlBuffer[44] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 44, 50);
        this.fmlBuffer[45] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 45, 50);
        ...
        this.fmlBuffer[52] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 52, 20);
        this.fmlBuffer[53] = new FmlField("LNKRECBAN", FmlField.TYPE_INTEGER, -1, null, 53, 20);
        this.fmlBuffer[54] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 54, 20);
        ...
        this.fmlBuffer[93] = new FmlField("TPID", FmlField.TYPE_STRING, 37, null, 93, 20);
        this.fmlBuffer[94] = new FmlField("E_FAKTURA_REF", FmlField.TYPE_INTEGER, -1, null, 94, 20);
        this.fmlBuffer[95] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 95, 20);
        this.fmlBuffer[96] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 96, 20);
        this.fmlBuffer[97] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 97, 20);
        this.fmlBuffer[98] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 98, 20);
        this.fmlBuffer[99] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 99, 20);
        this.fmlBuffer[100] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 100, 20);
        this.fmlBuffer[101] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 101, 20);
        this.fmlBuffer[102] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 102, 20);
        this.fmlBuffer[103] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 103, 20);
        this.fmlBuffer[104] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 104, 20);
        this.fmlBuffer[105] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 105, 20);
        this.fmlBuffer[106] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 106, 20);
        this.fmlBuffer[107] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 107, 20);
        this.fmlBuffer[108] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 108, 20);
        this.fmlBuffer[109] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 109, 20);
        this.fmlBuffer[110] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 110, 20);
        this.fmlBuffer[111] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 111, 20);
        this.fmlBuffer[112] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 112, 20);
        this.fmlBuffer[113] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 113, 20);
        this.fmlBuffer[114] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 114, 20);
        this.fmlBuffer[115] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 115, 20);
        this.fmlBuffer[116] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 116, 20);
        this.fmlBuffer[117] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 117, 20);
        this.fmlBuffer[118] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 118, 20);
        this.fmlBuffer[119] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 119, 20);
        this.fmlBuffer[120] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 120, 20);
        this.fmlBuffer[121] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 121, 20);
        this.fmlBuffer[122] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 122, 20);
        this.fmlBuffer[123] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 123, 20);
        this.fmlBuffer[124] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 124, 20);
        this.fmlBuffer[125] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 125, 20);
        this.fmlBuffer[126] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 126, 20);
        this.fmlBuffer[127] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 127, 20);
        this.fmlBuffer[128] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 128, 20);
        this.fmlBuffer[129] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 129, 20);
        this.fmlBuffer[130] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 130, 20);
        this.fmlBuffer[131] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 131, 20);
        this.fmlBuffer[132] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 132, 20);
        this.fmlBuffer[133] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 133, 20);
        this.fmlBuffer[134] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 134, 20);
        this.fmlBuffer[135] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 135, 20);
        this.fmlBuffer[136] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 136, 20);
        this.fmlBuffer[137] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 137, 20);
        this.fmlBuffer[138] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 138, 20);
        this.fmlBuffer[139] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 139, 20);
        this.fmlBuffer[140] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 140, 20);
    }
    ...
    public void set_SUSP_RC_RATE_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[25].setValue(nIndex, TypeConverter.stringToByte(value));
    }
