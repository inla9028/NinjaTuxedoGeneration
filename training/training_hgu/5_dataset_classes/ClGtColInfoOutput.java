...
public class ClGtColInfoOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[221];
        ...
        this.fmlBuffer[73] = new FmlField("CURRENCY_TYPE", FmlField.TYPE_STRING, 4, null, 73, 1);
        this.fmlBuffer[74] = new FmlField("COUNTERPART_ID", FmlField.TYPE_STRING, 4, null, 74, 1);
        this.fmlBuffer[75] = new FmlField("CUSTCOLROWID", FmlField.TYPE_STRING, 19, null, 75, 1);
        this.fmlBuffer[76] = new FmlField("CUSTCOLCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 76, 1);
        this.fmlBuffer[77] = new FmlField("CUSTOMER_TELNO", FmlField.TYPE_STRING, 21, null, 77, 1);
        this.fmlBuffer[78] = new FmlField("CUSTOMER_FAX", FmlField.TYPE_STRING, 21, null, 78, 1);
        this.fmlBuffer[79] = new FmlField("WORK_TELNO", FmlField.TYPE_STRING, 21, null, 79, 1);
        this.fmlBuffer[80] = new FmlField("WORK_FAX", FmlField.TYPE_STRING, 21, null, 80, 1);
        this.fmlBuffer[81] = new FmlField("ACC_PASSWORD", FmlField.TYPE_STRING, 21, null, 81, 1);
        this.fmlBuffer[82] = new FmlField("VERIFIED_DATE", FmlField.TYPE_STRING, 9, null, 82, 1);
        this.fmlBuffer[83] = new FmlField("BILHSTCOLROWID", FmlField.TYPE_STRING, 19, null, 83, 1);
        this.fmlBuffer[84] = new FmlField("BILL_DUE_DATE", FmlField.TYPE_STRING, 9, null, 84, 1);
        this.fmlBuffer[85] = new FmlField("CRDHSTCOLROWID", FmlField.TYPE_STRING, 19, null, 85, 1);
        this.fmlBuffer[86] = new FmlField("CREDIT_CLASS", FmlField.TYPE_BYTE, -1, null, 86, 1);
        this.fmlBuffer[87] = new FmlField("CREDIT_LIMIT", FmlField.TYPE_DOUBLE, -1, null, 87, 1);
        this.fmlBuffer[88] = new FmlField("CYCLCLOSEROWID", FmlField.TYPE_STRING, 19, null, 88, 1);
        this.fmlBuffer[89] = new FmlField("CYCLE_CLOSE_DAY", FmlField.TYPE_SHORT, -1, null, 89, 1);
        this.fmlBuffer[90] = new FmlField("NEXT_CYCLE_CLOSE_DAY", FmlField.TYPE_SHORT, -1, null, 90, 1);
        this.fmlBuffer[91] = new FmlField("FU_COUNT", FmlField.TYPE_INTEGER, -1, null, 91, 1);
        ...
        this.fmlBuffer[94] = new FmlField("COL_PAST_DUE_AMT_OUT", FmlField.TYPE_DOUBLE, -1, null, 94, 1);
        this.fmlBuffer[95] = new FmlField("DCKHISTENTRY", FmlField.TYPE_INTEGER, -1, null, 95, 12);
        this.fmlBuffer[96] = new FmlField("ACTVHISTENTRY", FmlField.TYPE_STRING, 3, null, 96, 12);
        this.fmlBuffer[97] = new FmlField("COLLECTORNAME", FmlField.TYPE_STRING, 21, null, 97, 1);
        this.fmlBuffer[98] = new FmlField("UNBILLED_REVENUE_OUT", FmlField.TYPE_DOUBLE, -1, null, 98, 1);
        this.fmlBuffer[99] = new FmlField("HELDDEPOSIT", FmlField.TYPE_DOUBLE, -1, null, 99, 1);
        this.fmlBuffer[100] = new FmlField("AGB0TO1", FmlField.TYPE_DOUBLE, -1, null, 100, 1);
        this.fmlBuffer[101] = new FmlField("AGB1TO30", FmlField.TYPE_DOUBLE, -1, null, 101, 1);
        this.fmlBuffer[102] = new FmlField("AGB31TO60", FmlField.TYPE_DOUBLE, -1, null, 102, 1);
        this.fmlBuffer[103] = new FmlField("AGB61TO90", FmlField.TYPE_DOUBLE, -1, null, 103, 1);
        this.fmlBuffer[104] = new FmlField("AGB91TO120", FmlField.TYPE_DOUBLE, -1, null, 104, 1);
        this.fmlBuffer[105] = new FmlField("AGB121TOPLUS", FmlField.TYPE_DOUBLE, -1, null, 105, 1);
        this.fmlBuffer[106] = new FmlField("PAST_DUE_AMT_OUT", FmlField.TYPE_DOUBLE, -1, null, 106, 1);
        this.fmlBuffer[107] = new FmlField("LASTSTEPNUM", FmlField.TYPE_SHORT, -1, null, 107, 1);
        this.fmlBuffer[108] = new FmlField("LASTSTEPDATE", FmlField.TYPE_STRING, 9, null, 108, 1);
        this.fmlBuffer[109] = new FmlField("HOLD_AUTOMATIC_TREATMENT", FmlField.TYPE_BYTE, -1, null, 109, 1);
        this.fmlBuffer[110] = new FmlField("COL_TREATMENT_STATUS", FmlField.TYPE_BYTE, -1, null, 110, 1);
        this.fmlBuffer[111] = new FmlField("LASTSTEPPATH", FmlField.TYPE_STRING, 4, null, 111, 1);
        this.fmlBuffer[112] = new FmlField("HOLD_COLL_REASON", FmlField.TYPE_STRING, 7, null, 112, 1);
        this.fmlBuffer[113] = new FmlField("DEBT_AGE_REF_DATE", FmlField.TYPE_STRING, 9, null, 113, 1);
        this.fmlBuffer[114] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 114, 1);
        this.fmlBuffer[115] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 115, 20);
        this.fmlBuffer[116] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 116, 20);
        this.fmlBuffer[117] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 117, 20);
        this.fmlBuffer[118] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 118, 20);
        this.fmlBuffer[119] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 119, 20);
        this.fmlBuffer[120] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 120, 20);
        this.fmlBuffer[121] = new FmlField("LNKRECBAN", FmlField.TYPE_INTEGER, -1, null, 121, 20);
        this.fmlBuffer[122] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 122, 20);
        this.fmlBuffer[123] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 123, 20);
        this.fmlBuffer[124] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 124, 20);
        this.fmlBuffer[125] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 125, 20);
        this.fmlBuffer[126] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 126, 20);
        this.fmlBuffer[127] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 127, 20);
        this.fmlBuffer[128] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 128, 20);
        this.fmlBuffer[129] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 129, 20);
        this.fmlBuffer[130] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 130, 20);
        this.fmlBuffer[131] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 131, 20);
        this.fmlBuffer[132] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 132, 20);
        this.fmlBuffer[133] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 133, 20);
        this.fmlBuffer[134] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 134, 20);
        this.fmlBuffer[135] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 135, 20);
        this.fmlBuffer[136] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 136, 20);
        this.fmlBuffer[137] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 137, 20);
        this.fmlBuffer[138] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 138, 20);
        this.fmlBuffer[139] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 139, 20);
        this.fmlBuffer[140] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 140, 20);
        this.fmlBuffer[141] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 141, 20);
        this.fmlBuffer[142] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 142, 20);
        this.fmlBuffer[143] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 143, 20);
        this.fmlBuffer[144] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 144, 20);
        this.fmlBuffer[145] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 145, 20);
        this.fmlBuffer[146] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 146, 20);
        this.fmlBuffer[147] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 147, 20);
        this.fmlBuffer[148] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 148, 20);
        this.fmlBuffer[149] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 149, 20);
        this.fmlBuffer[150] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 150, 20);
        this.fmlBuffer[151] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 51, null, 151, 20);
        this.fmlBuffer[152] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 152, 20);
        this.fmlBuffer[153] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 153, 20);
        this.fmlBuffer[154] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 154, 20);
        this.fmlBuffer[155] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 155, 20);
        this.fmlBuffer[156] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 156, 20);
        this.fmlBuffer[157] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 157, 20);
        this.fmlBuffer[158] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 158, 20);
        this.fmlBuffer[159] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 159, 20);
        this.fmlBuffer[160] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 160, 20);
        this.fmlBuffer[161] = new FmlField("TPID", FmlField.TYPE_STRING, 37, null, 161, 20);
        this.fmlBuffer[162] = new FmlField("E_FAKTURA_REF", FmlField.TYPE_INTEGER, -1, null, 162, 20);
        this.fmlBuffer[163] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 163, 20);
        this.fmlBuffer[164] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 164, 20);
        this.fmlBuffer[165] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 165, 20);
        this.fmlBuffer[166] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 166, 20);
        this.fmlBuffer[167] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 167, 20);
        this.fmlBuffer[168] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 168, 20);
        this.fmlBuffer[169] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 169, 20);
        this.fmlBuffer[170] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 170, 20);
        this.fmlBuffer[171] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 171, 20);
        this.fmlBuffer[172] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 172, 20);
        this.fmlBuffer[173] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 173, 20);
        this.fmlBuffer[174] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 174, 20);
        this.fmlBuffer[175] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 175, 20);
        this.fmlBuffer[176] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 176, 20);
        this.fmlBuffer[177] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 177, 20);
        this.fmlBuffer[178] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 178, 20);
        this.fmlBuffer[179] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 179, 20);
        this.fmlBuffer[180] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 180, 20);
        this.fmlBuffer[181] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 181, 20);
        this.fmlBuffer[182] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 182, 20);
        this.fmlBuffer[183] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 183, 20);
        this.fmlBuffer[184] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 184, 20);
        this.fmlBuffer[185] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 185, 20);
        this.fmlBuffer[186] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 186, 20);
        this.fmlBuffer[187] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 187, 20);
        this.fmlBuffer[188] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 188, 20);
        this.fmlBuffer[189] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 189, 20);
        this.fmlBuffer[190] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 190, 20);
        this.fmlBuffer[191] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 191, 20);
        this.fmlBuffer[192] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 192, 20);
        this.fmlBuffer[193] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 193, 20);
        this.fmlBuffer[194] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 194, 20);
        this.fmlBuffer[195] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 195, 20);
        this.fmlBuffer[196] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 196, 20);
        this.fmlBuffer[197] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 197, 20);
        this.fmlBuffer[198] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 198, 20);
        this.fmlBuffer[199] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 199, 20);
        this.fmlBuffer[200] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 200, 20);
        this.fmlBuffer[201] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 201, 20);
        this.fmlBuffer[202] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 202, 20);
        this.fmlBuffer[203] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 203, 20);
        this.fmlBuffer[204] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 204, 20);
        this.fmlBuffer[205] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 205, 20);
        this.fmlBuffer[206] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 206, 20);
        this.fmlBuffer[207] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 207, 20);
        this.fmlBuffer[208] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 208, 20);
        this.fmlBuffer[209] = new FmlField("PBANPYMROWID", FmlField.TYPE_STRING, 19, null, 209, 1);
        this.fmlBuffer[210] = new FmlField("PBANPYMBAN", FmlField.TYPE_INTEGER, -1, null, 210, 1);
        this.fmlBuffer[211] = new FmlField("ENT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 211, 1);
        this.fmlBuffer[212] = new FmlField("DEPOSIT_DATE", FmlField.TYPE_STRING, 9, null, 212, 1);
        this.fmlBuffer[213] = new FmlField("ORIGINAL_AMT", FmlField.TYPE_DOUBLE, -1, null, 213, 1);
        this.fmlBuffer[214] = new FmlField("CUSTOMER_PYM_DATE", FmlField.TYPE_STRING, 9, null, 214, 1);
        this.fmlBuffer[215] = new FmlField("PACT_ROWID", FmlField.TYPE_STRING, 19, null, 215, 1);
        this.fmlBuffer[216] = new FmlField("ACTV_SEQ_NO", FmlField.TYPE_SHORT, -1, null, 216, 1);
        this.fmlBuffer[217] = new FmlField("ACTV_CODE", FmlField.TYPE_STRING, 5, null, 217, 1);
        this.fmlBuffer[218] = new FmlField("ACTV_AMT", FmlField.TYPE_DOUBLE, -1, null, 218, 1);
        this.fmlBuffer[219] = new FmlField("PAYMENT_METHOD", FmlField.TYPE_STRING, 3, null, 219, 1);
        this.fmlBuffer[220] = new FmlField("PAYMENT_SUB_METHOD", FmlField.TYPE_STRING, 3, null, 220, 1);
    }
    ...
    public Integer get_NEXT_CYCLE_CLOSE_DAY() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[90].getValue(0)));
    }
    ...
    public Integer get_FU_COUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[91].getValue(0));
    }
    ...
    public Integer get_LNKRECCUSTOMER_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[120].getValue(nIndex));
    }
    ...
    public Integer get_FOREIGN_SEQ_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[125].getValue(nIndex));
    }
    ...
    public Integer get_NAMERECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[142].getValue(nIndex)));
    }
    ...
    public Integer get_NAMERECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[155].getValue(nIndex)));
    }
    ...
    public Integer get_ADDRESSRECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[170].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[173].getValue(nIndex)));
    }
    ...
    public Integer get_ADDRESSRECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[193].getValue(nIndex)));
    }
