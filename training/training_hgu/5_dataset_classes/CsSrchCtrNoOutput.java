 ...
 */
public class CsSrchCtrNoOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsSrchCtrNoOutput.
     *
     * @throws FMLManipulationException
     */
    public CsSrchCtrNoOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsSrchCtrNoOutput() {
    }

    /**
     * Creates a new instance of CsSrchCtrNoOutput.
     *
     * @param ds Output dataset from CsSrchCtrNo service.
     * @throws FMLManipulationException
     */
    public CsSrchCtrNoOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[16] = new FmlField("CONTRACT_NO", FmlField.TYPE_STRING, 11, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("SEARCH_IND", FmlField.TYPE_BYTE, -1, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("DEPARTMENT_CODE", FmlField.TYPE_STRING, 5, null, 19, 1);
        ...
        this.fmlBuffer[22] = new FmlField("ROWID", FmlField.TYPE_STRING, 19, null, 22, 1000);
        this.fmlBuffer[23] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 23, 1000);
        this.fmlBuffer[24] = new FmlField("ACCOUNT_TYPE", FmlField.TYPE_BYTE, -1, null, 24, 1000);
        this.fmlBuffer[25] = new FmlField("BAN_STATUS", FmlField.TYPE_BYTE, -1, null, 25, 1000);
        this.fmlBuffer[26] = new FmlField("STATUS_LAST_DATE", FmlField.TYPE_STRING, 9, null, 26, 1000);
        this.fmlBuffer[27] = new FmlField("BL_HIER_BAN_IND", FmlField.TYPE_BYTE, -1, null, 27, 1000);
        this.fmlBuffer[28] = new FmlField("VIP_IND", FmlField.TYPE_BYTE, -1, null, 28, 1000);
        this.fmlBuffer[29] = new FmlField("ACCOUNT_SUB_TYPE", FmlField.TYPE_STRING, 3, null, 29, 1000);
        this.fmlBuffer[30] = new FmlField("BILL_CYCLE", FmlField.TYPE_SHORT, -1, null, 30, 1000);
        this.fmlBuffer[31] = new FmlField("START_SERVICE_DATE", FmlField.TYPE_STRING, 9, null, 31, 1000);
        this.fmlBuffer[32] = new FmlField("AR_BALANCE", FmlField.TYPE_DOUBLE, -1, null, 32, 1000);
        this.fmlBuffer[33] = new FmlField("BL_BILL_PROD_IND", FmlField.TYPE_BYTE, -1, null, 33, 1000);
        this.fmlBuffer[34] = new FmlField("CURR_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 34, 1000);
        this.fmlBuffer[35] = new FmlField("NEXT_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 35, 1000);
        this.fmlBuffer[36] = new FmlField("NEXT_CONF_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 36, 1000);
        this.fmlBuffer[37] = new FmlField("SUBS_ROWID", FmlField.TYPE_STRING, 19, null, 37, 1000);
        this.fmlBuffer[38] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 38, 1000);
        this.fmlBuffer[39] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 39, 1000);
        this.fmlBuffer[40] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, null, 40, 1000);
        this.fmlBuffer[41] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 41, 1000);
        this.fmlBuffer[42] = new FmlField("ADR_ROWID", FmlField.TYPE_STRING, 19, null, 42, 1000);
        ...
        this.fmlBuffer[51] = new FmlField("CTNSRCHARRNAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 51, 1000);
    ...
    /**
     * Retrieves the value of the 'SEARCH_IND' field in the FML buffer.
     *
     * @return Value of 'SEARCH_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_SEARCH_IND() throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'DEPARTMENT_CODE' field in the FML buffer.
     *
     * @return Value of 'DEPARTMENT_CODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_DEPARTMENT_CODE() throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'CTNSRCHARRNAME_FORMAT' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 1000).
     * @return Value of 'CTNSRCHARRNAME_FORMAT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_CTNSRCHARRNAME_FORMAT(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[51].getValue(nIndex)));
    }

    /**
     * Retrieves number of values defined for 'CTNSRCHARRNAME_FORMAT' field in the FML buffer.
     *
     * @return Number of values defined for 'CTNSRCHARRNAME_FORMAT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_CTNSRCHARRNAME_FORMAT_size() throws FMLManipulationException {
