 ...
 */
public class CsMoveSubLnInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsMoveSubLnInput
     *
     * @throws FMLManipulationException
     */
    public CsMoveSubLnInput() throws FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csMoveSubLn", 49);
        ...
        this.fmlBuffer[17] = new FmlField("SOURCESUBNO", FmlField.TYPE_STRING, 21, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("SOURCESUBID", FmlField.TYPE_INTEGER, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("TARGETBAN", FmlField.TYPE_INTEGER, -1, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("TARGETSUBNO", FmlField.TYPE_STRING, 21, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("TARGETSUBID", FmlField.TYPE_INTEGER, -1, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("LOANSOCCODE", FmlField.TYPE_STRING, 10, null, 22, 1);
        this.fmlBuffer[23] = new FmlField("LOANSEQNO", FmlField.TYPE_INTEGER, -1, null, 23, 1);
        ...
        this.fmlBuffer[47] = new FmlField("SOURCE_BAN_LAST_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 47, 1);
        this.fmlBuffer[48] = new FmlField("SOURCE_BAN_LAST_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 48, 1);
    }
    ...
    /**
     * Retrieves the value of the 'SOURCESUBNO' field in the FML buffer.
     *
     * @return Value of 'SOURCESUBNO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_SOURCESUBNO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[17].getValue(0));
    }

    /**
     * Sets the value of the 'SOURCESUBNO' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_SOURCESUBNO(String value) throws FMLManipulationException {
        this.fmlBuffer[17].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'SOURCESUBID' field in the FML buffer.
     *
     * @return Value of 'SOURCESUBID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_SOURCESUBID() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[18].getValue(0));
    }

    /**
     * Sets the value of the 'SOURCESUBID' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_SOURCESUBID(Integer value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'TARGETSUBNO' field in the FML buffer.
     *
     * @return Value of 'TARGETSUBNO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_TARGETSUBNO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[20].getValue(0));
    }

    /**
     * Sets the value of the 'TARGETSUBNO' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_TARGETSUBNO(String value) throws FMLManipulationException {
        this.fmlBuffer[20].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'TARGETSUBID' field in the FML buffer.
     *
     * @return Value of 'TARGETSUBID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_TARGETSUBID() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[21].getValue(0));
    }

    /**
     * Sets the value of the 'TARGETSUBID' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_TARGETSUBID(Integer value) throws FMLManipulationException {
        this.fmlBuffer[21].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'LOANSOCCODE' field in the FML buffer.
     *
     * @return Value of 'LOANSOCCODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_LOANSOCCODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[22].getValue(0));
    }

    /**
     * Sets the value of the 'LOANSOCCODE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 10.
     * @throws FMLManipulationException
     */
    public void set_LOANSOCCODE(String value) throws FMLManipulationException {
        this.fmlBuffer[22].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'LOANSEQNO' field in the FML buffer.
     *
     * @return Value of 'LOANSEQNO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_LOANSEQNO() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[23].getValue(0));
    }

    /**
     * Sets the value of the 'LOANSEQNO' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_LOANSEQNO(Integer value) throws FMLManipulationException {
    ...
    public void set_SOURCE_BAN_LAST_UPDATE_STAMP(Integer value) throws FMLManipulationException {
        this.fmlBuffer[48].setValue(0, TypeConverter.integerToShort(value));
    }
}