...
public class ArSvBanSvcInput extends ServiceInput {
    ...
    public ArSvBanSvcInput() throws FMLManipulationException {
        ...
        this.fmlBuffer[58] = new FmlField("SOC_QUANTITY", FmlField.TYPE_INTEGER, -1, null, 58, 50);
        this.fmlBuffer[59] = new FmlField("BILL_TEXT", FmlField.TYPE_STRING, 41, null, 59, 50);
        this.fmlBuffer[60] = new FmlField("FULL_AMT", FmlField.TYPE_DOUBLE, -1, null, 60, 50);
        this.fmlBuffer[61] = new FmlField("FIRST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 61, 50);
        this.fmlBuffer[62] = new FmlField("OTHER_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 62, 50);
        this.fmlBuffer[63] = new FmlField("LAST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 63, 50);
        this.fmlBuffer[64] = new FmlField("NO_OF_INSTALLMENTS", FmlField.TYPE_SHORT, -1, null, 64, 50);
        this.fmlBuffer[65] = new FmlField("PSRVFTRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 65, 1);
        this.fmlBuffer[66] = new FmlField("PSRVFTRBUFROWID", FmlField.TYPE_STRING, 19, null, 66, 500);
        this.fmlBuffer[67] = new FmlField("PSRVFTRBUFSOC", FmlField.TYPE_STRING, 10, null, 67, 500);
        this.fmlBuffer[68] = new FmlField("PSRVFTRBUFSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 68, 500);
        this.fmlBuffer[69] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 69, 500);
        this.fmlBuffer[70] = new FmlField("MPS_FTR_CODE", FmlField.TYPE_STRING, 7, null, 70, 500);
        this.fmlBuffer[71] = new FmlField("FTR_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 71, 500);
        this.fmlBuffer[72] = new FmlField("FTR_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 72, 500);
        this.fmlBuffer[73] = new FmlField("FTR_EFF_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 73, 500);
        this.fmlBuffer[74] = new FmlField("FTR_EXP_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 74, 500);
        this.fmlBuffer[75] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 75, 500);
        this.fmlBuffer[76] = new FmlField("FTR_MODE", FmlField.TYPE_BYTE, -1, null, 76, 500);
        this.fmlBuffer[77] = new FmlField("PSRVFTRBUFSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 77, 500);
        this.fmlBuffer[78] = new FmlField("FTR_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 78, 500);
        this.fmlBuffer[79] = new FmlField("FTR_ADD_PARAM", FmlField.TYPE_STRING, 301, null, 79, 500);
        this.fmlBuffer[80] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, null, 80, 500);
        this.fmlBuffer[81] = new FmlField("PSRVFTRBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 81, 500);
        this.fmlBuffer[82] = new FmlField("PSRVFTRBUFCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 82, 500);
        this.fmlBuffer[83] = new FmlField("FTR_SPECIAL_TELNO", FmlField.TYPE_STRING, 21, null, 83, 500);
        this.fmlBuffer[84] = new FmlField("SWITCH_ACT_NEEDED", FmlField.TYPE_BYTE, -1, null, 84, 500);
        this.fmlBuffer[85] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, null, 85, 500);
        this.fmlBuffer[86] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, null, 86, 500);
        this.fmlBuffer[87] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 87, 500);
        this.fmlBuffer[88] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, null, 88, 500);
        this.fmlBuffer[89] = new FmlField("MANUAL_RC_RATE", FmlField.TYPE_DOUBLE, -1, null, 89, 500);
        this.fmlBuffer[90] = new FmlField("MANUAL_RC_EXP_DATE", FmlField.TYPE_STRING, 9, null, 90, 500);
        this.fmlBuffer[91] = new FmlField("MANUAL_RC_EFF_DATE", FmlField.TYPE_STRING, 9, null, 91, 500);
        this.fmlBuffer[92] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 92, 1);
        this.fmlBuffer[93] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 93, 50);
        this.fmlBuffer[94] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 94, 50);
        this.fmlBuffer[95] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 95, 50);
        this.fmlBuffer[96] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 96, 50);
        this.fmlBuffer[97] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 97, 50);
        this.fmlBuffer[98] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 98, 50);
        this.fmlBuffer[99] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 99, 50);
        this.fmlBuffer[100] = new FmlField("P1", FmlField.TYPE_STRING, 51, null, 100, 50);
        this.fmlBuffer[101] = new FmlField("P2", FmlField.TYPE_STRING, 51, null, 101, 50);
        this.fmlBuffer[102] = new FmlField("P3", FmlField.TYPE_STRING, 51, null, 102, 50);
        this.fmlBuffer[103] = new FmlField("P4", FmlField.TYPE_STRING, 51, null, 103, 50);
        this.fmlBuffer[104] = new FmlField("P5", FmlField.TYPE_STRING, 51, null, 104, 50);
        this.fmlBuffer[105] = new FmlField("P6", FmlField.TYPE_STRING, 51, null, 105, 50);
        this.fmlBuffer[106] = new FmlField("P7", FmlField.TYPE_STRING, 51, null, 106, 50);
        this.fmlBuffer[107] = new FmlField("P8", FmlField.TYPE_STRING, 51, null, 107, 50);
        this.fmlBuffer[108] = new FmlField("P9", FmlField.TYPE_STRING, 51, null, 108, 50);
        this.fmlBuffer[109] = new FmlField("P10", FmlField.TYPE_STRING, 51, null, 109, 50);
        this.fmlBuffer[110] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 110, 50);
        this.fmlBuffer[111] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 111, 50);
        this.fmlBuffer[112] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 112, 50);
        this.fmlBuffer[113] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 113, 50);
        this.fmlBuffer[114] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 114, 50);
        this.fmlBuffer[115] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 115, 50);
        this.fmlBuffer[116] = new FmlField("PCSFRNDFMLROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 116, 1);
        this.fmlBuffer[117] = new FmlField("ACTIONIND", FmlField.TYPE_BYTE, -1, null, 117, 10000);
        this.fmlBuffer[118] = new FmlField("PCSFANDFRECROWID", FmlField.TYPE_STRING, 19, null, 118, 10000);
        this.fmlBuffer[119] = new FmlField("PCSFANDFRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 119, 10000);
        this.fmlBuffer[120] = new FmlField("PCSFANDFRECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 120, 10000);
        this.fmlBuffer[121] = new FmlField("PERSONAL_TEL", FmlField.TYPE_STRING, 21, null, 121, 10000);
        this.fmlBuffer[122] = new FmlField("PERSONAL_TEL_TO", FmlField.TYPE_STRING, 21, null, 122, 10000);
        this.fmlBuffer[123] = new FmlField("FF_SOC", FmlField.TYPE_STRING, 10, null, 123, 10000);
        this.fmlBuffer[124] = new FmlField("PLAN_CODE", FmlField.TYPE_STRING, 10, null, 124, 10000);
        this.fmlBuffer[125] = new FmlField("DISCOUNT_TYPE", FmlField.TYPE_BYTE, -1, null, 125, 10000);
        this.fmlBuffer[126] = new FmlField("START_HOUR", FmlField.TYPE_STRING, 7, null, 126, 10000);
        this.fmlBuffer[127] = new FmlField("DURATION", FmlField.TYPE_DOUBLE, -1, null, 127, 10000);
    }
    ...
    public void set_NO_OF_INSTALLMENTS(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[64].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_PSRVFTRBUFCAMPAIGN_SEQ(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[82].getValue(nIndex));
    }
