 ...
 */
public class CsValFandFLstOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsValFandFLstOutput.
     *
     * @throws FMLManipulationException
     */
    public CsValFandFLstOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsValFandFLstOutput() {
    }

    /**
     * Creates a new instance of CsValFandFLstOutput.
     *
     * @param ds Output dataset from CsValFandFLst service.
     * @throws FMLManipulationException
     */
    public CsValFandFLstOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[21] = new FmlField("ERROR_CODE", FmlField.TYPE_SHORT, -1, null, 21, 10000);
    }
    ...
    /**
     * Retrieves the value of the 'ERROR_CODE' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 10000).
     * @return Value of 'ERROR_CODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_ERROR_CODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[21].getValue(nIndex)));
    }

    /**
     * Retrieves number of values defined for 'ERROR_CODE' field in the FML buffer.
     *
     * @return Number of values defined for 'ERROR_CODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_ERROR_CODE_size() throws FMLManipulationException {
