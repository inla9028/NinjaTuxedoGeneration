...
public class ArSvDiscInput extends ServiceInput {
     ...
     */
    public ArSvDiscInput() throws FMLManipulationException {
        ...
        this.fmlBuffer[40] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 40, 50);
        this.fmlBuffer[41] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 41, 50);
        this.fmlBuffer[42] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 42, 50);
        this.fmlBuffer[43] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 43, 50);
        this.fmlBuffer[44] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 44, 50);
        this.fmlBuffer[45] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 45, 50);
        this.fmlBuffer[46] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 46, 50);
        this.fmlBuffer[47] = new FmlField("P1", FmlField.TYPE_STRING, 51, null, 47, 50);
        this.fmlBuffer[48] = new FmlField("P2", FmlField.TYPE_STRING, 51, null, 48, 50);
        this.fmlBuffer[49] = new FmlField("P3", FmlField.TYPE_STRING, 51, null, 49, 50);
        this.fmlBuffer[50] = new FmlField("P4", FmlField.TYPE_STRING, 51, null, 50, 50);
        this.fmlBuffer[51] = new FmlField("P5", FmlField.TYPE_STRING, 51, null, 51, 50);
        this.fmlBuffer[52] = new FmlField("P6", FmlField.TYPE_STRING, 51, null, 52, 50);
        this.fmlBuffer[53] = new FmlField("P7", FmlField.TYPE_STRING, 51, null, 53, 50);
        this.fmlBuffer[54] = new FmlField("P8", FmlField.TYPE_STRING, 51, null, 54, 50);
        this.fmlBuffer[55] = new FmlField("P9", FmlField.TYPE_STRING, 51, null, 55, 50);
        this.fmlBuffer[56] = new FmlField("P10", FmlField.TYPE_STRING, 51, null, 56, 50);
        this.fmlBuffer[57] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 57, 50);
        this.fmlBuffer[58] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 58, 50);
        this.fmlBuffer[59] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 59, 50);
        this.fmlBuffer[60] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 60, 50);
        this.fmlBuffer[61] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 61, 50);
        this.fmlBuffer[62] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 62, 50);
    }
