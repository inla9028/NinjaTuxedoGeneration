...
public class CsChgCtnInput extends ServiceInput {
    ...
    public CsChgCtnInput() throws FMLManipulationException {
        ...
        this.fmlBuffer[192] = new FmlField("PNEWCTNROWID", FmlField.TYPE_STRING, 19, null, 192, 1);
        this.fmlBuffer[193] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 193, 1);
        this.fmlBuffer[194] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 194, 1);
        this.fmlBuffer[195] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 195, 1);
        this.fmlBuffer[196] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 196, 1);
        this.fmlBuffer[197] = new FmlField("PNEWCTNOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 197, 1);
        this.fmlBuffer[198] = new FmlField("PNEWCTNAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 198, 1);
        this.fmlBuffer[199] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 199, 1);
        this.fmlBuffer[200] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 200, 1);
        this.fmlBuffer[201] = new FmlField("PNEWCTNEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 201, 1);
        this.fmlBuffer[202] = new FmlField("INIT_ACTIVATION_DATE", FmlField.TYPE_STRING, 9, null, 202, 1);
        this.fmlBuffer[203] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 203, 1);
        this.fmlBuffer[204] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 204, 1);
        this.fmlBuffer[205] = new FmlField("ORIGINAL_INIT_DATE", FmlField.TYPE_STRING, 15, null, 205, 1);
        this.fmlBuffer[206] = new FmlField("SUB_STATUS_LAST_ACT", FmlField.TYPE_STRING, 4, null, 206, 1);
        this.fmlBuffer[207] = new FmlField("SUB_STATUS_RSN_CODE", FmlField.TYPE_STRING, 5, null, 207, 1);
        this.fmlBuffer[208] = new FmlField("PNEWCTNPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 208, 1);
        this.fmlBuffer[209] = new FmlField("CUSTOMER_BAN", FmlField.TYPE_INTEGER, -1, null, 209, 1);
        this.fmlBuffer[210] = new FmlField("CTN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 210, 1);
        this.fmlBuffer[211] = new FmlField("REQ_ST_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 211, 1);
        this.fmlBuffer[212] = new FmlField("REQ_END_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 212, 1);
        this.fmlBuffer[213] = new FmlField("COMMIT_START_DATE", FmlField.TYPE_STRING, 9, null, 213, 1);
        this.fmlBuffer[214] = new FmlField("COMMIT_END_DATE", FmlField.TYPE_STRING, 9, null, 214, 1);
        this.fmlBuffer[215] = new FmlField("COMMIT_REASON_CODE", FmlField.TYPE_STRING, 4, null, 215, 1);
        this.fmlBuffer[216] = new FmlField("PNEWCTNCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 216, 1);
        this.fmlBuffer[217] = new FmlField("PNEWCTNSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 217, 1);
        this.fmlBuffer[218] = new FmlField("CONTRACT_NO", FmlField.TYPE_STRING, 11, null, 218, 1);
        this.fmlBuffer[219] = new FmlField("CNT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 219, 1);
        this.fmlBuffer[220] = new FmlField("PNEWCTNDEALER_CODE", FmlField.TYPE_STRING, 6, null, 220, 1);
        this.fmlBuffer[221] = new FmlField("ORG_DEALER_CODE", FmlField.TYPE_STRING, 6, null, 221, 1);
        this.fmlBuffer[222] = new FmlField("PNEWCTNSALES_AGENT", FmlField.TYPE_STRING, 6, null, 222, 1);
        this.fmlBuffer[223] = new FmlField("ORG_SALES_AGENT", FmlField.TYPE_STRING, 6, null, 223, 1);
        this.fmlBuffer[224] = new FmlField("REQ_DEPOSIT_AMT", FmlField.TYPE_DOUBLE, -1, null, 224, 1);
        this.fmlBuffer[225] = new FmlField("LEADING_NUMBER", FmlField.TYPE_STRING, 21, null, 225, 1);
        this.fmlBuffer[226] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, null, 226, 1);
        this.fmlBuffer[227] = new FmlField("NEXT_CTN", FmlField.TYPE_STRING, 21, null, 227, 1);
        this.fmlBuffer[228] = new FmlField("NEXT_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 228, 1);
        this.fmlBuffer[229] = new FmlField("PRV_CTN", FmlField.TYPE_STRING, 21, null, 229, 1);
        this.fmlBuffer[230] = new FmlField("PRV_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 230, 1);
        this.fmlBuffer[231] = new FmlField("NEXT_BAN", FmlField.TYPE_INTEGER, -1, null, 231, 1);
        this.fmlBuffer[232] = new FmlField("NEXT_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 232, 1);
        this.fmlBuffer[233] = new FmlField("PRV_BAN", FmlField.TYPE_INTEGER, -1, null, 233, 1);
        this.fmlBuffer[234] = new FmlField("PRV_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 234, 1);
        this.fmlBuffer[235] = new FmlField("SUB_STS_ISSUE_DATE", FmlField.TYPE_STRING, 9, null, 235, 1);
        this.fmlBuffer[236] = new FmlField("ACTIVATE_WAIVE_RSN", FmlField.TYPE_STRING, 7, null, 236, 1);
        this.fmlBuffer[237] = new FmlField("EARLIEST_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 237, 1);
        this.fmlBuffer[238] = new FmlField("SUB_ACTV_LOCATION", FmlField.TYPE_STRING, 5, null, 238, 1);
        this.fmlBuffer[239] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 239, 1);
        this.fmlBuffer[240] = new FmlField("CUST_WATCH_DATE", FmlField.TYPE_STRING, 9, null, 240, 1);
        this.fmlBuffer[241] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 241, 1);
        this.fmlBuffer[242] = new FmlField("CREDIT_WATCH_PIN_CD", FmlField.TYPE_SHORT, -1, null, 242, 1);
        this.fmlBuffer[243] = new FmlField("SUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 243, 1);
        this.fmlBuffer[244] = new FmlField("LIMIT_RESERVED_DAYS", FmlField.TYPE_SHORT, -1, null, 244, 1);
        this.fmlBuffer[245] = new FmlField("FF_EXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 245, 1);
        this.fmlBuffer[246] = new FmlField("FLEX_IND", FmlField.TYPE_BYTE, -1, null, 246, 1);
        this.fmlBuffer[247] = new FmlField("DUO_IND", FmlField.TYPE_BYTE, -1, null, 247, 1);
        this.fmlBuffer[248] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, null, 248, 1);
        this.fmlBuffer[249] = new FmlField("SUB_DEPARTMENT_CD", FmlField.TYPE_STRING, 5, null, 249, 1);
        this.fmlBuffer[250] = new FmlField("LAST_SUBS_DISC_DT", FmlField.TYPE_STRING, 9, null, 250, 1);
        this.fmlBuffer[251] = new FmlField("LAST_SUBS_DISC_DT_UD", FmlField.TYPE_STRING, 9, null, 251, 1);
        this.fmlBuffer[252] = new FmlField("LAST_SUBSCR_DISC_SN", FmlField.TYPE_SHORT, -1, null, 252, 1);
        this.fmlBuffer[253] = new FmlField("LAST_SUBSCR_DISC_SN_UD", FmlField.TYPE_SHORT, -1, null, 253, 1);
        this.fmlBuffer[254] = new FmlField("PNI", FmlField.TYPE_STRING, 11, null, 254, 1);
        this.fmlBuffer[255] = new FmlField("RMS_REF_STORE_ID", FmlField.TYPE_STRING, 5, null, 255, 1);
        this.fmlBuffer[256] = new FmlField("RMS_REF_TYPE", FmlField.TYPE_BYTE, -1, null, 256, 1);
        this.fmlBuffer[257] = new FmlField("RMS_REF_OD", FmlField.TYPE_INTEGER, -1, null, 257, 1);
        this.fmlBuffer[258] = new FmlField("DLR_ACT_FEE", FmlField.TYPE_DOUBLE, -1, null, 258, 1);
        this.fmlBuffer[259] = new FmlField("PREP_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 259, 1);
        this.fmlBuffer[260] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 260, 1);
        this.fmlBuffer[261] = new FmlField("SUB_LANG", FmlField.TYPE_STRING, 3, null, 261, 1);
        this.fmlBuffer[262] = new FmlField("SMS_RCV_STYLE_CODE", FmlField.TYPE_STRING, 3, null, 262, 1);
        this.fmlBuffer[263] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 263, 1);
        this.fmlBuffer[264] = new FmlField("ALLOW_ADVERTISING_IND", FmlField.TYPE_BYTE, -1, null, 264, 1);
        this.fmlBuffer[265] = new FmlField("IVR_WRONG_ACCESS_NO", FmlField.TYPE_SHORT, -1, null, 265, 1);
        this.fmlBuffer[266] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, NinjaConfigurationReferenceTable.getThresholdAmt(), 266, 1);
        this.fmlBuffer[267] = new FmlField("PUBLISH_LEVEL", FmlField.TYPE_STRING, 31, null, 267, 1);
        this.fmlBuffer[268] = new FmlField("AUTO_RELEASE_IND", FmlField.TYPE_BYTE, -1, null, 268, 1);
        this.fmlBuffer[269] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, null, 269, 1);
        this.fmlBuffer[270] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, null, 270, 1);
        this.fmlBuffer[271] = new FmlField("OPERATOR_CW_LMT", FmlField.TYPE_DOUBLE, -1, null, 271, 1);
        this.fmlBuffer[272] = new FmlField("SEND_SMS_FOR_MATCH", FmlField.TYPE_BYTE, -1, null, 272, 1);
        this.fmlBuffer[273] = new FmlField("CPS_STATUS", FmlField.TYPE_BYTE, -1, null, 273, 1);
        this.fmlBuffer[274] = new FmlField("CPS_TRANSACTION", FmlField.TYPE_SHORT, -1, null, 274, 1);
        this.fmlBuffer[275] = new FmlField("CPS_TYPE", FmlField.TYPE_SHORT, -1, null, 275, 1);
        this.fmlBuffer[276] = new FmlField("ISP_PASS", FmlField.TYPE_STRING, 31, null, 276, 1);
        this.fmlBuffer[277] = new FmlField("ISP_TYPE", FmlField.TYPE_STRING, 3, null, 277, 1);
        this.fmlBuffer[278] = new FmlField("OPERATOR_TMP_DATE", FmlField.TYPE_STRING, 9, null, 278, 1);
        this.fmlBuffer[279] = new FmlField("OPERATOR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, null, 279, 1);
        this.fmlBuffer[280] = new FmlField("SUB_ORG_CD", FmlField.TYPE_STRING, 11, null, 280, 1);
        this.fmlBuffer[281] = new FmlField("ORG_MEMBER_NO", FmlField.TYPE_STRING, 21, null, 281, 1);
        this.fmlBuffer[282] = new FmlField("FIXED_AS_GSM_IND", FmlField.TYPE_BYTE, -1, null, 282, 1);
        this.fmlBuffer[283] = new FmlField("EARLY_PORT_OUT", FmlField.TYPE_BYTE, -1, null, 283, 1);
        this.fmlBuffer[284] = new FmlField("EARLY_PO_WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 284, 1);
        this.fmlBuffer[285] = new FmlField("EARLY_PO_WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 285, 1);
        this.fmlBuffer[286] = new FmlField("INTERNAL_CIRCUIT_ID", FmlField.TYPE_STRING, 21, null, 286, 1);
        this.fmlBuffer[287] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 287, 1);
        this.fmlBuffer[288] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 288, 1);
        this.fmlBuffer[289] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 289, 1);
        this.fmlBuffer[290] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 290, 1);
        this.fmlBuffer[291] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 291, 1);
        this.fmlBuffer[292] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 292, 1);
        this.fmlBuffer[293] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 293, 1);
        this.fmlBuffer[294] = new FmlField("ACT_COMPLETE_DATE", FmlField.TYPE_STRING, 9, null, 294, 1);
        this.fmlBuffer[295] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 295, 1);
        this.fmlBuffer[296] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 296, 20);
        this.fmlBuffer[297] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 297, 20);
        this.fmlBuffer[298] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 298, 20);
        this.fmlBuffer[299] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 299, 20);
        this.fmlBuffer[300] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 300, 20);
        this.fmlBuffer[301] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 301, 20);
        this.fmlBuffer[302] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 302, 20);
        this.fmlBuffer[303] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 303, 20);
        this.fmlBuffer[304] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 304, 20);
        this.fmlBuffer[305] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 305, 20);
        this.fmlBuffer[306] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 306, 20);
        this.fmlBuffer[307] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 307, 20);
        this.fmlBuffer[308] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 308, 20);
        this.fmlBuffer[309] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 309, 20);
        this.fmlBuffer[310] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 310, 20);
        this.fmlBuffer[311] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 311, 20);
        this.fmlBuffer[312] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 312, 20);
        this.fmlBuffer[313] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 313, 20);
        this.fmlBuffer[314] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 314, 20);
        this.fmlBuffer[315] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 315, 20);
        this.fmlBuffer[316] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 316, 20);
        this.fmlBuffer[317] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 317, 20);
        this.fmlBuffer[318] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 318, 20);
        this.fmlBuffer[319] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 319, 20);
        this.fmlBuffer[320] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 320, 20);
        this.fmlBuffer[321] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 321, 20);
        this.fmlBuffer[322] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 322, 20);
        this.fmlBuffer[323] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 323, 20);
        this.fmlBuffer[324] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 324, 20);
        this.fmlBuffer[325] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 325, 20);
        this.fmlBuffer[326] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 326, 20);
        this.fmlBuffer[327] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 327, 20);
        this.fmlBuffer[328] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 328, 20);
        this.fmlBuffer[329] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 329, 20);
        this.fmlBuffer[330] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 330, 20);
        this.fmlBuffer[331] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 331, 20);
        this.fmlBuffer[332] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 51, null, 332, 20);
        this.fmlBuffer[333] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 333, 20);
        this.fmlBuffer[334] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 334, 20);
        this.fmlBuffer[335] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 335, 20);
        this.fmlBuffer[336] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 336, 20);
        this.fmlBuffer[337] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 337, 20);
        this.fmlBuffer[338] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 338, 20);
        this.fmlBuffer[339] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 339, 20);
        this.fmlBuffer[340] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 340, 20);
        this.fmlBuffer[341] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 341, 20);
        this.fmlBuffer[342] = new FmlField("TPID", FmlField.TYPE_STRING, 37, null, 342, 20);
        this.fmlBuffer[343] = new FmlField("E_FAKTURA_REF", FmlField.TYPE_INTEGER, -1, null, 343, 20);
        this.fmlBuffer[344] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 344, 20);
        this.fmlBuffer[345] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 345, 20);
        this.fmlBuffer[346] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 346, 20);
        this.fmlBuffer[347] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 347, 20);
        this.fmlBuffer[348] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 348, 20);
        this.fmlBuffer[349] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 349, 20);
        this.fmlBuffer[350] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 350, 20);
        this.fmlBuffer[351] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 351, 20);
        this.fmlBuffer[352] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 352, 20);
        this.fmlBuffer[353] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 353, 20);
        this.fmlBuffer[354] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 354, 20);
        this.fmlBuffer[355] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 355, 20);
        this.fmlBuffer[356] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 356, 20);
        this.fmlBuffer[357] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 357, 20);
        this.fmlBuffer[358] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 358, 20);
        this.fmlBuffer[359] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 359, 20);
        this.fmlBuffer[360] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 360, 20);
        this.fmlBuffer[361] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 361, 20);
        this.fmlBuffer[362] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 362, 20);
        this.fmlBuffer[363] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 363, 20);
        this.fmlBuffer[364] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 364, 20);
        this.fmlBuffer[365] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 365, 20);
        this.fmlBuffer[366] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 366, 20);
        this.fmlBuffer[367] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 367, 20);
        this.fmlBuffer[368] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 368, 20);
        this.fmlBuffer[369] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 369, 20);
        this.fmlBuffer[370] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 370, 20);
        this.fmlBuffer[371] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 371, 20);
        this.fmlBuffer[372] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 372, 20);
        this.fmlBuffer[373] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 373, 20);
        this.fmlBuffer[374] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 374, 20);
        this.fmlBuffer[375] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 375, 20);
        this.fmlBuffer[376] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 376, 20);
        this.fmlBuffer[377] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 377, 20);
        this.fmlBuffer[378] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 378, 20);
        this.fmlBuffer[379] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 379, 20);
        this.fmlBuffer[380] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 380, 20);
        this.fmlBuffer[381] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 381, 20);
        this.fmlBuffer[382] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 382, 20);
        this.fmlBuffer[383] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 383, 20);
        this.fmlBuffer[384] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 384, 20);
        this.fmlBuffer[385] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 385, 20);
        this.fmlBuffer[386] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 386, 20);
        this.fmlBuffer[387] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 387, 20);
        this.fmlBuffer[388] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 388, 20);
        this.fmlBuffer[389] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 389, 20);
        this.fmlBuffer[390] = new FmlField("PCHGCTNRECBAN", FmlField.TYPE_INTEGER, -1, null, 390, 1);
        this.fmlBuffer[391] = new FmlField("OLD_CTN", FmlField.TYPE_STRING, 21, null, 391, 1);
        this.fmlBuffer[392] = new FmlField("PCHGCTNRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 392, 1);
        this.fmlBuffer[393] = new FmlField("PCHGCTNRECACTIVITY_DATE", FmlField.TYPE_STRING, 9, null, 393, 1);
        this.fmlBuffer[394] = new FmlField("OTHER_NL", FmlField.TYPE_STRING, 4, null, 394, 1);
        this.fmlBuffer[395] = new FmlField("INT_ORDER_ID_OF_TEMP_MSISDN", FmlField.TYPE_DOUBLE, -1, null, 395, 1);
        this.fmlBuffer[396] = new FmlField("ACTIVITY_CTN_FEE", FmlField.TYPE_DOUBLE, -1, null, 396, 1);
        this.fmlBuffer[397] = new FmlField("NUMBER_LOCATION", FmlField.TYPE_STRING, 4, null, 397, 1);
        this.fmlBuffer[398] = new FmlField("DEPOSITTERMSIND", FmlField.TYPE_BYTE, -1, null, 398, 1);
        this.fmlBuffer[399] = new FmlField("WAIVING_IND", FmlField.TYPE_BYTE, -1, null, 399, 1);
        this.fmlBuffer[400] = new FmlField("WAIVING_REASON_CODE", FmlField.TYPE_STRING, 5, null, 400, 1);
        this.fmlBuffer[401] = new FmlField("PINSTLBUFROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 401, 1);
        this.fmlBuffer[402] = new FmlField("INSTALLMENT_AMT", FmlField.TYPE_DOUBLE, -1, null, 402, 12);
        this.fmlBuffer[403] = new FmlField("INSTALLMENT_DATE", FmlField.TYPE_STRING, 9, null, 403, 12);
        this.fmlBuffer[404] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 404, 1);
        this.fmlBuffer[405] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 405, 2);
        this.fmlBuffer[406] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 406, 2);
    }
    ...
    public Integer get_NEXT_BAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[231].getValue(0));
    }
    ...
    public Integer get_PRV_BAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[233].getValue(0));
    }
    ...
    public Double get_CUST_WATCH_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[239].getValue(0));
    }
    ...
    public Integer get_RMS_REF_OD() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[257].getValue(0));
    }
    ...
    public Integer get_SUBSCRIBER_ID() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[260].getValue(0));
    }
    ...
    public Integer get_CPS_TYPE() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[275].getValue(0)));
    }
    ...
    public void set_CPS_TYPE(Integer value) throws FMLManipulationException {
        this.fmlBuffer[275].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_EARLY_PO_WAIVE_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[284].getValue(0)));
    }
    ...
    public void set_EARLY_PO_WAIVE_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[284].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_PAPER_WORK_STATUS() throws FMLManipulationException {
        return ((String) this.fmlBuffer[288].getValue(0));
    }
    ...
    public Integer get_PNAMEADRBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[295].getValue(0));
    }
    ...
    public Integer get_NAMERECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[323].getValue(nIndex)));
    }
    ...
    public void set_NAMERECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[323].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_KOB(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[333].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[351].getValue(nIndex));
    }
    ...
    public String get_CO_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[373].getValue(nIndex)));
    }
    ...
    public void set_CO_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[373].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_ADDRESSRECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[374].getValue(nIndex)));
    }
    ...
    public void set_ADDRESSRECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[374].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_INT_ORDER_ID_OF_TEMP_MSISDN() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[395].getValue(0));
    }
    ...
    public Double get_ACTIVITY_CTN_FEE() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[396].getValue(0));
    }
    ...
    public Double get_INSTALLMENT_AMT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[402].getValue(nIndex));
    }
    ...
    public Integer get_PFTRDEPBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[404].getValue(0));
    }
    ...
    public String get_DEPOSIT_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[405].getValue(nIndex)));
    }
    ...
    public void set_DEPOSIT_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[405].setValue(nIndex, TypeConverter.stringToByte(value));
    }
