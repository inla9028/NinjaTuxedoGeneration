 ...
 */
public class CsRsvMlCtnInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsRsvMlCtnInput
     *
     * @throws FMLManipulationException
     */
    public CsRsvMlCtnInput() throws FMLManipulationException {
        // Initialise FML buffer
        fmlBuffer = new FmlField[482];

        //// Get default values from DB
        //synchronized (this.defaultValuesPopulated) {
        //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
        //        defaultValues = getDefaultValues("csRsvMlCtn", 482);
        ...
        this.fmlBuffer[16] = new FmlField("RESACT", FmlField.TYPE_BYTE, -1, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 18, 500);
        this.fmlBuffer[19] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, null, 19, 500);
        this.fmlBuffer[20] = new FmlField("SIM", FmlField.TYPE_STRING, 21, null, 20, 500);
        this.fmlBuffer[21] = new FmlField("ROWID", FmlField.TYPE_STRING, 19, null, 21, 500);
        this.fmlBuffer[22] = new FmlField("PORT_NUMBER", FmlField.TYPE_STRING, 21, null, 22, 500);
        this.fmlBuffer[23] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 23, 500);
        this.fmlBuffer[24] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 24, 500);
        this.fmlBuffer[25] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 25, 500);
        this.fmlBuffer[26] = new FmlField("NPNUMINFORECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 26, 500);
        this.fmlBuffer[27] = new FmlField("NPNUMINFORECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 27, 500);
        this.fmlBuffer[28] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 28, 500);
        this.fmlBuffer[29] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 29, 500);
        this.fmlBuffer[30] = new FmlField("EXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 30, 500);
        this.fmlBuffer[31] = new FmlField("INT_ORDER_ID", FmlField.TYPE_DOUBLE, -1, null, 31, 500);
        this.fmlBuffer[32] = new FmlField("ORG_CUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 32, 500);
        this.fmlBuffer[33] = new FmlField("PORT_IND", FmlField.TYPE_BYTE, -1, null, 33, 500);
        this.fmlBuffer[34] = new FmlField("NUMBER_TYPE", FmlField.TYPE_BYTE, -1, null, 34, 500);
        this.fmlBuffer[35] = new FmlField("PORT_REQUEST_DATE", FmlField.TYPE_STRING, 15, null, 35, 500);
        this.fmlBuffer[36] = new FmlField("ORG_OPERATOR", FmlField.TYPE_STRING, 6, null, 36, 500);
        this.fmlBuffer[37] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 37, 500);
        this.fmlBuffer[38] = new FmlField("LAST_INT_ORD_ID", FmlField.TYPE_DOUBLE, -1, null, 38, 500);
        this.fmlBuffer[39] = new FmlField("FUNCTION_PORT_IND", FmlField.TYPE_BYTE, -1, null, 39, 500);
        this.fmlBuffer[40] = new FmlField("PASSIVE_IND", FmlField.TYPE_BYTE, -1, null, 40, 500);
        this.fmlBuffer[41] = new FmlField("AUTO_CONFIRM", FmlField.TYPE_BYTE, -1, null, 41, 500);
        this.fmlBuffer[42] = new FmlField("TEMPORARY_MSISDN", FmlField.TYPE_STRING, 21, null, 42, 500);
        this.fmlBuffer[43] = new FmlField("HANDLE_MODE", FmlField.TYPE_BYTE, -1, null, 43, 500);
        this.fmlBuffer[44] = new FmlField("SEND_IND", FmlField.TYPE_BYTE, -1, null, 44, 500);
        this.fmlBuffer[45] = new FmlField("ORDID_STR", FmlField.TYPE_STRING, 21, null, 45, 500);
        this.fmlBuffer[46] = new FmlField("LAST_ORDID_STR", FmlField.TYPE_STRING, 21, null, 46, 500);
        this.fmlBuffer[47] = new FmlField("ICC", FmlField.TYPE_STRING, 61, null, 47, 500);
        this.fmlBuffer[48] = new FmlField("CUSTOMER_NAME", FmlField.TYPE_STRING, 255, null, 48, 500);
        this.fmlBuffer[49] = new FmlField("CUSTOMER_ID_S", FmlField.TYPE_STRING, 61, null, 49, 500);
        this.fmlBuffer[50] = new FmlField("SERVICE_PROVIDER", FmlField.TYPE_STRING, 6, null, 50, 500);
        this.fmlBuffer[51] = new FmlField("MUNICIPALITY", FmlField.TYPE_STRING, 4, null, 51, 500);
        this.fmlBuffer[52] = new FmlField("RECIP_SERV_OPER", FmlField.TYPE_STRING, 6, null, 52, 500);
        this.fmlBuffer[53] = new FmlField("POINT_OF_CONNECTION", FmlField.TYPE_STRING, 61, null, 53, 500);
        this.fmlBuffer[54] = new FmlField("CSNPSPC", FmlField.TYPE_STRING, 7, null, 54, 500);
        this.fmlBuffer[55] = new FmlField("EIDNODSIGN", FmlField.TYPE_STRING, 21, null, 55, 500);
        this.fmlBuffer[56] = new FmlField("NPEIDNTYP", FmlField.TYPE_STRING, 21, null, 56, 500);
        this.fmlBuffer[57] = new FmlField("EIDNTYPNUMB", FmlField.TYPE_STRING, 21, null, 57, 500);
        this.fmlBuffer[58] = new FmlField("NPNEIDNODSIGN", FmlField.TYPE_STRING, 21, null, 58, 500);
        this.fmlBuffer[59] = new FmlField("NEIDNTYP", FmlField.TYPE_STRING, 21, null, 59, 500);
        this.fmlBuffer[60] = new FmlField("NEIDNTYPNUMB", FmlField.TYPE_STRING, 21, null, 60, 500);
        this.fmlBuffer[61] = new FmlField("CURR_SERV_OPER", FmlField.TYPE_STRING, 6, null, 61, 500);
        this.fmlBuffer[62] = new FmlField("ACTVFEEIND", FmlField.TYPE_BYTE, -1, null, 62, 1);
        this.fmlBuffer[63] = new FmlField("ACTIVATIONFEE", FmlField.TYPE_DOUBLE, -1, null, 63, 1);
        this.fmlBuffer[64] = new FmlField("CHANGEIND", FmlField.TYPE_BYTE, -1, null, 64, 1);
        this.fmlBuffer[65] = new FmlField("WAIVERSNIND", FmlField.TYPE_BYTE, -1, null, 65, 1);
        this.fmlBuffer[66] = new FmlField("WAIVERSN", FmlField.TYPE_STRING, 7, null, 66, 1);
        this.fmlBuffer[67] = new FmlField("NUMLOC", FmlField.TYPE_STRING, 4, null, 67, 1);
        this.fmlBuffer[68] = new FmlField("PPRWRK_STS_CD", FmlField.TYPE_STRING, 3, null, 68, 1);
        this.fmlBuffer[69] = new FmlField("RMSACTVIND", FmlField.TYPE_BYTE, -1, null, 69, 1);
        this.fmlBuffer[70] = new FmlField("RESERVE_TYPE", FmlField.TYPE_BYTE, -1, null, 70, 1);
        this.fmlBuffer[71] = new FmlField("PSOCBUFFERROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 71, 1);
        this.fmlBuffer[72] = new FmlField("PSOCBUFFERROWID", FmlField.TYPE_STRING, 19, null, 72, 50);
        this.fmlBuffer[73] = new FmlField("SOC", FmlField.TYPE_STRING, 10, null, 73, 50);
        this.fmlBuffer[74] = new FmlField("SOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 74, 50);
        this.fmlBuffer[75] = new FmlField("COMMITMENT_END_DATE", FmlField.TYPE_STRING, 9, null, 75, 50);
        this.fmlBuffer[76] = new FmlField("SERVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 76, 50);
        this.fmlBuffer[77] = new FmlField("PSOCBUFFEREFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 77, 50);
        this.fmlBuffer[78] = new FmlField("PSOCBUFFEREXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 78, 50);
        this.fmlBuffer[79] = new FmlField("SOC_LEVEL_CODE", FmlField.TYPE_BYTE, -1, null, 79, 50);
        this.fmlBuffer[80] = new FmlField("DEALER_CODE", FmlField.TYPE_STRING, 6, null, 80, 50);
        this.fmlBuffer[81] = new FmlField("SALES_AGENT", FmlField.TYPE_STRING, 6, null, 81, 50);
        this.fmlBuffer[82] = new FmlField("SRV_MODE", FmlField.TYPE_BYTE, -1, null, 82, 50);
        this.fmlBuffer[83] = new FmlField("SRV_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 83, 50);
        this.fmlBuffer[84] = new FmlField("SOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 84, 50);
        this.fmlBuffer[85] = new FmlField("SRV_TRX_ID", FmlField.TYPE_INTEGER, -1, null, 85, 50);
        this.fmlBuffer[86] = new FmlField("CAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 86, 50);
        this.fmlBuffer[87] = new FmlField("CAMPAIGN", FmlField.TYPE_STRING, 10, null, 87, 50);
        this.fmlBuffer[88] = new FmlField("COMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 88, 50);
        this.fmlBuffer[89] = new FmlField("PRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 89, 50);
        this.fmlBuffer[90] = new FmlField("LOAN_VER_NO", FmlField.TYPE_INTEGER, -1, null, 90, 50);
        this.fmlBuffer[91] = new FmlField("LOAN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 91, 50);
        this.fmlBuffer[92] = new FmlField("SOC_ACTV_FEE", FmlField.TYPE_DOUBLE, -1, null, 92, 50);
        this.fmlBuffer[93] = new FmlField("PROMOTIONAL_SOC", FmlField.TYPE_STRING, 10, null, 93, 50);
        this.fmlBuffer[94] = new FmlField("REASON_CODE", FmlField.TYPE_STRING, 5, null, 94, 50);
        this.fmlBuffer[95] = new FmlField("SOC_START_RC_DATE", FmlField.TYPE_STRING, 9, null, 95, 50);
        this.fmlBuffer[96] = new FmlField("RC_DATE_COPY_IND", FmlField.TYPE_BYTE, -1, null, 96, 50);
        this.fmlBuffer[97] = new FmlField("LOAN_SUB_ID", FmlField.TYPE_INTEGER, -1, null, 97, 50);
        this.fmlBuffer[98] = new FmlField("SOC_QUANTITY", FmlField.TYPE_INTEGER, -1, null, 98, 50);
        this.fmlBuffer[99] = new FmlField("BILL_TEXT", FmlField.TYPE_STRING, 41, null, 99, 50);
        this.fmlBuffer[100] = new FmlField("FULL_AMT", FmlField.TYPE_DOUBLE, -1, null, 100, 50);
        this.fmlBuffer[101] = new FmlField("FIRST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 101, 50);
        this.fmlBuffer[102] = new FmlField("OTHER_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 102, 50);
        this.fmlBuffer[103] = new FmlField("LAST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 103, 50);
        this.fmlBuffer[104] = new FmlField("NO_OF_INSTALLMENTS", FmlField.TYPE_SHORT, -1, null, 104, 50);
        this.fmlBuffer[105] = new FmlField("PAGRRECROWID", FmlField.TYPE_STRING, 19, null, 105, 1);
        this.fmlBuffer[106] = new FmlField("PAGRRECSOC", FmlField.TYPE_STRING, 10, null, 106, 1);
        this.fmlBuffer[107] = new FmlField("PAGRRECSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 107, 1);
        this.fmlBuffer[108] = new FmlField("PAGRRECCOMMITMENT_END_DATE", FmlField.TYPE_STRING, 9, null, 108, 1);
        this.fmlBuffer[109] = new FmlField("PAGRRECSERVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 109, 1);
        this.fmlBuffer[110] = new FmlField("PAGRRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 110, 1);
        this.fmlBuffer[111] = new FmlField("PAGRRECEXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 111, 1);
        this.fmlBuffer[112] = new FmlField("PAGRRECSOC_LEVEL_CODE", FmlField.TYPE_BYTE, -1, null, 112, 1);
        this.fmlBuffer[113] = new FmlField("PAGRRECDEALER_CODE", FmlField.TYPE_STRING, 6, null, 113, 1);
        this.fmlBuffer[114] = new FmlField("PAGRRECSALES_AGENT", FmlField.TYPE_STRING, 6, null, 114, 1);
        this.fmlBuffer[115] = new FmlField("PAGRRECSRV_MODE", FmlField.TYPE_BYTE, -1, null, 115, 1);
        this.fmlBuffer[116] = new FmlField("PAGRRECSRV_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 116, 1);
        this.fmlBuffer[117] = new FmlField("PAGRRECSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 117, 1);
        this.fmlBuffer[118] = new FmlField("PAGRRECSRV_TRX_ID", FmlField.TYPE_INTEGER, -1, null, 118, 1);
        this.fmlBuffer[119] = new FmlField("PAGRRECCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 119, 1);
        this.fmlBuffer[120] = new FmlField("PAGRRECCAMPAIGN", FmlField.TYPE_STRING, 10, null, 120, 1);
        this.fmlBuffer[121] = new FmlField("PAGRRECCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 121, 1);
        this.fmlBuffer[122] = new FmlField("PAGRRECPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 122, 1);
        this.fmlBuffer[123] = new FmlField("PAGRRECLOAN_VER_NO", FmlField.TYPE_INTEGER, -1, null, 123, 1);
        this.fmlBuffer[124] = new FmlField("PAGRRECLOAN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 124, 1);
        this.fmlBuffer[125] = new FmlField("PAGRRECSOC_ACTV_FEE", FmlField.TYPE_DOUBLE, -1, null, 125, 1);
        this.fmlBuffer[126] = new FmlField("PAGRRECPROMOTIONAL_SOC", FmlField.TYPE_STRING, 10, null, 126, 1);
        this.fmlBuffer[127] = new FmlField("PAGRRECREASON_CODE", FmlField.TYPE_STRING, 5, null, 127, 1);
        this.fmlBuffer[128] = new FmlField("PAGRRECSOC_START_RC_DATE", FmlField.TYPE_STRING, 9, null, 128, 1);
        this.fmlBuffer[129] = new FmlField("PAGRRECRC_DATE_COPY_IND", FmlField.TYPE_BYTE, -1, null, 129, 1);
        this.fmlBuffer[130] = new FmlField("PAGRRECLOAN_SUB_ID", FmlField.TYPE_INTEGER, -1, null, 130, 1);
        this.fmlBuffer[131] = new FmlField("PAGRRECSOC_QUANTITY", FmlField.TYPE_INTEGER, -1, null, 131, 1);
        this.fmlBuffer[132] = new FmlField("PAGRRECBILL_TEXT", FmlField.TYPE_STRING, 41, null, 132, 1);
        this.fmlBuffer[133] = new FmlField("PAGRRECFULL_AMT", FmlField.TYPE_DOUBLE, -1, null, 133, 1);
        this.fmlBuffer[134] = new FmlField("PAGRRECFIRST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 134, 1);
        this.fmlBuffer[135] = new FmlField("PAGRRECOTHER_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 135, 1);
        this.fmlBuffer[136] = new FmlField("PAGRRECLAST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 136, 1);
        this.fmlBuffer[137] = new FmlField("PAGRRECNO_OF_INSTALLMENTS", FmlField.TYPE_SHORT, -1, null, 137, 1);
        this.fmlBuffer[138] = new FmlField("PSOCFTRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 138, 1);
        this.fmlBuffer[139] = new FmlField("PSOCFTRBUFROWID", FmlField.TYPE_STRING, 19, null, 139, 500);
        this.fmlBuffer[140] = new FmlField("PSOCFTRBUFSOC", FmlField.TYPE_STRING, 10, null, 140, 500);
        this.fmlBuffer[141] = new FmlField("PSOCFTRBUFSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 141, 500);
        this.fmlBuffer[142] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 142, 500);
        this.fmlBuffer[143] = new FmlField("MPS_FTR_CODE", FmlField.TYPE_STRING, 7, null, 143, 500);
        this.fmlBuffer[144] = new FmlField("FTR_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 144, 500);
        this.fmlBuffer[145] = new FmlField("FTR_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 145, 500);
        this.fmlBuffer[146] = new FmlField("FTR_EFF_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 146, 500);
        this.fmlBuffer[147] = new FmlField("FTR_EXP_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 147, 500);
        this.fmlBuffer[148] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 148, 500);
        this.fmlBuffer[149] = new FmlField("FTR_MODE", FmlField.TYPE_BYTE, -1, null, 149, 500);
        this.fmlBuffer[150] = new FmlField("PSOCFTRBUFSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 150, 500);
        this.fmlBuffer[151] = new FmlField("FTR_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 151, 500);
        this.fmlBuffer[152] = new FmlField("FTR_ADD_PARAM", FmlField.TYPE_STRING, 301, null, 152, 500);
        this.fmlBuffer[153] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, null, 153, 500);
        this.fmlBuffer[154] = new FmlField("PSOCFTRBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 154, 500);
        this.fmlBuffer[155] = new FmlField("PSOCFTRBUFCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 155, 500);
        this.fmlBuffer[156] = new FmlField("FTR_SPECIAL_TELNO", FmlField.TYPE_STRING, 21, null, 156, 500);
        this.fmlBuffer[157] = new FmlField("SWITCH_ACT_NEEDED", FmlField.TYPE_BYTE, -1, null, 157, 500);
        this.fmlBuffer[158] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, null, 158, 500);
        this.fmlBuffer[159] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, null, 159, 500);
        this.fmlBuffer[160] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 160, 500);
        this.fmlBuffer[161] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, null, 161, 500);
        this.fmlBuffer[162] = new FmlField("MANUAL_RC_RATE", FmlField.TYPE_DOUBLE, -1, null, 162, 500);
        this.fmlBuffer[163] = new FmlField("MANUAL_RC_EXP_DATE", FmlField.TYPE_STRING, 9, null, 163, 500);
        this.fmlBuffer[164] = new FmlField("MANUAL_RC_EFF_DATE", FmlField.TYPE_STRING, 9, null, 164, 500);
        this.fmlBuffer[165] = new FmlField("PCSFRNDFMLROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 165, 1);
        this.fmlBuffer[166] = new FmlField("ACTIONIND", FmlField.TYPE_BYTE, -1, null, 166, 10000);
        this.fmlBuffer[167] = new FmlField("PCSFANDFRECROWID", FmlField.TYPE_STRING, 19, null, 167, 10000);
        this.fmlBuffer[168] = new FmlField("PCSFANDFRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 168, 10000);
        this.fmlBuffer[169] = new FmlField("PCSFANDFRECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 169, 10000);
        this.fmlBuffer[170] = new FmlField("PERSONAL_TEL", FmlField.TYPE_STRING, 21, null, 170, 10000);
        this.fmlBuffer[171] = new FmlField("PERSONAL_TEL_TO", FmlField.TYPE_STRING, 21, null, 171, 10000);
        this.fmlBuffer[172] = new FmlField("FF_SOC", FmlField.TYPE_STRING, 10, null, 172, 10000);
        this.fmlBuffer[173] = new FmlField("PLAN_CODE", FmlField.TYPE_STRING, 10, null, 173, 10000);
        this.fmlBuffer[174] = new FmlField("DISCOUNT_TYPE", FmlField.TYPE_BYTE, -1, null, 174, 10000);
        this.fmlBuffer[175] = new FmlField("START_HOUR", FmlField.TYPE_STRING, 7, null, 175, 10000);
        this.fmlBuffer[176] = new FmlField("DURATION", FmlField.TYPE_DOUBLE, -1, null, 176, 10000);
        this.fmlBuffer[177] = new FmlField("PESNBUFFERROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 177, 1);
        this.fmlBuffer[178] = new FmlField("EQUIPMENT_NO", FmlField.TYPE_STRING, 21, null, 178, 50);
        this.fmlBuffer[179] = new FmlField("PHD_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 179, 50);
        this.fmlBuffer[180] = new FmlField("EQUIPMENT_LEVEL", FmlField.TYPE_SHORT, -1, null, 180, 50);
        this.fmlBuffer[181] = new FmlField("IMSI", FmlField.TYPE_STRING, 16, null, 181, 50);
        this.fmlBuffer[182] = new FmlField("PHYDEVARRAYEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 182, 50);
        this.fmlBuffer[183] = new FmlField("PHYDEVARRAYEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 183, 50);
        this.fmlBuffer[184] = new FmlField("OWNERSHIP_CODE", FmlField.TYPE_STRING, 3, null, 184, 50);
        this.fmlBuffer[185] = new FmlField("SW_STATE_IND", FmlField.TYPE_BYTE, -1, null, 185, 50);
        this.fmlBuffer[186] = new FmlField("LAST_SW_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 186, 50);
        this.fmlBuffer[187] = new FmlField("NEXT_ACTV_CODE", FmlField.TYPE_BYTE, -1, null, 187, 50);
        this.fmlBuffer[188] = new FmlField("NEXT_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 188, 50);
        this.fmlBuffer[189] = new FmlField("NEXT_ACTV_ISSUE_DT", FmlField.TYPE_STRING, 9, null, 189, 50);
        this.fmlBuffer[190] = new FmlField("DEVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 190, 50);
        this.fmlBuffer[191] = new FmlField("ESN_MODE", FmlField.TYPE_BYTE, -1, null, 191, 50);
        this.fmlBuffer[192] = new FmlField("ITEM_ID", FmlField.TYPE_STRING, 16, null, 192, 50);
        this.fmlBuffer[193] = new FmlField("POOL", FmlField.TYPE_STRING, 3, null, 193, 50);
        this.fmlBuffer[194] = new FmlField("LOCATION_ID", FmlField.TYPE_STRING, 5, null, 194, 50);
        this.fmlBuffer[195] = new FmlField("ACTIVITY_CODE", FmlField.TYPE_STRING, 5, null, 195, 50);
        this.fmlBuffer[196] = new FmlField("ACTIVITY_DATE", FmlField.TYPE_STRING, 15, null, 196, 50);
        this.fmlBuffer[197] = new FmlField("OPERATION_STATUS", FmlField.TYPE_BYTE, -1, null, 197, 50);
        this.fmlBuffer[198] = new FmlField("ITEM_OWNERSHIP", FmlField.TYPE_BYTE, -1, null, 198, 50);
        this.fmlBuffer[199] = new FmlField("ITEM_OWNERSHIP_DT", FmlField.TYPE_STRING, 15, null, 199, 50);
        this.fmlBuffer[200] = new FmlField("CURR_POSSESSION", FmlField.TYPE_BYTE, -1, null, 200, 50);
        this.fmlBuffer[201] = new FmlField("CURR_POSSESSION_DT", FmlField.TYPE_STRING, 15, null, 201, 50);
        this.fmlBuffer[202] = new FmlField("MISSING_IND", FmlField.TYPE_BYTE, -1, null, 202, 50);
        this.fmlBuffer[203] = new FmlField("IN_REPAIR_IND", FmlField.TYPE_BYTE, -1, null, 203, 50);
        this.fmlBuffer[204] = new FmlField("IN_TRANSIT_IND", FmlField.TYPE_BYTE, -1, null, 204, 50);
        this.fmlBuffer[205] = new FmlField("COMITED_TO_POS_IND", FmlField.TYPE_BYTE, -1, null, 205, 50);
        this.fmlBuffer[206] = new FmlField("COMITED_DATE", FmlField.TYPE_STRING, 15, null, 206, 50);
        this.fmlBuffer[207] = new FmlField("ACTIVITY_REASON", FmlField.TYPE_STRING, 4, null, 207, 50);
        this.fmlBuffer[208] = new FmlField("UPGRADE_IND", FmlField.TYPE_BYTE, -1, null, 208, 50);
        this.fmlBuffer[209] = new FmlField("EXPECTED_RTRN_DATE", FmlField.TYPE_STRING, 15, null, 209, 50);
        this.fmlBuffer[210] = new FmlField("POLICE_REPORT_NO", FmlField.TYPE_STRING, 16, null, 210, 50);
        this.fmlBuffer[211] = new FmlField("POLICE_REPORT_DATE", FmlField.TYPE_STRING, 15, null, 211, 50);
        this.fmlBuffer[212] = new FmlField("POLICE_STATION", FmlField.TYPE_STRING, 31, null, 212, 50);
        this.fmlBuffer[213] = new FmlField("PUK", FmlField.TYPE_INTEGER, -1, null, 213, 50);
        this.fmlBuffer[214] = new FmlField("PUK2", FmlField.TYPE_INTEGER, -1, null, 214, 50);
        this.fmlBuffer[215] = new FmlField("FIRST_USED_DATE", FmlField.TYPE_STRING, 15, null, 215, 50);
        this.fmlBuffer[216] = new FmlField("SIM_STATUS", FmlField.TYPE_BYTE, -1, null, 216, 50);
        this.fmlBuffer[217] = new FmlField("SUSPEND_IND", FmlField.TYPE_BYTE, -1, null, 217, 50);
        this.fmlBuffer[218] = new FmlField("SUSPEND_DATE", FmlField.TYPE_STRING, 15, null, 218, 50);
        this.fmlBuffer[219] = new FmlField("SENT_TO_AUC_IND", FmlField.TYPE_BYTE, -1, null, 219, 50);
        this.fmlBuffer[220] = new FmlField("HLR_CD", FmlField.TYPE_STRING, 4, null, 220, 50);
        this.fmlBuffer[221] = new FmlField("K4ID", FmlField.TYPE_STRING, 41, null, 221, 50);
        this.fmlBuffer[222] = new FmlField("PHYDEVARRAYDEALER_CODE", FmlField.TYPE_STRING, 6, null, 222, 50);
        this.fmlBuffer[223] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 223, 1);
        this.fmlBuffer[224] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 224, 50);
        this.fmlBuffer[225] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 225, 50);
        this.fmlBuffer[226] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 226, 50);
        this.fmlBuffer[227] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 227, 50);
        this.fmlBuffer[228] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 228, 50);
        this.fmlBuffer[229] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 229, 50);
        this.fmlBuffer[230] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 230, 50);
        this.fmlBuffer[231] = new FmlField("P1", FmlField.TYPE_STRING, 51, null, 231, 50);
        this.fmlBuffer[232] = new FmlField("P2", FmlField.TYPE_STRING, 51, null, 232, 50);
        this.fmlBuffer[233] = new FmlField("P3", FmlField.TYPE_STRING, 51, null, 233, 50);
        this.fmlBuffer[234] = new FmlField("P4", FmlField.TYPE_STRING, 51, null, 234, 50);
        this.fmlBuffer[235] = new FmlField("P5", FmlField.TYPE_STRING, 51, null, 235, 50);
        this.fmlBuffer[236] = new FmlField("P6", FmlField.TYPE_STRING, 51, null, 236, 50);
        this.fmlBuffer[237] = new FmlField("P7", FmlField.TYPE_STRING, 51, null, 237, 50);
        this.fmlBuffer[238] = new FmlField("P8", FmlField.TYPE_STRING, 51, null, 238, 50);
        this.fmlBuffer[239] = new FmlField("P9", FmlField.TYPE_STRING, 51, null, 239, 50);
        this.fmlBuffer[240] = new FmlField("P10", FmlField.TYPE_STRING, 51, null, 240, 50);
        this.fmlBuffer[241] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 241, 50);
        this.fmlBuffer[242] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 242, 50);
        this.fmlBuffer[243] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 243, 50);
        this.fmlBuffer[244] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 244, 50);
        this.fmlBuffer[245] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 245, 50);
        this.fmlBuffer[246] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 246, 50);
        this.fmlBuffer[247] = new FmlField("PCTNRECROWID", FmlField.TYPE_STRING, 19, null, 247, 1);
        this.fmlBuffer[248] = new FmlField("PCTNRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 248, 1);
        this.fmlBuffer[249] = new FmlField("PCTNRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 249, 1);
        this.fmlBuffer[250] = new FmlField("PCTNRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 250, 1);
        this.fmlBuffer[251] = new FmlField("PCTNRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 251, 1);
        this.fmlBuffer[252] = new FmlField("PCTNRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 252, 1);
        this.fmlBuffer[253] = new FmlField("PCTNRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 253, 1);
        this.fmlBuffer[254] = new FmlField("PCTNRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 254, 1);
        this.fmlBuffer[255] = new FmlField("PCTNRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 255, 1);
        this.fmlBuffer[256] = new FmlField("PCTNRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 256, 1);
        this.fmlBuffer[257] = new FmlField("INIT_ACTIVATION_DATE", FmlField.TYPE_STRING, 9, null, 257, 1);
        this.fmlBuffer[258] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 258, 1);
        this.fmlBuffer[259] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 259, 1);
        this.fmlBuffer[260] = new FmlField("ORIGINAL_INIT_DATE", FmlField.TYPE_STRING, 15, null, 260, 1);
        this.fmlBuffer[261] = new FmlField("SUB_STATUS_LAST_ACT", FmlField.TYPE_STRING, 4, null, 261, 1);
        this.fmlBuffer[262] = new FmlField("SUB_STATUS_RSN_CODE", FmlField.TYPE_STRING, 5, null, 262, 1);
        this.fmlBuffer[263] = new FmlField("PCTNRECPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 263, 1);
        this.fmlBuffer[264] = new FmlField("CUSTOMER_BAN", FmlField.TYPE_INTEGER, -1, null, 264, 1);
        this.fmlBuffer[265] = new FmlField("CTN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 265, 1);
        this.fmlBuffer[266] = new FmlField("REQ_ST_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 266, 1);
        this.fmlBuffer[267] = new FmlField("REQ_END_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 267, 1);
        this.fmlBuffer[268] = new FmlField("COMMIT_START_DATE", FmlField.TYPE_STRING, 9, null, 268, 1);
        this.fmlBuffer[269] = new FmlField("COMMIT_END_DATE", FmlField.TYPE_STRING, 9, null, 269, 1);
        this.fmlBuffer[270] = new FmlField("COMMIT_REASON_CODE", FmlField.TYPE_STRING, 4, null, 270, 1);
        this.fmlBuffer[271] = new FmlField("PCTNRECCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 271, 1);
        this.fmlBuffer[272] = new FmlField("PCTNRECSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 272, 1);
        this.fmlBuffer[273] = new FmlField("CONTRACT_NO", FmlField.TYPE_STRING, 11, null, 273, 1);
        this.fmlBuffer[274] = new FmlField("CNT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 274, 1);
        this.fmlBuffer[275] = new FmlField("PCTNRECDEALER_CODE", FmlField.TYPE_STRING, 6, null, 275, 1);
        this.fmlBuffer[276] = new FmlField("ORG_DEALER_CODE", FmlField.TYPE_STRING, 6, null, 276, 1);
        this.fmlBuffer[277] = new FmlField("PCTNRECSALES_AGENT", FmlField.TYPE_STRING, 6, null, 277, 1);
        this.fmlBuffer[278] = new FmlField("ORG_SALES_AGENT", FmlField.TYPE_STRING, 6, null, 278, 1);
        this.fmlBuffer[279] = new FmlField("REQ_DEPOSIT_AMT", FmlField.TYPE_DOUBLE, -1, null, 279, 1);
        this.fmlBuffer[280] = new FmlField("LEADING_NUMBER", FmlField.TYPE_STRING, 21, null, 280, 1);
        this.fmlBuffer[281] = new FmlField("PCTNRECPABX_IND", FmlField.TYPE_BYTE, -1, null, 281, 1);
        this.fmlBuffer[282] = new FmlField("NEXT_CTN", FmlField.TYPE_STRING, 21, null, 282, 1);
        this.fmlBuffer[283] = new FmlField("NEXT_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 283, 1);
        this.fmlBuffer[284] = new FmlField("PRV_CTN", FmlField.TYPE_STRING, 21, null, 284, 1);
        this.fmlBuffer[285] = new FmlField("PRV_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 285, 1);
        this.fmlBuffer[286] = new FmlField("NEXT_BAN", FmlField.TYPE_INTEGER, -1, null, 286, 1);
        this.fmlBuffer[287] = new FmlField("NEXT_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 287, 1);
        this.fmlBuffer[288] = new FmlField("PRV_BAN", FmlField.TYPE_INTEGER, -1, null, 288, 1);
        this.fmlBuffer[289] = new FmlField("PRV_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 289, 1);
        this.fmlBuffer[290] = new FmlField("SUB_STS_ISSUE_DATE", FmlField.TYPE_STRING, 9, null, 290, 1);
        this.fmlBuffer[291] = new FmlField("ACTIVATE_WAIVE_RSN", FmlField.TYPE_STRING, 7, null, 291, 1);
        this.fmlBuffer[292] = new FmlField("EARLIEST_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 292, 1);
        this.fmlBuffer[293] = new FmlField("SUB_ACTV_LOCATION", FmlField.TYPE_STRING, 5, null, 293, 1);
        this.fmlBuffer[294] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 294, 1);
        this.fmlBuffer[295] = new FmlField("CUST_WATCH_DATE", FmlField.TYPE_STRING, 9, null, 295, 1);
        this.fmlBuffer[296] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 296, 1);
        this.fmlBuffer[297] = new FmlField("CREDIT_WATCH_PIN_CD", FmlField.TYPE_SHORT, -1, null, 297, 1);
        this.fmlBuffer[298] = new FmlField("SUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 298, 1);
        this.fmlBuffer[299] = new FmlField("LIMIT_RESERVED_DAYS", FmlField.TYPE_SHORT, -1, null, 299, 1);
        this.fmlBuffer[300] = new FmlField("FF_EXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 300, 1);
        this.fmlBuffer[301] = new FmlField("FLEX_IND", FmlField.TYPE_BYTE, -1, null, 301, 1);
        this.fmlBuffer[302] = new FmlField("DUO_IND", FmlField.TYPE_BYTE, -1, null, 302, 1);
        this.fmlBuffer[303] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, null, 303, 1);
        this.fmlBuffer[304] = new FmlField("SUB_DEPARTMENT_CD", FmlField.TYPE_STRING, 5, null, 304, 1);
        this.fmlBuffer[305] = new FmlField("LAST_SUBS_DISC_DT", FmlField.TYPE_STRING, 9, null, 305, 1);
        this.fmlBuffer[306] = new FmlField("LAST_SUBS_DISC_DT_UD", FmlField.TYPE_STRING, 9, null, 306, 1);
        this.fmlBuffer[307] = new FmlField("LAST_SUBSCR_DISC_SN", FmlField.TYPE_SHORT, -1, null, 307, 1);
        this.fmlBuffer[308] = new FmlField("LAST_SUBSCR_DISC_SN_UD", FmlField.TYPE_SHORT, -1, null, 308, 1);
        this.fmlBuffer[309] = new FmlField("PNI", FmlField.TYPE_STRING, 11, null, 309, 1);
        this.fmlBuffer[310] = new FmlField("RMS_REF_STORE_ID", FmlField.TYPE_STRING, 5, null, 310, 1);
        this.fmlBuffer[311] = new FmlField("RMS_REF_TYPE", FmlField.TYPE_BYTE, -1, null, 311, 1);
        this.fmlBuffer[312] = new FmlField("RMS_REF_OD", FmlField.TYPE_INTEGER, -1, null, 312, 1);
        this.fmlBuffer[313] = new FmlField("DLR_ACT_FEE", FmlField.TYPE_DOUBLE, -1, null, 313, 1);
        this.fmlBuffer[314] = new FmlField("PREP_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 314, 1);
        this.fmlBuffer[315] = new FmlField("PCTNRECSUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 315, 1);
        this.fmlBuffer[316] = new FmlField("SUB_LANG", FmlField.TYPE_STRING, 3, null, 316, 1);
        this.fmlBuffer[317] = new FmlField("SMS_RCV_STYLE_CODE", FmlField.TYPE_STRING, 3, null, 317, 1);
        this.fmlBuffer[318] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 318, 1);
        this.fmlBuffer[319] = new FmlField("ALLOW_ADVERTISING_IND", FmlField.TYPE_BYTE, -1, null, 319, 1);
        this.fmlBuffer[320] = new FmlField("IVR_WRONG_ACCESS_NO", FmlField.TYPE_SHORT, -1, null, 320, 1);
        this.fmlBuffer[321] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, NinjaConfigurationReferenceTable.getThresholdAmt(), 321, 1);
        this.fmlBuffer[322] = new FmlField("PUBLISH_LEVEL", FmlField.TYPE_STRING, 31, null, 322, 1);
        this.fmlBuffer[323] = new FmlField("AUTO_RELEASE_IND", FmlField.TYPE_BYTE, -1, null, 323, 1);
        this.fmlBuffer[324] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, null, 324, 1);
        this.fmlBuffer[325] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, null, 325, 1);
        this.fmlBuffer[326] = new FmlField("OPERATOR_CW_LMT", FmlField.TYPE_DOUBLE, -1, null, 326, 1);
        this.fmlBuffer[327] = new FmlField("SEND_SMS_FOR_MATCH", FmlField.TYPE_BYTE, -1, null, 327, 1);
        this.fmlBuffer[328] = new FmlField("CPS_STATUS", FmlField.TYPE_BYTE, -1, null, 328, 1);
        this.fmlBuffer[329] = new FmlField("CPS_TRANSACTION", FmlField.TYPE_SHORT, -1, null, 329, 1);
        this.fmlBuffer[330] = new FmlField("CPS_TYPE", FmlField.TYPE_SHORT, -1, null, 330, 1);
        this.fmlBuffer[331] = new FmlField("ISP_PASS", FmlField.TYPE_STRING, 31, null, 331, 1);
        this.fmlBuffer[332] = new FmlField("ISP_TYPE", FmlField.TYPE_STRING, 3, null, 332, 1);
        this.fmlBuffer[333] = new FmlField("OPERATOR_TMP_DATE", FmlField.TYPE_STRING, 9, null, 333, 1);
        this.fmlBuffer[334] = new FmlField("OPERATOR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, null, 334, 1);
        this.fmlBuffer[335] = new FmlField("SUB_ORG_CD", FmlField.TYPE_STRING, 11, null, 335, 1);
        this.fmlBuffer[336] = new FmlField("ORG_MEMBER_NO", FmlField.TYPE_STRING, 21, null, 336, 1);
        this.fmlBuffer[337] = new FmlField("FIXED_AS_GSM_IND", FmlField.TYPE_BYTE, -1, null, 337, 1);
        this.fmlBuffer[338] = new FmlField("EARLY_PORT_OUT", FmlField.TYPE_BYTE, -1, null, 338, 1);
        this.fmlBuffer[339] = new FmlField("EARLY_PO_WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 339, 1);
        this.fmlBuffer[340] = new FmlField("EARLY_PO_WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 340, 1);
        this.fmlBuffer[341] = new FmlField("INTERNAL_CIRCUIT_ID", FmlField.TYPE_STRING, 21, null, 341, 1);
        this.fmlBuffer[342] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 342, 1);
        this.fmlBuffer[343] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 343, 20);
        this.fmlBuffer[344] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 344, 20);
        this.fmlBuffer[345] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 345, 20);
        this.fmlBuffer[346] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 346, 20);
        this.fmlBuffer[347] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 347, 20);
        this.fmlBuffer[348] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 348, 20);
        this.fmlBuffer[349] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 349, 20);
        this.fmlBuffer[350] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 350, 20);
        this.fmlBuffer[351] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 351, 20);
        this.fmlBuffer[352] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 352, 20);
        this.fmlBuffer[353] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 353, 20);
        this.fmlBuffer[354] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 354, 20);
        this.fmlBuffer[355] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 355, 20);
        this.fmlBuffer[356] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 356, 20);
        this.fmlBuffer[357] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 357, 20);
        this.fmlBuffer[358] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 358, 20);
        this.fmlBuffer[359] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 359, 20);
        this.fmlBuffer[360] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 360, 20);
        this.fmlBuffer[361] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 361, 20);
        this.fmlBuffer[362] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 362, 20);
        this.fmlBuffer[363] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 363, 20);
        this.fmlBuffer[364] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 364, 20);
        this.fmlBuffer[365] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 365, 20);
        this.fmlBuffer[366] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 366, 20);
        this.fmlBuffer[367] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 367, 20);
        this.fmlBuffer[368] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 368, 20);
        this.fmlBuffer[369] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 369, 20);
        this.fmlBuffer[370] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 370, 20);
        this.fmlBuffer[371] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 371, 20);
        this.fmlBuffer[372] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 372, 20);
        this.fmlBuffer[373] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 373, 20);
        this.fmlBuffer[374] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 374, 20);
        this.fmlBuffer[375] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 375, 20);
        this.fmlBuffer[376] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 376, 20);
        this.fmlBuffer[377] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 377, 20);
        this.fmlBuffer[378] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 378, 20);
        this.fmlBuffer[379] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 51, null, 379, 20);
        this.fmlBuffer[380] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 380, 20);
        this.fmlBuffer[381] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 381, 20);
        this.fmlBuffer[382] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 382, 20);
        this.fmlBuffer[383] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 383, 20);
        this.fmlBuffer[384] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 384, 20);
        this.fmlBuffer[385] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 385, 20);
        this.fmlBuffer[386] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 386, 20);
        this.fmlBuffer[387] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 387, 20);
        this.fmlBuffer[388] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 388, 20);
        this.fmlBuffer[389] = new FmlField("TPID", FmlField.TYPE_STRING, 37, null, 389, 20);
        this.fmlBuffer[390] = new FmlField("E_FAKTURA_REF", FmlField.TYPE_INTEGER, -1, null, 390, 20);
        this.fmlBuffer[391] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 391, 20);
        this.fmlBuffer[392] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 392, 20);
        this.fmlBuffer[393] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 393, 20);
        this.fmlBuffer[394] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 394, 20);
        this.fmlBuffer[395] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 395, 20);
        this.fmlBuffer[396] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 396, 20);
        this.fmlBuffer[397] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 397, 20);
        this.fmlBuffer[398] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 398, 20);
        this.fmlBuffer[399] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 399, 20);
        this.fmlBuffer[400] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 400, 20);
        this.fmlBuffer[401] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 401, 20);
        this.fmlBuffer[402] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 402, 20);
        this.fmlBuffer[403] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 403, 20);
        this.fmlBuffer[404] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 404, 20);
        this.fmlBuffer[405] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 405, 20);
        this.fmlBuffer[406] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 406, 20);
        this.fmlBuffer[407] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 407, 20);
        this.fmlBuffer[408] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 408, 20);
        this.fmlBuffer[409] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 409, 20);
        this.fmlBuffer[410] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 410, 20);
        this.fmlBuffer[411] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 411, 20);
        this.fmlBuffer[412] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 412, 20);
        this.fmlBuffer[413] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 413, 20);
        this.fmlBuffer[414] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 414, 20);
        this.fmlBuffer[415] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 415, 20);
        this.fmlBuffer[416] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 416, 20);
        this.fmlBuffer[417] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 417, 20);
        this.fmlBuffer[418] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 418, 20);
        this.fmlBuffer[419] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 419, 20);
        this.fmlBuffer[420] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 420, 20);
        this.fmlBuffer[421] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 421, 20);
        this.fmlBuffer[422] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 422, 20);
        this.fmlBuffer[423] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 423, 20);
        this.fmlBuffer[424] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 424, 20);
        this.fmlBuffer[425] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 425, 20);
        this.fmlBuffer[426] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 426, 20);
        this.fmlBuffer[427] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 427, 20);
        this.fmlBuffer[428] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 428, 20);
        this.fmlBuffer[429] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 429, 20);
        this.fmlBuffer[430] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 430, 20);
        this.fmlBuffer[431] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 431, 20);
        this.fmlBuffer[432] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 432, 20);
        this.fmlBuffer[433] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 433, 20);
        this.fmlBuffer[434] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 434, 20);
        this.fmlBuffer[435] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 435, 20);
        this.fmlBuffer[436] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 436, 20);
        this.fmlBuffer[437] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 437, 1);
        this.fmlBuffer[438] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 438, 1);
        this.fmlBuffer[439] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 439, 1);
        this.fmlBuffer[440] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 440, 1);
        this.fmlBuffer[441] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 441, 1);
        this.fmlBuffer[442] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 442, 1);
        this.fmlBuffer[443] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 443, 1);
        this.fmlBuffer[444] = new FmlField("ACT_COMPLETE_DATE", FmlField.TYPE_STRING, 9, null, 444, 1);
        this.fmlBuffer[445] = new FmlField("PCSUPADDIFBUFBAN", FmlField.TYPE_INTEGER, -1, null, 445, 1);
        this.fmlBuffer[446] = new FmlField("PCSUPADDIFBUFSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 446, 1);
        this.fmlBuffer[447] = new FmlField("PCSUPADDIFBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 447, 1);
        this.fmlBuffer[448] = new FmlField("FIELD_NAME", FmlField.TYPE_STRING, 31, null, 448, 500);
        this.fmlBuffer[449] = new FmlField("FIELD_VALUE", FmlField.TYPE_STRING, 256, null, 449, 500);
        this.fmlBuffer[450] = new FmlField("PARSVDISCBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 450, 1);
        this.fmlBuffer[451] = new FmlField("PARDISCARRAYACTIONIND", FmlField.TYPE_BYTE, -1, null, 451, 100);
        this.fmlBuffer[452] = new FmlField("DEPLOYIND", FmlField.TYPE_BYTE, -1, null, 452, 100);
        this.fmlBuffer[453] = new FmlField("PARBANDISCROWID", FmlField.TYPE_STRING, 19, null, 453, 100);
        this.fmlBuffer[454] = new FmlField("PARBANDISCBAN", FmlField.TYPE_INTEGER, -1, null, 454, 100);
        this.fmlBuffer[455] = new FmlField("DISCOUNT_CODE", FmlField.TYPE_STRING, 7, null, 455, 100);
        this.fmlBuffer[456] = new FmlField("PARBANDISCSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 456, 100);
        this.fmlBuffer[457] = new FmlField("DISC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 457, 100);
        this.fmlBuffer[458] = new FmlField("PARBANDISCSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 458, 100);
        this.fmlBuffer[459] = new FmlField("PARBANDISCSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 459, 100);
        this.fmlBuffer[460] = new FmlField("PARBANDISCOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 460, 100);
        this.fmlBuffer[461] = new FmlField("PARBANDISCAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 461, 100);
        this.fmlBuffer[462] = new FmlField("PARBANDISCDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 462, 100);
        this.fmlBuffer[463] = new FmlField("PARBANDISCDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 463, 100);
        this.fmlBuffer[464] = new FmlField("PARBANDISCEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 464, 100);
        this.fmlBuffer[465] = new FmlField("DISC_BY_OPID", FmlField.TYPE_INTEGER, -1, null, 465, 100);
        this.fmlBuffer[466] = new FmlField("PARBANDISCEXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 466, 100);
        this.fmlBuffer[467] = new FmlField("PARBANDISCCAMPAIGN", FmlField.TYPE_STRING, 10, null, 467, 100);
        this.fmlBuffer[468] = new FmlField("PARBANDISCCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 468, 100);
        this.fmlBuffer[469] = new FmlField("POTENTIAL_SUBS_NO", FmlField.TYPE_INTEGER, -1, null, 469, 100);
        this.fmlBuffer[470] = new FmlField("LAST_POTENT_DATE", FmlField.TYPE_STRING, 9, null, 470, 100);
        this.fmlBuffer[471] = new FmlField("MAIN_NUMBER", FmlField.TYPE_STRING, 21, null, 471, 1);
        this.fmlBuffer[472] = new FmlField("ADDITIONAL_NUMBER_1", FmlField.TYPE_STRING, 255, null, 472, 1);
        this.fmlBuffer[473] = new FmlField("ADDITIONAL_NUMBER_2", FmlField.TYPE_STRING, 255, null, 473, 1);
        this.fmlBuffer[474] = new FmlField("ADDITIONAL_NUMBER_3", FmlField.TYPE_STRING, 255, null, 474, 1);
        this.fmlBuffer[475] = new FmlField("ADDITIONAL_NUMBER_4", FmlField.TYPE_STRING, 255, null, 475, 1);
        this.fmlBuffer[476] = new FmlField("ADDITIONAL_NUMBER_5", FmlField.TYPE_STRING, 255, null, 476, 1);
        this.fmlBuffer[477] = new FmlField("ADDITIONAL_NUMBER_6", FmlField.TYPE_STRING, 255, null, 477, 1);
        this.fmlBuffer[478] = new FmlField("ADDITIONAL_NUMBER_7", FmlField.TYPE_STRING, 255, null, 478, 1);
        this.fmlBuffer[479] = new FmlField("ADDITIONAL_NUMBER_8", FmlField.TYPE_STRING, 255, null, 479, 1);
        this.fmlBuffer[480] = new FmlField("ADDITIONAL_NUMBER_9", FmlField.TYPE_STRING, 255, null, 480, 1);
        this.fmlBuffer[481] = new FmlField("ADDITIONAL_NUMBER_10", FmlField.TYPE_STRING, 255, null, 481, 1);
    }
    ...
    /**
     * Retrieves the value of the 'RESACT' field in the FML buffer.
     *
     * @return Value of 'RESACT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_RESACT() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[16].getValue(0)));
    }

    /**
     * Sets the value of the 'RESACT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_RESACT(String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public String get_PABX_IND(int nIndex) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_PABX_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[19].setValue(nIndex, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves number of values defined for 'PABX_IND' field in the FML buffer.
     *
     * @return Number of values defined for 'PABX_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PABX_IND_size() throws FMLManipulationException {
        return (this.fmlBuffer[19].getCount());
    }

    /**
     * Retrieves the value of the 'SIM' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 500).
     * @return Value of 'SIM' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_SIM(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[20].getValue(nIndex));
    }

    /**
     * Sets the value of the 'SIM' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 500).
     * @throws FMLManipulationException
     */
    public void set_SIM(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[20].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'SIM' field in the FML buffer.
     *
     * @return Number of values defined for 'SIM' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_SIM_size() throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'CUSTOMER_ID_S' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 500).
     * @return Value of 'CUSTOMER_ID_S' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_CUSTOMER_ID_S(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[49].getValue(nIndex));
    }

    /**
     * Sets the value of the 'CUSTOMER_ID_S' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 61.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 500).
     * @throws FMLManipulationException
     */
    public void set_CUSTOMER_ID_S(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[49].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'CUSTOMER_ID_S' field in the FML buffer.
     *
     * @return Number of values defined for 'CUSTOMER_ID_S' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_CUSTOMER_ID_S_size() throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_MUNICIPALITY(int nIndex, String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_RECIP_SERV_OPER(int nIndex, String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_POINT_OF_CONNECTION(int nIndex, String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_CSNPSPC(int nIndex, String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_EIDNODSIGN(int nIndex, String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public String get_NPEIDNTYP(int nIndex) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_NPEIDNTYP(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[56].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'NPEIDNTYP' field in the FML buffer.
     *
     * @return Number of values defined for 'NPEIDNTYP' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_NPEIDNTYP_size() throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_EIDNTYPNUMB(int nIndex, String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public String get_NPNEIDNODSIGN(int nIndex) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_NPNEIDNODSIGN(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[58].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'NPNEIDNODSIGN' field in the FML buffer.
     *
     * @return Number of values defined for 'NPNEIDNODSIGN' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_NPNEIDNODSIGN_size() throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_NEIDNTYP(int nIndex, String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_NEIDNTYPNUMB(int nIndex, String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_CURR_SERV_OPER(int nIndex, String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'PSOCBUFFERROWCOUNT' field in the FML buffer.
     *
     * @return Value of 'PSOCBUFFERROWCOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PSOCBUFFERROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[71].getValue(0));
    }

    /**
     * Sets the value of the 'PSOCBUFFERROWCOUNT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PSOCBUFFERROWCOUNT(Integer value) throws FMLManipulationException {
        this.fmlBuffer[71].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PSOCBUFFERROWID' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 50).
     * @return Value of 'PSOCBUFFERROWID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PSOCBUFFERROWID(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[72].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PSOCBUFFERROWID' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 19.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 50).
     * @throws FMLManipulationException
     */
    public void set_PSOCBUFFERROWID(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[72].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PSOCBUFFERROWID' field in the FML buffer.
     *
     * @return Number of values defined for 'PSOCBUFFERROWID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PSOCBUFFERROWID_size() throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'PSOCBUFFEREFFECTIVE_DATE' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 50).
     * @return Value of 'PSOCBUFFEREFFECTIVE_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PSOCBUFFEREFFECTIVE_DATE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[77].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PSOCBUFFEREFFECTIVE_DATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 50).
     * @throws FMLManipulationException
     */
    public void set_PSOCBUFFEREFFECTIVE_DATE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[77].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PSOCBUFFEREFFECTIVE_DATE' field in the FML buffer.
     *
     * @return Number of values defined for 'PSOCBUFFEREFFECTIVE_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PSOCBUFFEREFFECTIVE_DATE_size() throws FMLManipulationException {
        return (this.fmlBuffer[77].getCount());
    }

    /**
     * Retrieves the value of the 'PSOCBUFFEREXPIRATION_DATE' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 50).
     * @return Value of 'PSOCBUFFEREXPIRATION_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PSOCBUFFEREXPIRATION_DATE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[78].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PSOCBUFFEREXPIRATION_DATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 50).
     * @throws FMLManipulationException
     */
    public void set_PSOCBUFFEREXPIRATION_DATE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[78].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PSOCBUFFEREXPIRATION_DATE' field in the FML buffer.
     *
     * @return Number of values defined for 'PSOCBUFFEREXPIRATION_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PSOCBUFFEREXPIRATION_DATE_size() throws FMLManipulationException {
    ...
    public Double get_SOC_ACTV_FEE(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[92].getValue(nIndex));
    }
    ...
    public Integer get_LOAN_SUB_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[97].getValue(nIndex));
    }
    ...
    public Integer get_PAGRRECSRV_TRX_ID() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[118].getValue(0));
    }
    ...
    public Integer get_PAGRRECLOAN_SEQ_NO() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[124].getValue(0));
    }
    ...
    public Double get_PAGRRECSOC_ACTV_FEE() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[125].getValue(0));
    }
    ...
    public Double get_PAGRRECFULL_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[133].getValue(0));
    }
    ...
    public Double get_PAGRRECFIRST_INSTALL_RATE() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[134].getValue(0));
    }
    ...
    public Double get_PAGRRECOTHER_INSTALL_RATE() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[135].getValue(0));
    }
    ...
    public Double get_PAGRRECLAST_INSTALL_RATE() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[136].getValue(0));
    }
    ...
    public Integer get_PAGRRECNO_OF_INSTALLMENTS() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[137].getValue(0)));
    }
    ...
    public void set_PAGRRECNO_OF_INSTALLMENTS(Integer value) throws FMLManipulationException {
        this.fmlBuffer[137].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_ACTION_MODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[161].getValue(nIndex)));
    }
    ...
    public void set_ACTION_MODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[161].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_MANUAL_RC_RATE(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[162].getValue(nIndex));
    }
    ...
    public Double get_DURATION(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[176].getValue(nIndex));
    }
    ...
    public Integer get_EQUIPMENT_LEVEL(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[180].getValue(nIndex)));
    }
    ...
    public void set_EQUIPMENT_LEVEL(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[180].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public String get_NEXT_ACTV_CODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[187].getValue(nIndex)));
    }
    ...
    public void set_NEXT_ACTV_CODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[187].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_ESN_MODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[191].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_OPERATION_STATUS(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[197].getValue(nIndex)));
    }
    ...
    public void set_OPERATION_STATUS(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[197].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_CURR_POSSESSION_DT(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[201].setValue(nIndex, value);
    }
    ...
    public String get_MISSING_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[202].getValue(nIndex)));
    }
    ...
    public void set_MISSING_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[202].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_UPGRADE_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[208].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PUK(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[213].getValue(nIndex));
    }
    ...
    public Integer get_PUK2(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[214].getValue(nIndex));
    }
    ...
    public void set_PUK2(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[214].setValue(nIndex, value);
    }
    ...
    public void set_FIRST_USED_DATE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[215].setValue(nIndex, value);
    }
    ...
    public String get_SUSPEND_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[217].getValue(nIndex)));
    }
    ...
    public void set_SUSPEND_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[217].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_SENT_TO_AUC_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[219].getValue(nIndex)));
    }
    ...
    public void set_SENT_TO_AUC_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[219].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_SUSP_RC_RATE_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[226].getValue(nIndex)));
    }
    ...
    public void set_SUSP_RC_RATE_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[226].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_MEMO_SOURCE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[229].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PARAM_COUNT(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[230].getValue(nIndex));
    }
    ...
    public void set_P3(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[233].setValue(nIndex, value);
    }
    ...
    public void set_P4(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[234].setValue(nIndex, value);
    }
    ...
    public Double get_MEMO_AMT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[241].getValue(nIndex));
    }
    ...
    public Double get_CHARGE_AMT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[243].getValue(nIndex));
    }
    ...
    public Integer get_CUSTOMER_BAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[264].getValue(0));
    }
    ...
    public Integer get_CTN_SEQ_NO() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[265].getValue(0));
    }
    ...
    public Integer get_PCTNRECCOMMIT_ORIG_NO_MONTH() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[271].getValue(0)));
    }
    ...
    public void set_PCTNRECCOMMIT_ORIG_NO_MONTH(Integer value) throws FMLManipulationException {
        this.fmlBuffer[271].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_REQ_DEPOSIT_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[279].getValue(0));
    }
    ...
    public String get_LEADING_NUMBER() throws FMLManipulationException {
        return ((String) this.fmlBuffer[280].getValue(0));
    }
    ...
    /**
     * Retrieves the value of the 'PCTNRECPABX_IND' field in the FML buffer.
     *
     * @return Value of 'PCTNRECPABX_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PCTNRECPABX_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[281].getValue(0)));
    }

    /**
     * Sets the value of the 'PCTNRECPABX_IND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PCTNRECPABX_IND(String value) throws FMLManipulationException {
    ...
    public String get_NEXT_CTN() throws FMLManipulationException {
        return ((String) this.fmlBuffer[282].getValue(0));
    }
    ...
    public String get_NEXT_CTN_CHG_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[283].getValue(0));
    }
    ...
    public void set_NEXT_CTN_CHG_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[283].setValue(0, value);
    }
    ...
    public String get_PRV_CTN() throws FMLManipulationException {
        return ((String) this.fmlBuffer[284].getValue(0));
    }
    ...
    public void set_PRV_CTN(String value) throws FMLManipulationException {
        this.fmlBuffer[284].setValue(0, value);
    }
    ...
    public Integer get_NEXT_BAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[286].getValue(0));
    }
    ...
    public Integer get_PRV_BAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[288].getValue(0));
    }
    ...
    public String get_ACTIVATE_WAIVE_RSN() throws FMLManipulationException {
        return ((String) this.fmlBuffer[291].getValue(0));
    }
    ...
    public void set_ACTIVATE_WAIVE_RSN(String value) throws FMLManipulationException {
        this.fmlBuffer[291].setValue(0, value);
    }
    ...
    public String get_EARLIEST_ACTV_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[292].getValue(0));
    }
    ...
    public void set_EARLIEST_ACTV_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[292].setValue(0, value);
    }
    ...
    public String get_SUB_ACTV_LOCATION() throws FMLManipulationException {
        return ((String) this.fmlBuffer[293].getValue(0));
    }
    ...
    public void set_SUB_ACTV_LOCATION(String value) throws FMLManipulationException {
        this.fmlBuffer[293].setValue(0, value);
    }
    ...
    public Double get_CUST_WATCH_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[294].getValue(0));
    }
    ...
    public Double get_BASIC_WATCH_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[296].getValue(0));
    }
    ...
    public void set_BASIC_WATCH_LMT(Double value) throws FMLManipulationException {
        this.fmlBuffer[296].setValue(0, value);
    }
    ...
    public Integer get_CREDIT_WATCH_PIN_CD() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[297].getValue(0)));
    }
    ...
    public void set_CREDIT_WATCH_PIN_CD(Integer value) throws FMLManipulationException {
        this.fmlBuffer[297].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_SUB_MARKET_CODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[298].getValue(0));
    }
    ...
    public void set_SUB_MARKET_CODE(String value) throws FMLManipulationException {
        this.fmlBuffer[298].setValue(0, value);
    }
    ...
    public Integer get_LIMIT_RESERVED_DAYS() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[299].getValue(0)));
    }
    ...
    public void set_LIMIT_RESERVED_DAYS(Integer value) throws FMLManipulationException {
        this.fmlBuffer[299].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_FLEX_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[301].getValue(0)));
    }
    ...
    public void set_FLEX_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[301].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_LISTED_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[303].getValue(0)));
    }
    ...
    public void set_LISTED_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[303].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_SUB_DEPARTMENT_CD() throws FMLManipulationException {
        return ((String) this.fmlBuffer[304].getValue(0));
    }
    ...
    public String get_LAST_SUBS_DISC_DT() throws FMLManipulationException {
        return ((String) this.fmlBuffer[305].getValue(0));
    }
    ...
    public void set_LAST_SUBS_DISC_DT(String value) throws FMLManipulationException {
        this.fmlBuffer[305].setValue(0, value);
    }
    ...
    public String get_LAST_SUBS_DISC_DT_UD() throws FMLManipulationException {
        return ((String) this.fmlBuffer[306].getValue(0));
    }
    ...
    public Integer get_LAST_SUBSCR_DISC_SN() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[307].getValue(0)));
    }
    ...
    public void set_LAST_SUBSCR_DISC_SN(Integer value) throws FMLManipulationException {
        this.fmlBuffer[307].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_LAST_SUBSCR_DISC_SN_UD() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[308].getValue(0)));
    }
    ...
    public void set_LAST_SUBSCR_DISC_SN_UD(Integer value) throws FMLManipulationException {
        this.fmlBuffer[308].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_PNI() throws FMLManipulationException {
        return ((String) this.fmlBuffer[309].getValue(0));
    }
    ...
    public void set_PNI(String value) throws FMLManipulationException {
        this.fmlBuffer[309].setValue(0, value);
    }
    ...
    public String get_RMS_REF_STORE_ID() throws FMLManipulationException {
        return ((String) this.fmlBuffer[310].getValue(0));
    }
    ...
    public void set_RMS_REF_STORE_ID(String value) throws FMLManipulationException {
        this.fmlBuffer[310].setValue(0, value);
    }
    ...
    public String get_RMS_REF_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[311].getValue(0)));
    }
    ...
    public void set_RMS_REF_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[311].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_RMS_REF_OD() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[312].getValue(0));
    }
    ...
    public void set_RMS_REF_OD(Integer value) throws FMLManipulationException {
        this.fmlBuffer[312].setValue(0, value);
    }
    ...
    public Double get_DLR_ACT_FEE() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[313].getValue(0));
    }
    ...
    public void set_DLR_ACT_FEE(Double value) throws FMLManipulationException {
        this.fmlBuffer[313].setValue(0, value);
    }
    ...
    public Double get_PREP_AMOUNT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[314].getValue(0));
    }
    ...
    public void set_PREP_AMOUNT(Double value) throws FMLManipulationException {
        this.fmlBuffer[314].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PCTNRECSUBSCRIBER_ID' field in the FML buffer.
     *
     * @return Value of 'PCTNRECSUBSCRIBER_ID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PCTNRECSUBSCRIBER_ID() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[315].getValue(0));
    }

    /**
     * Sets the value of the 'PCTNRECSUBSCRIBER_ID' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PCTNRECSUBSCRIBER_ID(Integer value) throws FMLManipulationException {
        this.fmlBuffer[315].setValue(0, value);
    }
    ...
    public String get_SUB_LANG() throws FMLManipulationException {
        return ((String) this.fmlBuffer[316].getValue(0));
    }
    ...
    public void set_SUB_LANG(String value) throws FMLManipulationException {
        this.fmlBuffer[316].setValue(0, value);
    }
    ...
    public String get_SMS_RCV_STYLE_CODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[317].getValue(0));
    }
    ...
    public void set_SMS_RCV_STYLE_CODE(String value) throws FMLManipulationException {
        this.fmlBuffer[317].setValue(0, value);
    }
    ...
    public Integer get_CONV_RUN_NO() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[318].getValue(0)));
    }
    ...
    public void set_CONV_RUN_NO(Integer value) throws FMLManipulationException {
        this.fmlBuffer[318].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_ALLOW_ADVERTISING_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[319].getValue(0)));
    }
    ...
    public void set_ALLOW_ADVERTISING_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[319].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_IVR_WRONG_ACCESS_NO() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[320].getValue(0)));
    }
    ...
    public void set_IVR_WRONG_ACCESS_NO(Integer value) throws FMLManipulationException {
        this.fmlBuffer[320].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_THRESHOLD_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[321].getValue(0));
    }
    ...
    public void set_THRESHOLD_AMT(Double value) throws FMLManipulationException {
        this.fmlBuffer[321].setValue(0, value);
    }
    ...
    public String get_PUBLISH_LEVEL() throws FMLManipulationException {
        return ((String) this.fmlBuffer[322].getValue(0));
    }
    ...
    public void set_PUBLISH_LEVEL(String value) throws FMLManipulationException {
        this.fmlBuffer[322].setValue(0, value);
    }
    ...
    public String get_AUTO_RELEASE_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[323].getValue(0)));
    }
    ...
    public void set_AUTO_RELEASE_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[323].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_CUST_WATCH_EFF_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[324].getValue(0));
    }
    ...
    public void set_CUST_WATCH_EFF_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[324].setValue(0, value);
    }
    ...
    public String get_CUST_WATCH_EXP_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[325].getValue(0));
    }
    ...
    public void set_CUST_WATCH_EXP_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[325].setValue(0, value);
    }
    ...
    public Double get_OPERATOR_CW_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[326].getValue(0));
    }
    ...
    public void set_OPERATOR_CW_LMT(Double value) throws FMLManipulationException {
        this.fmlBuffer[326].setValue(0, value);
    }
    ...
    public String get_SEND_SMS_FOR_MATCH() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[327].getValue(0)));
    }
    ...
    public void set_SEND_SMS_FOR_MATCH(String value) throws FMLManipulationException {
        this.fmlBuffer[327].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_CPS_STATUS() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[328].getValue(0)));
    }
    ...
    public void set_CPS_STATUS(String value) throws FMLManipulationException {
        this.fmlBuffer[328].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_CPS_TRANSACTION() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[329].getValue(0)));
    }
    ...
    public void set_CPS_TRANSACTION(Integer value) throws FMLManipulationException {
        this.fmlBuffer[329].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_CPS_TYPE() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[330].getValue(0)));
    }
    ...
    public void set_CPS_TYPE(Integer value) throws FMLManipulationException {
        this.fmlBuffer[330].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_ISP_PASS() throws FMLManipulationException {
        return ((String) this.fmlBuffer[331].getValue(0));
    }
    ...
    public void set_ISP_PASS(String value) throws FMLManipulationException {
        this.fmlBuffer[331].setValue(0, value);
    }
    ...
    public String get_ISP_TYPE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[332].getValue(0));
    }
    ...
    public void set_ISP_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[332].setValue(0, value);
    }
    ...
    public String get_OPERATOR_TMP_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[333].getValue(0));
    }
    ...
    public void set_OPERATOR_TMP_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[333].setValue(0, value);
    }
    ...
    public Double get_OPERATOR_TMP_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[334].getValue(0));
    }
    ...
    public void set_OPERATOR_TMP_LMT(Double value) throws FMLManipulationException {
        this.fmlBuffer[334].setValue(0, value);
    }
    ...
    public String get_SUB_ORG_CD() throws FMLManipulationException {
        return ((String) this.fmlBuffer[335].getValue(0));
    }
    ...
    public void set_SUB_ORG_CD(String value) throws FMLManipulationException {
        this.fmlBuffer[335].setValue(0, value);
    }
    ...
    public String get_ORG_MEMBER_NO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[336].getValue(0));
    }
    ...
    public void set_ORG_MEMBER_NO(String value) throws FMLManipulationException {
        this.fmlBuffer[336].setValue(0, value);
    }
    ...
    public String get_FIXED_AS_GSM_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[337].getValue(0)));
    }
    ...
    public void set_FIXED_AS_GSM_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[337].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_EARLY_PORT_OUT() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[338].getValue(0)));
    }
    ...
    public void set_EARLY_PORT_OUT(String value) throws FMLManipulationException {
        this.fmlBuffer[338].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_EARLY_PO_WAIVE_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[339].getValue(0)));
    }
    ...
    public void set_EARLY_PO_WAIVE_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[339].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_EARLY_PO_WAIVE_REASON() throws FMLManipulationException {
        return ((String) this.fmlBuffer[340].getValue(0));
    }
    ...
    public void set_EARLY_PO_WAIVE_REASON(String value) throws FMLManipulationException {
        this.fmlBuffer[340].setValue(0, value);
    }
    ...
    public String get_INTERNAL_CIRCUIT_ID() throws FMLManipulationException {
        return ((String) this.fmlBuffer[341].getValue(0));
    }
    ...
    public void set_INTERNAL_CIRCUIT_ID(String value) throws FMLManipulationException {
        this.fmlBuffer[341].setValue(0, value);
    }
    ...
    public Integer get_PNAMEADRBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[342].getValue(0));
    }
    ...
    public void set_PNAMEADRBUFROWCOUNT(Integer value) throws FMLManipulationException {
        this.fmlBuffer[342].setValue(0, value);
    }
    ...
    public void set_LINK_MODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[343].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_LINK_BAN(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[344].getValue(nIndex));
    }
    ...
    public Integer get_LINK_SEQ_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[347].getValue(nIndex));
    }
    ...
    public Integer get_LNKRECCUSTOMER_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[348].getValue(nIndex));
    }
    ...
    public Integer get_BAN(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[349].getValue(nIndex));
    }
    ...
    public Integer get_FOREIGN_SEQ_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[353].getValue(nIndex));
    }
    ...
    public String get_LINK_BILLING_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[357].getValue(nIndex)));
    }
    ...
    public void set_LINK_BILLING_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[357].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_LINK_MAILING_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[358].getValue(nIndex)));
    }
    ...
    public void set_LINK_MAILING_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[358].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_LINK_USER_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[359].getValue(nIndex)));
    }
    ...
    public void set_LINK_USER_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[359].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_NM_MODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[360].getValue(nIndex)));
    }
    ...
    public void set_NM_MODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[360].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_NAME_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[364].getValue(nIndex));
    }
    ...
    public Integer get_NAMERECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[367].getValue(nIndex));
    }
    ...
    public Integer get_NAMERECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[370].getValue(nIndex)));
    }
    ...
    public void set_NAMERECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[370].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_KOB(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[380].getValue(nIndex));
    }
    ...
    public String get_ROLE_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[388].getValue(nIndex)));
    }
    ...
    public void set_ROLE_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[388].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_E_FAKTURA_REF(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[390].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESS_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[395].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[401].getValue(nIndex)));
    }
    ...
    public void set_ADDRESSRECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[401].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public String get_CO_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[420].getValue(nIndex)));
    }
    ...
    public void set_CO_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[420].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_ADDRESSRECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[421].getValue(nIndex)));
    }
    ...
    public void set_ADDRESSRECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[421].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public String get_ACCOMMODATION_TYPE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[422].getValue(nIndex));
    }
    ...
    public void set_ACCOMMODATION_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[422].setValue(nIndex, value);
    }
    ...
    public String get_COMMUNITY_NAME(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[424].getValue(nIndex));
    }
    ...
    public void set_COMMUNITY_NAME(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[424].setValue(nIndex, value);
    }
    ...
    public String get_ADR_P1(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[427].getValue(nIndex));
    }
    ...
    public void set_ADR_P1(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[427].setValue(nIndex, value);
    }
    ...
    public String get_ADR_P6(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[432].getValue(nIndex));
    }
    ...
    public String get_FULLTABLE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[437].getValue(0)));
    }
    ...
    public void set_FULLTABLE(String value) throws FMLManipulationException {
        this.fmlBuffer[437].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_PAPER_WORK_STATUS() throws FMLManipulationException {
        return ((String) this.fmlBuffer[438].getValue(0));
    }
    ...
    public void set_PAPER_WORK_STATUS(String value) throws FMLManipulationException {
        this.fmlBuffer[438].setValue(0, value);
    }
    ...
    public String get_PAPER_WORK_REQUIRED() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[439].getValue(0)));
    }
    ...
    public void set_PAPER_WORK_REQUIRED(String value) throws FMLManipulationException {
        this.fmlBuffer[439].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_PAPER_WORK_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[440].getValue(0));
    }
    ...
    public void set_PAPER_WORK_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[440].setValue(0, value);
    }
    ...
    public String get_PAPER_WORK_REF_NO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[441].getValue(0));
    }
    ...
    public void set_PAPER_WORK_REF_NO(String value) throws FMLManipulationException {
        this.fmlBuffer[441].setValue(0, value);
    }
    ...
    public String get_PAPER_WORK_TRNS_NO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[442].getValue(0));
    }
    ...
    public String get_DELIVERY_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[443].getValue(0)));
    }
    ...
    public void set_DELIVERY_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[443].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_ACT_COMPLETE_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[444].getValue(0));
    }
    ...
    public void set_ACT_COMPLETE_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[444].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PCSUPADDIFBUFBAN' field in the FML buffer.
     *
     * @return Value of 'PCSUPADDIFBUFBAN' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PCSUPADDIFBUFBAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[445].getValue(0));
    }

    /**
     * Sets the value of the 'PCSUPADDIFBUFBAN' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PCSUPADDIFBUFBAN(Integer value) throws FMLManipulationException {
        this.fmlBuffer[445].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PCSUPADDIFBUFSUBSCRIBER_NO' field in the FML buffer.
     *
     * @return Value of 'PCSUPADDIFBUFSUBSCRIBER_NO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PCSUPADDIFBUFSUBSCRIBER_NO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[446].getValue(0));
    }

    /**
     * Sets the value of the 'PCSUPADDIFBUFSUBSCRIBER_NO' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_PCSUPADDIFBUFSUBSCRIBER_NO(String value) throws FMLManipulationException {
        this.fmlBuffer[446].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PCSUPADDIFBUFROWCOUNT' field in the FML buffer.
     *
     * @return Value of 'PCSUPADDIFBUFROWCOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PCSUPADDIFBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[447].getValue(0));
    }

    /**
     * Sets the value of the 'PCSUPADDIFBUFROWCOUNT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PCSUPADDIFBUFROWCOUNT(Integer value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'PARSVDISCBUFROWCOUNT' field in the FML buffer.
     *
     * @return Value of 'PARSVDISCBUFROWCOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PARSVDISCBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[450].getValue(0));
    }

    /**
     * Sets the value of the 'PARSVDISCBUFROWCOUNT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PARSVDISCBUFROWCOUNT(Integer value) throws FMLManipulationException {
        this.fmlBuffer[450].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PARDISCARRAYACTIONIND' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PARDISCARRAYACTIONIND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PARDISCARRAYACTIONIND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[451].getValue(nIndex)));
    }

    /**
     * Sets the value of the 'PARDISCARRAYACTIONIND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_PARDISCARRAYACTIONIND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[451].setValue(nIndex, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves number of values defined for 'PARDISCARRAYACTIONIND' field in the FML buffer.
     *
     * @return Number of values defined for 'PARDISCARRAYACTIONIND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PARDISCARRAYACTIONIND_size() throws FMLManipulationException {
    ...
    public String get_DEPLOYIND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[452].getValue(nIndex)));
    }
    ...
    public void set_DEPLOYIND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[452].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    /**
     * Retrieves the value of the 'PARBANDISCROWID' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PARBANDISCROWID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PARBANDISCROWID(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[453].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PARBANDISCROWID' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 19.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_PARBANDISCROWID(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[453].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PARBANDISCROWID' field in the FML buffer.
     *
     * @return Number of values defined for 'PARBANDISCROWID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PARBANDISCROWID_size() throws FMLManipulationException {
        return (this.fmlBuffer[453].getCount());
    }

    /**
     * Retrieves the value of the 'PARBANDISCBAN' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PARBANDISCBAN' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PARBANDISCBAN(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[454].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PARBANDISCBAN' field in the FML buffer.
     *
     * @param value Default value: null.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_PARBANDISCBAN(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[454].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PARBANDISCBAN' field in the FML buffer.
     *
     * @return Number of values defined for 'PARBANDISCBAN' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PARBANDISCBAN_size() throws FMLManipulationException {
    ...
    public String get_DISCOUNT_CODE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[455].getValue(nIndex));
    }
    ...
    public void set_DISCOUNT_CODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[455].setValue(nIndex, value);
    }
    ...
    /**
     * Retrieves the value of the 'PARBANDISCSUBSCRIBER_NO' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PARBANDISCSUBSCRIBER_NO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PARBANDISCSUBSCRIBER_NO(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[456].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PARBANDISCSUBSCRIBER_NO' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_PARBANDISCSUBSCRIBER_NO(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[456].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PARBANDISCSUBSCRIBER_NO' field in the FML buffer.
     *
     * @return Number of values defined for 'PARBANDISCSUBSCRIBER_NO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PARBANDISCSUBSCRIBER_NO_size() throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'PARBANDISCSYS_CREATION_DATE' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PARBANDISCSYS_CREATION_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PARBANDISCSYS_CREATION_DATE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[458].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PARBANDISCSYS_CREATION_DATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 15.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_PARBANDISCSYS_CREATION_DATE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[458].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PARBANDISCSYS_CREATION_DATE' field in the FML buffer.
     *
     * @return Number of values defined for 'PARBANDISCSYS_CREATION_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PARBANDISCSYS_CREATION_DATE_size() throws FMLManipulationException {
        return (this.fmlBuffer[458].getCount());
    }

    /**
     * Retrieves the value of the 'PARBANDISCSYS_UPDATE_DATE' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PARBANDISCSYS_UPDATE_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PARBANDISCSYS_UPDATE_DATE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[459].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PARBANDISCSYS_UPDATE_DATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 15.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_PARBANDISCSYS_UPDATE_DATE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[459].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PARBANDISCSYS_UPDATE_DATE' field in the FML buffer.
     *
     * @return Number of values defined for 'PARBANDISCSYS_UPDATE_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PARBANDISCSYS_UPDATE_DATE_size() throws FMLManipulationException {
        return (this.fmlBuffer[459].getCount());
    }

    /**
     * Retrieves the value of the 'PARBANDISCOPERATOR_ID' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PARBANDISCOPERATOR_ID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PARBANDISCOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[460].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PARBANDISCOPERATOR_ID' field in the FML buffer.
     *
     * @param value Default value: null.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_PARBANDISCOPERATOR_ID(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[460].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PARBANDISCOPERATOR_ID' field in the FML buffer.
     *
     * @return Number of values defined for 'PARBANDISCOPERATOR_ID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PARBANDISCOPERATOR_ID_size() throws FMLManipulationException {
        return (this.fmlBuffer[460].getCount());
    }

    /**
     * Retrieves the value of the 'PARBANDISCAPPLICATION_ID' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PARBANDISCAPPLICATION_ID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PARBANDISCAPPLICATION_ID(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[461].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PARBANDISCAPPLICATION_ID' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 7.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_PARBANDISCAPPLICATION_ID(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[461].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PARBANDISCAPPLICATION_ID' field in the FML buffer.
     *
     * @return Number of values defined for 'PARBANDISCAPPLICATION_ID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PARBANDISCAPPLICATION_ID_size() throws FMLManipulationException {
        return (this.fmlBuffer[461].getCount());
    }

    /**
     * Retrieves the value of the 'PARBANDISCDL_SERVICE_CODE' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PARBANDISCDL_SERVICE_CODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PARBANDISCDL_SERVICE_CODE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[462].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PARBANDISCDL_SERVICE_CODE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 6.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_PARBANDISCDL_SERVICE_CODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[462].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PARBANDISCDL_SERVICE_CODE' field in the FML buffer.
     *
     * @return Number of values defined for 'PARBANDISCDL_SERVICE_CODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PARBANDISCDL_SERVICE_CODE_size() throws FMLManipulationException {
        return (this.fmlBuffer[462].getCount());
    }

    /**
     * Retrieves the value of the 'PARBANDISCDL_UPDATE_STAMP' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PARBANDISCDL_UPDATE_STAMP' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PARBANDISCDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[463].getValue(nIndex)));
    }

    /**
     * Sets the value of the 'PARBANDISCDL_UPDATE_STAMP' field in the FML buffer.
     *
     * @param value Default value: null.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_PARBANDISCDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[463].setValue(nIndex, TypeConverter.integerToShort(value));
    }

    /**
     * Retrieves number of values defined for 'PARBANDISCDL_UPDATE_STAMP' field in the FML buffer.
     *
     * @return Number of values defined for 'PARBANDISCDL_UPDATE_STAMP' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PARBANDISCDL_UPDATE_STAMP_size() throws FMLManipulationException {
        return (this.fmlBuffer[463].getCount());
    }

    /**
     * Retrieves the value of the 'PARBANDISCEFFECTIVE_DATE' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PARBANDISCEFFECTIVE_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PARBANDISCEFFECTIVE_DATE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[464].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PARBANDISCEFFECTIVE_DATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_PARBANDISCEFFECTIVE_DATE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[464].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PARBANDISCEFFECTIVE_DATE' field in the FML buffer.
     *
     * @return Number of values defined for 'PARBANDISCEFFECTIVE_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PARBANDISCEFFECTIVE_DATE_size() throws FMLManipulationException {
    ...
    public Integer get_DISC_BY_OPID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[465].getValue(nIndex));
    }
    ...
    /**
     * Retrieves the value of the 'PARBANDISCEXPIRATION_DATE' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PARBANDISCEXPIRATION_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PARBANDISCEXPIRATION_DATE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[466].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PARBANDISCEXPIRATION_DATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_PARBANDISCEXPIRATION_DATE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[466].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PARBANDISCEXPIRATION_DATE' field in the FML buffer.
     *
     * @return Number of values defined for 'PARBANDISCEXPIRATION_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PARBANDISCEXPIRATION_DATE_size() throws FMLManipulationException {
        return (this.fmlBuffer[466].getCount());
    }

    /**
     * Retrieves the value of the 'PARBANDISCCAMPAIGN' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PARBANDISCCAMPAIGN' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PARBANDISCCAMPAIGN(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[467].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PARBANDISCCAMPAIGN' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 10.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_PARBANDISCCAMPAIGN(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[467].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PARBANDISCCAMPAIGN' field in the FML buffer.
     *
     * @return Number of values defined for 'PARBANDISCCAMPAIGN' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PARBANDISCCAMPAIGN_size() throws FMLManipulationException {
        return (this.fmlBuffer[467].getCount());
    }

    /**
     * Retrieves the value of the 'PARBANDISCCOMMIT_ORIG_NO_MONTH' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PARBANDISCCOMMIT_ORIG_NO_MONTH' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PARBANDISCCOMMIT_ORIG_NO_MONTH(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[468].getValue(nIndex)));
    }

    /**
     * Sets the value of the 'PARBANDISCCOMMIT_ORIG_NO_MONTH' field in the FML buffer.
     *
     * @param value Default value: null.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_PARBANDISCCOMMIT_ORIG_NO_MONTH(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[468].setValue(nIndex, TypeConverter.integerToShort(value));
    }

    /**
     * Retrieves number of values defined for 'PARBANDISCCOMMIT_ORIG_NO_MONTH' field in the FML buffer.
     *
     * @return Number of values defined for 'PARBANDISCCOMMIT_ORIG_NO_MONTH' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PARBANDISCCOMMIT_ORIG_NO_MONTH_size() throws FMLManipulationException {
    ...
    public Integer get_POTENTIAL_SUBS_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[469].getValue(nIndex));
    }
    ...
    public String get_MAIN_NUMBER() throws FMLManipulationException {
        return ((String) this.fmlBuffer[471].getValue(0));
    }
    ...
    public void set_MAIN_NUMBER(String value) throws FMLManipulationException {
        this.fmlBuffer[471].setValue(0, value);
    }
    ...
    public String get_ADDITIONAL_NUMBER_1() throws FMLManipulationException {
        return ((String) this.fmlBuffer[472].getValue(0));
    }
    ...
    public void set_ADDITIONAL_NUMBER_1(String value) throws FMLManipulationException {
        this.fmlBuffer[472].setValue(0, value);
    }
    ...
    public String get_ADDITIONAL_NUMBER_2() throws FMLManipulationException {
        return ((String) this.fmlBuffer[473].getValue(0));
    }
    ...
    public String get_ADDITIONAL_NUMBER_3() throws FMLManipulationException {
        return ((String) this.fmlBuffer[474].getValue(0));
    }
    ...
    public void set_ADDITIONAL_NUMBER_3(String value) throws FMLManipulationException {
        this.fmlBuffer[474].setValue(0, value);
    }
    ...
    public String get_ADDITIONAL_NUMBER_4() throws FMLManipulationException {
        return ((String) this.fmlBuffer[475].getValue(0));
    }
    ...
    public void set_ADDITIONAL_NUMBER_4(String value) throws FMLManipulationException {
        this.fmlBuffer[475].setValue(0, value);
    }
    ...
    public String get_ADDITIONAL_NUMBER_5() throws FMLManipulationException {
        return ((String) this.fmlBuffer[476].getValue(0));
    }
    ...
    public void set_ADDITIONAL_NUMBER_5(String value) throws FMLManipulationException {
        this.fmlBuffer[476].setValue(0, value);
    }
    ...
    public String get_ADDITIONAL_NUMBER_6() throws FMLManipulationException {
        return ((String) this.fmlBuffer[477].getValue(0));
    }
    ...
    public void set_ADDITIONAL_NUMBER_6(String value) throws FMLManipulationException {
        this.fmlBuffer[477].setValue(0, value);
    }
    ...
    public String get_ADDITIONAL_NUMBER_7() throws FMLManipulationException {
        return ((String) this.fmlBuffer[478].getValue(0));
    }
    ...
    public void set_ADDITIONAL_NUMBER_7(String value) throws FMLManipulationException {
        this.fmlBuffer[478].setValue(0, value);
    }
    ...
    public String get_ADDITIONAL_NUMBER_8() throws FMLManipulationException {
        return ((String) this.fmlBuffer[479].getValue(0));
    }
    ...
    public void set_ADDITIONAL_NUMBER_8(String value) throws FMLManipulationException {
        this.fmlBuffer[479].setValue(0, value);
    }
    ...
    public String get_ADDITIONAL_NUMBER_9() throws FMLManipulationException {
        return ((String) this.fmlBuffer[480].getValue(0));
    }
    ...
    public void set_ADDITIONAL_NUMBER_9(String value) throws FMLManipulationException {
        this.fmlBuffer[480].setValue(0, value);
    }
    ...
    public String get_ADDITIONAL_NUMBER_10() throws FMLManipulationException {
        return ((String) this.fmlBuffer[481].getValue(0));
    }
    ...
    public void set_ADDITIONAL_NUMBER_10(String value) throws FMLManipulationException {
        this.fmlBuffer[481].setValue(0, value);
    }
}