 ...
 */
public class CsLsDlrPabxNlInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsLsDlrPabxNlInput
     *
     * @throws FMLManipulationException
     */
    public CsLsDlrPabxNlInput() throws FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csLsDlrPabxNl", 24);
        ...
        this.fmlBuffer[16] = new FmlField("ORGCODE", FmlField.TYPE_STRING, 10, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("ACCTYPE", FmlField.TYPE_BYTE, -1, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("ACCSUBTYPE", FmlField.TYPE_STRING, 3, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("EFFECTIVEDATE", FmlField.TYPE_STRING, 9, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("DEALERCODE", FmlField.TYPE_STRING, 6, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("COUNTRYCODE", FmlField.TYPE_STRING, 4, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("PAGE", FmlField.TYPE_INTEGER, -1, null, 22, 1);
        this.fmlBuffer[23] = new FmlField("BUFFERSIZE", FmlField.TYPE_INTEGER, -1, null, 23, 1);
    }
    ...
    /**
     * Retrieves the value of the 'EFFECTIVEDATE' field in the FML buffer.
     *
     * @return Value of 'EFFECTIVEDATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_EFFECTIVEDATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[19].getValue(0));
    }

    /**
     * Sets the value of the 'EFFECTIVEDATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @throws FMLManipulationException
     */
    public void set_EFFECTIVEDATE(String value) throws FMLManipulationException {
        this.fmlBuffer[19].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'DEALERCODE' field in the FML buffer.
     *
     * @return Value of 'DEALERCODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_DEALERCODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[20].getValue(0));
    }

    /**
     * Sets the value of the 'DEALERCODE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 6.
     * @throws FMLManipulationException
     */
    public void set_DEALERCODE(String value) throws FMLManipulationException {
        this.fmlBuffer[20].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'COUNTRYCODE' field in the FML buffer.
     *
     * @return Value of 'COUNTRYCODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_COUNTRYCODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[21].getValue(0));
    }

    /**
     * Sets the value of the 'COUNTRYCODE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_COUNTRYCODE(String value) throws FMLManipulationException {
