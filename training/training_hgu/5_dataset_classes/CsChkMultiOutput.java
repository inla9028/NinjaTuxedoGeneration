 ...
 */
public class CsChkMultiOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsChkMultiOutput.
     *
     * @throws FMLManipulationException
     */
    public CsChkMultiOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsChkMultiOutput() {
    }

    /**
     * Creates a new instance of CsChkMultiOutput.
     *
     * @param ds Output dataset from CsChkMulti service.
     * @throws FMLManipulationException
     */
    public CsChkMultiOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[20];
        ...
        this.fmlBuffer[16] = new FmlField("LEADING_NO", FmlField.TYPE_STRING, 21, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("VALIDARR", FmlField.TYPE_STRING, 21, null, 17, 1000);
        this.fmlBuffer[18] = new FmlField("ERRCOUNT", FmlField.TYPE_INTEGER, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("MSISDNCOUNT", FmlField.TYPE_INTEGER, -1, null, 19, 1);
    }
    ...
    /**
     * Retrieves the value of the 'LEADING_NO' field in the FML buffer.
     *
     * @return Value of 'LEADING_NO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_LEADING_NO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[16].getValue(0));
    }

    /**
     * Retrieves the value of the 'VALIDARR' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 1000).
     * @return Value of 'VALIDARR' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_VALIDARR(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[17].getValue(nIndex));
    }

    /**
     * Retrieves number of values defined for 'VALIDARR' field in the FML buffer.
     *
     * @return Number of values defined for 'VALIDARR' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_VALIDARR_size() throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'MSISDNCOUNT' field in the FML buffer.
     *
     * @return Value of 'MSISDNCOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_MSISDNCOUNT() throws FMLManipulationException {
