 ...
 */
public class CsChkMultiInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsChkMultiInput
     *
     * @throws FMLManipulationException
     */
    public CsChkMultiInput() throws FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csChkMulti", 24);
        ...
        this.fmlBuffer[16] = new FmlField("FROM_MSISDN", FmlField.TYPE_STRING, 21, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("TO_MSISDN", FmlField.TYPE_STRING, 21, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("PRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("LEAD_IND", FmlField.TYPE_BYTE, -1, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("ORG_CODE", FmlField.TYPE_STRING, 10, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("ACCTYPE", FmlField.TYPE_BYTE, -1, null, 22, 1);
        this.fmlBuffer[23] = new FmlField("ACCSUBTYPE", FmlField.TYPE_STRING, 3, null, 23, 1);
    }
    ...
    /**
     * Retrieves the value of the 'FROM_MSISDN' field in the FML buffer.
     *
     * @return Value of 'FROM_MSISDN' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_FROM_MSISDN() throws FMLManipulationException {
        return ((String) this.fmlBuffer[16].getValue(0));
    }

    /**
     * Sets the value of the 'FROM_MSISDN' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_FROM_MSISDN(String value) throws FMLManipulationException {
        this.fmlBuffer[16].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'TO_MSISDN' field in the FML buffer.
     *
     * @return Value of 'TO_MSISDN' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_TO_MSISDN() throws FMLManipulationException {
        return ((String) this.fmlBuffer[17].getValue(0));
    }

    /**
     * Sets the value of the 'TO_MSISDN' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_TO_MSISDN(String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'LEAD_IND' field in the FML buffer.
     *
     * @return Value of 'LEAD_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_LEAD_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[20].getValue(0)));
    }

    /**
     * Sets the value of the 'LEAD_IND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_LEAD_IND(String value) throws FMLManipulationException {
