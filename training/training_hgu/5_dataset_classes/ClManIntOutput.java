 ...
 */
public class ClManIntOutput extends ServiceOutput {

    /**
     * Creates a new instance of ClManIntOutput.
     *
     * @throws FMLManipulationException
     */
    public ClManIntOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public ClManIntOutput() {
    }

    /**
     * Creates a new instance of ClManIntOutput.
     *
     * @param ds Output dataset from ClManInt service.
     * @throws FMLManipulationException
     */
    public ClManIntOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[81];
        ...
        this.fmlBuffer[18] = new FmlField("BAN_INFO_SUPPLIED_IND", FmlField.TYPE_BYTE, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("BAN_COL_INFOROWID", FmlField.TYPE_STRING, 19, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("BAN_COL_INFOBAN", FmlField.TYPE_INTEGER, -1, null, 20, 1);
        ...
        this.fmlBuffer[23] = new FmlField("BAN_COL_INFOOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 23, 1);
        this.fmlBuffer[24] = new FmlField("BAN_COL_INFOAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 24, 1);
        ...
        this.fmlBuffer[27] = new FmlField("PARTITION_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 27, 1);
        this.fmlBuffer[28] = new FmlField("AR_EXCPT_ACCT_IND", FmlField.TYPE_BYTE, -1, null, 28, 1);
        this.fmlBuffer[29] = new FmlField("ACCOUNT_TYPE", FmlField.TYPE_BYTE, -1, null, 29, 1);
        this.fmlBuffer[30] = new FmlField("BILL_CYCLE", FmlField.TYPE_SHORT, -1, null, 30, 1);
        this.fmlBuffer[31] = new FmlField("AR_BALANCE", FmlField.TYPE_DOUBLE, -1, null, 31, 1);
        this.fmlBuffer[32] = new FmlField("BAN_STATUS", FmlField.TYPE_BYTE, -1, null, 32, 1);
        ...
        this.fmlBuffer[40] = new FmlField("BL_COMPLT_STATUS", FmlField.TYPE_BYTE, -1, null, 40, 1);
        this.fmlBuffer[41] = new FmlField("BL_COMPLT_DATE", FmlField.TYPE_STRING, 9, null, 41, 1);
        this.fmlBuffer[42] = new FmlField("COL_DELINQ_STATUS", FmlField.TYPE_BYTE, -1, null, 42, 1);
        this.fmlBuffer[43] = new FmlField("COL_DELINQ_STS_DATE", FmlField.TYPE_STRING, 9, null, 43, 1);
        this.fmlBuffer[44] = new FmlField("COL_WAIVER_IND", FmlField.TYPE_BYTE, -1, null, 44, 1);
        this.fmlBuffer[45] = new FmlField("COL_WAIVER_DATE", FmlField.TYPE_STRING, 9, null, 45, 1);
        this.fmlBuffer[46] = new FmlField("COL_WAIVER_UID", FmlField.TYPE_STRING, 9, null, 46, 1);
        this.fmlBuffer[47] = new FmlField("COL_CATEGORY_NO", FmlField.TYPE_SHORT, -1, null, 47, 1);
        this.fmlBuffer[48] = new FmlField("COL_PATH_CODE", FmlField.TYPE_STRING, 4, null, 48, 1);
        this.fmlBuffer[49] = new FmlField("COL_NEXT_STEP_NO", FmlField.TYPE_SHORT, -1, null, 49, 1);
        this.fmlBuffer[50] = new FmlField("COL_NEXT_STEP_DATE", FmlField.TYPE_STRING, 9, null, 50, 1);
        this.fmlBuffer[51] = new FmlField("COL_NEXT_STP_APR_COD", FmlField.TYPE_BYTE, -1, null, 51, 1);
        this.fmlBuffer[52] = new FmlField("COL_NEXT_STP_APR_COL", FmlField.TYPE_STRING, 9, null, 52, 1);
        this.fmlBuffer[53] = new FmlField("COL_ASSIGNED_COLL", FmlField.TYPE_STRING, 9, null, 53, 1);
        this.fmlBuffer[54] = new FmlField("COL_COLCT_ASD_DATE", FmlField.TYPE_STRING, 9, null, 54, 1);
        this.fmlBuffer[55] = new FmlField("COL_AGNCY_CODE", FmlField.TYPE_STRING, 9, null, 55, 1);
        this.fmlBuffer[56] = new FmlField("COL_AGNCY_ASD_DATE", FmlField.TYPE_STRING, 9, null, 56, 1);
        this.fmlBuffer[57] = new FmlField("COL_AGNCY_ASD_AMT", FmlField.TYPE_DOUBLE, -1, null, 57, 1);
        this.fmlBuffer[58] = new FmlField("COL_FIRST_CNTCT_DATE", FmlField.TYPE_STRING, 9, null, 58, 1);
        this.fmlBuffer[59] = new FmlField("COL_CODE", FmlField.TYPE_BYTE, -1, null, 59, 1);
        this.fmlBuffer[60] = new FmlField("COMP_CRD_LMT", FmlField.TYPE_DOUBLE, -1, null, 60, 1);
        this.fmlBuffer[61] = new FmlField("STATUS_ISSUE_DATE", FmlField.TYPE_STRING, 9, null, 61, 1);
        this.fmlBuffer[62] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 62, 1);
        this.fmlBuffer[63] = new FmlField("COL_FIXED_PATH", FmlField.TYPE_STRING, 4, null, 63, 1);
        this.fmlBuffer[64] = new FmlField("ACCOUNT_SUB_TYPE", FmlField.TYPE_STRING, 3, null, 64, 1);
        this.fmlBuffer[65] = new FmlField("CYCLE_FREQUENCY", FmlField.TYPE_SHORT, -1, null, 65, 1);
        this.fmlBuffer[66] = new FmlField("DEFAULT_DEPARTMENT", FmlField.TYPE_STRING, 5, null, 66, 1);
        this.fmlBuffer[67] = new FmlField("CREDIT_CLASS", FmlField.TYPE_BYTE, -1, null, 67, 1);
        this.fmlBuffer[68] = new FmlField("PAYABLE_LTR_SEND_DATE", FmlField.TYPE_STRING, 9, null, 68, 1);
        this.fmlBuffer[69] = new FmlField("AGENCY_REF_NO", FmlField.TYPE_STRING, 9, null, 69, 1);
        this.fmlBuffer[70] = new FmlField("COL_AGENCY_CONF_DT", FmlField.TYPE_STRING, 9, null, 70, 1);
        this.fmlBuffer[71] = new FmlField("WAIVER_RSN_CODE", FmlField.TYPE_STRING, 7, null, 71, 1);
        this.fmlBuffer[72] = new FmlField("CALL_ACTV_CODE", FmlField.TYPE_STRING, 3, null, 72, 1);
        this.fmlBuffer[73] = new FmlField("FUTURE_TREATMENT_IND", FmlField.TYPE_BYTE, -1, null, 73, 1);
        this.fmlBuffer[74] = new FmlField("NEW_COLLECTION_PATH", FmlField.TYPE_STRING, 4, null, 74, 1);
        this.fmlBuffer[75] = new FmlField("NEW_NEXT_STEP_NUM", FmlField.TYPE_SHORT, -1, null, 75, 1);
        this.fmlBuffer[76] = new FmlField("NEW_NEXT_STEP_DATE", FmlField.TYPE_STRING, 9, null, 76, 1);
        this.fmlBuffer[77] = new FmlField("COLLECTOR", FmlField.TYPE_STRING, 9, null, 77, 1);
        this.fmlBuffer[78] = new FmlField("HOLD_AUTOMATIC_TREATMENT", FmlField.TYPE_BYTE, -1, null, 78, 1);
        this.fmlBuffer[79] = new FmlField("COL_TREATMENT_STATUS", FmlField.TYPE_BYTE, -1, null, 79, 1);
        this.fmlBuffer[80] = new FmlField("HOLD_COLL_REASON", FmlField.TYPE_STRING, 7, null, 80, 1);
    }
