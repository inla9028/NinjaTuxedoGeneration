 ...
 */
public class CvSvNmAdrOutput extends ServiceOutput {

    /**
     * Creates a new instance of CvSvNmAdrOutput.
     *
     * @throws FMLManipulationException
     */
    public CvSvNmAdrOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CvSvNmAdrOutput() {
    }

    /**
     * Creates a new instance of CvSvNmAdrOutput.
     *
     * @param ds Output dataset from CvSvNmAdr service.
     * @throws FMLManipulationException
     */
    public CvSvNmAdrOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[96];
        this.fmlBuffer[0] = new FmlField("GENERATION", FmlField.TYPE_INTEGER, -1, null, 0, 1);
        this.fmlBuffer[1] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 1, 1);
        this.fmlBuffer[2] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 2, 20);
        this.fmlBuffer[3] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 3, 20);
        this.fmlBuffer[4] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 4, 20);
        this.fmlBuffer[5] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 5, 20);
        this.fmlBuffer[6] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 6, 20);
        this.fmlBuffer[7] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 7, 20);
        this.fmlBuffer[8] = new FmlField("LNKRECBAN", FmlField.TYPE_INTEGER, -1, null, 8, 20);
        this.fmlBuffer[9] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 9, 20);
        this.fmlBuffer[10] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 10, 20);
        this.fmlBuffer[11] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 11, 20);
        this.fmlBuffer[12] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 12, 20);
        this.fmlBuffer[13] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 13, 20);
        this.fmlBuffer[14] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 14, 20);
        this.fmlBuffer[15] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 15, 20);
        this.fmlBuffer[16] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 16, 20);
        this.fmlBuffer[17] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 17, 20);
        this.fmlBuffer[18] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 18, 20);
        this.fmlBuffer[19] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 19, 20);
        this.fmlBuffer[20] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 20, 20);
        this.fmlBuffer[21] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 21, 20);
        this.fmlBuffer[22] = new FmlField("ROWID", FmlField.TYPE_STRING, 19, null, 22, 20);
        this.fmlBuffer[23] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 23, 20);
        this.fmlBuffer[24] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 24, 20);
        this.fmlBuffer[25] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 25, 20);
        this.fmlBuffer[26] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 26, 20);
        this.fmlBuffer[27] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 27, 20);
        this.fmlBuffer[28] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 28, 20);
        this.fmlBuffer[29] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 29, 20);
        this.fmlBuffer[30] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 30, 20);
        this.fmlBuffer[31] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 31, 20);
        this.fmlBuffer[32] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 32, 20);
        this.fmlBuffer[33] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 33, 20);
        this.fmlBuffer[34] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 34, 20);
        this.fmlBuffer[35] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 35, 20);
        this.fmlBuffer[36] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 36, 20);
        this.fmlBuffer[37] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 37, 20);
        this.fmlBuffer[38] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 51, null, 38, 20);
        this.fmlBuffer[39] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 39, 20);
        this.fmlBuffer[40] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 40, 20);
        this.fmlBuffer[41] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 41, 20);
        this.fmlBuffer[42] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 42, 20);
        this.fmlBuffer[43] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 43, 20);
        this.fmlBuffer[44] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 44, 20);
        this.fmlBuffer[45] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 45, 20);
        this.fmlBuffer[46] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 46, 20);
        this.fmlBuffer[47] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 47, 20);
        this.fmlBuffer[48] = new FmlField("TPID", FmlField.TYPE_STRING, 37, null, 48, 20);
        this.fmlBuffer[49] = new FmlField("E_FAKTURA_REF", FmlField.TYPE_INTEGER, -1, null, 49, 20);
        this.fmlBuffer[50] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 50, 20);
        this.fmlBuffer[51] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 51, 20);
        this.fmlBuffer[52] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 52, 20);
        this.fmlBuffer[53] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 53, 20);
        this.fmlBuffer[54] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 54, 20);
        this.fmlBuffer[55] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 55, 20);
        this.fmlBuffer[56] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 56, 20);
        this.fmlBuffer[57] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 57, 20);
        this.fmlBuffer[58] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 58, 20);
        this.fmlBuffer[59] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 59, 20);
        this.fmlBuffer[60] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 60, 20);
        this.fmlBuffer[61] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 61, 20);
        this.fmlBuffer[62] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 62, 20);
        this.fmlBuffer[63] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 63, 20);
        this.fmlBuffer[64] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 64, 20);
        this.fmlBuffer[65] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 65, 20);
        this.fmlBuffer[66] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 66, 20);
        this.fmlBuffer[67] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 67, 20);
        this.fmlBuffer[68] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 68, 20);
        this.fmlBuffer[69] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 69, 20);
        this.fmlBuffer[70] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 70, 20);
        this.fmlBuffer[71] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 71, 20);
        this.fmlBuffer[72] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 72, 20);
        this.fmlBuffer[73] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 73, 20);
        this.fmlBuffer[74] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 74, 20);
        this.fmlBuffer[75] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 75, 20);
        this.fmlBuffer[76] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 76, 20);
        this.fmlBuffer[77] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 77, 20);
        this.fmlBuffer[78] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 78, 20);
        this.fmlBuffer[79] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 79, 20);
        this.fmlBuffer[80] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 80, 20);
        this.fmlBuffer[81] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 81, 20);
        this.fmlBuffer[82] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 82, 20);
        this.fmlBuffer[83] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 83, 20);
        this.fmlBuffer[84] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 84, 20);
        this.fmlBuffer[85] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 85, 20);
        this.fmlBuffer[86] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 86, 20);
        this.fmlBuffer[87] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 87, 20);
        this.fmlBuffer[88] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 88, 20);
        this.fmlBuffer[89] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 89, 20);
        this.fmlBuffer[90] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 90, 20);
        this.fmlBuffer[91] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 91, 20);
        this.fmlBuffer[92] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 92, 20);
        this.fmlBuffer[93] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 93, 20);
        this.fmlBuffer[94] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 94, 20);
        this.fmlBuffer[95] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 95, 20);
    }
    ...
    public String get_LINK_MODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[2].getValue(nIndex)));
    }
    ...
    public void populateCvFolder(CsApiBanOutput csApiBanOutput) throws FMLManipulationException {
        ...
        // TODO: How do we know which fields to map to which others?
            this.set_ROWCOUNT(csApiBanOutput.get_PNAMEADRBUFROWCOUNT());
        for (int i = 0, n = csApiBanOutput.get_LINK_TYPE_size(); i < n; ++i) {
            this.set_LINK_TYPE(i, csApiBanOutput.get_LINK_TYPE(i));
        }
        for (int i = 0, n = csApiBanOutput.get_LNKRECEFFECTIVE_DATE_size(); i < n; ++i) {
            this.set_EFFECTIVE_DATE(i, csApiBanOutput.get_LNKRECEFFECTIVE_DATE(i));
        }
        for (int i = 0, n = csApiBanOutput.get_NAMERECROWID_size(); i < n; ++i) {
            this.set_ROWID(i, csApiBanOutput.get_NAMERECROWID(i));
        }
        for (int i = 0, n = csApiBanOutput.get_NAMERECSYS_CREATION_DATE_size(); i < n; ++i) {
            this.set_SYS_CREATION_DATE(i, csApiBanOutput.get_NAMERECSYS_CREATION_DATE(i));
        }
        for (int i = 0, n = csApiBanOutput.get_NAMERECSYS_UPDATE_DATE_size(); i < n; ++i) {
            this.set_SYS_UPDATE_DATE(i, csApiBanOutput.get_NAMERECSYS_UPDATE_DATE(i));
        }
        for (int i = 0, n = csApiBanOutput.get_NAMERECDL_SERVICE_CODE_size(); i < n; ++i) {
            this.set_DL_SERVICE_CODE(i, csApiBanOutput.get_NAMERECDL_SERVICE_CODE(i));
        }
        for (int i = 0, n = csApiBanOutput.get_NAMERECDL_UPDATE_STAMP_size(); i < n; ++i) {
            this.set_DL_UPDATE_STAMP(i, csApiBanOutput.get_NAMERECDL_UPDATE_STAMP(i));
        }
        for (int i = 0, n = csApiBanOutput.get_NAMERECCONV_RUN_NO_size(); i < n; ++i) {
            this.set_CONV_RUN_NO(i, csApiBanOutput.get_NAMERECCONV_RUN_NO(i));
        }
    ...
    private void set_LINK_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[10].setValue(nIndex, TypeConverter.stringToByte(value));
    }

    private void set_EFFECTIVE_DATE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[11].setValue(nIndex, value);
    }

    private void set_ROWID(int nIndex, String value) throws FMLManipulationException {
    ...
    private void set_CONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
