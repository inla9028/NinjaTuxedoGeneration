 ...
 */
public class GnGetNlOutput extends ServiceOutput {

    /**
     * Creates a new instance of GnGetNlOutput.
     *
     * @throws FMLManipulationException
     */
    public GnGetNlOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public GnGetNlOutput() {
    }

    /**
     * Creates a new instance of GnGetNlOutput.
     *
     * @param ds Output dataset from GnGetNl service.
     * @throws FMLManipulationException
     */
    public GnGetNlOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[16] = new FmlField("NLDESC", FmlField.TYPE_STRING, 31, null, 16, 1);
        ...
        this.fmlBuffer[20] = new FmlField("NGP_ID", FmlField.TYPE_STRING, 4, null, 20, 50);
        this.fmlBuffer[21] = new FmlField("NGP_DSC", FmlField.TYPE_STRING, 31, null, 21, 50);
        this.fmlBuffer[22] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 22, 50);
    }
    ...
    /**
     * Retrieves the value of the 'NLDESC' field in the FML buffer.
     *
     * @return Value of 'NLDESC' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_NLDESC() throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'NGP_ID' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 50).
     * @return Value of 'NGP_ID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_NGP_ID(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[20].getValue(nIndex));
    }

    /**
     * Retrieves number of values defined for 'NGP_ID' field in the FML buffer.
     *
     * @return Number of values defined for 'NGP_ID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_NGP_ID_size() throws FMLManipulationException {
