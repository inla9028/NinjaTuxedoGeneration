...
public class CvSvEsnInput extends ServiceInput implements Conversable {
     ...
     */
    public CvSvEsnInput() throws FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("cvSvEsn", 77);
        ...
        this.fmlBuffer[69] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 69, 1);
        this.fmlBuffer[70] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 70, 1);
        this.fmlBuffer[71] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 71, 1);
        this.fmlBuffer[72] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 72, 1);
        this.fmlBuffer[73] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 73, 1);
        this.fmlBuffer[74] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 74, 1);
        this.fmlBuffer[75] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 75, 1);
        this.fmlBuffer[76] = new FmlField("ACT_COMPLETE_DATE", FmlField.TYPE_STRING, 9, null, 76, 1);
    }
    ...
    public void populateCsApiBan(CsApiBanInput csApiBanInput) throws FMLManipulationException {
        ...
        for (int i = 0, n = this.get_EXPIRATION_DATE_size(); i < n; ++i) {
