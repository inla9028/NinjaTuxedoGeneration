 ...
 */
public class CsLsPabxNlOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsLsPabxNlOutput.
     *
     * @throws FMLManipulationException
     */
    public CsLsPabxNlOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsLsPabxNlOutput() {
    }

    /**
     * Creates a new instance of CsLsPabxNlOutput.
     *
     * @param ds Output dataset from CsLsPabxNl service.
     * @throws FMLManipulationException
     */
    public CsLsPabxNlOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[15];
        ...
        this.fmlBuffer[5] = new FmlField("NL", FmlField.TYPE_STRING, 4, null, 5, 600);
        this.fmlBuffer[6] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 6, 600);
        ...
        this.fmlBuffer[13] = new FmlField("EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 13, 600);
        this.fmlBuffer[14] = new FmlField("TOTALCOUNT", FmlField.TYPE_INTEGER, -1, null, 14, 1);
    }
