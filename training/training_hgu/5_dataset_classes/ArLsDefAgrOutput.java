...
public class ArLsDefAgrOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[43] = new FmlField("SOC_QUANTITY", FmlField.TYPE_INTEGER, -1, null, 43, 600);
        ...
        this.fmlBuffer[51] = new FmlField("MAX_QUANTITY", FmlField.TYPE_INTEGER, -1, null, 51, 600);
    ...
    /**
     * Retrieves the value of the 'SEPARATE_CRG_IND' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 600).
     * @return Value of 'SEPARATE_CRG_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_SEPARATE_CRG_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[55].getValue(nIndex)));
    }

    /**
     * Retrieves number of values defined for 'SEPARATE_CRG_IND' field in the FML buffer.
     *
     * @return Number of values defined for 'SEPARATE_CRG_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_SEPARATE_CRG_IND_size() throws FMLManipulationException {
