 ...
 */
public class CsRsvMlCtnOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsRsvMlCtnOutput.
     *
     * @throws FMLManipulationException
     */
    public CsRsvMlCtnOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsRsvMlCtnOutput() {
    }

    /**
     * Creates a new instance of CsRsvMlCtnOutput.
     *
     * @param ds Output dataset from CsRsvMlCtn service.
     * @throws FMLManipulationException
     */
    public CsRsvMlCtnOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[17] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 17, 500);
        this.fmlBuffer[18] = new FmlField("RSVSTATUS", FmlField.TYPE_BYTE, -1, null, 18, 500);
    }
    ...
    /**
     * Retrieves the value of the 'RSVSTATUS' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 500).
     * @return Value of 'RSVSTATUS' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_RSVSTATUS(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[18].getValue(nIndex)));
    }

    /**
     * Retrieves number of values defined for 'RSVSTATUS' field in the FML buffer.
     *
     * @return Number of values defined for 'RSVSTATUS' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_RSVSTATUS_size() throws FMLManipulationException {
