 ...
 */
public class GnNodeActInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of GnNodeActInput
     *
     * @throws FMLManipulationException
     */
    public GnNodeActInput() throws FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("gnNodeAct", 24);
        ...
        this.fmlBuffer[16] = new FmlField("ACTIONCODE", FmlField.TYPE_BYTE, -1, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("NODEBAN", FmlField.TYPE_INTEGER, -1, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("PARENTBAN", FmlField.TYPE_INTEGER, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("TREEROOTBAN", FmlField.TYPE_INTEGER, -1, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("TREECYCLECODE", FmlField.TYPE_SHORT, -1, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("TML_IND", FmlField.TYPE_BYTE, -1, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("TREE_INDEX", FmlField.TYPE_DOUBLE, -1, null, 22, 1);
        this.fmlBuffer[23] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 23, 1);
    }
    ...
    /**
     * Retrieves the value of the 'ACTIONCODE' field in the FML buffer.
     *
     * @return Value of 'ACTIONCODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_ACTIONCODE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[16].getValue(0)));
    }

    /**
     * Sets the value of the 'ACTIONCODE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_ACTIONCODE(String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'TREECYCLECODE' field in the FML buffer.
     *
     * @return Value of 'TREECYCLECODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_TREECYCLECODE() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[20].getValue(0)));
    }

    /**
     * Sets the value of the 'TREECYCLECODE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_TREECYCLECODE(Integer value) throws FMLManipulationException {
    ...
    /**
     * Sets the value of the 'TML_IND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_TML_IND(String value) throws FMLManipulationException {
    ...
    /**
     * Sets the value of the 'TREE_INDEX' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_TREE_INDEX(Double value) throws FMLManipulationException {
