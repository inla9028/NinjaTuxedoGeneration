 ...
 */
public class ArGtOcInfoOutput extends ServiceOutput {

    /**
     * Creates a new instance of ArGtOcInfoOutput.
     *
     * @throws FMLManipulationException
     */
    public ArGtOcInfoOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public ArGtOcInfoOutput() {
    }

    /**
     * Creates a new instance of ArGtOcInfoOutput.
     *
     * @param ds Output dataset from ArGtOcInfo service.
     * @throws FMLManipulationException
     */
    public ArGtOcInfoOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[17] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("MANUAL_OC_CREATE_IND", FmlField.TYPE_BYTE, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("MNL_OC_TXT_OVRD_IND", FmlField.TYPE_BYTE, -1, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("MNL_OC_CHRG_LEVEL", FmlField.TYPE_BYTE, -1, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("MNL_OC_AMT_OVRD_IND", FmlField.TYPE_BYTE, -1, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("BILL_FIXED_TEXT", FmlField.TYPE_STRING, 61, null, 22, 1);
        this.fmlBuffer[23] = new FmlField("OC_CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 23, 1);
    }
    ...
    /**
     * Retrieves the value of the 'MANUAL_OC_CREATE_IND' field in the FML buffer.
     *
     * @return Value of 'MANUAL_OC_CREATE_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_MANUAL_OC_CREATE_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[18].getValue(0)));
    }

    /**
     * Retrieves the value of the 'MNL_OC_TXT_OVRD_IND' field in the FML buffer.
     *
     * @return Value of 'MNL_OC_TXT_OVRD_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_MNL_OC_TXT_OVRD_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[19].getValue(0)));
    }

    /**
     * Retrieves the value of the 'MNL_OC_CHRG_LEVEL' field in the FML buffer.
     *
     * @return Value of 'MNL_OC_CHRG_LEVEL' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_MNL_OC_CHRG_LEVEL() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[20].getValue(0)));
    }

    /**
     * Retrieves the value of the 'MNL_OC_AMT_OVRD_IND' field in the FML buffer.
     *
     * @return Value of 'MNL_OC_AMT_OVRD_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_MNL_OC_AMT_OVRD_IND() throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'OC_CHARGE_AMT' field in the FML buffer.
     *
     * @return Value of 'OC_CHARGE_AMT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Double get_OC_CHARGE_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[23].getValue(0));
    }
}