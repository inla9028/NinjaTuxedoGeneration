...
public class ArSvBanSvcOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[50] = new FmlField("PSRVFTRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 50, 1);
        this.fmlBuffer[51] = new FmlField("PSRVFTRBUFROWID", FmlField.TYPE_STRING, 19, null, 51, 500);
        this.fmlBuffer[52] = new FmlField("PSRVFTRBUFSOC", FmlField.TYPE_STRING, 10, null, 52, 500);
        this.fmlBuffer[53] = new FmlField("PSRVFTRBUFSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 53, 500);
        this.fmlBuffer[54] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 54, 500);
        this.fmlBuffer[55] = new FmlField("MPS_FTR_CODE", FmlField.TYPE_STRING, 7, null, 55, 500);
        this.fmlBuffer[56] = new FmlField("FTR_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 56, 500);
        this.fmlBuffer[57] = new FmlField("FTR_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 57, 500);
        this.fmlBuffer[58] = new FmlField("FTR_EFF_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 58, 500);
        this.fmlBuffer[59] = new FmlField("FTR_EXP_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 59, 500);
        this.fmlBuffer[60] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 60, 500);
        this.fmlBuffer[61] = new FmlField("FTR_MODE", FmlField.TYPE_BYTE, -1, null, 61, 500);
        this.fmlBuffer[62] = new FmlField("PSRVFTRBUFSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 62, 500);
        this.fmlBuffer[63] = new FmlField("FTR_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 63, 500);
        this.fmlBuffer[64] = new FmlField("FTR_ADD_PARAM", FmlField.TYPE_STRING, 301, null, 64, 500);
        this.fmlBuffer[65] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, null, 65, 500);
        this.fmlBuffer[66] = new FmlField("PSRVFTRBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 66, 500);
        this.fmlBuffer[67] = new FmlField("PSRVFTRBUFCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 67, 500);
        this.fmlBuffer[68] = new FmlField("FTR_SPECIAL_TELNO", FmlField.TYPE_STRING, 21, null, 68, 500);
        this.fmlBuffer[69] = new FmlField("SWITCH_ACT_NEEDED", FmlField.TYPE_BYTE, -1, null, 69, 500);
        this.fmlBuffer[70] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, null, 70, 500);
        this.fmlBuffer[71] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, null, 71, 500);
        this.fmlBuffer[72] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 72, 500);
        this.fmlBuffer[73] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, null, 73, 500);
        this.fmlBuffer[74] = new FmlField("MANUAL_RC_RATE", FmlField.TYPE_DOUBLE, -1, null, 74, 500);
        this.fmlBuffer[75] = new FmlField("MANUAL_RC_EXP_DATE", FmlField.TYPE_STRING, 9, null, 75, 500);
        this.fmlBuffer[76] = new FmlField("MANUAL_RC_EFF_DATE", FmlField.TYPE_STRING, 9, null, 76, 500);
    }
