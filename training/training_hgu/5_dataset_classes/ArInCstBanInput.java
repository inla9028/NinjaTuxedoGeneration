...
public class ArInCstBanInput extends ServiceInput {
    ...
    public ArInCstBanInput() throws FMLManipulationException {
        ...
        this.fmlBuffer[136] = new FmlField("ORG_CODE", FmlField.TYPE_STRING, 10, null, 136, 1);
        ...
        this.fmlBuffer[209] = new FmlField("TPID", FmlField.TYPE_STRING, 37, null, 209, 20);
        this.fmlBuffer[210] = new FmlField("E_FAKTURA_REF", FmlField.TYPE_INTEGER, -1, null, 210, 20);
        this.fmlBuffer[211] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 211, 20);
        this.fmlBuffer[212] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 212, 20);
        this.fmlBuffer[213] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 213, 20);
        this.fmlBuffer[214] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 214, 20);
        this.fmlBuffer[215] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 215, 20);
        this.fmlBuffer[216] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 216, 20);
        this.fmlBuffer[217] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 217, 20);
        this.fmlBuffer[218] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 218, 20);
        this.fmlBuffer[219] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 219, 20);
        this.fmlBuffer[220] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 220, 20);
        this.fmlBuffer[221] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 221, 20);
        this.fmlBuffer[222] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 222, 20);
        this.fmlBuffer[223] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 223, 20);
        this.fmlBuffer[224] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 224, 20);
        this.fmlBuffer[225] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 225, 20);
        this.fmlBuffer[226] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 226, 20);
        this.fmlBuffer[227] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 227, 20);
        this.fmlBuffer[228] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 228, 20);
        this.fmlBuffer[229] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 229, 20);
        this.fmlBuffer[230] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 230, 20);
        this.fmlBuffer[231] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 231, 20);
        this.fmlBuffer[232] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 232, 20);
        this.fmlBuffer[233] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 233, 20);
        this.fmlBuffer[234] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 234, 20);
        this.fmlBuffer[235] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 235, 20);
        this.fmlBuffer[236] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 236, 20);
        this.fmlBuffer[237] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 237, 20);
        this.fmlBuffer[238] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 238, 20);
        this.fmlBuffer[239] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 239, 20);
        this.fmlBuffer[240] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 240, 20);
        this.fmlBuffer[241] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 241, 20);
        this.fmlBuffer[242] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 242, 20);
        this.fmlBuffer[243] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 243, 20);
        this.fmlBuffer[244] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 244, 20);
        this.fmlBuffer[245] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 245, 20);
        this.fmlBuffer[246] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 246, 20);
        this.fmlBuffer[247] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 247, 20);
        this.fmlBuffer[248] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 248, 20);
        this.fmlBuffer[249] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 249, 20);
        this.fmlBuffer[250] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 250, 20);
        this.fmlBuffer[251] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 251, 20);
        this.fmlBuffer[252] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 252, 20);
        this.fmlBuffer[253] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 253, 20);
        this.fmlBuffer[254] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 254, 20);
        this.fmlBuffer[255] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 255, 20);
        this.fmlBuffer[256] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 256, 20);
        this.fmlBuffer[257] = new FmlField("PSVBLPRMBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 257, 1);
        this.fmlBuffer[258] = new FmlField("BPMODE", FmlField.TYPE_BYTE, -1, null, 258, 20);
        this.fmlBuffer[259] = new FmlField("BPSEQNO", FmlField.TYPE_INTEGER, -1, null, 259, 20);
        this.fmlBuffer[260] = new FmlField("BPEFFDATE", FmlField.TYPE_STRING, 9, null, 260, 20);
        this.fmlBuffer[261] = new FmlField("BPEXPDATE", FmlField.TYPE_STRING, 9, null, 261, 20);
        this.fmlBuffer[262] = new FmlField("BPFORMAT", FmlField.TYPE_STRING, 3, null, 262, 20);
        this.fmlBuffer[263] = new FmlField("BPMEDIA", FmlField.TYPE_STRING, 3, null, 263, 20);
        this.fmlBuffer[264] = new FmlField("BPPRINTCATEGORY", FmlField.TYPE_STRING, 3, null, 264, 20);
        this.fmlBuffer[265] = new FmlField("BPNOOFCOPIES", FmlField.TYPE_SHORT, -1, null, 265, 20);
        this.fmlBuffer[266] = new FmlField("BP_LANGUAGE", FmlField.TYPE_STRING, 3, null, 266, 20);
        this.fmlBuffer[267] = new FmlField("BP_CALL_DETAILS_MEDIA", FmlField.TYPE_BYTE, -1, null, 267, 20);
        this.fmlBuffer[268] = new FmlField("BP_REFERENCE_INFO", FmlField.TYPE_STRING, 31, null, 268, 20);
    }
    ...
    public void set_CS_CREDIT_CLASS(String value) throws FMLManipulationException {
        this.fmlBuffer[159].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_CS_APPROVED_CTN_QTY() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[160].getValue(0)));
    }
    ...
    public void set_CS_APPROVED_CTN_QTY(Integer value) throws FMLManipulationException {
        this.fmlBuffer[160].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_FOREIGN_SEQ_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[173].getValue(nIndex));
    }
    ...
    public void set_LINK_USER_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[179].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_NAMERECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[190].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public String get_NAME_FORMAT(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[195].getValue(nIndex)));
    }
    ...
    public void set_NAME_FORMAT(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[195].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_KOB(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[200].getValue(nIndex));
    }
    ...
    public Integer get_NAMERECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[203].getValue(nIndex)));
    }
    ...
    public void set_NAMERECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[203].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public void set_NAME_TITLE_SALUTATION(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[204].setValue(nIndex, value);
    }
    ...
    public void set_NATIONALITY_CD(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[205].setValue(nIndex, value);
    }
    ...
    public Integer get_E_FAKTURA_REF(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[210].getValue(nIndex));
    }
    ...
    public void set_ADR_MODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[211].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_ADR_UP_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[212].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_ADDRESSRECSYS_CREATION_DATE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[216].setValue(nIndex, value);
    }
    ...
    public Integer get_ADDRESSRECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[218].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[221].getValue(nIndex)));
    }
    ...
    public void set_ADDRESSRECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[221].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public void set_ADR_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[222].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_ADR_STATUS(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[223].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_CO_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[240].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_ADDRESSRECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[241].getValue(nIndex)));
    }
    ...
    public void set_ADDRESSRECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[241].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_BPSEQNO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[259].getValue(nIndex));
    }
    ...
    public Integer get_BPNOOFCOPIES(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[265].getValue(nIndex)));
    }
    ...
    public void set_BPNOOFCOPIES(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[265].setValue(nIndex, TypeConverter.integerToShort(value));
    }
