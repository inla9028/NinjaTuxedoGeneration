 ...
 */
public class CsActvMlCtnOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsActvMlCtnOutput.
     *
     * @throws FMLManipulationException
     */
    public CsActvMlCtnOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsActvMlCtnOutput() {
    }

    /**
     * Creates a new instance of CsActvMlCtnOutput.
     *
     * @param ds Output dataset from CsActvMlCtn service.
     * @throws FMLManipulationException
     */
    public CsActvMlCtnOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[16] = new FmlField("PCTNBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("MLACTVARRSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 17, 600);
        this.fmlBuffer[18] = new FmlField("PREACTV_IND", FmlField.TYPE_BYTE, -1, null, 18, 600);
        this.fmlBuffer[19] = new FmlField("SERIAL_NUMBER", FmlField.TYPE_STRING, 21, null, 19, 600);
        ...
        this.fmlBuffer[22] = new FmlField("MSISDN", FmlField.TYPE_STRING, 21, null, 22, 100);
        this.fmlBuffer[23] = new FmlField("NL", FmlField.TYPE_STRING, 4, null, 23, 100);
        this.fmlBuffer[24] = new FmlField("CODE", FmlField.TYPE_INTEGER, -1, null, 24, 100);
        this.fmlBuffer[25] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 25, 100);
        this.fmlBuffer[26] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 26, 100);
        this.fmlBuffer[27] = new FmlField("ERRORDESC", FmlField.TYPE_STRING, 2001, null, 27, 1);
    }
