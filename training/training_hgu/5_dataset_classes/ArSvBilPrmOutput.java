...
public class ArSvBilPrmOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[111] = new FmlField("PSVBLPRMBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 111, 1);
        this.fmlBuffer[112] = new FmlField("BPMODE", FmlField.TYPE_BYTE, -1, null, 112, 20);
        this.fmlBuffer[113] = new FmlField("BPSEQNO", FmlField.TYPE_INTEGER, -1, null, 113, 20);
        this.fmlBuffer[114] = new FmlField("BPEFFDATE", FmlField.TYPE_STRING, 9, null, 114, 20);
        this.fmlBuffer[115] = new FmlField("BPEXPDATE", FmlField.TYPE_STRING, 9, null, 115, 20);
        this.fmlBuffer[116] = new FmlField("BPFORMAT", FmlField.TYPE_STRING, 3, null, 116, 20);
        this.fmlBuffer[117] = new FmlField("BPMEDIA", FmlField.TYPE_STRING, 3, null, 117, 20);
        this.fmlBuffer[118] = new FmlField("BPPRINTCATEGORY", FmlField.TYPE_STRING, 3, null, 118, 20);
        this.fmlBuffer[119] = new FmlField("BPNOOFCOPIES", FmlField.TYPE_SHORT, -1, null, 119, 20);
        this.fmlBuffer[120] = new FmlField("BP_LANGUAGE", FmlField.TYPE_STRING, 3, null, 120, 20);
        this.fmlBuffer[121] = new FmlField("BP_CALL_DETAILS_MEDIA", FmlField.TYPE_BYTE, -1, null, 121, 20);
        this.fmlBuffer[122] = new FmlField("BP_REFERENCE_INFO", FmlField.TYPE_STRING, 31, null, 122, 20);
    }
