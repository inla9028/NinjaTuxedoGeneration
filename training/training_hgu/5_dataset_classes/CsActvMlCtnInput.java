 ...
 */
public class CsActvMlCtnInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsActvMlCtnInput
     *
     * @throws FMLManipulationException
     */
    public CsActvMlCtnInput() throws FMLManipulationException {
        // Initialise FML buffer
        fmlBuffer = new FmlField[406];

        //// Get default values from DB
        //synchronized (this.defaultValuesPopulated) {
        //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
        //        defaultValues = getDefaultValues("csActvMlCtn", 406);
        ...
        this.fmlBuffer[131] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 131, 1);
        this.fmlBuffer[132] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 132, 50);
        this.fmlBuffer[133] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 133, 50);
        this.fmlBuffer[134] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 134, 50);
        this.fmlBuffer[135] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 135, 50);
        this.fmlBuffer[136] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 136, 50);
        this.fmlBuffer[137] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 137, 50);
        this.fmlBuffer[138] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 138, 50);
        this.fmlBuffer[139] = new FmlField("P1", FmlField.TYPE_STRING, 51, null, 139, 50);
        this.fmlBuffer[140] = new FmlField("P2", FmlField.TYPE_STRING, 51, null, 140, 50);
        this.fmlBuffer[141] = new FmlField("P3", FmlField.TYPE_STRING, 51, null, 141, 50);
        this.fmlBuffer[142] = new FmlField("P4", FmlField.TYPE_STRING, 51, null, 142, 50);
        this.fmlBuffer[143] = new FmlField("P5", FmlField.TYPE_STRING, 51, null, 143, 50);
        this.fmlBuffer[144] = new FmlField("P6", FmlField.TYPE_STRING, 51, null, 144, 50);
        this.fmlBuffer[145] = new FmlField("P7", FmlField.TYPE_STRING, 51, null, 145, 50);
        this.fmlBuffer[146] = new FmlField("P8", FmlField.TYPE_STRING, 51, null, 146, 50);
        this.fmlBuffer[147] = new FmlField("P9", FmlField.TYPE_STRING, 51, null, 147, 50);
        this.fmlBuffer[148] = new FmlField("P10", FmlField.TYPE_STRING, 51, null, 148, 50);
        this.fmlBuffer[149] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 149, 50);
        this.fmlBuffer[150] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 150, 50);
        this.fmlBuffer[151] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 151, 50);
        this.fmlBuffer[152] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 152, 50);
        this.fmlBuffer[153] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 153, 50);
        this.fmlBuffer[154] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 154, 50);
        this.fmlBuffer[155] = new FmlField("PCTNRECROWID", FmlField.TYPE_STRING, 19, null, 155, 1);
        this.fmlBuffer[156] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 156, 1);
        this.fmlBuffer[157] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 157, 1);
        this.fmlBuffer[158] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 158, 1);
        this.fmlBuffer[159] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 159, 1);
        this.fmlBuffer[160] = new FmlField("PCTNRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 160, 1);
        this.fmlBuffer[161] = new FmlField("PCTNRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 161, 1);
        this.fmlBuffer[162] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 162, 1);
        this.fmlBuffer[163] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 163, 1);
        this.fmlBuffer[164] = new FmlField("PCTNRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 164, 1);
        this.fmlBuffer[165] = new FmlField("INIT_ACTIVATION_DATE", FmlField.TYPE_STRING, 9, null, 165, 1);
        this.fmlBuffer[166] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 166, 1);
        this.fmlBuffer[167] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 167, 1);
        this.fmlBuffer[168] = new FmlField("ORIGINAL_INIT_DATE", FmlField.TYPE_STRING, 15, null, 168, 1);
        this.fmlBuffer[169] = new FmlField("SUB_STATUS_LAST_ACT", FmlField.TYPE_STRING, 4, null, 169, 1);
        this.fmlBuffer[170] = new FmlField("SUB_STATUS_RSN_CODE", FmlField.TYPE_STRING, 5, null, 170, 1);
        this.fmlBuffer[171] = new FmlField("PCTNRECPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 171, 1);
        this.fmlBuffer[172] = new FmlField("CUSTOMER_BAN", FmlField.TYPE_INTEGER, -1, null, 172, 1);
        this.fmlBuffer[173] = new FmlField("CTN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 173, 1);
        this.fmlBuffer[174] = new FmlField("REQ_ST_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 174, 1);
        this.fmlBuffer[175] = new FmlField("REQ_END_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 175, 1);
        this.fmlBuffer[176] = new FmlField("COMMIT_START_DATE", FmlField.TYPE_STRING, 9, null, 176, 1);
        this.fmlBuffer[177] = new FmlField("COMMIT_END_DATE", FmlField.TYPE_STRING, 9, null, 177, 1);
        this.fmlBuffer[178] = new FmlField("COMMIT_REASON_CODE", FmlField.TYPE_STRING, 4, null, 178, 1);
        this.fmlBuffer[179] = new FmlField("PCTNRECCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 179, 1);
        this.fmlBuffer[180] = new FmlField("PCTNRECSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 180, 1);
        this.fmlBuffer[181] = new FmlField("CONTRACT_NO", FmlField.TYPE_STRING, 11, null, 181, 1);
        this.fmlBuffer[182] = new FmlField("CNT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 182, 1);
        this.fmlBuffer[183] = new FmlField("PCTNRECDEALER_CODE", FmlField.TYPE_STRING, 6, null, 183, 1);
        this.fmlBuffer[184] = new FmlField("ORG_DEALER_CODE", FmlField.TYPE_STRING, 6, null, 184, 1);
        this.fmlBuffer[185] = new FmlField("PCTNRECSALES_AGENT", FmlField.TYPE_STRING, 6, null, 185, 1);
        this.fmlBuffer[186] = new FmlField("ORG_SALES_AGENT", FmlField.TYPE_STRING, 6, null, 186, 1);
        this.fmlBuffer[187] = new FmlField("REQ_DEPOSIT_AMT", FmlField.TYPE_DOUBLE, -1, null, 187, 1);
        this.fmlBuffer[188] = new FmlField("LEADING_NUMBER", FmlField.TYPE_STRING, 21, null, 188, 1);
        this.fmlBuffer[189] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, null, 189, 1);
        this.fmlBuffer[190] = new FmlField("NEXT_CTN", FmlField.TYPE_STRING, 21, null, 190, 1);
        this.fmlBuffer[191] = new FmlField("NEXT_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 191, 1);
        this.fmlBuffer[192] = new FmlField("PRV_CTN", FmlField.TYPE_STRING, 21, null, 192, 1);
        this.fmlBuffer[193] = new FmlField("PRV_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 193, 1);
        this.fmlBuffer[194] = new FmlField("NEXT_BAN", FmlField.TYPE_INTEGER, -1, null, 194, 1);
        this.fmlBuffer[195] = new FmlField("NEXT_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 195, 1);
        this.fmlBuffer[196] = new FmlField("PRV_BAN", FmlField.TYPE_INTEGER, -1, null, 196, 1);
        this.fmlBuffer[197] = new FmlField("PRV_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 197, 1);
        this.fmlBuffer[198] = new FmlField("SUB_STS_ISSUE_DATE", FmlField.TYPE_STRING, 9, null, 198, 1);
        this.fmlBuffer[199] = new FmlField("ACTIVATE_WAIVE_RSN", FmlField.TYPE_STRING, 7, null, 199, 1);
        this.fmlBuffer[200] = new FmlField("EARLIEST_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 200, 1);
        this.fmlBuffer[201] = new FmlField("SUB_ACTV_LOCATION", FmlField.TYPE_STRING, 5, null, 201, 1);
        this.fmlBuffer[202] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 202, 1);
        this.fmlBuffer[203] = new FmlField("CUST_WATCH_DATE", FmlField.TYPE_STRING, 9, null, 203, 1);
        this.fmlBuffer[204] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 204, 1);
        this.fmlBuffer[205] = new FmlField("CREDIT_WATCH_PIN_CD", FmlField.TYPE_SHORT, -1, null, 205, 1);
        this.fmlBuffer[206] = new FmlField("SUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 206, 1);
        this.fmlBuffer[207] = new FmlField("LIMIT_RESERVED_DAYS", FmlField.TYPE_SHORT, -1, null, 207, 1);
        this.fmlBuffer[208] = new FmlField("FF_EXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 208, 1);
        this.fmlBuffer[209] = new FmlField("FLEX_IND", FmlField.TYPE_BYTE, -1, null, 209, 1);
        this.fmlBuffer[210] = new FmlField("DUO_IND", FmlField.TYPE_BYTE, -1, null, 210, 1);
        this.fmlBuffer[211] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, null, 211, 1);
        this.fmlBuffer[212] = new FmlField("SUB_DEPARTMENT_CD", FmlField.TYPE_STRING, 5, null, 212, 1);
        this.fmlBuffer[213] = new FmlField("LAST_SUBS_DISC_DT", FmlField.TYPE_STRING, 9, null, 213, 1);
        this.fmlBuffer[214] = new FmlField("LAST_SUBS_DISC_DT_UD", FmlField.TYPE_STRING, 9, null, 214, 1);
        this.fmlBuffer[215] = new FmlField("LAST_SUBSCR_DISC_SN", FmlField.TYPE_SHORT, -1, null, 215, 1);
        this.fmlBuffer[216] = new FmlField("LAST_SUBSCR_DISC_SN_UD", FmlField.TYPE_SHORT, -1, null, 216, 1);
        this.fmlBuffer[217] = new FmlField("PNI", FmlField.TYPE_STRING, 11, null, 217, 1);
        this.fmlBuffer[218] = new FmlField("RMS_REF_STORE_ID", FmlField.TYPE_STRING, 5, null, 218, 1);
        this.fmlBuffer[219] = new FmlField("RMS_REF_TYPE", FmlField.TYPE_BYTE, -1, null, 219, 1);
        this.fmlBuffer[220] = new FmlField("RMS_REF_OD", FmlField.TYPE_INTEGER, -1, null, 220, 1);
        this.fmlBuffer[221] = new FmlField("DLR_ACT_FEE", FmlField.TYPE_DOUBLE, -1, null, 221, 1);
        this.fmlBuffer[222] = new FmlField("PREP_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 222, 1);
        this.fmlBuffer[223] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 223, 1);
        this.fmlBuffer[224] = new FmlField("SUB_LANG", FmlField.TYPE_STRING, 3, null, 224, 1);
        this.fmlBuffer[225] = new FmlField("SMS_RCV_STYLE_CODE", FmlField.TYPE_STRING, 3, null, 225, 1);
        this.fmlBuffer[226] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 226, 1);
        this.fmlBuffer[227] = new FmlField("ALLOW_ADVERTISING_IND", FmlField.TYPE_BYTE, -1, null, 227, 1);
        this.fmlBuffer[228] = new FmlField("IVR_WRONG_ACCESS_NO", FmlField.TYPE_SHORT, -1, null, 228, 1);
        this.fmlBuffer[229] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, NinjaConfigurationReferenceTable.getThresholdAmt(), 229, 1);
        this.fmlBuffer[230] = new FmlField("PUBLISH_LEVEL", FmlField.TYPE_STRING, 31, null, 230, 1);
        this.fmlBuffer[231] = new FmlField("AUTO_RELEASE_IND", FmlField.TYPE_BYTE, -1, null, 231, 1);
        this.fmlBuffer[232] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, null, 232, 1);
        this.fmlBuffer[233] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, null, 233, 1);
        this.fmlBuffer[234] = new FmlField("OPERATOR_CW_LMT", FmlField.TYPE_DOUBLE, -1, null, 234, 1);
        this.fmlBuffer[235] = new FmlField("SEND_SMS_FOR_MATCH", FmlField.TYPE_BYTE, -1, null, 235, 1);
        this.fmlBuffer[236] = new FmlField("CPS_STATUS", FmlField.TYPE_BYTE, -1, null, 236, 1);
        this.fmlBuffer[237] = new FmlField("CPS_TRANSACTION", FmlField.TYPE_SHORT, -1, null, 237, 1);
        this.fmlBuffer[238] = new FmlField("CPS_TYPE", FmlField.TYPE_SHORT, -1, null, 238, 1);
        this.fmlBuffer[239] = new FmlField("ISP_PASS", FmlField.TYPE_STRING, 31, null, 239, 1);
        this.fmlBuffer[240] = new FmlField("ISP_TYPE", FmlField.TYPE_STRING, 3, null, 240, 1);
        this.fmlBuffer[241] = new FmlField("OPERATOR_TMP_DATE", FmlField.TYPE_STRING, 9, null, 241, 1);
        this.fmlBuffer[242] = new FmlField("OPERATOR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, null, 242, 1);
        this.fmlBuffer[243] = new FmlField("SUB_ORG_CD", FmlField.TYPE_STRING, 11, null, 243, 1);
        this.fmlBuffer[244] = new FmlField("ORG_MEMBER_NO", FmlField.TYPE_STRING, 21, null, 244, 1);
        this.fmlBuffer[245] = new FmlField("FIXED_AS_GSM_IND", FmlField.TYPE_BYTE, -1, null, 245, 1);
        this.fmlBuffer[246] = new FmlField("EARLY_PORT_OUT", FmlField.TYPE_BYTE, -1, null, 246, 1);
        this.fmlBuffer[247] = new FmlField("EARLY_PO_WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 247, 1);
        this.fmlBuffer[248] = new FmlField("EARLY_PO_WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 248, 1);
        this.fmlBuffer[249] = new FmlField("INTERNAL_CIRCUIT_ID", FmlField.TYPE_STRING, 21, null, 249, 1);
        this.fmlBuffer[250] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 250, 1);
        this.fmlBuffer[251] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 251, 20);
        this.fmlBuffer[252] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 252, 20);
        this.fmlBuffer[253] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 253, 20);
        this.fmlBuffer[254] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 254, 20);
        this.fmlBuffer[255] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 255, 20);
        this.fmlBuffer[256] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 256, 20);
        this.fmlBuffer[257] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 257, 20);
        this.fmlBuffer[258] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 258, 20);
        this.fmlBuffer[259] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 259, 20);
        this.fmlBuffer[260] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 260, 20);
        this.fmlBuffer[261] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 261, 20);
        this.fmlBuffer[262] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 262, 20);
        this.fmlBuffer[263] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 263, 20);
        this.fmlBuffer[264] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 264, 20);
        this.fmlBuffer[265] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 265, 20);
        this.fmlBuffer[266] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 266, 20);
        this.fmlBuffer[267] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 267, 20);
        this.fmlBuffer[268] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 268, 20);
        this.fmlBuffer[269] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 269, 20);
        this.fmlBuffer[270] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 270, 20);
        this.fmlBuffer[271] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 271, 20);
        this.fmlBuffer[272] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 272, 20);
        this.fmlBuffer[273] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 273, 20);
        this.fmlBuffer[274] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 274, 20);
        this.fmlBuffer[275] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 275, 20);
        this.fmlBuffer[276] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 276, 20);
        this.fmlBuffer[277] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 277, 20);
        this.fmlBuffer[278] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 278, 20);
        this.fmlBuffer[279] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 279, 20);
        this.fmlBuffer[280] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 280, 20);
        this.fmlBuffer[281] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 281, 20);
        this.fmlBuffer[282] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 282, 20);
        this.fmlBuffer[283] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 283, 20);
        this.fmlBuffer[284] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 284, 20);
        this.fmlBuffer[285] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 285, 20);
        this.fmlBuffer[286] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 286, 20);
        this.fmlBuffer[287] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 51, null, 287, 20);
        this.fmlBuffer[288] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 288, 20);
        this.fmlBuffer[289] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 289, 20);
        this.fmlBuffer[290] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 290, 20);
        this.fmlBuffer[291] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 291, 20);
        this.fmlBuffer[292] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 292, 20);
        this.fmlBuffer[293] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 293, 20);
        this.fmlBuffer[294] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 294, 20);
        this.fmlBuffer[295] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 295, 20);
        this.fmlBuffer[296] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 296, 20);
        this.fmlBuffer[297] = new FmlField("TPID", FmlField.TYPE_STRING, 37, null, 297, 20);
        this.fmlBuffer[298] = new FmlField("E_FAKTURA_REF", FmlField.TYPE_INTEGER, -1, null, 298, 20);
        this.fmlBuffer[299] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 299, 20);
        this.fmlBuffer[300] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 300, 20);
        this.fmlBuffer[301] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 301, 20);
        this.fmlBuffer[302] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 302, 20);
        this.fmlBuffer[303] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 303, 20);
        this.fmlBuffer[304] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 304, 20);
        this.fmlBuffer[305] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 305, 20);
        this.fmlBuffer[306] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 306, 20);
        this.fmlBuffer[307] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 307, 20);
        this.fmlBuffer[308] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 308, 20);
        this.fmlBuffer[309] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 309, 20);
        this.fmlBuffer[310] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 310, 20);
        this.fmlBuffer[311] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 311, 20);
        this.fmlBuffer[312] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 312, 20);
        this.fmlBuffer[313] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 313, 20);
        this.fmlBuffer[314] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 314, 20);
        this.fmlBuffer[315] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 315, 20);
        this.fmlBuffer[316] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 316, 20);
        this.fmlBuffer[317] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 317, 20);
        this.fmlBuffer[318] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 318, 20);
        this.fmlBuffer[319] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 319, 20);
        this.fmlBuffer[320] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 320, 20);
        this.fmlBuffer[321] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 321, 20);
        this.fmlBuffer[322] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 322, 20);
        this.fmlBuffer[323] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 323, 20);
        this.fmlBuffer[324] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 324, 20);
        this.fmlBuffer[325] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 325, 20);
        this.fmlBuffer[326] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 326, 20);
        this.fmlBuffer[327] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 327, 20);
        this.fmlBuffer[328] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 328, 20);
        this.fmlBuffer[329] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 329, 20);
        this.fmlBuffer[330] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 330, 20);
        this.fmlBuffer[331] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 331, 20);
        this.fmlBuffer[332] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 332, 20);
        this.fmlBuffer[333] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 333, 20);
        this.fmlBuffer[334] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 334, 20);
        this.fmlBuffer[335] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 335, 20);
        this.fmlBuffer[336] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 336, 20);
        this.fmlBuffer[337] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 337, 20);
        this.fmlBuffer[338] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 338, 20);
        this.fmlBuffer[339] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 339, 20);
        this.fmlBuffer[340] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 340, 20);
        this.fmlBuffer[341] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 341, 20);
        this.fmlBuffer[342] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 342, 20);
        this.fmlBuffer[343] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 343, 20);
        this.fmlBuffer[344] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 344, 20);
        this.fmlBuffer[345] = new FmlField("PINSTLBUFROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 345, 1);
        this.fmlBuffer[346] = new FmlField("INSTALLMENT_AMT", FmlField.TYPE_DOUBLE, -1, null, 346, 12);
        this.fmlBuffer[347] = new FmlField("INSTALLMENT_DATE", FmlField.TYPE_STRING, 9, null, 347, 12);
        this.fmlBuffer[348] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 348, 1);
        this.fmlBuffer[349] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 349, 2);
        this.fmlBuffer[350] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 350, 2);
        this.fmlBuffer[351] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 351, 1);
        this.fmlBuffer[352] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 352, 1);
        this.fmlBuffer[353] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 353, 1);
        this.fmlBuffer[354] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 354, 1);
        this.fmlBuffer[355] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 355, 1);
        this.fmlBuffer[356] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 356, 1);
        this.fmlBuffer[357] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 357, 1);
        this.fmlBuffer[358] = new FmlField("ACT_COMPLETE_DATE", FmlField.TYPE_STRING, 9, null, 358, 1);
        this.fmlBuffer[359] = new FmlField("PARINPBAN", FmlField.TYPE_INTEGER, -1, null, 359, 1);
        this.fmlBuffer[360] = new FmlField("PARTITION_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 360, 1);
        this.fmlBuffer[361] = new FmlField("PARINPSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 361, 1);
        this.fmlBuffer[362] = new FmlField("PARINPSUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 362, 1);
        this.fmlBuffer[363] = new FmlField("REQUIREMENT_DATE", FmlField.TYPE_STRING, 9, null, 363, 1);
        this.fmlBuffer[364] = new FmlField("ACTIVATION_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 364, 1);
        this.fmlBuffer[365] = new FmlField("PREPAYMENT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 365, 1);
        this.fmlBuffer[366] = new FmlField("PREP_ACTV_AMT", FmlField.TYPE_DOUBLE, -1, null, 366, 1);
        this.fmlBuffer[367] = new FmlField("RC_ONLY_IND", FmlField.TYPE_BYTE, -1, null, 367, 1);
        this.fmlBuffer[368] = new FmlField("PARINPDEALER_CODE", FmlField.TYPE_STRING, 6, null, 368, 1);
        this.fmlBuffer[369] = new FmlField("ACTV_EXMP_IND", FmlField.TYPE_BYTE, -1, null, 369, 1);
        this.fmlBuffer[370] = new FmlField("PREP_EXMP_IND", FmlField.TYPE_BYTE, -1, null, 370, 1);
        this.fmlBuffer[371] = new FmlField("SOURCE_APPL_CODE", FmlField.TYPE_BYTE, -1, null, 371, 1);
        this.fmlBuffer[372] = new FmlField("PARINPFEATURE_CODE", FmlField.TYPE_STRING, 7, null, 372, 1);
        this.fmlBuffer[373] = new FmlField("PARINPSOC", FmlField.TYPE_STRING, 10, null, 373, 1);
        this.fmlBuffer[374] = new FmlField("SOC_DATE", FmlField.TYPE_STRING, 9, null, 374, 1);
        this.fmlBuffer[375] = new FmlField("PCTNBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 375, 1);
        this.fmlBuffer[376] = new FmlField("MLACTVARRSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 376, 600);
        this.fmlBuffer[377] = new FmlField("PREACTV_IND", FmlField.TYPE_BYTE, -1, null, 377, 600);
        this.fmlBuffer[378] = new FmlField("SERIAL_NUMBER", FmlField.TYPE_STRING, 21, null, 378, 600);
        this.fmlBuffer[379] = new FmlField("CAS_PT_REQ", FmlField.TYPE_BYTE, -1, null, 379, 1);
        this.fmlBuffer[380] = new FmlField("PCSUPADDIFBUFBAN", FmlField.TYPE_INTEGER, -1, null, 380, 1);
        this.fmlBuffer[381] = new FmlField("PCSUPADDIFBUFSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 381, 1);
        this.fmlBuffer[382] = new FmlField("PCSUPADDIFBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 382, 1);
        this.fmlBuffer[383] = new FmlField("FIELD_NAME", FmlField.TYPE_STRING, 31, null, 383, 500);
        this.fmlBuffer[384] = new FmlField("FIELD_VALUE", FmlField.TYPE_STRING, 256, null, 384, 500);
        this.fmlBuffer[385] = new FmlField("PARSVDISCBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 385, 1);
        this.fmlBuffer[386] = new FmlField("PARDISCARRAYACTIONIND", FmlField.TYPE_BYTE, -1, null, 386, 100);
        this.fmlBuffer[387] = new FmlField("DEPLOYIND", FmlField.TYPE_BYTE, -1, null, 387, 100);
        this.fmlBuffer[388] = new FmlField("PARBANDISCROWID", FmlField.TYPE_STRING, 19, null, 388, 100);
        this.fmlBuffer[389] = new FmlField("PARBANDISCBAN", FmlField.TYPE_INTEGER, -1, null, 389, 100);
        this.fmlBuffer[390] = new FmlField("DISCOUNT_CODE", FmlField.TYPE_STRING, 7, null, 390, 100);
        this.fmlBuffer[391] = new FmlField("PARBANDISCSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 391, 100);
        this.fmlBuffer[392] = new FmlField("DISC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 392, 100);
        this.fmlBuffer[393] = new FmlField("PARBANDISCSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 393, 100);
        this.fmlBuffer[394] = new FmlField("PARBANDISCSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 394, 100);
        this.fmlBuffer[395] = new FmlField("PARBANDISCOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 395, 100);
        this.fmlBuffer[396] = new FmlField("PARBANDISCAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 396, 100);
        this.fmlBuffer[397] = new FmlField("PARBANDISCDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 397, 100);
        this.fmlBuffer[398] = new FmlField("PARBANDISCDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 398, 100);
        this.fmlBuffer[399] = new FmlField("PARBANDISCEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 399, 100);
        this.fmlBuffer[400] = new FmlField("DISC_BY_OPID", FmlField.TYPE_INTEGER, -1, null, 400, 100);
        this.fmlBuffer[401] = new FmlField("PARBANDISCEXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 401, 100);
        this.fmlBuffer[402] = new FmlField("PARBANDISCCAMPAIGN", FmlField.TYPE_STRING, 10, null, 402, 100);
        this.fmlBuffer[403] = new FmlField("PARBANDISCCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 403, 100);
        this.fmlBuffer[404] = new FmlField("POTENTIAL_SUBS_NO", FmlField.TYPE_INTEGER, -1, null, 404, 100);
        this.fmlBuffer[405] = new FmlField("LAST_POTENT_DATE", FmlField.TYPE_STRING, 9, null, 405, 100);
    }
    ...
    public Double get_MEMO_AMT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[149].getValue(nIndex));
    }
    ...
    public Double get_CHARGE_AMT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[151].getValue(nIndex));
    }
    ...
    public String get_SUB_STATUS() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[166].getValue(0)));
    }
    ...
    public void set_SUB_STATUS(String value) throws FMLManipulationException {
        this.fmlBuffer[166].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_CUSTOMER_BAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[172].getValue(0));
    }
    ...
    public Integer get_CTN_SEQ_NO() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[173].getValue(0));
    }
    ...
    public Integer get_PCTNRECCOMMIT_ORIG_NO_MONTH() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[179].getValue(0)));
    }
    ...
    public void set_PCTNRECCOMMIT_ORIG_NO_MONTH(Integer value) throws FMLManipulationException {
        this.fmlBuffer[179].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_PABX_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[189].getValue(0)));
    }
    ...
    public void set_PABX_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[189].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_CUST_WATCH_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[202].getValue(0));
    }
    ...
    public Double get_BASIC_WATCH_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[204].getValue(0));
    }
    ...
    public Integer get_LAST_SUBSCR_DISC_SN() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[215].getValue(0)));
    }
    ...
    public void set_LAST_SUBSCR_DISC_SN(Integer value) throws FMLManipulationException {
        this.fmlBuffer[215].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_LAST_SUBSCR_DISC_SN_UD() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[216].getValue(0)));
    }
    ...
    public void set_LAST_SUBSCR_DISC_SN_UD(Integer value) throws FMLManipulationException {
        this.fmlBuffer[216].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_DLR_ACT_FEE() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[221].getValue(0));
    }
    ...
    public Integer get_CONV_RUN_NO() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[226].getValue(0)));
    }
    ...
    public void set_CONV_RUN_NO(Integer value) throws FMLManipulationException {
        this.fmlBuffer[226].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_ALLOW_ADVERTISING_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[227].getValue(0)));
    }
    ...
    public void set_ALLOW_ADVERTISING_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[227].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_IVR_WRONG_ACCESS_NO() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[228].getValue(0)));
    }
    ...
    public void set_IVR_WRONG_ACCESS_NO(Integer value) throws FMLManipulationException {
        this.fmlBuffer[228].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_FIXED_AS_GSM_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[245].getValue(0)));
    }
    ...
    public void set_FIXED_AS_GSM_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[245].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_BAN(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[257].getValue(nIndex));
    }
    ...
    public String get_LINK_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[259].getValue(nIndex)));
    }
    ...
    public void set_LINK_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[259].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_BILLING_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[262].getValue(nIndex)));
    }
    ...
    public void set_BILLING_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[262].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_USER_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[264].getValue(nIndex)));
    }
    ...
    public void set_USER_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[264].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_LINK_BILLING_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[265].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_LINK_USER_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[267].getValue(nIndex)));
    }
    ...
    public void set_LINK_USER_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[267].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_NM_UP_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[269].getValue(nIndex)));
    }
    ...
    public void set_NM_UP_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[269].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_NAMERECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[278].getValue(nIndex)));
    }
    ...
    public void set_NAMERECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[278].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_KOB(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[288].getValue(nIndex));
    }
    ...
    public Integer get_NAMERECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[291].getValue(nIndex)));
    }
    ...
    public void set_NAMERECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[291].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[309].getValue(nIndex)));
    }
    ...
    public void set_ADDRESSRECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[309].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_PINSTLBUFROW_COUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[345].getValue(0));
    }
    ...
    public void set_PINSTLBUFROW_COUNT(Integer value) throws FMLManipulationException {
        this.fmlBuffer[345].setValue(0, value);
    }
    ...
    public Integer get_PFTRDEPBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[348].getValue(0));
    }
    ...
    public void set_PFTRDEPBUFROWCOUNT(Integer value) throws FMLManipulationException {
        this.fmlBuffer[348].setValue(0, value);
    }
    ...
    public Double get_DEPOSIT_AMOUNT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[350].getValue(nIndex));
    }
    ...
    public String get_FULLTABLE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[351].getValue(0)));
    }
    ...
    public void set_FULLTABLE(String value) throws FMLManipulationException {
        this.fmlBuffer[351].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_PAPER_WORK_STATUS() throws FMLManipulationException {
        return ((String) this.fmlBuffer[352].getValue(0));
    }
    ...
    public void set_PAPER_WORK_STATUS(String value) throws FMLManipulationException {
        this.fmlBuffer[352].setValue(0, value);
    }
    ...
    public String get_PAPER_WORK_REQUIRED() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[353].getValue(0)));
    }
    ...
    public void set_PAPER_WORK_REQUIRED(String value) throws FMLManipulationException {
        this.fmlBuffer[353].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_PAPER_WORK_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[354].getValue(0));
    }
    ...
    public void set_PAPER_WORK_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[354].setValue(0, value);
    }
    ...
    public String get_PAPER_WORK_REF_NO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[355].getValue(0));
    }
    ...
    public void set_PAPER_WORK_REF_NO(String value) throws FMLManipulationException {
        this.fmlBuffer[355].setValue(0, value);
    }
    ...
    public String get_PAPER_WORK_TRNS_NO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[356].getValue(0));
    }
    ...
    public void set_PAPER_WORK_TRNS_NO(String value) throws FMLManipulationException {
        this.fmlBuffer[356].setValue(0, value);
    }
    ...
    public String get_DELIVERY_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[357].getValue(0)));
    }
    ...
    public void set_DELIVERY_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[357].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_ACT_COMPLETE_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[358].getValue(0));
    }
    ...
    public void set_ACT_COMPLETE_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[358].setValue(0, value);
    }
    ...
    public Integer get_PARINPBAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[359].getValue(0));
    }
    ...
    public void set_PARINPBAN(Integer value) throws FMLManipulationException {
        this.fmlBuffer[359].setValue(0, value);
    }
    ...
    public Integer get_PARTITION_ROOT_BAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[360].getValue(0));
    }
    ...
    public void set_PARTITION_ROOT_BAN(Integer value) throws FMLManipulationException {
        this.fmlBuffer[360].setValue(0, value);
    }
    ...
    public String get_PARINPSUBSCRIBER_NO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[361].getValue(0));
    }
    ...
    public void set_PARINPSUBSCRIBER_NO(String value) throws FMLManipulationException {
        this.fmlBuffer[361].setValue(0, value);
    }
    ...
    public Double get_ACTIVATION_AMOUNT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[364].getValue(0));
    }
    ...
    public Double get_PREPAYMENT_AMOUNT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[365].getValue(0));
    }
    ...
    public Double get_PREP_ACTV_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[366].getValue(0));
    }
    ...
    /**
     * Retrieves the value of the 'PCTNBUFROWCOUNT' field in the FML buffer.
     *
     * @return Value of 'PCTNBUFROWCOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PCTNBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[375].getValue(0));
    }

    /**
     * Sets the value of the 'PCTNBUFROWCOUNT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PCTNBUFROWCOUNT(Integer value) throws FMLManipulationException {
        this.fmlBuffer[375].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'MLACTVARRSUBSCRIBER_NO' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 600).
     * @return Value of 'MLACTVARRSUBSCRIBER_NO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_MLACTVARRSUBSCRIBER_NO(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[376].getValue(nIndex));
    }

    /**
     * Sets the value of the 'MLACTVARRSUBSCRIBER_NO' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 600).
     * @throws FMLManipulationException
     */
    public void set_MLACTVARRSUBSCRIBER_NO(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[376].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'MLACTVARRSUBSCRIBER_NO' field in the FML buffer.
     *
     * @return Number of values defined for 'MLACTVARRSUBSCRIBER_NO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_MLACTVARRSUBSCRIBER_NO_size() throws FMLManipulationException {
        return (this.fmlBuffer[376].getCount());
    }

    /**
     * Retrieves the value of the 'PREACTV_IND' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 600).
     * @return Value of 'PREACTV_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PREACTV_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[377].getValue(nIndex)));
    }

    /**
     * Sets the value of the 'PREACTV_IND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 600).
     * @throws FMLManipulationException
     */
    public void set_PREACTV_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[377].setValue(nIndex, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves number of values defined for 'PREACTV_IND' field in the FML buffer.
     *
     * @return Number of values defined for 'PREACTV_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PREACTV_IND_size() throws FMLManipulationException {
    ...
    public String get_DEPLOYIND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[387].getValue(nIndex)));
    }
    ...
    public void set_DEPLOYIND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[387].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_DISC_SEQ_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[392].getValue(nIndex));
    }
    ...
    public Integer get_PARBANDISCDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[398].getValue(nIndex)));
    }
    ...
    public void set_PARBANDISCDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[398].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_DISC_BY_OPID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[400].getValue(nIndex));
    }
    ...
    public Integer get_POTENTIAL_SUBS_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[404].getValue(nIndex));
    }
