 ...
 */
public class CsLsOrgDepOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsLsOrgDepOutput.
     *
     * @throws FMLManipulationException
     */
    public CsLsOrgDepOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsLsOrgDepOutput() {
    }

    /**
     * Creates a new instance of CsLsOrgDepOutput.
     *
     * @param ds Output dataset from CsLsOrgDep service.
     * @throws FMLManipulationException
     */
    public CsLsOrgDepOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[5] = new FmlField("DEPARTMENT_CD", FmlField.TYPE_STRING, 5, null, 5, 600);
        ...
        this.fmlBuffer[12] = new FmlField("DEPT_DESC", FmlField.TYPE_STRING, 51, null, 12, 600);
        this.fmlBuffer[13] = new FmlField("TOTALCOUNT", FmlField.TYPE_INTEGER, -1, null, 13, 1);
    }
