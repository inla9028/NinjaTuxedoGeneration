...
public class CvSvNmAdrInput extends ServiceInput implements Conversable {
     ...
     */
    public CvSvNmAdrInput() throws FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("cvSvNmAdr", 117);
        ...
        this.fmlBuffer[59] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 51, null, 59, 20);
        ...
        this.fmlBuffer[69] = new FmlField("TPID", FmlField.TYPE_STRING, 37, null, 69, 20);
        this.fmlBuffer[70] = new FmlField("E_FAKTURA_REF", FmlField.TYPE_INTEGER, -1, null, 70, 20);
        this.fmlBuffer[71] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 71, 20);
        this.fmlBuffer[72] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 72, 20);
        this.fmlBuffer[73] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 73, 20);
        this.fmlBuffer[74] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 74, 20);
        this.fmlBuffer[75] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 75, 20);
        this.fmlBuffer[76] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 76, 20);
        this.fmlBuffer[77] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 77, 20);
        this.fmlBuffer[78] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 78, 20);
        this.fmlBuffer[79] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 79, 20);
        this.fmlBuffer[80] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 80, 20);
        this.fmlBuffer[81] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 81, 20);
        this.fmlBuffer[82] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 82, 20);
        this.fmlBuffer[83] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 83, 20);
        this.fmlBuffer[84] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 84, 20);
        this.fmlBuffer[85] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 85, 20);
        this.fmlBuffer[86] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 86, 20);
        this.fmlBuffer[87] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 87, 20);
        this.fmlBuffer[88] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 88, 20);
        this.fmlBuffer[89] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 89, 20);
        this.fmlBuffer[90] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 90, 20);
        this.fmlBuffer[91] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 91, 20);
        this.fmlBuffer[92] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 92, 20);
        this.fmlBuffer[93] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 93, 20);
        this.fmlBuffer[94] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 94, 20);
        this.fmlBuffer[95] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 95, 20);
        this.fmlBuffer[96] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 96, 20);
        this.fmlBuffer[97] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 97, 20);
        this.fmlBuffer[98] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 98, 20);
        this.fmlBuffer[99] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 99, 20);
        this.fmlBuffer[100] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 100, 20);
        this.fmlBuffer[101] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 101, 20);
        this.fmlBuffer[102] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 102, 20);
        this.fmlBuffer[103] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 103, 20);
        this.fmlBuffer[104] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 104, 20);
        this.fmlBuffer[105] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 105, 20);
        this.fmlBuffer[106] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 106, 20);
        this.fmlBuffer[107] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 107, 20);
        this.fmlBuffer[108] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 108, 20);
        this.fmlBuffer[109] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 109, 20);
        this.fmlBuffer[110] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 110, 20);
        this.fmlBuffer[111] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 111, 20);
        this.fmlBuffer[112] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 112, 20);
        this.fmlBuffer[113] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 113, 20);
        this.fmlBuffer[114] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 114, 20);
        this.fmlBuffer[115] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 115, 20);
        this.fmlBuffer[116] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 116, 20);
    }
    ...
    public void populateCsApiBan(CsApiBanInput csApiBanInput) throws FMLManipulationException {
        ...
        for (int i = 0, n = this.get_CONV_RUN_NO_size(); i < n; ++i) {
