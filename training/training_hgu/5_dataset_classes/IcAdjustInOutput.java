 ...
 */
public class IcAdjustInOutput extends ServiceOutput {

    /**
     * Creates a new instance of IcAdjustInOutput.
     *
     * @throws FMLManipulationException
     */
    public IcAdjustInOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public IcAdjustInOutput() {
    }

    /**
     * Creates a new instance of IcAdjustInOutput.
     *
     * @param ds Output dataset from IcAdjustIn service.
     * @throws FMLManipulationException
     */
    public IcAdjustInOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[16] = new FmlField("SERIAL_NUMBER", FmlField.TYPE_STRING, 21, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("ERRORNO", FmlField.TYPE_SHORT, -1, null, 17, 1);
    }
     ...
     * @throws FMLManipulationException
     */
    public String get_SERIAL_NUMBER() throws FMLManipulationException {
        return ((String) this.fmlBuffer[16].getValue(0));
    }

    /**
     * Retrieves the value of the 'ERRORNO' field in the FML buffer.
     *
     * @return Value of 'ERRORNO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_ERRORNO() throws FMLManipulationException {
