...
public class CsCnclCtnInput extends ServiceInput {
     ...
     */
    public CsCnclCtnInput() throws FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csCnclCtn", 63);
        ...
        this.fmlBuffer[38] = new FmlField("PENALTY_BASE_AMT", FmlField.TYPE_DOUBLE, -1, null, 38, 100);
        this.fmlBuffer[39] = new FmlField("MAIN_SIP_IND", FmlField.TYPE_BYTE, -1, null, 39, 100);
        this.fmlBuffer[40] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 40, 1);
        this.fmlBuffer[41] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 41, 1);
        this.fmlBuffer[42] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 42, 1);
        this.fmlBuffer[43] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 43, 1);
        this.fmlBuffer[44] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 44, 1);
        this.fmlBuffer[45] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 45, 1);
        this.fmlBuffer[46] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 46, 1);
        this.fmlBuffer[47] = new FmlField("P1", FmlField.TYPE_STRING, 51, null, 47, 1);
        this.fmlBuffer[48] = new FmlField("P2", FmlField.TYPE_STRING, 51, null, 48, 1);
        this.fmlBuffer[49] = new FmlField("P3", FmlField.TYPE_STRING, 51, null, 49, 1);
        this.fmlBuffer[50] = new FmlField("P4", FmlField.TYPE_STRING, 51, null, 50, 1);
        this.fmlBuffer[51] = new FmlField("P5", FmlField.TYPE_STRING, 51, null, 51, 1);
        this.fmlBuffer[52] = new FmlField("P6", FmlField.TYPE_STRING, 51, null, 52, 1);
        this.fmlBuffer[53] = new FmlField("P7", FmlField.TYPE_STRING, 51, null, 53, 1);
        this.fmlBuffer[54] = new FmlField("P8", FmlField.TYPE_STRING, 51, null, 54, 1);
        this.fmlBuffer[55] = new FmlField("P9", FmlField.TYPE_STRING, 51, null, 55, 1);
        this.fmlBuffer[56] = new FmlField("P10", FmlField.TYPE_STRING, 51, null, 56, 1);
        this.fmlBuffer[57] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 57, 1);
        this.fmlBuffer[58] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 58, 1);
        this.fmlBuffer[59] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 59, 1);
        this.fmlBuffer[60] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 60, 1);
        this.fmlBuffer[61] = new FmlField("PCSACTPARAMWAIVE_REASON", FmlField.TYPE_STRING, 7, null, 61, 1);
        this.fmlBuffer[62] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 62, 1);
    }
    ...
    public String get_SUSP_RC_RATE_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[42].getValue(0)));
    }
    ...
    public void set_SUSP_RC_RATE_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[42].setValue(0, TypeConverter.stringToByte(value));
    }
