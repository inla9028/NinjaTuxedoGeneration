...
public class CsLsBanCtnInput extends ServiceInput {
     ...
     */
    public CsLsBanCtnInput() throws FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csLsBanCtn", 25);
        ...
        this.fmlBuffer[24] = new FmlField("SELECTMODE", FmlField.TYPE_BYTE, -1, null, 24, 1);
    }
    ...
    /**
     * Retrieves the value of the 'SPECIFICCTN' field in the FML buffer.
     *
     * @return Value of 'SPECIFICCTN' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_SPECIFICCTN() throws FMLManipulationException {
        return ((String) this.fmlBuffer[23].getValue(0));
    }

    /**
     * Sets the value of the 'SPECIFICCTN' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_SPECIFICCTN(String value) throws FMLManipulationException {
        this.fmlBuffer[23].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'SELECTMODE' field in the FML buffer.
     *
     * @return Value of 'SELECTMODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_SELECTMODE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[24].getValue(0)));
    }

    /**
     * Sets the value of the 'SELECTMODE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_SELECTMODE(String value) throws FMLManipulationException {
