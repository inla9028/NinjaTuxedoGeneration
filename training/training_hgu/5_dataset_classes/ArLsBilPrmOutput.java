...
public class ArLsBilPrmOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[70];
        ...
        this.fmlBuffer[45] = new FmlField("TPID", FmlField.TYPE_STRING, 37, null, 45, 30);
        this.fmlBuffer[46] = new FmlField("E_FAKTURA_REF", FmlField.TYPE_INTEGER, -1, null, 46, 30);
        this.fmlBuffer[47] = new FmlField("ND_CONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 47, 30);
        this.fmlBuffer[48] = new FmlField("COMPNAME1", FmlField.TYPE_STRING, 61, null, 48, 30);
        this.fmlBuffer[49] = new FmlField("COMPNAME2", FmlField.TYPE_STRING, 61, null, 49, 30);
        this.fmlBuffer[50] = new FmlField("BL_PARAM_ROWID", FmlField.TYPE_STRING, 19, null, 50, 30);
        this.fmlBuffer[51] = new FmlField("BP_BAN", FmlField.TYPE_INTEGER, -1, null, 51, 30);
        this.fmlBuffer[52] = new FmlField("BP_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 52, 30);
        this.fmlBuffer[53] = new FmlField("BP_MEDIA_CATEGORY", FmlField.TYPE_STRING, 3, null, 53, 30);
        this.fmlBuffer[54] = new FmlField("BP_BILL_FORMAT", FmlField.TYPE_STRING, 3, null, 54, 30);
        this.fmlBuffer[55] = new FmlField("BP_NO_OF_COPIES", FmlField.TYPE_SHORT, -1, null, 55, 30);
        this.fmlBuffer[56] = new FmlField("BP_PRINT_CATEGORY", FmlField.TYPE_STRING, 3, null, 56, 30);
        this.fmlBuffer[57] = new FmlField("BP_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 57, 30);
        this.fmlBuffer[58] = new FmlField("BP_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 58, 30);
        this.fmlBuffer[59] = new FmlField("BP_LANGUAGE", FmlField.TYPE_STRING, 3, null, 59, 30);
        this.fmlBuffer[60] = new FmlField("BP_CALL_DETAILS_MEDIA", FmlField.TYPE_BYTE, -1, null, 60, 30);
        this.fmlBuffer[61] = new FmlField("FORMAT_DESC", FmlField.TYPE_STRING, 41, null, 61, 30);
        this.fmlBuffer[62] = new FmlField("PB_NAME", FmlField.TYPE_STRING, 41, null, 62, 30);
        this.fmlBuffer[63] = new FmlField("BP_REFERENCE_INFO", FmlField.TYPE_STRING, 31, null, 63, 30);
        this.fmlBuffer[64] = new FmlField("TOTALCOUNT", FmlField.TYPE_INTEGER, -1, null, 64, 1);
        this.fmlBuffer[65] = new FmlField("DCI_ERROR_CODE", FmlField.TYPE_INTEGER, -1, null, 65, 1);
        this.fmlBuffer[66] = new FmlField("DCI_ERROR_TYPE", FmlField.TYPE_SHORT, -1, null, 66, 1);
        this.fmlBuffer[67] = new FmlField("DCI_ERROR_TEXT", FmlField.TYPE_STRING, 81, null, 67, 1);
        this.fmlBuffer[68] = new FmlField("DCI_ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 68, 1);
        this.fmlBuffer[69] = new FmlField("DCI_MORE_ROWS", FmlField.TYPE_SHORT, -1, null, 69, 1);
    }
