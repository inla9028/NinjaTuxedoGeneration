...
public class ArGtBanOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[167];
    ...
    /**
     * Retrieves the value of the 'BL_INV_SEQ_NO' field in the FML buffer.
     *
     * @return Value of 'BL_INV_SEQ_NO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_BL_INV_SEQ_NO() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[161].getValue(0)));
    }
    ...
    public String get_HELD_SUB_LETTER_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[163].getValue(0)));
    }
