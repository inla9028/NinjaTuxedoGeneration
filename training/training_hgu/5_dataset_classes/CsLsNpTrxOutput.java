...
public class CsLsNpTrxOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[159];
        this.fmlBuffer[0] = new FmlField("GENERATION", FmlField.TYPE_INTEGER, -1, null, 0, 1);
        this.fmlBuffer[1] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 1, 1);
        this.fmlBuffer[2] = new FmlField("TRX_CODE_S", FmlField.TYPE_STRING, 4, null, 2, 1);
        ...
        this.fmlBuffer[74] = new FmlField("EIDNODSIGN", FmlField.TYPE_STRING, 21, null, 74, 200);
        this.fmlBuffer[75] = new FmlField("EIDNTYP", FmlField.TYPE_STRING, 21, null, 75, 200);
        this.fmlBuffer[76] = new FmlField("EIDNTYPNUMB", FmlField.TYPE_STRING, 21, null, 76, 200);
        this.fmlBuffer[77] = new FmlField("NEIDNODSIGN", FmlField.TYPE_STRING, 21, null, 77, 200);
        this.fmlBuffer[78] = new FmlField("NEIDNTYP", FmlField.TYPE_STRING, 21, null, 78, 200);
        this.fmlBuffer[79] = new FmlField("NEIDNTYPNUMB", FmlField.TYPE_STRING, 21, null, 79, 200);
        ...
        this.fmlBuffer[130] = new FmlField("PORT_IND", FmlField.TYPE_BYTE, -1, null, 130, 50);
        this.fmlBuffer[131] = new FmlField("PNPERRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 131, 1);
        this.fmlBuffer[132] = new FmlField("NPTRXERRBUFROWID", FmlField.TYPE_STRING, 19, null, 132, 500);
        this.fmlBuffer[133] = new FmlField("NPTRXERRBUFERROR_UNIQ_ID", FmlField.TYPE_INTEGER, -1, null, 133, 500);
        this.fmlBuffer[134] = new FmlField("REJ_ERR_SEQ", FmlField.TYPE_INTEGER, -1, null, 134, 500);
        this.fmlBuffer[135] = new FmlField("NPTRXERRBUFSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 135, 500);
        this.fmlBuffer[136] = new FmlField("NPTRXERRBUFSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 136, 500);
        this.fmlBuffer[137] = new FmlField("NPTRXERRBUFOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 137, 500);
        this.fmlBuffer[138] = new FmlField("NPTRXERRBUFAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 138, 500);
        this.fmlBuffer[139] = new FmlField("NPTRXERRBUFDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 139, 500);
        this.fmlBuffer[140] = new FmlField("NPTRXERRBUFDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 140, 500);
        this.fmlBuffer[141] = new FmlField("REJ_ERR_CD", FmlField.TYPE_INTEGER, -1, null, 141, 500);
        this.fmlBuffer[142] = new FmlField("REJ_ERR_TXT", FmlField.TYPE_STRING, 256, null, 142, 500);
        this.fmlBuffer[143] = new FmlField("ERR_FIELD", FmlField.TYPE_STRING, 256, null, 143, 500);
        this.fmlBuffer[144] = new FmlField("DCI_ERROR_CODE", FmlField.TYPE_INTEGER, -1, null, 144, 1);
        this.fmlBuffer[145] = new FmlField("DCI_ERROR_TYPE", FmlField.TYPE_SHORT, -1, null, 145, 1);
        this.fmlBuffer[146] = new FmlField("DCI_ERROR_TEXT", FmlField.TYPE_STRING, 81, null, 146, 1);
        this.fmlBuffer[147] = new FmlField("DCI_ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 147, 1);
        this.fmlBuffer[148] = new FmlField("DCI_MORE_ROWS", FmlField.TYPE_SHORT, -1, null, 148, 1);
        this.fmlBuffer[149] = new FmlField("PNPSERBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 149, 1);
        this.fmlBuffer[150] = new FmlField("NPTRXSERBUFROWID", FmlField.TYPE_STRING, 19, null, 150, 500);
        this.fmlBuffer[151] = new FmlField("NPTRXSERBUFSERIES_UNIQ_ID", FmlField.TYPE_INTEGER, -1, null, 151, 500);
        this.fmlBuffer[152] = new FmlField("SERIES", FmlField.TYPE_STRING, 18, null, 152, 500);
        this.fmlBuffer[153] = new FmlField("NPTRXSERBUFSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 153, 500);
        this.fmlBuffer[154] = new FmlField("NPTRXSERBUFSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 154, 500);
        this.fmlBuffer[155] = new FmlField("NPTRXSERBUFOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 155, 500);
        this.fmlBuffer[156] = new FmlField("NPTRXSERBUFAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 156, 500);
        this.fmlBuffer[157] = new FmlField("NPTRXSERBUFDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 157, 500);
        this.fmlBuffer[158] = new FmlField("NPTRXSERBUFDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 158, 500);
    }
    ...
    public Integer get_DCI_ERROR_TYPE() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[145].getValue(0)));
    }
