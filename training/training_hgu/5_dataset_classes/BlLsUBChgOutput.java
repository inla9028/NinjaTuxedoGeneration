...
public class BlLsUBChgOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[123];
        ...
        this.fmlBuffer[41] = new FmlField("DISCOUNT_PCT_L", FmlField.TYPE_INTEGER, -1, null, 41, 600);
        ...
        this.fmlBuffer[59] = new FmlField("BILL_COMMENT", FmlField.TYPE_STRING, 501, null, 59, 600);
        this.fmlBuffer[60] = new FmlField("QUANTITY", FmlField.TYPE_INTEGER, -1, null, 60, 600);
        this.fmlBuffer[61] = new FmlField("TML_UTC_IND", FmlField.TYPE_BYTE, -1, null, 61, 600);
        this.fmlBuffer[62] = new FmlField("PUBADJROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 62, 1);
        this.fmlBuffer[63] = new FmlField("BLADJROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 63, 500);
        this.fmlBuffer[64] = new FmlField("BLADJBAN", FmlField.TYPE_INTEGER, -1, null, 64, 500);
        this.fmlBuffer[65] = new FmlField("BLADJVOUCHER_NUM", FmlField.TYPE_STRING, 14, null, 65, 500);
        this.fmlBuffer[66] = new FmlField("BLADJSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 66, 500);
        this.fmlBuffer[67] = new FmlField("BLADJENT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 67, 500);
        this.fmlBuffer[68] = new FmlField("BLADJACTV_SEQ_NO", FmlField.TYPE_SHORT, -1, null, 68, 500);
        this.fmlBuffer[69] = new FmlField("BLADJPRIOD_CVRG_ST_DATE", FmlField.TYPE_STRING, 9, null, 69, 500);
        this.fmlBuffer[70] = new FmlField("BLADJPRIOD_CVRG_ND_DATE", FmlField.TYPE_STRING, 9, null, 70, 500);
        this.fmlBuffer[71] = new FmlField("BLADJCHG_CREATION_DATE", FmlField.TYPE_STRING, 9, null, 71, 500);
        this.fmlBuffer[72] = new FmlField("BLADJACTV_CODE", FmlField.TYPE_STRING, 5, null, 72, 500);
        this.fmlBuffer[73] = new FmlField("BLADJACTV_REASON_CODE", FmlField.TYPE_STRING, 7, null, 73, 500);
        this.fmlBuffer[74] = new FmlField("BLADJACTV_AMT", FmlField.TYPE_DOUBLE, -1, null, 74, 500);
        this.fmlBuffer[75] = new FmlField("BLADJDURATION", FmlField.TYPE_DOUBLE, -1, null, 75, 500);
        this.fmlBuffer[76] = new FmlField("BLADJIM_ALLOWED_PRD_1", FmlField.TYPE_DOUBLE, -1, null, 76, 500);
        this.fmlBuffer[77] = new FmlField("BLADJIM_ALLOWED_PRD_2", FmlField.TYPE_DOUBLE, -1, null, 77, 500);
        this.fmlBuffer[78] = new FmlField("BLADJIM_ALLOWED_PRD_3", FmlField.TYPE_DOUBLE, -1, null, 78, 500);
        this.fmlBuffer[79] = new FmlField("BLADJIM_ALLOWED_PRD_4", FmlField.TYPE_DOUBLE, -1, null, 79, 500);
        this.fmlBuffer[80] = new FmlField("BLADJIM_ALLOWED_PRD_5", FmlField.TYPE_DOUBLE, -1, null, 80, 500);
        this.fmlBuffer[81] = new FmlField("BLADJIM_ALLOWED_PRD_6", FmlField.TYPE_DOUBLE, -1, null, 81, 500);
        this.fmlBuffer[82] = new FmlField("BLADJIM_ALLOWED_COMBD", FmlField.TYPE_DOUBLE, -1, null, 82, 500);
        this.fmlBuffer[83] = new FmlField("BLADJCTN_IM_USED_PRD_1", FmlField.TYPE_DOUBLE, -1, null, 83, 500);
        this.fmlBuffer[84] = new FmlField("BLADJCTN_IM_USED_PRD_2", FmlField.TYPE_DOUBLE, -1, null, 84, 500);
        this.fmlBuffer[85] = new FmlField("BLADJCTN_IM_USED_PRD_3", FmlField.TYPE_DOUBLE, -1, null, 85, 500);
        this.fmlBuffer[86] = new FmlField("BLADJCTN_IM_USED_PRD_4", FmlField.TYPE_DOUBLE, -1, null, 86, 500);
        this.fmlBuffer[87] = new FmlField("BLADJCTN_IM_USED_PRD_5", FmlField.TYPE_DOUBLE, -1, null, 87, 500);
        this.fmlBuffer[88] = new FmlField("BLADJCTN_IM_USED_PRD_6", FmlField.TYPE_DOUBLE, -1, null, 88, 500);
        this.fmlBuffer[89] = new FmlField("BLADJCTN_IM_USED_COMBD", FmlField.TYPE_DOUBLE, -1, null, 89, 500);
        this.fmlBuffer[90] = new FmlField("BLADJNUM_OF_CALLS", FmlField.TYPE_INTEGER, -1, null, 90, 500);
        this.fmlBuffer[91] = new FmlField("BLADJFEATURE_CODE", FmlField.TYPE_STRING, 7, null, 91, 500);
        this.fmlBuffer[92] = new FmlField("BLADJFTR_REVENUE_CODE", FmlField.TYPE_STRING, 4, null, 92, 500);
        this.fmlBuffer[93] = new FmlField("BLADJFEATURE_CATEGORY", FmlField.TYPE_STRING, 5, null, 93, 500);
        this.fmlBuffer[94] = new FmlField("BLADJBALANCE_IMPACT_CODE", FmlField.TYPE_BYTE, -1, null, 94, 500);
        this.fmlBuffer[95] = new FmlField("BLADJSOC", FmlField.TYPE_STRING, 10, null, 95, 500);
        this.fmlBuffer[96] = new FmlField("BLADJSOC_VER_NO", FmlField.TYPE_INTEGER, -1, null, 96, 500);
        this.fmlBuffer[97] = new FmlField("BLADJTOLL_RS_CODE", FmlField.TYPE_STRING, 10, null, 97, 500);
        this.fmlBuffer[98] = new FmlField("BLADJSOURCE_APPL_CODE", FmlField.TYPE_BYTE, -1, null, 98, 500);
        this.fmlBuffer[99] = new FmlField("BLADJVAT_AMT", FmlField.TYPE_DOUBLE, -1, null, 99, 500);
        this.fmlBuffer[100] = new FmlField("BLADJVAT_EXMP_AMT", FmlField.TYPE_DOUBLE, -1, null, 100, 500);
        this.fmlBuffer[101] = new FmlField("BLADJTAX_CODE", FmlField.TYPE_BYTE, -1, null, 101, 500);
        this.fmlBuffer[102] = new FmlField("BLADJDISCOUNT_PCT_L", FmlField.TYPE_INTEGER, -1, null, 102, 500);
        this.fmlBuffer[103] = new FmlField("BLADJDISCOUNT_CODE", FmlField.TYPE_STRING, 10, null, 103, 500);
        this.fmlBuffer[104] = new FmlField("BLADJCREDIT_LEVEL", FmlField.TYPE_BYTE, -1, null, 104, 500);
        this.fmlBuffer[105] = new FmlField("BLADJACTION_DIRECTION_CD", FmlField.TYPE_BYTE, -1, null, 105, 500);
        this.fmlBuffer[106] = new FmlField("BLADJUTC_DISCOUNT_TYPE", FmlField.TYPE_STRING, 3, null, 106, 500);
        this.fmlBuffer[107] = new FmlField("BLADJUTC_FROM_TO_BAN", FmlField.TYPE_INTEGER, -1, null, 107, 500);
        this.fmlBuffer[108] = new FmlField("BLADJUTC_FROM_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 108, 500);
        this.fmlBuffer[109] = new FmlField("BLADJCHANNEL_SEIZURE_DT", FmlField.TYPE_STRING, 15, null, 109, 500);
        this.fmlBuffer[110] = new FmlField("BLADJMESSAGE_SWITCH_ID", FmlField.TYPE_STRING, 8, null, 110, 500);
        this.fmlBuffer[111] = new FmlField("BLADJMESSAGE_IDENTIFIER", FmlField.TYPE_STRING, 25, null, 111, 500);
        this.fmlBuffer[112] = new FmlField("BLADJRERATE_REQUIRED_IND", FmlField.TYPE_BYTE, -1, null, 112, 500);
        this.fmlBuffer[113] = new FmlField("BLADJBL_IGNORE_IND", FmlField.TYPE_BYTE, -1, null, 113, 500);
        this.fmlBuffer[114] = new FmlField("BLADJCHARGE_TYPE", FmlField.TYPE_BYTE, -1, null, 114, 500);
        this.fmlBuffer[115] = new FmlField("BLADJADJ_REVERSAL_IND", FmlField.TYPE_BYTE, -1, null, 115, 500);
        this.fmlBuffer[116] = new FmlField("BLADJVCHR_NUM_OF_ADJ_REV", FmlField.TYPE_STRING, 14, null, 116, 500);
        this.fmlBuffer[117] = new FmlField("BLADJUNIT_MEASURE_CODE", FmlField.TYPE_BYTE, -1, null, 117, 500);
        this.fmlBuffer[118] = new FmlField("BLADJMATCH_TIER_LEVEL", FmlField.TYPE_SHORT, -1, null, 118, 500);
        this.fmlBuffer[119] = new FmlField("BLADJSERVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 119, 500);
        this.fmlBuffer[120] = new FmlField("BLADJBILL_COMMENT", FmlField.TYPE_STRING, 501, null, 120, 500);
        this.fmlBuffer[121] = new FmlField("BLADJQUANTITY", FmlField.TYPE_INTEGER, -1, null, 121, 500);
        this.fmlBuffer[122] = new FmlField("BLADJTML_UTC_IND", FmlField.TYPE_BYTE, -1, null, 122, 500);
    }
    ...
    public Integer get_BLADJACTV_SEQ_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[68].getValue(nIndex)));
    }
    ...
    public Double get_BLADJCTN_IM_USED_PRD_5(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[87].getValue(nIndex));
    }
    ...
    /**
     * Retrieves the value of the 'BLADJDISCOUNT_PCT_L' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 500).
     * @return Value of 'BLADJDISCOUNT_PCT_L' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_BLADJDISCOUNT_PCT_L(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[102].getValue(nIndex));
    }

    /**
     * Retrieves number of values defined for 'BLADJDISCOUNT_PCT_L' field in the FML buffer.
     *
     * @return Number of values defined for 'BLADJDISCOUNT_PCT_L' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_BLADJDISCOUNT_PCT_L_size() throws FMLManipulationException {
    ...
    public Integer get_BLADJMATCH_TIER_LEVEL(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[118].getValue(nIndex)));
    }
    ...
    /**
     * Retrieves the value of the 'BLADJBILL_COMMENT' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 500).
     * @return Value of 'BLADJBILL_COMMENT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_BLADJBILL_COMMENT(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[120].getValue(nIndex));
    }

    /**
     * Retrieves number of values defined for 'BLADJBILL_COMMENT' field in the FML buffer.
     *
     * @return Number of values defined for 'BLADJBILL_COMMENT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_BLADJBILL_COMMENT_size() throws FMLManipulationException {
        return (this.fmlBuffer[120].getCount());
    }

    /**
     * Retrieves the value of the 'BLADJQUANTITY' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 500).
     * @return Value of 'BLADJQUANTITY' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_BLADJQUANTITY(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[121].getValue(nIndex));
    }

    /**
     * Retrieves number of values defined for 'BLADJQUANTITY' field in the FML buffer.
     *
     * @return Number of values defined for 'BLADJQUANTITY' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_BLADJQUANTITY_size() throws FMLManipulationException {
        return (this.fmlBuffer[121].getCount());
    }

    /**
     * Retrieves the value of the 'BLADJTML_UTC_IND' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 500).
     * @return Value of 'BLADJTML_UTC_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_BLADJTML_UTC_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[122].getValue(nIndex)));
    }

    /**
     * Retrieves number of values defined for 'BLADJTML_UTC_IND' field in the FML buffer.
     *
     * @return Number of values defined for 'BLADJTML_UTC_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_BLADJTML_UTC_IND_size() throws FMLManipulationException {
