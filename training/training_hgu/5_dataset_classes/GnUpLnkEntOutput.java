...
public class GnUpLnkEntOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[110];
        ...
        this.fmlBuffer[52] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 51, null, 52, 1);
        ...
        this.fmlBuffer[62] = new FmlField("TPID", FmlField.TYPE_STRING, 37, null, 62, 1);
        this.fmlBuffer[63] = new FmlField("E_FAKTURA_REF", FmlField.TYPE_INTEGER, -1, null, 63, 1);
        this.fmlBuffer[64] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 64, 1);
        this.fmlBuffer[65] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 65, 1);
        this.fmlBuffer[66] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 66, 1);
        this.fmlBuffer[67] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 67, 1);
        this.fmlBuffer[68] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 68, 1);
        this.fmlBuffer[69] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 69, 1);
        this.fmlBuffer[70] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 70, 1);
        this.fmlBuffer[71] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 71, 1);
        this.fmlBuffer[72] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 72, 1);
        this.fmlBuffer[73] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 73, 1);
        this.fmlBuffer[74] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 74, 1);
        this.fmlBuffer[75] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 75, 1);
        this.fmlBuffer[76] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 76, 1);
        this.fmlBuffer[77] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 77, 1);
        this.fmlBuffer[78] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 78, 1);
        this.fmlBuffer[79] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 79, 1);
        this.fmlBuffer[80] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 80, 1);
        this.fmlBuffer[81] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 81, 1);
        this.fmlBuffer[82] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 82, 1);
        this.fmlBuffer[83] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 83, 1);
        this.fmlBuffer[84] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 84, 1);
        this.fmlBuffer[85] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 85, 1);
        this.fmlBuffer[86] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 86, 1);
        this.fmlBuffer[87] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 87, 1);
        this.fmlBuffer[88] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 88, 1);
        this.fmlBuffer[89] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 89, 1);
        this.fmlBuffer[90] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 90, 1);
        this.fmlBuffer[91] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 91, 1);
        this.fmlBuffer[92] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 92, 1);
        this.fmlBuffer[93] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 93, 1);
        this.fmlBuffer[94] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 94, 1);
        this.fmlBuffer[95] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 95, 1);
        this.fmlBuffer[96] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 96, 1);
        this.fmlBuffer[97] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 97, 1);
        this.fmlBuffer[98] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 98, 1);
        this.fmlBuffer[99] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 99, 1);
        this.fmlBuffer[100] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 100, 1);
        this.fmlBuffer[101] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 101, 1);
        this.fmlBuffer[102] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 102, 1);
        this.fmlBuffer[103] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 103, 1);
        this.fmlBuffer[104] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 104, 1);
        this.fmlBuffer[105] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 105, 1);
        this.fmlBuffer[106] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 106, 1);
        this.fmlBuffer[107] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 107, 1);
        this.fmlBuffer[108] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 108, 1);
        this.fmlBuffer[109] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 109, 1);
    }
