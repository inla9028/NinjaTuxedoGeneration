...
public class CsMoveCtnInput extends ServiceInput {
    ...
    public CsMoveCtnInput() throws FMLManipulationException {
        ...
        this.fmlBuffer[43] = new FmlField("SOC_QUANTITY", FmlField.TYPE_INTEGER, -1, null, 43, 50);
        this.fmlBuffer[44] = new FmlField("BILL_TEXT", FmlField.TYPE_STRING, 41, null, 44, 50);
        this.fmlBuffer[45] = new FmlField("FULL_AMT", FmlField.TYPE_DOUBLE, -1, null, 45, 50);
        this.fmlBuffer[46] = new FmlField("FIRST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 46, 50);
        this.fmlBuffer[47] = new FmlField("OTHER_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 47, 50);
        this.fmlBuffer[48] = new FmlField("LAST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 48, 50);
        this.fmlBuffer[49] = new FmlField("NO_OF_INSTALLMENTS", FmlField.TYPE_SHORT, -1, null, 49, 50);
        this.fmlBuffer[50] = new FmlField("PAGRRECROWID", FmlField.TYPE_STRING, 19, null, 50, 1);
        this.fmlBuffer[51] = new FmlField("PAGRRECSOC", FmlField.TYPE_STRING, 10, null, 51, 1);
        this.fmlBuffer[52] = new FmlField("PAGRRECSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 52, 1);
        this.fmlBuffer[53] = new FmlField("PAGRRECCOMMITMENT_END_DATE", FmlField.TYPE_STRING, 9, null, 53, 1);
        this.fmlBuffer[54] = new FmlField("PAGRRECSERVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 54, 1);
        this.fmlBuffer[55] = new FmlField("PAGRRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 55, 1);
        this.fmlBuffer[56] = new FmlField("PAGRRECEXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 56, 1);
        this.fmlBuffer[57] = new FmlField("PAGRRECSOC_LEVEL_CODE", FmlField.TYPE_BYTE, -1, null, 57, 1);
        this.fmlBuffer[58] = new FmlField("PAGRRECDEALER_CODE", FmlField.TYPE_STRING, 6, null, 58, 1);
        this.fmlBuffer[59] = new FmlField("PAGRRECSALES_AGENT", FmlField.TYPE_STRING, 6, null, 59, 1);
        this.fmlBuffer[60] = new FmlField("PAGRRECSRV_MODE", FmlField.TYPE_BYTE, -1, null, 60, 1);
        this.fmlBuffer[61] = new FmlField("PAGRRECSRV_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 61, 1);
        this.fmlBuffer[62] = new FmlField("PAGRRECSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 62, 1);
        this.fmlBuffer[63] = new FmlField("PAGRRECSRV_TRX_ID", FmlField.TYPE_INTEGER, -1, null, 63, 1);
        this.fmlBuffer[64] = new FmlField("PAGRRECCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 64, 1);
        this.fmlBuffer[65] = new FmlField("PAGRRECCAMPAIGN", FmlField.TYPE_STRING, 10, null, 65, 1);
        this.fmlBuffer[66] = new FmlField("PAGRRECCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 66, 1);
        this.fmlBuffer[67] = new FmlField("PAGRRECPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 67, 1);
        this.fmlBuffer[68] = new FmlField("PAGRRECLOAN_VER_NO", FmlField.TYPE_INTEGER, -1, null, 68, 1);
        this.fmlBuffer[69] = new FmlField("PAGRRECLOAN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 69, 1);
        this.fmlBuffer[70] = new FmlField("PAGRRECSOC_ACTV_FEE", FmlField.TYPE_DOUBLE, -1, null, 70, 1);
        this.fmlBuffer[71] = new FmlField("PAGRRECPROMOTIONAL_SOC", FmlField.TYPE_STRING, 10, null, 71, 1);
        this.fmlBuffer[72] = new FmlField("PAGRRECREASON_CODE", FmlField.TYPE_STRING, 5, null, 72, 1);
        this.fmlBuffer[73] = new FmlField("PAGRRECSOC_START_RC_DATE", FmlField.TYPE_STRING, 9, null, 73, 1);
        this.fmlBuffer[74] = new FmlField("PAGRRECRC_DATE_COPY_IND", FmlField.TYPE_BYTE, -1, null, 74, 1);
        this.fmlBuffer[75] = new FmlField("PAGRRECLOAN_SUB_ID", FmlField.TYPE_INTEGER, -1, null, 75, 1);
        this.fmlBuffer[76] = new FmlField("PAGRRECSOC_QUANTITY", FmlField.TYPE_INTEGER, -1, null, 76, 1);
        this.fmlBuffer[77] = new FmlField("PAGRRECBILL_TEXT", FmlField.TYPE_STRING, 41, null, 77, 1);
        this.fmlBuffer[78] = new FmlField("PAGRRECFULL_AMT", FmlField.TYPE_DOUBLE, -1, null, 78, 1);
        this.fmlBuffer[79] = new FmlField("PAGRRECFIRST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 79, 1);
        this.fmlBuffer[80] = new FmlField("PAGRRECOTHER_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 80, 1);
        this.fmlBuffer[81] = new FmlField("PAGRRECLAST_INSTALL_RATE", FmlField.TYPE_DOUBLE, -1, null, 81, 1);
        this.fmlBuffer[82] = new FmlField("PAGRRECNO_OF_INSTALLMENTS", FmlField.TYPE_SHORT, -1, null, 82, 1);
        this.fmlBuffer[83] = new FmlField("PSOCFTRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 83, 1);
        this.fmlBuffer[84] = new FmlField("PSOCFTRBUFROWID", FmlField.TYPE_STRING, 19, null, 84, 500);
        this.fmlBuffer[85] = new FmlField("PSOCFTRBUFSOC", FmlField.TYPE_STRING, 10, null, 85, 500);
        this.fmlBuffer[86] = new FmlField("PSOCFTRBUFSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 86, 500);
        this.fmlBuffer[87] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 87, 500);
        this.fmlBuffer[88] = new FmlField("MPS_FTR_CODE", FmlField.TYPE_STRING, 7, null, 88, 500);
        this.fmlBuffer[89] = new FmlField("FTR_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 89, 500);
        this.fmlBuffer[90] = new FmlField("FTR_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 90, 500);
        this.fmlBuffer[91] = new FmlField("FTR_EFF_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 91, 500);
        this.fmlBuffer[92] = new FmlField("FTR_EXP_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 92, 500);
        this.fmlBuffer[93] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 93, 500);
        this.fmlBuffer[94] = new FmlField("FTR_MODE", FmlField.TYPE_BYTE, -1, null, 94, 500);
        this.fmlBuffer[95] = new FmlField("PSOCFTRBUFSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 95, 500);
        this.fmlBuffer[96] = new FmlField("FTR_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 96, 500);
        this.fmlBuffer[97] = new FmlField("FTR_ADD_PARAM", FmlField.TYPE_STRING, 301, null, 97, 500);
        this.fmlBuffer[98] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, null, 98, 500);
        this.fmlBuffer[99] = new FmlField("PSOCFTRBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 99, 500);
        this.fmlBuffer[100] = new FmlField("PSOCFTRBUFCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 100, 500);
        this.fmlBuffer[101] = new FmlField("FTR_SPECIAL_TELNO", FmlField.TYPE_STRING, 21, null, 101, 500);
        this.fmlBuffer[102] = new FmlField("SWITCH_ACT_NEEDED", FmlField.TYPE_BYTE, -1, null, 102, 500);
        this.fmlBuffer[103] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, null, 103, 500);
        this.fmlBuffer[104] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, null, 104, 500);
        this.fmlBuffer[105] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 105, 500);
        this.fmlBuffer[106] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, null, 106, 500);
        this.fmlBuffer[107] = new FmlField("MANUAL_RC_RATE", FmlField.TYPE_DOUBLE, -1, null, 107, 500);
        this.fmlBuffer[108] = new FmlField("MANUAL_RC_EXP_DATE", FmlField.TYPE_STRING, 9, null, 108, 500);
        this.fmlBuffer[109] = new FmlField("MANUAL_RC_EFF_DATE", FmlField.TYPE_STRING, 9, null, 109, 500);
        this.fmlBuffer[110] = new FmlField("PCSFRNDFMLROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 110, 1);
        this.fmlBuffer[111] = new FmlField("ACTIONIND", FmlField.TYPE_BYTE, -1, null, 111, 10000);
        this.fmlBuffer[112] = new FmlField("PCSFANDFRECROWID", FmlField.TYPE_STRING, 19, null, 112, 10000);
        this.fmlBuffer[113] = new FmlField("PCSFANDFRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 113, 10000);
        this.fmlBuffer[114] = new FmlField("PCSFANDFRECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 114, 10000);
        this.fmlBuffer[115] = new FmlField("PERSONAL_TEL", FmlField.TYPE_STRING, 21, null, 115, 10000);
        this.fmlBuffer[116] = new FmlField("PERSONAL_TEL_TO", FmlField.TYPE_STRING, 21, null, 116, 10000);
        this.fmlBuffer[117] = new FmlField("FF_SOC", FmlField.TYPE_STRING, 10, null, 117, 10000);
        this.fmlBuffer[118] = new FmlField("PLAN_CODE", FmlField.TYPE_STRING, 10, null, 118, 10000);
        this.fmlBuffer[119] = new FmlField("DISCOUNT_TYPE", FmlField.TYPE_BYTE, -1, null, 119, 10000);
        this.fmlBuffer[120] = new FmlField("START_HOUR", FmlField.TYPE_STRING, 7, null, 120, 10000);
        this.fmlBuffer[121] = new FmlField("DURATION", FmlField.TYPE_DOUBLE, -1, null, 121, 10000);
        this.fmlBuffer[122] = new FmlField("PESNBUFFERROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 122, 1);
        this.fmlBuffer[123] = new FmlField("EQUIPMENT_NO", FmlField.TYPE_STRING, 21, null, 123, 50);
        this.fmlBuffer[124] = new FmlField("PHD_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 124, 50);
        this.fmlBuffer[125] = new FmlField("EQUIPMENT_LEVEL", FmlField.TYPE_SHORT, -1, null, 125, 50);
        this.fmlBuffer[126] = new FmlField("IMSI", FmlField.TYPE_STRING, 16, null, 126, 50);
        this.fmlBuffer[127] = new FmlField("PHYDEVARRAYEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 127, 50);
        this.fmlBuffer[128] = new FmlField("PHYDEVARRAYEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 128, 50);
        this.fmlBuffer[129] = new FmlField("OWNERSHIP_CODE", FmlField.TYPE_STRING, 3, null, 129, 50);
        this.fmlBuffer[130] = new FmlField("SW_STATE_IND", FmlField.TYPE_BYTE, -1, null, 130, 50);
        this.fmlBuffer[131] = new FmlField("LAST_SW_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 131, 50);
        this.fmlBuffer[132] = new FmlField("NEXT_ACTV_CODE", FmlField.TYPE_BYTE, -1, null, 132, 50);
        this.fmlBuffer[133] = new FmlField("NEXT_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 133, 50);
        this.fmlBuffer[134] = new FmlField("NEXT_ACTV_ISSUE_DT", FmlField.TYPE_STRING, 9, null, 134, 50);
        this.fmlBuffer[135] = new FmlField("DEVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 135, 50);
        this.fmlBuffer[136] = new FmlField("ESN_MODE", FmlField.TYPE_BYTE, -1, null, 136, 50);
        this.fmlBuffer[137] = new FmlField("ITEM_ID", FmlField.TYPE_STRING, 16, null, 137, 50);
        this.fmlBuffer[138] = new FmlField("POOL", FmlField.TYPE_STRING, 3, null, 138, 50);
        this.fmlBuffer[139] = new FmlField("LOCATION_ID", FmlField.TYPE_STRING, 5, null, 139, 50);
        this.fmlBuffer[140] = new FmlField("ACTIVITY_CODE", FmlField.TYPE_STRING, 5, null, 140, 50);
        this.fmlBuffer[141] = new FmlField("ACTIVITY_DATE", FmlField.TYPE_STRING, 15, null, 141, 50);
        this.fmlBuffer[142] = new FmlField("OPERATION_STATUS", FmlField.TYPE_BYTE, -1, null, 142, 50);
        this.fmlBuffer[143] = new FmlField("ITEM_OWNERSHIP", FmlField.TYPE_BYTE, -1, null, 143, 50);
        this.fmlBuffer[144] = new FmlField("ITEM_OWNERSHIP_DT", FmlField.TYPE_STRING, 15, null, 144, 50);
        this.fmlBuffer[145] = new FmlField("CURR_POSSESSION", FmlField.TYPE_BYTE, -1, null, 145, 50);
        this.fmlBuffer[146] = new FmlField("CURR_POSSESSION_DT", FmlField.TYPE_STRING, 15, null, 146, 50);
        this.fmlBuffer[147] = new FmlField("MISSING_IND", FmlField.TYPE_BYTE, -1, null, 147, 50);
        this.fmlBuffer[148] = new FmlField("IN_REPAIR_IND", FmlField.TYPE_BYTE, -1, null, 148, 50);
        this.fmlBuffer[149] = new FmlField("IN_TRANSIT_IND", FmlField.TYPE_BYTE, -1, null, 149, 50);
        this.fmlBuffer[150] = new FmlField("COMITED_TO_POS_IND", FmlField.TYPE_BYTE, -1, null, 150, 50);
        this.fmlBuffer[151] = new FmlField("COMITED_DATE", FmlField.TYPE_STRING, 15, null, 151, 50);
        this.fmlBuffer[152] = new FmlField("ACTIVITY_REASON", FmlField.TYPE_STRING, 4, null, 152, 50);
        this.fmlBuffer[153] = new FmlField("UPGRADE_IND", FmlField.TYPE_BYTE, -1, null, 153, 50);
        this.fmlBuffer[154] = new FmlField("EXPECTED_RTRN_DATE", FmlField.TYPE_STRING, 15, null, 154, 50);
        this.fmlBuffer[155] = new FmlField("POLICE_REPORT_NO", FmlField.TYPE_STRING, 16, null, 155, 50);
        this.fmlBuffer[156] = new FmlField("POLICE_REPORT_DATE", FmlField.TYPE_STRING, 15, null, 156, 50);
        this.fmlBuffer[157] = new FmlField("POLICE_STATION", FmlField.TYPE_STRING, 31, null, 157, 50);
        this.fmlBuffer[158] = new FmlField("PUK", FmlField.TYPE_INTEGER, -1, null, 158, 50);
        this.fmlBuffer[159] = new FmlField("PUK2", FmlField.TYPE_INTEGER, -1, null, 159, 50);
        this.fmlBuffer[160] = new FmlField("FIRST_USED_DATE", FmlField.TYPE_STRING, 15, null, 160, 50);
        this.fmlBuffer[161] = new FmlField("SIM_STATUS", FmlField.TYPE_BYTE, -1, null, 161, 50);
        this.fmlBuffer[162] = new FmlField("SUSPEND_IND", FmlField.TYPE_BYTE, -1, null, 162, 50);
        this.fmlBuffer[163] = new FmlField("SUSPEND_DATE", FmlField.TYPE_STRING, 15, null, 163, 50);
        this.fmlBuffer[164] = new FmlField("SENT_TO_AUC_IND", FmlField.TYPE_BYTE, -1, null, 164, 50);
        this.fmlBuffer[165] = new FmlField("HLR_CD", FmlField.TYPE_STRING, 4, null, 165, 50);
        this.fmlBuffer[166] = new FmlField("K4ID", FmlField.TYPE_STRING, 41, null, 166, 50);
        this.fmlBuffer[167] = new FmlField("PHYDEVARRAYDEALER_CODE", FmlField.TYPE_STRING, 6, null, 167, 50);
        this.fmlBuffer[168] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 168, 1);
        this.fmlBuffer[169] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 169, 50);
        this.fmlBuffer[170] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 170, 50);
        this.fmlBuffer[171] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 171, 50);
        this.fmlBuffer[172] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 172, 50);
        this.fmlBuffer[173] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 173, 50);
        this.fmlBuffer[174] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 174, 50);
        this.fmlBuffer[175] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 175, 50);
        this.fmlBuffer[176] = new FmlField("P1", FmlField.TYPE_STRING, 51, null, 176, 50);
        this.fmlBuffer[177] = new FmlField("P2", FmlField.TYPE_STRING, 51, null, 177, 50);
        this.fmlBuffer[178] = new FmlField("P3", FmlField.TYPE_STRING, 51, null, 178, 50);
        this.fmlBuffer[179] = new FmlField("P4", FmlField.TYPE_STRING, 51, null, 179, 50);
        this.fmlBuffer[180] = new FmlField("P5", FmlField.TYPE_STRING, 51, null, 180, 50);
        this.fmlBuffer[181] = new FmlField("P6", FmlField.TYPE_STRING, 51, null, 181, 50);
        this.fmlBuffer[182] = new FmlField("P7", FmlField.TYPE_STRING, 51, null, 182, 50);
        this.fmlBuffer[183] = new FmlField("P8", FmlField.TYPE_STRING, 51, null, 183, 50);
        this.fmlBuffer[184] = new FmlField("P9", FmlField.TYPE_STRING, 51, null, 184, 50);
        this.fmlBuffer[185] = new FmlField("P10", FmlField.TYPE_STRING, 51, null, 185, 50);
        this.fmlBuffer[186] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 186, 50);
        this.fmlBuffer[187] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 187, 50);
        this.fmlBuffer[188] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 188, 50);
        this.fmlBuffer[189] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 189, 50);
        this.fmlBuffer[190] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 190, 50);
        this.fmlBuffer[191] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 191, 50);
        this.fmlBuffer[192] = new FmlField("PMKTPROGBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 192, 1);
        this.fmlBuffer[193] = new FmlField("MP_MODE", FmlField.TYPE_BYTE, -1, null, 193, 5);
        this.fmlBuffer[194] = new FmlField("SUB_MKTPR_ENT_NO", FmlField.TYPE_INTEGER, -1, null, 194, 5);
        this.fmlBuffer[195] = new FmlField("SUB_MKTPR_CODE", FmlField.TYPE_STRING, 7, null, 195, 5);
        this.fmlBuffer[196] = new FmlField("SUB_MKTPR_EFF_DATE", FmlField.TYPE_STRING, 9, null, 196, 5);
        this.fmlBuffer[197] = new FmlField("PTARCTNROWID", FmlField.TYPE_STRING, 19, null, 197, 1);
        this.fmlBuffer[198] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 198, 1);
        this.fmlBuffer[199] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 199, 1);
        this.fmlBuffer[200] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 200, 1);
        this.fmlBuffer[201] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 201, 1);
        this.fmlBuffer[202] = new FmlField("PTARCTNOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 202, 1);
        this.fmlBuffer[203] = new FmlField("PTARCTNAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 203, 1);
        this.fmlBuffer[204] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 204, 1);
        this.fmlBuffer[205] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 205, 1);
        this.fmlBuffer[206] = new FmlField("PTARCTNEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 206, 1);
        this.fmlBuffer[207] = new FmlField("INIT_ACTIVATION_DATE", FmlField.TYPE_STRING, 9, null, 207, 1);
        this.fmlBuffer[208] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 208, 1);
        this.fmlBuffer[209] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 209, 1);
        this.fmlBuffer[210] = new FmlField("ORIGINAL_INIT_DATE", FmlField.TYPE_STRING, 15, null, 210, 1);
        this.fmlBuffer[211] = new FmlField("SUB_STATUS_LAST_ACT", FmlField.TYPE_STRING, 4, null, 211, 1);
        this.fmlBuffer[212] = new FmlField("SUB_STATUS_RSN_CODE", FmlField.TYPE_STRING, 5, null, 212, 1);
        this.fmlBuffer[213] = new FmlField("PTARCTNPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 213, 1);
        this.fmlBuffer[214] = new FmlField("CUSTOMER_BAN", FmlField.TYPE_INTEGER, -1, null, 214, 1);
        this.fmlBuffer[215] = new FmlField("CTN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 215, 1);
        this.fmlBuffer[216] = new FmlField("REQ_ST_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 216, 1);
        this.fmlBuffer[217] = new FmlField("REQ_END_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 217, 1);
        this.fmlBuffer[218] = new FmlField("COMMIT_START_DATE", FmlField.TYPE_STRING, 9, null, 218, 1);
        this.fmlBuffer[219] = new FmlField("COMMIT_END_DATE", FmlField.TYPE_STRING, 9, null, 219, 1);
        this.fmlBuffer[220] = new FmlField("COMMIT_REASON_CODE", FmlField.TYPE_STRING, 4, null, 220, 1);
        this.fmlBuffer[221] = new FmlField("PTARCTNCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 221, 1);
        this.fmlBuffer[222] = new FmlField("PTARCTNSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 222, 1);
        this.fmlBuffer[223] = new FmlField("CONTRACT_NO", FmlField.TYPE_STRING, 11, null, 223, 1);
        this.fmlBuffer[224] = new FmlField("CNT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 224, 1);
        this.fmlBuffer[225] = new FmlField("PTARCTNDEALER_CODE", FmlField.TYPE_STRING, 6, null, 225, 1);
        this.fmlBuffer[226] = new FmlField("ORG_DEALER_CODE", FmlField.TYPE_STRING, 6, null, 226, 1);
        this.fmlBuffer[227] = new FmlField("PTARCTNSALES_AGENT", FmlField.TYPE_STRING, 6, null, 227, 1);
        this.fmlBuffer[228] = new FmlField("ORG_SALES_AGENT", FmlField.TYPE_STRING, 6, null, 228, 1);
        this.fmlBuffer[229] = new FmlField("REQ_DEPOSIT_AMT", FmlField.TYPE_DOUBLE, -1, null, 229, 1);
        this.fmlBuffer[230] = new FmlField("LEADING_NUMBER", FmlField.TYPE_STRING, 21, null, 230, 1);
        this.fmlBuffer[231] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, null, 231, 1);
        this.fmlBuffer[232] = new FmlField("NEXT_CTN", FmlField.TYPE_STRING, 21, null, 232, 1);
        this.fmlBuffer[233] = new FmlField("NEXT_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 233, 1);
        this.fmlBuffer[234] = new FmlField("PRV_CTN", FmlField.TYPE_STRING, 21, null, 234, 1);
        this.fmlBuffer[235] = new FmlField("PRV_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 235, 1);
        this.fmlBuffer[236] = new FmlField("NEXT_BAN", FmlField.TYPE_INTEGER, -1, null, 236, 1);
        this.fmlBuffer[237] = new FmlField("NEXT_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 237, 1);
        this.fmlBuffer[238] = new FmlField("PRV_BAN", FmlField.TYPE_INTEGER, -1, null, 238, 1);
        this.fmlBuffer[239] = new FmlField("PRV_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 239, 1);
        this.fmlBuffer[240] = new FmlField("SUB_STS_ISSUE_DATE", FmlField.TYPE_STRING, 9, null, 240, 1);
        this.fmlBuffer[241] = new FmlField("ACTIVATE_WAIVE_RSN", FmlField.TYPE_STRING, 7, null, 241, 1);
        this.fmlBuffer[242] = new FmlField("EARLIEST_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 242, 1);
        this.fmlBuffer[243] = new FmlField("SUB_ACTV_LOCATION", FmlField.TYPE_STRING, 5, null, 243, 1);
        this.fmlBuffer[244] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 244, 1);
        this.fmlBuffer[245] = new FmlField("CUST_WATCH_DATE", FmlField.TYPE_STRING, 9, null, 245, 1);
        this.fmlBuffer[246] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 246, 1);
        this.fmlBuffer[247] = new FmlField("CREDIT_WATCH_PIN_CD", FmlField.TYPE_SHORT, -1, null, 247, 1);
        this.fmlBuffer[248] = new FmlField("SUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 248, 1);
        this.fmlBuffer[249] = new FmlField("LIMIT_RESERVED_DAYS", FmlField.TYPE_SHORT, -1, null, 249, 1);
        this.fmlBuffer[250] = new FmlField("FF_EXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 250, 1);
        this.fmlBuffer[251] = new FmlField("FLEX_IND", FmlField.TYPE_BYTE, -1, null, 251, 1);
        this.fmlBuffer[252] = new FmlField("DUO_IND", FmlField.TYPE_BYTE, -1, null, 252, 1);
        this.fmlBuffer[253] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, null, 253, 1);
        this.fmlBuffer[254] = new FmlField("SUB_DEPARTMENT_CD", FmlField.TYPE_STRING, 5, null, 254, 1);
        this.fmlBuffer[255] = new FmlField("LAST_SUBS_DISC_DT", FmlField.TYPE_STRING, 9, null, 255, 1);
        this.fmlBuffer[256] = new FmlField("LAST_SUBS_DISC_DT_UD", FmlField.TYPE_STRING, 9, null, 256, 1);
        this.fmlBuffer[257] = new FmlField("LAST_SUBSCR_DISC_SN", FmlField.TYPE_SHORT, -1, null, 257, 1);
        this.fmlBuffer[258] = new FmlField("LAST_SUBSCR_DISC_SN_UD", FmlField.TYPE_SHORT, -1, null, 258, 1);
        this.fmlBuffer[259] = new FmlField("PNI", FmlField.TYPE_STRING, 11, null, 259, 1);
        this.fmlBuffer[260] = new FmlField("RMS_REF_STORE_ID", FmlField.TYPE_STRING, 5, null, 260, 1);
        this.fmlBuffer[261] = new FmlField("RMS_REF_TYPE", FmlField.TYPE_BYTE, -1, null, 261, 1);
        this.fmlBuffer[262] = new FmlField("RMS_REF_OD", FmlField.TYPE_INTEGER, -1, null, 262, 1);
        this.fmlBuffer[263] = new FmlField("DLR_ACT_FEE", FmlField.TYPE_DOUBLE, -1, null, 263, 1);
        this.fmlBuffer[264] = new FmlField("PREP_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 264, 1);
        this.fmlBuffer[265] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 265, 1);
        this.fmlBuffer[266] = new FmlField("SUB_LANG", FmlField.TYPE_STRING, 3, null, 266, 1);
        this.fmlBuffer[267] = new FmlField("SMS_RCV_STYLE_CODE", FmlField.TYPE_STRING, 3, null, 267, 1);
        this.fmlBuffer[268] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 268, 1);
        this.fmlBuffer[269] = new FmlField("ALLOW_ADVERTISING_IND", FmlField.TYPE_BYTE, -1, null, 269, 1);
        this.fmlBuffer[270] = new FmlField("IVR_WRONG_ACCESS_NO", FmlField.TYPE_SHORT, -1, null, 270, 1);
        this.fmlBuffer[271] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, NinjaConfigurationReferenceTable.getThresholdAmt(), 271, 1);
        this.fmlBuffer[272] = new FmlField("PUBLISH_LEVEL", FmlField.TYPE_STRING, 31, null, 272, 1);
        this.fmlBuffer[273] = new FmlField("AUTO_RELEASE_IND", FmlField.TYPE_BYTE, -1, null, 273, 1);
        this.fmlBuffer[274] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, null, 274, 1);
        this.fmlBuffer[275] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, null, 275, 1);
        this.fmlBuffer[276] = new FmlField("OPERATOR_CW_LMT", FmlField.TYPE_DOUBLE, -1, null, 276, 1);
        this.fmlBuffer[277] = new FmlField("SEND_SMS_FOR_MATCH", FmlField.TYPE_BYTE, -1, null, 277, 1);
        this.fmlBuffer[278] = new FmlField("CPS_STATUS", FmlField.TYPE_BYTE, -1, null, 278, 1);
        this.fmlBuffer[279] = new FmlField("CPS_TRANSACTION", FmlField.TYPE_SHORT, -1, null, 279, 1);
        this.fmlBuffer[280] = new FmlField("CPS_TYPE", FmlField.TYPE_SHORT, -1, null, 280, 1);
        this.fmlBuffer[281] = new FmlField("ISP_PASS", FmlField.TYPE_STRING, 31, null, 281, 1);
        this.fmlBuffer[282] = new FmlField("ISP_TYPE", FmlField.TYPE_STRING, 3, null, 282, 1);
        this.fmlBuffer[283] = new FmlField("OPERATOR_TMP_DATE", FmlField.TYPE_STRING, 9, null, 283, 1);
        this.fmlBuffer[284] = new FmlField("OPERATOR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, null, 284, 1);
        this.fmlBuffer[285] = new FmlField("SUB_ORG_CD", FmlField.TYPE_STRING, 11, null, 285, 1);
        this.fmlBuffer[286] = new FmlField("ORG_MEMBER_NO", FmlField.TYPE_STRING, 21, null, 286, 1);
        this.fmlBuffer[287] = new FmlField("FIXED_AS_GSM_IND", FmlField.TYPE_BYTE, -1, null, 287, 1);
        this.fmlBuffer[288] = new FmlField("EARLY_PORT_OUT", FmlField.TYPE_BYTE, -1, null, 288, 1);
        this.fmlBuffer[289] = new FmlField("EARLY_PO_WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 289, 1);
        this.fmlBuffer[290] = new FmlField("EARLY_PO_WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 290, 1);
        this.fmlBuffer[291] = new FmlField("INTERNAL_CIRCUIT_ID", FmlField.TYPE_STRING, 21, null, 291, 1);
        this.fmlBuffer[292] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 292, 1);
        this.fmlBuffer[293] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 293, 20);
        this.fmlBuffer[294] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 294, 20);
        this.fmlBuffer[295] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 295, 20);
        this.fmlBuffer[296] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 296, 20);
        this.fmlBuffer[297] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 297, 20);
        this.fmlBuffer[298] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 298, 20);
        this.fmlBuffer[299] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 299, 20);
        this.fmlBuffer[300] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 300, 20);
        this.fmlBuffer[301] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 301, 20);
        this.fmlBuffer[302] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 302, 20);
        this.fmlBuffer[303] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 303, 20);
        this.fmlBuffer[304] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 304, 20);
        this.fmlBuffer[305] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 305, 20);
        this.fmlBuffer[306] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 306, 20);
        this.fmlBuffer[307] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 307, 20);
        this.fmlBuffer[308] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 308, 20);
        this.fmlBuffer[309] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 309, 20);
        this.fmlBuffer[310] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 310, 20);
        this.fmlBuffer[311] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 311, 20);
        this.fmlBuffer[312] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 312, 20);
        this.fmlBuffer[313] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 313, 20);
        this.fmlBuffer[314] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 314, 20);
        this.fmlBuffer[315] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 315, 20);
        this.fmlBuffer[316] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 316, 20);
        this.fmlBuffer[317] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 317, 20);
        this.fmlBuffer[318] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 318, 20);
        this.fmlBuffer[319] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 319, 20);
        this.fmlBuffer[320] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 320, 20);
        this.fmlBuffer[321] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 321, 20);
        this.fmlBuffer[322] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 322, 20);
        this.fmlBuffer[323] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 323, 20);
        this.fmlBuffer[324] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 324, 20);
        this.fmlBuffer[325] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 325, 20);
        this.fmlBuffer[326] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 326, 20);
        this.fmlBuffer[327] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 327, 20);
        this.fmlBuffer[328] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 328, 20);
        this.fmlBuffer[329] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 51, null, 329, 20);
        this.fmlBuffer[330] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 330, 20);
        this.fmlBuffer[331] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 331, 20);
        this.fmlBuffer[332] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 332, 20);
        this.fmlBuffer[333] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 333, 20);
        this.fmlBuffer[334] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 334, 20);
        this.fmlBuffer[335] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 335, 20);
        this.fmlBuffer[336] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 336, 20);
        this.fmlBuffer[337] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 337, 20);
        this.fmlBuffer[338] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 338, 20);
        this.fmlBuffer[339] = new FmlField("TPID", FmlField.TYPE_STRING, 37, null, 339, 20);
        this.fmlBuffer[340] = new FmlField("E_FAKTURA_REF", FmlField.TYPE_INTEGER, -1, null, 340, 20);
        this.fmlBuffer[341] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 341, 20);
        this.fmlBuffer[342] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 342, 20);
        this.fmlBuffer[343] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 343, 20);
        this.fmlBuffer[344] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 344, 20);
        this.fmlBuffer[345] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 345, 20);
        this.fmlBuffer[346] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 346, 20);
        this.fmlBuffer[347] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 347, 20);
        this.fmlBuffer[348] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 348, 20);
        this.fmlBuffer[349] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 349, 20);
        this.fmlBuffer[350] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 350, 20);
        this.fmlBuffer[351] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 351, 20);
        this.fmlBuffer[352] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 352, 20);
        this.fmlBuffer[353] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 353, 20);
        this.fmlBuffer[354] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 354, 20);
        this.fmlBuffer[355] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 355, 20);
        this.fmlBuffer[356] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 356, 20);
        this.fmlBuffer[357] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 357, 20);
        this.fmlBuffer[358] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 358, 20);
        this.fmlBuffer[359] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 359, 20);
        this.fmlBuffer[360] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 360, 20);
        this.fmlBuffer[361] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 361, 20);
        this.fmlBuffer[362] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 362, 20);
        this.fmlBuffer[363] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 363, 20);
        this.fmlBuffer[364] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 364, 20);
        this.fmlBuffer[365] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 365, 20);
        this.fmlBuffer[366] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 366, 20);
        this.fmlBuffer[367] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 367, 20);
        this.fmlBuffer[368] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 368, 20);
        this.fmlBuffer[369] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 369, 20);
        this.fmlBuffer[370] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 370, 20);
        this.fmlBuffer[371] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 371, 20);
        this.fmlBuffer[372] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 372, 20);
        this.fmlBuffer[373] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 373, 20);
        this.fmlBuffer[374] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 374, 20);
        this.fmlBuffer[375] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 375, 20);
        this.fmlBuffer[376] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 376, 20);
        this.fmlBuffer[377] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 377, 20);
        this.fmlBuffer[378] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 378, 20);
        this.fmlBuffer[379] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 379, 20);
        this.fmlBuffer[380] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 380, 20);
        this.fmlBuffer[381] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 381, 20);
        this.fmlBuffer[382] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 382, 20);
        this.fmlBuffer[383] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 383, 20);
        this.fmlBuffer[384] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 384, 20);
        this.fmlBuffer[385] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 385, 20);
        this.fmlBuffer[386] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 386, 20);
        this.fmlBuffer[387] = new FmlField("SOURCE_BAN_LAST_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 387, 1);
        this.fmlBuffer[388] = new FmlField("SOURCE_BAN_LAST_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 388, 1);
        this.fmlBuffer[389] = new FmlField("PCNCLSRCEBANRECBAN", FmlField.TYPE_INTEGER, -1, null, 389, 1);
        this.fmlBuffer[390] = new FmlField("PCNCLSRCEBANRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 390, 1);
        this.fmlBuffer[391] = new FmlField("PCNCLSRCEBANRECACTIVITY_DATE", FmlField.TYPE_STRING, 9, null, 391, 1);
        this.fmlBuffer[392] = new FmlField("RESTORE_DATE", FmlField.TYPE_STRING, 9, null, 392, 1);
        this.fmlBuffer[393] = new FmlField("DEP_RETURN_METHOD", FmlField.TYPE_BYTE, -1, null, 393, 1);
        this.fmlBuffer[394] = new FmlField("NEW_BAN_STATUS", FmlField.TYPE_BYTE, -1, null, 394, 1);
        this.fmlBuffer[395] = new FmlField("EXP_CYCLE_CODE", FmlField.TYPE_SHORT, -1, null, 395, 1);
        this.fmlBuffer[396] = new FmlField("BAN_WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 396, 1);
        this.fmlBuffer[397] = new FmlField("BAN_WAIVE_RSN", FmlField.TYPE_STRING, 7, null, 397, 1);
        this.fmlBuffer[398] = new FmlField("WAIVER_UID", FmlField.TYPE_STRING, 9, null, 398, 1);
        this.fmlBuffer[399] = new FmlField("HOLD_COLL_TREATMENT", FmlField.TYPE_BYTE, -1, null, 399, 1);
        this.fmlBuffer[400] = new FmlField("PCTNCNCLBUFROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 400, 1);
        this.fmlBuffer[401] = new FmlField("CTN", FmlField.TYPE_STRING, 21, null, 401, 100);
        this.fmlBuffer[402] = new FmlField("PCTNCNCLBUFSUB_STATUS", FmlField.TYPE_BYTE, -1, null, 402, 100);
        this.fmlBuffer[403] = new FmlField("COMM_START_DATE", FmlField.TYPE_STRING, 9, null, 403, 100);
        this.fmlBuffer[404] = new FmlField("COMM_END_DATE", FmlField.TYPE_STRING, 9, null, 404, 100);
        this.fmlBuffer[405] = new FmlField("REMAINING_MONTHS", FmlField.TYPE_SHORT, -1, null, 405, 100);
        this.fmlBuffer[406] = new FmlField("DEPOSIT", FmlField.TYPE_DOUBLE, -1, null, 406, 100);
        this.fmlBuffer[407] = new FmlField("DEPOSIT_INTEREST", FmlField.TYPE_DOUBLE, -1, null, 407, 100);
        this.fmlBuffer[408] = new FmlField("PENALTY", FmlField.TYPE_DOUBLE, -1, null, 408, 100);
        this.fmlBuffer[409] = new FmlField("WAIVE_INDICATOR", FmlField.TYPE_BYTE, -1, null, 409, 100);
        this.fmlBuffer[410] = new FmlField("PCTNCNCLBUFWAIVE_REASON", FmlField.TYPE_STRING, 7, null, 410, 100);
        this.fmlBuffer[411] = new FmlField("PENALTY_BASE_AMT", FmlField.TYPE_DOUBLE, -1, null, 411, 100);
        this.fmlBuffer[412] = new FmlField("MAIN_SIP_IND", FmlField.TYPE_BYTE, -1, null, 412, 100);
        this.fmlBuffer[413] = new FmlField("ACTIVITY_CTN_FEE", FmlField.TYPE_DOUBLE, -1, null, 413, 1);
        this.fmlBuffer[414] = new FmlField("NUMBER_LOCATION", FmlField.TYPE_STRING, 4, null, 414, 1);
        this.fmlBuffer[415] = new FmlField("DEPOSITTERMSIND", FmlField.TYPE_BYTE, -1, null, 415, 1);
        this.fmlBuffer[416] = new FmlField("WAIVING_IND", FmlField.TYPE_BYTE, -1, null, 416, 1);
        this.fmlBuffer[417] = new FmlField("WAIVING_REASON_CODE", FmlField.TYPE_STRING, 5, null, 417, 1);
        this.fmlBuffer[418] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 418, 1);
        this.fmlBuffer[419] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 419, 2);
        this.fmlBuffer[420] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 420, 2);
        this.fmlBuffer[421] = new FmlField("PARSVDISCBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 421, 1);
        this.fmlBuffer[422] = new FmlField("PARDISCARRAYACTIONIND", FmlField.TYPE_BYTE, -1, null, 422, 100);
        this.fmlBuffer[423] = new FmlField("DEPLOYIND", FmlField.TYPE_BYTE, -1, null, 423, 100);
        this.fmlBuffer[424] = new FmlField("PARBANDISCROWID", FmlField.TYPE_STRING, 19, null, 424, 100);
        this.fmlBuffer[425] = new FmlField("PARBANDISCBAN", FmlField.TYPE_INTEGER, -1, null, 425, 100);
        this.fmlBuffer[426] = new FmlField("DISCOUNT_CODE", FmlField.TYPE_STRING, 7, null, 426, 100);
        this.fmlBuffer[427] = new FmlField("PARBANDISCSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 427, 100);
        this.fmlBuffer[428] = new FmlField("DISC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 428, 100);
        this.fmlBuffer[429] = new FmlField("PARBANDISCSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 429, 100);
        this.fmlBuffer[430] = new FmlField("PARBANDISCSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 430, 100);
        this.fmlBuffer[431] = new FmlField("PARBANDISCOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 431, 100);
        this.fmlBuffer[432] = new FmlField("PARBANDISCAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 432, 100);
        this.fmlBuffer[433] = new FmlField("PARBANDISCDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 433, 100);
        this.fmlBuffer[434] = new FmlField("PARBANDISCDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 434, 100);
        this.fmlBuffer[435] = new FmlField("PARBANDISCEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 435, 100);
        this.fmlBuffer[436] = new FmlField("DISC_BY_OPID", FmlField.TYPE_INTEGER, -1, null, 436, 100);
        this.fmlBuffer[437] = new FmlField("PARBANDISCEXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 437, 100);
        this.fmlBuffer[438] = new FmlField("PARBANDISCCAMPAIGN", FmlField.TYPE_STRING, 10, null, 438, 100);
        this.fmlBuffer[439] = new FmlField("PARBANDISCCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 439, 100);
        this.fmlBuffer[440] = new FmlField("POTENTIAL_SUBS_NO", FmlField.TYPE_INTEGER, -1, null, 440, 100);
        this.fmlBuffer[441] = new FmlField("LAST_POTENT_DATE", FmlField.TYPE_STRING, 9, null, 441, 100);
        this.fmlBuffer[442] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 442, 1);
        this.fmlBuffer[443] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 443, 1);
        this.fmlBuffer[444] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 444, 1);
        this.fmlBuffer[445] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 445, 1);
        this.fmlBuffer[446] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 446, 1);
        this.fmlBuffer[447] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 447, 1);
        this.fmlBuffer[448] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 448, 1);
        this.fmlBuffer[449] = new FmlField("ACT_COMPLETE_DATE", FmlField.TYPE_STRING, 9, null, 449, 1);
    }
    ...
    public void set_NO_OF_INSTALLMENTS(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[49].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_PAGRRECFULL_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[78].getValue(0));
    }
    ...
    public Double get_PAGRRECLAST_INSTALL_RATE() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[81].getValue(0));
    }
    ...
    public void set_PAGRRECNO_OF_INSTALLMENTS(Integer value) throws FMLManipulationException {
        this.fmlBuffer[82].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_PCSFRNDFMLROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[110].getValue(0));
    }
    ...
    public Double get_DURATION(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[121].getValue(nIndex));
    }
    ...
    public Integer get_PESNBUFFERROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[122].getValue(0));
    }
    ...
    public Integer get_PHD_SEQ_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[124].getValue(nIndex));
    }
    ...
    public void set_EQUIPMENT_LEVEL(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[125].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public void set_COMITED_TO_POS_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[150].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_SENT_TO_AUC_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[164].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PARAM_COUNT(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[175].getValue(nIndex));
    }
    ...
    public Double get_MEMO_AMT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[186].getValue(nIndex));
    }
    ...
    public Double get_CHARGE_AMT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[188].getValue(nIndex));
    }
    ...
    public void set_CHARGE_AMT_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[189].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_MP_MODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[193].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_SUB_MKTPR_ENT_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[194].getValue(nIndex));
    }
    ...
    public Integer get_DL_UPDATE_STAMP() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[205].getValue(0)));
    }
    ...
    public void set_DL_UPDATE_STAMP(Integer value) throws FMLManipulationException {
        this.fmlBuffer[205].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_CTN_SEQ_NO() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[215].getValue(0));
    }
    ...
    public String get_PTARCTNSUSP_RC_RATE_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[222].getValue(0)));
    }
    ...
    public void set_PTARCTNSUSP_RC_RATE_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[222].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PRV_BAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[238].getValue(0));
    }
    ...
    public Double get_CUST_WATCH_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[244].getValue(0));
    }
    ...
    public Integer get_LIMIT_RESERVED_DAYS() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[249].getValue(0)));
    }
    ...
    public void set_LIMIT_RESERVED_DAYS(Integer value) throws FMLManipulationException {
        this.fmlBuffer[249].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_LISTED_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[253].getValue(0)));
    }
    ...
    public void set_LISTED_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[253].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_ALLOW_ADVERTISING_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[269].getValue(0)));
    }
    ...
    public void set_ALLOW_ADVERTISING_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[269].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_IVR_WRONG_ACCESS_NO() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[270].getValue(0)));
    }
    ...
    public void set_IVR_WRONG_ACCESS_NO(Integer value) throws FMLManipulationException {
        this.fmlBuffer[270].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_OPERATOR_CW_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[276].getValue(0));
    }
    ...
    public Integer get_CPS_TRANSACTION() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[279].getValue(0)));
    }
    ...
    public void set_CPS_TRANSACTION(Integer value) throws FMLManipulationException {
        this.fmlBuffer[279].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_CPS_TYPE() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[280].getValue(0)));
    }
    ...
    public void set_CPS_TYPE(Integer value) throws FMLManipulationException {
        this.fmlBuffer[280].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_ISP_PASS() throws FMLManipulationException {
        return ((String) this.fmlBuffer[281].getValue(0));
    }
    ...
    public void set_ISP_PASS(String value) throws FMLManipulationException {
        this.fmlBuffer[281].setValue(0, value);
    }
    ...
    public Double get_OPERATOR_TMP_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[284].getValue(0));
    }
    ...
    public String get_FIXED_AS_GSM_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[287].getValue(0)));
    }
    ...
    public void set_FIXED_AS_GSM_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[287].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_EARLY_PORT_OUT() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[288].getValue(0)));
    }
    ...
    public void set_EARLY_PORT_OUT(String value) throws FMLManipulationException {
        this.fmlBuffer[288].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_EARLY_PO_WAIVE_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[289].getValue(0)));
    }
    ...
    public void set_EARLY_PO_WAIVE_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[289].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PNAMEADRBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[292].getValue(0));
    }
    ...
    public String get_LINK_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[301].getValue(nIndex)));
    }
    ...
    public void set_LINK_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[301].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_LINK_MAILING_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[308].getValue(nIndex)));
    }
    ...
    public void set_LINK_MAILING_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[308].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_NAMERECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[317].getValue(nIndex));
    }
    ...
    public Double get_KOB(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[330].getValue(nIndex));
    }
    ...
    public Integer get_E_FAKTURA_REF(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[340].getValue(nIndex));
    }
    ...
    public String get_ADR_UP_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[342].getValue(nIndex)));
    }
    ...
    public void set_ADR_UP_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[342].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_ADDRESS_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[345].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[371].getValue(nIndex)));
    }
    ...
    public void set_ADDRESSRECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[371].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_SOURCE_BAN_LAST_UPDATE_STAMP() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[388].getValue(0)));
    }
    ...
    public void set_SOURCE_BAN_LAST_UPDATE_STAMP(Integer value) throws FMLManipulationException {
        this.fmlBuffer[388].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_PCNCLSRCEBANRECBAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[389].getValue(0));
    }
    ...
    public Integer get_PCNCLSRCEBANRECCUSTOMER_ID() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[390].getValue(0));
    }
    ...
    public Integer get_EXP_CYCLE_CODE() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[395].getValue(0)));
    }
    ...
    public void set_EXP_CYCLE_CODE(Integer value) throws FMLManipulationException {
        this.fmlBuffer[395].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_HOLD_COLL_TREATMENT() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[399].getValue(0)));
    }
    ...
    public void set_HOLD_COLL_TREATMENT(String value) throws FMLManipulationException {
        this.fmlBuffer[399].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PCTNCNCLBUFROW_COUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[400].getValue(0));
    }
    ...
    public Integer get_REMAINING_MONTHS(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[405].getValue(nIndex)));
    }
    ...
    public void set_REMAINING_MONTHS(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[405].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_DEPOSIT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[406].getValue(nIndex));
    }
    ...
    public Double get_DEPOSIT_INTEREST(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[407].getValue(nIndex));
    }
    ...
    public Double get_PENALTY(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[408].getValue(nIndex));
    }
    ...
    public Double get_PENALTY_BASE_AMT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[411].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PENALTY_BASE_AMT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_PENALTY_BASE_AMT(int nIndex, Double value) throws FMLManipulationException {
    ...
    public String get_MAIN_SIP_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[412].getValue(nIndex)));
    }

    /**
     * Sets the value of the 'MAIN_SIP_IND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_MAIN_SIP_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[412].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_ACTIVITY_CTN_FEE() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[413].getValue(0));
    }
    ...
    public String get_DEPOSITTERMSIND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[415].getValue(0)));
    }
    ...
    public void set_DEPOSITTERMSIND(String value) throws FMLManipulationException {
        this.fmlBuffer[415].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_WAIVING_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[416].getValue(0)));
    }
    ...
    public void set_WAIVING_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[416].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PFTRDEPBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[418].getValue(0));
    }
    ...
    public Double get_DEPOSIT_AMOUNT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[420].getValue(nIndex));
    }
    ...
    public Integer get_PARSVDISCBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[421].getValue(0));
    }
    ...
    public void set_PARSVDISCBUFROWCOUNT(Integer value) throws FMLManipulationException {
        this.fmlBuffer[421].setValue(0, value);
    }
    ...
    public Integer get_PARBANDISCBAN(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[425].getValue(nIndex));
    }
    ...
    public Integer get_DISC_SEQ_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[428].getValue(nIndex));
    }
    ...
    public Integer get_PARBANDISCOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[431].getValue(nIndex));
    }
    ...
    public Integer get_PARBANDISCDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[434].getValue(nIndex)));
    }
    ...
    public void set_PARBANDISCDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[434].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_DISC_BY_OPID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[436].getValue(nIndex));
    }
    ...
    public String get_PARBANDISCCAMPAIGN(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[438].getValue(nIndex));
    }
    ...
    public Integer get_PARBANDISCCOMMIT_ORIG_NO_MONTH(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[439].getValue(nIndex)));
    }
    ...
    public void set_PARBANDISCCOMMIT_ORIG_NO_MONTH(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[439].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_POTENTIAL_SUBS_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[440].getValue(nIndex));
    }
    ...
    public String get_FULLTABLE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[442].getValue(0)));
    }
    ...
    public void set_FULLTABLE(String value) throws FMLManipulationException {
        this.fmlBuffer[442].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_PAPER_WORK_STATUS() throws FMLManipulationException {
        return ((String) this.fmlBuffer[443].getValue(0));
    }
    ...
    public void set_PAPER_WORK_STATUS(String value) throws FMLManipulationException {
        this.fmlBuffer[443].setValue(0, value);
    }
    ...
    public String get_PAPER_WORK_REQUIRED() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[444].getValue(0)));
    }
    ...
    public void set_PAPER_WORK_REQUIRED(String value) throws FMLManipulationException {
        this.fmlBuffer[444].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_PAPER_WORK_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[445].getValue(0));
    }
    ...
    public String get_PAPER_WORK_TRNS_NO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[447].getValue(0));
    }
    ...
    public String get_DELIVERY_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[448].getValue(0)));
    }
    ...
    public void set_DELIVERY_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[448].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_ACT_COMPLETE_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[449].getValue(0));
    }
    ...
    public void set_ACT_COMPLETE_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[449].setValue(0, value);
    }
}