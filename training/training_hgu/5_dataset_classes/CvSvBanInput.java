...
public class CvSvBanInput extends ServiceInput implements Conversable {
    ...
    static {
        fieldsNotToBeDirectlyCopied.add("PCUSTRECOPERATOR_ID");
        fieldsNotToBeDirectlyCopied.add("PCUSTRECAPPLICATION_ID");
    }
    ...
    public CvSvBanInput() throws FMLManipulationException {
        ...
        this.fmlBuffer[138] = new FmlField("PCNTRINPROWID", FmlField.TYPE_STRING, 19, null, 138, 1);
        this.fmlBuffer[139] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 139, 1);
        this.fmlBuffer[140] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 140, 1);
        this.fmlBuffer[141] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 141, 1);
        this.fmlBuffer[142] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 142, 1);
        this.fmlBuffer[143] = new FmlField("PW_DESCRIPTION", FmlField.TYPE_STRING, 21, null, 143, 1);
        this.fmlBuffer[144] = new FmlField("MOREROWS", FmlField.TYPE_SHORT, -1, null, 144, 1);
        this.fmlBuffer[145] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 145, 1);
        this.fmlBuffer[146] = new FmlField("PARTRDREFARRAYROWID", FmlField.TYPE_STRING, 19, null, 146, 10);
        this.fmlBuffer[147] = new FmlField("PARTRDREFARRAYCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 147, 10);
        this.fmlBuffer[148] = new FmlField("TR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 148, 10);
        this.fmlBuffer[149] = new FmlField("COMPANY_NAME", FmlField.TYPE_STRING, 61, null, 149, 10);
        this.fmlBuffer[150] = new FmlField("CONTACT_PERSON", FmlField.TYPE_STRING, 61, null, 150, 10);
        this.fmlBuffer[151] = new FmlField("PHONE_NO", FmlField.TYPE_STRING, 16, null, 151, 10);
        this.fmlBuffer[152] = new FmlField("FAX_NO", FmlField.TYPE_STRING, 16, null, 152, 10);
    }
    ...
    public void set_MOREROWS(Integer value) throws FMLManipulationException {
        this.fmlBuffer[144].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public void populateCsApiBan(CsApiBanInput csApiBanInput) throws FMLManipulationException {
        ...
        if (csApiBanInput.get_PBANCUSTRECOPERATOR_ID() == null) {
            csApiBanInput.set_PBANCUSTRECOPERATOR_ID(this.get_PCUSTRECOPERATOR_ID());
        }
        if (csApiBanInput.get_PBANCUSTRECAPPLICATION_ID() == null) {
            csApiBanInput.set_PBANCUSTRECAPPLICATION_ID(this.get_PCUSTRECAPPLICATION_ID());
        }
        ...
        if (csApiBanInput.get_PCTNAGRPRMRECCUSTOMER_ID() == null) {
            csApiBanInput.set_PCTNAGRPRMRECCUSTOMER_ID(this.get_BAN());
        }
        if (csApiBanInput.get_PBANRECCUSTOMER_ID() == null) {
            csApiBanInput.set_PBANRECCUSTOMER_ID(this.get_BAN());
        }
