...
public class ArInCstBanOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[242];
        ...
        this.fmlBuffer[182] = new FmlField("TPID", FmlField.TYPE_STRING, 37, null, 182, 20);
        this.fmlBuffer[183] = new FmlField("E_FAKTURA_REF", FmlField.TYPE_INTEGER, -1, null, 183, 20);
        this.fmlBuffer[184] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 184, 20);
        this.fmlBuffer[185] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 185, 20);
        this.fmlBuffer[186] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 186, 20);
        this.fmlBuffer[187] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 187, 20);
        this.fmlBuffer[188] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 188, 20);
        this.fmlBuffer[189] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 189, 20);
        this.fmlBuffer[190] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 190, 20);
        this.fmlBuffer[191] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 191, 20);
        this.fmlBuffer[192] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 192, 20);
        this.fmlBuffer[193] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 193, 20);
        this.fmlBuffer[194] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 194, 20);
        this.fmlBuffer[195] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 195, 20);
        this.fmlBuffer[196] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 196, 20);
        this.fmlBuffer[197] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 197, 20);
        this.fmlBuffer[198] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 198, 20);
        this.fmlBuffer[199] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 199, 20);
        this.fmlBuffer[200] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 200, 20);
        this.fmlBuffer[201] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 201, 20);
        this.fmlBuffer[202] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 202, 20);
        this.fmlBuffer[203] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 203, 20);
        this.fmlBuffer[204] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 204, 20);
        this.fmlBuffer[205] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 205, 20);
        this.fmlBuffer[206] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 206, 20);
        this.fmlBuffer[207] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 207, 20);
        this.fmlBuffer[208] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 208, 20);
        this.fmlBuffer[209] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 209, 20);
        this.fmlBuffer[210] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 210, 20);
        this.fmlBuffer[211] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 211, 20);
        this.fmlBuffer[212] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 212, 20);
        this.fmlBuffer[213] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 213, 20);
        this.fmlBuffer[214] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 214, 20);
        this.fmlBuffer[215] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 215, 20);
        this.fmlBuffer[216] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 216, 20);
        this.fmlBuffer[217] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 217, 20);
        this.fmlBuffer[218] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 218, 20);
        this.fmlBuffer[219] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 219, 20);
        this.fmlBuffer[220] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 220, 20);
        this.fmlBuffer[221] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 221, 20);
        this.fmlBuffer[222] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 222, 20);
        this.fmlBuffer[223] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 223, 20);
        this.fmlBuffer[224] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 224, 20);
        this.fmlBuffer[225] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 225, 20);
        this.fmlBuffer[226] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 226, 20);
        this.fmlBuffer[227] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 227, 20);
        this.fmlBuffer[228] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 228, 20);
        this.fmlBuffer[229] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 229, 20);
        this.fmlBuffer[230] = new FmlField("PSVBLPRMBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 230, 1);
        this.fmlBuffer[231] = new FmlField("BPMODE", FmlField.TYPE_BYTE, -1, null, 231, 20);
        this.fmlBuffer[232] = new FmlField("BPSEQNO", FmlField.TYPE_INTEGER, -1, null, 232, 20);
        this.fmlBuffer[233] = new FmlField("BPEFFDATE", FmlField.TYPE_STRING, 9, null, 233, 20);
        this.fmlBuffer[234] = new FmlField("BPEXPDATE", FmlField.TYPE_STRING, 9, null, 234, 20);
        this.fmlBuffer[235] = new FmlField("BPFORMAT", FmlField.TYPE_STRING, 3, null, 235, 20);
        this.fmlBuffer[236] = new FmlField("BPMEDIA", FmlField.TYPE_STRING, 3, null, 236, 20);
        this.fmlBuffer[237] = new FmlField("BPPRINTCATEGORY", FmlField.TYPE_STRING, 3, null, 237, 20);
        this.fmlBuffer[238] = new FmlField("BPNOOFCOPIES", FmlField.TYPE_SHORT, -1, null, 238, 20);
        this.fmlBuffer[239] = new FmlField("BP_LANGUAGE", FmlField.TYPE_STRING, 3, null, 239, 20);
        this.fmlBuffer[240] = new FmlField("BP_CALL_DETAILS_MEDIA", FmlField.TYPE_BYTE, -1, null, 240, 20);
        this.fmlBuffer[241] = new FmlField("BP_REFERENCE_INFO", FmlField.TYPE_STRING, 31, null, 241, 20);
    }
    ...
    public Integer get_NAME_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[157].getValue(nIndex));
    }
    ...
    public Integer get_NAMERECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[163].getValue(nIndex)));
    }
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[194].getValue(nIndex)));
    }
    ...
    public String get_CO_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[213].getValue(nIndex)));
    }
    ...
    public Integer get_PSVBLPRMBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[230].getValue(0));
    }
    ...
    public String get_BPMODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[231].getValue(nIndex)));
    }
    ...
    public Integer get_BPNOOFCOPIES(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[238].getValue(nIndex)));
    }
