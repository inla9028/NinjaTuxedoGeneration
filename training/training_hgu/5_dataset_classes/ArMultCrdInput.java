...
public class ArMultCrdInput extends ServiceInput {
    ...
    public ArMultCrdInput() throws FMLManipulationException {
        ...
        this.fmlBuffer[32] = new FmlField("ORG_CODE", FmlField.TYPE_STRING, 10, null, 32, 100);
        ...
        this.fmlBuffer[66] = new FmlField("VAT_PERCENT_RATE_L", FmlField.TYPE_INTEGER, -1, null, 66, 100);
        ...
        this.fmlBuffer[71] = new FmlField("DISCOUNT_PCT_L", FmlField.TYPE_INTEGER, -1, null, 71, 100);
        ...
        this.fmlBuffer[74] = new FmlField("CRG_QUANTITY", FmlField.TYPE_INTEGER, -1, null, 74, 100);
        ...
        this.fmlBuffer[110] = new FmlField("PERCENTAGE_RATE_L", FmlField.TYPE_INTEGER, -1, null, 110, 100);
        ...
        this.fmlBuffer[118] = new FmlField("TML_UTC_IND", FmlField.TYPE_BYTE, -1, null, 118, 100);
        this.fmlBuffer[119] = new FmlField("TO_PRINT", FmlField.TYPE_BYTE, -1, null, 119, 1);
        this.fmlBuffer[120] = new FmlField("PADJINPINDBILL_COMMENT", FmlField.TYPE_STRING, 501, null, 120, 1);
        this.fmlBuffer[121] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 121, 1);
        this.fmlBuffer[122] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 122, 1);
        this.fmlBuffer[123] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 123, 1);
        this.fmlBuffer[124] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 124, 1);
        this.fmlBuffer[125] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 125, 1);
        this.fmlBuffer[126] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 126, 1);
        this.fmlBuffer[127] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 127, 1);
        this.fmlBuffer[128] = new FmlField("P1", FmlField.TYPE_STRING, 51, null, 128, 1);
        this.fmlBuffer[129] = new FmlField("P2", FmlField.TYPE_STRING, 51, null, 129, 1);
        this.fmlBuffer[130] = new FmlField("P3", FmlField.TYPE_STRING, 51, null, 130, 1);
        this.fmlBuffer[131] = new FmlField("P4", FmlField.TYPE_STRING, 51, null, 131, 1);
        this.fmlBuffer[132] = new FmlField("P5", FmlField.TYPE_STRING, 51, null, 132, 1);
        this.fmlBuffer[133] = new FmlField("P6", FmlField.TYPE_STRING, 51, null, 133, 1);
        this.fmlBuffer[134] = new FmlField("P7", FmlField.TYPE_STRING, 51, null, 134, 1);
        this.fmlBuffer[135] = new FmlField("P8", FmlField.TYPE_STRING, 51, null, 135, 1);
        this.fmlBuffer[136] = new FmlField("P9", FmlField.TYPE_STRING, 51, null, 136, 1);
        this.fmlBuffer[137] = new FmlField("P10", FmlField.TYPE_STRING, 51, null, 137, 1);
        this.fmlBuffer[138] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 138, 1);
        this.fmlBuffer[139] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 139, 1);
        this.fmlBuffer[140] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 140, 1);
        this.fmlBuffer[141] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 141, 1);
        this.fmlBuffer[142] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 142, 1);
        this.fmlBuffer[143] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 143, 1);
    }
     ...
     * @throws FMLManipulationException
     */
    public Integer get_VAT_PERCENT_RATE_L(int nIndex) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_VAT_PERCENT_RATE_L(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[66].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'VAT_PERCENT_RATE_L' field in the FML buffer.
     *
     * @return Number of values defined for 'VAT_PERCENT_RATE_L' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_VAT_PERCENT_RATE_L_size() throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public Integer get_PERCENTAGE_RATE_L(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[110].getValue(nIndex));
    }
     ...
     * @throws FMLManipulationException
     */
    public void set_PERCENTAGE_RATE_L(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[110].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PERCENTAGE_RATE_L' field in the FML buffer.
     *
     * @return Number of values defined for 'PERCENTAGE_RATE_L' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PERCENTAGE_RATE_L_size() throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_TML_UTC_IND(int nIndex, String value) throws FMLManipulationException {
    ...
    public String get_SUSP_RC_RATE_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[123].getValue(0)));
    }
    ...
    public void set_SUSP_RC_RATE_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[123].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_MEMO_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[138].getValue(0));
    }
    ...
    public String get_WAIVE_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[143].getValue(0)));
    }
    ...
    public void set_WAIVE_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[143].setValue(0, TypeConverter.stringToByte(value));
    }
}