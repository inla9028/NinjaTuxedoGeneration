...
public class CsApiBanOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[187] = new FmlField("ERRORDESC", FmlField.TYPE_STRING, 2001, null, 187, 1);
        this.fmlBuffer[188] = new FmlField("PNPINFOBUFFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 188, 1);
        this.fmlBuffer[189] = new FmlField("NPNUMINFORECROWID", FmlField.TYPE_STRING, 19, null, 189, 500);
        this.fmlBuffer[190] = new FmlField("PORT_NUMBER", FmlField.TYPE_STRING, 21, null, 190, 500);
        this.fmlBuffer[191] = new FmlField("NPNUMINFORECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 191, 500);
        this.fmlBuffer[192] = new FmlField("NPNUMINFORECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 192, 500);
        this.fmlBuffer[193] = new FmlField("NPNUMINFORECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 193, 500);
        this.fmlBuffer[194] = new FmlField("NPNUMINFORECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 194, 500);
        this.fmlBuffer[195] = new FmlField("NPNUMINFORECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 195, 500);
        this.fmlBuffer[196] = new FmlField("NPNUMINFORECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 196, 500);
        this.fmlBuffer[197] = new FmlField("NPNUMINFORECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 197, 500);
        this.fmlBuffer[198] = new FmlField("NPNUMINFORECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 198, 500);
        this.fmlBuffer[199] = new FmlField("INT_ORDER_ID", FmlField.TYPE_DOUBLE, -1, null, 199, 500);
        this.fmlBuffer[200] = new FmlField("ORG_CUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 200, 500);
        this.fmlBuffer[201] = new FmlField("PORT_IND", FmlField.TYPE_BYTE, -1, null, 201, 500);
        this.fmlBuffer[202] = new FmlField("NUMBER_TYPE", FmlField.TYPE_BYTE, -1, null, 202, 500);
        this.fmlBuffer[203] = new FmlField("PORT_REQUEST_DATE", FmlField.TYPE_STRING, 15, null, 203, 500);
        this.fmlBuffer[204] = new FmlField("ORG_OPERATOR", FmlField.TYPE_STRING, 6, null, 204, 500);
        this.fmlBuffer[205] = new FmlField("NPNUMINFORECSUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 205, 500);
        this.fmlBuffer[206] = new FmlField("LAST_INT_ORD_ID", FmlField.TYPE_DOUBLE, -1, null, 206, 500);
        this.fmlBuffer[207] = new FmlField("FUNCTION_PORT_IND", FmlField.TYPE_BYTE, -1, null, 207, 500);
        this.fmlBuffer[208] = new FmlField("PASSIVE_IND", FmlField.TYPE_BYTE, -1, null, 208, 500);
        this.fmlBuffer[209] = new FmlField("AUTO_CONFIRM", FmlField.TYPE_BYTE, -1, null, 209, 500);
        this.fmlBuffer[210] = new FmlField("TEMPORARY_MSISDN", FmlField.TYPE_STRING, 21, null, 210, 500);
        this.fmlBuffer[211] = new FmlField("HANDLE_MODE", FmlField.TYPE_BYTE, -1, null, 211, 500);
        this.fmlBuffer[212] = new FmlField("SEND_IND", FmlField.TYPE_BYTE, -1, null, 212, 500);
        this.fmlBuffer[213] = new FmlField("ORDID_STR", FmlField.TYPE_STRING, 21, null, 213, 500);
        this.fmlBuffer[214] = new FmlField("LAST_ORDID_STR", FmlField.TYPE_STRING, 21, null, 214, 500);
        this.fmlBuffer[215] = new FmlField("ICC", FmlField.TYPE_STRING, 61, null, 215, 500);
        this.fmlBuffer[216] = new FmlField("CUSTOMER_NAME", FmlField.TYPE_STRING, 255, null, 216, 500);
        this.fmlBuffer[217] = new FmlField("NPINFOBUFFCUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 217, 500);
        this.fmlBuffer[218] = new FmlField("SERVICE_PROVIDER", FmlField.TYPE_STRING, 6, null, 218, 500);
    }
    ...
    public Double get_INT_ORDER_ID(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[199].getValue(nIndex));
    }
    ...
    public Integer get_NPNUMINFORECSUBSCRIBER_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[205].getValue(nIndex));
    }
    ...
    public Double get_LAST_INT_ORD_ID(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[206].getValue(nIndex));
    }
