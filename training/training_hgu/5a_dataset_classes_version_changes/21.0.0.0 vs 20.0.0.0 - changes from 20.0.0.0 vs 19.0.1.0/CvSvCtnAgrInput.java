...
public class CvSvCtnAgrInput extends ServiceInput implements Conversable {
    ...
    public CvSvCtnAgrInput() throws EnvironmentException, FMLManipulationException {
        ...
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[46] = new FmlField("SOC_START_RC_DATE", FmlField.TYPE_STRING, 9, null, 46, 50);
            this.fmlBuffer[47] = new FmlField("RC_DATE_COPY_IND", FmlField.TYPE_BYTE, -1, null, 47, 50);
            this.fmlBuffer[48] = new FmlField("PSOCFTRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 48, 1);
            this.fmlBuffer[49] = new FmlField("PSOCFTRBUFROWID", FmlField.TYPE_STRING, 19, null, 49, 200);
            this.fmlBuffer[50] = new FmlField("PSOCFTRBUFSOC", FmlField.TYPE_STRING, 10, null, 50, 200);
            this.fmlBuffer[51] = new FmlField("PSOCFTRBUFSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 51, 200);
            this.fmlBuffer[52] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 52, 200);
            this.fmlBuffer[53] = new FmlField("MPS_FTR_CODE", FmlField.TYPE_STRING, 7, null, 53, 200);
            this.fmlBuffer[54] = new FmlField("FTR_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 54, 200);
            this.fmlBuffer[55] = new FmlField("FTR_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 55, 200);
            this.fmlBuffer[56] = new FmlField("FTR_EFF_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 56, 200);
            this.fmlBuffer[57] = new FmlField("FTR_EXP_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 57, 200);
            this.fmlBuffer[58] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 58, 200);
            this.fmlBuffer[59] = new FmlField("FTR_MODE", FmlField.TYPE_BYTE, -1, null, 59, 200);
            this.fmlBuffer[60] = new FmlField("PSOCFTRBUFSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 60, 200);
            this.fmlBuffer[61] = new FmlField("FTR_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 61, 200);
            this.fmlBuffer[62] = new FmlField("FTR_ADD_PARAM", FmlField.TYPE_STRING, 301, null, 62, 200);
            this.fmlBuffer[63] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, null, 63, 200);
            this.fmlBuffer[64] = new FmlField("PSOCFTRBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 64, 200);
            this.fmlBuffer[65] = new FmlField("PSOCFTRBUFCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 65, 200);
            this.fmlBuffer[66] = new FmlField("FTR_SPECIAL_TELNO", FmlField.TYPE_STRING, 21, null, 66, 200);
            this.fmlBuffer[67] = new FmlField("SWITCH_ACT_NEEDED", FmlField.TYPE_BYTE, -1, null, 67, 200);
            this.fmlBuffer[68] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, null, 68, 200);
            this.fmlBuffer[69] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, null, 69, 200);
            this.fmlBuffer[70] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 70, 200);
            this.fmlBuffer[71] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, null, 71, 200);
            this.fmlBuffer[72] = new FmlField("MANUAL_RC_RATE", FmlField.TYPE_DOUBLE, -1, null, 72, 200);
            this.fmlBuffer[73] = new FmlField("MANUAL_RC_EXP_DATE", FmlField.TYPE_STRING, 9, null, 73, 200);
            this.fmlBuffer[74] = new FmlField("PCSFRNDFMLROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 74, 1);
            this.fmlBuffer[75] = new FmlField("ACTIONIND", FmlField.TYPE_BYTE, -1, null, 75, 10000);
            this.fmlBuffer[76] = new FmlField("PCSFANDFRECROWID", FmlField.TYPE_STRING, 19, null, 76, 10000);
            this.fmlBuffer[77] = new FmlField("PCSFANDFRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 77, 10000);
            this.fmlBuffer[78] = new FmlField("PCSFANDFRECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 78, 10000);
            this.fmlBuffer[79] = new FmlField("PERSONAL_TEL", FmlField.TYPE_STRING, 21, null, 79, 10000);
            this.fmlBuffer[80] = new FmlField("PERSONAL_TEL_TO", FmlField.TYPE_STRING, 21, null, 80, 10000);
            this.fmlBuffer[81] = new FmlField("FF_SOC", FmlField.TYPE_STRING, 10, null, 81, 10000);
            this.fmlBuffer[82] = new FmlField("PLAN_CODE", FmlField.TYPE_STRING, 10, null, 82, 10000);
            this.fmlBuffer[83] = new FmlField("DISCOUNT_TYPE", FmlField.TYPE_BYTE, -1, null, 83, 10000);
            this.fmlBuffer[84] = new FmlField("START_HOUR", FmlField.TYPE_STRING, 7, null, 84, 10000);
            this.fmlBuffer[85] = new FmlField("DURATION", FmlField.TYPE_DOUBLE, -1, null, 85, 10000);
            this.fmlBuffer[86] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 86, 1);
            this.fmlBuffer[87] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 87, 2);
            this.fmlBuffer[88] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 88, 2);
            this.fmlBuffer[89] = new FmlField("PNPINFOBUFFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 89, 1);
            this.fmlBuffer[90] = new FmlField("NPNUMINFORECROWID", FmlField.TYPE_STRING, 19, null, 90, 500);
            this.fmlBuffer[91] = new FmlField("PORT_NUMBER", FmlField.TYPE_STRING, 21, null, 91, 500);
            this.fmlBuffer[92] = new FmlField("NPNUMINFORECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 92, 500);
            this.fmlBuffer[93] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 93, 500);
            this.fmlBuffer[94] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 94, 500);
            this.fmlBuffer[95] = new FmlField("NPNUMINFORECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 95, 500);
            this.fmlBuffer[96] = new FmlField("NPNUMINFORECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 96, 500);
            this.fmlBuffer[97] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 97, 500);
            this.fmlBuffer[98] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 98, 500);
            this.fmlBuffer[99] = new FmlField("NPNUMINFORECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 99, 500);
            this.fmlBuffer[100] = new FmlField("INT_ORDER_ID", FmlField.TYPE_DOUBLE, -1, null, 100, 500);
            this.fmlBuffer[101] = new FmlField("ORG_CUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 101, 500);
            this.fmlBuffer[102] = new FmlField("PORT_IND", FmlField.TYPE_BYTE, -1, null, 102, 500);
            this.fmlBuffer[103] = new FmlField("NUMBER_TYPE", FmlField.TYPE_BYTE, -1, null, 103, 500);
            this.fmlBuffer[104] = new FmlField("PORT_REQUEST_DATE", FmlField.TYPE_STRING, 15, null, 104, 500);
            this.fmlBuffer[105] = new FmlField("ORG_OPERATOR", FmlField.TYPE_STRING, 6, null, 105, 500);
            this.fmlBuffer[106] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 106, 500);
            this.fmlBuffer[107] = new FmlField("LAST_INT_ORD_ID", FmlField.TYPE_DOUBLE, -1, null, 107, 500);
            this.fmlBuffer[108] = new FmlField("FUNCTION_PORT_IND", FmlField.TYPE_BYTE, -1, null, 108, 500);
            this.fmlBuffer[109] = new FmlField("PASSIVE_IND", FmlField.TYPE_BYTE, -1, null, 109, 500);
            this.fmlBuffer[110] = new FmlField("AUTO_CONFIRM", FmlField.TYPE_BYTE, -1, null, 110, 500);
            this.fmlBuffer[111] = new FmlField("TEMPORARY_MSISDN", FmlField.TYPE_STRING, 21, null, 111, 500);
            this.fmlBuffer[112] = new FmlField("HANDLE_MODE", FmlField.TYPE_BYTE, -1, null, 112, 500);
            this.fmlBuffer[113] = new FmlField("SEND_IND", FmlField.TYPE_BYTE, -1, null, 113, 500);
            this.fmlBuffer[114] = new FmlField("ORDID_STR", FmlField.TYPE_STRING, 21, null, 114, 500);
            this.fmlBuffer[115] = new FmlField("LAST_ORDID_STR", FmlField.TYPE_STRING, 21, null, 115, 500);
            this.fmlBuffer[116] = new FmlField("ICC", FmlField.TYPE_STRING, 61, null, 116, 500);
            this.fmlBuffer[117] = new FmlField("CUSTOMER_NAME", FmlField.TYPE_STRING, 255, null, 117, 500);
            this.fmlBuffer[118] = new FmlField("NPINFOBUFFCUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 118, 500);
            this.fmlBuffer[119] = new FmlField("SERVICE_PROVIDER", FmlField.TYPE_STRING, 6, null, 119, 500);
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CvSvCtnAgrOutput class");
        }
    }
