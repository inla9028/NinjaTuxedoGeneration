...
public class ArInCstBanInput extends ServiceInput {
    ...
    public ArInCstBanInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[150] = new FmlField("CAAP_TYPE", FmlField.TYPE_BYTE, -1, NinjaConfigurationReferenceTable.getCAAPType(), 150, 1);
        ...
        this.fmlBuffer[155] = new FmlField("CS_CREDIT_CLASS", FmlField.TYPE_BYTE, -1, null, 155, 1);
        this.fmlBuffer[156] = new FmlField("CS_APPROVED_CTN_QTY", FmlField.TYPE_SHORT, -1, null, 156, 1);
        this.fmlBuffer[157] = new FmlField("CAS_ORDER_NUMBER", FmlField.TYPE_INTEGER, -1, null, 157, 1);
        this.fmlBuffer[158] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 158, 1);
        this.fmlBuffer[159] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 159, 20);
        this.fmlBuffer[160] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 160, 20);
        this.fmlBuffer[161] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 161, 20);
        this.fmlBuffer[162] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 162, 20);
        this.fmlBuffer[163] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 163, 20);
        this.fmlBuffer[164] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 164, 20);
        this.fmlBuffer[165] = new FmlField("LNKRECBAN", FmlField.TYPE_INTEGER, -1, null, 165, 20);
        this.fmlBuffer[166] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 166, 20);
        this.fmlBuffer[167] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 167, 20);
        this.fmlBuffer[168] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 168, 20);
        this.fmlBuffer[169] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 169, 20);
        this.fmlBuffer[170] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 170, 20);
        this.fmlBuffer[171] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 171, 20);
        this.fmlBuffer[172] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 172, 20);
        this.fmlBuffer[173] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 173, 20);
        this.fmlBuffer[174] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 174, 20);
        this.fmlBuffer[175] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 175, 20);
        this.fmlBuffer[176] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 176, 20);
        this.fmlBuffer[177] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 177, 20);
        this.fmlBuffer[178] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 178, 20);
        this.fmlBuffer[179] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 179, 20);
        this.fmlBuffer[180] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 180, 20);
        this.fmlBuffer[181] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 181, 20);
        this.fmlBuffer[182] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 182, 20);
        this.fmlBuffer[183] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 183, 20);
        this.fmlBuffer[184] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 184, 20);
        this.fmlBuffer[185] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 185, 20);
        this.fmlBuffer[186] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 186, 20);
        this.fmlBuffer[187] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 187, 20);
        this.fmlBuffer[188] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 188, 20);
        this.fmlBuffer[189] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 189, 20);
        this.fmlBuffer[190] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 190, 20);
        this.fmlBuffer[191] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 191, 20);
        this.fmlBuffer[192] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 192, 20);
        this.fmlBuffer[193] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 193, 20);
        this.fmlBuffer[194] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 194, 20);
        this.fmlBuffer[195] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, null, 195, 20);
        this.fmlBuffer[196] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 196, 20);
        this.fmlBuffer[197] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 197, 20);
        this.fmlBuffer[198] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 198, 20);
        this.fmlBuffer[199] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 199, 20);
        this.fmlBuffer[200] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 200, 20);
        this.fmlBuffer[201] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 201, 20);
        this.fmlBuffer[202] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 202, 20);
        this.fmlBuffer[203] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 203, 20);
        this.fmlBuffer[204] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 204, 20);
        this.fmlBuffer[205] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 205, 20);
        this.fmlBuffer[206] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 206, 20);
        this.fmlBuffer[207] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 207, 20);
        this.fmlBuffer[208] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 208, 20);
        this.fmlBuffer[209] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 209, 20);
        this.fmlBuffer[210] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 210, 20);
        this.fmlBuffer[211] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 211, 20);
        this.fmlBuffer[212] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 212, 20);
        this.fmlBuffer[213] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 213, 20);
        this.fmlBuffer[214] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 214, 20);
        this.fmlBuffer[215] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 215, 20);
        this.fmlBuffer[216] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 216, 20);
        this.fmlBuffer[217] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 217, 20);
        this.fmlBuffer[218] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 218, 20);
        this.fmlBuffer[219] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 219, 20);
        this.fmlBuffer[220] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 220, 20);
        this.fmlBuffer[221] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 221, 20);
        this.fmlBuffer[222] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 222, 20);
        this.fmlBuffer[223] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 223, 20);
        this.fmlBuffer[224] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 224, 20);
        this.fmlBuffer[225] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 225, 20);
        this.fmlBuffer[226] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 226, 20);
        this.fmlBuffer[227] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 227, 20);
        this.fmlBuffer[228] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 228, 20);
        this.fmlBuffer[229] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 229, 20);
        this.fmlBuffer[230] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 230, 20);
        this.fmlBuffer[231] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 231, 20);
        this.fmlBuffer[232] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 232, 20);
        this.fmlBuffer[233] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 233, 20);
        this.fmlBuffer[234] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 234, 20);
        this.fmlBuffer[235] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 235, 20);
        this.fmlBuffer[236] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 236, 20);
        this.fmlBuffer[237] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 237, 20);
        this.fmlBuffer[238] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 238, 20);
        this.fmlBuffer[239] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 239, 20);
        this.fmlBuffer[240] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 240, 20);
        this.fmlBuffer[241] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 241, 20);
        this.fmlBuffer[242] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 242, 20);
        this.fmlBuffer[243] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 243, 20);
        this.fmlBuffer[244] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 244, 20);
        this.fmlBuffer[245] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 245, 20);
        this.fmlBuffer[246] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 246, 20);
        this.fmlBuffer[247] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 247, 20);
        this.fmlBuffer[248] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 248, 20);
        this.fmlBuffer[249] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 249, 20);
        this.fmlBuffer[250] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 250, 20);
        this.fmlBuffer[251] = new FmlField("PSVBLPRMBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 251, 1);
        this.fmlBuffer[252] = new FmlField("BPMODE", FmlField.TYPE_BYTE, -1, null, 252, 20);
        this.fmlBuffer[253] = new FmlField("BPSEQNO", FmlField.TYPE_INTEGER, -1, null, 253, 20);
        this.fmlBuffer[254] = new FmlField("BPEFFDATE", FmlField.TYPE_STRING, 9, null, 254, 20);
        this.fmlBuffer[255] = new FmlField("BPEXPDATE", FmlField.TYPE_STRING, 9, null, 255, 20);
        this.fmlBuffer[256] = new FmlField("BPFORMAT", FmlField.TYPE_STRING, 3, null, 256, 20);
        this.fmlBuffer[257] = new FmlField("BPMEDIA", FmlField.TYPE_STRING, 3, null, 257, 20);
        this.fmlBuffer[258] = new FmlField("BPPRINTCATEGORY", FmlField.TYPE_STRING, 3, null, 258, 20);
        this.fmlBuffer[259] = new FmlField("BPNOOFCOPIES", FmlField.TYPE_SHORT, -1, null, 259, 20);
        this.fmlBuffer[260] = new FmlField("BP_LANGUAGE", FmlField.TYPE_STRING, 3, null, 260, 20);
        this.fmlBuffer[261] = new FmlField("BP_CALL_DETAILS_MEDIA", FmlField.TYPE_BYTE, -1, null, 261, 20);
    }
    ...
    public Integer get_CS_APPROVED_CTN_QTY() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[156].getValue(0)));
    }
    ...
    public void set_CS_APPROVED_CTN_QTY(Integer value) throws FMLManipulationException {
        this.fmlBuffer[156].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public void set_LINK_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[167].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_NM_UP_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[177].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_NAME_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[180].getValue(nIndex));
    }
    ...
    public Integer get_NAMERECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[183].getValue(nIndex));
    }
    ...
    public Integer get_NAMERECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[186].getValue(nIndex)));
    }
    ...
    public void set_NAMERECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[186].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_KOB(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[196].getValue(nIndex));
    }
    ...
    public void set_TELEMARKET_ID(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[198].setValue(nIndex, value);
    }
    ...
    public Integer get_NAMERECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[199].getValue(nIndex)));
    }
    ...
    public void set_NAMERECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[199].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public void set_MARITAL_STATUS(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[203].setValue(nIndex, value);
    }
    ...
    public void set_ADR_UP_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[206].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_ADDRESS_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[209].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[212].getValue(nIndex));
    }
    ...
    public void set_ADDRESSRECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[215].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public void set_CO_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[234].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_ADDRESSRECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[235].getValue(nIndex)));
    }
    ...
    public void set_ADDRESSRECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[235].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_BPNOOFCOPIES(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[259].getValue(nIndex)));
    }
    ...
    public void set_BPNOOFCOPIES(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[259].setValue(nIndex, TypeConverter.integerToShort(value));
    }
