...
public class CsRsCanCtnInput extends ServiceInput {
    ...
    public CsRsCanCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[135] = new FmlField("PHYDEVARRAYACTIVITY_DATE", FmlField.TYPE_STRING, 15, null, 135, 50);
            ...
            this.fmlBuffer[279] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 279, 1);
            this.fmlBuffer[280] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 280, 1);
            this.fmlBuffer[281] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 281, 1);
            this.fmlBuffer[282] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 282, 1);
            this.fmlBuffer[283] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 283, 1);
            this.fmlBuffer[284] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 284, 1);
            this.fmlBuffer[285] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 285, 1);
            this.fmlBuffer[286] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 286, 1);
            this.fmlBuffer[287] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 287, 20);
            this.fmlBuffer[288] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 288, 20);
            this.fmlBuffer[289] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 289, 20);
            this.fmlBuffer[290] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 290, 20);
            this.fmlBuffer[291] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 291, 20);
            this.fmlBuffer[292] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 292, 20);
            this.fmlBuffer[293] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 293, 20);
            this.fmlBuffer[294] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 294, 20);
            this.fmlBuffer[295] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 295, 20);
            this.fmlBuffer[296] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 296, 20);
            this.fmlBuffer[297] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 297, 20);
            this.fmlBuffer[298] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 298, 20);
            this.fmlBuffer[299] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 299, 20);
            this.fmlBuffer[300] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 300, 20);
            this.fmlBuffer[301] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 301, 20);
            this.fmlBuffer[302] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 302, 20);
            this.fmlBuffer[303] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 303, 20);
            this.fmlBuffer[304] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 304, 20);
            this.fmlBuffer[305] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 305, 20);
            this.fmlBuffer[306] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 306, 20);
            this.fmlBuffer[307] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 307, 20);
            this.fmlBuffer[308] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 308, 20);
            this.fmlBuffer[309] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 309, 20);
            this.fmlBuffer[310] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 310, 20);
            this.fmlBuffer[311] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 311, 20);
            this.fmlBuffer[312] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 312, 20);
            this.fmlBuffer[313] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 313, 20);
            this.fmlBuffer[314] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 314, 20);
            this.fmlBuffer[315] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 315, 20);
            this.fmlBuffer[316] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 316, 20);
            this.fmlBuffer[317] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 317, 20);
            this.fmlBuffer[318] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 318, 20);
            this.fmlBuffer[319] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 319, 20);
            this.fmlBuffer[320] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 320, 20);
            this.fmlBuffer[321] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 321, 20);
            this.fmlBuffer[322] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 322, 20);
            this.fmlBuffer[323] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, null, 323, 20);
            this.fmlBuffer[324] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 324, 20);
            this.fmlBuffer[325] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 325, 20);
            this.fmlBuffer[326] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 326, 20);
            this.fmlBuffer[327] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 327, 20);
            this.fmlBuffer[328] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 328, 20);
            this.fmlBuffer[329] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 329, 20);
            this.fmlBuffer[330] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 330, 20);
            this.fmlBuffer[331] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 331, 20);
            this.fmlBuffer[332] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 332, 20);
            this.fmlBuffer[333] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 333, 20);
            this.fmlBuffer[334] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 334, 20);
            this.fmlBuffer[335] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 335, 20);
            this.fmlBuffer[336] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 336, 20);
            this.fmlBuffer[337] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 337, 20);
            this.fmlBuffer[338] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 338, 20);
            this.fmlBuffer[339] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 339, 20);
            this.fmlBuffer[340] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 340, 20);
            this.fmlBuffer[341] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 341, 20);
            this.fmlBuffer[342] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 342, 20);
            this.fmlBuffer[343] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 343, 20);
            this.fmlBuffer[344] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 344, 20);
            this.fmlBuffer[345] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 345, 20);
            this.fmlBuffer[346] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 346, 20);
            this.fmlBuffer[347] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 347, 20);
            this.fmlBuffer[348] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 348, 20);
            this.fmlBuffer[349] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 349, 20);
            this.fmlBuffer[350] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 350, 20);
            this.fmlBuffer[351] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 351, 20);
            this.fmlBuffer[352] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 352, 20);
            this.fmlBuffer[353] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 353, 20);
            this.fmlBuffer[354] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 354, 20);
            this.fmlBuffer[355] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 355, 20);
            this.fmlBuffer[356] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 356, 20);
            this.fmlBuffer[357] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 357, 20);
            this.fmlBuffer[358] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 358, 20);
            this.fmlBuffer[359] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 359, 20);
            this.fmlBuffer[360] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 360, 20);
            this.fmlBuffer[361] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 361, 20);
            this.fmlBuffer[362] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 362, 20);
            this.fmlBuffer[363] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 363, 20);
            this.fmlBuffer[364] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 364, 20);
            this.fmlBuffer[365] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 365, 20);
            this.fmlBuffer[366] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 366, 20);
            this.fmlBuffer[367] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 367, 20);
            this.fmlBuffer[368] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 368, 20);
            this.fmlBuffer[369] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 369, 20);
            this.fmlBuffer[370] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 370, 20);
            this.fmlBuffer[371] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 371, 20);
            this.fmlBuffer[372] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 372, 20);
            this.fmlBuffer[373] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 373, 20);
            this.fmlBuffer[374] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 374, 20);
            this.fmlBuffer[375] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 375, 20);
            this.fmlBuffer[376] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 376, 20);
            this.fmlBuffer[377] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 377, 20);
            this.fmlBuffer[378] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 378, 20);
            this.fmlBuffer[379] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 379, 1);
            this.fmlBuffer[380] = new FmlField("INSTALLMENT_AMT", FmlField.TYPE_DOUBLE, -1, null, 380, 12);
            this.fmlBuffer[381] = new FmlField("INSTALLMENT_DATE", FmlField.TYPE_STRING, 9, null, 381, 12);
            this.fmlBuffer[382] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 382, 1);
            this.fmlBuffer[383] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 383, 2);
            this.fmlBuffer[384] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 384, 2);
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            fmlBuffer = new FmlField[383];
    
            //// Get default values from DB
            //synchronized (this.defaultValuesPopulated) {
            //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
            //        defaultValues = getDefaultValues("csRsCanCtn", 383);
            //        this.defaultValuesPopulated = Boolean.TRUE;
            //    }
            //}
            ...
            this.fmlBuffer[133] = new FmlField("PHYDEVARRAYACTIVITY_DATE", FmlField.TYPE_STRING, 15, null, 133, 50);
            ...
            this.fmlBuffer[277] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 277, 1);
            this.fmlBuffer[278] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 278, 1);
            this.fmlBuffer[279] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 279, 1);
            this.fmlBuffer[280] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 280, 1);
            this.fmlBuffer[281] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 281, 1);
            this.fmlBuffer[282] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 282, 1);
            this.fmlBuffer[283] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 283, 1);
            this.fmlBuffer[284] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 284, 1);
            this.fmlBuffer[285] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 285, 20);
            this.fmlBuffer[286] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 286, 20);
            this.fmlBuffer[287] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 287, 20);
            this.fmlBuffer[288] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 288, 20);
            this.fmlBuffer[289] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 289, 20);
            this.fmlBuffer[290] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 290, 20);
            this.fmlBuffer[291] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 291, 20);
            this.fmlBuffer[292] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 292, 20);
            this.fmlBuffer[293] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 293, 20);
            this.fmlBuffer[294] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 294, 20);
            this.fmlBuffer[295] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 295, 20);
            this.fmlBuffer[296] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 296, 20);
            this.fmlBuffer[297] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 297, 20);
            this.fmlBuffer[298] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 298, 20);
            this.fmlBuffer[299] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 299, 20);
            this.fmlBuffer[300] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 300, 20);
            this.fmlBuffer[301] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 301, 20);
            this.fmlBuffer[302] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 302, 20);
            this.fmlBuffer[303] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 303, 20);
            this.fmlBuffer[304] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 304, 20);
            this.fmlBuffer[305] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 305, 20);
            this.fmlBuffer[306] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 306, 20);
            this.fmlBuffer[307] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 307, 20);
            this.fmlBuffer[308] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 308, 20);
            this.fmlBuffer[309] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 309, 20);
            this.fmlBuffer[310] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 310, 20);
            this.fmlBuffer[311] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 311, 20);
            this.fmlBuffer[312] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 312, 20);
            this.fmlBuffer[313] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 313, 20);
            this.fmlBuffer[314] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 314, 20);
            this.fmlBuffer[315] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 315, 20);
            this.fmlBuffer[316] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 316, 20);
            this.fmlBuffer[317] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 317, 20);
            this.fmlBuffer[318] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 318, 20);
            this.fmlBuffer[319] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 319, 20);
            this.fmlBuffer[320] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 320, 20);
            this.fmlBuffer[321] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, null, 321, 20);
            this.fmlBuffer[322] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 322, 20);
            this.fmlBuffer[323] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 323, 20);
            this.fmlBuffer[324] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 324, 20);
            this.fmlBuffer[325] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 325, 20);
            this.fmlBuffer[326] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 326, 20);
            this.fmlBuffer[327] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 327, 20);
            this.fmlBuffer[328] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 328, 20);
            this.fmlBuffer[329] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 329, 20);
            this.fmlBuffer[330] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 330, 20);
            this.fmlBuffer[331] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 331, 20);
            this.fmlBuffer[332] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 332, 20);
            this.fmlBuffer[333] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 333, 20);
            this.fmlBuffer[334] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 334, 20);
            this.fmlBuffer[335] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 335, 20);
            this.fmlBuffer[336] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 336, 20);
            this.fmlBuffer[337] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 337, 20);
            this.fmlBuffer[338] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 338, 20);
            this.fmlBuffer[339] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 339, 20);
            this.fmlBuffer[340] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 340, 20);
            this.fmlBuffer[341] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 341, 20);
            this.fmlBuffer[342] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 342, 20);
            this.fmlBuffer[343] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 343, 20);
            this.fmlBuffer[344] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 344, 20);
            this.fmlBuffer[345] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 345, 20);
            this.fmlBuffer[346] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 346, 20);
            this.fmlBuffer[347] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 347, 20);
            this.fmlBuffer[348] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 348, 20);
            this.fmlBuffer[349] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 349, 20);
            this.fmlBuffer[350] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 350, 20);
            this.fmlBuffer[351] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 351, 20);
            this.fmlBuffer[352] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 352, 20);
            this.fmlBuffer[353] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 353, 20);
            this.fmlBuffer[354] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 354, 20);
            this.fmlBuffer[355] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 355, 20);
            this.fmlBuffer[356] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 356, 20);
            this.fmlBuffer[357] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 357, 20);
            this.fmlBuffer[358] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 358, 20);
            this.fmlBuffer[359] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 359, 20);
            this.fmlBuffer[360] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 360, 20);
            this.fmlBuffer[361] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 361, 20);
            this.fmlBuffer[362] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 362, 20);
            this.fmlBuffer[363] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 363, 20);
            this.fmlBuffer[364] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 364, 20);
            this.fmlBuffer[365] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 365, 20);
            this.fmlBuffer[366] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 366, 20);
            this.fmlBuffer[367] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 367, 20);
            this.fmlBuffer[368] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 368, 20);
            this.fmlBuffer[369] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 369, 20);
            this.fmlBuffer[370] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 370, 20);
            this.fmlBuffer[371] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 371, 20);
            this.fmlBuffer[372] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 372, 20);
            this.fmlBuffer[373] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 373, 20);
            this.fmlBuffer[374] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 374, 20);
            this.fmlBuffer[375] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 375, 20);
            this.fmlBuffer[376] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 376, 20);
            this.fmlBuffer[377] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 377, 1);
            this.fmlBuffer[378] = new FmlField("INSTALLMENT_AMT", FmlField.TYPE_DOUBLE, -1, null, 378, 12);
            this.fmlBuffer[379] = new FmlField("INSTALLMENT_DATE", FmlField.TYPE_STRING, 9, null, 379, 12);
            this.fmlBuffer[380] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 380, 1);
            this.fmlBuffer[381] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 381, 2);
            this.fmlBuffer[382] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 382, 2);
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
        }
    }
    ...
    public String get_DELIVERY_TYPE() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[285].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[283].getValue(0)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
        }
    }
    ...
    public void set_DELIVERY_TYPE(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[285].setValue(0, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[283].setValue(0, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
        }
    }
    ...
    public Integer get_PNAMEADRBUFROWCOUNT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Integer) this.fmlBuffer[284].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
        }
    }
    ...
    public Integer get_BAN(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[293].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[291].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
    ...
    public Integer get_NAMERECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[312].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
        }
    }
    ...
    public void set_NAMERECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[312].setValue(nIndex, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
        }
    }
    ...
    public Double get_KOB(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[324].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[322].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
        }
    }
    ...
    public Integer get_NAMERECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[325].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
        }
    }
    ...
    public void set_NAMERECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[325].setValue(nIndex, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
        }
    }
    ...
    public Integer get_ADDRESS_ID(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[337].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[335].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
        }
    }
    ...
    public Integer get_ADDRESSRECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Integer) this.fmlBuffer[338].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
        }
    }
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[343].getValue(nIndex)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[341].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
        }
    }
    ...
    public void set_ADDRESSRECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[343].setValue(nIndex, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[341].setValue(nIndex, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
        }
    }
    ...
    public String get_ADR_TYPE(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[344].getValue(nIndex)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_ADR_TYPE(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[344].setValue(nIndex, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_ADDRESSRECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[361].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
        }
    }
    ...
    public void set_ADDRESSRECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[361].setValue(nIndex, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
        }
    }
    ...
    public String get_DEPOSIT_TYPE(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[383].getValue(nIndex)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[381].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
        }
    }
    ...
    public void set_DEPOSIT_TYPE(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[383].setValue(nIndex, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[381].setValue(nIndex, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsRsCanCtnOutput class");
        }
    }
