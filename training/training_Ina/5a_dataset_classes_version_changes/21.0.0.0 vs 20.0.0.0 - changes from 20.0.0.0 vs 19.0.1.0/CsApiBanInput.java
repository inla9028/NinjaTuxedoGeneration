...
public class CsApiBanInput extends ServiceInput {
    ...
    public CsApiBanInput() throws EnvironmentException, FMLManipulationException {
        ...
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[267] = new FmlField("LOAN_SUB_ID", FmlField.TYPE_INTEGER, -1, null, 267, 50);
            this.fmlBuffer[268] = new FmlField("PAGRFRNDFMLROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 268, 1);
            this.fmlBuffer[269] = new FmlField("ACTIONIND", FmlField.TYPE_BYTE, -1, null, 269, 10000);
            this.fmlBuffer[270] = new FmlField("PCSFANDFRECROWID", FmlField.TYPE_STRING, 19, null, 270, 10000);
            this.fmlBuffer[271] = new FmlField("PCSFANDFRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 271, 10000);
            this.fmlBuffer[272] = new FmlField("PCSFANDFRECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 272, 10000);
            this.fmlBuffer[273] = new FmlField("PERSONAL_TEL", FmlField.TYPE_STRING, 21, null, 273, 10000);
            this.fmlBuffer[274] = new FmlField("PERSONAL_TEL_TO", FmlField.TYPE_STRING, 21, null, 274, 10000);
            this.fmlBuffer[275] = new FmlField("FF_SOC", FmlField.TYPE_STRING, 10, null, 275, 10000);
            this.fmlBuffer[276] = new FmlField("PLAN_CODE", FmlField.TYPE_STRING, 10, null, 276, 10000);
            this.fmlBuffer[277] = new FmlField("DISCOUNT_TYPE", FmlField.TYPE_BYTE, -1, null, 277, 10000);
            this.fmlBuffer[278] = new FmlField("START_HOUR", FmlField.TYPE_STRING, 7, null, 278, 10000);
            this.fmlBuffer[279] = new FmlField("DURATION", FmlField.TYPE_DOUBLE, -1, null, 279, 10000);
            this.fmlBuffer[280] = new FmlField("PAGRFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 280, 1);
            this.fmlBuffer[281] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 281, 2);
            this.fmlBuffer[282] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 282, 2);
            this.fmlBuffer[283] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 283, 1);
            this.fmlBuffer[284] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 284, 25);
            this.fmlBuffer[285] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 285, 25);
            this.fmlBuffer[286] = new FmlField("PEFCSMACTVBUFSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 286, 25);
            this.fmlBuffer[287] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 287, 25);
            this.fmlBuffer[288] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 288, 25);
            this.fmlBuffer[289] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 289, 25);
            this.fmlBuffer[290] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 290, 25);
            this.fmlBuffer[291] = new FmlField("P1", FmlField.TYPE_STRING, 21, null, 291, 25);
            this.fmlBuffer[292] = new FmlField("P2", FmlField.TYPE_STRING, 21, null, 292, 25);
            this.fmlBuffer[293] = new FmlField("P3", FmlField.TYPE_STRING, 21, null, 293, 25);
            this.fmlBuffer[294] = new FmlField("P4", FmlField.TYPE_STRING, 21, null, 294, 25);
            this.fmlBuffer[295] = new FmlField("P5", FmlField.TYPE_STRING, 21, null, 295, 25);
            this.fmlBuffer[296] = new FmlField("P6", FmlField.TYPE_STRING, 21, null, 296, 25);
            this.fmlBuffer[297] = new FmlField("P7", FmlField.TYPE_STRING, 21, null, 297, 25);
            this.fmlBuffer[298] = new FmlField("P8", FmlField.TYPE_STRING, 21, null, 298, 25);
            this.fmlBuffer[299] = new FmlField("P9", FmlField.TYPE_STRING, 21, null, 299, 25);
            this.fmlBuffer[300] = new FmlField("P10", FmlField.TYPE_STRING, 21, null, 300, 25);
            this.fmlBuffer[301] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 301, 25);
            this.fmlBuffer[302] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 302, 25);
            this.fmlBuffer[303] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 303, 25);
            this.fmlBuffer[304] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 304, 25);
            this.fmlBuffer[305] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 305, 25);
            this.fmlBuffer[306] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 306, 25);
            this.fmlBuffer[307] = new FmlField("PSRVTPINPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 307, 1);
            this.fmlBuffer[308] = new FmlField("TUXSRVTP", FmlField.TYPE_BYTE, -1, null, 308, 25);
            this.fmlBuffer[309] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 309, 1);
            this.fmlBuffer[310] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 310, 20);
            this.fmlBuffer[311] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 311, 20);
            this.fmlBuffer[312] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 312, 20);
            this.fmlBuffer[313] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 313, 20);
            this.fmlBuffer[314] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 314, 20);
            this.fmlBuffer[315] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 315, 20);
            this.fmlBuffer[316] = new FmlField("LNKRECBAN", FmlField.TYPE_INTEGER, -1, null, 316, 20);
            this.fmlBuffer[317] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 317, 20);
            this.fmlBuffer[318] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 318, 20);
            this.fmlBuffer[319] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 319, 20);
            this.fmlBuffer[320] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 320, 20);
            this.fmlBuffer[321] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 321, 20);
            this.fmlBuffer[322] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 322, 20);
            this.fmlBuffer[323] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 323, 20);
            this.fmlBuffer[324] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 324, 20);
            this.fmlBuffer[325] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 325, 20);
            this.fmlBuffer[326] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 326, 20);
            this.fmlBuffer[327] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 327, 20);
            this.fmlBuffer[328] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 328, 20);
            this.fmlBuffer[329] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 329, 20);
            this.fmlBuffer[330] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 330, 20);
            this.fmlBuffer[331] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 331, 20);
            this.fmlBuffer[332] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 332, 20);
            this.fmlBuffer[333] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 333, 20);
            this.fmlBuffer[334] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 334, 20);
            this.fmlBuffer[335] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 335, 20);
            this.fmlBuffer[336] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 336, 20);
            this.fmlBuffer[337] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 337, 20);
            this.fmlBuffer[338] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 338, 20);
            this.fmlBuffer[339] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 339, 20);
            this.fmlBuffer[340] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 340, 20);
            this.fmlBuffer[341] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 341, 20);
            this.fmlBuffer[342] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 342, 20);
            this.fmlBuffer[343] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 343, 20);
            this.fmlBuffer[344] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 344, 20);
            this.fmlBuffer[345] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 345, 20);
            this.fmlBuffer[346] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, null, 346, 20);
            this.fmlBuffer[347] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 347, 20);
            this.fmlBuffer[348] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 348, 20);
            this.fmlBuffer[349] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 349, 20);
            this.fmlBuffer[350] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 350, 20);
            this.fmlBuffer[351] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 351, 20);
            this.fmlBuffer[352] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 352, 20);
            this.fmlBuffer[353] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 353, 20);
            this.fmlBuffer[354] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 354, 20);
            this.fmlBuffer[355] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 355, 20);
            this.fmlBuffer[356] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 356, 20);
            this.fmlBuffer[357] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 357, 20);
            this.fmlBuffer[358] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 358, 20);
            this.fmlBuffer[359] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 359, 20);
            this.fmlBuffer[360] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 360, 20);
            this.fmlBuffer[361] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 361, 20);
            this.fmlBuffer[362] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 362, 20);
            this.fmlBuffer[363] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 363, 20);
            this.fmlBuffer[364] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 364, 20);
            this.fmlBuffer[365] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 365, 20);
            this.fmlBuffer[366] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 366, 20);
            this.fmlBuffer[367] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 367, 20);
            this.fmlBuffer[368] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 368, 20);
            this.fmlBuffer[369] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 369, 20);
            this.fmlBuffer[370] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 370, 20);
            this.fmlBuffer[371] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 371, 20);
            this.fmlBuffer[372] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 372, 20);
            this.fmlBuffer[373] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 373, 20);
            this.fmlBuffer[374] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 374, 20);
            this.fmlBuffer[375] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 375, 20);
            this.fmlBuffer[376] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 376, 20);
            this.fmlBuffer[377] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 377, 20);
            this.fmlBuffer[378] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 378, 20);
            this.fmlBuffer[379] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 379, 20);
            this.fmlBuffer[380] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 380, 20);
            this.fmlBuffer[381] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 381, 20);
            this.fmlBuffer[382] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 382, 20);
            this.fmlBuffer[383] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 383, 20);
            this.fmlBuffer[384] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 384, 20);
            this.fmlBuffer[385] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 385, 20);
            this.fmlBuffer[386] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 386, 20);
            this.fmlBuffer[387] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 387, 20);
            this.fmlBuffer[388] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 388, 20);
            this.fmlBuffer[389] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 389, 20);
            this.fmlBuffer[390] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 390, 20);
            this.fmlBuffer[391] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 391, 20);
            this.fmlBuffer[392] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 392, 20);
            this.fmlBuffer[393] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 393, 20);
            this.fmlBuffer[394] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 394, 20);
            this.fmlBuffer[395] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 395, 20);
            this.fmlBuffer[396] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 396, 20);
            this.fmlBuffer[397] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 397, 20);
            this.fmlBuffer[398] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 398, 20);
            this.fmlBuffer[399] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 399, 20);
            this.fmlBuffer[400] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 400, 20);
            this.fmlBuffer[401] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 401, 20);
            this.fmlBuffer[402] = new FmlField("PESNBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 402, 1);
            this.fmlBuffer[403] = new FmlField("EQUIPMENT_NO", FmlField.TYPE_STRING, 21, null, 403, 50);
            this.fmlBuffer[404] = new FmlField("PHD_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 404, 50);
            this.fmlBuffer[405] = new FmlField("EQUIPMENT_LEVEL", FmlField.TYPE_SHORT, -1, null, 405, 50);
            this.fmlBuffer[406] = new FmlField("IMSI", FmlField.TYPE_STRING, 16, null, 406, 50);
            this.fmlBuffer[407] = new FmlField("PHYDEVARRAYEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 407, 50);
            this.fmlBuffer[408] = new FmlField("PHYDEVARRAYEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 408, 50);
            this.fmlBuffer[409] = new FmlField("OWNERSHIP_CODE", FmlField.TYPE_STRING, 3, null, 409, 50);
            this.fmlBuffer[410] = new FmlField("SW_STATE_IND", FmlField.TYPE_BYTE, -1, null, 410, 50);
            this.fmlBuffer[411] = new FmlField("LAST_SW_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 411, 50);
            this.fmlBuffer[412] = new FmlField("NEXT_ACTV_CODE", FmlField.TYPE_BYTE, -1, null, 412, 50);
            this.fmlBuffer[413] = new FmlField("NEXT_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 413, 50);
            this.fmlBuffer[414] = new FmlField("NEXT_ACTV_ISSUE_DT", FmlField.TYPE_STRING, 9, null, 414, 50);
            this.fmlBuffer[415] = new FmlField("DEVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 415, 50);
            this.fmlBuffer[416] = new FmlField("ESN_MODE", FmlField.TYPE_BYTE, -1, null, 416, 50);
            this.fmlBuffer[417] = new FmlField("ITEM_ID", FmlField.TYPE_STRING, 16, null, 417, 50);
            this.fmlBuffer[418] = new FmlField("POOL", FmlField.TYPE_STRING, 3, null, 418, 50);
            this.fmlBuffer[419] = new FmlField("LOCATION_ID", FmlField.TYPE_STRING, 5, null, 419, 50);
            this.fmlBuffer[420] = new FmlField("ACTIVITY_CODE", FmlField.TYPE_STRING, 5, null, 420, 50);
            this.fmlBuffer[421] = new FmlField("ACTIVITY_DATE", FmlField.TYPE_STRING, 15, null, 421, 50);
            this.fmlBuffer[422] = new FmlField("OPERATION_STATUS", FmlField.TYPE_BYTE, -1, null, 422, 50);
            this.fmlBuffer[423] = new FmlField("ITEM_OWNERSHIP", FmlField.TYPE_BYTE, -1, null, 423, 50);
            this.fmlBuffer[424] = new FmlField("ITEM_OWNERSHIP_DT", FmlField.TYPE_STRING, 15, null, 424, 50);
            this.fmlBuffer[425] = new FmlField("CURR_POSSESSION", FmlField.TYPE_BYTE, -1, null, 425, 50);
            this.fmlBuffer[426] = new FmlField("CURR_POSSESSION_DT", FmlField.TYPE_STRING, 15, null, 426, 50);
            this.fmlBuffer[427] = new FmlField("MISSING_IND", FmlField.TYPE_BYTE, -1, null, 427, 50);
            this.fmlBuffer[428] = new FmlField("IN_REPAIR_IND", FmlField.TYPE_BYTE, -1, null, 428, 50);
            this.fmlBuffer[429] = new FmlField("IN_TRANSIT_IND", FmlField.TYPE_BYTE, -1, null, 429, 50);
            this.fmlBuffer[430] = new FmlField("COMITED_TO_POS_IND", FmlField.TYPE_BYTE, -1, null, 430, 50);
            this.fmlBuffer[431] = new FmlField("COMITED_DATE", FmlField.TYPE_STRING, 15, null, 431, 50);
            this.fmlBuffer[432] = new FmlField("ACTIVITY_REASON", FmlField.TYPE_STRING, 4, null, 432, 50);
            this.fmlBuffer[433] = new FmlField("UPGRADE_IND", FmlField.TYPE_BYTE, -1, null, 433, 50);
            this.fmlBuffer[434] = new FmlField("EXPECTED_RTRN_DATE", FmlField.TYPE_STRING, 15, null, 434, 50);
            this.fmlBuffer[435] = new FmlField("POLICE_REPORT_NO", FmlField.TYPE_STRING, 16, null, 435, 50);
            this.fmlBuffer[436] = new FmlField("POLICE_REPORT_DATE", FmlField.TYPE_STRING, 15, null, 436, 50);
            this.fmlBuffer[437] = new FmlField("POLICE_STATION", FmlField.TYPE_STRING, 31, null, 437, 50);
            this.fmlBuffer[438] = new FmlField("PUK", FmlField.TYPE_INTEGER, -1, null, 438, 50);
            this.fmlBuffer[439] = new FmlField("PUK2", FmlField.TYPE_INTEGER, -1, null, 439, 50);
            this.fmlBuffer[440] = new FmlField("FIRST_USED_DATE", FmlField.TYPE_STRING, 15, null, 440, 50);
            this.fmlBuffer[441] = new FmlField("SIM_STATUS", FmlField.TYPE_BYTE, -1, null, 441, 50);
            this.fmlBuffer[442] = new FmlField("SUSPEND_IND", FmlField.TYPE_BYTE, -1, null, 442, 50);
            this.fmlBuffer[443] = new FmlField("SUSPEND_DATE", FmlField.TYPE_STRING, 15, null, 443, 50);
            this.fmlBuffer[444] = new FmlField("SENT_TO_AUC_IND", FmlField.TYPE_BYTE, -1, null, 444, 50);
            this.fmlBuffer[445] = new FmlField("HLR_CD", FmlField.TYPE_STRING, 4, null, 445, 50);
            this.fmlBuffer[446] = new FmlField("K4ID", FmlField.TYPE_STRING, 41, null, 446, 50);
            this.fmlBuffer[447] = new FmlField("PHYDEVARRAYDEALER_CODE", FmlField.TYPE_STRING, 6, null, 447, 50);
            this.fmlBuffer[448] = new FmlField("PSOCFTRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 448, 1);
            this.fmlBuffer[449] = new FmlField("PSOCFTRBUFROWID", FmlField.TYPE_STRING, 19, null, 449, 200);
            this.fmlBuffer[450] = new FmlField("PSOCFTRBUFSOC", FmlField.TYPE_STRING, 10, null, 450, 200);
            this.fmlBuffer[451] = new FmlField("PSOCFTRBUFSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 451, 200);
            this.fmlBuffer[452] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 452, 200);
            this.fmlBuffer[453] = new FmlField("MPS_FTR_CODE", FmlField.TYPE_STRING, 7, null, 453, 200);
            this.fmlBuffer[454] = new FmlField("FTR_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 454, 200);
            this.fmlBuffer[455] = new FmlField("FTR_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 455, 200);
            this.fmlBuffer[456] = new FmlField("FTR_EFF_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 456, 200);
            this.fmlBuffer[457] = new FmlField("FTR_EXP_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 457, 200);
            this.fmlBuffer[458] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 458, 200);
            this.fmlBuffer[459] = new FmlField("FTR_MODE", FmlField.TYPE_BYTE, -1, null, 459, 200);
            this.fmlBuffer[460] = new FmlField("PSOCFTRBUFSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 460, 200);
            this.fmlBuffer[461] = new FmlField("FTR_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 461, 200);
            this.fmlBuffer[462] = new FmlField("FTR_ADD_PARAM", FmlField.TYPE_STRING, 301, null, 462, 200);
            this.fmlBuffer[463] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, null, 463, 200);
            this.fmlBuffer[464] = new FmlField("PSOCFTRBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 464, 200);
            this.fmlBuffer[465] = new FmlField("PSOCFTRBUFCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 465, 200);
            this.fmlBuffer[466] = new FmlField("FTR_SPECIAL_TELNO", FmlField.TYPE_STRING, 21, null, 466, 200);
            this.fmlBuffer[467] = new FmlField("SWITCH_ACT_NEEDED", FmlField.TYPE_BYTE, -1, null, 467, 200);
            this.fmlBuffer[468] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, null, 468, 200);
            this.fmlBuffer[469] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, null, 469, 200);
            this.fmlBuffer[470] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 470, 200);
            this.fmlBuffer[471] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, null, 471, 200);
            this.fmlBuffer[472] = new FmlField("MANUAL_RC_RATE", FmlField.TYPE_DOUBLE, -1, null, 472, 200);
            this.fmlBuffer[473] = new FmlField("MANUAL_RC_EXP_DATE", FmlField.TYPE_STRING, 9, null, 473, 200);
            this.fmlBuffer[474] = new FmlField("PNPINFOBUFFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 474, 1);
            this.fmlBuffer[475] = new FmlField("NPNUMINFORECROWID", FmlField.TYPE_STRING, 19, null, 475, 500);
            this.fmlBuffer[476] = new FmlField("PORT_NUMBER", FmlField.TYPE_STRING, 21, null, 476, 500);
            this.fmlBuffer[477] = new FmlField("NPNUMINFORECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 477, 500);
            this.fmlBuffer[478] = new FmlField("NPNUMINFORECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 478, 500);
            this.fmlBuffer[479] = new FmlField("NPNUMINFORECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 479, 500);
            this.fmlBuffer[480] = new FmlField("NPNUMINFORECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 480, 500);
            this.fmlBuffer[481] = new FmlField("NPNUMINFORECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 481, 500);
            this.fmlBuffer[482] = new FmlField("NPNUMINFORECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 482, 500);
            this.fmlBuffer[483] = new FmlField("NPNUMINFORECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 483, 500);
            this.fmlBuffer[484] = new FmlField("NPNUMINFORECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 484, 500);
            this.fmlBuffer[485] = new FmlField("INT_ORDER_ID", FmlField.TYPE_DOUBLE, -1, null, 485, 500);
            this.fmlBuffer[486] = new FmlField("ORG_CUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 486, 500);
            this.fmlBuffer[487] = new FmlField("PORT_IND", FmlField.TYPE_BYTE, -1, null, 487, 500);
            this.fmlBuffer[488] = new FmlField("NUMBER_TYPE", FmlField.TYPE_BYTE, -1, null, 488, 500);
            this.fmlBuffer[489] = new FmlField("PORT_REQUEST_DATE", FmlField.TYPE_STRING, 15, null, 489, 500);
            this.fmlBuffer[490] = new FmlField("ORG_OPERATOR", FmlField.TYPE_STRING, 6, null, 490, 500);
            this.fmlBuffer[491] = new FmlField("NPNUMINFORECSUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 491, 500);
            this.fmlBuffer[492] = new FmlField("LAST_INT_ORD_ID", FmlField.TYPE_DOUBLE, -1, null, 492, 500);
            this.fmlBuffer[493] = new FmlField("FUNCTION_PORT_IND", FmlField.TYPE_BYTE, -1, null, 493, 500);
            this.fmlBuffer[494] = new FmlField("PASSIVE_IND", FmlField.TYPE_BYTE, -1, null, 494, 500);
            this.fmlBuffer[495] = new FmlField("AUTO_CONFIRM", FmlField.TYPE_BYTE, -1, null, 495, 500);
            this.fmlBuffer[496] = new FmlField("TEMPORARY_MSISDN", FmlField.TYPE_STRING, 21, null, 496, 500);
            this.fmlBuffer[497] = new FmlField("HANDLE_MODE", FmlField.TYPE_BYTE, -1, null, 497, 500);
            this.fmlBuffer[498] = new FmlField("SEND_IND", FmlField.TYPE_BYTE, -1, null, 498, 500);
            this.fmlBuffer[499] = new FmlField("ORDID_STR", FmlField.TYPE_STRING, 21, null, 499, 500);
            this.fmlBuffer[500] = new FmlField("LAST_ORDID_STR", FmlField.TYPE_STRING, 21, null, 500, 500);
            this.fmlBuffer[501] = new FmlField("ICC", FmlField.TYPE_STRING, 61, null, 501, 500);
            this.fmlBuffer[502] = new FmlField("CUSTOMER_NAME", FmlField.TYPE_STRING, 255, null, 502, 500);
            this.fmlBuffer[503] = new FmlField("NPINFOBUFFCUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 503, 500);
            this.fmlBuffer[504] = new FmlField("SERVICE_PROVIDER", FmlField.TYPE_STRING, 6, null, 504, 500);
            this.fmlBuffer[505] = new FmlField("RSNCODE", FmlField.TYPE_STRING, 5, null, 505, 1);
            ...
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsApiBanOutput class");
        }
    }
    ...
    public Double get_DEPOSIT_AMOUNT(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[282].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Double get_MEMO_AMT(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[301].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Double get_CHARGE_AMT(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[303].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_PSRVTPINPBUFROWCOUNT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[307].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_PSRVTPINPBUFROWCOUNT(Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[307].setValue(0, value);
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_PNAMEADRBUFROWCOUNT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[309].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_LNKRECBAN(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[316].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[315].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsApiBanOutput class");
    ...
    public Double get_KOB(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[347].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_ADDRESSRECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[363].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[366].getValue(nIndex)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_ADDRESSRECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[366].setValue(nIndex, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public String get_UPGRADE_IND(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[433].getValue(nIndex)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_UPGRADE_IND(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[433].setValue(nIndex, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_PUK2(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[439].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[438].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsApiBanOutput class");
    ...
    public Integer get_PSOCFTRBUFROWCOUNT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[448].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_PSOCFTRBUFROWCOUNT(Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[448].setValue(0, value);
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_SERVICE_FTR_SEQ_NO(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[458].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public String get_SWITCH_ACT_NEEDED(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[467].getValue(nIndex)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_SWITCH_ACT_NEEDED(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[467].setValue(nIndex, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Double get_MANUAL_RC_RATE(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[472].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_PNPINFOBUFFROWCOUNT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[474].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public String get_NPNUMINFORECDL_SERVICE_CODE(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((String) this.fmlBuffer[482].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((String) this.fmlBuffer[481].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsApiBanOutput class");
    ...
    public void set_NPNUMINFORECDL_SERVICE_CODE(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[482].setValue(nIndex, value);
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[481].setValue(nIndex, value);
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsApiBanOutput class");
    ...
    public Integer get_NPNUMINFORECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[483].getValue(nIndex)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_NPNUMINFORECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[483].setValue(nIndex, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_NPNUMINFORECSUBSCRIBER_ID(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[491].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Double get_LAST_INT_ORD_ID(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[492].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public String get_AUTO_CONFIRM(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[495].getValue(nIndex)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[494].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsApiBanOutput class");
    ...
    public void set_AUTO_CONFIRM(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[495].setValue(nIndex, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[494].setValue(nIndex, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsApiBanOutput class");
    ...
    public String get_SEND_IND(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[498].getValue(nIndex)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[497].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsApiBanOutput class");
    ...
    public void set_SEND_IND(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[498].setValue(nIndex, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[497].setValue(nIndex, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsApiBanOutput class");
    ...
    public String get_RSNCODE() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((String) this.fmlBuffer[505].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_RSNCODE(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[505].setValue(0, value);
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
