...
public class ArLsBanAgrOutput extends ServiceOutput {
     ...
     * Creates a new instance of ArLsBanAgrOutput.
     *
     * @param ds Output dataset from ArLsBanAgr service.
     * @throws FMLManipulationException
     */
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[48] = new FmlField("SOC_GROUP", FmlField.TYPE_STRING, 7, null, 48, 600);
        this.fmlBuffer[49] = new FmlField("PRMT_ROWID", FmlField.TYPE_STRING, 19, null, 49, 600);
        this.fmlBuffer[50] = new FmlField("PT_DURATION", FmlField.TYPE_SHORT, -1, null, 50, 600);
        this.fmlBuffer[51] = new FmlField("DURATION_IND", FmlField.TYPE_BYTE, -1, null, 51, 600);
        this.fmlBuffer[52] = new FmlField("PP_IND", FmlField.TYPE_BYTE, -1, null, 52, 600);
        this.fmlBuffer[53] = new FmlField("AUTO_RENEWAL_IND", FmlField.TYPE_BYTE, -1, null, 53, 600);
        this.fmlBuffer[54] = new FmlField("CUT_DATE", FmlField.TYPE_STRING, 9, null, 54, 600);
        this.fmlBuffer[55] = new FmlField("TRS_ROWID", FmlField.TYPE_STRING, 19, null, 55, 600);
        this.fmlBuffer[56] = new FmlField("TRS_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 56, 600);
        this.fmlBuffer[57] = new FmlField("TRS_SOC", FmlField.TYPE_STRING, 10, null, 57, 600);
        this.fmlBuffer[58] = new FmlField("CALL_TYPE_CODE", FmlField.TYPE_BYTE, -1, null, 58, 600);
        this.fmlBuffer[59] = new FmlField("TOLL_RS_DESC", FmlField.TYPE_STRING, 31, null, 59, 600);
