...
public class CsCtnClInfOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[12] = new FmlField("TOTAL_DEP_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 12, 1);
        this.fmlBuffer[13] = new FmlField("TOTAL_DEP_INTEREST", FmlField.TYPE_DOUBLE, -1, null, 13, 1);
        this.fmlBuffer[14] = new FmlField("TOTAL_PENALTY", FmlField.TYPE_DOUBLE, -1, null, 14, 1);
        this.fmlBuffer[15] = new FmlField("SOC", FmlField.TYPE_STRING, 10, null, 15, 1);
    }
