...
public class ArInCstBanOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[235];
        ...
        this.fmlBuffer[131] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 131, 1);
        this.fmlBuffer[132] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 132, 20);
        this.fmlBuffer[133] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 133, 20);
        this.fmlBuffer[134] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 134, 20);
        this.fmlBuffer[135] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 135, 20);
        this.fmlBuffer[136] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 136, 20);
        this.fmlBuffer[137] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 137, 20);
        this.fmlBuffer[138] = new FmlField("LNKRECBAN", FmlField.TYPE_INTEGER, -1, null, 138, 20);
        this.fmlBuffer[139] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 139, 20);
        this.fmlBuffer[140] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 140, 20);
        this.fmlBuffer[141] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 141, 20);
        this.fmlBuffer[142] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 142, 20);
        this.fmlBuffer[143] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 143, 20);
        this.fmlBuffer[144] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 144, 20);
        this.fmlBuffer[145] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 145, 20);
        this.fmlBuffer[146] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 146, 20);
        this.fmlBuffer[147] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 147, 20);
        this.fmlBuffer[148] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 148, 20);
        this.fmlBuffer[149] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 149, 20);
        this.fmlBuffer[150] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 150, 20);
        this.fmlBuffer[151] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 151, 20);
        this.fmlBuffer[152] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 152, 20);
        this.fmlBuffer[153] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 153, 20);
        this.fmlBuffer[154] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 154, 20);
        this.fmlBuffer[155] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 155, 20);
        this.fmlBuffer[156] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 156, 20);
        this.fmlBuffer[157] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 157, 20);
        this.fmlBuffer[158] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 158, 20);
        this.fmlBuffer[159] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 159, 20);
        this.fmlBuffer[160] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 160, 20);
        this.fmlBuffer[161] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 161, 20);
        this.fmlBuffer[162] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 162, 20);
        this.fmlBuffer[163] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 163, 20);
        this.fmlBuffer[164] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 164, 20);
        this.fmlBuffer[165] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 165, 20);
        this.fmlBuffer[166] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 166, 20);
        this.fmlBuffer[167] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 167, 20);
        this.fmlBuffer[168] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, null, 168, 20);
        this.fmlBuffer[169] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 169, 20);
        this.fmlBuffer[170] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 170, 20);
        this.fmlBuffer[171] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 171, 20);
        this.fmlBuffer[172] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 172, 20);
        this.fmlBuffer[173] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 173, 20);
        this.fmlBuffer[174] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 174, 20);
        this.fmlBuffer[175] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 175, 20);
        this.fmlBuffer[176] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 176, 20);
        this.fmlBuffer[177] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 177, 20);
        this.fmlBuffer[178] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 178, 20);
        this.fmlBuffer[179] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 179, 20);
        this.fmlBuffer[180] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 180, 20);
        this.fmlBuffer[181] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 181, 20);
        this.fmlBuffer[182] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 182, 20);
        this.fmlBuffer[183] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 183, 20);
        this.fmlBuffer[184] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 184, 20);
        this.fmlBuffer[185] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 185, 20);
        this.fmlBuffer[186] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 186, 20);
        this.fmlBuffer[187] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 187, 20);
        this.fmlBuffer[188] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 188, 20);
        this.fmlBuffer[189] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 189, 20);
        this.fmlBuffer[190] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 190, 20);
        this.fmlBuffer[191] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 191, 20);
        this.fmlBuffer[192] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 192, 20);
        this.fmlBuffer[193] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 193, 20);
        this.fmlBuffer[194] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 194, 20);
        this.fmlBuffer[195] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 195, 20);
        this.fmlBuffer[196] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 196, 20);
        this.fmlBuffer[197] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 197, 20);
        this.fmlBuffer[198] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 198, 20);
        this.fmlBuffer[199] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 199, 20);
        this.fmlBuffer[200] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 200, 20);
        this.fmlBuffer[201] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 201, 20);
        this.fmlBuffer[202] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 202, 20);
        this.fmlBuffer[203] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 203, 20);
        this.fmlBuffer[204] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 204, 20);
        this.fmlBuffer[205] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 205, 20);
        this.fmlBuffer[206] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 206, 20);
        this.fmlBuffer[207] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 207, 20);
        this.fmlBuffer[208] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 208, 20);
        this.fmlBuffer[209] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 209, 20);
        this.fmlBuffer[210] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 210, 20);
        this.fmlBuffer[211] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 211, 20);
        this.fmlBuffer[212] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 212, 20);
        this.fmlBuffer[213] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 213, 20);
        this.fmlBuffer[214] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 214, 20);
        this.fmlBuffer[215] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 215, 20);
        this.fmlBuffer[216] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 216, 20);
        this.fmlBuffer[217] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 217, 20);
        this.fmlBuffer[218] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 218, 20);
        this.fmlBuffer[219] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 219, 20);
        this.fmlBuffer[220] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 220, 20);
        this.fmlBuffer[221] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 221, 20);
        this.fmlBuffer[222] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 222, 20);
        this.fmlBuffer[223] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 223, 20);
        this.fmlBuffer[224] = new FmlField("PSVBLPRMBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 224, 1);
        this.fmlBuffer[225] = new FmlField("BPMODE", FmlField.TYPE_BYTE, -1, null, 225, 20);
        this.fmlBuffer[226] = new FmlField("BPSEQNO", FmlField.TYPE_INTEGER, -1, null, 226, 20);
        this.fmlBuffer[227] = new FmlField("BPEFFDATE", FmlField.TYPE_STRING, 9, null, 227, 20);
        this.fmlBuffer[228] = new FmlField("BPEXPDATE", FmlField.TYPE_STRING, 9, null, 228, 20);
        this.fmlBuffer[229] = new FmlField("BPFORMAT", FmlField.TYPE_STRING, 3, null, 229, 20);
        this.fmlBuffer[230] = new FmlField("BPMEDIA", FmlField.TYPE_STRING, 3, null, 230, 20);
        this.fmlBuffer[231] = new FmlField("BPPRINTCATEGORY", FmlField.TYPE_STRING, 3, null, 231, 20);
        this.fmlBuffer[232] = new FmlField("BPNOOFCOPIES", FmlField.TYPE_SHORT, -1, null, 232, 20);
        this.fmlBuffer[233] = new FmlField("BP_LANGUAGE", FmlField.TYPE_STRING, 3, null, 233, 20);
        this.fmlBuffer[234] = new FmlField("BP_CALL_DETAILS_MEDIA", FmlField.TYPE_BYTE, -1, null, 234, 20);
    }
    ...
    public Integer get_NAMERECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[159].getValue(nIndex)));
    }
    ...
    public Integer get_NAMERECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[172].getValue(nIndex)));
    }
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[188].getValue(nIndex)));
    }
    ...
    public Integer get_ADDRESSRECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[208].getValue(nIndex)));
    }
    ...
    public String get_BPMODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[225].getValue(nIndex)));
    }
    ...
    public Integer get_BPNOOFCOPIES(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[232].getValue(nIndex)));
    }
