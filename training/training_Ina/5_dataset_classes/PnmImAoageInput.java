 ...
 */
public class PnmImAoageInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of PnmImAoageInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public PnmImAoageInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("pnmImAoage", 28);
        ...
        this.fmlBuffer[16] = new FmlField("MKT_CODE", FmlField.TYPE_STRING, 4, NinjaConfigurationReferenceTable.getDefaultMarket(), 16, 1);
        this.fmlBuffer[17] = new FmlField("FROM_NL", FmlField.TYPE_STRING, 4, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("SELECTION_CODE", FmlField.TYPE_BYTE, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("NGP", FmlField.TYPE_STRING, 4, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("FROM_CTN", FmlField.TYPE_STRING, 21, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("TO_CTN", FmlField.TYPE_STRING, 21, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("CTN_PATTERN", FmlField.TYPE_STRING, 21, null, 22, 1);
        this.fmlBuffer[23] = new FmlField("QUANTITY", FmlField.TYPE_INTEGER, -1, null, 23, 1);
        this.fmlBuffer[24] = new FmlField("ACTION_CODE", FmlField.TYPE_BYTE, -1, null, 24, 1);
        this.fmlBuffer[25] = new FmlField("TO_STATUS", FmlField.TYPE_STRING, 3, null, 25, 1);
        this.fmlBuffer[26] = new FmlField("TO_NL", FmlField.TYPE_STRING, 4, null, 26, 1);
        this.fmlBuffer[27] = new FmlField("LAST_TRX_CODE", FmlField.TYPE_STRING, 4, null, 27, 1);
    }
    ...
    /**
     * Retrieves the value of the 'MKT_CODE' field in the FML buffer.
     *
     * @return Value of 'MKT_CODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_MKT_CODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[16].getValue(0));
    }

    /**
     * Sets the value of the 'MKT_CODE' field in the FML buffer.
     *
     * @param value Default value: :NinjaConfigurationReferenceTable.getDefaultMarket(), Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_MKT_CODE(String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'SELECTION_CODE' field in the FML buffer.
     *
     * @return Value of 'SELECTION_CODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_SELECTION_CODE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[18].getValue(0)));
    }

    /**
     * Sets the value of the 'SELECTION_CODE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_SELECTION_CODE(String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'ACTION_CODE' field in the FML buffer.
     *
     * @return Value of 'ACTION_CODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_ACTION_CODE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[24].getValue(0)));
    }

    /**
     * Sets the value of the 'ACTION_CODE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_ACTION_CODE(String value) throws FMLManipulationException {
