 ...
 */
public class CsRelsCtnOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsRelsCtnOutput.
     *
     * @throws FMLManipulationException
     */
    public CsRelsCtnOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsRelsCtnOutput() {
    }

    /**
     * Creates a new instance of CsRelsCtnOutput.
     *
     * @param ds Output dataset from CsRelsCtn service.
     * @throws FMLManipulationException
     */
    public CsRelsCtnOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[26] = new FmlField("EXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 26, 500);
