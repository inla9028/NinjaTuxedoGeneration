 ...
 */
public class CsSvCrdWchInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsSvCrdWchInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsSvCrdWchInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csSvCrdWch", 62);
        ...
        this.fmlBuffer[40] = new FmlField("PREV_CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 40, 1);
        this.fmlBuffer[41] = new FmlField("PREV_OPR_CW_LMT", FmlField.TYPE_DOUBLE, -1, null, 41, 1);
        this.fmlBuffer[42] = new FmlField("PREV_OPR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, null, 42, 1);
        this.fmlBuffer[43] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 43, 1);
        this.fmlBuffer[44] = new FmlField("ROWID", FmlField.TYPE_STRING, 19, null, 44, 1);
        this.fmlBuffer[45] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 45, 1);
        this.fmlBuffer[46] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 46, 1);
        this.fmlBuffer[47] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 47, 1);
        this.fmlBuffer[48] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 48, 1);
        this.fmlBuffer[49] = new FmlField("CRDWCHRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 49, 1);
        this.fmlBuffer[50] = new FmlField("CRDWCHRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 50, 1);
        this.fmlBuffer[51] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 51, 1);
        this.fmlBuffer[52] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 52, 1);
        this.fmlBuffer[53] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 53, 1);
        this.fmlBuffer[54] = new FmlField("CUST_WATCH_DATE", FmlField.TYPE_STRING, 9, null, 54, 1);
        this.fmlBuffer[55] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 55, 1);
        this.fmlBuffer[56] = new FmlField("CREDIT_WATCH_PIN_CD", FmlField.TYPE_SHORT, -1, null, 56, 1);
        this.fmlBuffer[57] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, null, 57, 1);
        this.fmlBuffer[58] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, null, 58, 1);
        this.fmlBuffer[59] = new FmlField("OPERATOR_CW_LMT", FmlField.TYPE_DOUBLE, -1, null, 59, 1);
        this.fmlBuffer[60] = new FmlField("OPERATOR_TMP_DATE", FmlField.TYPE_STRING, 9, null, 60, 1);
        this.fmlBuffer[61] = new FmlField("OPERATOR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, null, 61, 1);
    }
    ...
    /**
     * Sets the value of the 'PREV_CUST_WATCH_LMT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PREV_CUST_WATCH_LMT(Double value) throws FMLManipulationException {
    ...
    /**
     * Sets the value of the 'PREV_OPR_CW_LMT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PREV_OPR_CW_LMT(Double value) throws FMLManipulationException {
    ...
    /**
     * Sets the value of the 'PREV_OPR_TMP_LMT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PREV_OPR_TMP_LMT(Double value) throws FMLManipulationException {
    ...
    /**
     * Sets the value of the 'CRDWCHRECOPERATOR_ID' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_CRDWCHRECOPERATOR_ID(Integer value) throws FMLManipulationException {
    ...
    /**
     * Sets the value of the 'CRDWCHRECAPPLICATION_ID' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 7.
     * @throws FMLManipulationException
     */
    public void set_CRDWCHRECAPPLICATION_ID(String value) throws FMLManipulationException {
    ...
    public void set_CREDIT_WATCH_PIN_CD(Integer value) throws FMLManipulationException {
        this.fmlBuffer[56].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_OPERATOR_TMP_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[61].getValue(0));
    }
