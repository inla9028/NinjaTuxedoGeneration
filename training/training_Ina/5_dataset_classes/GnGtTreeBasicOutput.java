...
public class GnGtTreeBasicOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[30] = new FmlField("NEXT_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 30, 1000);
        this.fmlBuffer[31] = new FmlField("NEXT_CONF_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 31, 1000);
        this.fmlBuffer[32] = new FmlField("CURR_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 32, 1000);
        this.fmlBuffer[33] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 33, 1000);
        this.fmlBuffer[34] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 34, 1000);
        this.fmlBuffer[35] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 35, 1000);
        this.fmlBuffer[36] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 36, 1000);
        this.fmlBuffer[37] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 37, 1000);
        this.fmlBuffer[38] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 38, 1000);
        this.fmlBuffer[39] = new FmlField("TREEDISCROWID", FmlField.TYPE_STRING, 19, null, 39, 1);
        this.fmlBuffer[40] = new FmlField("DISCOUNT_GROUP_CODE", FmlField.TYPE_STRING, 7, null, 40, 1);
        this.fmlBuffer[41] = new FmlField("DISC_GROUP_DESC", FmlField.TYPE_STRING, 41, null, 41, 1);
        this.fmlBuffer[42] = new FmlField("TREEDISCTREE_LEVEL", FmlField.TYPE_SHORT, -1, null, 42, 1);
        this.fmlBuffer[43] = new FmlField("POTENTIAL_SUBS_NO", FmlField.TYPE_INTEGER, -1, null, 43, 1);
        this.fmlBuffer[44] = new FmlField("LAST_POTENT_DATE", FmlField.TYPE_STRING, 9, null, 44, 1);
    }
