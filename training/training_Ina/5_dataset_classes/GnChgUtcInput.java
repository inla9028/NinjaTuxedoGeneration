...
public class GnChgUtcInput extends ServiceInput {
     ...
     */
    public GnChgUtcInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("gnChgUtc", 23);
        ...
        this.fmlBuffer[19] = new FmlField("ROWID", FmlField.TYPE_STRING, 19, null, 19, 100);
        this.fmlBuffer[20] = new FmlField("UTC_PLAN_CODE", FmlField.TYPE_STRING, 10, null, 20, 100);
        this.fmlBuffer[21] = new FmlField("TREE_LEVEL", FmlField.TYPE_SHORT, -1, null, 21, 100);
        this.fmlBuffer[22] = new FmlField("CTN", FmlField.TYPE_STRING, 21, null, 22, 100);
    }
    ...
    public void set_TREE_LEVEL(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[21].setValue(nIndex, TypeConverter.integerToShort(value));
    }
