 ...
 */
public class CsSrchAgrNoInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsSrchAgrNoInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsSrchAgrNoInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csSrchAgrNo", 19);
        ...
        this.fmlBuffer[16] = new FmlField("BANGRNO", FmlField.TYPE_STRING, 11, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("FROMBAN", FmlField.TYPE_INTEGER, -1, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("TOBAN", FmlField.TYPE_INTEGER, -1, null, 18, 1);
    }
    ...
    /**
     * Retrieves the value of the 'BANGRNO' field in the FML buffer.
     *
     * @return Value of 'BANGRNO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_BANGRNO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[16].getValue(0));
    }

    /**
     * Sets the value of the 'BANGRNO' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 11.
     * @throws FMLManipulationException
     */
    public void set_BANGRNO(String value) throws FMLManipulationException {
        this.fmlBuffer[16].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'FROMBAN' field in the FML buffer.
     *
     * @return Value of 'FROMBAN' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_FROMBAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[17].getValue(0));
    }

    /**
     * Sets the value of the 'FROMBAN' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_FROMBAN(Integer value) throws FMLManipulationException {
        this.fmlBuffer[17].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'TOBAN' field in the FML buffer.
     *
     * @return Value of 'TOBAN' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_TOBAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[18].getValue(0));
    }

    /**
     * Sets the value of the 'TOBAN' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_TOBAN(Integer value) throws FMLManipulationException {
