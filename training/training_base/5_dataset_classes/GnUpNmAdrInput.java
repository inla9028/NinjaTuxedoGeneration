...
public class GnUpNmAdrInput extends ServiceInput {
     ...
     */
    public GnUpNmAdrInput() throws EnvironmentException, FMLManipulationException {
        // Initialise FML buffer
        fmlBuffer = new FmlField[139];

        //// Get default values from DB
        //synchronized (this.defaultValuesPopulated) {
        //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
        //        defaultValues = getDefaultValues("gnUpNmAdr", 139);
        ...
        this.fmlBuffer[23] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 23, 25);
        this.fmlBuffer[24] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 24, 25);
        this.fmlBuffer[25] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 25, 25);
        this.fmlBuffer[26] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 26, 25);
        this.fmlBuffer[27] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 27, 25);
        this.fmlBuffer[28] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 28, 25);
        this.fmlBuffer[29] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 29, 25);
        this.fmlBuffer[30] = new FmlField("P1", FmlField.TYPE_STRING, 21, null, 30, 25);
        this.fmlBuffer[31] = new FmlField("P2", FmlField.TYPE_STRING, 21, null, 31, 25);
        this.fmlBuffer[32] = new FmlField("P3", FmlField.TYPE_STRING, 21, null, 32, 25);
        this.fmlBuffer[33] = new FmlField("P4", FmlField.TYPE_STRING, 21, null, 33, 25);
        this.fmlBuffer[34] = new FmlField("P5", FmlField.TYPE_STRING, 21, null, 34, 25);
        this.fmlBuffer[35] = new FmlField("P6", FmlField.TYPE_STRING, 21, null, 35, 25);
        this.fmlBuffer[36] = new FmlField("P7", FmlField.TYPE_STRING, 21, null, 36, 25);
        this.fmlBuffer[37] = new FmlField("P8", FmlField.TYPE_STRING, 21, null, 37, 25);
        this.fmlBuffer[38] = new FmlField("P9", FmlField.TYPE_STRING, 21, null, 38, 25);
        this.fmlBuffer[39] = new FmlField("P10", FmlField.TYPE_STRING, 21, null, 39, 25);
        this.fmlBuffer[40] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 40, 25);
        this.fmlBuffer[41] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 41, 25);
        this.fmlBuffer[42] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 42, 25);
        this.fmlBuffer[43] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 43, 25);
        this.fmlBuffer[44] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 44, 25);
        this.fmlBuffer[45] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 45, 25);
