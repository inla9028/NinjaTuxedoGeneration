 ...
 */
public class GnGtTreeBasicInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of GnGtTreeBasicInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public GnGtTreeBasicInput() throws EnvironmentException, FMLManipulationException {
        // Initialise FML buffer
        fmlBuffer = new FmlField[22];

        //// Get default values from DB
        //synchronized (this.defaultValuesPopulated) {
        //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
        //        defaultValues = getDefaultValues("gnGtTreeBasic", 22);
        ...
        this.fmlBuffer[16] = new FmlField("NODEBAN", FmlField.TYPE_INTEGER, -1, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("LASTBAN", FmlField.TYPE_INTEGER, -1, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("EFFECTIVEDATE", FmlField.TYPE_STRING, 9, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("SHOWTREETYPE", FmlField.TYPE_BYTE, -1, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("PAGENO", FmlField.TYPE_INTEGER, -1, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("BUFFERSIZE", FmlField.TYPE_INTEGER, -1, null, 21, 1);
    }
    ...
    /**
     * Retrieves the value of the 'LASTBAN' field in the FML buffer.
     *
     * @return Value of 'LASTBAN' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_LASTBAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[17].getValue(0));
    }

    /**
     * Sets the value of the 'LASTBAN' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_LASTBAN(Integer value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'SHOWTREETYPE' field in the FML buffer.
     *
     * @return Value of 'SHOWTREETYPE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_SHOWTREETYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[19].getValue(0)));
    }

    /**
     * Sets the value of the 'SHOWTREETYPE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_SHOWTREETYPE(String value) throws FMLManipulationException {
