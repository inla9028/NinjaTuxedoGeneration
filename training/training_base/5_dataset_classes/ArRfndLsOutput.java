...
public class ArRfndLsOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[45] = new FmlField("TOTALCOUNT", FmlField.TYPE_INTEGER, -1, null, 45, 1);
        this.fmlBuffer[46] = new FmlField("DCI_ERROR_CODE", FmlField.TYPE_INTEGER, -1, null, 46, 1);
        this.fmlBuffer[47] = new FmlField("DCI_ERROR_TYPE", FmlField.TYPE_SHORT, -1, null, 47, 1);
        this.fmlBuffer[48] = new FmlField("DCI_ERROR_TEXT", FmlField.TYPE_STRING, 81, null, 48, 1);
        this.fmlBuffer[49] = new FmlField("DCI_ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 49, 1);
        this.fmlBuffer[50] = new FmlField("DCI_MORE_ROWS", FmlField.TYPE_SHORT, -1, null, 50, 1);
    }
