 ...
 */
public class CsGtOcAmtInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsGtOcAmtInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsGtOcAmtInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csGtOcAmt", 22);
        ...
        this.fmlBuffer[16] = new FmlField("ACTCODE", FmlField.TYPE_STRING, 4, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("ACTREASON", FmlField.TYPE_STRING, 5, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("CTN", FmlField.TYPE_STRING, 21, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("PPCODE", FmlField.TYPE_STRING, 10, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("ACCTYPE", FmlField.TYPE_BYTE, -1, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("ACCSUBTYPE", FmlField.TYPE_STRING, 3, null, 21, 1);
    }
    ...
    /**
     * Retrieves the value of the 'ACTCODE' field in the FML buffer.
     *
     * @return Value of 'ACTCODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_ACTCODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[16].getValue(0));
    }

    /**
     * Sets the value of the 'ACTCODE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_ACTCODE(String value) throws FMLManipulationException {
        this.fmlBuffer[16].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'ACTREASON' field in the FML buffer.
     *
     * @return Value of 'ACTREASON' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_ACTREASON() throws FMLManipulationException {
        return ((String) this.fmlBuffer[17].getValue(0));
    }

    /**
     * Sets the value of the 'ACTREASON' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 5.
     * @throws FMLManipulationException
     */
    public void set_ACTREASON(String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'PPCODE' field in the FML buffer.
     *
     * @return Value of 'PPCODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PPCODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[19].getValue(0));
    }

    /**
     * Sets the value of the 'PPCODE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 10.
     * @throws FMLManipulationException
     */
    public void set_PPCODE(String value) throws FMLManipulationException {
