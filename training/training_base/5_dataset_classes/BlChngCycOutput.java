 ...
 */
public class BlChngCycOutput extends ServiceOutput {

    /**
     * Creates a new instance of BlChngCycOutput.
     *
     * @throws FMLManipulationException
     */
    public BlChngCycOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public BlChngCycOutput() {
    }

    /**
     * Creates a new instance of BlChngCycOutput.
     *
     * @param ds Output dataset from BlChngCyc service.
     * @throws FMLManipulationException
     */
    public BlChngCycOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[17] = new FmlField("CYCLE_CODE", FmlField.TYPE_SHORT, -1, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("CYCLE_FREQUENCY", FmlField.TYPE_SHORT, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("CYCLE_FIRST_MONTH", FmlField.TYPE_SHORT, -1, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("CYCLE_DESC", FmlField.TYPE_STRING, 31, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("CYCLE_CLOSE_DAY", FmlField.TYPE_SHORT, -1, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("CYCLE_POPULATION_CD", FmlField.TYPE_BYTE, -1, null, 22, 1);
        this.fmlBuffer[23] = new FmlField("CYCLE_BILL_DAY", FmlField.TYPE_SHORT, -1, null, 23, 1);
        this.fmlBuffer[24] = new FmlField("CYCLE_DUE_DAY", FmlField.TYPE_SHORT, -1, null, 24, 1);
        this.fmlBuffer[25] = new FmlField("ALLOCATION_IND", FmlField.TYPE_BYTE, -1, null, 25, 1);
        this.fmlBuffer[26] = new FmlField("BL_NEXT_CYC_EFF_DATE", FmlField.TYPE_STRING, 9, null, 26, 1);
    }
