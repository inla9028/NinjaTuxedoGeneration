 ...
 */
public class CsGtSplTlFtrInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsGtSplTlFtrInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsGtSplTlFtrInput() throws EnvironmentException, FMLManipulationException {
        // Initialise FML buffer
        fmlBuffer = new FmlField[21];

        //// Get default values from DB
        //synchronized (this.defaultValuesPopulated) {
        //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
        //        defaultValues = getDefaultValues("csGtSplTlFtr", 21);
        ...
        this.fmlBuffer[16] = new FmlField("MAIN_SUBNO", FmlField.TYPE_STRING, 21, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("FTR_SPLTEL", FmlField.TYPE_STRING, 21, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("FTR_TYPE", FmlField.TYPE_STRING, 4, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("FTR_EFFDT", FmlField.TYPE_STRING, 9, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("FTR_EXPDT", FmlField.TYPE_STRING, 9, null, 20, 1);
    }
    ...
    /**
     * Retrieves the value of the 'MAIN_SUBNO' field in the FML buffer.
     *
     * @return Value of 'MAIN_SUBNO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_MAIN_SUBNO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[16].getValue(0));
    }

    /**
     * Sets the value of the 'MAIN_SUBNO' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_MAIN_SUBNO(String value) throws FMLManipulationException {
        this.fmlBuffer[16].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'FTR_SPLTEL' field in the FML buffer.
     *
     * @return Value of 'FTR_SPLTEL' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_FTR_SPLTEL() throws FMLManipulationException {
        return ((String) this.fmlBuffer[17].getValue(0));
    }

    /**
     * Sets the value of the 'FTR_SPLTEL' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_FTR_SPLTEL(String value) throws FMLManipulationException {
        this.fmlBuffer[17].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'FTR_TYPE' field in the FML buffer.
     *
     * @return Value of 'FTR_TYPE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_FTR_TYPE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[18].getValue(0));
    }

    /**
     * Sets the value of the 'FTR_TYPE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_FTR_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[18].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'FTR_EFFDT' field in the FML buffer.
     *
     * @return Value of 'FTR_EFFDT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_FTR_EFFDT() throws FMLManipulationException {
        return ((String) this.fmlBuffer[19].getValue(0));
    }

    /**
     * Sets the value of the 'FTR_EFFDT' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @throws FMLManipulationException
     */
    public void set_FTR_EFFDT(String value) throws FMLManipulationException {
        this.fmlBuffer[19].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'FTR_EXPDT' field in the FML buffer.
     *
     * @return Value of 'FTR_EXPDT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_FTR_EXPDT() throws FMLManipulationException {
        return ((String) this.fmlBuffer[20].getValue(0));
    }

    /**
     * Sets the value of the 'FTR_EXPDT' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @throws FMLManipulationException
     */
    public void set_FTR_EXPDT(String value) throws FMLManipulationException {
