...
public class CsMoveCtnInput extends ServiceInput {
    ...
    public CsMoveCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[42] = new FmlField("LOAN_SUB_ID", FmlField.TYPE_INTEGER, -1, null, 42, 50);
            this.fmlBuffer[43] = new FmlField("PAGRRECROWID", FmlField.TYPE_STRING, 19, null, 43, 1);
            this.fmlBuffer[44] = new FmlField("PAGRRECSOC", FmlField.TYPE_STRING, 10, null, 44, 1);
            this.fmlBuffer[45] = new FmlField("PAGRRECSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 45, 1);
            this.fmlBuffer[46] = new FmlField("PAGRRECCOMMITMENT_END_DATE", FmlField.TYPE_STRING, 9, null, 46, 1);
            this.fmlBuffer[47] = new FmlField("PAGRRECSERVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 47, 1);
            this.fmlBuffer[48] = new FmlField("PAGRRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 48, 1);
            this.fmlBuffer[49] = new FmlField("PAGRRECEXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 49, 1);
            this.fmlBuffer[50] = new FmlField("PAGRRECSOC_LEVEL_CODE", FmlField.TYPE_BYTE, -1, null, 50, 1);
            this.fmlBuffer[51] = new FmlField("PAGRRECDEALER_CODE", FmlField.TYPE_STRING, 6, null, 51, 1);
            this.fmlBuffer[52] = new FmlField("PAGRRECSALES_AGENT", FmlField.TYPE_STRING, 6, null, 52, 1);
            this.fmlBuffer[53] = new FmlField("PAGRRECSRV_MODE", FmlField.TYPE_BYTE, -1, null, 53, 1);
            this.fmlBuffer[54] = new FmlField("PAGRRECSRV_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 54, 1);
            this.fmlBuffer[55] = new FmlField("PAGRRECSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 55, 1);
            this.fmlBuffer[56] = new FmlField("PAGRRECSRV_TRX_ID", FmlField.TYPE_INTEGER, -1, null, 56, 1);
            this.fmlBuffer[57] = new FmlField("PAGRRECCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 57, 1);
            this.fmlBuffer[58] = new FmlField("PAGRRECCAMPAIGN", FmlField.TYPE_STRING, 10, null, 58, 1);
            this.fmlBuffer[59] = new FmlField("PAGRRECCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 59, 1);
            this.fmlBuffer[60] = new FmlField("PAGRRECPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 60, 1);
            this.fmlBuffer[61] = new FmlField("PAGRRECLOAN_VER_NO", FmlField.TYPE_INTEGER, -1, null, 61, 1);
            this.fmlBuffer[62] = new FmlField("PAGRRECLOAN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 62, 1);
            this.fmlBuffer[63] = new FmlField("PAGRRECSOC_ACTV_FEE", FmlField.TYPE_DOUBLE, -1, null, 63, 1);
            this.fmlBuffer[64] = new FmlField("PAGRRECPROMOTIONAL_SOC", FmlField.TYPE_STRING, 10, null, 64, 1);
            this.fmlBuffer[65] = new FmlField("PAGRRECREASON_CODE", FmlField.TYPE_STRING, 5, null, 65, 1);
            this.fmlBuffer[66] = new FmlField("PAGRRECSOC_START_RC_DATE", FmlField.TYPE_STRING, 9, null, 66, 1);
            this.fmlBuffer[67] = new FmlField("PAGRRECRC_DATE_COPY_IND", FmlField.TYPE_BYTE, -1, null, 67, 1);
            this.fmlBuffer[68] = new FmlField("PAGRRECLOAN_SUB_ID", FmlField.TYPE_INTEGER, -1, null, 68, 1);
            this.fmlBuffer[69] = new FmlField("PSOCFTRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 69, 1);
            this.fmlBuffer[70] = new FmlField("PSOCFTRBUFROWID", FmlField.TYPE_STRING, 19, null, 70, 200);
            this.fmlBuffer[71] = new FmlField("PSOCFTRBUFSOC", FmlField.TYPE_STRING, 10, null, 71, 200);
            this.fmlBuffer[72] = new FmlField("PSOCFTRBUFSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 72, 200);
            this.fmlBuffer[73] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 73, 200);
            this.fmlBuffer[74] = new FmlField("MPS_FTR_CODE", FmlField.TYPE_STRING, 7, null, 74, 200);
            this.fmlBuffer[75] = new FmlField("FTR_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 75, 200);
            this.fmlBuffer[76] = new FmlField("FTR_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 76, 200);
            this.fmlBuffer[77] = new FmlField("FTR_EFF_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 77, 200);
            this.fmlBuffer[78] = new FmlField("FTR_EXP_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 78, 200);
            this.fmlBuffer[79] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 79, 200);
            this.fmlBuffer[80] = new FmlField("FTR_MODE", FmlField.TYPE_BYTE, -1, null, 80, 200);
            this.fmlBuffer[81] = new FmlField("PSOCFTRBUFSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 81, 200);
            this.fmlBuffer[82] = new FmlField("FTR_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 82, 200);
            this.fmlBuffer[83] = new FmlField("FTR_ADD_PARAM", FmlField.TYPE_STRING, 301, null, 83, 200);
            this.fmlBuffer[84] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, null, 84, 200);
            this.fmlBuffer[85] = new FmlField("PSOCFTRBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 85, 200);
            this.fmlBuffer[86] = new FmlField("PSOCFTRBUFCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 86, 200);
            this.fmlBuffer[87] = new FmlField("FTR_SPECIAL_TELNO", FmlField.TYPE_STRING, 21, null, 87, 200);
            this.fmlBuffer[88] = new FmlField("SWITCH_ACT_NEEDED", FmlField.TYPE_BYTE, -1, null, 88, 200);
            this.fmlBuffer[89] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, null, 89, 200);
            this.fmlBuffer[90] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, null, 90, 200);
            this.fmlBuffer[91] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 91, 200);
            this.fmlBuffer[92] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, null, 92, 200);
            this.fmlBuffer[93] = new FmlField("MANUAL_RC_RATE", FmlField.TYPE_DOUBLE, -1, null, 93, 200);
            this.fmlBuffer[94] = new FmlField("MANUAL_RC_EXP_DATE", FmlField.TYPE_STRING, 9, null, 94, 200);
            this.fmlBuffer[95] = new FmlField("PCSFRNDFMLROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 95, 1);
            this.fmlBuffer[96] = new FmlField("ACTIONIND", FmlField.TYPE_BYTE, -1, null, 96, 10000);
            this.fmlBuffer[97] = new FmlField("PCSFANDFRECROWID", FmlField.TYPE_STRING, 19, null, 97, 10000);
            this.fmlBuffer[98] = new FmlField("PCSFANDFRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 98, 10000);
            this.fmlBuffer[99] = new FmlField("PCSFANDFRECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 99, 10000);
            this.fmlBuffer[100] = new FmlField("PERSONAL_TEL", FmlField.TYPE_STRING, 21, null, 100, 10000);
            this.fmlBuffer[101] = new FmlField("PERSONAL_TEL_TO", FmlField.TYPE_STRING, 21, null, 101, 10000);
            this.fmlBuffer[102] = new FmlField("FF_SOC", FmlField.TYPE_STRING, 10, null, 102, 10000);
            this.fmlBuffer[103] = new FmlField("PLAN_CODE", FmlField.TYPE_STRING, 10, null, 103, 10000);
            this.fmlBuffer[104] = new FmlField("DISCOUNT_TYPE", FmlField.TYPE_BYTE, -1, null, 104, 10000);
            this.fmlBuffer[105] = new FmlField("START_HOUR", FmlField.TYPE_STRING, 7, null, 105, 10000);
            this.fmlBuffer[106] = new FmlField("DURATION", FmlField.TYPE_DOUBLE, -1, null, 106, 10000);
            this.fmlBuffer[107] = new FmlField("PESNBUFFERROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 107, 1);
            this.fmlBuffer[108] = new FmlField("EQUIPMENT_NO", FmlField.TYPE_STRING, 21, null, 108, 50);
            this.fmlBuffer[109] = new FmlField("PHD_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 109, 50);
            this.fmlBuffer[110] = new FmlField("EQUIPMENT_LEVEL", FmlField.TYPE_SHORT, -1, null, 110, 50);
            this.fmlBuffer[111] = new FmlField("IMSI", FmlField.TYPE_STRING, 16, null, 111, 50);
            this.fmlBuffer[112] = new FmlField("PHYDEVARRAYEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 112, 50);
            this.fmlBuffer[113] = new FmlField("PHYDEVARRAYEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 113, 50);
            this.fmlBuffer[114] = new FmlField("OWNERSHIP_CODE", FmlField.TYPE_STRING, 3, null, 114, 50);
            this.fmlBuffer[115] = new FmlField("SW_STATE_IND", FmlField.TYPE_BYTE, -1, null, 115, 50);
            this.fmlBuffer[116] = new FmlField("LAST_SW_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 116, 50);
            this.fmlBuffer[117] = new FmlField("NEXT_ACTV_CODE", FmlField.TYPE_BYTE, -1, null, 117, 50);
            this.fmlBuffer[118] = new FmlField("NEXT_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 118, 50);
            this.fmlBuffer[119] = new FmlField("NEXT_ACTV_ISSUE_DT", FmlField.TYPE_STRING, 9, null, 119, 50);
            this.fmlBuffer[120] = new FmlField("DEVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 120, 50);
            this.fmlBuffer[121] = new FmlField("ESN_MODE", FmlField.TYPE_BYTE, -1, null, 121, 50);
            this.fmlBuffer[122] = new FmlField("ITEM_ID", FmlField.TYPE_STRING, 16, null, 122, 50);
            this.fmlBuffer[123] = new FmlField("POOL", FmlField.TYPE_STRING, 3, null, 123, 50);
            this.fmlBuffer[124] = new FmlField("LOCATION_ID", FmlField.TYPE_STRING, 5, null, 124, 50);
            this.fmlBuffer[125] = new FmlField("ACTIVITY_CODE", FmlField.TYPE_STRING, 5, null, 125, 50);
            this.fmlBuffer[126] = new FmlField("ACTIVITY_DATE", FmlField.TYPE_STRING, 15, null, 126, 50);
            this.fmlBuffer[127] = new FmlField("OPERATION_STATUS", FmlField.TYPE_BYTE, -1, null, 127, 50);
            this.fmlBuffer[128] = new FmlField("ITEM_OWNERSHIP", FmlField.TYPE_BYTE, -1, null, 128, 50);
            this.fmlBuffer[129] = new FmlField("ITEM_OWNERSHIP_DT", FmlField.TYPE_STRING, 15, null, 129, 50);
            this.fmlBuffer[130] = new FmlField("CURR_POSSESSION", FmlField.TYPE_BYTE, -1, null, 130, 50);
            this.fmlBuffer[131] = new FmlField("CURR_POSSESSION_DT", FmlField.TYPE_STRING, 15, null, 131, 50);
            this.fmlBuffer[132] = new FmlField("MISSING_IND", FmlField.TYPE_BYTE, -1, null, 132, 50);
            this.fmlBuffer[133] = new FmlField("IN_REPAIR_IND", FmlField.TYPE_BYTE, -1, null, 133, 50);
            this.fmlBuffer[134] = new FmlField("IN_TRANSIT_IND", FmlField.TYPE_BYTE, -1, null, 134, 50);
            this.fmlBuffer[135] = new FmlField("COMITED_TO_POS_IND", FmlField.TYPE_BYTE, -1, null, 135, 50);
            this.fmlBuffer[136] = new FmlField("COMITED_DATE", FmlField.TYPE_STRING, 15, null, 136, 50);
            this.fmlBuffer[137] = new FmlField("ACTIVITY_REASON", FmlField.TYPE_STRING, 4, null, 137, 50);
            this.fmlBuffer[138] = new FmlField("UPGRADE_IND", FmlField.TYPE_BYTE, -1, null, 138, 50);
            this.fmlBuffer[139] = new FmlField("EXPECTED_RTRN_DATE", FmlField.TYPE_STRING, 15, null, 139, 50);
            this.fmlBuffer[140] = new FmlField("POLICE_REPORT_NO", FmlField.TYPE_STRING, 16, null, 140, 50);
            this.fmlBuffer[141] = new FmlField("POLICE_REPORT_DATE", FmlField.TYPE_STRING, 15, null, 141, 50);
            this.fmlBuffer[142] = new FmlField("POLICE_STATION", FmlField.TYPE_STRING, 31, null, 142, 50);
            this.fmlBuffer[143] = new FmlField("PUK", FmlField.TYPE_INTEGER, -1, null, 143, 50);
            this.fmlBuffer[144] = new FmlField("PUK2", FmlField.TYPE_INTEGER, -1, null, 144, 50);
            this.fmlBuffer[145] = new FmlField("FIRST_USED_DATE", FmlField.TYPE_STRING, 15, null, 145, 50);
            this.fmlBuffer[146] = new FmlField("SIM_STATUS", FmlField.TYPE_BYTE, -1, null, 146, 50);
            this.fmlBuffer[147] = new FmlField("SUSPEND_IND", FmlField.TYPE_BYTE, -1, null, 147, 50);
            this.fmlBuffer[148] = new FmlField("SUSPEND_DATE", FmlField.TYPE_STRING, 15, null, 148, 50);
            this.fmlBuffer[149] = new FmlField("SENT_TO_AUC_IND", FmlField.TYPE_BYTE, -1, null, 149, 50);
            this.fmlBuffer[150] = new FmlField("HLR_CD", FmlField.TYPE_STRING, 4, null, 150, 50);
            this.fmlBuffer[151] = new FmlField("K4ID", FmlField.TYPE_STRING, 41, null, 151, 50);
            this.fmlBuffer[152] = new FmlField("PHYDEVARRAYDEALER_CODE", FmlField.TYPE_STRING, 6, null, 152, 50);
            this.fmlBuffer[153] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 153, 1);
            this.fmlBuffer[154] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 154, 25);
            this.fmlBuffer[155] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 155, 25);
            this.fmlBuffer[156] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 156, 25);
            this.fmlBuffer[157] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 157, 25);
            this.fmlBuffer[158] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 158, 25);
            this.fmlBuffer[159] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 159, 25);
            this.fmlBuffer[160] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 160, 25);
            this.fmlBuffer[161] = new FmlField("P1", FmlField.TYPE_STRING, 21, null, 161, 25);
            this.fmlBuffer[162] = new FmlField("P2", FmlField.TYPE_STRING, 21, null, 162, 25);
            this.fmlBuffer[163] = new FmlField("P3", FmlField.TYPE_STRING, 21, null, 163, 25);
            this.fmlBuffer[164] = new FmlField("P4", FmlField.TYPE_STRING, 21, null, 164, 25);
            this.fmlBuffer[165] = new FmlField("P5", FmlField.TYPE_STRING, 21, null, 165, 25);
            this.fmlBuffer[166] = new FmlField("P6", FmlField.TYPE_STRING, 21, null, 166, 25);
            this.fmlBuffer[167] = new FmlField("P7", FmlField.TYPE_STRING, 21, null, 167, 25);
            this.fmlBuffer[168] = new FmlField("P8", FmlField.TYPE_STRING, 21, null, 168, 25);
            this.fmlBuffer[169] = new FmlField("P9", FmlField.TYPE_STRING, 21, null, 169, 25);
            this.fmlBuffer[170] = new FmlField("P10", FmlField.TYPE_STRING, 21, null, 170, 25);
            this.fmlBuffer[171] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 171, 25);
            this.fmlBuffer[172] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 172, 25);
            this.fmlBuffer[173] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 173, 25);
            this.fmlBuffer[174] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 174, 25);
            this.fmlBuffer[175] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 175, 25);
            this.fmlBuffer[176] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 176, 25);
            this.fmlBuffer[177] = new FmlField("PMKTPROGBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 177, 1);
            this.fmlBuffer[178] = new FmlField("MP_MODE", FmlField.TYPE_BYTE, -1, null, 178, 5);
            this.fmlBuffer[179] = new FmlField("SUB_MKTPR_ENT_NO", FmlField.TYPE_INTEGER, -1, null, 179, 5);
            this.fmlBuffer[180] = new FmlField("SUB_MKTPR_CODE", FmlField.TYPE_STRING, 7, null, 180, 5);
            this.fmlBuffer[181] = new FmlField("SUB_MKTPR_EFF_DATE", FmlField.TYPE_STRING, 9, null, 181, 5);
            this.fmlBuffer[182] = new FmlField("PTARCTNROWID", FmlField.TYPE_STRING, 19, null, 182, 1);
            this.fmlBuffer[183] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 183, 1);
            this.fmlBuffer[184] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 184, 1);
            this.fmlBuffer[185] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 185, 1);
            this.fmlBuffer[186] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 186, 1);
            this.fmlBuffer[187] = new FmlField("PTARCTNOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 187, 1);
            this.fmlBuffer[188] = new FmlField("PTARCTNAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 188, 1);
            this.fmlBuffer[189] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 189, 1);
            this.fmlBuffer[190] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 190, 1);
            this.fmlBuffer[191] = new FmlField("PTARCTNEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 191, 1);
            this.fmlBuffer[192] = new FmlField("INIT_ACTIVATION_DATE", FmlField.TYPE_STRING, 9, null, 192, 1);
            this.fmlBuffer[193] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 193, 1);
            this.fmlBuffer[194] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 194, 1);
            this.fmlBuffer[195] = new FmlField("ORIGINAL_INIT_DATE", FmlField.TYPE_STRING, 15, null, 195, 1);
            this.fmlBuffer[196] = new FmlField("SUB_STATUS_LAST_ACT", FmlField.TYPE_STRING, 4, null, 196, 1);
            this.fmlBuffer[197] = new FmlField("SUB_STATUS_RSN_CODE", FmlField.TYPE_STRING, 5, null, 197, 1);
            this.fmlBuffer[198] = new FmlField("PTARCTNPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 198, 1);
            this.fmlBuffer[199] = new FmlField("CUSTOMER_BAN", FmlField.TYPE_INTEGER, -1, null, 199, 1);
            this.fmlBuffer[200] = new FmlField("CTN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 200, 1);
            this.fmlBuffer[201] = new FmlField("REQ_ST_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 201, 1);
            this.fmlBuffer[202] = new FmlField("REQ_END_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 202, 1);
            this.fmlBuffer[203] = new FmlField("COMMIT_START_DATE", FmlField.TYPE_STRING, 9, null, 203, 1);
            this.fmlBuffer[204] = new FmlField("COMMIT_END_DATE", FmlField.TYPE_STRING, 9, null, 204, 1);
            this.fmlBuffer[205] = new FmlField("COMMIT_REASON_CODE", FmlField.TYPE_STRING, 4, null, 205, 1);
            this.fmlBuffer[206] = new FmlField("PTARCTNCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 206, 1);
            this.fmlBuffer[207] = new FmlField("PTARCTNSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 207, 1);
            this.fmlBuffer[208] = new FmlField("CONTRACT_NO", FmlField.TYPE_STRING, 11, null, 208, 1);
            this.fmlBuffer[209] = new FmlField("CNT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 209, 1);
            this.fmlBuffer[210] = new FmlField("PTARCTNDEALER_CODE", FmlField.TYPE_STRING, 6, null, 210, 1);
            this.fmlBuffer[211] = new FmlField("ORG_DEALER_CODE", FmlField.TYPE_STRING, 6, null, 211, 1);
            this.fmlBuffer[212] = new FmlField("PTARCTNSALES_AGENT", FmlField.TYPE_STRING, 6, null, 212, 1);
            this.fmlBuffer[213] = new FmlField("ORG_SALES_AGENT", FmlField.TYPE_STRING, 6, null, 213, 1);
            this.fmlBuffer[214] = new FmlField("REQ_DEPOSIT_AMT", FmlField.TYPE_DOUBLE, -1, null, 214, 1);
            this.fmlBuffer[215] = new FmlField("LEADING_NUMBER", FmlField.TYPE_STRING, 21, null, 215, 1);
            this.fmlBuffer[216] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, null, 216, 1);
            this.fmlBuffer[217] = new FmlField("NEXT_CTN", FmlField.TYPE_STRING, 21, null, 217, 1);
            this.fmlBuffer[218] = new FmlField("NEXT_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 218, 1);
            this.fmlBuffer[219] = new FmlField("PRV_CTN", FmlField.TYPE_STRING, 21, null, 219, 1);
            this.fmlBuffer[220] = new FmlField("PRV_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 220, 1);
            this.fmlBuffer[221] = new FmlField("NEXT_BAN", FmlField.TYPE_INTEGER, -1, null, 221, 1);
            this.fmlBuffer[222] = new FmlField("NEXT_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 222, 1);
            this.fmlBuffer[223] = new FmlField("PRV_BAN", FmlField.TYPE_INTEGER, -1, null, 223, 1);
            this.fmlBuffer[224] = new FmlField("PRV_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 224, 1);
            this.fmlBuffer[225] = new FmlField("SUB_STS_ISSUE_DATE", FmlField.TYPE_STRING, 9, null, 225, 1);
            this.fmlBuffer[226] = new FmlField("ACTIVATE_WAIVE_RSN", FmlField.TYPE_STRING, 7, null, 226, 1);
            this.fmlBuffer[227] = new FmlField("EARLIEST_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 227, 1);
            this.fmlBuffer[228] = new FmlField("SUB_ACTV_LOCATION", FmlField.TYPE_STRING, 5, null, 228, 1);
            this.fmlBuffer[229] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 229, 1);
            this.fmlBuffer[230] = new FmlField("CUST_WATCH_DATE", FmlField.TYPE_STRING, 9, null, 230, 1);
            this.fmlBuffer[231] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 231, 1);
            this.fmlBuffer[232] = new FmlField("CREDIT_WATCH_PIN_CD", FmlField.TYPE_SHORT, -1, null, 232, 1);
            this.fmlBuffer[233] = new FmlField("SUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 233, 1);
            this.fmlBuffer[234] = new FmlField("LIMIT_RESERVED_DAYS", FmlField.TYPE_SHORT, -1, null, 234, 1);
            this.fmlBuffer[235] = new FmlField("FF_EXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 235, 1);
            this.fmlBuffer[236] = new FmlField("FLEX_IND", FmlField.TYPE_BYTE, -1, null, 236, 1);
            this.fmlBuffer[237] = new FmlField("DUO_IND", FmlField.TYPE_BYTE, -1, null, 237, 1);
            this.fmlBuffer[238] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, null, 238, 1);
            this.fmlBuffer[239] = new FmlField("SUB_DEPARTMENT_CD", FmlField.TYPE_STRING, 5, null, 239, 1);
            this.fmlBuffer[240] = new FmlField("LAST_SUBS_DISC_DT", FmlField.TYPE_STRING, 9, null, 240, 1);
            this.fmlBuffer[241] = new FmlField("LAST_SUBS_DISC_DT_UD", FmlField.TYPE_STRING, 9, null, 241, 1);
            this.fmlBuffer[242] = new FmlField("LAST_SUBSCR_DISC_SN", FmlField.TYPE_SHORT, -1, null, 242, 1);
            this.fmlBuffer[243] = new FmlField("LAST_SUBSCR_DISC_SN_UD", FmlField.TYPE_SHORT, -1, null, 243, 1);
            this.fmlBuffer[244] = new FmlField("PNI", FmlField.TYPE_STRING, 11, null, 244, 1);
            this.fmlBuffer[245] = new FmlField("RMS_REF_STORE_ID", FmlField.TYPE_STRING, 5, null, 245, 1);
            this.fmlBuffer[246] = new FmlField("RMS_REF_TYPE", FmlField.TYPE_BYTE, -1, null, 246, 1);
            this.fmlBuffer[247] = new FmlField("RMS_REF_OD", FmlField.TYPE_INTEGER, -1, null, 247, 1);
            this.fmlBuffer[248] = new FmlField("DLR_ACT_FEE", FmlField.TYPE_DOUBLE, -1, null, 248, 1);
            this.fmlBuffer[249] = new FmlField("PREP_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 249, 1);
            this.fmlBuffer[250] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 250, 1);
            this.fmlBuffer[251] = new FmlField("SUB_LANG", FmlField.TYPE_STRING, 3, null, 251, 1);
            this.fmlBuffer[252] = new FmlField("SMS_RCV_STYLE_CODE", FmlField.TYPE_STRING, 3, null, 252, 1);
            this.fmlBuffer[253] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 253, 1);
            this.fmlBuffer[254] = new FmlField("ALLOW_ADVERTISING_IND", FmlField.TYPE_BYTE, -1, null, 254, 1);
            this.fmlBuffer[255] = new FmlField("IVR_WRONG_ACCESS_NO", FmlField.TYPE_SHORT, -1, null, 255, 1);
            this.fmlBuffer[256] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, NinjaConfigurationReferenceTable.getThresholdAmt(), 256, 1);
            this.fmlBuffer[257] = new FmlField("PUBLISH_LEVEL", FmlField.TYPE_STRING, 31, null, 257, 1);
            this.fmlBuffer[258] = new FmlField("AUTO_RELEASE_IND", FmlField.TYPE_BYTE, -1, null, 258, 1);
            this.fmlBuffer[259] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, null, 259, 1);
            this.fmlBuffer[260] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, null, 260, 1);
            this.fmlBuffer[261] = new FmlField("OPERATOR_CW_LMT", FmlField.TYPE_DOUBLE, -1, null, 261, 1);
            this.fmlBuffer[262] = new FmlField("SEND_SMS_FOR_MATCH", FmlField.TYPE_BYTE, -1, null, 262, 1);
            this.fmlBuffer[263] = new FmlField("CPS_STATUS", FmlField.TYPE_BYTE, -1, null, 263, 1);
            this.fmlBuffer[264] = new FmlField("CPS_TRANSACTION", FmlField.TYPE_SHORT, -1, null, 264, 1);
            this.fmlBuffer[265] = new FmlField("CPS_TYPE", FmlField.TYPE_SHORT, -1, null, 265, 1);
            this.fmlBuffer[266] = new FmlField("ISP_PASS", FmlField.TYPE_STRING, 31, null, 266, 1);
            this.fmlBuffer[267] = new FmlField("ISP_TYPE", FmlField.TYPE_STRING, 3, null, 267, 1);
            this.fmlBuffer[268] = new FmlField("OPERATOR_TMP_DATE", FmlField.TYPE_STRING, 9, null, 268, 1);
            this.fmlBuffer[269] = new FmlField("OPERATOR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, null, 269, 1);
            this.fmlBuffer[270] = new FmlField("SUB_ORG_CD", FmlField.TYPE_STRING, 11, null, 270, 1);
            this.fmlBuffer[271] = new FmlField("ORG_MEMBER_NO", FmlField.TYPE_STRING, 21, null, 271, 1);
            this.fmlBuffer[272] = new FmlField("FIXED_AS_GSM_IND", FmlField.TYPE_BYTE, -1, null, 272, 1);
            this.fmlBuffer[273] = new FmlField("EARLY_PORT_OUT", FmlField.TYPE_BYTE, -1, null, 273, 1);
            this.fmlBuffer[274] = new FmlField("EARLY_PO_WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 274, 1);
            this.fmlBuffer[275] = new FmlField("EARLY_PO_WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 275, 1);
            this.fmlBuffer[276] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 276, 1);
            this.fmlBuffer[277] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 277, 20);
            this.fmlBuffer[278] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 278, 20);
            this.fmlBuffer[279] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 279, 20);
            this.fmlBuffer[280] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 280, 20);
            this.fmlBuffer[281] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 281, 20);
            this.fmlBuffer[282] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 282, 20);
            this.fmlBuffer[283] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 283, 20);
            this.fmlBuffer[284] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 284, 20);
            this.fmlBuffer[285] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 285, 20);
            this.fmlBuffer[286] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 286, 20);
            this.fmlBuffer[287] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 287, 20);
            this.fmlBuffer[288] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 288, 20);
            this.fmlBuffer[289] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 289, 20);
            this.fmlBuffer[290] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 290, 20);
            this.fmlBuffer[291] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 291, 20);
            this.fmlBuffer[292] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 292, 20);
            this.fmlBuffer[293] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 293, 20);
            this.fmlBuffer[294] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 294, 20);
            this.fmlBuffer[295] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 295, 20);
            this.fmlBuffer[296] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 296, 20);
            this.fmlBuffer[297] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 297, 20);
            this.fmlBuffer[298] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 298, 20);
            this.fmlBuffer[299] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 299, 20);
            this.fmlBuffer[300] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 300, 20);
            this.fmlBuffer[301] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 301, 20);
            this.fmlBuffer[302] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 302, 20);
            this.fmlBuffer[303] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 303, 20);
            this.fmlBuffer[304] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 304, 20);
            this.fmlBuffer[305] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 305, 20);
            this.fmlBuffer[306] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 306, 20);
            this.fmlBuffer[307] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 307, 20);
            this.fmlBuffer[308] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 308, 20);
            this.fmlBuffer[309] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 309, 20);
            this.fmlBuffer[310] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 310, 20);
            this.fmlBuffer[311] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 311, 20);
            this.fmlBuffer[312] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 312, 20);
            this.fmlBuffer[313] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, null, 313, 20);
            this.fmlBuffer[314] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 314, 20);
            this.fmlBuffer[315] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 315, 20);
            this.fmlBuffer[316] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 316, 20);
            this.fmlBuffer[317] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 317, 20);
            this.fmlBuffer[318] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 318, 20);
            this.fmlBuffer[319] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 319, 20);
            this.fmlBuffer[320] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 320, 20);
            this.fmlBuffer[321] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 321, 20);
            this.fmlBuffer[322] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 322, 20);
            this.fmlBuffer[323] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 323, 20);
            this.fmlBuffer[324] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 324, 20);
            this.fmlBuffer[325] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 325, 20);
            this.fmlBuffer[326] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 326, 20);
            this.fmlBuffer[327] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 327, 20);
            this.fmlBuffer[328] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 328, 20);
            this.fmlBuffer[329] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 329, 20);
            this.fmlBuffer[330] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 330, 20);
            this.fmlBuffer[331] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 331, 20);
            this.fmlBuffer[332] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 332, 20);
            this.fmlBuffer[333] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 333, 20);
            this.fmlBuffer[334] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 334, 20);
            this.fmlBuffer[335] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 335, 20);
            this.fmlBuffer[336] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 336, 20);
            this.fmlBuffer[337] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 337, 20);
            this.fmlBuffer[338] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 338, 20);
            this.fmlBuffer[339] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 339, 20);
            this.fmlBuffer[340] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 340, 20);
            this.fmlBuffer[341] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 341, 20);
            this.fmlBuffer[342] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 342, 20);
            this.fmlBuffer[343] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 343, 20);
            this.fmlBuffer[344] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 344, 20);
            this.fmlBuffer[345] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 345, 20);
            this.fmlBuffer[346] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 346, 20);
            this.fmlBuffer[347] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 347, 20);
            this.fmlBuffer[348] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 348, 20);
            this.fmlBuffer[349] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 349, 20);
            this.fmlBuffer[350] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 350, 20);
            this.fmlBuffer[351] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 351, 20);
            this.fmlBuffer[352] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 352, 20);
            this.fmlBuffer[353] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 353, 20);
            this.fmlBuffer[354] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 354, 20);
            this.fmlBuffer[355] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 355, 20);
            this.fmlBuffer[356] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 356, 20);
            this.fmlBuffer[357] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 357, 20);
            this.fmlBuffer[358] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 358, 20);
            this.fmlBuffer[359] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 359, 20);
            this.fmlBuffer[360] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 360, 20);
            this.fmlBuffer[361] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 361, 20);
            this.fmlBuffer[362] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 362, 20);
            this.fmlBuffer[363] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 363, 20);
            this.fmlBuffer[364] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 364, 20);
            this.fmlBuffer[365] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 365, 20);
            this.fmlBuffer[366] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 366, 20);
            this.fmlBuffer[367] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 367, 20);
            this.fmlBuffer[368] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 368, 20);
            this.fmlBuffer[369] = new FmlField("SOURCE_BAN_LAST_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 369, 1);
            this.fmlBuffer[370] = new FmlField("SOURCE_BAN_LAST_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 370, 1);
            this.fmlBuffer[371] = new FmlField("PCNCLSRCEBANRECBAN", FmlField.TYPE_INTEGER, -1, null, 371, 1);
            this.fmlBuffer[372] = new FmlField("PCNCLSRCEBANRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 372, 1);
            this.fmlBuffer[373] = new FmlField("PCNCLSRCEBANRECACTIVITY_DATE", FmlField.TYPE_STRING, 9, null, 373, 1);
            this.fmlBuffer[374] = new FmlField("RESTORE_DATE", FmlField.TYPE_STRING, 9, null, 374, 1);
            this.fmlBuffer[375] = new FmlField("DEP_RETURN_METHOD", FmlField.TYPE_BYTE, -1, null, 375, 1);
            this.fmlBuffer[376] = new FmlField("NEW_BAN_STATUS", FmlField.TYPE_BYTE, -1, null, 376, 1);
            this.fmlBuffer[377] = new FmlField("EXP_CYCLE_CODE", FmlField.TYPE_SHORT, -1, null, 377, 1);
            this.fmlBuffer[378] = new FmlField("BAN_WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 378, 1);
            this.fmlBuffer[379] = new FmlField("BAN_WAIVE_RSN", FmlField.TYPE_STRING, 7, null, 379, 1);
            this.fmlBuffer[380] = new FmlField("WAIVER_UID", FmlField.TYPE_STRING, 9, null, 380, 1);
            this.fmlBuffer[381] = new FmlField("HOLD_COLL_TREATMENT", FmlField.TYPE_BYTE, -1, null, 381, 1);
            this.fmlBuffer[382] = new FmlField("PCTNCNCLBUFROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 382, 1);
            this.fmlBuffer[383] = new FmlField("CTN", FmlField.TYPE_STRING, 21, null, 383, 100);
            this.fmlBuffer[384] = new FmlField("PCTNCNCLBUFSUB_STATUS", FmlField.TYPE_BYTE, -1, null, 384, 100);
            this.fmlBuffer[385] = new FmlField("COMM_START_DATE", FmlField.TYPE_STRING, 9, null, 385, 100);
            this.fmlBuffer[386] = new FmlField("COMM_END_DATE", FmlField.TYPE_STRING, 9, null, 386, 100);
            this.fmlBuffer[387] = new FmlField("REMAINING_MONTHS", FmlField.TYPE_SHORT, -1, null, 387, 100);
            this.fmlBuffer[388] = new FmlField("DEPOSIT", FmlField.TYPE_DOUBLE, -1, null, 388, 100);
            this.fmlBuffer[389] = new FmlField("DEPOSIT_INTEREST", FmlField.TYPE_DOUBLE, -1, null, 389, 100);
            this.fmlBuffer[390] = new FmlField("PENALTY", FmlField.TYPE_DOUBLE, -1, null, 390, 100);
            this.fmlBuffer[391] = new FmlField("WAIVE_INDICATOR", FmlField.TYPE_BYTE, -1, null, 391, 100);
            this.fmlBuffer[392] = new FmlField("PCTNCNCLBUFWAIVE_REASON", FmlField.TYPE_STRING, 7, null, 392, 100);
            this.fmlBuffer[393] = new FmlField("ACTIVITY_CTN_FEE", FmlField.TYPE_DOUBLE, -1, null, 393, 1);
            this.fmlBuffer[394] = new FmlField("NUMBER_LOCATION", FmlField.TYPE_STRING, 4, null, 394, 1);
            this.fmlBuffer[395] = new FmlField("DEPOSITTERMSIND", FmlField.TYPE_BYTE, -1, null, 395, 1);
            this.fmlBuffer[396] = new FmlField("WAIVING_IND", FmlField.TYPE_BYTE, -1, null, 396, 1);
            this.fmlBuffer[397] = new FmlField("WAIVING_REASON_CODE", FmlField.TYPE_STRING, 5, null, 397, 1);
            this.fmlBuffer[398] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 398, 1);
            this.fmlBuffer[399] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 399, 2);
            this.fmlBuffer[400] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 400, 2);
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            fmlBuffer = new FmlField[399];
    
            //// Get default values from DB
            //synchronized (this.defaultValuesPopulated) {
            //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
            //        defaultValues = getDefaultValues("csMoveCtn", 399);
            //        this.defaultValuesPopulated = Boolean.TRUE;
            //    }
            //}
            ...
            this.fmlBuffer[40] = new FmlField("SOC_START_RC_DATE", FmlField.TYPE_STRING, 9, null, 40, 50);
            this.fmlBuffer[41] = new FmlField("RC_DATE_COPY_IND", FmlField.TYPE_BYTE, -1, null, 41, 50);
            this.fmlBuffer[42] = new FmlField("PAGRRECROWID", FmlField.TYPE_STRING, 19, null, 42, 1);
            this.fmlBuffer[43] = new FmlField("PAGRRECSOC", FmlField.TYPE_STRING, 10, null, 43, 1);
            this.fmlBuffer[44] = new FmlField("PAGRRECSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 44, 1);
            this.fmlBuffer[45] = new FmlField("PAGRRECCOMMITMENT_END_DATE", FmlField.TYPE_STRING, 9, null, 45, 1);
            this.fmlBuffer[46] = new FmlField("PAGRRECSERVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 46, 1);
            this.fmlBuffer[47] = new FmlField("PAGRRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 47, 1);
            this.fmlBuffer[48] = new FmlField("PAGRRECEXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 48, 1);
            this.fmlBuffer[49] = new FmlField("PAGRRECSOC_LEVEL_CODE", FmlField.TYPE_BYTE, -1, null, 49, 1);
            this.fmlBuffer[50] = new FmlField("PAGRRECDEALER_CODE", FmlField.TYPE_STRING, 6, null, 50, 1);
            this.fmlBuffer[51] = new FmlField("PAGRRECSALES_AGENT", FmlField.TYPE_STRING, 6, null, 51, 1);
            this.fmlBuffer[52] = new FmlField("PAGRRECSRV_MODE", FmlField.TYPE_BYTE, -1, null, 52, 1);
            this.fmlBuffer[53] = new FmlField("PAGRRECSRV_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 53, 1);
            this.fmlBuffer[54] = new FmlField("PAGRRECSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 54, 1);
            this.fmlBuffer[55] = new FmlField("PAGRRECSRV_TRX_ID", FmlField.TYPE_INTEGER, -1, null, 55, 1);
            this.fmlBuffer[56] = new FmlField("PAGRRECCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 56, 1);
            this.fmlBuffer[57] = new FmlField("PAGRRECCAMPAIGN", FmlField.TYPE_STRING, 10, null, 57, 1);
            this.fmlBuffer[58] = new FmlField("PAGRRECCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 58, 1);
            this.fmlBuffer[59] = new FmlField("PAGRRECPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 59, 1);
            this.fmlBuffer[60] = new FmlField("PAGRRECLOAN_VER_NO", FmlField.TYPE_INTEGER, -1, null, 60, 1);
            this.fmlBuffer[61] = new FmlField("PAGRRECLOAN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 61, 1);
            this.fmlBuffer[62] = new FmlField("PAGRRECSOC_ACTV_FEE", FmlField.TYPE_DOUBLE, -1, null, 62, 1);
            this.fmlBuffer[63] = new FmlField("PAGRRECPROMOTIONAL_SOC", FmlField.TYPE_STRING, 10, null, 63, 1);
            this.fmlBuffer[64] = new FmlField("PAGRRECREASON_CODE", FmlField.TYPE_STRING, 5, null, 64, 1);
            this.fmlBuffer[65] = new FmlField("PAGRRECSOC_START_RC_DATE", FmlField.TYPE_STRING, 9, null, 65, 1);
            this.fmlBuffer[66] = new FmlField("PAGRRECRC_DATE_COPY_IND", FmlField.TYPE_BYTE, -1, null, 66, 1);
            this.fmlBuffer[67] = new FmlField("PSOCFTRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 67, 1);
            this.fmlBuffer[68] = new FmlField("PSOCFTRBUFROWID", FmlField.TYPE_STRING, 19, null, 68, 200);
            this.fmlBuffer[69] = new FmlField("PSOCFTRBUFSOC", FmlField.TYPE_STRING, 10, null, 69, 200);
            this.fmlBuffer[70] = new FmlField("PSOCFTRBUFSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 70, 200);
            this.fmlBuffer[71] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 71, 200);
            this.fmlBuffer[72] = new FmlField("MPS_FTR_CODE", FmlField.TYPE_STRING, 7, null, 72, 200);
            this.fmlBuffer[73] = new FmlField("FTR_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 73, 200);
            this.fmlBuffer[74] = new FmlField("FTR_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 74, 200);
            this.fmlBuffer[75] = new FmlField("FTR_EFF_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 75, 200);
            this.fmlBuffer[76] = new FmlField("FTR_EXP_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 76, 200);
            this.fmlBuffer[77] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 77, 200);
            this.fmlBuffer[78] = new FmlField("FTR_MODE", FmlField.TYPE_BYTE, -1, null, 78, 200);
            this.fmlBuffer[79] = new FmlField("PSOCFTRBUFSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 79, 200);
            this.fmlBuffer[80] = new FmlField("FTR_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 80, 200);
            this.fmlBuffer[81] = new FmlField("FTR_ADD_PARAM", FmlField.TYPE_STRING, 301, null, 81, 200);
            this.fmlBuffer[82] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, null, 82, 200);
            this.fmlBuffer[83] = new FmlField("PSOCFTRBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 83, 200);
            this.fmlBuffer[84] = new FmlField("PSOCFTRBUFCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 84, 200);
            this.fmlBuffer[85] = new FmlField("FTR_SPECIAL_TELNO", FmlField.TYPE_STRING, 21, null, 85, 200);
            this.fmlBuffer[86] = new FmlField("SWITCH_ACT_NEEDED", FmlField.TYPE_BYTE, -1, null, 86, 200);
            this.fmlBuffer[87] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, null, 87, 200);
            this.fmlBuffer[88] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, null, 88, 200);
            this.fmlBuffer[89] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 89, 200);
            this.fmlBuffer[90] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, null, 90, 200);
            this.fmlBuffer[91] = new FmlField("MANUAL_RC_RATE", FmlField.TYPE_DOUBLE, -1, null, 91, 200);
            this.fmlBuffer[92] = new FmlField("MANUAL_RC_EXP_DATE", FmlField.TYPE_STRING, 9, null, 92, 200);
            this.fmlBuffer[93] = new FmlField("PCSFRNDFMLROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 93, 1);
            this.fmlBuffer[94] = new FmlField("ACTIONIND", FmlField.TYPE_BYTE, -1, null, 94, 10000);
            this.fmlBuffer[95] = new FmlField("PCSFANDFRECROWID", FmlField.TYPE_STRING, 19, null, 95, 10000);
            this.fmlBuffer[96] = new FmlField("PCSFANDFRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 96, 10000);
            this.fmlBuffer[97] = new FmlField("PCSFANDFRECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 97, 10000);
            this.fmlBuffer[98] = new FmlField("PERSONAL_TEL", FmlField.TYPE_STRING, 21, null, 98, 10000);
            this.fmlBuffer[99] = new FmlField("PERSONAL_TEL_TO", FmlField.TYPE_STRING, 21, null, 99, 10000);
            this.fmlBuffer[100] = new FmlField("FF_SOC", FmlField.TYPE_STRING, 10, null, 100, 10000);
            this.fmlBuffer[101] = new FmlField("PLAN_CODE", FmlField.TYPE_STRING, 10, null, 101, 10000);
            this.fmlBuffer[102] = new FmlField("DISCOUNT_TYPE", FmlField.TYPE_BYTE, -1, null, 102, 10000);
            this.fmlBuffer[103] = new FmlField("START_HOUR", FmlField.TYPE_STRING, 7, null, 103, 10000);
            this.fmlBuffer[104] = new FmlField("DURATION", FmlField.TYPE_DOUBLE, -1, null, 104, 10000);
            this.fmlBuffer[105] = new FmlField("PESNBUFFERROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 105, 1);
            this.fmlBuffer[106] = new FmlField("EQUIPMENT_NO", FmlField.TYPE_STRING, 21, null, 106, 50);
            this.fmlBuffer[107] = new FmlField("PHD_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 107, 50);
            this.fmlBuffer[108] = new FmlField("EQUIPMENT_LEVEL", FmlField.TYPE_SHORT, -1, null, 108, 50);
            this.fmlBuffer[109] = new FmlField("IMSI", FmlField.TYPE_STRING, 16, null, 109, 50);
            this.fmlBuffer[110] = new FmlField("PHYDEVARRAYEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 110, 50);
            this.fmlBuffer[111] = new FmlField("PHYDEVARRAYEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 111, 50);
            this.fmlBuffer[112] = new FmlField("OWNERSHIP_CODE", FmlField.TYPE_STRING, 3, null, 112, 50);
            this.fmlBuffer[113] = new FmlField("SW_STATE_IND", FmlField.TYPE_BYTE, -1, null, 113, 50);
            this.fmlBuffer[114] = new FmlField("LAST_SW_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 114, 50);
            this.fmlBuffer[115] = new FmlField("NEXT_ACTV_CODE", FmlField.TYPE_BYTE, -1, null, 115, 50);
            this.fmlBuffer[116] = new FmlField("NEXT_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 116, 50);
            this.fmlBuffer[117] = new FmlField("NEXT_ACTV_ISSUE_DT", FmlField.TYPE_STRING, 9, null, 117, 50);
            this.fmlBuffer[118] = new FmlField("DEVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 118, 50);
            this.fmlBuffer[119] = new FmlField("ESN_MODE", FmlField.TYPE_BYTE, -1, null, 119, 50);
            this.fmlBuffer[120] = new FmlField("ITEM_ID", FmlField.TYPE_STRING, 16, null, 120, 50);
            this.fmlBuffer[121] = new FmlField("POOL", FmlField.TYPE_STRING, 3, null, 121, 50);
            this.fmlBuffer[122] = new FmlField("LOCATION_ID", FmlField.TYPE_STRING, 5, null, 122, 50);
            this.fmlBuffer[123] = new FmlField("ACTIVITY_CODE", FmlField.TYPE_STRING, 5, null, 123, 50);
            this.fmlBuffer[124] = new FmlField("ACTIVITY_DATE", FmlField.TYPE_STRING, 15, null, 124, 50);
            this.fmlBuffer[125] = new FmlField("OPERATION_STATUS", FmlField.TYPE_BYTE, -1, null, 125, 50);
            this.fmlBuffer[126] = new FmlField("ITEM_OWNERSHIP", FmlField.TYPE_BYTE, -1, null, 126, 50);
            this.fmlBuffer[127] = new FmlField("ITEM_OWNERSHIP_DT", FmlField.TYPE_STRING, 15, null, 127, 50);
            this.fmlBuffer[128] = new FmlField("CURR_POSSESSION", FmlField.TYPE_BYTE, -1, null, 128, 50);
            this.fmlBuffer[129] = new FmlField("CURR_POSSESSION_DT", FmlField.TYPE_STRING, 15, null, 129, 50);
            this.fmlBuffer[130] = new FmlField("MISSING_IND", FmlField.TYPE_BYTE, -1, null, 130, 50);
            this.fmlBuffer[131] = new FmlField("IN_REPAIR_IND", FmlField.TYPE_BYTE, -1, null, 131, 50);
            this.fmlBuffer[132] = new FmlField("IN_TRANSIT_IND", FmlField.TYPE_BYTE, -1, null, 132, 50);
            this.fmlBuffer[133] = new FmlField("COMITED_TO_POS_IND", FmlField.TYPE_BYTE, -1, null, 133, 50);
            this.fmlBuffer[134] = new FmlField("COMITED_DATE", FmlField.TYPE_STRING, 15, null, 134, 50);
            this.fmlBuffer[135] = new FmlField("ACTIVITY_REASON", FmlField.TYPE_STRING, 4, null, 135, 50);
            this.fmlBuffer[136] = new FmlField("UPGRADE_IND", FmlField.TYPE_BYTE, -1, null, 136, 50);
            this.fmlBuffer[137] = new FmlField("EXPECTED_RTRN_DATE", FmlField.TYPE_STRING, 15, null, 137, 50);
            this.fmlBuffer[138] = new FmlField("POLICE_REPORT_NO", FmlField.TYPE_STRING, 16, null, 138, 50);
            this.fmlBuffer[139] = new FmlField("POLICE_REPORT_DATE", FmlField.TYPE_STRING, 15, null, 139, 50);
            this.fmlBuffer[140] = new FmlField("POLICE_STATION", FmlField.TYPE_STRING, 31, null, 140, 50);
            this.fmlBuffer[141] = new FmlField("PUK", FmlField.TYPE_INTEGER, -1, null, 141, 50);
            this.fmlBuffer[142] = new FmlField("PUK2", FmlField.TYPE_INTEGER, -1, null, 142, 50);
            this.fmlBuffer[143] = new FmlField("FIRST_USED_DATE", FmlField.TYPE_STRING, 15, null, 143, 50);
            this.fmlBuffer[144] = new FmlField("SIM_STATUS", FmlField.TYPE_BYTE, -1, null, 144, 50);
            this.fmlBuffer[145] = new FmlField("SUSPEND_IND", FmlField.TYPE_BYTE, -1, null, 145, 50);
            this.fmlBuffer[146] = new FmlField("SUSPEND_DATE", FmlField.TYPE_STRING, 15, null, 146, 50);
            this.fmlBuffer[147] = new FmlField("SENT_TO_AUC_IND", FmlField.TYPE_BYTE, -1, null, 147, 50);
            this.fmlBuffer[148] = new FmlField("HLR_CD", FmlField.TYPE_STRING, 4, null, 148, 50);
            this.fmlBuffer[149] = new FmlField("K4ID", FmlField.TYPE_STRING, 41, null, 149, 50);
            this.fmlBuffer[150] = new FmlField("PHYDEVARRAYDEALER_CODE", FmlField.TYPE_STRING, 6, null, 150, 50);
            this.fmlBuffer[151] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 151, 1);
            this.fmlBuffer[152] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 152, 25);
            this.fmlBuffer[153] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 153, 25);
            this.fmlBuffer[154] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 154, 25);
            this.fmlBuffer[155] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 155, 25);
            this.fmlBuffer[156] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 156, 25);
            this.fmlBuffer[157] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 157, 25);
            this.fmlBuffer[158] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 158, 25);
            this.fmlBuffer[159] = new FmlField("P1", FmlField.TYPE_STRING, 21, null, 159, 25);
            this.fmlBuffer[160] = new FmlField("P2", FmlField.TYPE_STRING, 21, null, 160, 25);
            this.fmlBuffer[161] = new FmlField("P3", FmlField.TYPE_STRING, 21, null, 161, 25);
            this.fmlBuffer[162] = new FmlField("P4", FmlField.TYPE_STRING, 21, null, 162, 25);
            this.fmlBuffer[163] = new FmlField("P5", FmlField.TYPE_STRING, 21, null, 163, 25);
            this.fmlBuffer[164] = new FmlField("P6", FmlField.TYPE_STRING, 21, null, 164, 25);
            this.fmlBuffer[165] = new FmlField("P7", FmlField.TYPE_STRING, 21, null, 165, 25);
            this.fmlBuffer[166] = new FmlField("P8", FmlField.TYPE_STRING, 21, null, 166, 25);
            this.fmlBuffer[167] = new FmlField("P9", FmlField.TYPE_STRING, 21, null, 167, 25);
            this.fmlBuffer[168] = new FmlField("P10", FmlField.TYPE_STRING, 21, null, 168, 25);
            this.fmlBuffer[169] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 169, 25);
            this.fmlBuffer[170] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 170, 25);
            this.fmlBuffer[171] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 171, 25);
            this.fmlBuffer[172] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 172, 25);
            this.fmlBuffer[173] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 173, 25);
            this.fmlBuffer[174] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 174, 25);
            this.fmlBuffer[175] = new FmlField("PMKTPROGBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 175, 1);
            this.fmlBuffer[176] = new FmlField("MP_MODE", FmlField.TYPE_BYTE, -1, null, 176, 5);
            this.fmlBuffer[177] = new FmlField("SUB_MKTPR_ENT_NO", FmlField.TYPE_INTEGER, -1, null, 177, 5);
            this.fmlBuffer[178] = new FmlField("SUB_MKTPR_CODE", FmlField.TYPE_STRING, 7, null, 178, 5);
            this.fmlBuffer[179] = new FmlField("SUB_MKTPR_EFF_DATE", FmlField.TYPE_STRING, 9, null, 179, 5);
            this.fmlBuffer[180] = new FmlField("PTARCTNROWID", FmlField.TYPE_STRING, 19, null, 180, 1);
            this.fmlBuffer[181] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 181, 1);
            this.fmlBuffer[182] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 182, 1);
            this.fmlBuffer[183] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 183, 1);
            this.fmlBuffer[184] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 184, 1);
            this.fmlBuffer[185] = new FmlField("PTARCTNOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 185, 1);
            this.fmlBuffer[186] = new FmlField("PTARCTNAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 186, 1);
            this.fmlBuffer[187] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 187, 1);
            this.fmlBuffer[188] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 188, 1);
            this.fmlBuffer[189] = new FmlField("PTARCTNEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 189, 1);
            this.fmlBuffer[190] = new FmlField("INIT_ACTIVATION_DATE", FmlField.TYPE_STRING, 9, null, 190, 1);
            this.fmlBuffer[191] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 191, 1);
            this.fmlBuffer[192] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 192, 1);
            this.fmlBuffer[193] = new FmlField("ORIGINAL_INIT_DATE", FmlField.TYPE_STRING, 15, null, 193, 1);
            this.fmlBuffer[194] = new FmlField("SUB_STATUS_LAST_ACT", FmlField.TYPE_STRING, 4, null, 194, 1);
            this.fmlBuffer[195] = new FmlField("SUB_STATUS_RSN_CODE", FmlField.TYPE_STRING, 5, null, 195, 1);
            this.fmlBuffer[196] = new FmlField("PTARCTNPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 196, 1);
            this.fmlBuffer[197] = new FmlField("CUSTOMER_BAN", FmlField.TYPE_INTEGER, -1, null, 197, 1);
            this.fmlBuffer[198] = new FmlField("CTN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 198, 1);
            this.fmlBuffer[199] = new FmlField("REQ_ST_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 199, 1);
            this.fmlBuffer[200] = new FmlField("REQ_END_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 200, 1);
            this.fmlBuffer[201] = new FmlField("COMMIT_START_DATE", FmlField.TYPE_STRING, 9, null, 201, 1);
            this.fmlBuffer[202] = new FmlField("COMMIT_END_DATE", FmlField.TYPE_STRING, 9, null, 202, 1);
            this.fmlBuffer[203] = new FmlField("COMMIT_REASON_CODE", FmlField.TYPE_STRING, 4, null, 203, 1);
            this.fmlBuffer[204] = new FmlField("PTARCTNCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 204, 1);
            this.fmlBuffer[205] = new FmlField("PTARCTNSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 205, 1);
            this.fmlBuffer[206] = new FmlField("CONTRACT_NO", FmlField.TYPE_STRING, 11, null, 206, 1);
            this.fmlBuffer[207] = new FmlField("CNT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 207, 1);
            this.fmlBuffer[208] = new FmlField("PTARCTNDEALER_CODE", FmlField.TYPE_STRING, 6, null, 208, 1);
            this.fmlBuffer[209] = new FmlField("ORG_DEALER_CODE", FmlField.TYPE_STRING, 6, null, 209, 1);
            this.fmlBuffer[210] = new FmlField("PTARCTNSALES_AGENT", FmlField.TYPE_STRING, 6, null, 210, 1);
            this.fmlBuffer[211] = new FmlField("ORG_SALES_AGENT", FmlField.TYPE_STRING, 6, null, 211, 1);
            this.fmlBuffer[212] = new FmlField("REQ_DEPOSIT_AMT", FmlField.TYPE_DOUBLE, -1, null, 212, 1);
            this.fmlBuffer[213] = new FmlField("LEADING_NUMBER", FmlField.TYPE_STRING, 21, null, 213, 1);
            this.fmlBuffer[214] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, null, 214, 1);
            this.fmlBuffer[215] = new FmlField("NEXT_CTN", FmlField.TYPE_STRING, 21, null, 215, 1);
            this.fmlBuffer[216] = new FmlField("NEXT_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 216, 1);
            this.fmlBuffer[217] = new FmlField("PRV_CTN", FmlField.TYPE_STRING, 21, null, 217, 1);
            this.fmlBuffer[218] = new FmlField("PRV_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 218, 1);
            this.fmlBuffer[219] = new FmlField("NEXT_BAN", FmlField.TYPE_INTEGER, -1, null, 219, 1);
            this.fmlBuffer[220] = new FmlField("NEXT_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 220, 1);
            this.fmlBuffer[221] = new FmlField("PRV_BAN", FmlField.TYPE_INTEGER, -1, null, 221, 1);
            this.fmlBuffer[222] = new FmlField("PRV_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 222, 1);
            this.fmlBuffer[223] = new FmlField("SUB_STS_ISSUE_DATE", FmlField.TYPE_STRING, 9, null, 223, 1);
            this.fmlBuffer[224] = new FmlField("ACTIVATE_WAIVE_RSN", FmlField.TYPE_STRING, 7, null, 224, 1);
            this.fmlBuffer[225] = new FmlField("EARLIEST_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 225, 1);
            this.fmlBuffer[226] = new FmlField("SUB_ACTV_LOCATION", FmlField.TYPE_STRING, 5, null, 226, 1);
            this.fmlBuffer[227] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 227, 1);
            this.fmlBuffer[228] = new FmlField("CUST_WATCH_DATE", FmlField.TYPE_STRING, 9, null, 228, 1);
            this.fmlBuffer[229] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 229, 1);
            this.fmlBuffer[230] = new FmlField("CREDIT_WATCH_PIN_CD", FmlField.TYPE_SHORT, -1, null, 230, 1);
            this.fmlBuffer[231] = new FmlField("SUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 231, 1);
            this.fmlBuffer[232] = new FmlField("LIMIT_RESERVED_DAYS", FmlField.TYPE_SHORT, -1, null, 232, 1);
            this.fmlBuffer[233] = new FmlField("FF_EXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 233, 1);
            this.fmlBuffer[234] = new FmlField("FLEX_IND", FmlField.TYPE_BYTE, -1, null, 234, 1);
            this.fmlBuffer[235] = new FmlField("DUO_IND", FmlField.TYPE_BYTE, -1, null, 235, 1);
            this.fmlBuffer[236] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, null, 236, 1);
            this.fmlBuffer[237] = new FmlField("SUB_DEPARTMENT_CD", FmlField.TYPE_STRING, 5, null, 237, 1);
            this.fmlBuffer[238] = new FmlField("LAST_SUBS_DISC_DT", FmlField.TYPE_STRING, 9, null, 238, 1);
            this.fmlBuffer[239] = new FmlField("LAST_SUBS_DISC_DT_UD", FmlField.TYPE_STRING, 9, null, 239, 1);
            this.fmlBuffer[240] = new FmlField("LAST_SUBSCR_DISC_SN", FmlField.TYPE_SHORT, -1, null, 240, 1);
            this.fmlBuffer[241] = new FmlField("LAST_SUBSCR_DISC_SN_UD", FmlField.TYPE_SHORT, -1, null, 241, 1);
            this.fmlBuffer[242] = new FmlField("PNI", FmlField.TYPE_STRING, 11, null, 242, 1);
            this.fmlBuffer[243] = new FmlField("RMS_REF_STORE_ID", FmlField.TYPE_STRING, 5, null, 243, 1);
            this.fmlBuffer[244] = new FmlField("RMS_REF_TYPE", FmlField.TYPE_BYTE, -1, null, 244, 1);
            this.fmlBuffer[245] = new FmlField("RMS_REF_OD", FmlField.TYPE_INTEGER, -1, null, 245, 1);
            this.fmlBuffer[246] = new FmlField("DLR_ACT_FEE", FmlField.TYPE_DOUBLE, -1, null, 246, 1);
            this.fmlBuffer[247] = new FmlField("PREP_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 247, 1);
            this.fmlBuffer[248] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 248, 1);
            this.fmlBuffer[249] = new FmlField("SUB_LANG", FmlField.TYPE_STRING, 3, null, 249, 1);
            this.fmlBuffer[250] = new FmlField("SMS_RCV_STYLE_CODE", FmlField.TYPE_STRING, 3, null, 250, 1);
            this.fmlBuffer[251] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 251, 1);
            this.fmlBuffer[252] = new FmlField("ALLOW_ADVERTISING_IND", FmlField.TYPE_BYTE, -1, null, 252, 1);
            this.fmlBuffer[253] = new FmlField("IVR_WRONG_ACCESS_NO", FmlField.TYPE_SHORT, -1, null, 253, 1);
            this.fmlBuffer[254] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, NinjaConfigurationReferenceTable.getThresholdAmt(), 254, 1);
            this.fmlBuffer[255] = new FmlField("PUBLISH_LEVEL", FmlField.TYPE_STRING, 31, null, 255, 1);
            this.fmlBuffer[256] = new FmlField("AUTO_RELEASE_IND", FmlField.TYPE_BYTE, -1, null, 256, 1);
            this.fmlBuffer[257] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, null, 257, 1);
            this.fmlBuffer[258] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, null, 258, 1);
            this.fmlBuffer[259] = new FmlField("OPERATOR_CW_LMT", FmlField.TYPE_DOUBLE, -1, null, 259, 1);
            this.fmlBuffer[260] = new FmlField("SEND_SMS_FOR_MATCH", FmlField.TYPE_BYTE, -1, null, 260, 1);
            this.fmlBuffer[261] = new FmlField("CPS_STATUS", FmlField.TYPE_BYTE, -1, null, 261, 1);
            this.fmlBuffer[262] = new FmlField("CPS_TRANSACTION", FmlField.TYPE_SHORT, -1, null, 262, 1);
            this.fmlBuffer[263] = new FmlField("CPS_TYPE", FmlField.TYPE_SHORT, -1, null, 263, 1);
            this.fmlBuffer[264] = new FmlField("ISP_PASS", FmlField.TYPE_STRING, 31, null, 264, 1);
            this.fmlBuffer[265] = new FmlField("ISP_TYPE", FmlField.TYPE_STRING, 3, null, 265, 1);
            this.fmlBuffer[266] = new FmlField("OPERATOR_TMP_DATE", FmlField.TYPE_STRING, 9, null, 266, 1);
            this.fmlBuffer[267] = new FmlField("OPERATOR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, null, 267, 1);
            this.fmlBuffer[268] = new FmlField("SUB_ORG_CD", FmlField.TYPE_STRING, 11, null, 268, 1);
            this.fmlBuffer[269] = new FmlField("ORG_MEMBER_NO", FmlField.TYPE_STRING, 21, null, 269, 1);
            this.fmlBuffer[270] = new FmlField("FIXED_AS_GSM_IND", FmlField.TYPE_BYTE, -1, null, 270, 1);
            this.fmlBuffer[271] = new FmlField("EARLY_PORT_OUT", FmlField.TYPE_BYTE, -1, null, 271, 1);
            this.fmlBuffer[272] = new FmlField("EARLY_PO_WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 272, 1);
            this.fmlBuffer[273] = new FmlField("EARLY_PO_WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 273, 1);
            this.fmlBuffer[274] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 274, 1);
            this.fmlBuffer[275] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 275, 20);
            this.fmlBuffer[276] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 276, 20);
            this.fmlBuffer[277] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 277, 20);
            this.fmlBuffer[278] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 278, 20);
            this.fmlBuffer[279] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 279, 20);
            this.fmlBuffer[280] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 280, 20);
            this.fmlBuffer[281] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 281, 20);
            this.fmlBuffer[282] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 282, 20);
            this.fmlBuffer[283] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 283, 20);
            this.fmlBuffer[284] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 284, 20);
            this.fmlBuffer[285] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 285, 20);
            this.fmlBuffer[286] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 286, 20);
            this.fmlBuffer[287] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 287, 20);
            this.fmlBuffer[288] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 288, 20);
            this.fmlBuffer[289] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 289, 20);
            this.fmlBuffer[290] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 290, 20);
            this.fmlBuffer[291] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 291, 20);
            this.fmlBuffer[292] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 292, 20);
            this.fmlBuffer[293] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 293, 20);
            this.fmlBuffer[294] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 294, 20);
            this.fmlBuffer[295] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 295, 20);
            this.fmlBuffer[296] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 296, 20);
            this.fmlBuffer[297] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 297, 20);
            this.fmlBuffer[298] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 298, 20);
            this.fmlBuffer[299] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 299, 20);
            this.fmlBuffer[300] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 300, 20);
            this.fmlBuffer[301] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 301, 20);
            this.fmlBuffer[302] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 302, 20);
            this.fmlBuffer[303] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 303, 20);
            this.fmlBuffer[304] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 304, 20);
            this.fmlBuffer[305] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 305, 20);
            this.fmlBuffer[306] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 306, 20);
            this.fmlBuffer[307] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 307, 20);
            this.fmlBuffer[308] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 308, 20);
            this.fmlBuffer[309] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 309, 20);
            this.fmlBuffer[310] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 310, 20);
            this.fmlBuffer[311] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, null, 311, 20);
            this.fmlBuffer[312] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 312, 20);
            this.fmlBuffer[313] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 313, 20);
            this.fmlBuffer[314] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 314, 20);
            this.fmlBuffer[315] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 315, 20);
            this.fmlBuffer[316] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 316, 20);
            this.fmlBuffer[317] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 317, 20);
            this.fmlBuffer[318] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 318, 20);
            this.fmlBuffer[319] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 319, 20);
            this.fmlBuffer[320] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 320, 20);
            this.fmlBuffer[321] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 321, 20);
            this.fmlBuffer[322] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 322, 20);
            this.fmlBuffer[323] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 323, 20);
            this.fmlBuffer[324] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 324, 20);
            this.fmlBuffer[325] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 325, 20);
            this.fmlBuffer[326] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 326, 20);
            this.fmlBuffer[327] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 327, 20);
            this.fmlBuffer[328] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 328, 20);
            this.fmlBuffer[329] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 329, 20);
            this.fmlBuffer[330] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 330, 20);
            this.fmlBuffer[331] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 331, 20);
            this.fmlBuffer[332] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 332, 20);
            this.fmlBuffer[333] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 333, 20);
            this.fmlBuffer[334] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 334, 20);
            this.fmlBuffer[335] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 335, 20);
            this.fmlBuffer[336] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 336, 20);
            this.fmlBuffer[337] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 337, 20);
            this.fmlBuffer[338] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 338, 20);
            this.fmlBuffer[339] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 339, 20);
            this.fmlBuffer[340] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 340, 20);
            this.fmlBuffer[341] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 341, 20);
            this.fmlBuffer[342] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 342, 20);
            this.fmlBuffer[343] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 343, 20);
            this.fmlBuffer[344] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 344, 20);
            this.fmlBuffer[345] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 345, 20);
            this.fmlBuffer[346] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 346, 20);
            this.fmlBuffer[347] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 347, 20);
            this.fmlBuffer[348] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 348, 20);
            this.fmlBuffer[349] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 349, 20);
            this.fmlBuffer[350] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 350, 20);
            this.fmlBuffer[351] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 351, 20);
            this.fmlBuffer[352] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 352, 20);
            this.fmlBuffer[353] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 353, 20);
            this.fmlBuffer[354] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 354, 20);
            this.fmlBuffer[355] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 355, 20);
            this.fmlBuffer[356] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 356, 20);
            this.fmlBuffer[357] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 357, 20);
            this.fmlBuffer[358] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 358, 20);
            this.fmlBuffer[359] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 359, 20);
            this.fmlBuffer[360] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 360, 20);
            this.fmlBuffer[361] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 361, 20);
            this.fmlBuffer[362] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 362, 20);
            this.fmlBuffer[363] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 363, 20);
            this.fmlBuffer[364] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 364, 20);
            this.fmlBuffer[365] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 365, 20);
            this.fmlBuffer[366] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 366, 20);
            this.fmlBuffer[367] = new FmlField("SOURCE_BAN_LAST_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 367, 1);
            this.fmlBuffer[368] = new FmlField("SOURCE_BAN_LAST_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 368, 1);
            this.fmlBuffer[369] = new FmlField("PCNCLSRCEBANRECBAN", FmlField.TYPE_INTEGER, -1, null, 369, 1);
            this.fmlBuffer[370] = new FmlField("PCNCLSRCEBANRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 370, 1);
            this.fmlBuffer[371] = new FmlField("PCNCLSRCEBANRECACTIVITY_DATE", FmlField.TYPE_STRING, 9, null, 371, 1);
            this.fmlBuffer[372] = new FmlField("RESTORE_DATE", FmlField.TYPE_STRING, 9, null, 372, 1);
            this.fmlBuffer[373] = new FmlField("DEP_RETURN_METHOD", FmlField.TYPE_BYTE, -1, null, 373, 1);
            this.fmlBuffer[374] = new FmlField("NEW_BAN_STATUS", FmlField.TYPE_BYTE, -1, null, 374, 1);
            this.fmlBuffer[375] = new FmlField("EXP_CYCLE_CODE", FmlField.TYPE_SHORT, -1, null, 375, 1);
            this.fmlBuffer[376] = new FmlField("BAN_WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 376, 1);
            this.fmlBuffer[377] = new FmlField("BAN_WAIVE_RSN", FmlField.TYPE_STRING, 7, null, 377, 1);
            this.fmlBuffer[378] = new FmlField("WAIVER_UID", FmlField.TYPE_STRING, 9, null, 378, 1);
            this.fmlBuffer[379] = new FmlField("HOLD_COLL_TREATMENT", FmlField.TYPE_BYTE, -1, null, 379, 1);
            this.fmlBuffer[380] = new FmlField("PCTNCNCLBUFROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 380, 1);
            this.fmlBuffer[381] = new FmlField("CTN", FmlField.TYPE_STRING, 21, null, 381, 100);
            this.fmlBuffer[382] = new FmlField("PCTNCNCLBUFSUB_STATUS", FmlField.TYPE_BYTE, -1, null, 382, 100);
            this.fmlBuffer[383] = new FmlField("COMM_START_DATE", FmlField.TYPE_STRING, 9, null, 383, 100);
            this.fmlBuffer[384] = new FmlField("COMM_END_DATE", FmlField.TYPE_STRING, 9, null, 384, 100);
            this.fmlBuffer[385] = new FmlField("REMAINING_MONTHS", FmlField.TYPE_SHORT, -1, null, 385, 100);
            this.fmlBuffer[386] = new FmlField("DEPOSIT", FmlField.TYPE_DOUBLE, -1, null, 386, 100);
            this.fmlBuffer[387] = new FmlField("DEPOSIT_INTEREST", FmlField.TYPE_DOUBLE, -1, null, 387, 100);
            this.fmlBuffer[388] = new FmlField("PENALTY", FmlField.TYPE_DOUBLE, -1, null, 388, 100);
            this.fmlBuffer[389] = new FmlField("WAIVE_INDICATOR", FmlField.TYPE_BYTE, -1, null, 389, 100);
            this.fmlBuffer[390] = new FmlField("PCTNCNCLBUFWAIVE_REASON", FmlField.TYPE_STRING, 7, null, 390, 100);
            this.fmlBuffer[391] = new FmlField("ACTIVITY_CTN_FEE", FmlField.TYPE_DOUBLE, -1, null, 391, 1);
            this.fmlBuffer[392] = new FmlField("NUMBER_LOCATION", FmlField.TYPE_STRING, 4, null, 392, 1);
            this.fmlBuffer[393] = new FmlField("DEPOSITTERMSIND", FmlField.TYPE_BYTE, -1, null, 393, 1);
            this.fmlBuffer[394] = new FmlField("WAIVING_IND", FmlField.TYPE_BYTE, -1, null, 394, 1);
            this.fmlBuffer[395] = new FmlField("WAIVING_REASON_CODE", FmlField.TYPE_STRING, 5, null, 395, 1);
            this.fmlBuffer[396] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 396, 1);
            this.fmlBuffer[397] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 397, 2);
            this.fmlBuffer[398] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 398, 2);
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public Integer get_PAGRRECCOMMIT_ORIG_NO_MONTH() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[59].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_PAGRRECCOMMIT_ORIG_NO_MONTH(Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[59].setValue(0, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_PSOCFTRBUFSOC_SEQ_NO(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[81].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[79].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
    ...
    public String get_FTR_SUB_MODE(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[82].getValue(nIndex)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[80].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
    ...
    public void set_FTR_SUB_MODE(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[82].setValue(nIndex, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[80].setValue(nIndex, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
    ...
    public void set_ACTION_MODE(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[92].setValue(nIndex, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[90].setValue(nIndex, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
    ...
    public Double get_DURATION(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[106].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_EQUIPMENT_LEVEL(int nIndex, Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[110].setValue(nIndex, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_SIM_STATUS(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[146].setValue(nIndex, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_SENT_TO_AUC_IND(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[149].setValue(nIndex, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[147].setValue(nIndex, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
    ...
    public Integer get_ROW_COUNT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[153].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_PARAM_COUNT(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[160].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Double get_CHARGE_AMT(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[173].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[171].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
    ...
    public void set_MP_MODE(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[178].setValue(nIndex, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[176].setValue(nIndex, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
    ...
    public String get_FIXED_AS_GSM_IND() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[272].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[270].getValue(0)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public void set_FIXED_AS_GSM_IND(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[272].setValue(0, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[270].setValue(0, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public String get_EARLY_PO_WAIVE_REASON() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((String) this.fmlBuffer[275].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public String get_LINK_MODE(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[277].getValue(nIndex)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_LINK_MODE(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[277].setValue(nIndex, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_NAME_ID(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Integer) this.fmlBuffer[296].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public Integer get_NAMERECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[304].getValue(nIndex)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[302].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public void set_NAMERECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[304].setValue(nIndex, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[302].setValue(nIndex, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public Double get_KOB(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[314].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[312].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public Integer get_NAMERECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[317].getValue(nIndex)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[315].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public void set_NAMERECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[317].setValue(nIndex, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[315].setValue(nIndex, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[333].getValue(nIndex)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_ADDRESSRECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[333].setValue(nIndex, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public String get_ADR_TYPE(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[334].getValue(nIndex)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_ADR_TYPE(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[334].setValue(nIndex, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public String get_ADR_STATUS(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[333].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public void set_ADR_STATUS(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[333].setValue(nIndex, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public void set_ADDRESSRECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[353].setValue(nIndex, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[351].setValue(nIndex, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public Integer get_SOURCE_BAN_LAST_UPDATE_STAMP() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[368].getValue(0)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public void set_SOURCE_BAN_LAST_UPDATE_STAMP(Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[368].setValue(0, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public Integer get_PCNCLSRCEBANRECBAN() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[371].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_PCNCLSRCEBANRECCUSTOMER_ID() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Integer) this.fmlBuffer[370].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public Integer get_EXP_CYCLE_CODE() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[377].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[375].getValue(0)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public void set_EXP_CYCLE_CODE(Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[377].setValue(0, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[375].setValue(0, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public String get_BAN_WAIVE_RSN() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((String) this.fmlBuffer[379].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public String get_WAIVER_UID() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((String) this.fmlBuffer[380].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((String) this.fmlBuffer[378].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public void set_WAIVER_UID(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[378].setValue(0, value);
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public String get_HOLD_COLL_TREATMENT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[381].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[379].getValue(0)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public void set_HOLD_COLL_TREATMENT(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[381].setValue(0, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[379].setValue(0, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public Integer get_PCTNCNCLBUFROW_COUNT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[382].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_REMAINING_MONTHS(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[387].getValue(nIndex)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_REMAINING_MONTHS(int nIndex, Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[387].setValue(nIndex, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Double get_DEPOSIT(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Double) this.fmlBuffer[386].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public Double get_DEPOSIT_INTEREST(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[389].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[387].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public String get_WAIVE_INDICATOR(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[389].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public void set_WAIVE_INDICATOR(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[389].setValue(nIndex, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public Double get_ACTIVITY_CTN_FEE() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[393].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[391].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public String get_DEPOSITTERMSIND() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[393].getValue(0)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public void set_DEPOSITTERMSIND(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[393].setValue(0, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public String get_WAIVING_IND() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[396].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[394].getValue(0)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public void set_WAIVING_IND(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[396].setValue(0, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[394].setValue(0, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public String get_WAIVING_REASON_CODE() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((String) this.fmlBuffer[397].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((String) this.fmlBuffer[395].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public void set_WAIVING_REASON_CODE(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[397].setValue(0, value);
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[395].setValue(0, value);
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
    ...
    public Integer get_PFTRDEPBUFROWCOUNT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[398].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_PFTRDEPBUFROWCOUNT(Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[398].setValue(0, value);
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Double get_DEPOSIT_AMOUNT(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Double) this.fmlBuffer[398].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsMoveCtnOutput class");
        }
    }
