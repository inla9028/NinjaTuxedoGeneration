...
public class CsActvCtnInput extends ServiceInput {
    ...
    public CsActvCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[162] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 162, 1);
            this.fmlBuffer[163] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 163, 25);
            this.fmlBuffer[164] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 164, 25);
            this.fmlBuffer[165] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 165, 25);
            this.fmlBuffer[166] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 166, 25);
            this.fmlBuffer[167] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 167, 25);
            this.fmlBuffer[168] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 168, 25);
            this.fmlBuffer[169] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 169, 25);
            this.fmlBuffer[170] = new FmlField("P1", FmlField.TYPE_STRING, 21, null, 170, 25);
            this.fmlBuffer[171] = new FmlField("P2", FmlField.TYPE_STRING, 21, null, 171, 25);
            this.fmlBuffer[172] = new FmlField("P3", FmlField.TYPE_STRING, 21, null, 172, 25);
            this.fmlBuffer[173] = new FmlField("P4", FmlField.TYPE_STRING, 21, null, 173, 25);
            this.fmlBuffer[174] = new FmlField("P5", FmlField.TYPE_STRING, 21, null, 174, 25);
            this.fmlBuffer[175] = new FmlField("P6", FmlField.TYPE_STRING, 21, null, 175, 25);
            this.fmlBuffer[176] = new FmlField("P7", FmlField.TYPE_STRING, 21, null, 176, 25);
            this.fmlBuffer[177] = new FmlField("P8", FmlField.TYPE_STRING, 21, null, 177, 25);
            this.fmlBuffer[178] = new FmlField("P9", FmlField.TYPE_STRING, 21, null, 178, 25);
            this.fmlBuffer[179] = new FmlField("P10", FmlField.TYPE_STRING, 21, null, 179, 25);
            this.fmlBuffer[180] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 180, 25);
            this.fmlBuffer[181] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 181, 25);
            this.fmlBuffer[182] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 182, 25);
            this.fmlBuffer[183] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 183, 25);
            this.fmlBuffer[184] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 184, 25);
            this.fmlBuffer[185] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 185, 25);
            this.fmlBuffer[186] = new FmlField("PCTNRECROWID", FmlField.TYPE_STRING, 19, null, 186, 1);
            this.fmlBuffer[187] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 187, 1);
            this.fmlBuffer[188] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 188, 1);
            this.fmlBuffer[189] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 189, 1);
            this.fmlBuffer[190] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 190, 1);
            this.fmlBuffer[191] = new FmlField("PCTNRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 191, 1);
            this.fmlBuffer[192] = new FmlField("PCTNRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 192, 1);
            this.fmlBuffer[193] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 193, 1);
            this.fmlBuffer[194] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 194, 1);
            this.fmlBuffer[195] = new FmlField("PCTNRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 195, 1);
            this.fmlBuffer[196] = new FmlField("INIT_ACTIVATION_DATE", FmlField.TYPE_STRING, 9, null, 196, 1);
            this.fmlBuffer[197] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 197, 1);
            this.fmlBuffer[198] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 198, 1);
            this.fmlBuffer[199] = new FmlField("ORIGINAL_INIT_DATE", FmlField.TYPE_STRING, 15, null, 199, 1);
            this.fmlBuffer[200] = new FmlField("SUB_STATUS_LAST_ACT", FmlField.TYPE_STRING, 4, null, 200, 1);
            this.fmlBuffer[201] = new FmlField("SUB_STATUS_RSN_CODE", FmlField.TYPE_STRING, 5, null, 201, 1);
            this.fmlBuffer[202] = new FmlField("PCTNRECPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 202, 1);
            this.fmlBuffer[203] = new FmlField("CUSTOMER_BAN", FmlField.TYPE_INTEGER, -1, null, 203, 1);
            this.fmlBuffer[204] = new FmlField("CTN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 204, 1);
            this.fmlBuffer[205] = new FmlField("REQ_ST_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 205, 1);
            this.fmlBuffer[206] = new FmlField("REQ_END_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 206, 1);
            this.fmlBuffer[207] = new FmlField("COMMIT_START_DATE", FmlField.TYPE_STRING, 9, null, 207, 1);
            this.fmlBuffer[208] = new FmlField("COMMIT_END_DATE", FmlField.TYPE_STRING, 9, null, 208, 1);
            this.fmlBuffer[209] = new FmlField("COMMIT_REASON_CODE", FmlField.TYPE_STRING, 4, null, 209, 1);
            this.fmlBuffer[210] = new FmlField("PCTNRECCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 210, 1);
            this.fmlBuffer[211] = new FmlField("PCTNRECSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 211, 1);
            this.fmlBuffer[212] = new FmlField("CONTRACT_NO", FmlField.TYPE_STRING, 11, null, 212, 1);
            this.fmlBuffer[213] = new FmlField("CNT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 213, 1);
            this.fmlBuffer[214] = new FmlField("PCTNRECDEALER_CODE", FmlField.TYPE_STRING, 6, null, 214, 1);
            this.fmlBuffer[215] = new FmlField("ORG_DEALER_CODE", FmlField.TYPE_STRING, 6, null, 215, 1);
            this.fmlBuffer[216] = new FmlField("PCTNRECSALES_AGENT", FmlField.TYPE_STRING, 6, null, 216, 1);
            this.fmlBuffer[217] = new FmlField("ORG_SALES_AGENT", FmlField.TYPE_STRING, 6, null, 217, 1);
            this.fmlBuffer[218] = new FmlField("REQ_DEPOSIT_AMT", FmlField.TYPE_DOUBLE, -1, null, 218, 1);
            this.fmlBuffer[219] = new FmlField("LEADING_NUMBER", FmlField.TYPE_STRING, 21, null, 219, 1);
            this.fmlBuffer[220] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, null, 220, 1);
            this.fmlBuffer[221] = new FmlField("NEXT_CTN", FmlField.TYPE_STRING, 21, null, 221, 1);
            this.fmlBuffer[222] = new FmlField("NEXT_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 222, 1);
            this.fmlBuffer[223] = new FmlField("PRV_CTN", FmlField.TYPE_STRING, 21, null, 223, 1);
            this.fmlBuffer[224] = new FmlField("PRV_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 224, 1);
            this.fmlBuffer[225] = new FmlField("NEXT_BAN", FmlField.TYPE_INTEGER, -1, null, 225, 1);
            this.fmlBuffer[226] = new FmlField("NEXT_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 226, 1);
            this.fmlBuffer[227] = new FmlField("PRV_BAN", FmlField.TYPE_INTEGER, -1, null, 227, 1);
            this.fmlBuffer[228] = new FmlField("PRV_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 228, 1);
            this.fmlBuffer[229] = new FmlField("SUB_STS_ISSUE_DATE", FmlField.TYPE_STRING, 9, null, 229, 1);
            this.fmlBuffer[230] = new FmlField("ACTIVATE_WAIVE_RSN", FmlField.TYPE_STRING, 7, null, 230, 1);
            this.fmlBuffer[231] = new FmlField("EARLIEST_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 231, 1);
            this.fmlBuffer[232] = new FmlField("SUB_ACTV_LOCATION", FmlField.TYPE_STRING, 5, null, 232, 1);
            this.fmlBuffer[233] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 233, 1);
            this.fmlBuffer[234] = new FmlField("CUST_WATCH_DATE", FmlField.TYPE_STRING, 9, null, 234, 1);
            this.fmlBuffer[235] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 235, 1);
            this.fmlBuffer[236] = new FmlField("CREDIT_WATCH_PIN_CD", FmlField.TYPE_SHORT, -1, null, 236, 1);
            this.fmlBuffer[237] = new FmlField("SUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 237, 1);
            this.fmlBuffer[238] = new FmlField("LIMIT_RESERVED_DAYS", FmlField.TYPE_SHORT, -1, null, 238, 1);
            this.fmlBuffer[239] = new FmlField("FF_EXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 239, 1);
            this.fmlBuffer[240] = new FmlField("FLEX_IND", FmlField.TYPE_BYTE, -1, null, 240, 1);
            this.fmlBuffer[241] = new FmlField("DUO_IND", FmlField.TYPE_BYTE, -1, null, 241, 1);
            this.fmlBuffer[242] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, null, 242, 1);
            this.fmlBuffer[243] = new FmlField("SUB_DEPARTMENT_CD", FmlField.TYPE_STRING, 5, null, 243, 1);
            this.fmlBuffer[244] = new FmlField("LAST_SUBS_DISC_DT", FmlField.TYPE_STRING, 9, null, 244, 1);
            this.fmlBuffer[245] = new FmlField("LAST_SUBS_DISC_DT_UD", FmlField.TYPE_STRING, 9, null, 245, 1);
            this.fmlBuffer[246] = new FmlField("LAST_SUBSCR_DISC_SN", FmlField.TYPE_SHORT, -1, null, 246, 1);
            this.fmlBuffer[247] = new FmlField("LAST_SUBSCR_DISC_SN_UD", FmlField.TYPE_SHORT, -1, null, 247, 1);
            this.fmlBuffer[248] = new FmlField("PNI", FmlField.TYPE_STRING, 11, null, 248, 1);
            this.fmlBuffer[249] = new FmlField("RMS_REF_STORE_ID", FmlField.TYPE_STRING, 5, null, 249, 1);
            this.fmlBuffer[250] = new FmlField("RMS_REF_TYPE", FmlField.TYPE_BYTE, -1, null, 250, 1);
            this.fmlBuffer[251] = new FmlField("RMS_REF_OD", FmlField.TYPE_INTEGER, -1, null, 251, 1);
            this.fmlBuffer[252] = new FmlField("DLR_ACT_FEE", FmlField.TYPE_DOUBLE, -1, null, 252, 1);
            this.fmlBuffer[253] = new FmlField("PREP_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 253, 1);
            this.fmlBuffer[254] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 254, 1);
            this.fmlBuffer[255] = new FmlField("SUB_LANG", FmlField.TYPE_STRING, 3, null, 255, 1);
            this.fmlBuffer[256] = new FmlField("SMS_RCV_STYLE_CODE", FmlField.TYPE_STRING, 3, null, 256, 1);
            this.fmlBuffer[257] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 257, 1);
            this.fmlBuffer[258] = new FmlField("ALLOW_ADVERTISING_IND", FmlField.TYPE_BYTE, -1, null, 258, 1);
            this.fmlBuffer[259] = new FmlField("IVR_WRONG_ACCESS_NO", FmlField.TYPE_SHORT, -1, null, 259, 1);
            this.fmlBuffer[260] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, NinjaConfigurationReferenceTable.getThresholdAmt(), 260, 1);
            this.fmlBuffer[261] = new FmlField("PUBLISH_LEVEL", FmlField.TYPE_STRING, 31, null, 261, 1);
            this.fmlBuffer[262] = new FmlField("AUTO_RELEASE_IND", FmlField.TYPE_BYTE, -1, null, 262, 1);
            this.fmlBuffer[263] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, null, 263, 1);
            this.fmlBuffer[264] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, null, 264, 1);
            this.fmlBuffer[265] = new FmlField("OPERATOR_CW_LMT", FmlField.TYPE_DOUBLE, -1, null, 265, 1);
            this.fmlBuffer[266] = new FmlField("SEND_SMS_FOR_MATCH", FmlField.TYPE_BYTE, -1, null, 266, 1);
            this.fmlBuffer[267] = new FmlField("CPS_STATUS", FmlField.TYPE_BYTE, -1, null, 267, 1);
            this.fmlBuffer[268] = new FmlField("CPS_TRANSACTION", FmlField.TYPE_SHORT, -1, null, 268, 1);
            this.fmlBuffer[269] = new FmlField("CPS_TYPE", FmlField.TYPE_SHORT, -1, null, 269, 1);
            this.fmlBuffer[270] = new FmlField("ISP_PASS", FmlField.TYPE_STRING, 31, null, 270, 1);
            this.fmlBuffer[271] = new FmlField("ISP_TYPE", FmlField.TYPE_STRING, 3, null, 271, 1);
            this.fmlBuffer[272] = new FmlField("OPERATOR_TMP_DATE", FmlField.TYPE_STRING, 9, null, 272, 1);
            this.fmlBuffer[273] = new FmlField("OPERATOR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, null, 273, 1);
            this.fmlBuffer[274] = new FmlField("SUB_ORG_CD", FmlField.TYPE_STRING, 11, null, 274, 1);
            this.fmlBuffer[275] = new FmlField("ORG_MEMBER_NO", FmlField.TYPE_STRING, 21, null, 275, 1);
            this.fmlBuffer[276] = new FmlField("FIXED_AS_GSM_IND", FmlField.TYPE_BYTE, -1, null, 276, 1);
            this.fmlBuffer[277] = new FmlField("EARLY_PORT_OUT", FmlField.TYPE_BYTE, -1, null, 277, 1);
            this.fmlBuffer[278] = new FmlField("EARLY_PO_WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 278, 1);
            this.fmlBuffer[279] = new FmlField("EARLY_PO_WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 279, 1);
            this.fmlBuffer[280] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 280, 1);
            this.fmlBuffer[281] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 281, 20);
            this.fmlBuffer[282] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 282, 20);
            this.fmlBuffer[283] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 283, 20);
            this.fmlBuffer[284] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 284, 20);
            this.fmlBuffer[285] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 285, 20);
            this.fmlBuffer[286] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 286, 20);
            this.fmlBuffer[287] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 287, 20);
            this.fmlBuffer[288] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 288, 20);
            this.fmlBuffer[289] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 289, 20);
            this.fmlBuffer[290] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 290, 20);
            this.fmlBuffer[291] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 291, 20);
            this.fmlBuffer[292] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 292, 20);
            this.fmlBuffer[293] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 293, 20);
            this.fmlBuffer[294] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 294, 20);
            this.fmlBuffer[295] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 295, 20);
            this.fmlBuffer[296] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 296, 20);
            this.fmlBuffer[297] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 297, 20);
            this.fmlBuffer[298] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 298, 20);
            this.fmlBuffer[299] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 299, 20);
            this.fmlBuffer[300] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 300, 20);
            this.fmlBuffer[301] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 301, 20);
            this.fmlBuffer[302] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 302, 20);
            this.fmlBuffer[303] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 303, 20);
            this.fmlBuffer[304] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 304, 20);
            this.fmlBuffer[305] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 305, 20);
            this.fmlBuffer[306] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 306, 20);
            this.fmlBuffer[307] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 307, 20);
            this.fmlBuffer[308] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 308, 20);
            this.fmlBuffer[309] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 309, 20);
            this.fmlBuffer[310] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 310, 20);
            this.fmlBuffer[311] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 311, 20);
            this.fmlBuffer[312] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 312, 20);
            this.fmlBuffer[313] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 313, 20);
            this.fmlBuffer[314] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 314, 20);
            this.fmlBuffer[315] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 315, 20);
            this.fmlBuffer[316] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 316, 20);
            this.fmlBuffer[317] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, null, 317, 20);
            this.fmlBuffer[318] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 318, 20);
            this.fmlBuffer[319] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 319, 20);
            this.fmlBuffer[320] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 320, 20);
            this.fmlBuffer[321] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 321, 20);
            this.fmlBuffer[322] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 322, 20);
            this.fmlBuffer[323] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 323, 20);
            this.fmlBuffer[324] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 324, 20);
            this.fmlBuffer[325] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 325, 20);
            this.fmlBuffer[326] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 326, 20);
            this.fmlBuffer[327] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 327, 20);
            this.fmlBuffer[328] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 328, 20);
            this.fmlBuffer[329] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 329, 20);
            this.fmlBuffer[330] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 330, 20);
            this.fmlBuffer[331] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 331, 20);
            this.fmlBuffer[332] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 332, 20);
            this.fmlBuffer[333] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 333, 20);
            this.fmlBuffer[334] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 334, 20);
            this.fmlBuffer[335] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 335, 20);
            this.fmlBuffer[336] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 336, 20);
            this.fmlBuffer[337] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 337, 20);
            this.fmlBuffer[338] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 338, 20);
            this.fmlBuffer[339] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 339, 20);
            this.fmlBuffer[340] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 340, 20);
            this.fmlBuffer[341] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 341, 20);
            this.fmlBuffer[342] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 342, 20);
            this.fmlBuffer[343] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 343, 20);
            this.fmlBuffer[344] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 344, 20);
            this.fmlBuffer[345] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 345, 20);
            this.fmlBuffer[346] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 346, 20);
            this.fmlBuffer[347] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 347, 20);
            this.fmlBuffer[348] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 348, 20);
            this.fmlBuffer[349] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 349, 20);
            this.fmlBuffer[350] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 350, 20);
            this.fmlBuffer[351] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 351, 20);
            this.fmlBuffer[352] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 352, 20);
            this.fmlBuffer[353] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 353, 20);
            this.fmlBuffer[354] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 354, 20);
            this.fmlBuffer[355] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 355, 20);
            this.fmlBuffer[356] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 356, 20);
            this.fmlBuffer[357] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 357, 20);
            this.fmlBuffer[358] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 358, 20);
            this.fmlBuffer[359] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 359, 20);
            this.fmlBuffer[360] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 360, 20);
            this.fmlBuffer[361] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 361, 20);
            this.fmlBuffer[362] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 362, 20);
            this.fmlBuffer[363] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 363, 20);
            this.fmlBuffer[364] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 364, 20);
            this.fmlBuffer[365] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 365, 20);
            this.fmlBuffer[366] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 366, 20);
            this.fmlBuffer[367] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 367, 20);
            this.fmlBuffer[368] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 368, 20);
            this.fmlBuffer[369] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 369, 20);
            this.fmlBuffer[370] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 370, 20);
            this.fmlBuffer[371] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 371, 20);
            this.fmlBuffer[372] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 372, 20);
            this.fmlBuffer[373] = new FmlField("PINSTLBUFROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 373, 1);
            this.fmlBuffer[374] = new FmlField("INSTALLMENT_AMT", FmlField.TYPE_DOUBLE, -1, null, 374, 12);
            this.fmlBuffer[375] = new FmlField("INSTALLMENT_DATE", FmlField.TYPE_STRING, 9, null, 375, 12);
            this.fmlBuffer[376] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 376, 1);
            this.fmlBuffer[377] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 377, 2);
            this.fmlBuffer[378] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 378, 2);
            this.fmlBuffer[379] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 379, 1);
            this.fmlBuffer[380] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 380, 1);
            this.fmlBuffer[381] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 381, 1);
            this.fmlBuffer[382] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 382, 1);
            this.fmlBuffer[383] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 383, 1);
            this.fmlBuffer[384] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 384, 1);
            this.fmlBuffer[385] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 385, 1);
            this.fmlBuffer[386] = new FmlField("PARINPBAN", FmlField.TYPE_INTEGER, -1, null, 386, 1);
            this.fmlBuffer[387] = new FmlField("PARTITION_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 387, 1);
            this.fmlBuffer[388] = new FmlField("PARINPSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 388, 1);
            this.fmlBuffer[389] = new FmlField("PARINPSUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 389, 1);
            this.fmlBuffer[390] = new FmlField("REQUIREMENT_DATE", FmlField.TYPE_STRING, 9, null, 390, 1);
            this.fmlBuffer[391] = new FmlField("ACTIVATION_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 391, 1);
            this.fmlBuffer[392] = new FmlField("PREPAYMENT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 392, 1);
            this.fmlBuffer[393] = new FmlField("PREP_ACTV_AMT", FmlField.TYPE_DOUBLE, -1, null, 393, 1);
            this.fmlBuffer[394] = new FmlField("RC_ONLY_IND", FmlField.TYPE_BYTE, -1, null, 394, 1);
            this.fmlBuffer[395] = new FmlField("PARINPDEALER_CODE", FmlField.TYPE_STRING, 6, null, 395, 1);
            this.fmlBuffer[396] = new FmlField("ACTV_EXMP_IND", FmlField.TYPE_BYTE, -1, null, 396, 1);
            this.fmlBuffer[397] = new FmlField("PREP_EXMP_IND", FmlField.TYPE_BYTE, -1, null, 397, 1);
            this.fmlBuffer[398] = new FmlField("SOURCE_APPL_CODE", FmlField.TYPE_BYTE, -1, null, 398, 1);
            this.fmlBuffer[399] = new FmlField("PARINPFEATURE_CODE", FmlField.TYPE_STRING, 7, null, 399, 1);
            this.fmlBuffer[400] = new FmlField("PARINPSOC", FmlField.TYPE_STRING, 10, null, 400, 1);
            this.fmlBuffer[401] = new FmlField("SOC_DATE", FmlField.TYPE_STRING, 9, null, 401, 1);
            this.fmlBuffer[402] = new FmlField("CAS_PT_REQ", FmlField.TYPE_BYTE, -1, null, 402, 1);
            ...
            //synchronized (this.defaultValuesPopulated) {
            //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
            //        defaultValues = getDefaultValues("csActvCtn", 401);
            //        this.defaultValuesPopulated = Boolean.TRUE;
            //    }
            //}
            ...
            this.fmlBuffer[160] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 160, 1);
            this.fmlBuffer[161] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 161, 25);
            this.fmlBuffer[162] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 162, 25);
            this.fmlBuffer[163] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 163, 25);
            this.fmlBuffer[164] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 164, 25);
            this.fmlBuffer[165] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 165, 25);
            this.fmlBuffer[166] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 166, 25);
            this.fmlBuffer[167] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 167, 25);
            this.fmlBuffer[168] = new FmlField("P1", FmlField.TYPE_STRING, 21, null, 168, 25);
            this.fmlBuffer[169] = new FmlField("P2", FmlField.TYPE_STRING, 21, null, 169, 25);
            this.fmlBuffer[170] = new FmlField("P3", FmlField.TYPE_STRING, 21, null, 170, 25);
            this.fmlBuffer[171] = new FmlField("P4", FmlField.TYPE_STRING, 21, null, 171, 25);
            this.fmlBuffer[172] = new FmlField("P5", FmlField.TYPE_STRING, 21, null, 172, 25);
            this.fmlBuffer[173] = new FmlField("P6", FmlField.TYPE_STRING, 21, null, 173, 25);
            this.fmlBuffer[174] = new FmlField("P7", FmlField.TYPE_STRING, 21, null, 174, 25);
            this.fmlBuffer[175] = new FmlField("P8", FmlField.TYPE_STRING, 21, null, 175, 25);
            this.fmlBuffer[176] = new FmlField("P9", FmlField.TYPE_STRING, 21, null, 176, 25);
            this.fmlBuffer[177] = new FmlField("P10", FmlField.TYPE_STRING, 21, null, 177, 25);
            this.fmlBuffer[178] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 178, 25);
            this.fmlBuffer[179] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 179, 25);
            this.fmlBuffer[180] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 180, 25);
            this.fmlBuffer[181] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 181, 25);
            this.fmlBuffer[182] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 182, 25);
            this.fmlBuffer[183] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 183, 25);
            this.fmlBuffer[184] = new FmlField("PCTNRECROWID", FmlField.TYPE_STRING, 19, null, 184, 1);
            this.fmlBuffer[185] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 185, 1);
            this.fmlBuffer[186] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 186, 1);
            this.fmlBuffer[187] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 187, 1);
            this.fmlBuffer[188] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 188, 1);
            this.fmlBuffer[189] = new FmlField("PCTNRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 189, 1);
            this.fmlBuffer[190] = new FmlField("PCTNRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 190, 1);
            this.fmlBuffer[191] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 191, 1);
            this.fmlBuffer[192] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 192, 1);
            this.fmlBuffer[193] = new FmlField("PCTNRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 193, 1);
            this.fmlBuffer[194] = new FmlField("INIT_ACTIVATION_DATE", FmlField.TYPE_STRING, 9, null, 194, 1);
            this.fmlBuffer[195] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 195, 1);
            this.fmlBuffer[196] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 196, 1);
            this.fmlBuffer[197] = new FmlField("ORIGINAL_INIT_DATE", FmlField.TYPE_STRING, 15, null, 197, 1);
            this.fmlBuffer[198] = new FmlField("SUB_STATUS_LAST_ACT", FmlField.TYPE_STRING, 4, null, 198, 1);
            this.fmlBuffer[199] = new FmlField("SUB_STATUS_RSN_CODE", FmlField.TYPE_STRING, 5, null, 199, 1);
            this.fmlBuffer[200] = new FmlField("PCTNRECPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 200, 1);
            this.fmlBuffer[201] = new FmlField("CUSTOMER_BAN", FmlField.TYPE_INTEGER, -1, null, 201, 1);
            this.fmlBuffer[202] = new FmlField("CTN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 202, 1);
            this.fmlBuffer[203] = new FmlField("REQ_ST_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 203, 1);
            this.fmlBuffer[204] = new FmlField("REQ_END_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 204, 1);
            this.fmlBuffer[205] = new FmlField("COMMIT_START_DATE", FmlField.TYPE_STRING, 9, null, 205, 1);
            this.fmlBuffer[206] = new FmlField("COMMIT_END_DATE", FmlField.TYPE_STRING, 9, null, 206, 1);
            this.fmlBuffer[207] = new FmlField("COMMIT_REASON_CODE", FmlField.TYPE_STRING, 4, null, 207, 1);
            this.fmlBuffer[208] = new FmlField("PCTNRECCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 208, 1);
            this.fmlBuffer[209] = new FmlField("PCTNRECSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 209, 1);
            this.fmlBuffer[210] = new FmlField("CONTRACT_NO", FmlField.TYPE_STRING, 11, null, 210, 1);
            this.fmlBuffer[211] = new FmlField("CNT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 211, 1);
            this.fmlBuffer[212] = new FmlField("PCTNRECDEALER_CODE", FmlField.TYPE_STRING, 6, null, 212, 1);
            this.fmlBuffer[213] = new FmlField("ORG_DEALER_CODE", FmlField.TYPE_STRING, 6, null, 213, 1);
            this.fmlBuffer[214] = new FmlField("PCTNRECSALES_AGENT", FmlField.TYPE_STRING, 6, null, 214, 1);
            this.fmlBuffer[215] = new FmlField("ORG_SALES_AGENT", FmlField.TYPE_STRING, 6, null, 215, 1);
            this.fmlBuffer[216] = new FmlField("REQ_DEPOSIT_AMT", FmlField.TYPE_DOUBLE, -1, null, 216, 1);
            this.fmlBuffer[217] = new FmlField("LEADING_NUMBER", FmlField.TYPE_STRING, 21, null, 217, 1);
            this.fmlBuffer[218] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, null, 218, 1);
            this.fmlBuffer[219] = new FmlField("NEXT_CTN", FmlField.TYPE_STRING, 21, null, 219, 1);
            this.fmlBuffer[220] = new FmlField("NEXT_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 220, 1);
            this.fmlBuffer[221] = new FmlField("PRV_CTN", FmlField.TYPE_STRING, 21, null, 221, 1);
            this.fmlBuffer[222] = new FmlField("PRV_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 222, 1);
            this.fmlBuffer[223] = new FmlField("NEXT_BAN", FmlField.TYPE_INTEGER, -1, null, 223, 1);
            this.fmlBuffer[224] = new FmlField("NEXT_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 224, 1);
            this.fmlBuffer[225] = new FmlField("PRV_BAN", FmlField.TYPE_INTEGER, -1, null, 225, 1);
            this.fmlBuffer[226] = new FmlField("PRV_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 226, 1);
            this.fmlBuffer[227] = new FmlField("SUB_STS_ISSUE_DATE", FmlField.TYPE_STRING, 9, null, 227, 1);
            this.fmlBuffer[228] = new FmlField("ACTIVATE_WAIVE_RSN", FmlField.TYPE_STRING, 7, null, 228, 1);
            this.fmlBuffer[229] = new FmlField("EARLIEST_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 229, 1);
            this.fmlBuffer[230] = new FmlField("SUB_ACTV_LOCATION", FmlField.TYPE_STRING, 5, null, 230, 1);
            this.fmlBuffer[231] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 231, 1);
            this.fmlBuffer[232] = new FmlField("CUST_WATCH_DATE", FmlField.TYPE_STRING, 9, null, 232, 1);
            this.fmlBuffer[233] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 233, 1);
            this.fmlBuffer[234] = new FmlField("CREDIT_WATCH_PIN_CD", FmlField.TYPE_SHORT, -1, null, 234, 1);
            this.fmlBuffer[235] = new FmlField("SUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 235, 1);
            this.fmlBuffer[236] = new FmlField("LIMIT_RESERVED_DAYS", FmlField.TYPE_SHORT, -1, null, 236, 1);
            this.fmlBuffer[237] = new FmlField("FF_EXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 237, 1);
            this.fmlBuffer[238] = new FmlField("FLEX_IND", FmlField.TYPE_BYTE, -1, null, 238, 1);
            this.fmlBuffer[239] = new FmlField("DUO_IND", FmlField.TYPE_BYTE, -1, null, 239, 1);
            this.fmlBuffer[240] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, null, 240, 1);
            this.fmlBuffer[241] = new FmlField("SUB_DEPARTMENT_CD", FmlField.TYPE_STRING, 5, null, 241, 1);
            this.fmlBuffer[242] = new FmlField("LAST_SUBS_DISC_DT", FmlField.TYPE_STRING, 9, null, 242, 1);
            this.fmlBuffer[243] = new FmlField("LAST_SUBS_DISC_DT_UD", FmlField.TYPE_STRING, 9, null, 243, 1);
            this.fmlBuffer[244] = new FmlField("LAST_SUBSCR_DISC_SN", FmlField.TYPE_SHORT, -1, null, 244, 1);
            this.fmlBuffer[245] = new FmlField("LAST_SUBSCR_DISC_SN_UD", FmlField.TYPE_SHORT, -1, null, 245, 1);
            this.fmlBuffer[246] = new FmlField("PNI", FmlField.TYPE_STRING, 11, null, 246, 1);
            this.fmlBuffer[247] = new FmlField("RMS_REF_STORE_ID", FmlField.TYPE_STRING, 5, null, 247, 1);
            this.fmlBuffer[248] = new FmlField("RMS_REF_TYPE", FmlField.TYPE_BYTE, -1, null, 248, 1);
            this.fmlBuffer[249] = new FmlField("RMS_REF_OD", FmlField.TYPE_INTEGER, -1, null, 249, 1);
            this.fmlBuffer[250] = new FmlField("DLR_ACT_FEE", FmlField.TYPE_DOUBLE, -1, null, 250, 1);
            this.fmlBuffer[251] = new FmlField("PREP_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 251, 1);
            this.fmlBuffer[252] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 252, 1);
            this.fmlBuffer[253] = new FmlField("SUB_LANG", FmlField.TYPE_STRING, 3, null, 253, 1);
            this.fmlBuffer[254] = new FmlField("SMS_RCV_STYLE_CODE", FmlField.TYPE_STRING, 3, null, 254, 1);
            this.fmlBuffer[255] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 255, 1);
            this.fmlBuffer[256] = new FmlField("ALLOW_ADVERTISING_IND", FmlField.TYPE_BYTE, -1, null, 256, 1);
            this.fmlBuffer[257] = new FmlField("IVR_WRONG_ACCESS_NO", FmlField.TYPE_SHORT, -1, null, 257, 1);
            this.fmlBuffer[258] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, NinjaConfigurationReferenceTable.getThresholdAmt(), 258, 1);
            this.fmlBuffer[259] = new FmlField("PUBLISH_LEVEL", FmlField.TYPE_STRING, 31, null, 259, 1);
            this.fmlBuffer[260] = new FmlField("AUTO_RELEASE_IND", FmlField.TYPE_BYTE, -1, null, 260, 1);
            this.fmlBuffer[261] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, null, 261, 1);
            this.fmlBuffer[262] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, null, 262, 1);
            this.fmlBuffer[263] = new FmlField("OPERATOR_CW_LMT", FmlField.TYPE_DOUBLE, -1, null, 263, 1);
            this.fmlBuffer[264] = new FmlField("SEND_SMS_FOR_MATCH", FmlField.TYPE_BYTE, -1, null, 264, 1);
            this.fmlBuffer[265] = new FmlField("CPS_STATUS", FmlField.TYPE_BYTE, -1, null, 265, 1);
            this.fmlBuffer[266] = new FmlField("CPS_TRANSACTION", FmlField.TYPE_SHORT, -1, null, 266, 1);
            this.fmlBuffer[267] = new FmlField("CPS_TYPE", FmlField.TYPE_SHORT, -1, null, 267, 1);
            this.fmlBuffer[268] = new FmlField("ISP_PASS", FmlField.TYPE_STRING, 31, null, 268, 1);
            this.fmlBuffer[269] = new FmlField("ISP_TYPE", FmlField.TYPE_STRING, 3, null, 269, 1);
            this.fmlBuffer[270] = new FmlField("OPERATOR_TMP_DATE", FmlField.TYPE_STRING, 9, null, 270, 1);
            this.fmlBuffer[271] = new FmlField("OPERATOR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, null, 271, 1);
            this.fmlBuffer[272] = new FmlField("SUB_ORG_CD", FmlField.TYPE_STRING, 11, null, 272, 1);
            this.fmlBuffer[273] = new FmlField("ORG_MEMBER_NO", FmlField.TYPE_STRING, 21, null, 273, 1);
            this.fmlBuffer[274] = new FmlField("FIXED_AS_GSM_IND", FmlField.TYPE_BYTE, -1, null, 274, 1);
            this.fmlBuffer[275] = new FmlField("EARLY_PORT_OUT", FmlField.TYPE_BYTE, -1, null, 275, 1);
            this.fmlBuffer[276] = new FmlField("EARLY_PO_WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 276, 1);
            this.fmlBuffer[277] = new FmlField("EARLY_PO_WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 277, 1);
            this.fmlBuffer[278] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 278, 1);
            this.fmlBuffer[279] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 279, 20);
            this.fmlBuffer[280] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 280, 20);
            this.fmlBuffer[281] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 281, 20);
            this.fmlBuffer[282] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 282, 20);
            this.fmlBuffer[283] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 283, 20);
            this.fmlBuffer[284] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 284, 20);
            this.fmlBuffer[285] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 285, 20);
            this.fmlBuffer[286] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 286, 20);
            this.fmlBuffer[287] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 287, 20);
            this.fmlBuffer[288] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 288, 20);
            this.fmlBuffer[289] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 289, 20);
            this.fmlBuffer[290] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 290, 20);
            this.fmlBuffer[291] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 291, 20);
            this.fmlBuffer[292] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 292, 20);
            this.fmlBuffer[293] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 293, 20);
            this.fmlBuffer[294] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 294, 20);
            this.fmlBuffer[295] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 295, 20);
            this.fmlBuffer[296] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 296, 20);
            this.fmlBuffer[297] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 297, 20);
            this.fmlBuffer[298] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 298, 20);
            this.fmlBuffer[299] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 299, 20);
            this.fmlBuffer[300] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 300, 20);
            this.fmlBuffer[301] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 301, 20);
            this.fmlBuffer[302] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 302, 20);
            this.fmlBuffer[303] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 303, 20);
            this.fmlBuffer[304] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 304, 20);
            this.fmlBuffer[305] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 305, 20);
            this.fmlBuffer[306] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 306, 20);
            this.fmlBuffer[307] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 307, 20);
            this.fmlBuffer[308] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 308, 20);
            this.fmlBuffer[309] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 309, 20);
            this.fmlBuffer[310] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 310, 20);
            this.fmlBuffer[311] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 311, 20);
            this.fmlBuffer[312] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 312, 20);
            this.fmlBuffer[313] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 313, 20);
            this.fmlBuffer[314] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 314, 20);
            this.fmlBuffer[315] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, null, 315, 20);
            this.fmlBuffer[316] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 316, 20);
            this.fmlBuffer[317] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 317, 20);
            this.fmlBuffer[318] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 318, 20);
            this.fmlBuffer[319] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 319, 20);
            this.fmlBuffer[320] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 320, 20);
            this.fmlBuffer[321] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 321, 20);
            this.fmlBuffer[322] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 322, 20);
            this.fmlBuffer[323] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 323, 20);
            this.fmlBuffer[324] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 324, 20);
            this.fmlBuffer[325] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 325, 20);
            this.fmlBuffer[326] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 326, 20);
            this.fmlBuffer[327] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 327, 20);
            this.fmlBuffer[328] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 328, 20);
            this.fmlBuffer[329] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 329, 20);
            this.fmlBuffer[330] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 330, 20);
            this.fmlBuffer[331] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 331, 20);
            this.fmlBuffer[332] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 332, 20);
            this.fmlBuffer[333] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 333, 20);
            this.fmlBuffer[334] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 334, 20);
            this.fmlBuffer[335] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 335, 20);
            this.fmlBuffer[336] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 336, 20);
            this.fmlBuffer[337] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 337, 20);
            this.fmlBuffer[338] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 338, 20);
            this.fmlBuffer[339] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 339, 20);
            this.fmlBuffer[340] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 340, 20);
            this.fmlBuffer[341] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 341, 20);
            this.fmlBuffer[342] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 342, 20);
            this.fmlBuffer[343] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 343, 20);
            this.fmlBuffer[344] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 344, 20);
            this.fmlBuffer[345] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 345, 20);
            this.fmlBuffer[346] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 346, 20);
            this.fmlBuffer[347] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 347, 20);
            this.fmlBuffer[348] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 348, 20);
            this.fmlBuffer[349] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 349, 20);
            this.fmlBuffer[350] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 350, 20);
            this.fmlBuffer[351] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 351, 20);
            this.fmlBuffer[352] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 352, 20);
            this.fmlBuffer[353] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 353, 20);
            this.fmlBuffer[354] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 354, 20);
            this.fmlBuffer[355] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 355, 20);
            this.fmlBuffer[356] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 356, 20);
            this.fmlBuffer[357] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 357, 20);
            this.fmlBuffer[358] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 358, 20);
            this.fmlBuffer[359] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 359, 20);
            this.fmlBuffer[360] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 360, 20);
            this.fmlBuffer[361] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 361, 20);
            this.fmlBuffer[362] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 362, 20);
            this.fmlBuffer[363] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 363, 20);
            this.fmlBuffer[364] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 364, 20);
            this.fmlBuffer[365] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 365, 20);
            this.fmlBuffer[366] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 366, 20);
            this.fmlBuffer[367] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 367, 20);
            this.fmlBuffer[368] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 368, 20);
            this.fmlBuffer[369] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 369, 20);
            this.fmlBuffer[370] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 370, 20);
            this.fmlBuffer[371] = new FmlField("PINSTLBUFROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 371, 1);
            this.fmlBuffer[372] = new FmlField("INSTALLMENT_AMT", FmlField.TYPE_DOUBLE, -1, null, 372, 12);
            this.fmlBuffer[373] = new FmlField("INSTALLMENT_DATE", FmlField.TYPE_STRING, 9, null, 373, 12);
            this.fmlBuffer[374] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 374, 1);
            this.fmlBuffer[375] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 375, 2);
            this.fmlBuffer[376] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 376, 2);
            this.fmlBuffer[377] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 377, 1);
            this.fmlBuffer[378] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 378, 1);
            this.fmlBuffer[379] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 379, 1);
            this.fmlBuffer[380] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 380, 1);
            this.fmlBuffer[381] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 381, 1);
            this.fmlBuffer[382] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 382, 1);
            this.fmlBuffer[383] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 383, 1);
            this.fmlBuffer[384] = new FmlField("PARINPBAN", FmlField.TYPE_INTEGER, -1, null, 384, 1);
            this.fmlBuffer[385] = new FmlField("PARTITION_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 385, 1);
            this.fmlBuffer[386] = new FmlField("PARINPSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 386, 1);
            this.fmlBuffer[387] = new FmlField("PARINPSUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 387, 1);
            this.fmlBuffer[388] = new FmlField("REQUIREMENT_DATE", FmlField.TYPE_STRING, 9, null, 388, 1);
            this.fmlBuffer[389] = new FmlField("ACTIVATION_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 389, 1);
            this.fmlBuffer[390] = new FmlField("PREPAYMENT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 390, 1);
            this.fmlBuffer[391] = new FmlField("PREP_ACTV_AMT", FmlField.TYPE_DOUBLE, -1, null, 391, 1);
            this.fmlBuffer[392] = new FmlField("RC_ONLY_IND", FmlField.TYPE_BYTE, -1, null, 392, 1);
            this.fmlBuffer[393] = new FmlField("PARINPDEALER_CODE", FmlField.TYPE_STRING, 6, null, 393, 1);
            this.fmlBuffer[394] = new FmlField("ACTV_EXMP_IND", FmlField.TYPE_BYTE, -1, null, 394, 1);
            this.fmlBuffer[395] = new FmlField("PREP_EXMP_IND", FmlField.TYPE_BYTE, -1, null, 395, 1);
            this.fmlBuffer[396] = new FmlField("SOURCE_APPL_CODE", FmlField.TYPE_BYTE, -1, null, 396, 1);
            this.fmlBuffer[397] = new FmlField("PARINPFEATURE_CODE", FmlField.TYPE_STRING, 7, null, 397, 1);
            this.fmlBuffer[398] = new FmlField("PARINPSOC", FmlField.TYPE_STRING, 10, null, 398, 1);
            this.fmlBuffer[399] = new FmlField("SOC_DATE", FmlField.TYPE_STRING, 9, null, 399, 1);
            this.fmlBuffer[400] = new FmlField("CAS_PT_REQ", FmlField.TYPE_BYTE, -1, null, 400, 1);
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Integer get_ROW_COUNT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[162].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[160].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_SUSP_RC_RATE_TYPE(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[163].setValue(nIndex, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_MEMO_SOURCE(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[168].setValue(nIndex, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Double get_MEMO_AMT(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[180].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[178].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Double get_CHARGE_AMT(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[182].getValue(nIndex));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[180].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
    ...
    public void set_CHARGE_AMT_IND(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[181].setValue(nIndex, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public String get_WAIVE_IND(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[185].getValue(nIndex)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[183].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
    ...
    public void set_WAIVE_IND(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[185].setValue(nIndex, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[183].setValue(nIndex, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
    ...
    public Integer get_CUSTOMER_ID() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Integer) this.fmlBuffer[186].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Integer get_PCTNRECOPERATOR_ID() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Integer) this.fmlBuffer[189].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Integer get_DL_UPDATE_STAMP() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[194].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_DL_UPDATE_STAMP(Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[194].setValue(0, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public String get_SUB_STATUS() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[197].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_SUB_STATUS(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[197].setValue(0, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_PCTNRECCOMMIT_ORIG_NO_MONTH() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[208].getValue(0)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_PCTNRECCOMMIT_ORIG_NO_MONTH(Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[208].setValue(0, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Integer get_CNT_SEQ_NO() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[213].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[211].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Double get_REQ_DEPOSIT_AMT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Double) this.fmlBuffer[216].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public String get_PABX_IND() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[218].getValue(0)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_PABX_IND(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[218].setValue(0, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Integer get_NEXT_BAN() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[225].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Integer get_PRV_BAN() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[227].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[225].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
    ...
    public Double get_BASIC_WATCH_LMT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[235].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[233].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
    ...
    public Integer get_LIMIT_RESERVED_DAYS() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[238].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[236].getValue(0)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
    ...
    public void set_LIMIT_RESERVED_DAYS(Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[238].setValue(0, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[236].setValue(0, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
    ...
    public String get_LISTED_IND() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[242].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[240].getValue(0)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
    ...
    public void set_LISTED_IND(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[242].setValue(0, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[240].setValue(0, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
    ...
    public void set_LAST_SUBSCR_DISC_SN_UD(Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[247].setValue(0, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public String get_RMS_REF_TYPE() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[250].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[248].getValue(0)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_RMS_REF_TYPE(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[250].setValue(0, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[248].setValue(0, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Integer get_SUBSCRIBER_ID() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[254].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[252].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_IVR_WRONG_ACCESS_NO(Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[259].setValue(0, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[257].setValue(0, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
    ...
    public Double get_THRESHOLD_AMT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[260].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Double get_OPERATOR_CW_LMT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[265].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[263].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_CPS_TYPE(Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[269].setValue(0, TypeConverter.integerToShort(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public Double get_OPERATOR_TMP_LMT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[273].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[271].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_EARLY_PO_WAIVE_IND(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[278].setValue(0, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[276].setValue(0, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
    ...
    public Integer get_NAME_ID(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Integer) this.fmlBuffer[300].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Integer get_NAMERECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Integer) this.fmlBuffer[303].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Integer get_NAMERECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[306].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_NAMERECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[306].setValue(nIndex, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public String get_NAME_FORMAT(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[311].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_NAME_FORMAT(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[311].setValue(nIndex, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Double get_KOB(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Double) this.fmlBuffer[316].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Integer get_NAMERECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[319].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_NAMERECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[319].setValue(nIndex, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Integer get_ADDRESSRECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Integer) this.fmlBuffer[332].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return (TypeConverter.shortToInteger((Short) this.fmlBuffer[335].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_ADDRESSRECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[335].setValue(nIndex, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_ADDRESSRECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[355].setValue(nIndex, TypeConverter.integerToShort(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Double get_INSTALLMENT_AMT(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Double) this.fmlBuffer[372].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Integer get_PFTRDEPBUFROWCOUNT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Integer) this.fmlBuffer[374].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public String get_DEPOSIT_TYPE(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[375].getValue(nIndex)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_DEPOSIT_TYPE(int nIndex, String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[375].setValue(nIndex, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Double get_DEPOSIT_AMOUNT(int nIndex) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Double) this.fmlBuffer[376].getValue(nIndex));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public String get_FULLTABLE() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[377].getValue(0)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_FULLTABLE(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[377].setValue(0, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public String get_PAPER_WORK_TRNS_NO() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((String) this.fmlBuffer[384].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((String) this.fmlBuffer[382].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
    ...
    public String get_DELIVERY_TYPE() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[385].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[383].getValue(0)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_DELIVERY_TYPE(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[385].setValue(0, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[383].setValue(0, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Integer get_PARINPBAN() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[386].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[384].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Integer get_PARTITION_ROOT_BAN() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[387].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Integer) this.fmlBuffer[385].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public String get_PARINPSUBSCRIBER_NO() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((String) this.fmlBuffer[386].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public String get_PARINPSUB_MARKET_CODE() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((String) this.fmlBuffer[389].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_PARINPSUB_MARKET_CODE(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[389].setValue(0, value);
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[387].setValue(0, value);
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
    ...
    public Double get_ACTIVATION_AMOUNT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return ((Double) this.fmlBuffer[389].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public Double get_PREPAYMENT_AMOUNT() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[392].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((Double) this.fmlBuffer[390].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public String get_RC_ONLY_IND() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[392].getValue(0)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_RC_ONLY_IND(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            ...
            this.fmlBuffer[392].setValue(0, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public String get_PREP_EXMP_IND() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[397].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public void set_PREP_EXMP_IND(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[397].setValue(0, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public String get_SOURCE_APPL_CODE() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[398].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[396].getValue(0)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
    ...
    public void set_SOURCE_APPL_CODE(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[398].setValue(0, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[396].setValue(0, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
    ...
    public String get_PARINPFEATURE_CODE() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((String) this.fmlBuffer[399].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public String get_PARINPSOC() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((String) this.fmlBuffer[400].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((String) this.fmlBuffer[398].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_PARINPSOC(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[400].setValue(0, value);
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
    ...
    public String get_SOC_DATE() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return ((String) this.fmlBuffer[401].getValue(0));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return ((String) this.fmlBuffer[399].getValue(0));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
    ...
    public String get_CAS_PT_REQ() throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[402].getValue(0)));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            return (TypeConverter.byteToString((Byte) this.fmlBuffer[400].getValue(0)));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
    ...
    public void set_CAS_PT_REQ(String value) throws FMLManipulationException {
        if ("21.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[402].setValue(0, TypeConverter.stringToByte(value));
        } else if ("20.0.0.0".equals(this.getNinjaVersion())) {
            this.fmlBuffer[400].setValue(0, TypeConverter.stringToByte(value));
        } else {
            throw new FMLManipulationException("Current version (" + this.getNinjaVersion() + ") not supported by CsActvCtnOutput class");
        }
    }
