...
public class CvSvCtnAgrOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[33] = new FmlField("ERRORDESC", FmlField.TYPE_STRING, 2001, null, 33, 1);
        this.fmlBuffer[34] = new FmlField("PNPINFOBUFFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 34, 1);
        this.fmlBuffer[35] = new FmlField("NPNUMINFORECROWID", FmlField.TYPE_STRING, 19, null, 35, 500);
        this.fmlBuffer[36] = new FmlField("PORT_NUMBER", FmlField.TYPE_STRING, 21, null, 36, 500);
        this.fmlBuffer[37] = new FmlField("NPNUMINFORECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 37, 500);
        this.fmlBuffer[38] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 38, 500);
        this.fmlBuffer[39] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 39, 500);
        this.fmlBuffer[40] = new FmlField("NPNUMINFORECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 40, 500);
        this.fmlBuffer[41] = new FmlField("NPNUMINFORECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 41, 500);
        this.fmlBuffer[42] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 42, 500);
        this.fmlBuffer[43] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 43, 500);
        this.fmlBuffer[44] = new FmlField("NPNUMINFORECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 44, 500);
        this.fmlBuffer[45] = new FmlField("INT_ORDER_ID", FmlField.TYPE_DOUBLE, -1, null, 45, 500);
        this.fmlBuffer[46] = new FmlField("ORG_CUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 46, 500);
        this.fmlBuffer[47] = new FmlField("PORT_IND", FmlField.TYPE_BYTE, -1, null, 47, 500);
        this.fmlBuffer[48] = new FmlField("NUMBER_TYPE", FmlField.TYPE_BYTE, -1, null, 48, 500);
        this.fmlBuffer[49] = new FmlField("PORT_REQUEST_DATE", FmlField.TYPE_STRING, 15, null, 49, 500);
        this.fmlBuffer[50] = new FmlField("ORG_OPERATOR", FmlField.TYPE_STRING, 6, null, 50, 500);
        this.fmlBuffer[51] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 51, 500);
        this.fmlBuffer[52] = new FmlField("LAST_INT_ORD_ID", FmlField.TYPE_DOUBLE, -1, null, 52, 500);
        this.fmlBuffer[53] = new FmlField("FUNCTION_PORT_IND", FmlField.TYPE_BYTE, -1, null, 53, 500);
        this.fmlBuffer[54] = new FmlField("PASSIVE_IND", FmlField.TYPE_BYTE, -1, null, 54, 500);
        this.fmlBuffer[55] = new FmlField("AUTO_CONFIRM", FmlField.TYPE_BYTE, -1, null, 55, 500);
        this.fmlBuffer[56] = new FmlField("TEMPORARY_MSISDN", FmlField.TYPE_STRING, 21, null, 56, 500);
        this.fmlBuffer[57] = new FmlField("HANDLE_MODE", FmlField.TYPE_BYTE, -1, null, 57, 500);
        this.fmlBuffer[58] = new FmlField("SEND_IND", FmlField.TYPE_BYTE, -1, null, 58, 500);
        this.fmlBuffer[59] = new FmlField("ORDID_STR", FmlField.TYPE_STRING, 21, null, 59, 500);
        this.fmlBuffer[60] = new FmlField("LAST_ORDID_STR", FmlField.TYPE_STRING, 21, null, 60, 500);
        this.fmlBuffer[61] = new FmlField("ICC", FmlField.TYPE_STRING, 61, null, 61, 500);
        this.fmlBuffer[62] = new FmlField("CUSTOMER_NAME", FmlField.TYPE_STRING, 255, null, 62, 500);
        this.fmlBuffer[63] = new FmlField("NPINFOBUFFCUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 63, 500);
        this.fmlBuffer[64] = new FmlField("SERVICE_PROVIDER", FmlField.TYPE_STRING, 6, null, 64, 500);
    }
