 ...
 */
public class BlBilHisInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of BlBilHisInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public BlBilHisInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("blBilHis", 23);
        ...
        this.fmlBuffer[19] = new FmlField("BILL_DATE_INT", FmlField.TYPE_INTEGER, -1, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("BILL_CONF_STATUS", FmlField.TYPE_BYTE, -1, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("LAST_BILL", FmlField.TYPE_BYTE, -1, null, 21, 1);
    ...
    /**
     * Retrieves the value of the 'BILL_DATE_INT' field in the FML buffer.
     *
     * @return Value of 'BILL_DATE_INT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_BILL_DATE_INT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[19].getValue(0));
    }

    /**
     * Sets the value of the 'BILL_DATE_INT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_BILL_DATE_INT(Integer value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public String get_BILL_CONF_STATUS() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[20].getValue(0)));
    }

    /**
     * Sets the value of the 'BILL_CONF_STATUS' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_BILL_CONF_STATUS(String value) throws FMLManipulationException {
        this.fmlBuffer[20].setValue(0, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves the value of the 'LAST_BILL' field in the FML buffer.
     *
     * @return Value of 'LAST_BILL' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_LAST_BILL() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[21].getValue(0)));
    }

    /**
     * Sets the value of the 'LAST_BILL' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_LAST_BILL(String value) throws FMLManipulationException {
