 ...
 */
public class BlRprntReqOutput extends ServiceOutput {

    /**
     * Creates a new instance of BlRprntReqOutput.
     *
     * @throws FMLManipulationException
     */
    public BlRprntReqOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public BlRprntReqOutput() {
    }

    /**
     * Creates a new instance of BlRprntReqOutput.
     *
     * @param ds Output dataset from BlRprntReq service.
     * @throws FMLManipulationException
     */
    public BlRprntReqOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[17] = new FmlField("ROWID", FmlField.TYPE_STRING, 19, null, 17, 10);
        this.fmlBuffer[18] = new FmlField("BILL_FORMAT", FmlField.TYPE_STRING, 3, null, 18, 10);
        this.fmlBuffer[19] = new FmlField("FORMAT_DESC", FmlField.TYPE_STRING, 41, null, 19, 10);
    }
    ...
    /**
     * Retrieves the value of the 'BILL_FORMAT' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 10).
     * @return Value of 'BILL_FORMAT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_BILL_FORMAT(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[18].getValue(nIndex));
    }

    /**
     * Retrieves number of values defined for 'BILL_FORMAT' field in the FML buffer.
     *
     * @return Number of values defined for 'BILL_FORMAT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_BILL_FORMAT_size() throws FMLManipulationException {
