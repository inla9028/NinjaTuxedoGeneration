...
public class ArUpPymMtdInput extends ServiceInput {
    ...
    public ArUpPymMtdInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[25] = new FmlField("P1", FmlField.TYPE_STRING, 21, null, 25, 1);
        this.fmlBuffer[26] = new FmlField("P2", FmlField.TYPE_STRING, 21, null, 26, 1);
        this.fmlBuffer[27] = new FmlField("P3", FmlField.TYPE_STRING, 21, null, 27, 1);
        this.fmlBuffer[28] = new FmlField("P4", FmlField.TYPE_STRING, 21, null, 28, 1);
        this.fmlBuffer[29] = new FmlField("P5", FmlField.TYPE_STRING, 21, null, 29, 1);
        this.fmlBuffer[30] = new FmlField("P6", FmlField.TYPE_STRING, 21, null, 30, 1);
        this.fmlBuffer[31] = new FmlField("P7", FmlField.TYPE_STRING, 21, null, 31, 1);
        this.fmlBuffer[32] = new FmlField("P8", FmlField.TYPE_STRING, 21, null, 32, 1);
        this.fmlBuffer[33] = new FmlField("P9", FmlField.TYPE_STRING, 21, null, 33, 1);
        this.fmlBuffer[34] = new FmlField("P10", FmlField.TYPE_STRING, 21, null, 34, 1);
