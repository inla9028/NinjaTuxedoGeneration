 ...
 */
public class CsSrchNmPrmInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsSrchNmPrmInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsSrchNmPrmInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csSrchNmPrm", 23);
        ...
        this.fmlBuffer[17] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("TREE_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("EXACT_NAME_IND", FmlField.TYPE_BYTE, -1, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("SRCHTPIND", FmlField.TYPE_BYTE, -1, null, 22, 1);
    }
    ...
    /**
     * Sets the value of the 'TREE_ROOT_BAN' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_TREE_ROOT_BAN(Integer value) throws FMLManipulationException {
        this.fmlBuffer[20].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'EXACT_NAME_IND' field in the FML buffer.
     *
     * @return Value of 'EXACT_NAME_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_EXACT_NAME_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[21].getValue(0)));
    }

    /**
     * Sets the value of the 'EXACT_NAME_IND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_EXACT_NAME_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[21].setValue(0, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves the value of the 'SRCHTPIND' field in the FML buffer.
     *
     * @return Value of 'SRCHTPIND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_SRCHTPIND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[22].getValue(0)));
    }

    /**
     * Sets the value of the 'SRCHTPIND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_SRCHTPIND(String value) throws FMLManipulationException {
