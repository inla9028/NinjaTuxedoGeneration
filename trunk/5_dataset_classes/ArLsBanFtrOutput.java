...
public class ArLsBanFtrOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[52] = new FmlField("FTR_ADD_SW_PRM_TRUNC", FmlField.TYPE_STRING, 301, null, 52, 400);
        this.fmlBuffer[53] = new FmlField("FTR_ADD_SW_PRM_LEN", FmlField.TYPE_INTEGER, -1, null, 53, 400);
        this.fmlBuffer[54] = new FmlField("FEATURE_DESC", FmlField.TYPE_STRING, 101, null, 54, 400);
        this.fmlBuffer[55] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, null, 55, 400);
        this.fmlBuffer[56] = new FmlField("RC_INFO_IND", FmlField.TYPE_BYTE, -1, null, 56, 400);
        this.fmlBuffer[57] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, null, 57, 400);
        this.fmlBuffer[58] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 58, 400);
        this.fmlBuffer[59] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, null, 59, 400);
        this.fmlBuffer[60] = new FmlField("DCI_ERROR_CODE", FmlField.TYPE_INTEGER, -1, null, 60, 1);
        this.fmlBuffer[61] = new FmlField("DCI_ERROR_TYPE", FmlField.TYPE_SHORT, -1, null, 61, 1);
        this.fmlBuffer[62] = new FmlField("DCI_ERROR_TEXT", FmlField.TYPE_STRING, 81, null, 62, 1);
        this.fmlBuffer[63] = new FmlField("DCI_ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 63, 1);
        this.fmlBuffer[64] = new FmlField("DCI_MORE_ROWS", FmlField.TYPE_SHORT, -1, null, 64, 1);
    }
