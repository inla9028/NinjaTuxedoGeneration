 ...
 */
public class CsMoveMlCtnInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsMoveMlCtnInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsMoveMlCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csMoveMlCtn", 49);
        ...
        this.fmlBuffer[17] = new FmlField("TARGETBAN", FmlField.TYPE_INTEGER, -1, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("FIRSTCALLIND", FmlField.TYPE_BYTE, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("LASTCALLIND", FmlField.TYPE_BYTE, -1, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 21, 50);
        this.fmlBuffer[22] = new FmlField("MOVE_RESULT", FmlField.TYPE_BYTE, -1, null, 22, 50);
        ...
        this.fmlBuffer[46] = new FmlField("ACTIVITY_DATE", FmlField.TYPE_STRING, 9, null, 46, 1);
    ...
    /**
     * Retrieves the value of the 'FIRSTCALLIND' field in the FML buffer.
     *
     * @return Value of 'FIRSTCALLIND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_FIRSTCALLIND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[18].getValue(0)));
    }

    /**
     * Sets the value of the 'FIRSTCALLIND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_FIRSTCALLIND(String value) throws FMLManipulationException {
        this.fmlBuffer[18].setValue(0, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves the value of the 'LASTCALLIND' field in the FML buffer.
     *
     * @return Value of 'LASTCALLIND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_LASTCALLIND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[19].getValue(0)));
    }

    /**
     * Sets the value of the 'LASTCALLIND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_LASTCALLIND(String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'MOVE_RESULT' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 50).
     * @return Value of 'MOVE_RESULT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_MOVE_RESULT(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[22].getValue(nIndex)));
    }

    /**
     * Sets the value of the 'MOVE_RESULT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 50).
     * @throws FMLManipulationException
     */
    public void set_MOVE_RESULT(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[22].setValue(nIndex, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves number of values defined for 'MOVE_RESULT' field in the FML buffer.
     *
     * @return Number of values defined for 'MOVE_RESULT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_MOVE_RESULT_size() throws FMLManipulationException {
