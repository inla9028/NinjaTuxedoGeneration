...
public class CsLsSrvAgrOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[28] = new FmlField("SOC_ROWID", FmlField.TYPE_STRING, 19, null, 28, 600);
        this.fmlBuffer[29] = new FmlField("SALE_EFF_DATE", FmlField.TYPE_STRING, 9, null, 29, 600);
        this.fmlBuffer[30] = new FmlField("SALE_EXP_DATE", FmlField.TYPE_STRING, 9, null, 30, 600);
        this.fmlBuffer[31] = new FmlField("MINIMUM_NO_MONTHS", FmlField.TYPE_SHORT, -1, null, 31, 600);
        this.fmlBuffer[32] = new FmlField("SOC_DESCRIPTION", FmlField.TYPE_STRING, 31, null, 32, 600);
        this.fmlBuffer[33] = new FmlField("SOC_GROUP", FmlField.TYPE_STRING, 7, null, 33, 600);
        this.fmlBuffer[34] = new FmlField("PRMT_ROWID", FmlField.TYPE_STRING, 19, null, 34, 600);
        this.fmlBuffer[35] = new FmlField("PT_DURATION", FmlField.TYPE_SHORT, -1, null, 35, 600);
        this.fmlBuffer[36] = new FmlField("DURATION_IND", FmlField.TYPE_BYTE, -1, null, 36, 600);
        this.fmlBuffer[37] = new FmlField("PP_IND", FmlField.TYPE_BYTE, -1, null, 37, 600);
        this.fmlBuffer[38] = new FmlField("AUTO_RENEWAL_IND", FmlField.TYPE_BYTE, -1, null, 38, 600);
        this.fmlBuffer[39] = new FmlField("CUT_DATE", FmlField.TYPE_STRING, 9, null, 39, 600);
        this.fmlBuffer[40] = new FmlField("TRS_ROWID", FmlField.TYPE_STRING, 19, null, 40, 600);
        this.fmlBuffer[41] = new FmlField("TRS_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 41, 600);
        this.fmlBuffer[42] = new FmlField("TRS_SOC", FmlField.TYPE_STRING, 10, null, 42, 600);
        this.fmlBuffer[43] = new FmlField("CALL_TYPE_CODE", FmlField.TYPE_BYTE, -1, null, 43, 600);
        this.fmlBuffer[44] = new FmlField("TOLL_RS_DESC", FmlField.TYPE_STRING, 31, null, 44, 600);
    }
