 ...
 */
public class GnLsUtcDscOutput extends ServiceOutput {

    /**
     * Creates a new instance of GnLsUtcDscOutput.
     *
     * @throws FMLManipulationException
     */
    public GnLsUtcDscOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public GnLsUtcDscOutput() {
    }

    /**
     * Creates a new instance of GnLsUtcDscOutput.
     *
     * @param ds Output dataset from GnLsUtcDsc service.
     * @throws FMLManipulationException
     */
    public GnLsUtcDscOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[16] = new FmlField("DISCCOUNT", FmlField.TYPE_INTEGER, -1, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("UTCCOUNT", FmlField.TYPE_INTEGER, -1, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("ROWID", FmlField.TYPE_STRING, 19, null, 18, 100);
        this.fmlBuffer[19] = new FmlField("DISCOUNT_GROUP_CODE", FmlField.TYPE_STRING, 7, null, 19, 100);
        this.fmlBuffer[20] = new FmlField("DISC_GROUP_DESC", FmlField.TYPE_STRING, 41, null, 20, 100);
        this.fmlBuffer[21] = new FmlField("TREE_LEVEL", FmlField.TYPE_SHORT, -1, null, 21, 100);
        this.fmlBuffer[22] = new FmlField("POTENTIAL_SUBS_NO", FmlField.TYPE_INTEGER, -1, null, 22, 100);
        this.fmlBuffer[23] = new FmlField("LAST_POTENT_DATE", FmlField.TYPE_STRING, 9, null, 23, 100);
        this.fmlBuffer[24] = new FmlField("PGNUTCPLANARRAYROWID", FmlField.TYPE_STRING, 19, null, 24, 100);
        this.fmlBuffer[25] = new FmlField("UTC_PLAN_CODE", FmlField.TYPE_STRING, 10, null, 25, 100);
        this.fmlBuffer[26] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 26, 100);
        this.fmlBuffer[27] = new FmlField("EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 27, 100);
        this.fmlBuffer[28] = new FmlField("UTC_PLAN_DESC", FmlField.TYPE_STRING, 31, null, 28, 100);
        this.fmlBuffer[29] = new FmlField("PGNUTCPLANARRAYTREE_LEVEL", FmlField.TYPE_SHORT, -1, null, 29, 100);
    }
    ...
    /**
     * Retrieves the value of the 'DISCCOUNT' field in the FML buffer.
     *
     * @return Value of 'DISCCOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_DISCCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[16].getValue(0));
    }

    /**
     * Retrieves the value of the 'UTCCOUNT' field in the FML buffer.
     *
     * @return Value of 'UTCCOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_UTCCOUNT() throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'PGNUTCPLANARRAYROWID' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PGNUTCPLANARRAYROWID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PGNUTCPLANARRAYROWID(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[24].getValue(nIndex));
    }

    /**
     * Retrieves number of values defined for 'PGNUTCPLANARRAYROWID' field in the FML buffer.
     *
     * @return Number of values defined for 'PGNUTCPLANARRAYROWID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PGNUTCPLANARRAYROWID_size() throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public String get_UTC_PLAN_DESC(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[28].getValue(nIndex));
    }

    /**
     * Retrieves number of values defined for 'UTC_PLAN_DESC' field in the FML buffer.
     *
     * @return Number of values defined for 'UTC_PLAN_DESC' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_UTC_PLAN_DESC_size() throws FMLManipulationException {
        return (this.fmlBuffer[28].getCount());
    }

    /**
     * Retrieves the value of the 'PGNUTCPLANARRAYTREE_LEVEL' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PGNUTCPLANARRAYTREE_LEVEL' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PGNUTCPLANARRAYTREE_LEVEL(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[29].getValue(nIndex)));
    }

    /**
     * Retrieves number of values defined for 'PGNUTCPLANARRAYTREE_LEVEL' field in the FML buffer.
     *
     * @return Number of values defined for 'PGNUTCPLANARRAYTREE_LEVEL' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PGNUTCPLANARRAYTREE_LEVEL_size() throws FMLManipulationException {
