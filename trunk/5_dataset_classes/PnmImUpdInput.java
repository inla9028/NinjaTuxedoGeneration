 ...
 */
public class PnmImUpdInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of PnmImUpdInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public PnmImUpdInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("pnmImUpd", 30);
        ...
        this.fmlBuffer[16] = new FmlField("NGP", FmlField.TYPE_STRING, 4, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("FROM_CTN", FmlField.TYPE_STRING, 21, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("TO_CTN", FmlField.TYPE_STRING, 21, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("CTN_PATTERN", FmlField.TYPE_STRING, 21, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("QUANTITY", FmlField.TYPE_INTEGER, -1, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("FROM_STATUS", FmlField.TYPE_STRING, 3, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("TO_STATUS", FmlField.TYPE_STRING, 3, null, 22, 1);
        this.fmlBuffer[23] = new FmlField("FROM_NL", FmlField.TYPE_STRING, 4, null, 23, 1);
        this.fmlBuffer[24] = new FmlField("TO_NL", FmlField.TYPE_STRING, 4, null, 24, 1);
        this.fmlBuffer[25] = new FmlField("LAST_TRX_CODE", FmlField.TYPE_STRING, 4, null, 25, 1);
        this.fmlBuffer[26] = new FmlField("CONTIGUITY_IND", FmlField.TYPE_BYTE, -1, null, 26, 1);
        this.fmlBuffer[27] = new FmlField("ROW_COUNTER", FmlField.TYPE_INTEGER, -1, null, 27, 1);
        this.fmlBuffer[28] = new FmlField("CTN", FmlField.TYPE_STRING, 21, null, 28, 1000);
        this.fmlBuffer[29] = new FmlField("REASON", FmlField.TYPE_STRING, 31, null, 29, 1);
    }
    ...
    /**
     * Sets the value of the 'NGP' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_NGP(String value) throws FMLManipulationException {
    ...
    /**
     * Sets the value of the 'FROM_CTN' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_FROM_CTN(String value) throws FMLManipulationException {
    ...
    /**
     * Sets the value of the 'TO_CTN' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_TO_CTN(String value) throws FMLManipulationException {
        this.fmlBuffer[18].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'CTN_PATTERN' field in the FML buffer.
     *
     * @return Value of 'CTN_PATTERN' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_CTN_PATTERN() throws FMLManipulationException {
        return ((String) this.fmlBuffer[19].getValue(0));
    }

    /**
     * Sets the value of the 'CTN_PATTERN' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_CTN_PATTERN(String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public Integer get_QUANTITY() throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_QUANTITY(Integer value) throws FMLManipulationException {
        this.fmlBuffer[20].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'FROM_STATUS' field in the FML buffer.
     *
     * @return Value of 'FROM_STATUS' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_FROM_STATUS() throws FMLManipulationException {
        return ((String) this.fmlBuffer[21].getValue(0));
    }

    /**
     * Sets the value of the 'FROM_STATUS' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 3.
     * @throws FMLManipulationException
     */
    public void set_FROM_STATUS(String value) throws FMLManipulationException {
        this.fmlBuffer[21].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'TO_STATUS' field in the FML buffer.
     *
     * @return Value of 'TO_STATUS' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_TO_STATUS() throws FMLManipulationException {
        return ((String) this.fmlBuffer[22].getValue(0));
    }

    /**
     * Sets the value of the 'TO_STATUS' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 3.
     * @throws FMLManipulationException
     */
    public void set_TO_STATUS(String value) throws FMLManipulationException {
        this.fmlBuffer[22].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'FROM_NL' field in the FML buffer.
     *
     * @return Value of 'FROM_NL' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_FROM_NL() throws FMLManipulationException {
        return ((String) this.fmlBuffer[23].getValue(0));
    }

    /**
     * Sets the value of the 'FROM_NL' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_FROM_NL(String value) throws FMLManipulationException {
        this.fmlBuffer[23].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'TO_NL' field in the FML buffer.
     *
     * @return Value of 'TO_NL' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_TO_NL() throws FMLManipulationException {
        return ((String) this.fmlBuffer[24].getValue(0));
    }

    /**
     * Sets the value of the 'TO_NL' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_TO_NL(String value) throws FMLManipulationException {
    ...
    /**
     * Sets the value of the 'LAST_TRX_CODE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_LAST_TRX_CODE(String value) throws FMLManipulationException {
        this.fmlBuffer[25].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'CONTIGUITY_IND' field in the FML buffer.
     *
     * @return Value of 'CONTIGUITY_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_CONTIGUITY_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[26].getValue(0)));
    }

    /**
     * Sets the value of the 'CONTIGUITY_IND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_CONTIGUITY_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[26].setValue(0, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves the value of the 'ROW_COUNTER' field in the FML buffer.
     *
     * @return Value of 'ROW_COUNTER' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_ROW_COUNTER() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[27].getValue(0));
    }

    /**
     * Sets the value of the 'ROW_COUNTER' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_ROW_COUNTER(Integer value) throws FMLManipulationException {
    ...
    /**
     * Sets the value of the 'REASON' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 31.
     * @throws FMLManipulationException
     */
    public void set_REASON(String value) throws FMLManipulationException {
