 ...
 * @author  Ninja
 *
 * ClGtColHistInput class.
 */
public class ClGtColHistInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of ClGtColHistInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public ClGtColHistInput() throws EnvironmentException, FMLManipulationException {
        // Initialize FML buffer
        fmlBuffer = new FmlField[17];

        // Get default values from DB
        synchronized (this.defaultValuesPopulated) {
            if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
                defaultValues = getDefaultValues("clGtColHist", 17);
