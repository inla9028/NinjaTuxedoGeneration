 ...
 */
public class GnChkAdrVldInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of GnChkAdrVldInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public GnChkAdrVldInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("gnChkAdrVld", 23);
        ...
        this.fmlBuffer[16] = new FmlField("ZIP", FmlField.TYPE_STRING, 10, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("CITY", FmlField.TYPE_STRING, 40, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("ADDRTYPE", FmlField.TYPE_BYTE, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("STREETNAME", FmlField.TYPE_STRING, 61, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("HOUSENO", FmlField.TYPE_STRING, 21, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("LETTER", FmlField.TYPE_STRING, 3, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("POB", FmlField.TYPE_STRING, 11, null, 22, 1);
    }
    ...
    /**
     * Retrieves the value of the 'ZIP' field in the FML buffer.
     *
     * @return Value of 'ZIP' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_ZIP() throws FMLManipulationException {
        return ((String) this.fmlBuffer[16].getValue(0));
    }

    /**
     * Sets the value of the 'ZIP' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 10.
     * @throws FMLManipulationException
     */
    public void set_ZIP(String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public String get_CITY() throws FMLManipulationException {
        return ((String) this.fmlBuffer[17].getValue(0));
    }

    /**
     * Sets the value of the 'CITY' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 40.
     * @throws FMLManipulationException
     */
    public void set_CITY(String value) throws FMLManipulationException {
        this.fmlBuffer[17].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'ADDRTYPE' field in the FML buffer.
     *
     * @return Value of 'ADDRTYPE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_ADDRTYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[18].getValue(0)));
    }

    /**
     * Sets the value of the 'ADDRTYPE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_ADDRTYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[18].setValue(0, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves the value of the 'STREETNAME' field in the FML buffer.
     *
     * @return Value of 'STREETNAME' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_STREETNAME() throws FMLManipulationException {
        return ((String) this.fmlBuffer[19].getValue(0));
    }

    /**
     * Sets the value of the 'STREETNAME' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 61.
     * @throws FMLManipulationException
     */
    public void set_STREETNAME(String value) throws FMLManipulationException {
        this.fmlBuffer[19].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'HOUSENO' field in the FML buffer.
     *
     * @return Value of 'HOUSENO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_HOUSENO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[20].getValue(0));
    }

    /**
     * Sets the value of the 'HOUSENO' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_HOUSENO(String value) throws FMLManipulationException {
        this.fmlBuffer[20].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'LETTER' field in the FML buffer.
     *
     * @return Value of 'LETTER' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_LETTER() throws FMLManipulationException {
        return ((String) this.fmlBuffer[21].getValue(0));
    }

    /**
     * Sets the value of the 'LETTER' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 3.
     * @throws FMLManipulationException
     */
    public void set_LETTER(String value) throws FMLManipulationException {
        this.fmlBuffer[21].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'POB' field in the FML buffer.
     *
     * @return Value of 'POB' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_POB() throws FMLManipulationException {
        return ((String) this.fmlBuffer[22].getValue(0));
    }

    /**
     * Sets the value of the 'POB' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 11.
     * @throws FMLManipulationException
     */
    public void set_POB(String value) throws FMLManipulationException {
