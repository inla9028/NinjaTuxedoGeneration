...
public class GnLsFtrTrxOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[14] = new FmlField("CFR_P1", FmlField.TYPE_STRING, 21, null, 14, 50);
        this.fmlBuffer[15] = new FmlField("CFR_P2", FmlField.TYPE_STRING, 21, null, 15, 50);
        this.fmlBuffer[16] = new FmlField("CFR_P3", FmlField.TYPE_STRING, 21, null, 16, 50);
        this.fmlBuffer[17] = new FmlField("CFR_P4", FmlField.TYPE_STRING, 21, null, 17, 50);
        this.fmlBuffer[18] = new FmlField("CFR_P5", FmlField.TYPE_STRING, 21, null, 18, 50);
        this.fmlBuffer[19] = new FmlField("CFR_P6", FmlField.TYPE_STRING, 21, null, 19, 50);
        this.fmlBuffer[20] = new FmlField("CFR_P7", FmlField.TYPE_STRING, 21, null, 20, 50);
        this.fmlBuffer[21] = new FmlField("CFR_P8", FmlField.TYPE_STRING, 21, null, 21, 50);
        this.fmlBuffer[22] = new FmlField("CFR_P9", FmlField.TYPE_STRING, 21, null, 22, 50);
        this.fmlBuffer[23] = new FmlField("CFR_P10", FmlField.TYPE_STRING, 21, null, 23, 50);
