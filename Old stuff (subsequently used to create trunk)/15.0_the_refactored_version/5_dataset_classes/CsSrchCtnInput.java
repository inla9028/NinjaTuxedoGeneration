 ...
 */
public class CsSrchCtnInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsSrchCtnInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsSrchCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csSrchCtn", 23);
        ...
        this.fmlBuffer[16] = new FmlField("SUBNO", FmlField.TYPE_STRING, 21, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("ADDITIONAL_SUBNO", FmlField.TYPE_STRING, 21, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("PRODTP_ARR", FmlField.TYPE_STRING, 4, null, 18, 10);
        this.fmlBuffer[19] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("DEPARTMENT_CODE", FmlField.TYPE_STRING, 5, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 22, 1);
    }
    ...
    /**
     * Retrieves the value of the 'ADDITIONAL_SUBNO' field in the FML buffer.
     *
     * @return Value of 'ADDITIONAL_SUBNO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_ADDITIONAL_SUBNO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[17].getValue(0));
    }

    /**
     * Sets the value of the 'ADDITIONAL_SUBNO' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_ADDITIONAL_SUBNO(String value) throws FMLManipulationException {
        this.fmlBuffer[17].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PRODTP_ARR' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 10).
     * @return Value of 'PRODTP_ARR' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PRODTP_ARR(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[18].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PRODTP_ARR' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 10).
     * @throws FMLManipulationException
     */
    public void set_PRODTP_ARR(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[18].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PRODTP_ARR' field in the FML buffer.
     *
     * @return Number of values defined for 'PRODTP_ARR' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PRODTP_ARR_size() throws FMLManipulationException {
    ...
    /**
     * Sets the value of the 'DEPARTMENT_CODE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 5.
     * @throws FMLManipulationException
     */
    public void set_DEPARTMENT_CODE(String value) throws FMLManipulationException {
