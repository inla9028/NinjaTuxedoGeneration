 ...
 */
public class CsSrchAgrNoOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsSrchAgrNoOutput.
     *
     * @throws FMLManipulationException
     */
    public CsSrchAgrNoOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsSrchAgrNoOutput() {
    }

    /**
     * Creates a new instance of CsSrchAgrNoOutput.
     *
     * @param ds Output dataset from CsSrchAgrNo service.
     * @throws FMLManipulationException
     */
    public CsSrchAgrNoOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[33] = new FmlField("ADNMLN_ROWID", FmlField.TYPE_STRING, 19, null, 33, 100);
        ...
        this.fmlBuffer[44] = new FmlField("ACTUALSIZE", FmlField.TYPE_INTEGER, -1, null, 44, 1);
    }
    ...
    /**
     * Retrieves the value of the 'ADNMLN_ROWID' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'ADNMLN_ROWID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_ADNMLN_ROWID(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[33].getValue(nIndex));
    }

    /**
     * Retrieves number of values defined for 'ADNMLN_ROWID' field in the FML buffer.
     *
     * @return Number of values defined for 'ADNMLN_ROWID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_ADNMLN_ROWID_size() throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'ACTUALSIZE' field in the FML buffer.
     *
     * @return Value of 'ACTUALSIZE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_ACTUALSIZE() throws FMLManipulationException {
