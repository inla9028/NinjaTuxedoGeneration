 ...
 */
public class MmMemoLsInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of MmMemoLsInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public MmMemoLsInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("mmMemoLs", 27);
        ...
        this.fmlBuffer[18] = new FmlField("MEMO_TYPE", FmlField.TYPE_STRING, 5, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("MEMO_ID", FmlField.TYPE_INTEGER, -1, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("PAGE_NO", FmlField.TYPE_INTEGER, -1, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("PAGE_SIZE", FmlField.TYPE_INTEGER, -1, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 22, 1);
        this.fmlBuffer[23] = new FmlField("MEMO_CATEGORY", FmlField.TYPE_STRING, 5, null, 23, 1);
        this.fmlBuffer[24] = new FmlField("FROM_DATE", FmlField.TYPE_STRING, 15, null, 24, 1);
        this.fmlBuffer[25] = new FmlField("TO_DATE", FmlField.TYPE_STRING, 15, null, 25, 1);
        this.fmlBuffer[26] = new FmlField("VIP_MEMO_IND", FmlField.TYPE_BYTE, -1, null, 26, 1);
    }
    ...
    /**
     * Retrieves the value of the 'PAGE_SIZE' field in the FML buffer.
     *
     * @return Value of 'PAGE_SIZE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PAGE_SIZE() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[21].getValue(0));
    }

    /**
     * Sets the value of the 'PAGE_SIZE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PAGE_SIZE(Integer value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'MEMO_CATEGORY' field in the FML buffer.
     *
     * @return Value of 'MEMO_CATEGORY' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_MEMO_CATEGORY() throws FMLManipulationException {
        return ((String) this.fmlBuffer[23].getValue(0));
    }

    /**
     * Sets the value of the 'MEMO_CATEGORY' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 5.
     * @throws FMLManipulationException
     */
    public void set_MEMO_CATEGORY(String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'VIP_MEMO_IND' field in the FML buffer.
     *
     * @return Value of 'VIP_MEMO_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_VIP_MEMO_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[26].getValue(0)));
    }

    /**
     * Sets the value of the 'VIP_MEMO_IND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_VIP_MEMO_IND(String value) throws FMLManipulationException {
