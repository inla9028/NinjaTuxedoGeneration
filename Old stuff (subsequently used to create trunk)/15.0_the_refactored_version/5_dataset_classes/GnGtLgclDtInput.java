 ...
 */
public class GnGtLgclDtInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of GnGtLgclDtInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public GnGtLgclDtInput() throws EnvironmentException, FMLManipulationException {
        // Initialise FML buffer
        fmlBuffer = new FmlField[16];

        //// Get default values from DB
        //synchronized (this.defaultValuesPopulated) {
        //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
        //        defaultValues = getDefaultValues("gnGtLgclDt", 16);
