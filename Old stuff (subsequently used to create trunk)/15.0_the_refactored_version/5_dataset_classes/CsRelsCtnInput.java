...
public class CsRelsCtnInput extends ServiceInput {
    ...
    public CsRelsCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[113] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, "999999999.99", 113, 1);
        ...
        this.fmlBuffer[129] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 129, 1);
        this.fmlBuffer[130] = new FmlField("NPNUMINFORECROWID", FmlField.TYPE_STRING, 19, null, 130, 500);
        this.fmlBuffer[131] = new FmlField("PORT_NUMBER", FmlField.TYPE_STRING, 21, null, 131, 500);
        this.fmlBuffer[132] = new FmlField("NPNUMINFORECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 132, 500);
        this.fmlBuffer[133] = new FmlField("NPNUMINFORECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 133, 500);
        this.fmlBuffer[134] = new FmlField("NPNUMINFORECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 134, 500);
        this.fmlBuffer[135] = new FmlField("NPNUMINFORECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 135, 500);
        this.fmlBuffer[136] = new FmlField("NPNUMINFORECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 136, 500);
        this.fmlBuffer[137] = new FmlField("NPNUMINFORECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 137, 500);
        this.fmlBuffer[138] = new FmlField("NPNUMINFORECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 138, 500);
        this.fmlBuffer[139] = new FmlField("EXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 139, 500);
        this.fmlBuffer[140] = new FmlField("INT_ORDER_ID", FmlField.TYPE_DOUBLE, -1, null, 140, 500);
        this.fmlBuffer[141] = new FmlField("ORG_CUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 141, 500);
        this.fmlBuffer[142] = new FmlField("PORT_IND", FmlField.TYPE_BYTE, -1, null, 142, 500);
        this.fmlBuffer[143] = new FmlField("NUMBER_TYPE", FmlField.TYPE_BYTE, -1, null, 143, 500);
        this.fmlBuffer[144] = new FmlField("PORT_REQUEST_DATE", FmlField.TYPE_STRING, 15, null, 144, 500);
        this.fmlBuffer[145] = new FmlField("ORG_OPERATOR", FmlField.TYPE_STRING, 6, null, 145, 500);
        this.fmlBuffer[146] = new FmlField("NPNUMINFORECSUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 146, 500);
        this.fmlBuffer[147] = new FmlField("LAST_INT_ORD_ID", FmlField.TYPE_DOUBLE, -1, null, 147, 500);
        this.fmlBuffer[148] = new FmlField("FUNCTION_PORT_IND", FmlField.TYPE_BYTE, -1, null, 148, 500);
        this.fmlBuffer[149] = new FmlField("PASSIVE_IND", FmlField.TYPE_BYTE, -1, null, 149, 500);
        this.fmlBuffer[150] = new FmlField("AUTO_CONFIRM", FmlField.TYPE_BYTE, -1, null, 150, 500);
        this.fmlBuffer[151] = new FmlField("TEMPORARY_MSISDN", FmlField.TYPE_STRING, 21, null, 151, 500);
        this.fmlBuffer[152] = new FmlField("HANDLE_MODE", FmlField.TYPE_BYTE, -1, null, 152, 500);
        this.fmlBuffer[153] = new FmlField("SEND_IND", FmlField.TYPE_BYTE, -1, null, 153, 500);
        this.fmlBuffer[154] = new FmlField("ORDID_STR", FmlField.TYPE_STRING, 21, null, 154, 500);
        this.fmlBuffer[155] = new FmlField("LAST_ORDID_STR", FmlField.TYPE_STRING, 21, null, 155, 500);
        this.fmlBuffer[156] = new FmlField("ICC", FmlField.TYPE_STRING, 61, null, 156, 500);
        this.fmlBuffer[157] = new FmlField("CUSTOMER_NAME", FmlField.TYPE_STRING, 255, null, 157, 500);
        this.fmlBuffer[158] = new FmlField("NPINFOBUFFCUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 158, 500);
        this.fmlBuffer[159] = new FmlField("SERVICE_PROVIDER", FmlField.TYPE_STRING, 6, null, 159, 500);
    }
    ...
    public void set_NPNUMINFORECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[138].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_INT_ORDER_ID(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[140].getValue(nIndex));
    }
    ...
    public Double get_LAST_INT_ORD_ID(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[147].getValue(nIndex));
    }
