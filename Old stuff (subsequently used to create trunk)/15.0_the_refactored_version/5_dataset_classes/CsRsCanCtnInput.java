...
public class CsRsCanCtnInput extends ServiceInput {
    ...
    public CsRsCanCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[273] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 273, 1);
        this.fmlBuffer[274] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 274, 1);
        this.fmlBuffer[275] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 275, 1);
        this.fmlBuffer[276] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 276, 1);
        this.fmlBuffer[277] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 277, 1);
        this.fmlBuffer[278] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 278, 1);
        this.fmlBuffer[279] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 279, 1);
        ...
        this.fmlBuffer[373] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 373, 1);
