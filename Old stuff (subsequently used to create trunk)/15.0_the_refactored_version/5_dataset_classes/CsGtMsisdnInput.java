 ...
 */
public class CsGtMsisdnInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsGtMsisdnInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsGtMsisdnInput() throws EnvironmentException, FMLManipulationException {
        // Initialise FML buffer
        fmlBuffer = new FmlField[19];

        //// Get default values from DB
        //synchronized (this.defaultValuesPopulated) {
        //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
        //        defaultValues = getDefaultValues("csGtMsisdn", 19);
        ...
        this.fmlBuffer[16] = new FmlField("MSISDN_NO", FmlField.TYPE_STRING, 21, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("SIMCARD_NO", FmlField.TYPE_STRING, 21, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("DEALER_ID", FmlField.TYPE_STRING, 6, null, 18, 1);
    }
    ...
    /**
     * Retrieves the value of the 'MSISDN_NO' field in the FML buffer.
     *
     * @return Value of 'MSISDN_NO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_MSISDN_NO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[16].getValue(0));
    }

    /**
     * Sets the value of the 'MSISDN_NO' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_MSISDN_NO(String value) throws FMLManipulationException {
        this.fmlBuffer[16].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'SIMCARD_NO' field in the FML buffer.
     *
     * @return Value of 'SIMCARD_NO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_SIMCARD_NO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[17].getValue(0));
    }

    /**
     * Sets the value of the 'SIMCARD_NO' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_SIMCARD_NO(String value) throws FMLManipulationException {
        this.fmlBuffer[17].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'DEALER_ID' field in the FML buffer.
     *
     * @return Value of 'DEALER_ID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_DEALER_ID() throws FMLManipulationException {
        return ((String) this.fmlBuffer[18].getValue(0));
    }

    /**
     * Sets the value of the 'DEALER_ID' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 6.
     * @throws FMLManipulationException
     */
    public void set_DEALER_ID(String value) throws FMLManipulationException {
