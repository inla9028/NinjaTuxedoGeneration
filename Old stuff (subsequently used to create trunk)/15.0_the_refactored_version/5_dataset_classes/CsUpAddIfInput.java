 ...
 */
public class CsUpAddIfInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsUpAddIfInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsUpAddIfInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csUpAddIf", 44);
        ...
        this.fmlBuffer[19] = new FmlField("FIELD_NAME", FmlField.TYPE_STRING, 31, null, 19, 500);
        this.fmlBuffer[20] = new FmlField("FIELD_VALUE", FmlField.TYPE_STRING, 256, null, 20, 500);
        ...
        this.fmlBuffer[28] = new FmlField("P1", FmlField.TYPE_STRING, 21, null, 28, 1);
        this.fmlBuffer[29] = new FmlField("P2", FmlField.TYPE_STRING, 21, null, 29, 1);
        this.fmlBuffer[30] = new FmlField("P3", FmlField.TYPE_STRING, 21, null, 30, 1);
        this.fmlBuffer[31] = new FmlField("P4", FmlField.TYPE_STRING, 21, null, 31, 1);
        this.fmlBuffer[32] = new FmlField("P5", FmlField.TYPE_STRING, 21, null, 32, 1);
        this.fmlBuffer[33] = new FmlField("P6", FmlField.TYPE_STRING, 21, null, 33, 1);
        this.fmlBuffer[34] = new FmlField("P7", FmlField.TYPE_STRING, 21, null, 34, 1);
        this.fmlBuffer[35] = new FmlField("P8", FmlField.TYPE_STRING, 21, null, 35, 1);
        this.fmlBuffer[36] = new FmlField("P9", FmlField.TYPE_STRING, 21, null, 36, 1);
        this.fmlBuffer[37] = new FmlField("P10", FmlField.TYPE_STRING, 21, null, 37, 1);
