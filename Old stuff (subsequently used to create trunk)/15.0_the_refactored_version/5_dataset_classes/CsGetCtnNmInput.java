...
public class CsGetCtnNmInput extends ServiceInput {
    ...
    public CsGetCtnNmInput() throws EnvironmentException, FMLManipulationException {
        ...
        //        defaultValues = getDefaultValues("csGetCtnNm", 27);
        ...
        this.fmlBuffer[23] = new FmlField("PRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 23, 1);
        this.fmlBuffer[24] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, null, 24, 1);
        this.fmlBuffer[25] = new FmlField("TO_CTN", FmlField.TYPE_STRING, 21, null, 25, 1);
        this.fmlBuffer[26] = new FmlField("PAGESIZE", FmlField.TYPE_INTEGER, -1, null, 26, 1);
    }
