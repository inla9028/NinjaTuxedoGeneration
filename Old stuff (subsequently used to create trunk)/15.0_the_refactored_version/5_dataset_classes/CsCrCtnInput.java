...
public class CsCrCtnInput extends ServiceInput {
    ...
    public CsCrCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[159] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 159, 1);
        this.fmlBuffer[160] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 160, 1);
        this.fmlBuffer[161] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 161, 1);
        this.fmlBuffer[162] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 162, 1);
        this.fmlBuffer[163] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 163, 1);
        this.fmlBuffer[164] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 164, 1);
        this.fmlBuffer[165] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 165, 1);
        this.fmlBuffer[166] = new FmlField("P1", FmlField.TYPE_STRING, 21, null, 166, 1);
        this.fmlBuffer[167] = new FmlField("P2", FmlField.TYPE_STRING, 21, null, 167, 1);
        this.fmlBuffer[168] = new FmlField("P3", FmlField.TYPE_STRING, 21, null, 168, 1);
        this.fmlBuffer[169] = new FmlField("P4", FmlField.TYPE_STRING, 21, null, 169, 1);
        this.fmlBuffer[170] = new FmlField("P5", FmlField.TYPE_STRING, 21, null, 170, 1);
        this.fmlBuffer[171] = new FmlField("P6", FmlField.TYPE_STRING, 21, null, 171, 1);
        this.fmlBuffer[172] = new FmlField("P7", FmlField.TYPE_STRING, 21, null, 172, 1);
        this.fmlBuffer[173] = new FmlField("P8", FmlField.TYPE_STRING, 21, null, 173, 1);
        this.fmlBuffer[174] = new FmlField("P9", FmlField.TYPE_STRING, 21, null, 174, 1);
        this.fmlBuffer[175] = new FmlField("P10", FmlField.TYPE_STRING, 21, null, 175, 1);
        this.fmlBuffer[176] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 176, 1);
        this.fmlBuffer[177] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 177, 1);
        this.fmlBuffer[178] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 178, 1);
        this.fmlBuffer[179] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 179, 1);
        this.fmlBuffer[180] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 180, 1);
        this.fmlBuffer[181] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 181, 1);
        this.fmlBuffer[182] = new FmlField("PCTNRECROWID", FmlField.TYPE_STRING, 19, null, 182, 1);
        ...
        this.fmlBuffer[187] = new FmlField("PCTNRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 187, 1);
        this.fmlBuffer[188] = new FmlField("PCTNRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 188, 1);
        ...
        this.fmlBuffer[191] = new FmlField("PCTNRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 191, 1);
        ...
        this.fmlBuffer[198] = new FmlField("PCTNRECPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 198, 1);
        ...
        this.fmlBuffer[206] = new FmlField("PCTNRECCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 206, 1);
        this.fmlBuffer[207] = new FmlField("PCTNRECSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 207, 1);
        ...
        this.fmlBuffer[210] = new FmlField("PCTNRECDEALER_CODE", FmlField.TYPE_STRING, 6, null, 210, 1);
        this.fmlBuffer[211] = new FmlField("ORG_DEALER_CODE", FmlField.TYPE_STRING, 6, null, 211, 1);
        this.fmlBuffer[212] = new FmlField("PCTNRECSALES_AGENT", FmlField.TYPE_STRING, 6, null, 212, 1);
        ...
        this.fmlBuffer[256] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, "999999999.99", 256, 1);
        ...
        this.fmlBuffer[272] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 272, 1);
        this.fmlBuffer[273] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 273, 20);
        this.fmlBuffer[274] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 274, 20);
        this.fmlBuffer[275] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 275, 20);
        this.fmlBuffer[276] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 276, 20);
        this.fmlBuffer[277] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 277, 20);
        this.fmlBuffer[278] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 278, 20);
        this.fmlBuffer[279] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 279, 20);
        this.fmlBuffer[280] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 280, 20);
        this.fmlBuffer[281] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 281, 20);
        this.fmlBuffer[282] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 282, 20);
        this.fmlBuffer[283] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 283, 20);
        this.fmlBuffer[284] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 284, 20);
        this.fmlBuffer[285] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 285, 20);
        this.fmlBuffer[286] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 286, 20);
        this.fmlBuffer[287] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 287, 20);
        this.fmlBuffer[288] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 288, 20);
        this.fmlBuffer[289] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 289, 20);
        this.fmlBuffer[290] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 290, 20);
        this.fmlBuffer[291] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 291, 20);
        this.fmlBuffer[292] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 292, 20);
        this.fmlBuffer[293] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 293, 20);
        this.fmlBuffer[294] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 294, 20);
        this.fmlBuffer[295] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 295, 20);
        this.fmlBuffer[296] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 296, 20);
        this.fmlBuffer[297] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 297, 20);
        this.fmlBuffer[298] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 298, 20);
        this.fmlBuffer[299] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 299, 20);
        this.fmlBuffer[300] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 300, 20);
        this.fmlBuffer[301] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 301, 20);
        this.fmlBuffer[302] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 302, 20);
        this.fmlBuffer[303] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 303, 20);
        this.fmlBuffer[304] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 304, 20);
        this.fmlBuffer[305] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 305, 20);
        this.fmlBuffer[306] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 306, 20);
        this.fmlBuffer[307] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 307, 20);
        this.fmlBuffer[308] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 308, 20);
        this.fmlBuffer[309] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, null, 309, 20);
        this.fmlBuffer[310] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 310, 20);
        this.fmlBuffer[311] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 311, 20);
        this.fmlBuffer[312] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 312, 20);
        this.fmlBuffer[313] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 313, 20);
        this.fmlBuffer[314] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 314, 20);
        this.fmlBuffer[315] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 315, 20);
        this.fmlBuffer[316] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 316, 20);
        this.fmlBuffer[317] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 317, 20);
        this.fmlBuffer[318] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 318, 20);
        this.fmlBuffer[319] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 319, 20);
        this.fmlBuffer[320] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 320, 20);
        this.fmlBuffer[321] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 321, 20);
        this.fmlBuffer[322] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 322, 20);
        this.fmlBuffer[323] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 323, 20);
        this.fmlBuffer[324] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 324, 20);
        this.fmlBuffer[325] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 325, 20);
        this.fmlBuffer[326] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 326, 20);
        this.fmlBuffer[327] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 327, 20);
        this.fmlBuffer[328] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 328, 20);
        this.fmlBuffer[329] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 329, 20);
        this.fmlBuffer[330] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 330, 20);
        this.fmlBuffer[331] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 331, 20);
        this.fmlBuffer[332] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 332, 20);
        this.fmlBuffer[333] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 333, 20);
        this.fmlBuffer[334] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 334, 20);
        this.fmlBuffer[335] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 335, 20);
        this.fmlBuffer[336] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 336, 20);
        this.fmlBuffer[337] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 337, 20);
        this.fmlBuffer[338] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 338, 20);
        this.fmlBuffer[339] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 339, 20);
        this.fmlBuffer[340] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 340, 20);
        this.fmlBuffer[341] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 341, 20);
        this.fmlBuffer[342] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 342, 20);
        this.fmlBuffer[343] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 343, 20);
        this.fmlBuffer[344] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 344, 20);
        this.fmlBuffer[345] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 345, 20);
        this.fmlBuffer[346] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 346, 20);
        this.fmlBuffer[347] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 347, 20);
        this.fmlBuffer[348] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 348, 20);
        this.fmlBuffer[349] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 349, 20);
        this.fmlBuffer[350] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 350, 20);
        this.fmlBuffer[351] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 351, 20);
        this.fmlBuffer[352] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 352, 20);
        this.fmlBuffer[353] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 353, 20);
        this.fmlBuffer[354] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 354, 20);
        this.fmlBuffer[355] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 355, 20);
        this.fmlBuffer[356] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 356, 20);
        this.fmlBuffer[357] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 357, 20);
        this.fmlBuffer[358] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 358, 20);
        this.fmlBuffer[359] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 359, 20);
        this.fmlBuffer[360] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 360, 20);
        this.fmlBuffer[361] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 361, 20);
        this.fmlBuffer[362] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 362, 20);
        this.fmlBuffer[363] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 363, 20);
        this.fmlBuffer[364] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 364, 20);
        this.fmlBuffer[365] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 365, 1);
        this.fmlBuffer[366] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 366, 1);
        this.fmlBuffer[367] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 367, 1);
        this.fmlBuffer[368] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 368, 1);
        this.fmlBuffer[369] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 369, 1);
        this.fmlBuffer[370] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 370, 1);
        this.fmlBuffer[371] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 371, 1);
        this.fmlBuffer[372] = new FmlField("PNPINFOBUFFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 372, 1);
        this.fmlBuffer[373] = new FmlField("NPNUMINFORECROWID", FmlField.TYPE_STRING, 19, null, 373, 500);
        this.fmlBuffer[374] = new FmlField("PORT_NUMBER", FmlField.TYPE_STRING, 21, null, 374, 500);
        this.fmlBuffer[375] = new FmlField("NPNUMINFORECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 375, 500);
        this.fmlBuffer[376] = new FmlField("NPNUMINFORECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 376, 500);
        this.fmlBuffer[377] = new FmlField("NPNUMINFORECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 377, 500);
        this.fmlBuffer[378] = new FmlField("NPNUMINFORECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 378, 500);
        this.fmlBuffer[379] = new FmlField("NPNUMINFORECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 379, 500);
        this.fmlBuffer[380] = new FmlField("NPNUMINFORECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 380, 500);
        this.fmlBuffer[381] = new FmlField("NPNUMINFORECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 381, 500);
        this.fmlBuffer[382] = new FmlField("NPNUMINFORECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 382, 500);
        this.fmlBuffer[383] = new FmlField("INT_ORDER_ID", FmlField.TYPE_DOUBLE, -1, null, 383, 500);
        this.fmlBuffer[384] = new FmlField("ORG_CUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 384, 500);
        this.fmlBuffer[385] = new FmlField("PORT_IND", FmlField.TYPE_BYTE, -1, null, 385, 500);
        this.fmlBuffer[386] = new FmlField("NUMBER_TYPE", FmlField.TYPE_BYTE, -1, null, 386, 500);
        this.fmlBuffer[387] = new FmlField("PORT_REQUEST_DATE", FmlField.TYPE_STRING, 15, null, 387, 500);
        this.fmlBuffer[388] = new FmlField("ORG_OPERATOR", FmlField.TYPE_STRING, 6, null, 388, 500);
        this.fmlBuffer[389] = new FmlField("NPNUMINFORECSUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 389, 500);
        this.fmlBuffer[390] = new FmlField("LAST_INT_ORD_ID", FmlField.TYPE_DOUBLE, -1, null, 390, 500);
        this.fmlBuffer[391] = new FmlField("FUNCTION_PORT_IND", FmlField.TYPE_BYTE, -1, null, 391, 500);
        this.fmlBuffer[392] = new FmlField("PASSIVE_IND", FmlField.TYPE_BYTE, -1, null, 392, 500);
        this.fmlBuffer[393] = new FmlField("AUTO_CONFIRM", FmlField.TYPE_BYTE, -1, null, 393, 500);
        this.fmlBuffer[394] = new FmlField("TEMPORARY_MSISDN", FmlField.TYPE_STRING, 21, null, 394, 500);
        this.fmlBuffer[395] = new FmlField("HANDLE_MODE", FmlField.TYPE_BYTE, -1, null, 395, 500);
        this.fmlBuffer[396] = new FmlField("SEND_IND", FmlField.TYPE_BYTE, -1, null, 396, 500);
        this.fmlBuffer[397] = new FmlField("ORDID_STR", FmlField.TYPE_STRING, 21, null, 397, 500);
        this.fmlBuffer[398] = new FmlField("LAST_ORDID_STR", FmlField.TYPE_STRING, 21, null, 398, 500);
        this.fmlBuffer[399] = new FmlField("ICC", FmlField.TYPE_STRING, 61, null, 399, 500);
        this.fmlBuffer[400] = new FmlField("CUSTOMER_NAME", FmlField.TYPE_STRING, 255, null, 400, 500);
        this.fmlBuffer[401] = new FmlField("NPINFOBUFFCUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 401, 500);
        this.fmlBuffer[402] = new FmlField("SERVICE_PROVIDER", FmlField.TYPE_STRING, 6, null, 402, 500);
        this.fmlBuffer[403] = new FmlField("MUNICIPALITY", FmlField.TYPE_STRING, 4, null, 403, 1);
        this.fmlBuffer[404] = new FmlField("RECIP_SERV_OPER", FmlField.TYPE_STRING, 6, null, 404, 1);
        this.fmlBuffer[405] = new FmlField("POINT_OF_CONNECTION", FmlField.TYPE_STRING, 61, null, 405, 1);
        this.fmlBuffer[406] = new FmlField("CSNPSPC", FmlField.TYPE_STRING, 7, null, 406, 1);
        this.fmlBuffer[407] = new FmlField("EIDNODSIGN", FmlField.TYPE_STRING, 7, null, 407, 1);
        this.fmlBuffer[408] = new FmlField("NPEIDNTYP", FmlField.TYPE_STRING, 5, null, 408, 1);
        this.fmlBuffer[409] = new FmlField("EIDNTYPNUMB", FmlField.TYPE_STRING, 5, null, 409, 1);
        this.fmlBuffer[410] = new FmlField("NPNEIDNODSIGN", FmlField.TYPE_STRING, 7, null, 410, 1);
        this.fmlBuffer[411] = new FmlField("NEIDNTYP", FmlField.TYPE_STRING, 5, null, 411, 1);
        this.fmlBuffer[412] = new FmlField("NEIDNTYPNUMB", FmlField.TYPE_STRING, 5, null, 412, 1);
        this.fmlBuffer[413] = new FmlField("CURR_SERV_OPER", FmlField.TYPE_STRING, 6, null, 413, 1);
    }
