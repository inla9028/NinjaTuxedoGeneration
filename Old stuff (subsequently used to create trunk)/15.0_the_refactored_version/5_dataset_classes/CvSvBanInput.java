...
public class CvSvBanInput extends ServiceInput implements Conversable {
    ...
    public CvSvBanInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[133] = new FmlField("PCNTRINPROWID", FmlField.TYPE_STRING, 19, null, 133, 1);
        this.fmlBuffer[134] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 134, 1);
        this.fmlBuffer[135] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 135, 1);
        this.fmlBuffer[136] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 136, 1);
        this.fmlBuffer[137] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 137, 1);
        this.fmlBuffer[138] = new FmlField("PW_DESCRIPTION", FmlField.TYPE_STRING, 21, null, 138, 1);
        this.fmlBuffer[139] = new FmlField("MOREROWS", FmlField.TYPE_SHORT, -1, null, 139, 1);
        this.fmlBuffer[140] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 140, 1);
        this.fmlBuffer[141] = new FmlField("PARTRDREFARRAYROWID", FmlField.TYPE_STRING, 19, null, 141, 10);
        this.fmlBuffer[142] = new FmlField("PARTRDREFARRAYCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 142, 10);
        this.fmlBuffer[143] = new FmlField("TR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 143, 10);
        this.fmlBuffer[144] = new FmlField("COMPANY_NAME", FmlField.TYPE_STRING, 61, null, 144, 10);
        this.fmlBuffer[145] = new FmlField("CONTACT_PERSON", FmlField.TYPE_STRING, 61, null, 145, 10);
        this.fmlBuffer[146] = new FmlField("PHONE_NO", FmlField.TYPE_STRING, 16, null, 146, 10);
        this.fmlBuffer[147] = new FmlField("FAX_NO", FmlField.TYPE_STRING, 16, null, 147, 10);
    }
