...
public class CsChgCtnInput extends ServiceInput {
    ...
    public CsChgCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[249] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, "999999999.99", 249, 1);
        ...
        this.fmlBuffer[265] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 265, 1);
        this.fmlBuffer[266] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 266, 1);
        this.fmlBuffer[267] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 267, 1);
        this.fmlBuffer[268] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 268, 1);
        this.fmlBuffer[269] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 269, 1);
        this.fmlBuffer[270] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 270, 1);
        this.fmlBuffer[271] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 271, 1);
        ...
        this.fmlBuffer[365] = new FmlField("PCHGCTNRECBAN", FmlField.TYPE_INTEGER, -1, null, 365, 1);
        this.fmlBuffer[366] = new FmlField("OLD_CTN", FmlField.TYPE_STRING, 21, null, 366, 1);
        this.fmlBuffer[367] = new FmlField("PCHGCTNRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 367, 1);
        this.fmlBuffer[368] = new FmlField("PCHGCTNRECACTIVITY_DATE", FmlField.TYPE_STRING, 9, null, 368, 1);
        this.fmlBuffer[369] = new FmlField("OTHER_NL", FmlField.TYPE_STRING, 4, null, 369, 1);
        this.fmlBuffer[370] = new FmlField("INT_ORDER_ID_OF_TEMP_MSISDN", FmlField.TYPE_DOUBLE, -1, null, 370, 1);
        this.fmlBuffer[371] = new FmlField("ACTIVITY_CTN_FEE", FmlField.TYPE_DOUBLE, -1, null, 371, 1);
        this.fmlBuffer[372] = new FmlField("NUMBER_LOCATION", FmlField.TYPE_STRING, 4, null, 372, 1);
        this.fmlBuffer[373] = new FmlField("DEPOSITTERMSIND", FmlField.TYPE_BYTE, -1, null, 373, 1);
        this.fmlBuffer[374] = new FmlField("WAIVING_IND", FmlField.TYPE_BYTE, -1, null, 374, 1);
        this.fmlBuffer[375] = new FmlField("WAIVING_REASON_CODE", FmlField.TYPE_STRING, 5, null, 375, 1);
        this.fmlBuffer[376] = new FmlField("PINSTLBUFROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 376, 1);
        this.fmlBuffer[377] = new FmlField("INSTALLMENT_AMT", FmlField.TYPE_DOUBLE, -1, null, 377, 12);
        this.fmlBuffer[378] = new FmlField("INSTALLMENT_DATE", FmlField.TYPE_STRING, 9, null, 378, 12);
        this.fmlBuffer[379] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 379, 1);
        this.fmlBuffer[380] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 380, 2);
        this.fmlBuffer[381] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 381, 2);
    }
