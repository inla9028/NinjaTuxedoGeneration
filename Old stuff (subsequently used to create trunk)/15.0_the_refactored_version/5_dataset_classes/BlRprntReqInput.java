...
public class BlRprntReqInput extends ServiceInput {
    ...
    public BlRprntReqInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[42] = new FmlField("PCREATECRG", FmlField.TYPE_BYTE, -1, null, 42, 1);
        this.fmlBuffer[43] = new FmlField("BANID", FmlField.TYPE_INTEGER, -1, null, 43, 1);
        this.fmlBuffer[44] = new FmlField("BILLSEQNO", FmlField.TYPE_SHORT, -1, null, 44, 1);
        this.fmlBuffer[45] = new FmlField("FROMPAGE", FmlField.TYPE_STRING, 10, null, 45, 1);
        this.fmlBuffer[46] = new FmlField("TOPAGE", FmlField.TYPE_STRING, 10, null, 46, 1);
        this.fmlBuffer[47] = new FmlField("CTN", FmlField.TYPE_STRING, 21, null, 47, 1);
        this.fmlBuffer[48] = new FmlField("REQTYPE", FmlField.TYPE_BYTE, -1, null, 48, 1);
        this.fmlBuffer[49] = new FmlField("TEXTTYPE", FmlField.TYPE_STRING, 5, null, 49, 1);
        this.fmlBuffer[50] = new FmlField("COPIES", FmlField.TYPE_SHORT, -1, null, 50, 1);
        this.fmlBuffer[51] = new FmlField("COVERPAGEIND", FmlField.TYPE_BYTE, -1, null, 51, 1);
        this.fmlBuffer[52] = new FmlField("COVERINS", FmlField.TYPE_STRING, 41, null, 52, 1);
        this.fmlBuffer[53] = new FmlField("FULLBILLIND", FmlField.TYPE_BYTE, -1, null, 53, 1);
        this.fmlBuffer[54] = new FmlField("DESTINATION", FmlField.TYPE_STRING, 21, null, 54, 1);
        this.fmlBuffer[55] = new FmlField("FORMATCODE", FmlField.TYPE_STRING, 3, null, 55, 1);
        this.fmlBuffer[56] = new FmlField("DOCUMENT_ID", FmlField.TYPE_STRING, 14, null, 56, 1);
    }
    ...
    public void set_BILLSEQNO(Integer value) throws FMLManipulationException {
        this.fmlBuffer[44].setValue(0, TypeConverter.integerToShort(value));
    }
