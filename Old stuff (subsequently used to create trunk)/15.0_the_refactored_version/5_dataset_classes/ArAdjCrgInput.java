...
public class ArAdjCrgInput extends ServiceInput {
     ...
     */
    public ArAdjCrgInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[66] = new FmlField("DISCOUNT_PCT", FmlField.TYPE_DOUBLE, -1, null, 66, 70);
        ...
        this.fmlBuffer[73] = new FmlField("ORG_CODE", FmlField.TYPE_STRING, 6, null, 73, 70);
