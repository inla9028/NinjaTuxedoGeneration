 ...
 */
public class CsChkValImpOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsChkValImpOutput.
     *
     * @throws FMLManipulationException
     */
    public CsChkValImpOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsChkValImpOutput() {
    }

    /**
     * Creates a new instance of CsChkValImpOutput.
     *
     * @param ds Output dataset from CsChkValImp service.
     * @throws FMLManipulationException
     */
    public CsChkValImpOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[16] = new FmlField("ORIG_PRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("RNGHOLDIND", FmlField.TYPE_BYTE, -1, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("INTPORTIND", FmlField.TYPE_BYTE, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("CTNSTSIND", FmlField.TYPE_STRING, 3, null, 19, 1);
    }
    ...
    /**
     * Retrieves the value of the 'ORIG_PRODUCT_TYPE' field in the FML buffer.
     *
     * @return Value of 'ORIG_PRODUCT_TYPE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_ORIG_PRODUCT_TYPE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[16].getValue(0));
    }

    /**
     * Retrieves the value of the 'RNGHOLDIND' field in the FML buffer.
     *
     * @return Value of 'RNGHOLDIND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_RNGHOLDIND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[17].getValue(0)));
    }

    /**
     * Retrieves the value of the 'INTPORTIND' field in the FML buffer.
     *
     * @return Value of 'INTPORTIND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_INTPORTIND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[18].getValue(0)));
    }

    /**
     * Retrieves the value of the 'CTNSTSIND' field in the FML buffer.
     *
     * @return Value of 'CTNSTSIND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_CTNSTSIND() throws FMLManipulationException {
