...
public class CvSvCtnInput extends ServiceInput implements Conversable {
    ...
    public CvSvCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[90] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, "999999999.99", 90, 1);
        ...
        this.fmlBuffer[106] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 106, 1);
        this.fmlBuffer[107] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 107, 1);
        this.fmlBuffer[108] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 108, 1);
        this.fmlBuffer[109] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 109, 1);
        this.fmlBuffer[110] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 110, 1);
        this.fmlBuffer[111] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 111, 1);
        this.fmlBuffer[112] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 112, 1);
    }
