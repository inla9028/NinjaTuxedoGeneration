...
public class CsMoveCtnInput extends ServiceInput {
    ...
    public CsMoveCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[254] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, "999999999.99", 254, 1);
        ...
        this.fmlBuffer[270] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 270, 1);
        this.fmlBuffer[271] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 271, 20);
        this.fmlBuffer[272] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 272, 20);
        this.fmlBuffer[273] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 273, 20);
        this.fmlBuffer[274] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 274, 20);
        this.fmlBuffer[275] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 275, 20);
        this.fmlBuffer[276] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 276, 20);
        this.fmlBuffer[277] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 277, 20);
        this.fmlBuffer[278] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 278, 20);
        this.fmlBuffer[279] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 279, 20);
        this.fmlBuffer[280] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 280, 20);
        this.fmlBuffer[281] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 281, 20);
        this.fmlBuffer[282] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 282, 20);
        this.fmlBuffer[283] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 283, 20);
        this.fmlBuffer[284] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 284, 20);
        this.fmlBuffer[285] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 285, 20);
        this.fmlBuffer[286] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 286, 20);
        this.fmlBuffer[287] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 287, 20);
        this.fmlBuffer[288] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 288, 20);
        this.fmlBuffer[289] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 289, 20);
        this.fmlBuffer[290] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 290, 20);
        this.fmlBuffer[291] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 291, 20);
        this.fmlBuffer[292] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 292, 20);
        this.fmlBuffer[293] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 293, 20);
        this.fmlBuffer[294] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 294, 20);
        this.fmlBuffer[295] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 295, 20);
        this.fmlBuffer[296] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 296, 20);
        this.fmlBuffer[297] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 297, 20);
        this.fmlBuffer[298] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 298, 20);
        this.fmlBuffer[299] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 299, 20);
        this.fmlBuffer[300] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 300, 20);
        this.fmlBuffer[301] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 301, 20);
        this.fmlBuffer[302] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 302, 20);
        this.fmlBuffer[303] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 303, 20);
        this.fmlBuffer[304] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 304, 20);
        this.fmlBuffer[305] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 305, 20);
        this.fmlBuffer[306] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 306, 20);
        this.fmlBuffer[307] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, null, 307, 20);
        this.fmlBuffer[308] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 308, 20);
        this.fmlBuffer[309] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 309, 20);
        this.fmlBuffer[310] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 310, 20);
        this.fmlBuffer[311] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 311, 20);
        this.fmlBuffer[312] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 312, 20);
        this.fmlBuffer[313] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 313, 20);
        this.fmlBuffer[314] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 314, 20);
        this.fmlBuffer[315] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 315, 20);
        this.fmlBuffer[316] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 316, 20);
        this.fmlBuffer[317] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 317, 20);
        this.fmlBuffer[318] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 318, 20);
        this.fmlBuffer[319] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 319, 20);
        this.fmlBuffer[320] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 320, 20);
        this.fmlBuffer[321] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 321, 20);
        this.fmlBuffer[322] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 322, 20);
        this.fmlBuffer[323] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 323, 20);
        this.fmlBuffer[324] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 324, 20);
        this.fmlBuffer[325] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 325, 20);
        this.fmlBuffer[326] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 326, 20);
        this.fmlBuffer[327] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 327, 20);
        this.fmlBuffer[328] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 328, 20);
        this.fmlBuffer[329] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 329, 20);
        this.fmlBuffer[330] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 330, 20);
        this.fmlBuffer[331] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 331, 20);
        this.fmlBuffer[332] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 332, 20);
        this.fmlBuffer[333] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 333, 20);
        this.fmlBuffer[334] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 334, 20);
        this.fmlBuffer[335] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 335, 20);
        this.fmlBuffer[336] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 336, 20);
        this.fmlBuffer[337] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 337, 20);
        this.fmlBuffer[338] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 338, 20);
        this.fmlBuffer[339] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 339, 20);
        this.fmlBuffer[340] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 340, 20);
        this.fmlBuffer[341] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 341, 20);
        this.fmlBuffer[342] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 342, 20);
        this.fmlBuffer[343] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 343, 20);
        this.fmlBuffer[344] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 344, 20);
        this.fmlBuffer[345] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 345, 20);
        this.fmlBuffer[346] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 346, 20);
        this.fmlBuffer[347] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 347, 20);
        this.fmlBuffer[348] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 348, 20);
        this.fmlBuffer[349] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 349, 20);
        this.fmlBuffer[350] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 350, 20);
        this.fmlBuffer[351] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 351, 20);
        this.fmlBuffer[352] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 352, 20);
        this.fmlBuffer[353] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 353, 20);
        this.fmlBuffer[354] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 354, 20);
        this.fmlBuffer[355] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 355, 20);
        this.fmlBuffer[356] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 356, 20);
        this.fmlBuffer[357] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 357, 20);
        this.fmlBuffer[358] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 358, 20);
        this.fmlBuffer[359] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 359, 20);
        this.fmlBuffer[360] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 360, 20);
        this.fmlBuffer[361] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 361, 20);
        this.fmlBuffer[362] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 362, 20);
        this.fmlBuffer[363] = new FmlField("SOURCE_BAN_LAST_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 363, 1);
        this.fmlBuffer[364] = new FmlField("SOURCE_BAN_LAST_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 364, 1);
        this.fmlBuffer[365] = new FmlField("PCNCLSRCEBANRECBAN", FmlField.TYPE_INTEGER, -1, null, 365, 1);
        this.fmlBuffer[366] = new FmlField("PCNCLSRCEBANRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 366, 1);
        this.fmlBuffer[367] = new FmlField("PCNCLSRCEBANRECACTIVITY_DATE", FmlField.TYPE_STRING, 9, null, 367, 1);
        this.fmlBuffer[368] = new FmlField("RESTORE_DATE", FmlField.TYPE_STRING, 9, null, 368, 1);
        this.fmlBuffer[369] = new FmlField("DEP_RETURN_METHOD", FmlField.TYPE_BYTE, -1, null, 369, 1);
        this.fmlBuffer[370] = new FmlField("NEW_BAN_STATUS", FmlField.TYPE_BYTE, -1, null, 370, 1);
        this.fmlBuffer[371] = new FmlField("EXP_CYCLE_CODE", FmlField.TYPE_SHORT, -1, null, 371, 1);
        this.fmlBuffer[372] = new FmlField("BAN_WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 372, 1);
        this.fmlBuffer[373] = new FmlField("BAN_WAIVE_RSN", FmlField.TYPE_STRING, 7, null, 373, 1);
        this.fmlBuffer[374] = new FmlField("WAIVER_UID", FmlField.TYPE_STRING, 9, null, 374, 1);
        this.fmlBuffer[375] = new FmlField("HOLD_COLL_TREATMENT", FmlField.TYPE_BYTE, -1, null, 375, 1);
        this.fmlBuffer[376] = new FmlField("PCTNCNCLBUFROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 376, 1);
        this.fmlBuffer[377] = new FmlField("CTN", FmlField.TYPE_STRING, 21, null, 377, 100);
        this.fmlBuffer[378] = new FmlField("PCTNCNCLBUFSUB_STATUS", FmlField.TYPE_BYTE, -1, null, 378, 100);
        this.fmlBuffer[379] = new FmlField("COMM_START_DATE", FmlField.TYPE_STRING, 9, null, 379, 100);
        this.fmlBuffer[380] = new FmlField("COMM_END_DATE", FmlField.TYPE_STRING, 9, null, 380, 100);
        this.fmlBuffer[381] = new FmlField("REMAINING_MONTHS", FmlField.TYPE_SHORT, -1, null, 381, 100);
        this.fmlBuffer[382] = new FmlField("DEPOSIT", FmlField.TYPE_DOUBLE, -1, null, 382, 100);
        this.fmlBuffer[383] = new FmlField("DEPOSIT_INTEREST", FmlField.TYPE_DOUBLE, -1, null, 383, 100);
        this.fmlBuffer[384] = new FmlField("PENALTY", FmlField.TYPE_DOUBLE, -1, null, 384, 100);
        this.fmlBuffer[385] = new FmlField("WAIVE_INDICATOR", FmlField.TYPE_BYTE, -1, null, 385, 100);
        this.fmlBuffer[386] = new FmlField("PCTNCNCLBUFWAIVE_REASON", FmlField.TYPE_STRING, 7, null, 386, 100);
        this.fmlBuffer[387] = new FmlField("ACTIVITY_CTN_FEE", FmlField.TYPE_DOUBLE, -1, null, 387, 1);
        this.fmlBuffer[388] = new FmlField("NUMBER_LOCATION", FmlField.TYPE_STRING, 4, null, 388, 1);
        this.fmlBuffer[389] = new FmlField("DEPOSITTERMSIND", FmlField.TYPE_BYTE, -1, null, 389, 1);
        this.fmlBuffer[390] = new FmlField("WAIVING_IND", FmlField.TYPE_BYTE, -1, null, 390, 1);
        this.fmlBuffer[391] = new FmlField("WAIVING_REASON_CODE", FmlField.TYPE_STRING, 5, null, 391, 1);
        this.fmlBuffer[392] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 392, 1);
        this.fmlBuffer[393] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 393, 2);
        this.fmlBuffer[394] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 394, 2);
    }
