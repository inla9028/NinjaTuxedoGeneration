...
public class ArCrCrgInput extends ServiceInput {
    ...
    public ArCrCrgInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[20] = new FmlField("BILL_CYCLE", FmlField.TYPE_SHORT, -1, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("BL_NEXT_CYCLE", FmlField.TYPE_SHORT, -1, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("BL_NEXT_CYC_EFF_DATE", FmlField.TYPE_STRING, 9, null, 22, 1);
        this.fmlBuffer[23] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 23, 1);
        this.fmlBuffer[24] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 24, 1);
        this.fmlBuffer[25] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 25, 1);
        this.fmlBuffer[26] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 26, 1);
        this.fmlBuffer[27] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 27, 1);
        this.fmlBuffer[28] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 28, 1);
        this.fmlBuffer[29] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 29, 1);
        this.fmlBuffer[30] = new FmlField("P1", FmlField.TYPE_STRING, 21, null, 30, 1);
        this.fmlBuffer[31] = new FmlField("P2", FmlField.TYPE_STRING, 21, null, 31, 1);
        this.fmlBuffer[32] = new FmlField("P3", FmlField.TYPE_STRING, 21, null, 32, 1);
        this.fmlBuffer[33] = new FmlField("P4", FmlField.TYPE_STRING, 21, null, 33, 1);
        this.fmlBuffer[34] = new FmlField("P5", FmlField.TYPE_STRING, 21, null, 34, 1);
        this.fmlBuffer[35] = new FmlField("P6", FmlField.TYPE_STRING, 21, null, 35, 1);
        this.fmlBuffer[36] = new FmlField("P7", FmlField.TYPE_STRING, 21, null, 36, 1);
        this.fmlBuffer[37] = new FmlField("P8", FmlField.TYPE_STRING, 21, null, 37, 1);
        this.fmlBuffer[38] = new FmlField("P9", FmlField.TYPE_STRING, 21, null, 38, 1);
        this.fmlBuffer[39] = new FmlField("P10", FmlField.TYPE_STRING, 21, null, 39, 1);
        this.fmlBuffer[40] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 40, 1);
        this.fmlBuffer[41] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 41, 1);
        this.fmlBuffer[42] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 42, 1);
        this.fmlBuffer[43] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 43, 1);
        this.fmlBuffer[44] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 44, 1);
        this.fmlBuffer[45] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 45, 1);
        this.fmlBuffer[46] = new FmlField("PCHARGERECROWID", FmlField.TYPE_STRING, 19, null, 46, 1);
        this.fmlBuffer[47] = new FmlField("ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 47, 1);
        this.fmlBuffer[48] = new FmlField("PCHARGERECBAN", FmlField.TYPE_INTEGER, -1, null, 48, 1);
        this.fmlBuffer[49] = new FmlField("ACTV_BILL_SEQ_NO", FmlField.TYPE_SHORT, -1, null, 49, 1);
        this.fmlBuffer[50] = new FmlField("ENT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 50, 1);
        this.fmlBuffer[51] = new FmlField("ACTV_SEQ_NO", FmlField.TYPE_SHORT, -1, null, 51, 1);
        this.fmlBuffer[52] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 52, 1);
        this.fmlBuffer[53] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 53, 1);
        this.fmlBuffer[54] = new FmlField("PCHARGERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 54, 1);
        this.fmlBuffer[55] = new FmlField("PCHARGERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 55, 1);
        this.fmlBuffer[56] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 56, 1);
        this.fmlBuffer[57] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 57, 1);
        this.fmlBuffer[58] = new FmlField("VOUCHER_NUM", FmlField.TYPE_STRING, 14, null, 58, 1);
        this.fmlBuffer[59] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 59, 1);
        this.fmlBuffer[60] = new FmlField("DEPARTMENT", FmlField.TYPE_STRING, 5, null, 60, 1);
        this.fmlBuffer[61] = new FmlField("ORG_CODE", FmlField.TYPE_STRING, 6, null, 61, 1);
        this.fmlBuffer[62] = new FmlField("PRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 62, 1);
        this.fmlBuffer[63] = new FmlField("SUB_MARKET_CD", FmlField.TYPE_STRING, 4, null, 63, 1);
        this.fmlBuffer[64] = new FmlField("PRIOD_CVRG_ST_DATE", FmlField.TYPE_STRING, 9, null, 64, 1);
        this.fmlBuffer[65] = new FmlField("PRIOD_CVRG_ND_DATE", FmlField.TYPE_STRING, 9, null, 65, 1);
        this.fmlBuffer[66] = new FmlField("CHG_CREATION_DATE", FmlField.TYPE_STRING, 9, null, 66, 1);
        this.fmlBuffer[67] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 67, 1);
        this.fmlBuffer[68] = new FmlField("FINANCE_EFF_DATE", FmlField.TYPE_STRING, 9, null, 68, 1);
        this.fmlBuffer[69] = new FmlField("LAST_RG_RC_DATE", FmlField.TYPE_STRING, 9, null, 69, 1);
        this.fmlBuffer[70] = new FmlField("ACTV_DATE", FmlField.TYPE_STRING, 9, null, 70, 1);
        this.fmlBuffer[71] = new FmlField("ACTV_CODE", FmlField.TYPE_STRING, 5, null, 71, 1);
        this.fmlBuffer[72] = new FmlField("ACTV_REASON_CODE", FmlField.TYPE_STRING, 7, null, 72, 1);
        this.fmlBuffer[73] = new FmlField("ACTV_AMT", FmlField.TYPE_DOUBLE, -1, null, 73, 1);
        this.fmlBuffer[74] = new FmlField("DURATION", FmlField.TYPE_DOUBLE, -1, null, 74, 1);
        this.fmlBuffer[75] = new FmlField("NUM_OF_CALLS", FmlField.TYPE_INTEGER, -1, null, 75, 1);
        this.fmlBuffer[76] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 76, 1);
        this.fmlBuffer[77] = new FmlField("FTR_REVENUE_CODE", FmlField.TYPE_STRING, 4, null, 77, 1);
        this.fmlBuffer[78] = new FmlField("FEATURE_CATEGORY", FmlField.TYPE_STRING, 5, null, 78, 1);
        this.fmlBuffer[79] = new FmlField("SECONDARY_FEATURE_CD", FmlField.TYPE_STRING, 7, null, 79, 1);
        this.fmlBuffer[80] = new FmlField("AU_RATING_SCHEME_IND", FmlField.TYPE_BYTE, -1, null, 80, 1);
        this.fmlBuffer[81] = new FmlField("BALANCE_IMPACT_CODE", FmlField.TYPE_BYTE, -1, null, 81, 1);
        this.fmlBuffer[82] = new FmlField("SOC", FmlField.TYPE_STRING, 10, null, 82, 1);
        this.fmlBuffer[83] = new FmlField("SOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 83, 1);
        this.fmlBuffer[84] = new FmlField("SOC_VER_NO", FmlField.TYPE_INTEGER, -1, null, 84, 1);
        this.fmlBuffer[85] = new FmlField("SOC_DATE", FmlField.TYPE_STRING, 9, null, 85, 1);
        this.fmlBuffer[86] = new FmlField("SERVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 86, 1);
        this.fmlBuffer[87] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 87, 1);
        this.fmlBuffer[88] = new FmlField("TOLL_RS_CODE", FmlField.TYPE_STRING, 10, null, 88, 1);
        this.fmlBuffer[89] = new FmlField("SOURCE_APPL_CODE", FmlField.TYPE_BYTE, -1, null, 89, 1);
        this.fmlBuffer[90] = new FmlField("ASGN_TO_BILL_APPL_CD", FmlField.TYPE_BYTE, -1, null, 90, 1);
        this.fmlBuffer[91] = new FmlField("INV_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 91, 1);
        this.fmlBuffer[92] = new FmlField("VAT_AMT", FmlField.TYPE_DOUBLE, -1, null, 92, 1);
        this.fmlBuffer[93] = new FmlField("VAT_EXMP_AMT", FmlField.TYPE_DOUBLE, -1, null, 93, 1);
        this.fmlBuffer[94] = new FmlField("TAX_CODE", FmlField.TYPE_BYTE, -1, null, 94, 1);
        this.fmlBuffer[95] = new FmlField("VAT_PERCENT_RATE", FmlField.TYPE_DOUBLE, -1, null, 95, 1);
        this.fmlBuffer[96] = new FmlField("VAT_EXMP_IND", FmlField.TYPE_BYTE, -1, null, 96, 1);
        this.fmlBuffer[97] = new FmlField("RC_FTR_PRE_PROR_AMT", FmlField.TYPE_DOUBLE, -1, null, 97, 1);
        this.fmlBuffer[98] = new FmlField("BEFORE_DISCNT_AMT", FmlField.TYPE_DOUBLE, -1, null, 98, 1);
        this.fmlBuffer[99] = new FmlField("DISCOUNT_AMT", FmlField.TYPE_DOUBLE, -1, null, 99, 1);
        this.fmlBuffer[100] = new FmlField("DISCOUNT_PCT", FmlField.TYPE_DOUBLE, -1, null, 100, 1);
        this.fmlBuffer[101] = new FmlField("DISCOUNT_CODE", FmlField.TYPE_STRING, 10, null, 101, 1);
        this.fmlBuffer[102] = new FmlField("CREDIT_LEVEL", FmlField.TYPE_BYTE, -1, null, 102, 1);
        this.fmlBuffer[103] = new FmlField("CRG_QUANTITY", FmlField.TYPE_SHORT, -1, null, 103, 1);
        this.fmlBuffer[104] = new FmlField("AU_ISSUE_CODE", FmlField.TYPE_STRING, 7, null, 104, 1);
        this.fmlBuffer[105] = new FmlField("AU_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 105, 1);
        this.fmlBuffer[106] = new FmlField("ACTION_DIRECTION_CD", FmlField.TYPE_BYTE, -1, null, 106, 1);
        this.fmlBuffer[107] = new FmlField("MANUAL_OVERRIDE_IND", FmlField.TYPE_BYTE, -1, null, 107, 1);
        this.fmlBuffer[108] = new FmlField("MEMO_ID", FmlField.TYPE_INTEGER, -1, null, 108, 1);
        this.fmlBuffer[109] = new FmlField("BL_IGNORE_IND", FmlField.TYPE_BYTE, -1, null, 109, 1);
        this.fmlBuffer[110] = new FmlField("CHARGE_TYPE", FmlField.TYPE_BYTE, -1, null, 110, 1);
        this.fmlBuffer[111] = new FmlField("UTC_DISCOUNT_TYPE", FmlField.TYPE_STRING, 3, null, 111, 1);
        this.fmlBuffer[112] = new FmlField("FRWD_FM_BILL_SEQ_NO", FmlField.TYPE_SHORT, -1, null, 112, 1);
        this.fmlBuffer[113] = new FmlField("CHG_GROUP_LEVEL", FmlField.TYPE_BYTE, -1, null, 113, 1);
        this.fmlBuffer[114] = new FmlField("CHG_GROUP_ID", FmlField.TYPE_INTEGER, -1, null, 114, 1);
        this.fmlBuffer[115] = new FmlField("CHARGE_HIST_IND", FmlField.TYPE_BYTE, -1, null, 115, 1);
        this.fmlBuffer[116] = new FmlField("UTC_FROM_TO_BAN", FmlField.TYPE_INTEGER, -1, null, 116, 1);
        this.fmlBuffer[117] = new FmlField("UTC_FROM_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 117, 1);
        this.fmlBuffer[118] = new FmlField("BILL_PROD_GRP", FmlField.TYPE_STRING, 3, null, 118, 1);
        this.fmlBuffer[119] = new FmlField("UTC_IND", FmlField.TYPE_BYTE, -1, null, 119, 1);
        this.fmlBuffer[120] = new FmlField("ORIG_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 120, 1);
        this.fmlBuffer[121] = new FmlField("CHANNEL_SEIZURE_DT", FmlField.TYPE_STRING, 15, null, 121, 1);
        this.fmlBuffer[122] = new FmlField("MESSAGE_SWITCH_ID", FmlField.TYPE_STRING, 8, null, 122, 1);
        this.fmlBuffer[123] = new FmlField("MESSAGE_IDENTIFIER", FmlField.TYPE_STRING, 25, null, 123, 1);
        this.fmlBuffer[124] = new FmlField("NO_OF_INSTALL_FROM", FmlField.TYPE_SHORT, -1, null, 124, 1);
        this.fmlBuffer[125] = new FmlField("NO_OF_INSTALL_TO", FmlField.TYPE_SHORT, -1, null, 125, 1);
        this.fmlBuffer[126] = new FmlField("TOTAL_NO_OF_INSTALL", FmlField.TYPE_SHORT, -1, null, 126, 1);
        this.fmlBuffer[127] = new FmlField("RMS_INV_STORE_ID", FmlField.TYPE_STRING, 5, null, 127, 1);
        this.fmlBuffer[128] = new FmlField("RMS_INV_ID", FmlField.TYPE_INTEGER, -1, null, 128, 1);
        this.fmlBuffer[129] = new FmlField("RMS_INV_LINE_SEQ", FmlField.TYPE_SHORT, -1, null, 129, 1);
        this.fmlBuffer[130] = new FmlField("RMS_INV_SUBLN_SEQ", FmlField.TYPE_SHORT, -1, null, 130, 1);
        this.fmlBuffer[131] = new FmlField("RMS_INV_ACTV_TYPE", FmlField.TYPE_BYTE, -1, null, 131, 1);
        this.fmlBuffer[132] = new FmlField("BILL_COMMENT", FmlField.TYPE_STRING, 501, null, 132, 1);
        this.fmlBuffer[133] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 133, 1);
        this.fmlBuffer[134] = new FmlField("ADJ_MSG_BILL_SEQ_NO", FmlField.TYPE_SHORT, -1, null, 134, 1);
        this.fmlBuffer[135] = new FmlField("DESIGNATED_INV", FmlField.TYPE_STRING, 14, null, 135, 1);
        this.fmlBuffer[136] = new FmlField("DESIGNATED_ITEM", FmlField.TYPE_INTEGER, -1, null, 136, 1);
        this.fmlBuffer[137] = new FmlField("BILL_RELEVANCE_IND", FmlField.TYPE_BYTE, -1, null, 137, 1);
        this.fmlBuffer[138] = new FmlField("NUM_OF_DAYS_PYM_LATE", FmlField.TYPE_SHORT, -1, null, 138, 1);
        this.fmlBuffer[139] = new FmlField("PERCENTAGE_RATE", FmlField.TYPE_DOUBLE, -1, null, 139, 1);
        this.fmlBuffer[140] = new FmlField("BILL_NUM_FOR_LATE_PYM", FmlField.TYPE_STRING, 14, null, 140, 1);
        this.fmlBuffer[141] = new FmlField("ORIG_OPER_ID", FmlField.TYPE_INTEGER, -1, null, 141, 1);
        this.fmlBuffer[142] = new FmlField("DISC_UTC_AMT", FmlField.TYPE_DOUBLE, -1, null, 142, 1);
        this.fmlBuffer[143] = new FmlField("DISC_UTC_VAT", FmlField.TYPE_DOUBLE, -1, null, 143, 1);
        this.fmlBuffer[144] = new FmlField("CHRG_AMT_PRD_1", FmlField.TYPE_DOUBLE, -1, null, 144, 1);
        this.fmlBuffer[145] = new FmlField("CHRG_AMT_PRD_2", FmlField.TYPE_DOUBLE, -1, null, 145, 1);
        this.fmlBuffer[146] = new FmlField("MATCH_TIER_LEVEL", FmlField.TYPE_SHORT, -1, null, 146, 1);
    }
    ...
    public void set_SUSP_RC_RATE_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[25].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public void set_ACTV_SEQ_NO(Integer value) throws FMLManipulationException {
        this.fmlBuffer[51].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_ACTV_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[73].getValue(0));
    }
    ...
    public void set_CRG_QUANTITY(Integer value) throws FMLManipulationException {
        this.fmlBuffer[103].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_CONV_RUN_NO() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[133].getValue(0)));
    }
    ...
    public void set_CONV_RUN_NO(Integer value) throws FMLManipulationException {
        this.fmlBuffer[133].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_NUM_OF_DAYS_PYM_LATE() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[138].getValue(0)));
    }
    ...
    public void set_NUM_OF_DAYS_PYM_LATE(Integer value) throws FMLManipulationException {
        this.fmlBuffer[138].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_DISC_UTC_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[142].getValue(0));
    }
    ...
    public Integer get_MATCH_TIER_LEVEL() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[146].getValue(0)));
    }
    ...
    public void set_MATCH_TIER_LEVEL(Integer value) throws FMLManipulationException {
        this.fmlBuffer[146].setValue(0, TypeConverter.integerToShort(value));
    }
}