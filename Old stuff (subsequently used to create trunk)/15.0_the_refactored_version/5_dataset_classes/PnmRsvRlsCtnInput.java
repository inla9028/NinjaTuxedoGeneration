 ...
 */
public class PnmRsvRlsCtnInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of PnmRsvRlsCtnInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public PnmRsvRlsCtnInput() throws EnvironmentException, FMLManipulationException {
        // Initialise FML buffer
        fmlBuffer = new FmlField[20];

        //// Get default values from DB
        //synchronized (this.defaultValuesPopulated) {
        //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
        //        defaultValues = getDefaultValues("pnmRsvRlsCtn", 20);
        ...
        this.fmlBuffer[17] = new FmlField("CTN", FmlField.TYPE_STRING, 21, null, 17, 1000);
        this.fmlBuffer[18] = new FmlField("NEW_CTN_STATUS", FmlField.TYPE_STRING, 3, null, 18, 1000);
        this.fmlBuffer[19] = new FmlField("FAILED", FmlField.TYPE_BYTE, -1, null, 19, 1000);
    }
    ...
    /**
     * Retrieves the value of the 'NEW_CTN_STATUS' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 1000).
     * @return Value of 'NEW_CTN_STATUS' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_NEW_CTN_STATUS(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[18].getValue(nIndex));
    }

    /**
     * Sets the value of the 'NEW_CTN_STATUS' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 3.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 1000).
     * @throws FMLManipulationException
     */
    public void set_NEW_CTN_STATUS(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[18].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'NEW_CTN_STATUS' field in the FML buffer.
     *
     * @return Number of values defined for 'NEW_CTN_STATUS' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_NEW_CTN_STATUS_size() throws FMLManipulationException {
        return (this.fmlBuffer[18].getCount());
    }

    /**
     * Retrieves the value of the 'FAILED' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 1000).
     * @return Value of 'FAILED' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_FAILED(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[19].getValue(nIndex)));
    }

    /**
     * Sets the value of the 'FAILED' field in the FML buffer.
     *
     * @param value Default value: null.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 1000).
     * @throws FMLManipulationException
     */
    public void set_FAILED(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[19].setValue(nIndex, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves number of values defined for 'FAILED' field in the FML buffer.
     *
     * @return Number of values defined for 'FAILED' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_FAILED_size() throws FMLManipulationException {
