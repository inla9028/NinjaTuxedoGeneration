...
public class CsApiBanInput extends ServiceInput {
    ...
    public CsApiBanInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[126] = new FmlField("CAAP_TYPE", FmlField.TYPE_BYTE, -1, "B", 126, 1);
        ...
        this.fmlBuffer[130] = new FmlField("CS_CREDIT_CLASS", FmlField.TYPE_BYTE, -1, null, 130, 1);
        this.fmlBuffer[131] = new FmlField("CS_APPROVED_CTN_QTY", FmlField.TYPE_SHORT, -1, null, 131, 1);
        this.fmlBuffer[132] = new FmlField("CAS_ORDER_NUMBER", FmlField.TYPE_INTEGER, -1, null, 132, 1);
        this.fmlBuffer[133] = new FmlField("PCTNAGRPRMRECBAN", FmlField.TYPE_INTEGER, -1, null, 133, 1);
        this.fmlBuffer[134] = new FmlField("BAN_ROWID", FmlField.TYPE_STRING, 19, null, 134, 1);
        this.fmlBuffer[135] = new FmlField("PCTNAGRPRMRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 135, 1);
        this.fmlBuffer[136] = new FmlField("CUSTOMER_ROWID", FmlField.TYPE_STRING, 19, null, 136, 1);
        this.fmlBuffer[137] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 137, 1);
        this.fmlBuffer[138] = new FmlField("CTN_ROWID", FmlField.TYPE_STRING, 19, null, 138, 1);
        this.fmlBuffer[139] = new FmlField("PCTNRECROWID", FmlField.TYPE_STRING, 19, null, 139, 1);
        this.fmlBuffer[140] = new FmlField("PCTNRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 140, 1);
        this.fmlBuffer[141] = new FmlField("PCTNRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 141, 1);
        this.fmlBuffer[142] = new FmlField("PCTNRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 142, 1);
        this.fmlBuffer[143] = new FmlField("PCTNRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 143, 1);
        this.fmlBuffer[144] = new FmlField("PCTNRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 144, 1);
        this.fmlBuffer[145] = new FmlField("PCTNRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 145, 1);
        this.fmlBuffer[146] = new FmlField("PCTNRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 146, 1);
        this.fmlBuffer[147] = new FmlField("PCTNRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 147, 1);
        this.fmlBuffer[148] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 148, 1);
        this.fmlBuffer[149] = new FmlField("INIT_ACTIVATION_DATE", FmlField.TYPE_STRING, 9, null, 149, 1);
        this.fmlBuffer[150] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, null, 150, 1);
        this.fmlBuffer[151] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 151, 1);
        this.fmlBuffer[152] = new FmlField("ORIGINAL_INIT_DATE", FmlField.TYPE_STRING, 15, null, 152, 1);
        this.fmlBuffer[153] = new FmlField("SUB_STATUS_LAST_ACT", FmlField.TYPE_STRING, 4, null, 153, 1);
        this.fmlBuffer[154] = new FmlField("SUB_STATUS_RSN_CODE", FmlField.TYPE_STRING, 5, null, 154, 1);
        this.fmlBuffer[155] = new FmlField("PRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 155, 1);
        this.fmlBuffer[156] = new FmlField("CUSTOMER_BAN", FmlField.TYPE_INTEGER, -1, null, 156, 1);
        this.fmlBuffer[157] = new FmlField("CTN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 157, 1);
        this.fmlBuffer[158] = new FmlField("REQ_ST_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 158, 1);
        this.fmlBuffer[159] = new FmlField("REQ_END_GRACE_PERIOD", FmlField.TYPE_STRING, 9, null, 159, 1);
        this.fmlBuffer[160] = new FmlField("COMMIT_START_DATE", FmlField.TYPE_STRING, 9, null, 160, 1);
        this.fmlBuffer[161] = new FmlField("COMMIT_END_DATE", FmlField.TYPE_STRING, 9, null, 161, 1);
        this.fmlBuffer[162] = new FmlField("COMMIT_REASON_CODE", FmlField.TYPE_STRING, 4, null, 162, 1);
        this.fmlBuffer[163] = new FmlField("COMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 163, 1);
        this.fmlBuffer[164] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 164, 1);
        this.fmlBuffer[165] = new FmlField("CONTRACT_NO", FmlField.TYPE_STRING, 11, null, 165, 1);
        this.fmlBuffer[166] = new FmlField("CNT_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 166, 1);
        this.fmlBuffer[167] = new FmlField("PCTNRECDEALER_CODE", FmlField.TYPE_STRING, 6, null, 167, 1);
        this.fmlBuffer[168] = new FmlField("ORG_DEALER_CODE", FmlField.TYPE_STRING, 6, null, 168, 1);
        this.fmlBuffer[169] = new FmlField("PCTNRECSALES_AGENT", FmlField.TYPE_STRING, 6, null, 169, 1);
        this.fmlBuffer[170] = new FmlField("ORG_SALES_AGENT", FmlField.TYPE_STRING, 6, null, 170, 1);
        this.fmlBuffer[171] = new FmlField("REQ_DEPOSIT_AMT", FmlField.TYPE_DOUBLE, -1, null, 171, 1);
        this.fmlBuffer[172] = new FmlField("LEADING_NUMBER", FmlField.TYPE_STRING, 21, null, 172, 1);
        this.fmlBuffer[173] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, null, 173, 1);
        this.fmlBuffer[174] = new FmlField("NEXT_CTN", FmlField.TYPE_STRING, 21, null, 174, 1);
        this.fmlBuffer[175] = new FmlField("NEXT_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 175, 1);
        this.fmlBuffer[176] = new FmlField("PRV_CTN", FmlField.TYPE_STRING, 21, null, 176, 1);
        this.fmlBuffer[177] = new FmlField("PRV_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, null, 177, 1);
        this.fmlBuffer[178] = new FmlField("NEXT_BAN", FmlField.TYPE_INTEGER, -1, null, 178, 1);
        this.fmlBuffer[179] = new FmlField("NEXT_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 179, 1);
        this.fmlBuffer[180] = new FmlField("PRV_BAN", FmlField.TYPE_INTEGER, -1, null, 180, 1);
        this.fmlBuffer[181] = new FmlField("PRV_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, null, 181, 1);
        this.fmlBuffer[182] = new FmlField("SUB_STS_ISSUE_DATE", FmlField.TYPE_STRING, 9, null, 182, 1);
        this.fmlBuffer[183] = new FmlField("ACTIVATE_WAIVE_RSN", FmlField.TYPE_STRING, 7, null, 183, 1);
        this.fmlBuffer[184] = new FmlField("EARLIEST_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 184, 1);
        this.fmlBuffer[185] = new FmlField("SUB_ACTV_LOCATION", FmlField.TYPE_STRING, 5, null, 185, 1);
        this.fmlBuffer[186] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 186, 1);
        this.fmlBuffer[187] = new FmlField("CUST_WATCH_DATE", FmlField.TYPE_STRING, 9, null, 187, 1);
        this.fmlBuffer[188] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 188, 1);
        this.fmlBuffer[189] = new FmlField("CREDIT_WATCH_PIN_CD", FmlField.TYPE_SHORT, -1, null, 189, 1);
        this.fmlBuffer[190] = new FmlField("SUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 190, 1);
        this.fmlBuffer[191] = new FmlField("LIMIT_RESERVED_DAYS", FmlField.TYPE_SHORT, -1, null, 191, 1);
        this.fmlBuffer[192] = new FmlField("FF_EXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 192, 1);
        this.fmlBuffer[193] = new FmlField("FLEX_IND", FmlField.TYPE_BYTE, -1, null, 193, 1);
        this.fmlBuffer[194] = new FmlField("DUO_IND", FmlField.TYPE_BYTE, -1, null, 194, 1);
        this.fmlBuffer[195] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, null, 195, 1);
        this.fmlBuffer[196] = new FmlField("SUB_DEPARTMENT_CD", FmlField.TYPE_STRING, 5, null, 196, 1);
        this.fmlBuffer[197] = new FmlField("LAST_SUBS_DISC_DT", FmlField.TYPE_STRING, 9, null, 197, 1);
        this.fmlBuffer[198] = new FmlField("LAST_SUBS_DISC_DT_UD", FmlField.TYPE_STRING, 9, null, 198, 1);
        this.fmlBuffer[199] = new FmlField("LAST_SUBSCR_DISC_SN", FmlField.TYPE_SHORT, -1, null, 199, 1);
        this.fmlBuffer[200] = new FmlField("LAST_SUBSCR_DISC_SN_UD", FmlField.TYPE_SHORT, -1, null, 200, 1);
        this.fmlBuffer[201] = new FmlField("PNI", FmlField.TYPE_STRING, 11, null, 201, 1);
        this.fmlBuffer[202] = new FmlField("RMS_REF_STORE_ID", FmlField.TYPE_STRING, 5, null, 202, 1);
        this.fmlBuffer[203] = new FmlField("RMS_REF_TYPE", FmlField.TYPE_BYTE, -1, null, 203, 1);
        this.fmlBuffer[204] = new FmlField("RMS_REF_OD", FmlField.TYPE_INTEGER, -1, null, 204, 1);
        this.fmlBuffer[205] = new FmlField("DLR_ACT_FEE", FmlField.TYPE_DOUBLE, -1, null, 205, 1);
        this.fmlBuffer[206] = new FmlField("PREP_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 206, 1);
        this.fmlBuffer[207] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 207, 1);
        this.fmlBuffer[208] = new FmlField("SUB_LANG", FmlField.TYPE_STRING, 3, null, 208, 1);
        this.fmlBuffer[209] = new FmlField("SMS_RCV_STYLE_CODE", FmlField.TYPE_STRING, 3, null, 209, 1);
        this.fmlBuffer[210] = new FmlField("PCTNRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 210, 1);
        this.fmlBuffer[211] = new FmlField("PCTNRECALLOW_ADVERTISING_IND", FmlField.TYPE_BYTE, -1, null, 211, 1);
        this.fmlBuffer[212] = new FmlField("IVR_WRONG_ACCESS_NO", FmlField.TYPE_SHORT, -1, null, 212, 1);
        this.fmlBuffer[213] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, "999999999.99", 213, 1);
        this.fmlBuffer[214] = new FmlField("PUBLISH_LEVEL", FmlField.TYPE_STRING, 31, null, 214, 1);
        this.fmlBuffer[215] = new FmlField("AUTO_RELEASE_IND", FmlField.TYPE_BYTE, -1, null, 215, 1);
        this.fmlBuffer[216] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, null, 216, 1);
        this.fmlBuffer[217] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, null, 217, 1);
        this.fmlBuffer[218] = new FmlField("OPERATOR_CW_LMT", FmlField.TYPE_DOUBLE, -1, null, 218, 1);
        this.fmlBuffer[219] = new FmlField("SEND_SMS_FOR_MATCH", FmlField.TYPE_BYTE, -1, null, 219, 1);
        this.fmlBuffer[220] = new FmlField("CPS_STATUS", FmlField.TYPE_BYTE, -1, null, 220, 1);
        this.fmlBuffer[221] = new FmlField("CPS_TRANSACTION", FmlField.TYPE_SHORT, -1, null, 221, 1);
        this.fmlBuffer[222] = new FmlField("CPS_TYPE", FmlField.TYPE_SHORT, -1, null, 222, 1);
        this.fmlBuffer[223] = new FmlField("ISP_PASS", FmlField.TYPE_STRING, 31, null, 223, 1);
        this.fmlBuffer[224] = new FmlField("ISP_TYPE", FmlField.TYPE_STRING, 3, null, 224, 1);
        this.fmlBuffer[225] = new FmlField("OPERATOR_TMP_DATE", FmlField.TYPE_STRING, 9, null, 225, 1);
        this.fmlBuffer[226] = new FmlField("OPERATOR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, null, 226, 1);
        this.fmlBuffer[227] = new FmlField("SUB_ORG_CD", FmlField.TYPE_STRING, 11, null, 227, 1);
        this.fmlBuffer[228] = new FmlField("ORG_MEMBER_NO", FmlField.TYPE_STRING, 21, null, 228, 1);
        this.fmlBuffer[229] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, null, 229, 1);
        this.fmlBuffer[230] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 230, 1);
        this.fmlBuffer[231] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, null, 231, 1);
        this.fmlBuffer[232] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 232, 1);
        this.fmlBuffer[233] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 233, 1);
        this.fmlBuffer[234] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, null, 234, 1);
        this.fmlBuffer[235] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, null, 235, 1);
        this.fmlBuffer[236] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 236, 1);
        this.fmlBuffer[237] = new FmlField("PAGRSOCBUFROWID", FmlField.TYPE_STRING, 19, null, 237, 50);
        this.fmlBuffer[238] = new FmlField("SOC", FmlField.TYPE_STRING, 10, null, 238, 50);
        this.fmlBuffer[239] = new FmlField("SOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 239, 50);
        this.fmlBuffer[240] = new FmlField("COMMITMENT_END_DATE", FmlField.TYPE_STRING, 9, null, 240, 50);
        this.fmlBuffer[241] = new FmlField("SERVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 241, 50);
        this.fmlBuffer[242] = new FmlField("PAGRSOCBUFEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 242, 50);
        this.fmlBuffer[243] = new FmlField("EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 243, 50);
        this.fmlBuffer[244] = new FmlField("SOC_LEVEL_CODE", FmlField.TYPE_BYTE, -1, null, 244, 50);
        this.fmlBuffer[245] = new FmlField("PAGRSOCBUFDEALER_CODE", FmlField.TYPE_STRING, 6, null, 245, 50);
        this.fmlBuffer[246] = new FmlField("PAGRSOCBUFSALES_AGENT", FmlField.TYPE_STRING, 6, null, 246, 50);
        this.fmlBuffer[247] = new FmlField("SRV_MODE", FmlField.TYPE_BYTE, -1, null, 247, 50);
        this.fmlBuffer[248] = new FmlField("SRV_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 248, 50);
        this.fmlBuffer[249] = new FmlField("SOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 249, 50);
        this.fmlBuffer[250] = new FmlField("SRV_TRX_ID", FmlField.TYPE_INTEGER, -1, null, 250, 50);
        this.fmlBuffer[251] = new FmlField("CAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 251, 50);
        this.fmlBuffer[252] = new FmlField("CAMPAIGN", FmlField.TYPE_STRING, 10, null, 252, 50);
        this.fmlBuffer[253] = new FmlField("PAGRSOCBUFCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 253, 50);
        this.fmlBuffer[254] = new FmlField("PAGRSOCBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 254, 50);
        this.fmlBuffer[255] = new FmlField("LOAN_VER_NO", FmlField.TYPE_INTEGER, -1, null, 255, 50);
        this.fmlBuffer[256] = new FmlField("LOAN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 256, 50);
        this.fmlBuffer[257] = new FmlField("SOC_ACTV_FEE", FmlField.TYPE_DOUBLE, -1, null, 257, 50);
        this.fmlBuffer[258] = new FmlField("PROMOTIONAL_SOC", FmlField.TYPE_STRING, 10, null, 258, 50);
        this.fmlBuffer[259] = new FmlField("REASON_CODE", FmlField.TYPE_STRING, 5, null, 259, 50);
        this.fmlBuffer[260] = new FmlField("SOC_START_RC_DATE", FmlField.TYPE_STRING, 9, null, 260, 50);
        this.fmlBuffer[261] = new FmlField("RC_DATE_COPY_IND", FmlField.TYPE_BYTE, -1, null, 261, 50);
        this.fmlBuffer[262] = new FmlField("PAGRFRNDFMLROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 262, 1);
        this.fmlBuffer[263] = new FmlField("ACTIONIND", FmlField.TYPE_BYTE, -1, null, 263, 10000);
        this.fmlBuffer[264] = new FmlField("PCSFANDFRECROWID", FmlField.TYPE_STRING, 19, null, 264, 10000);
        this.fmlBuffer[265] = new FmlField("PCSFANDFRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 265, 10000);
        this.fmlBuffer[266] = new FmlField("PCSFANDFRECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 266, 10000);
        this.fmlBuffer[267] = new FmlField("PERSONAL_TEL", FmlField.TYPE_STRING, 21, null, 267, 10000);
        this.fmlBuffer[268] = new FmlField("PERSONAL_TEL_TO", FmlField.TYPE_STRING, 21, null, 268, 10000);
        this.fmlBuffer[269] = new FmlField("FF_SOC", FmlField.TYPE_STRING, 10, null, 269, 10000);
        this.fmlBuffer[270] = new FmlField("PLAN_CODE", FmlField.TYPE_STRING, 10, null, 270, 10000);
        this.fmlBuffer[271] = new FmlField("DISCOUNT_TYPE", FmlField.TYPE_BYTE, -1, null, 271, 10000);
        this.fmlBuffer[272] = new FmlField("START_HOUR", FmlField.TYPE_STRING, 7, null, 272, 10000);
        this.fmlBuffer[273] = new FmlField("DURATION", FmlField.TYPE_DOUBLE, -1, null, 273, 10000);
        this.fmlBuffer[274] = new FmlField("PAGRFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 274, 1);
        this.fmlBuffer[275] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 275, 2);
        this.fmlBuffer[276] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 276, 2);
        this.fmlBuffer[277] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 277, 1);
        this.fmlBuffer[278] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 278, 25);
        this.fmlBuffer[279] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 279, 25);
        this.fmlBuffer[280] = new FmlField("PEFCSMACTVBUFSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 280, 25);
        this.fmlBuffer[281] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 281, 25);
        this.fmlBuffer[282] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 282, 25);
        this.fmlBuffer[283] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 283, 25);
        this.fmlBuffer[284] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 284, 25);
        this.fmlBuffer[285] = new FmlField("P1", FmlField.TYPE_STRING, 21, null, 285, 25);
        this.fmlBuffer[286] = new FmlField("P2", FmlField.TYPE_STRING, 21, null, 286, 25);
        this.fmlBuffer[287] = new FmlField("P3", FmlField.TYPE_STRING, 21, null, 287, 25);
        this.fmlBuffer[288] = new FmlField("P4", FmlField.TYPE_STRING, 21, null, 288, 25);
        this.fmlBuffer[289] = new FmlField("P5", FmlField.TYPE_STRING, 21, null, 289, 25);
        this.fmlBuffer[290] = new FmlField("P6", FmlField.TYPE_STRING, 21, null, 290, 25);
        this.fmlBuffer[291] = new FmlField("P7", FmlField.TYPE_STRING, 21, null, 291, 25);
        this.fmlBuffer[292] = new FmlField("P8", FmlField.TYPE_STRING, 21, null, 292, 25);
        this.fmlBuffer[293] = new FmlField("P9", FmlField.TYPE_STRING, 21, null, 293, 25);
        this.fmlBuffer[294] = new FmlField("P10", FmlField.TYPE_STRING, 21, null, 294, 25);
        this.fmlBuffer[295] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 295, 25);
        this.fmlBuffer[296] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 296, 25);
        this.fmlBuffer[297] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 297, 25);
        this.fmlBuffer[298] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 298, 25);
        this.fmlBuffer[299] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 299, 25);
        this.fmlBuffer[300] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 300, 25);
        this.fmlBuffer[301] = new FmlField("PSRVTPINPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 301, 1);
        this.fmlBuffer[302] = new FmlField("TUXSRVTP", FmlField.TYPE_BYTE, -1, null, 302, 25);
        this.fmlBuffer[303] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 303, 1);
        this.fmlBuffer[304] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 304, 20);
        this.fmlBuffer[305] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 305, 20);
        this.fmlBuffer[306] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 306, 20);
        this.fmlBuffer[307] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 307, 20);
        this.fmlBuffer[308] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 308, 20);
        this.fmlBuffer[309] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 309, 20);
        this.fmlBuffer[310] = new FmlField("LNKRECBAN", FmlField.TYPE_INTEGER, -1, null, 310, 20);
        this.fmlBuffer[311] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 311, 20);
        this.fmlBuffer[312] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 312, 20);
        this.fmlBuffer[313] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 313, 20);
        this.fmlBuffer[314] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 314, 20);
        this.fmlBuffer[315] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 315, 20);
        this.fmlBuffer[316] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 316, 20);
        this.fmlBuffer[317] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 317, 20);
        this.fmlBuffer[318] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 318, 20);
        this.fmlBuffer[319] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 319, 20);
        this.fmlBuffer[320] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 320, 20);
        this.fmlBuffer[321] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 321, 20);
        this.fmlBuffer[322] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 322, 20);
        this.fmlBuffer[323] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 323, 20);
        this.fmlBuffer[324] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 324, 20);
        this.fmlBuffer[325] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 325, 20);
        this.fmlBuffer[326] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 326, 20);
        this.fmlBuffer[327] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 327, 20);
        this.fmlBuffer[328] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 328, 20);
        this.fmlBuffer[329] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 329, 20);
        this.fmlBuffer[330] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 330, 20);
        this.fmlBuffer[331] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 331, 20);
        this.fmlBuffer[332] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 332, 20);
        this.fmlBuffer[333] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 333, 20);
        this.fmlBuffer[334] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 334, 20);
        this.fmlBuffer[335] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 335, 20);
        this.fmlBuffer[336] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 336, 20);
        this.fmlBuffer[337] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 337, 20);
        this.fmlBuffer[338] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 338, 20);
        this.fmlBuffer[339] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 339, 20);
        this.fmlBuffer[340] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, null, 340, 20);
        this.fmlBuffer[341] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 341, 20);
        this.fmlBuffer[342] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 342, 20);
        this.fmlBuffer[343] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 343, 20);
        this.fmlBuffer[344] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 344, 20);
        this.fmlBuffer[345] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 345, 20);
        this.fmlBuffer[346] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 346, 20);
        this.fmlBuffer[347] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 347, 20);
        this.fmlBuffer[348] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 348, 20);
        this.fmlBuffer[349] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 349, 20);
        this.fmlBuffer[350] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 350, 20);
        this.fmlBuffer[351] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 351, 20);
        this.fmlBuffer[352] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 352, 20);
        this.fmlBuffer[353] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 353, 20);
        this.fmlBuffer[354] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 354, 20);
        this.fmlBuffer[355] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 355, 20);
        this.fmlBuffer[356] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 356, 20);
        this.fmlBuffer[357] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 357, 20);
        this.fmlBuffer[358] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 358, 20);
        this.fmlBuffer[359] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 359, 20);
        this.fmlBuffer[360] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 360, 20);
        this.fmlBuffer[361] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 361, 20);
        this.fmlBuffer[362] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 362, 20);
        this.fmlBuffer[363] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 363, 20);
        this.fmlBuffer[364] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 364, 20);
        this.fmlBuffer[365] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 365, 20);
        this.fmlBuffer[366] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 366, 20);
        this.fmlBuffer[367] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 367, 20);
        this.fmlBuffer[368] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 368, 20);
        this.fmlBuffer[369] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 369, 20);
        this.fmlBuffer[370] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 370, 20);
        this.fmlBuffer[371] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 371, 20);
        this.fmlBuffer[372] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 372, 20);
        this.fmlBuffer[373] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 373, 20);
        this.fmlBuffer[374] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 374, 20);
        this.fmlBuffer[375] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 375, 20);
        this.fmlBuffer[376] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 376, 20);
        this.fmlBuffer[377] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 377, 20);
        this.fmlBuffer[378] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 378, 20);
        this.fmlBuffer[379] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 379, 20);
        this.fmlBuffer[380] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 380, 20);
        this.fmlBuffer[381] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 381, 20);
        this.fmlBuffer[382] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 382, 20);
        this.fmlBuffer[383] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 383, 20);
        this.fmlBuffer[384] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 384, 20);
        this.fmlBuffer[385] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 385, 20);
        this.fmlBuffer[386] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 386, 20);
        this.fmlBuffer[387] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 387, 20);
        this.fmlBuffer[388] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 388, 20);
        this.fmlBuffer[389] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 389, 20);
        this.fmlBuffer[390] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 390, 20);
        this.fmlBuffer[391] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 391, 20);
        this.fmlBuffer[392] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 392, 20);
        this.fmlBuffer[393] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 393, 20);
        this.fmlBuffer[394] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 394, 20);
        this.fmlBuffer[395] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 395, 20);
        this.fmlBuffer[396] = new FmlField("PESNBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 396, 1);
        this.fmlBuffer[397] = new FmlField("EQUIPMENT_NO", FmlField.TYPE_STRING, 21, null, 397, 50);
        this.fmlBuffer[398] = new FmlField("PHD_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 398, 50);
        this.fmlBuffer[399] = new FmlField("EQUIPMENT_LEVEL", FmlField.TYPE_SHORT, -1, null, 399, 50);
        this.fmlBuffer[400] = new FmlField("IMSI", FmlField.TYPE_STRING, 16, null, 400, 50);
        this.fmlBuffer[401] = new FmlField("PHYDEVARRAYEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 401, 50);
        this.fmlBuffer[402] = new FmlField("PHYDEVARRAYEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 402, 50);
        this.fmlBuffer[403] = new FmlField("OWNERSHIP_CODE", FmlField.TYPE_STRING, 3, null, 403, 50);
        this.fmlBuffer[404] = new FmlField("SW_STATE_IND", FmlField.TYPE_BYTE, -1, null, 404, 50);
        this.fmlBuffer[405] = new FmlField("LAST_SW_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 405, 50);
        this.fmlBuffer[406] = new FmlField("NEXT_ACTV_CODE", FmlField.TYPE_BYTE, -1, null, 406, 50);
        this.fmlBuffer[407] = new FmlField("NEXT_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 407, 50);
        this.fmlBuffer[408] = new FmlField("NEXT_ACTV_ISSUE_DT", FmlField.TYPE_STRING, 9, null, 408, 50);
        this.fmlBuffer[409] = new FmlField("DEVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 409, 50);
        this.fmlBuffer[410] = new FmlField("ESN_MODE", FmlField.TYPE_BYTE, -1, null, 410, 50);
        this.fmlBuffer[411] = new FmlField("ITEM_ID", FmlField.TYPE_STRING, 16, null, 411, 50);
        this.fmlBuffer[412] = new FmlField("POOL", FmlField.TYPE_STRING, 3, null, 412, 50);
        this.fmlBuffer[413] = new FmlField("LOCATION_ID", FmlField.TYPE_STRING, 5, null, 413, 50);
        this.fmlBuffer[414] = new FmlField("ACTIVITY_CODE", FmlField.TYPE_STRING, 5, null, 414, 50);
        this.fmlBuffer[415] = new FmlField("ACTIVITY_DATE", FmlField.TYPE_STRING, 15, null, 415, 50);
        this.fmlBuffer[416] = new FmlField("OPERATION_STATUS", FmlField.TYPE_BYTE, -1, null, 416, 50);
        this.fmlBuffer[417] = new FmlField("ITEM_OWNERSHIP", FmlField.TYPE_BYTE, -1, null, 417, 50);
        this.fmlBuffer[418] = new FmlField("ITEM_OWNERSHIP_DT", FmlField.TYPE_STRING, 15, null, 418, 50);
        this.fmlBuffer[419] = new FmlField("CURR_POSSESSION", FmlField.TYPE_BYTE, -1, null, 419, 50);
        this.fmlBuffer[420] = new FmlField("CURR_POSSESSION_DT", FmlField.TYPE_STRING, 15, null, 420, 50);
        this.fmlBuffer[421] = new FmlField("MISSING_IND", FmlField.TYPE_BYTE, -1, null, 421, 50);
        this.fmlBuffer[422] = new FmlField("IN_REPAIR_IND", FmlField.TYPE_BYTE, -1, null, 422, 50);
        this.fmlBuffer[423] = new FmlField("IN_TRANSIT_IND", FmlField.TYPE_BYTE, -1, null, 423, 50);
        this.fmlBuffer[424] = new FmlField("COMITED_TO_POS_IND", FmlField.TYPE_BYTE, -1, null, 424, 50);
        this.fmlBuffer[425] = new FmlField("COMITED_DATE", FmlField.TYPE_STRING, 15, null, 425, 50);
        this.fmlBuffer[426] = new FmlField("ACTIVITY_REASON", FmlField.TYPE_STRING, 4, null, 426, 50);
        this.fmlBuffer[427] = new FmlField("UPGRADE_IND", FmlField.TYPE_BYTE, -1, null, 427, 50);
        this.fmlBuffer[428] = new FmlField("EXPECTED_RTRN_DATE", FmlField.TYPE_STRING, 15, null, 428, 50);
        this.fmlBuffer[429] = new FmlField("POLICE_REPORT_NO", FmlField.TYPE_STRING, 16, null, 429, 50);
        this.fmlBuffer[430] = new FmlField("POLICE_REPORT_DATE", FmlField.TYPE_STRING, 15, null, 430, 50);
        this.fmlBuffer[431] = new FmlField("POLICE_STATION", FmlField.TYPE_STRING, 31, null, 431, 50);
        this.fmlBuffer[432] = new FmlField("PUK", FmlField.TYPE_INTEGER, -1, null, 432, 50);
        this.fmlBuffer[433] = new FmlField("PUK2", FmlField.TYPE_INTEGER, -1, null, 433, 50);
        this.fmlBuffer[434] = new FmlField("FIRST_USED_DATE", FmlField.TYPE_STRING, 15, null, 434, 50);
        this.fmlBuffer[435] = new FmlField("SIM_STATUS", FmlField.TYPE_BYTE, -1, null, 435, 50);
        this.fmlBuffer[436] = new FmlField("SUSPEND_IND", FmlField.TYPE_BYTE, -1, null, 436, 50);
        this.fmlBuffer[437] = new FmlField("SUSPEND_DATE", FmlField.TYPE_STRING, 15, null, 437, 50);
        this.fmlBuffer[438] = new FmlField("SENT_TO_AUC_IND", FmlField.TYPE_BYTE, -1, null, 438, 50);
        this.fmlBuffer[439] = new FmlField("HLR_CD", FmlField.TYPE_STRING, 4, null, 439, 50);
        this.fmlBuffer[440] = new FmlField("K4ID", FmlField.TYPE_STRING, 41, null, 440, 50);
        this.fmlBuffer[441] = new FmlField("PHYDEVARRAYDEALER_CODE", FmlField.TYPE_STRING, 6, null, 441, 50);
        this.fmlBuffer[442] = new FmlField("PSOCFTRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 442, 1);
        this.fmlBuffer[443] = new FmlField("PSOCFTRBUFROWID", FmlField.TYPE_STRING, 19, null, 443, 200);
        this.fmlBuffer[444] = new FmlField("PSOCFTRBUFSOC", FmlField.TYPE_STRING, 10, null, 444, 200);
        this.fmlBuffer[445] = new FmlField("PSOCFTRBUFSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 445, 200);
        this.fmlBuffer[446] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 446, 200);
        this.fmlBuffer[447] = new FmlField("MPS_FTR_CODE", FmlField.TYPE_STRING, 7, null, 447, 200);
        this.fmlBuffer[448] = new FmlField("FTR_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 448, 200);
        this.fmlBuffer[449] = new FmlField("FTR_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 449, 200);
        this.fmlBuffer[450] = new FmlField("FTR_EFF_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 450, 200);
        this.fmlBuffer[451] = new FmlField("FTR_EXP_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 451, 200);
        this.fmlBuffer[452] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 452, 200);
        this.fmlBuffer[453] = new FmlField("FTR_MODE", FmlField.TYPE_BYTE, -1, null, 453, 200);
        this.fmlBuffer[454] = new FmlField("PSOCFTRBUFSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 454, 200);
        this.fmlBuffer[455] = new FmlField("FTR_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 455, 200);
        this.fmlBuffer[456] = new FmlField("FTR_ADD_PARAM", FmlField.TYPE_STRING, 301, null, 456, 200);
        this.fmlBuffer[457] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, null, 457, 200);
        this.fmlBuffer[458] = new FmlField("PSOCFTRBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 458, 200);
        this.fmlBuffer[459] = new FmlField("PSOCFTRBUFCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 459, 200);
        this.fmlBuffer[460] = new FmlField("FTR_SPECIAL_TELNO", FmlField.TYPE_STRING, 21, null, 460, 200);
        this.fmlBuffer[461] = new FmlField("SWITCH_ACT_NEEDED", FmlField.TYPE_BYTE, -1, null, 461, 200);
        this.fmlBuffer[462] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, null, 462, 200);
        this.fmlBuffer[463] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, null, 463, 200);
        this.fmlBuffer[464] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 464, 200);
        this.fmlBuffer[465] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, null, 465, 200);
        this.fmlBuffer[466] = new FmlField("MANUAL_RC_RATE", FmlField.TYPE_DOUBLE, -1, null, 466, 200);
        this.fmlBuffer[467] = new FmlField("MANUAL_RC_EXP_DATE", FmlField.TYPE_STRING, 9, null, 467, 200);
        this.fmlBuffer[468] = new FmlField("PNPINFOBUFFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 468, 1);
        this.fmlBuffer[469] = new FmlField("NPNUMINFORECROWID", FmlField.TYPE_STRING, 19, null, 469, 500);
        this.fmlBuffer[470] = new FmlField("PORT_NUMBER", FmlField.TYPE_STRING, 21, null, 470, 500);
        this.fmlBuffer[471] = new FmlField("NPNUMINFORECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 471, 500);
        this.fmlBuffer[472] = new FmlField("NPNUMINFORECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 472, 500);
        this.fmlBuffer[473] = new FmlField("NPNUMINFORECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 473, 500);
        this.fmlBuffer[474] = new FmlField("NPNUMINFORECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 474, 500);
        this.fmlBuffer[475] = new FmlField("NPNUMINFORECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 475, 500);
        this.fmlBuffer[476] = new FmlField("NPNUMINFORECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 476, 500);
        this.fmlBuffer[477] = new FmlField("NPNUMINFORECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 477, 500);
        this.fmlBuffer[478] = new FmlField("NPNUMINFORECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 478, 500);
        this.fmlBuffer[479] = new FmlField("INT_ORDER_ID", FmlField.TYPE_DOUBLE, -1, null, 479, 500);
        this.fmlBuffer[480] = new FmlField("ORG_CUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 480, 500);
        this.fmlBuffer[481] = new FmlField("PORT_IND", FmlField.TYPE_BYTE, -1, null, 481, 500);
        this.fmlBuffer[482] = new FmlField("NUMBER_TYPE", FmlField.TYPE_BYTE, -1, null, 482, 500);
        this.fmlBuffer[483] = new FmlField("PORT_REQUEST_DATE", FmlField.TYPE_STRING, 15, null, 483, 500);
        this.fmlBuffer[484] = new FmlField("ORG_OPERATOR", FmlField.TYPE_STRING, 6, null, 484, 500);
        this.fmlBuffer[485] = new FmlField("NPNUMINFORECSUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, null, 485, 500);
        this.fmlBuffer[486] = new FmlField("LAST_INT_ORD_ID", FmlField.TYPE_DOUBLE, -1, null, 486, 500);
        this.fmlBuffer[487] = new FmlField("FUNCTION_PORT_IND", FmlField.TYPE_BYTE, -1, null, 487, 500);
        this.fmlBuffer[488] = new FmlField("PASSIVE_IND", FmlField.TYPE_BYTE, -1, null, 488, 500);
        this.fmlBuffer[489] = new FmlField("AUTO_CONFIRM", FmlField.TYPE_BYTE, -1, null, 489, 500);
        this.fmlBuffer[490] = new FmlField("TEMPORARY_MSISDN", FmlField.TYPE_STRING, 21, null, 490, 500);
        this.fmlBuffer[491] = new FmlField("HANDLE_MODE", FmlField.TYPE_BYTE, -1, null, 491, 500);
        this.fmlBuffer[492] = new FmlField("SEND_IND", FmlField.TYPE_BYTE, -1, null, 492, 500);
        this.fmlBuffer[493] = new FmlField("ORDID_STR", FmlField.TYPE_STRING, 21, null, 493, 500);
        this.fmlBuffer[494] = new FmlField("LAST_ORDID_STR", FmlField.TYPE_STRING, 21, null, 494, 500);
        this.fmlBuffer[495] = new FmlField("ICC", FmlField.TYPE_STRING, 61, null, 495, 500);
        this.fmlBuffer[496] = new FmlField("CUSTOMER_NAME", FmlField.TYPE_STRING, 255, null, 496, 500);
        this.fmlBuffer[497] = new FmlField("NPINFOBUFFCUSTOMER_ID", FmlField.TYPE_STRING, 61, null, 497, 500);
        this.fmlBuffer[498] = new FmlField("SERVICE_PROVIDER", FmlField.TYPE_STRING, 6, null, 498, 500);
        this.fmlBuffer[499] = new FmlField("RSNCODE", FmlField.TYPE_STRING, 5, null, 499, 1);
    }
