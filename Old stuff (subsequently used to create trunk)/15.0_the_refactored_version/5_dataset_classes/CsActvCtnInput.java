...
public class CsActvCtnInput extends ServiceInput {
    ...
    public CsActvCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[24] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 24, 1);
        this.fmlBuffer[25] = new FmlField("ROWID", FmlField.TYPE_STRING, 19, null, 25, 50);
        this.fmlBuffer[26] = new FmlField("SOC", FmlField.TYPE_STRING, 10, null, 26, 50);
        this.fmlBuffer[27] = new FmlField("SOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 27, 50);
        this.fmlBuffer[28] = new FmlField("COMMITMENT_END_DATE", FmlField.TYPE_STRING, 9, null, 28, 50);
        this.fmlBuffer[29] = new FmlField("SERVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 29, 50);
        this.fmlBuffer[30] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 30, 50);
        this.fmlBuffer[31] = new FmlField("EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 31, 50);
        this.fmlBuffer[32] = new FmlField("SOC_LEVEL_CODE", FmlField.TYPE_BYTE, -1, null, 32, 50);
        this.fmlBuffer[33] = new FmlField("DEALER_CODE", FmlField.TYPE_STRING, 6, null, 33, 50);
        this.fmlBuffer[34] = new FmlField("SALES_AGENT", FmlField.TYPE_STRING, 6, null, 34, 50);
        this.fmlBuffer[35] = new FmlField("SRV_MODE", FmlField.TYPE_BYTE, -1, null, 35, 50);
        this.fmlBuffer[36] = new FmlField("SRV_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 36, 50);
        this.fmlBuffer[37] = new FmlField("SOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 37, 50);
        this.fmlBuffer[38] = new FmlField("SRV_TRX_ID", FmlField.TYPE_INTEGER, -1, null, 38, 50);
        this.fmlBuffer[39] = new FmlField("CAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 39, 50);
        this.fmlBuffer[40] = new FmlField("CAMPAIGN", FmlField.TYPE_STRING, 10, null, 40, 50);
        this.fmlBuffer[41] = new FmlField("COMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, null, 41, 50);
        this.fmlBuffer[42] = new FmlField("PRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 42, 50);
        this.fmlBuffer[43] = new FmlField("LOAN_VER_NO", FmlField.TYPE_INTEGER, -1, null, 43, 50);
        this.fmlBuffer[44] = new FmlField("LOAN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 44, 50);
        this.fmlBuffer[45] = new FmlField("SOC_ACTV_FEE", FmlField.TYPE_DOUBLE, -1, null, 45, 50);
        this.fmlBuffer[46] = new FmlField("PROMOTIONAL_SOC", FmlField.TYPE_STRING, 10, null, 46, 50);
        this.fmlBuffer[47] = new FmlField("REASON_CODE", FmlField.TYPE_STRING, 5, null, 47, 50);
        this.fmlBuffer[48] = new FmlField("SOC_START_RC_DATE", FmlField.TYPE_STRING, 9, null, 48, 50);
        this.fmlBuffer[49] = new FmlField("RC_DATE_COPY_IND", FmlField.TYPE_BYTE, -1, null, 49, 50);
        ...
        this.fmlBuffer[75] = new FmlField("PSOCFTRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 75, 1);
        this.fmlBuffer[76] = new FmlField("PSOCFTRBUFROWID", FmlField.TYPE_STRING, 19, null, 76, 200);
        this.fmlBuffer[77] = new FmlField("PSOCFTRBUFSOC", FmlField.TYPE_STRING, 10, null, 77, 200);
        this.fmlBuffer[78] = new FmlField("PSOCFTRBUFSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 78, 200);
        this.fmlBuffer[79] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 79, 200);
        this.fmlBuffer[80] = new FmlField("MPS_FTR_CODE", FmlField.TYPE_STRING, 7, null, 80, 200);
        this.fmlBuffer[81] = new FmlField("FTR_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 81, 200);
        this.fmlBuffer[82] = new FmlField("FTR_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, null, 82, 200);
        this.fmlBuffer[83] = new FmlField("FTR_EFF_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 83, 200);
        this.fmlBuffer[84] = new FmlField("FTR_EXP_RSN_CODE", FmlField.TYPE_BYTE, -1, null, 84, 200);
        this.fmlBuffer[85] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 85, 200);
        this.fmlBuffer[86] = new FmlField("FTR_MODE", FmlField.TYPE_BYTE, -1, null, 86, 200);
        this.fmlBuffer[87] = new FmlField("PSOCFTRBUFSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 87, 200);
        this.fmlBuffer[88] = new FmlField("FTR_SUB_MODE", FmlField.TYPE_BYTE, -1, null, 88, 200);
        this.fmlBuffer[89] = new FmlField("FTR_ADD_PARAM", FmlField.TYPE_STRING, 301, null, 89, 200);
        this.fmlBuffer[90] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, null, 90, 200);
        this.fmlBuffer[91] = new FmlField("PSOCFTRBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 91, 200);
        this.fmlBuffer[92] = new FmlField("PSOCFTRBUFCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, null, 92, 200);
        this.fmlBuffer[93] = new FmlField("FTR_SPECIAL_TELNO", FmlField.TYPE_STRING, 21, null, 93, 200);
        this.fmlBuffer[94] = new FmlField("SWITCH_ACT_NEEDED", FmlField.TYPE_BYTE, -1, null, 94, 200);
        this.fmlBuffer[95] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, null, 95, 200);
        this.fmlBuffer[96] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, null, 96, 200);
        this.fmlBuffer[97] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, null, 97, 200);
        this.fmlBuffer[98] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, null, 98, 200);
        this.fmlBuffer[99] = new FmlField("MANUAL_RC_RATE", FmlField.TYPE_DOUBLE, -1, null, 99, 200);
        this.fmlBuffer[100] = new FmlField("MANUAL_RC_EXP_DATE", FmlField.TYPE_STRING, 9, null, 100, 200);
        this.fmlBuffer[101] = new FmlField("PCSFRNDFMLROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 101, 1);
        this.fmlBuffer[102] = new FmlField("ACTIONIND", FmlField.TYPE_BYTE, -1, null, 102, 10000);
        this.fmlBuffer[103] = new FmlField("PCSFANDFRECROWID", FmlField.TYPE_STRING, 19, null, 103, 10000);
        this.fmlBuffer[104] = new FmlField("PCSFANDFRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 104, 10000);
        this.fmlBuffer[105] = new FmlField("PCSFANDFRECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 105, 10000);
        this.fmlBuffer[106] = new FmlField("PERSONAL_TEL", FmlField.TYPE_STRING, 21, null, 106, 10000);
        this.fmlBuffer[107] = new FmlField("PERSONAL_TEL_TO", FmlField.TYPE_STRING, 21, null, 107, 10000);
        this.fmlBuffer[108] = new FmlField("FF_SOC", FmlField.TYPE_STRING, 10, null, 108, 10000);
        this.fmlBuffer[109] = new FmlField("PLAN_CODE", FmlField.TYPE_STRING, 10, null, 109, 10000);
        this.fmlBuffer[110] = new FmlField("DISCOUNT_TYPE", FmlField.TYPE_BYTE, -1, null, 110, 10000);
        this.fmlBuffer[111] = new FmlField("START_HOUR", FmlField.TYPE_STRING, 7, null, 111, 10000);
        this.fmlBuffer[112] = new FmlField("DURATION", FmlField.TYPE_DOUBLE, -1, null, 112, 10000);
        this.fmlBuffer[113] = new FmlField("PESNBUFFERROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 113, 1);
        this.fmlBuffer[114] = new FmlField("EQUIPMENT_NO", FmlField.TYPE_STRING, 21, null, 114, 50);
        this.fmlBuffer[115] = new FmlField("PHD_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 115, 50);
        this.fmlBuffer[116] = new FmlField("EQUIPMENT_LEVEL", FmlField.TYPE_SHORT, -1, null, 116, 50);
        this.fmlBuffer[117] = new FmlField("IMSI", FmlField.TYPE_STRING, 16, null, 117, 50);
        this.fmlBuffer[118] = new FmlField("PHYDEVARRAYEXPIRATION_DATE", FmlField.TYPE_STRING, 15, null, 118, 50);
        this.fmlBuffer[119] = new FmlField("PHYDEVARRAYEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, null, 119, 50);
        this.fmlBuffer[120] = new FmlField("OWNERSHIP_CODE", FmlField.TYPE_STRING, 3, null, 120, 50);
        this.fmlBuffer[121] = new FmlField("SW_STATE_IND", FmlField.TYPE_BYTE, -1, null, 121, 50);
        this.fmlBuffer[122] = new FmlField("LAST_SW_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 122, 50);
        this.fmlBuffer[123] = new FmlField("NEXT_ACTV_CODE", FmlField.TYPE_BYTE, -1, null, 123, 50);
        this.fmlBuffer[124] = new FmlField("NEXT_ACTV_DATE", FmlField.TYPE_STRING, 9, null, 124, 50);
        this.fmlBuffer[125] = new FmlField("NEXT_ACTV_ISSUE_DT", FmlField.TYPE_STRING, 9, null, 125, 50);
        this.fmlBuffer[126] = new FmlField("DEVICE_TYPE", FmlField.TYPE_BYTE, -1, null, 126, 50);
        this.fmlBuffer[127] = new FmlField("ESN_MODE", FmlField.TYPE_BYTE, -1, null, 127, 50);
        this.fmlBuffer[128] = new FmlField("ITEM_ID", FmlField.TYPE_STRING, 16, null, 128, 50);
        this.fmlBuffer[129] = new FmlField("POOL", FmlField.TYPE_STRING, 3, null, 129, 50);
        this.fmlBuffer[130] = new FmlField("LOCATION_ID", FmlField.TYPE_STRING, 5, null, 130, 50);
        this.fmlBuffer[131] = new FmlField("ACTIVITY_CODE", FmlField.TYPE_STRING, 5, null, 131, 50);
        this.fmlBuffer[132] = new FmlField("ACTIVITY_DATE", FmlField.TYPE_STRING, 15, null, 132, 50);
        this.fmlBuffer[133] = new FmlField("OPERATION_STATUS", FmlField.TYPE_BYTE, -1, null, 133, 50);
        this.fmlBuffer[134] = new FmlField("ITEM_OWNERSHIP", FmlField.TYPE_BYTE, -1, null, 134, 50);
        this.fmlBuffer[135] = new FmlField("ITEM_OWNERSHIP_DT", FmlField.TYPE_STRING, 15, null, 135, 50);
        this.fmlBuffer[136] = new FmlField("CURR_POSSESSION", FmlField.TYPE_BYTE, -1, null, 136, 50);
        this.fmlBuffer[137] = new FmlField("CURR_POSSESSION_DT", FmlField.TYPE_STRING, 15, null, 137, 50);
        this.fmlBuffer[138] = new FmlField("MISSING_IND", FmlField.TYPE_BYTE, -1, null, 138, 50);
        this.fmlBuffer[139] = new FmlField("IN_REPAIR_IND", FmlField.TYPE_BYTE, -1, null, 139, 50);
        this.fmlBuffer[140] = new FmlField("IN_TRANSIT_IND", FmlField.TYPE_BYTE, -1, null, 140, 50);
        this.fmlBuffer[141] = new FmlField("COMITED_TO_POS_IND", FmlField.TYPE_BYTE, -1, null, 141, 50);
        this.fmlBuffer[142] = new FmlField("COMITED_DATE", FmlField.TYPE_STRING, 15, null, 142, 50);
        this.fmlBuffer[143] = new FmlField("ACTIVITY_REASON", FmlField.TYPE_STRING, 4, null, 143, 50);
        this.fmlBuffer[144] = new FmlField("UPGRADE_IND", FmlField.TYPE_BYTE, -1, null, 144, 50);
        this.fmlBuffer[145] = new FmlField("EXPECTED_RTRN_DATE", FmlField.TYPE_STRING, 15, null, 145, 50);
        this.fmlBuffer[146] = new FmlField("POLICE_REPORT_NO", FmlField.TYPE_STRING, 16, null, 146, 50);
        this.fmlBuffer[147] = new FmlField("POLICE_REPORT_DATE", FmlField.TYPE_STRING, 15, null, 147, 50);
        this.fmlBuffer[148] = new FmlField("POLICE_STATION", FmlField.TYPE_STRING, 31, null, 148, 50);
        this.fmlBuffer[149] = new FmlField("PUK", FmlField.TYPE_INTEGER, -1, null, 149, 50);
        this.fmlBuffer[150] = new FmlField("PUK2", FmlField.TYPE_INTEGER, -1, null, 150, 50);
        this.fmlBuffer[151] = new FmlField("FIRST_USED_DATE", FmlField.TYPE_STRING, 15, null, 151, 50);
        this.fmlBuffer[152] = new FmlField("SIM_STATUS", FmlField.TYPE_BYTE, -1, null, 152, 50);
        this.fmlBuffer[153] = new FmlField("SUSPEND_IND", FmlField.TYPE_BYTE, -1, null, 153, 50);
        this.fmlBuffer[154] = new FmlField("SUSPEND_DATE", FmlField.TYPE_STRING, 15, null, 154, 50);
        this.fmlBuffer[155] = new FmlField("SENT_TO_AUC_IND", FmlField.TYPE_BYTE, -1, null, 155, 50);
        this.fmlBuffer[156] = new FmlField("HLR_CD", FmlField.TYPE_STRING, 4, null, 156, 50);
        this.fmlBuffer[157] = new FmlField("K4ID", FmlField.TYPE_STRING, 41, null, 157, 50);
        this.fmlBuffer[158] = new FmlField("PHYDEVARRAYDEALER_CODE", FmlField.TYPE_STRING, 6, null, 158, 50);
        this.fmlBuffer[159] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 159, 1);
        this.fmlBuffer[160] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 160, 25);
        this.fmlBuffer[161] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 161, 25);
        this.fmlBuffer[162] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 162, 25);
        this.fmlBuffer[163] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 163, 25);
        this.fmlBuffer[164] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 164, 25);
        this.fmlBuffer[165] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 165, 25);
        this.fmlBuffer[166] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 166, 25);
        this.fmlBuffer[167] = new FmlField("P1", FmlField.TYPE_STRING, 21, null, 167, 25);
        this.fmlBuffer[168] = new FmlField("P2", FmlField.TYPE_STRING, 21, null, 168, 25);
        this.fmlBuffer[169] = new FmlField("P3", FmlField.TYPE_STRING, 21, null, 169, 25);
        this.fmlBuffer[170] = new FmlField("P4", FmlField.TYPE_STRING, 21, null, 170, 25);
        this.fmlBuffer[171] = new FmlField("P5", FmlField.TYPE_STRING, 21, null, 171, 25);
        this.fmlBuffer[172] = new FmlField("P6", FmlField.TYPE_STRING, 21, null, 172, 25);
        this.fmlBuffer[173] = new FmlField("P7", FmlField.TYPE_STRING, 21, null, 173, 25);
        this.fmlBuffer[174] = new FmlField("P8", FmlField.TYPE_STRING, 21, null, 174, 25);
        this.fmlBuffer[175] = new FmlField("P9", FmlField.TYPE_STRING, 21, null, 175, 25);
        this.fmlBuffer[176] = new FmlField("P10", FmlField.TYPE_STRING, 21, null, 176, 25);
        this.fmlBuffer[177] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 177, 25);
        this.fmlBuffer[178] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 178, 25);
        this.fmlBuffer[179] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 179, 25);
        this.fmlBuffer[180] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 180, 25);
        this.fmlBuffer[181] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 181, 25);
        this.fmlBuffer[182] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 182, 25);
        ...
        this.fmlBuffer[257] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, "999999999.99", 257, 1);
        ...
        this.fmlBuffer[273] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 273, 1);
        this.fmlBuffer[274] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 274, 20);
        this.fmlBuffer[275] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 275, 20);
        this.fmlBuffer[276] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 276, 20);
        this.fmlBuffer[277] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 277, 20);
        this.fmlBuffer[278] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 278, 20);
        this.fmlBuffer[279] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 279, 20);
        this.fmlBuffer[280] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 280, 20);
        this.fmlBuffer[281] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 281, 20);
        this.fmlBuffer[282] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 282, 20);
        this.fmlBuffer[283] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 283, 20);
        this.fmlBuffer[284] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 284, 20);
        this.fmlBuffer[285] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 285, 20);
        this.fmlBuffer[286] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 286, 20);
        this.fmlBuffer[287] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 287, 20);
        this.fmlBuffer[288] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 288, 20);
        this.fmlBuffer[289] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 289, 20);
        this.fmlBuffer[290] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 290, 20);
        this.fmlBuffer[291] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 291, 20);
        this.fmlBuffer[292] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 292, 20);
        this.fmlBuffer[293] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 293, 20);
        this.fmlBuffer[294] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 294, 20);
        this.fmlBuffer[295] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 295, 20);
        this.fmlBuffer[296] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 296, 20);
        this.fmlBuffer[297] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 297, 20);
        this.fmlBuffer[298] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 298, 20);
        this.fmlBuffer[299] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 299, 20);
        this.fmlBuffer[300] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 300, 20);
        this.fmlBuffer[301] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 301, 20);
        this.fmlBuffer[302] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 302, 20);
        this.fmlBuffer[303] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 303, 20);
        this.fmlBuffer[304] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 304, 20);
        this.fmlBuffer[305] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 305, 20);
        this.fmlBuffer[306] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 306, 20);
        this.fmlBuffer[307] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 307, 20);
        this.fmlBuffer[308] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 308, 20);
        this.fmlBuffer[309] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 309, 20);
        this.fmlBuffer[310] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, null, 310, 20);
        this.fmlBuffer[311] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 311, 20);
        this.fmlBuffer[312] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 312, 20);
        this.fmlBuffer[313] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 313, 20);
        this.fmlBuffer[314] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 314, 20);
        this.fmlBuffer[315] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 315, 20);
        this.fmlBuffer[316] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 316, 20);
        this.fmlBuffer[317] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 317, 20);
        this.fmlBuffer[318] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 318, 20);
        this.fmlBuffer[319] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 319, 20);
        this.fmlBuffer[320] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 320, 20);
        this.fmlBuffer[321] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 321, 20);
        this.fmlBuffer[322] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 322, 20);
        this.fmlBuffer[323] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 323, 20);
        this.fmlBuffer[324] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 324, 20);
        this.fmlBuffer[325] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 325, 20);
        this.fmlBuffer[326] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 326, 20);
        this.fmlBuffer[327] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 327, 20);
        this.fmlBuffer[328] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 328, 20);
        this.fmlBuffer[329] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 329, 20);
        this.fmlBuffer[330] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 330, 20);
        this.fmlBuffer[331] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 331, 20);
        this.fmlBuffer[332] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 332, 20);
        this.fmlBuffer[333] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 333, 20);
        this.fmlBuffer[334] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 334, 20);
        this.fmlBuffer[335] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 335, 20);
        this.fmlBuffer[336] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 336, 20);
        this.fmlBuffer[337] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 337, 20);
        this.fmlBuffer[338] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 338, 20);
        this.fmlBuffer[339] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 339, 20);
        this.fmlBuffer[340] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 340, 20);
        this.fmlBuffer[341] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 341, 20);
        this.fmlBuffer[342] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 342, 20);
        this.fmlBuffer[343] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 343, 20);
        this.fmlBuffer[344] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 344, 20);
        this.fmlBuffer[345] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 345, 20);
        this.fmlBuffer[346] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 346, 20);
        this.fmlBuffer[347] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 347, 20);
        this.fmlBuffer[348] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 348, 20);
        this.fmlBuffer[349] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 349, 20);
        this.fmlBuffer[350] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 350, 20);
        this.fmlBuffer[351] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 351, 20);
        this.fmlBuffer[352] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 352, 20);
        this.fmlBuffer[353] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 353, 20);
        this.fmlBuffer[354] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 354, 20);
        this.fmlBuffer[355] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 355, 20);
        this.fmlBuffer[356] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 356, 20);
        this.fmlBuffer[357] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 357, 20);
        this.fmlBuffer[358] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 358, 20);
        this.fmlBuffer[359] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 359, 20);
        this.fmlBuffer[360] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 360, 20);
        this.fmlBuffer[361] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 361, 20);
        this.fmlBuffer[362] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 362, 20);
        this.fmlBuffer[363] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 363, 20);
        this.fmlBuffer[364] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 364, 20);
        this.fmlBuffer[365] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 365, 20);
        this.fmlBuffer[366] = new FmlField("PINSTLBUFROW_COUNT", FmlField.TYPE_INTEGER, -1, null, 366, 1);
        this.fmlBuffer[367] = new FmlField("INSTALLMENT_AMT", FmlField.TYPE_DOUBLE, -1, null, 367, 12);
        this.fmlBuffer[368] = new FmlField("INSTALLMENT_DATE", FmlField.TYPE_STRING, 9, null, 368, 12);
        this.fmlBuffer[369] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 369, 1);
        this.fmlBuffer[370] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, null, 370, 2);
        this.fmlBuffer[371] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 371, 2);
        ...
        this.fmlBuffer[379] = new FmlField("PARINPBAN", FmlField.TYPE_INTEGER, -1, null, 379, 1);
        this.fmlBuffer[380] = new FmlField("PARTITION_ROOT_BAN", FmlField.TYPE_INTEGER, -1, null, 380, 1);
        this.fmlBuffer[381] = new FmlField("PARINPSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 381, 1);
        this.fmlBuffer[382] = new FmlField("PARINPSUB_MARKET_CODE", FmlField.TYPE_STRING, 4, null, 382, 1);
        this.fmlBuffer[383] = new FmlField("REQUIREMENT_DATE", FmlField.TYPE_STRING, 9, null, 383, 1);
        this.fmlBuffer[384] = new FmlField("ACTIVATION_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 384, 1);
        this.fmlBuffer[385] = new FmlField("PREPAYMENT_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 385, 1);
        this.fmlBuffer[386] = new FmlField("PREP_ACTV_AMT", FmlField.TYPE_DOUBLE, -1, null, 386, 1);
        this.fmlBuffer[387] = new FmlField("RC_ONLY_IND", FmlField.TYPE_BYTE, -1, null, 387, 1);
        this.fmlBuffer[388] = new FmlField("PARINPDEALER_CODE", FmlField.TYPE_STRING, 6, null, 388, 1);
        this.fmlBuffer[389] = new FmlField("ACTV_EXMP_IND", FmlField.TYPE_BYTE, -1, null, 389, 1);
        this.fmlBuffer[390] = new FmlField("PREP_EXMP_IND", FmlField.TYPE_BYTE, -1, null, 390, 1);
        this.fmlBuffer[391] = new FmlField("SOURCE_APPL_CODE", FmlField.TYPE_BYTE, -1, null, 391, 1);
        this.fmlBuffer[392] = new FmlField("PARINPFEATURE_CODE", FmlField.TYPE_STRING, 7, null, 392, 1);
        this.fmlBuffer[393] = new FmlField("PARINPSOC", FmlField.TYPE_STRING, 10, null, 393, 1);
        this.fmlBuffer[394] = new FmlField("SOC_DATE", FmlField.TYPE_STRING, 9, null, 394, 1);
        this.fmlBuffer[395] = new FmlField("CAS_PT_REQ", FmlField.TYPE_BYTE, -1, null, 395, 1);
    }
