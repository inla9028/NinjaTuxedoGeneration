...
public class CsCallFrwdInput extends ServiceInput {
    ...
    public CsCallFrwdInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[17] = new FmlField("TN", FmlField.TYPE_STRING, 21, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("SRV_TRX_TP_CD", FmlField.TYPE_STRING, 4, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("TRX_SRC", FmlField.TYPE_STRING, 4, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("IMSI", FmlField.TYPE_STRING, 16, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("HLR_ID", FmlField.TYPE_STRING, 4, null, 21, 1);
        this.fmlBuffer[22] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, null, 22, 1);
        this.fmlBuffer[23] = new FmlField("FEATURES", FmlField.TYPE_STRING, 2001, null, 23, 1);
        this.fmlBuffer[24] = new FmlField("PRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 24, 1);
        this.fmlBuffer[25] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, null, 25, 1);
        this.fmlBuffer[26] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, null, 26, 1);
        this.fmlBuffer[27] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, null, 27, 1);
        this.fmlBuffer[28] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, null, 28, 1);
        this.fmlBuffer[29] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, null, 29, 1);
        this.fmlBuffer[30] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 30, 1);
        this.fmlBuffer[31] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, null, 31, 1);
        this.fmlBuffer[32] = new FmlField("P1", FmlField.TYPE_STRING, 21, null, 32, 1);
        this.fmlBuffer[33] = new FmlField("P2", FmlField.TYPE_STRING, 21, null, 33, 1);
        this.fmlBuffer[34] = new FmlField("P3", FmlField.TYPE_STRING, 21, null, 34, 1);
        this.fmlBuffer[35] = new FmlField("P4", FmlField.TYPE_STRING, 21, null, 35, 1);
        this.fmlBuffer[36] = new FmlField("P5", FmlField.TYPE_STRING, 21, null, 36, 1);
        this.fmlBuffer[37] = new FmlField("P6", FmlField.TYPE_STRING, 21, null, 37, 1);
        this.fmlBuffer[38] = new FmlField("P7", FmlField.TYPE_STRING, 21, null, 38, 1);
        this.fmlBuffer[39] = new FmlField("P8", FmlField.TYPE_STRING, 21, null, 39, 1);
        this.fmlBuffer[40] = new FmlField("P9", FmlField.TYPE_STRING, 21, null, 40, 1);
        this.fmlBuffer[41] = new FmlField("P10", FmlField.TYPE_STRING, 21, null, 41, 1);
        this.fmlBuffer[42] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 42, 1);
        this.fmlBuffer[43] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, null, 43, 1);
        this.fmlBuffer[44] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, null, 44, 1);
        this.fmlBuffer[45] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, null, 45, 1);
        this.fmlBuffer[46] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, null, 46, 1);
        this.fmlBuffer[47] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, null, 47, 1);
    }
