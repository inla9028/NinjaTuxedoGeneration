 ...
 */
public class CsGtAddIfOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsGtAddIfOutput.
     *
     * @throws FMLManipulationException
     */
    public CsGtAddIfOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsGtAddIfOutput() {
    }

    /**
     * Creates a new instance of CsGtAddIfOutput.
     *
     * @param ds Output dataset from CsGtAddIf service.
     * @throws FMLManipulationException
     */
    public CsGtAddIfOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[17] = new FmlField("FIELD_NAME", FmlField.TYPE_STRING, 31, null, 17, 500);
        this.fmlBuffer[18] = new FmlField("FIELD_VALUE", FmlField.TYPE_STRING, 256, null, 18, 500);
    }
