...
public class BlLsCallsDetOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        ...
        this.fmlBuffer[49] = new FmlField("CALLSLSTTOLLRECROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 49, 1);
        this.fmlBuffer[50] = new FmlField("CLLSTTOLBUFSTART_PERIOD", FmlField.TYPE_STRING, 3, null, 50, 600);
        this.fmlBuffer[51] = new FmlField("CLLSTTOLBUFCHARGED_DURATION", FmlField.TYPE_DOUBLE, -1, null, 51, 600);
        this.fmlBuffer[52] = new FmlField("CLLSTTOLBUFIM_GRANTED", FmlField.TYPE_DOUBLE, -1, null, 52, 600);
        this.fmlBuffer[53] = new FmlField("CLLSTTOLBUFGROSS_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 53, 600);
        this.fmlBuffer[54] = new FmlField("CLLSTTOLBUFNET_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 54, 600);
    }
