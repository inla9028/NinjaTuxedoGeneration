 ...
 */
public class CsSvPNPInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsSvPNPInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsSvPNPInput() throws EnvironmentException, FMLManipulationException {
        // Initialise FML buffer
        fmlBuffer = new FmlField[30];

        //// Get default values from DB
        //synchronized (this.defaultValuesPopulated) {
        //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
        //        defaultValues = getDefaultValues("csSvPNP", 30);
        ...
        this.fmlBuffer[17] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, null, 17, 10000);
        this.fmlBuffer[18] = new FmlField("ROWID", FmlField.TYPE_STRING, 19, null, 18, 10000);
        this.fmlBuffer[19] = new FmlField("PNI", FmlField.TYPE_STRING, 11, null, 19, 10000);
        this.fmlBuffer[20] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 20, 10000);
        this.fmlBuffer[21] = new FmlField("PNP_DESC", FmlField.TYPE_STRING, 41, null, 21, 10000);
        this.fmlBuffer[22] = new FmlField("MAX_MEMBERS", FmlField.TYPE_INTEGER, -1, null, 22, 10000);
        this.fmlBuffer[23] = new FmlField("PNI_TYPE", FmlField.TYPE_BYTE, -1, null, 23, 10000);
        this.fmlBuffer[24] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 24, 10000);
        this.fmlBuffer[25] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, null, 25, 10000);
        this.fmlBuffer[26] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, null, 26, 10000);
        this.fmlBuffer[27] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, null, 27, 10000);
        this.fmlBuffer[28] = new FmlField("MASTER_NUMBER", FmlField.TYPE_STRING, 21, null, 28, 10000);
        this.fmlBuffer[29] = new FmlField("STATUS", FmlField.TYPE_BYTE, -1, null, 29, 10000);
    }
     ...
     * @throws FMLManipulationException
     */
    public void set_PNI(int nIndex, String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'PNP_DESC' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 10000).
     * @return Value of 'PNP_DESC' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PNP_DESC(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[21].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PNP_DESC' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 41.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 10000).
     * @throws FMLManipulationException
     */
    public void set_PNP_DESC(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[21].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PNP_DESC' field in the FML buffer.
     *
     * @return Number of values defined for 'PNP_DESC' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PNP_DESC_size() throws FMLManipulationException {
        return (this.fmlBuffer[21].getCount());
    }

    /**
     * Retrieves the value of the 'MAX_MEMBERS' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 10000).
     * @return Value of 'MAX_MEMBERS' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_MAX_MEMBERS(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[22].getValue(nIndex));
    }

    /**
     * Sets the value of the 'MAX_MEMBERS' field in the FML buffer.
     *
     * @param value Default value: null.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 10000).
     * @throws FMLManipulationException
     */
    public void set_MAX_MEMBERS(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[22].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'MAX_MEMBERS' field in the FML buffer.
     *
     * @return Number of values defined for 'MAX_MEMBERS' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_MAX_MEMBERS_size() throws FMLManipulationException {
        return (this.fmlBuffer[22].getCount());
    }

    /**
     * Retrieves the value of the 'PNI_TYPE' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 10000).
     * @return Value of 'PNI_TYPE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PNI_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[23].getValue(nIndex)));
    }

    /**
     * Sets the value of the 'PNI_TYPE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 10000).
     * @throws FMLManipulationException
     */
    public void set_PNI_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[23].setValue(nIndex, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves number of values defined for 'PNI_TYPE' field in the FML buffer.
     *
     * @return Number of values defined for 'PNI_TYPE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PNI_TYPE_size() throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public Double get_CUST_WATCH_LMT(int nIndex) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_CUST_WATCH_LMT(int nIndex, Double value) throws FMLManipulationException {
        this.fmlBuffer[24].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'CUST_WATCH_LMT' field in the FML buffer.
     *
     * @return Number of values defined for 'CUST_WATCH_LMT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_CUST_WATCH_LMT_size() throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public Double get_BASIC_WATCH_LMT(int nIndex) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_BASIC_WATCH_LMT(int nIndex, Double value) throws FMLManipulationException {
        this.fmlBuffer[25].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'BASIC_WATCH_LMT' field in the FML buffer.
     *
     * @return Number of values defined for 'BASIC_WATCH_LMT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_BASIC_WATCH_LMT_size() throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public String get_CUST_WATCH_EFF_DATE(int nIndex) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_CUST_WATCH_EFF_DATE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[26].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'CUST_WATCH_EFF_DATE' field in the FML buffer.
     *
     * @return Number of values defined for 'CUST_WATCH_EFF_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_CUST_WATCH_EFF_DATE_size() throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public String get_CUST_WATCH_EXP_DATE(int nIndex) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_CUST_WATCH_EXP_DATE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[27].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'CUST_WATCH_EXP_DATE' field in the FML buffer.
     *
     * @return Number of values defined for 'CUST_WATCH_EXP_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_CUST_WATCH_EXP_DATE_size() throws FMLManipulationException {
        return (this.fmlBuffer[27].getCount());
    }

    /**
     * Retrieves the value of the 'MASTER_NUMBER' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 10000).
     * @return Value of 'MASTER_NUMBER' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_MASTER_NUMBER(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[28].getValue(nIndex));
    }

    /**
     * Sets the value of the 'MASTER_NUMBER' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 10000).
     * @throws FMLManipulationException
     */
    public void set_MASTER_NUMBER(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[28].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'MASTER_NUMBER' field in the FML buffer.
     *
     * @return Number of values defined for 'MASTER_NUMBER' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_MASTER_NUMBER_size() throws FMLManipulationException {
        return (this.fmlBuffer[28].getCount());
    }

    /**
     * Retrieves the value of the 'STATUS' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 10000).
     * @return Value of 'STATUS' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_STATUS(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[29].getValue(nIndex)));
    }

    /**
     * Sets the value of the 'STATUS' field in the FML buffer.
     *
     * @param value Default value: null.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 10000).
     * @throws FMLManipulationException
     */
    public void set_STATUS(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[29].setValue(nIndex, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves number of values defined for 'STATUS' field in the FML buffer.
     *
     * @return Number of values defined for 'STATUS' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_STATUS_size() throws FMLManipulationException {
