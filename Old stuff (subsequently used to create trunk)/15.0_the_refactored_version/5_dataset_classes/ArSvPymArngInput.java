 ...
 */
public class ArSvPymArngInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of ArSvPymArngInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public ArSvPymArngInput() throws EnvironmentException, FMLManipulationException {
        // Initialise FML buffer
        fmlBuffer = new FmlField[56];

        //// Get default values from DB
        //synchronized (this.defaultValuesPopulated) {
        //    if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
        //        defaultValues = getDefaultValues("arSvPymArng", 56);
        ...
        this.fmlBuffer[16] = new FmlField("PA_MODE", FmlField.TYPE_STRING, 4, null, 16, 1);
        this.fmlBuffer[17] = new FmlField("ROWID", FmlField.TYPE_STRING, 19, null, 17, 1);
        this.fmlBuffer[18] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, null, 18, 1);
        this.fmlBuffer[19] = new FmlField("PA_TYPE", FmlField.TYPE_BYTE, -1, null, 19, 1);
        this.fmlBuffer[20] = new FmlField("INI_CSR_ID", FmlField.TYPE_STRING, 9, null, 20, 1);
        this.fmlBuffer[21] = new FmlField("EXPECTED_PYM_AMOUNT", FmlField.TYPE_DOUBLE, -1, null, 21, 500);
        this.fmlBuffer[22] = new FmlField("EXPECTED_PYM_DATE", FmlField.TYPE_STRING, 9, null, 22, 500);
        this.fmlBuffer[23] = new FmlField("NEW_BUFF_SIZE", FmlField.TYPE_INTEGER, -1, null, 23, 1);
        this.fmlBuffer[24] = new FmlField("DELETE_REASON", FmlField.TYPE_STRING, 7, null, 24, 1);
        this.fmlBuffer[25] = new FmlField("DEL_CSR_ID", FmlField.TYPE_STRING, 9, null, 25, 1);
        this.fmlBuffer[26] = new FmlField("PA_ONETIME_FEE", FmlField.TYPE_DOUBLE, -1, null, 26, 1);
        this.fmlBuffer[27] = new FmlField("PA_RECURRING_FEE", FmlField.TYPE_DOUBLE, -1, null, 27, 1);
        this.fmlBuffer[28] = new FmlField("MAILING_ADDR_TP", FmlField.TYPE_BYTE, -1, null, 28, 1);
        ...
        this.fmlBuffer[36] = new FmlField("P1", FmlField.TYPE_STRING, 21, null, 36, 1);
        this.fmlBuffer[37] = new FmlField("P2", FmlField.TYPE_STRING, 21, null, 37, 1);
        this.fmlBuffer[38] = new FmlField("P3", FmlField.TYPE_STRING, 21, null, 38, 1);
        this.fmlBuffer[39] = new FmlField("P4", FmlField.TYPE_STRING, 21, null, 39, 1);
        this.fmlBuffer[40] = new FmlField("P5", FmlField.TYPE_STRING, 21, null, 40, 1);
        this.fmlBuffer[41] = new FmlField("P6", FmlField.TYPE_STRING, 21, null, 41, 1);
        this.fmlBuffer[42] = new FmlField("P7", FmlField.TYPE_STRING, 21, null, 42, 1);
        this.fmlBuffer[43] = new FmlField("P8", FmlField.TYPE_STRING, 21, null, 43, 1);
        this.fmlBuffer[44] = new FmlField("P9", FmlField.TYPE_STRING, 21, null, 44, 1);
        this.fmlBuffer[45] = new FmlField("P10", FmlField.TYPE_STRING, 21, null, 45, 1);
        ...
        this.fmlBuffer[52] = new FmlField("CHARGEAMOUNT", FmlField.TYPE_DOUBLE, -1, null, 52, 1);
        this.fmlBuffer[53] = new FmlField("CHARGEWAIVEIND", FmlField.TYPE_BYTE, -1, null, 53, 1);
        this.fmlBuffer[54] = new FmlField("DELETECHARGEIND", FmlField.TYPE_BYTE, -1, null, 54, 1);
        this.fmlBuffer[55] = new FmlField("CHRGENTSEQNO", FmlField.TYPE_INTEGER, -1, null, 55, 1);
    }
    ...
    /**
     * Retrieves the value of the 'PA_MODE' field in the FML buffer.
     *
     * @return Value of 'PA_MODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PA_MODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[16].getValue(0));
    }

    /**
     * Sets the value of the 'PA_MODE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_PA_MODE(String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public String get_PA_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[19].getValue(0)));
    }

    /**
     * Sets the value of the 'PA_TYPE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PA_TYPE(String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public String get_INI_CSR_ID() throws FMLManipulationException {
        return ((String) this.fmlBuffer[20].getValue(0));
    }

    /**
     * Sets the value of the 'INI_CSR_ID' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @throws FMLManipulationException
     */
    public void set_INI_CSR_ID(String value) throws FMLManipulationException {
        this.fmlBuffer[20].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'EXPECTED_PYM_AMOUNT' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 500).
     * @return Value of 'EXPECTED_PYM_AMOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Double get_EXPECTED_PYM_AMOUNT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[21].getValue(nIndex));
    }

    /**
     * Sets the value of the 'EXPECTED_PYM_AMOUNT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 500).
     * @throws FMLManipulationException
     */
    public void set_EXPECTED_PYM_AMOUNT(int nIndex, Double value) throws FMLManipulationException {
        this.fmlBuffer[21].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'EXPECTED_PYM_AMOUNT' field in the FML buffer.
     *
     * @return Number of values defined for 'EXPECTED_PYM_AMOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_EXPECTED_PYM_AMOUNT_size() throws FMLManipulationException {
        return (this.fmlBuffer[21].getCount());
    }

    /**
     * Retrieves the value of the 'EXPECTED_PYM_DATE' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 500).
     * @return Value of 'EXPECTED_PYM_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_EXPECTED_PYM_DATE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[22].getValue(nIndex));
    }

    /**
     * Sets the value of the 'EXPECTED_PYM_DATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 500).
     * @throws FMLManipulationException
     */
    public void set_EXPECTED_PYM_DATE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[22].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'EXPECTED_PYM_DATE' field in the FML buffer.
     *
     * @return Number of values defined for 'EXPECTED_PYM_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_EXPECTED_PYM_DATE_size() throws FMLManipulationException {
        return (this.fmlBuffer[22].getCount());
    }

    /**
     * Retrieves the value of the 'NEW_BUFF_SIZE' field in the FML buffer.
     *
     * @return Value of 'NEW_BUFF_SIZE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_NEW_BUFF_SIZE() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[23].getValue(0));
    }

    /**
     * Sets the value of the 'NEW_BUFF_SIZE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_NEW_BUFF_SIZE(Integer value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public String get_DELETE_REASON() throws FMLManipulationException {
        return ((String) this.fmlBuffer[24].getValue(0));
    }

    /**
     * Sets the value of the 'DELETE_REASON' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 7.
     * @throws FMLManipulationException
     */
    public void set_DELETE_REASON(String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public String get_DEL_CSR_ID() throws FMLManipulationException {
        return ((String) this.fmlBuffer[25].getValue(0));
    }

    /**
     * Sets the value of the 'DEL_CSR_ID' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @throws FMLManipulationException
     */
    public void set_DEL_CSR_ID(String value) throws FMLManipulationException {
        this.fmlBuffer[25].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PA_ONETIME_FEE' field in the FML buffer.
     *
     * @return Value of 'PA_ONETIME_FEE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Double get_PA_ONETIME_FEE() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[26].getValue(0));
    }

    /**
     * Sets the value of the 'PA_ONETIME_FEE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PA_ONETIME_FEE(Double value) throws FMLManipulationException {
        this.fmlBuffer[26].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PA_RECURRING_FEE' field in the FML buffer.
     *
     * @return Value of 'PA_RECURRING_FEE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Double get_PA_RECURRING_FEE() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[27].getValue(0));
    }

    /**
     * Sets the value of the 'PA_RECURRING_FEE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PA_RECURRING_FEE(Double value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public String get_MAILING_ADDR_TP() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[28].getValue(0)));
    }

    /**
     * Sets the value of the 'MAILING_ADDR_TP' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_MAILING_ADDR_TP(String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'CHARGEAMOUNT' field in the FML buffer.
     *
     * @return Value of 'CHARGEAMOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Double get_CHARGEAMOUNT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[52].getValue(0));
    }

    /**
     * Sets the value of the 'CHARGEAMOUNT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_CHARGEAMOUNT(Double value) throws FMLManipulationException {
        this.fmlBuffer[52].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'CHARGEWAIVEIND' field in the FML buffer.
     *
     * @return Value of 'CHARGEWAIVEIND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_CHARGEWAIVEIND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[53].getValue(0)));
    }

    /**
     * Sets the value of the 'CHARGEWAIVEIND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_CHARGEWAIVEIND(String value) throws FMLManipulationException {
        this.fmlBuffer[53].setValue(0, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves the value of the 'DELETECHARGEIND' field in the FML buffer.
     *
     * @return Value of 'DELETECHARGEIND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_DELETECHARGEIND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[54].getValue(0)));
    }

    /**
     * Sets the value of the 'DELETECHARGEIND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_DELETECHARGEIND(String value) throws FMLManipulationException {
        this.fmlBuffer[54].setValue(0, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves the value of the 'CHRGENTSEQNO' field in the FML buffer.
     *
     * @return Value of 'CHRGENTSEQNO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_CHRGENTSEQNO() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[55].getValue(0));
    }

    /**
     * Sets the value of the 'CHRGENTSEQNO' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_CHRGENTSEQNO(Integer value) throws FMLManipulationException {
