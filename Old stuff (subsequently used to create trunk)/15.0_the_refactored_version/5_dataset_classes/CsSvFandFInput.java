...
public class CsSvFandFInput extends ServiceInput {
    ...
    public CsSvFandFInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[38] = new FmlField("P1", FmlField.TYPE_STRING, 21, null, 38, 1);
        this.fmlBuffer[39] = new FmlField("P2", FmlField.TYPE_STRING, 21, null, 39, 1);
        this.fmlBuffer[40] = new FmlField("P3", FmlField.TYPE_STRING, 21, null, 40, 1);
        this.fmlBuffer[41] = new FmlField("P4", FmlField.TYPE_STRING, 21, null, 41, 1);
        this.fmlBuffer[42] = new FmlField("P5", FmlField.TYPE_STRING, 21, null, 42, 1);
        this.fmlBuffer[43] = new FmlField("P6", FmlField.TYPE_STRING, 21, null, 43, 1);
        this.fmlBuffer[44] = new FmlField("P7", FmlField.TYPE_STRING, 21, null, 44, 1);
        this.fmlBuffer[45] = new FmlField("P8", FmlField.TYPE_STRING, 21, null, 45, 1);
        this.fmlBuffer[46] = new FmlField("P9", FmlField.TYPE_STRING, 21, null, 46, 1);
        this.fmlBuffer[47] = new FmlField("P10", FmlField.TYPE_STRING, 21, null, 47, 1);
