...
public class ArGtCstBanOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[280];
        ...
        this.fmlBuffer[133] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 133, 1);
        this.fmlBuffer[134] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, null, 134, 20);
        this.fmlBuffer[135] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, null, 135, 20);
        this.fmlBuffer[136] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 136, 20);
        this.fmlBuffer[137] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, null, 137, 20);
        this.fmlBuffer[138] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 138, 20);
        this.fmlBuffer[139] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, null, 139, 20);
        this.fmlBuffer[140] = new FmlField("LNKRECBAN", FmlField.TYPE_INTEGER, -1, null, 140, 20);
        this.fmlBuffer[141] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 141, 20);
        this.fmlBuffer[142] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, null, 142, 20);
        this.fmlBuffer[143] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, null, 143, 20);
        this.fmlBuffer[144] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, null, 144, 20);
        this.fmlBuffer[145] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, null, 145, 20);
        this.fmlBuffer[146] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, null, 146, 20);
        this.fmlBuffer[147] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, null, 147, 20);
        this.fmlBuffer[148] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, null, 148, 20);
        this.fmlBuffer[149] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, null, 149, 20);
        this.fmlBuffer[150] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, null, 150, 20);
        this.fmlBuffer[151] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, null, 151, 20);
        this.fmlBuffer[152] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 152, 20);
        this.fmlBuffer[153] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 153, 20);
        this.fmlBuffer[154] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, null, 154, 20);
        this.fmlBuffer[155] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, null, 155, 20);
        this.fmlBuffer[156] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 156, 20);
        this.fmlBuffer[157] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 157, 20);
        this.fmlBuffer[158] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 158, 20);
        this.fmlBuffer[159] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 159, 20);
        this.fmlBuffer[160] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 160, 20);
        this.fmlBuffer[161] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 161, 20);
        this.fmlBuffer[162] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, null, 162, 20);
        this.fmlBuffer[163] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, null, 163, 20);
        this.fmlBuffer[164] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, null, 164, 20);
        this.fmlBuffer[165] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, null, 165, 20);
        this.fmlBuffer[166] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, null, 166, 20);
        this.fmlBuffer[167] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, null, 167, 20);
        this.fmlBuffer[168] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, null, 168, 20);
        this.fmlBuffer[169] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, null, 169, 20);
        this.fmlBuffer[170] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, null, 170, 20);
        this.fmlBuffer[171] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, null, 171, 20);
        this.fmlBuffer[172] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, null, 172, 20);
        this.fmlBuffer[173] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, null, 173, 20);
        this.fmlBuffer[174] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 174, 20);
        this.fmlBuffer[175] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, null, 175, 20);
        this.fmlBuffer[176] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, null, 176, 20);
        this.fmlBuffer[177] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, null, 177, 20);
        this.fmlBuffer[178] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, null, 178, 20);
        this.fmlBuffer[179] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, null, 179, 20);
        this.fmlBuffer[180] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, null, 180, 20);
        this.fmlBuffer[181] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, null, 181, 20);
        this.fmlBuffer[182] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, null, 182, 20);
        this.fmlBuffer[183] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, null, 183, 20);
        this.fmlBuffer[184] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, null, 184, 20);
        this.fmlBuffer[185] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 185, 20);
        this.fmlBuffer[186] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 186, 20);
        this.fmlBuffer[187] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 187, 20);
        this.fmlBuffer[188] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 188, 20);
        this.fmlBuffer[189] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 189, 20);
        this.fmlBuffer[190] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 190, 20);
        this.fmlBuffer[191] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, null, 191, 20);
        this.fmlBuffer[192] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, null, 192, 20);
        this.fmlBuffer[193] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, null, 193, 20);
        this.fmlBuffer[194] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, null, 194, 20);
        this.fmlBuffer[195] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, null, 195, 20);
        this.fmlBuffer[196] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, null, 196, 20);
        this.fmlBuffer[197] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, null, 197, 20);
        this.fmlBuffer[198] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, null, 198, 20);
        this.fmlBuffer[199] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, null, 199, 20);
        this.fmlBuffer[200] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, null, 200, 20);
        this.fmlBuffer[201] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, null, 201, 20);
        this.fmlBuffer[202] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, null, 202, 20);
        this.fmlBuffer[203] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, null, 203, 20);
        this.fmlBuffer[204] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, null, 204, 20);
        this.fmlBuffer[205] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, null, 205, 20);
        this.fmlBuffer[206] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, null, 206, 20);
        this.fmlBuffer[207] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, null, 207, 20);
        this.fmlBuffer[208] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, null, 208, 20);
        this.fmlBuffer[209] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, null, 209, 20);
        this.fmlBuffer[210] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, null, 210, 20);
        this.fmlBuffer[211] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, null, 211, 20);
        this.fmlBuffer[212] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, null, 212, 20);
        this.fmlBuffer[213] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, null, 213, 20);
        this.fmlBuffer[214] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, null, 214, 20);
        this.fmlBuffer[215] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, null, 215, 20);
        this.fmlBuffer[216] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, null, 216, 20);
        this.fmlBuffer[217] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, null, 217, 20);
        this.fmlBuffer[218] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, null, 218, 20);
        this.fmlBuffer[219] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, null, 219, 20);
        this.fmlBuffer[220] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, null, 220, 20);
        this.fmlBuffer[221] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, null, 221, 20);
        this.fmlBuffer[222] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, null, 222, 20);
        this.fmlBuffer[223] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, null, 223, 20);
        this.fmlBuffer[224] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, null, 224, 20);
        this.fmlBuffer[225] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, null, 225, 20);
        this.fmlBuffer[226] = new FmlField("MEMO_1VROWID", FmlField.TYPE_STRING, 19, null, 226, 4);
        this.fmlBuffer[227] = new FmlField("MEMO_BAN", FmlField.TYPE_INTEGER, -1, null, 227, 4);
        this.fmlBuffer[228] = new FmlField("MEMO_ID", FmlField.TYPE_INTEGER, -1, null, 228, 4);
        this.fmlBuffer[229] = new FmlField("MEMO_1VSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 229, 4);
        this.fmlBuffer[230] = new FmlField("MEMO_DATE", FmlField.TYPE_STRING, 15, null, 230, 4);
        this.fmlBuffer[231] = new FmlField("MEMO_TYPE", FmlField.TYPE_STRING, 5, null, 231, 4);
        this.fmlBuffer[232] = new FmlField("MEMO_SUBSCRIBER", FmlField.TYPE_STRING, 21, null, 232, 4);
        this.fmlBuffer[233] = new FmlField("MEMO_SYSTEM_TXT", FmlField.TYPE_STRING, 181, null, 233, 4);
        this.fmlBuffer[234] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, null, 234, 4);
        this.fmlBuffer[235] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, null, 235, 4);
        this.fmlBuffer[236] = new FmlField("MEMO_MANUAL_TXT_TRUNC", FmlField.TYPE_STRING, 241, null, 236, 4);
        this.fmlBuffer[237] = new FmlField("MEMO_SYS_DATE", FmlField.TYPE_STRING, 15, null, 237, 4);
        this.fmlBuffer[238] = new FmlField("USER_ID", FmlField.TYPE_INTEGER, -1, null, 238, 4);
        this.fmlBuffer[239] = new FmlField("USER_SHORT_NAME", FmlField.TYPE_STRING, 21, null, 239, 4);
        this.fmlBuffer[240] = new FmlField("XX_ROWID", FmlField.TYPE_STRING, 19, null, 240, 4);
        this.fmlBuffer[241] = new FmlField("MEMTP_MEMO_CATEGORY", FmlField.TYPE_STRING, 5, null, 241, 4);
        this.fmlBuffer[242] = new FmlField("MEMTP_MEMO_DESCRIPTION", FmlField.TYPE_STRING, 21, null, 242, 4);
        this.fmlBuffer[243] = new FmlField("USER_TEXT_LEN", FmlField.TYPE_INTEGER, -1, null, 243, 4);
        this.fmlBuffer[244] = new FmlField("MEMO_COUNT", FmlField.TYPE_INTEGER, -1, null, 244, 1);
        this.fmlBuffer[245] = new FmlField("PPBLGTCYCRECROWID", FmlField.TYPE_STRING, 19, null, 245, 1);
        this.fmlBuffer[246] = new FmlField("CYCLE_CODE", FmlField.TYPE_SHORT, -1, null, 246, 1);
        this.fmlBuffer[247] = new FmlField("PPBLGTCYCRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, null, 247, 1);
        this.fmlBuffer[248] = new FmlField("PPBLGTCYCRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, null, 248, 1);
        this.fmlBuffer[249] = new FmlField("PPBLGTCYCRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, null, 249, 1);
        this.fmlBuffer[250] = new FmlField("PPBLGTCYCRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, null, 250, 1);
        this.fmlBuffer[251] = new FmlField("PPBLGTCYCRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, null, 251, 1);
        this.fmlBuffer[252] = new FmlField("PPBLGTCYCRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, null, 252, 1);
        this.fmlBuffer[253] = new FmlField("PPBLGTCYCRECCYCLE_FREQUENCY", FmlField.TYPE_SHORT, -1, null, 253, 1);
        this.fmlBuffer[254] = new FmlField("CYCLE_DESC", FmlField.TYPE_STRING, 31, null, 254, 1);
        this.fmlBuffer[255] = new FmlField("CYCLE_FIRST_MONTH", FmlField.TYPE_SHORT, -1, null, 255, 1);
        this.fmlBuffer[256] = new FmlField("CYCLE_CLOSE_DAY", FmlField.TYPE_SHORT, -1, null, 256, 1);
        this.fmlBuffer[257] = new FmlField("CYCLE_POPULATION_CD", FmlField.TYPE_BYTE, -1, null, 257, 1);
        this.fmlBuffer[258] = new FmlField("CYCLE_BILL_DAY", FmlField.TYPE_SHORT, -1, null, 258, 1);
        this.fmlBuffer[259] = new FmlField("CYCLE_DUE_DAY", FmlField.TYPE_SHORT, -1, null, 259, 1);
        this.fmlBuffer[260] = new FmlField("ALLOCATION_IND", FmlField.TYPE_BYTE, -1, null, 260, 1);
        this.fmlBuffer[261] = new FmlField("PBS_INFO_LINK_IND", FmlField.TYPE_BYTE, -1, null, 261, 1);
        this.fmlBuffer[262] = new FmlField("PCNTRTINFROWID", FmlField.TYPE_STRING, 19, null, 262, 1);
        this.fmlBuffer[263] = new FmlField("PCNTRTINFSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 263, 1);
        this.fmlBuffer[264] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 264, 1);
        this.fmlBuffer[265] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 265, 1);
        this.fmlBuffer[266] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 266, 1);
        this.fmlBuffer[267] = new FmlField("PW_DESCRIPTION", FmlField.TYPE_STRING, 21, null, 267, 1);
        this.fmlBuffer[268] = new FmlField("MOREROWS", FmlField.TYPE_SHORT, -1, null, 268, 1);
        this.fmlBuffer[269] = new FmlField("CTNSTSCOUNTROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 269, 1);
        this.fmlBuffer[270] = new FmlField("PRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 270, 10);
        this.fmlBuffer[271] = new FmlField("CTN_RESERVED", FmlField.TYPE_INTEGER, -1, null, 271, 10);
        this.fmlBuffer[272] = new FmlField("CTN_OPEN", FmlField.TYPE_INTEGER, -1, null, 272, 10);
        this.fmlBuffer[273] = new FmlField("CTN_SUSPENDED", FmlField.TYPE_INTEGER, -1, null, 273, 10);
        this.fmlBuffer[274] = new FmlField("CTN_CANCELLED", FmlField.TYPE_INTEGER, -1, null, 274, 10);
        this.fmlBuffer[275] = new FmlField("FUTURE_REQ_COUNT", FmlField.TYPE_INTEGER, -1, null, 275, 1);
        this.fmlBuffer[276] = new FmlField("FU_COUNT", FmlField.TYPE_INTEGER, -1, null, 276, 1);
        this.fmlBuffer[277] = new FmlField("LINKED_IND", FmlField.TYPE_BYTE, -1, null, 277, 1);
        this.fmlBuffer[278] = new FmlField("BP_LANGUAGE", FmlField.TYPE_STRING, 3, null, 278, 1);
        this.fmlBuffer[279] = new FmlField("FNF_FAMILIES_COUNT", FmlField.TYPE_INTEGER, -1, null, 279, 1);
    }
    ...
    public Integer get_LINK_SEQ_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[138].getValue(nIndex));
    }
    /**
    ...
    public Integer get_NAMERECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[161].getValue(nIndex)));
    }
    /**
    ...
    public Integer get_NAMERECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[174].getValue(nIndex)));
    }
    /**
    ...
    public String get_ROLE_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[179].getValue(nIndex)));
    }
    /**
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[190].getValue(nIndex)));
    }
    /**
    ...
    public String get_ADR_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[191].getValue(nIndex)));
    }
    /**
    ...
    public String get_CO_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[209].getValue(nIndex)));
    }
    /**
    ...
    public Integer get_ADDRESSRECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[210].getValue(nIndex)));
    }
    /**
    ...
    public Integer get_MEMO_BAN(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[227].getValue(nIndex));
    }
    /**
    ...
    public String get_MEMO_SOURCE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[234].getValue(nIndex)));
    }
    /**
    ...
    public Double get_MEMO_AMT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[235].getValue(nIndex));
    }
    /**
    ...
    public Integer get_USER_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[238].getValue(nIndex));
    }
    /**
    ...
    public Integer get_USER_TEXT_LEN(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[243].getValue(nIndex));
    }
    /**
    ...
    public Integer get_PPBLGTCYCRECOPERATOR_ID() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[249].getValue(0));
    }
    ...
    public Integer get_FUTURE_REQ_COUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[275].getValue(0));
    }
