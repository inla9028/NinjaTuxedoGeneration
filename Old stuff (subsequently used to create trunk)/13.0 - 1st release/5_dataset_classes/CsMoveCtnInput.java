 ...
 * @author  Ninja
 *
 * CsMoveCtnInput class.
 */
public class CsMoveCtnInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsMoveCtnInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsMoveCtnInput() throws EnvironmentException, FMLManipulationException {
        // Initialize FML buffer
        fmlBuffer = new FmlField[394];

        // Get default values from DB
        synchronized (this.defaultValuesPopulated) {
            if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
                defaultValues = getDefaultValues("csMoveCtn", 394);
        ...
        this.fmlBuffer[151] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, defaultValues[151], 151, 1);
        this.fmlBuffer[152] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, defaultValues[152], 152, 1);
        this.fmlBuffer[153] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[153], 153, 1);
        this.fmlBuffer[154] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, defaultValues[154], 154, 1);
        this.fmlBuffer[155] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, defaultValues[155], 155, 1);
        this.fmlBuffer[156] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, defaultValues[156], 156, 1);
        this.fmlBuffer[157] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, defaultValues[157], 157, 1);
        this.fmlBuffer[158] = new FmlField("P1", FmlField.TYPE_STRING, 21, defaultValues[158], 158, 1);
        this.fmlBuffer[159] = new FmlField("P2", FmlField.TYPE_STRING, 21, defaultValues[159], 159, 1);
        this.fmlBuffer[160] = new FmlField("P3", FmlField.TYPE_STRING, 21, defaultValues[160], 160, 1);
        this.fmlBuffer[161] = new FmlField("P4", FmlField.TYPE_STRING, 21, defaultValues[161], 161, 1);
        this.fmlBuffer[162] = new FmlField("P5", FmlField.TYPE_STRING, 21, defaultValues[162], 162, 1);
        this.fmlBuffer[163] = new FmlField("P6", FmlField.TYPE_STRING, 21, defaultValues[163], 163, 1);
        this.fmlBuffer[164] = new FmlField("P7", FmlField.TYPE_STRING, 21, defaultValues[164], 164, 1);
        this.fmlBuffer[165] = new FmlField("P8", FmlField.TYPE_STRING, 21, defaultValues[165], 165, 1);
        this.fmlBuffer[166] = new FmlField("P9", FmlField.TYPE_STRING, 21, defaultValues[166], 166, 1);
        this.fmlBuffer[167] = new FmlField("P10", FmlField.TYPE_STRING, 21, defaultValues[167], 167, 1);
        this.fmlBuffer[168] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[168], 168, 1);
        this.fmlBuffer[169] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, defaultValues[169], 169, 1);
        this.fmlBuffer[170] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[170], 170, 1);
        this.fmlBuffer[171] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, defaultValues[171], 171, 1);
        this.fmlBuffer[172] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, defaultValues[172], 172, 1);
        this.fmlBuffer[173] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, defaultValues[173], 173, 1);
        this.fmlBuffer[174] = new FmlField("PMKTPROGBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[174], 174, 1);
        this.fmlBuffer[175] = new FmlField("MP_MODE", FmlField.TYPE_BYTE, -1, defaultValues[175], 175, 5);
        this.fmlBuffer[176] = new FmlField("SUB_MKTPR_ENT_NO", FmlField.TYPE_INTEGER, -1, defaultValues[176], 176, 5);
        this.fmlBuffer[177] = new FmlField("SUB_MKTPR_CODE", FmlField.TYPE_STRING, 7, defaultValues[177], 177, 5);
        this.fmlBuffer[178] = new FmlField("SUB_MKTPR_EFF_DATE", FmlField.TYPE_STRING, 9, defaultValues[178], 178, 5);
        this.fmlBuffer[179] = new FmlField("PTARCTNROWID", FmlField.TYPE_STRING, 19, defaultValues[179], 179, 1);
        this.fmlBuffer[180] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, defaultValues[180], 180, 1);
        this.fmlBuffer[181] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, defaultValues[181], 181, 1);
        this.fmlBuffer[182] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[182], 182, 1);
        this.fmlBuffer[183] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[183], 183, 1);
        this.fmlBuffer[184] = new FmlField("PTARCTNOPERATOR_ID", FmlField.TYPE_INTEGER, -1, defaultValues[184], 184, 1);
        this.fmlBuffer[185] = new FmlField("PTARCTNAPPLICATION_ID", FmlField.TYPE_STRING, 7, defaultValues[185], 185, 1);
        this.fmlBuffer[186] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, defaultValues[186], 186, 1);
        this.fmlBuffer[187] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[187], 187, 1);
        this.fmlBuffer[188] = new FmlField("PTARCTNEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, defaultValues[188], 188, 1);
        this.fmlBuffer[189] = new FmlField("INIT_ACTIVATION_DATE", FmlField.TYPE_STRING, 9, defaultValues[189], 189, 1);
        this.fmlBuffer[190] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[190], 190, 1);
        this.fmlBuffer[191] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, defaultValues[191], 191, 1);
        this.fmlBuffer[192] = new FmlField("ORIGINAL_INIT_DATE", FmlField.TYPE_STRING, 15, defaultValues[192], 192, 1);
        this.fmlBuffer[193] = new FmlField("SUB_STATUS_LAST_ACT", FmlField.TYPE_STRING, 4, defaultValues[193], 193, 1);
        this.fmlBuffer[194] = new FmlField("SUB_STATUS_RSN_CODE", FmlField.TYPE_STRING, 5, defaultValues[194], 194, 1);
        this.fmlBuffer[195] = new FmlField("PTARCTNPRODUCT_TYPE", FmlField.TYPE_STRING, 4, defaultValues[195], 195, 1);
        this.fmlBuffer[196] = new FmlField("CUSTOMER_BAN", FmlField.TYPE_INTEGER, -1, defaultValues[196], 196, 1);
        this.fmlBuffer[197] = new FmlField("CTN_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[197], 197, 1);
        this.fmlBuffer[198] = new FmlField("REQ_ST_GRACE_PERIOD", FmlField.TYPE_STRING, 9, defaultValues[198], 198, 1);
        this.fmlBuffer[199] = new FmlField("REQ_END_GRACE_PERIOD", FmlField.TYPE_STRING, 9, defaultValues[199], 199, 1);
        this.fmlBuffer[200] = new FmlField("COMMIT_START_DATE", FmlField.TYPE_STRING, 9, defaultValues[200], 200, 1);
        this.fmlBuffer[201] = new FmlField("COMMIT_END_DATE", FmlField.TYPE_STRING, 9, defaultValues[201], 201, 1);
        this.fmlBuffer[202] = new FmlField("COMMIT_REASON_CODE", FmlField.TYPE_STRING, 4, defaultValues[202], 202, 1);
        this.fmlBuffer[203] = new FmlField("PTARCTNCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, defaultValues[203], 203, 1);
        this.fmlBuffer[204] = new FmlField("PTARCTNSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[204], 204, 1);
        this.fmlBuffer[205] = new FmlField("CONTRACT_NO", FmlField.TYPE_STRING, 11, defaultValues[205], 205, 1);
        this.fmlBuffer[206] = new FmlField("CNT_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[206], 206, 1);
        this.fmlBuffer[207] = new FmlField("PTARCTNDEALER_CODE", FmlField.TYPE_STRING, 6, defaultValues[207], 207, 1);
        this.fmlBuffer[208] = new FmlField("ORG_DEALER_CODE", FmlField.TYPE_STRING, 6, defaultValues[208], 208, 1);
        this.fmlBuffer[209] = new FmlField("PTARCTNSALES_AGENT", FmlField.TYPE_STRING, 6, defaultValues[209], 209, 1);
        this.fmlBuffer[210] = new FmlField("ORG_SALES_AGENT", FmlField.TYPE_STRING, 6, defaultValues[210], 210, 1);
        this.fmlBuffer[211] = new FmlField("REQ_DEPOSIT_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[211], 211, 1);
        this.fmlBuffer[212] = new FmlField("LEADING_NUMBER", FmlField.TYPE_STRING, 21, defaultValues[212], 212, 1);
        this.fmlBuffer[213] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, defaultValues[213], 213, 1);
        this.fmlBuffer[214] = new FmlField("NEXT_CTN", FmlField.TYPE_STRING, 21, defaultValues[214], 214, 1);
        this.fmlBuffer[215] = new FmlField("NEXT_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, defaultValues[215], 215, 1);
        this.fmlBuffer[216] = new FmlField("PRV_CTN", FmlField.TYPE_STRING, 21, defaultValues[216], 216, 1);
        this.fmlBuffer[217] = new FmlField("PRV_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, defaultValues[217], 217, 1);
        this.fmlBuffer[218] = new FmlField("NEXT_BAN", FmlField.TYPE_INTEGER, -1, defaultValues[218], 218, 1);
        this.fmlBuffer[219] = new FmlField("NEXT_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[219], 219, 1);
        this.fmlBuffer[220] = new FmlField("PRV_BAN", FmlField.TYPE_INTEGER, -1, defaultValues[220], 220, 1);
        this.fmlBuffer[221] = new FmlField("PRV_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[221], 221, 1);
        this.fmlBuffer[222] = new FmlField("SUB_STS_ISSUE_DATE", FmlField.TYPE_STRING, 9, defaultValues[222], 222, 1);
        this.fmlBuffer[223] = new FmlField("ACTIVATE_WAIVE_RSN", FmlField.TYPE_STRING, 7, defaultValues[223], 223, 1);
        this.fmlBuffer[224] = new FmlField("EARLIEST_ACTV_DATE", FmlField.TYPE_STRING, 9, defaultValues[224], 224, 1);
        this.fmlBuffer[225] = new FmlField("SUB_ACTV_LOCATION", FmlField.TYPE_STRING, 5, defaultValues[225], 225, 1);
        this.fmlBuffer[226] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, defaultValues[226], 226, 1);
        this.fmlBuffer[227] = new FmlField("CUST_WATCH_DATE", FmlField.TYPE_STRING, 9, defaultValues[227], 227, 1);
        this.fmlBuffer[228] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, defaultValues[228], 228, 1);
        this.fmlBuffer[229] = new FmlField("CREDIT_WATCH_PIN_CD", FmlField.TYPE_SHORT, -1, defaultValues[229], 229, 1);
        this.fmlBuffer[230] = new FmlField("SUB_MARKET_CODE", FmlField.TYPE_STRING, 4, defaultValues[230], 230, 1);
        this.fmlBuffer[231] = new FmlField("LIMIT_RESERVED_DAYS", FmlField.TYPE_SHORT, -1, defaultValues[231], 231, 1);
        this.fmlBuffer[232] = new FmlField("FF_EXPIRATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[232], 232, 1);
        this.fmlBuffer[233] = new FmlField("FLEX_IND", FmlField.TYPE_BYTE, -1, defaultValues[233], 233, 1);
        this.fmlBuffer[234] = new FmlField("DUO_IND", FmlField.TYPE_BYTE, -1, defaultValues[234], 234, 1);
        this.fmlBuffer[235] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, defaultValues[235], 235, 1);
        this.fmlBuffer[236] = new FmlField("SUB_DEPARTMENT_CD", FmlField.TYPE_STRING, 5, defaultValues[236], 236, 1);
        this.fmlBuffer[237] = new FmlField("LAST_SUBS_DISC_DT", FmlField.TYPE_STRING, 9, defaultValues[237], 237, 1);
        this.fmlBuffer[238] = new FmlField("LAST_SUBS_DISC_DT_UD", FmlField.TYPE_STRING, 9, defaultValues[238], 238, 1);
        this.fmlBuffer[239] = new FmlField("LAST_SUBSCR_DISC_SN", FmlField.TYPE_SHORT, -1, defaultValues[239], 239, 1);
        this.fmlBuffer[240] = new FmlField("LAST_SUBSCR_DISC_SN_UD", FmlField.TYPE_SHORT, -1, defaultValues[240], 240, 1);
        this.fmlBuffer[241] = new FmlField("PNI", FmlField.TYPE_STRING, 11, defaultValues[241], 241, 1);
        this.fmlBuffer[242] = new FmlField("RMS_REF_STORE_ID", FmlField.TYPE_STRING, 5, defaultValues[242], 242, 1);
        this.fmlBuffer[243] = new FmlField("RMS_REF_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[243], 243, 1);
        this.fmlBuffer[244] = new FmlField("RMS_REF_OD", FmlField.TYPE_INTEGER, -1, defaultValues[244], 244, 1);
        this.fmlBuffer[245] = new FmlField("DLR_ACT_FEE", FmlField.TYPE_DOUBLE, -1, defaultValues[245], 245, 1);
        this.fmlBuffer[246] = new FmlField("PREP_AMOUNT", FmlField.TYPE_DOUBLE, -1, defaultValues[246], 246, 1);
        this.fmlBuffer[247] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, defaultValues[247], 247, 1);
        this.fmlBuffer[248] = new FmlField("SUB_LANG", FmlField.TYPE_STRING, 3, defaultValues[248], 248, 1);
        this.fmlBuffer[249] = new FmlField("SMS_RCV_STYLE_CODE", FmlField.TYPE_STRING, 3, defaultValues[249], 249, 1);
        this.fmlBuffer[250] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, defaultValues[250], 250, 1);
        this.fmlBuffer[251] = new FmlField("ALLOW_ADVERTISING_IND", FmlField.TYPE_BYTE, -1, defaultValues[251], 251, 1);
        this.fmlBuffer[252] = new FmlField("IVR_WRONG_ACCESS_NO", FmlField.TYPE_SHORT, -1, defaultValues[252], 252, 1);
        this.fmlBuffer[253] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[253], 253, 1);
        this.fmlBuffer[254] = new FmlField("PUBLISH_LEVEL", FmlField.TYPE_STRING, 31, defaultValues[254], 254, 1);
        this.fmlBuffer[255] = new FmlField("AUTO_RELEASE_IND", FmlField.TYPE_BYTE, -1, defaultValues[255], 255, 1);
        this.fmlBuffer[256] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, defaultValues[256], 256, 1);
        this.fmlBuffer[257] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, defaultValues[257], 257, 1);
        this.fmlBuffer[258] = new FmlField("OPERATOR_CW_LMT", FmlField.TYPE_DOUBLE, -1, defaultValues[258], 258, 1);
        this.fmlBuffer[259] = new FmlField("SEND_SMS_FOR_MATCH", FmlField.TYPE_BYTE, -1, defaultValues[259], 259, 1);
        this.fmlBuffer[260] = new FmlField("CPS_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[260], 260, 1);
        this.fmlBuffer[261] = new FmlField("CPS_TRANSACTION", FmlField.TYPE_SHORT, -1, defaultValues[261], 261, 1);
        this.fmlBuffer[262] = new FmlField("CPS_TYPE", FmlField.TYPE_SHORT, -1, defaultValues[262], 262, 1);
        this.fmlBuffer[263] = new FmlField("ISP_PASS", FmlField.TYPE_STRING, 31, defaultValues[263], 263, 1);
        this.fmlBuffer[264] = new FmlField("ISP_TYPE", FmlField.TYPE_STRING, 3, defaultValues[264], 264, 1);
        this.fmlBuffer[265] = new FmlField("OPERATOR_TMP_DATE", FmlField.TYPE_STRING, 9, defaultValues[265], 265, 1);
        this.fmlBuffer[266] = new FmlField("OPERATOR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, defaultValues[266], 266, 1);
        this.fmlBuffer[267] = new FmlField("SUB_ORG_CD", FmlField.TYPE_STRING, 11, defaultValues[267], 267, 1);
        this.fmlBuffer[268] = new FmlField("ORG_MEMBER_NO", FmlField.TYPE_STRING, 21, defaultValues[268], 268, 1);
        this.fmlBuffer[269] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[269], 269, 1);
        this.fmlBuffer[270] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, defaultValues[270], 270, 20);
        this.fmlBuffer[271] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, defaultValues[271], 271, 20);
        this.fmlBuffer[272] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, defaultValues[272], 272, 20);
        this.fmlBuffer[273] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, defaultValues[273], 273, 20);
        this.fmlBuffer[274] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[274], 274, 20);
        this.fmlBuffer[275] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, defaultValues[275], 275, 20);
        this.fmlBuffer[276] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, defaultValues[276], 276, 20);
        this.fmlBuffer[277] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, defaultValues[277], 277, 20);
        this.fmlBuffer[278] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[278], 278, 20);
        this.fmlBuffer[279] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[279], 279, 20);
        this.fmlBuffer[280] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[280], 280, 20);
        this.fmlBuffer[281] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, defaultValues[281], 281, 20);
        this.fmlBuffer[282] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, defaultValues[282], 282, 20);
        this.fmlBuffer[283] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, defaultValues[283], 283, 20);
        this.fmlBuffer[284] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, defaultValues[284], 284, 20);
        this.fmlBuffer[285] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, defaultValues[285], 285, 20);
        this.fmlBuffer[286] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, defaultValues[286], 286, 20);
        this.fmlBuffer[287] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, defaultValues[287], 287, 20);
        this.fmlBuffer[288] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[288], 288, 20);
        this.fmlBuffer[289] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, defaultValues[289], 289, 20);
        this.fmlBuffer[290] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, defaultValues[290], 290, 20);
        this.fmlBuffer[291] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, defaultValues[291], 291, 20);
        this.fmlBuffer[292] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[292], 292, 20);
        this.fmlBuffer[293] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[293], 293, 20);
        this.fmlBuffer[294] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, defaultValues[294], 294, 20);
        this.fmlBuffer[295] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, defaultValues[295], 295, 20);
        this.fmlBuffer[296] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, defaultValues[296], 296, 20);
        this.fmlBuffer[297] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[297], 297, 20);
        this.fmlBuffer[298] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, defaultValues[298], 298, 20);
        this.fmlBuffer[299] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, defaultValues[299], 299, 20);
        this.fmlBuffer[300] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, defaultValues[300], 300, 20);
        this.fmlBuffer[301] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, defaultValues[301], 301, 20);
        this.fmlBuffer[302] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, defaultValues[302], 302, 20);
        this.fmlBuffer[303] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, defaultValues[303], 303, 20);
        this.fmlBuffer[304] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, defaultValues[304], 304, 20);
        this.fmlBuffer[305] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, defaultValues[305], 305, 20);
        this.fmlBuffer[306] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, defaultValues[306], 306, 20);
        this.fmlBuffer[307] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, defaultValues[307], 307, 20);
        this.fmlBuffer[308] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, defaultValues[308], 308, 20);
        this.fmlBuffer[309] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, defaultValues[309], 309, 20);
        this.fmlBuffer[310] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, defaultValues[310], 310, 20);
        this.fmlBuffer[311] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, defaultValues[311], 311, 20);
        this.fmlBuffer[312] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, defaultValues[312], 312, 20);
        this.fmlBuffer[313] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, defaultValues[313], 313, 20);
        this.fmlBuffer[314] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, defaultValues[314], 314, 20);
        this.fmlBuffer[315] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, defaultValues[315], 315, 20);
        this.fmlBuffer[316] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, defaultValues[316], 316, 20);
        this.fmlBuffer[317] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[317], 317, 20);
        this.fmlBuffer[318] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, defaultValues[318], 318, 20);
        this.fmlBuffer[319] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, defaultValues[319], 319, 20);
        this.fmlBuffer[320] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, defaultValues[320], 320, 20);
        this.fmlBuffer[321] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[321], 321, 20);
        this.fmlBuffer[322] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[322], 322, 20);
        this.fmlBuffer[323] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, defaultValues[323], 323, 20);
        this.fmlBuffer[324] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, defaultValues[324], 324, 20);
        this.fmlBuffer[325] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, defaultValues[325], 325, 20);
        this.fmlBuffer[326] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[326], 326, 20);
        this.fmlBuffer[327] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[327], 327, 20);
        this.fmlBuffer[328] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[328], 328, 20);
        this.fmlBuffer[329] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, defaultValues[329], 329, 20);
        this.fmlBuffer[330] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, defaultValues[330], 330, 20);
        this.fmlBuffer[331] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, defaultValues[331], 331, 20);
        this.fmlBuffer[332] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, defaultValues[332], 332, 20);
        this.fmlBuffer[333] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, defaultValues[333], 333, 20);
        this.fmlBuffer[334] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, defaultValues[334], 334, 20);
        this.fmlBuffer[335] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, defaultValues[335], 335, 20);
        this.fmlBuffer[336] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, defaultValues[336], 336, 20);
        this.fmlBuffer[337] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, defaultValues[337], 337, 20);
        this.fmlBuffer[338] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, defaultValues[338], 338, 20);
        this.fmlBuffer[339] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, defaultValues[339], 339, 20);
        this.fmlBuffer[340] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, defaultValues[340], 340, 20);
        this.fmlBuffer[341] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, defaultValues[341], 341, 20);
        this.fmlBuffer[342] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, defaultValues[342], 342, 20);
        this.fmlBuffer[343] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, defaultValues[343], 343, 20);
        this.fmlBuffer[344] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, defaultValues[344], 344, 20);
        this.fmlBuffer[345] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, defaultValues[345], 345, 20);
        this.fmlBuffer[346] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, defaultValues[346], 346, 20);
        this.fmlBuffer[347] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, defaultValues[347], 347, 20);
        this.fmlBuffer[348] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, defaultValues[348], 348, 20);
        this.fmlBuffer[349] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, defaultValues[349], 349, 20);
        this.fmlBuffer[350] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, defaultValues[350], 350, 20);
        this.fmlBuffer[351] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, defaultValues[351], 351, 20);
        this.fmlBuffer[352] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, defaultValues[352], 352, 20);
        this.fmlBuffer[353] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, defaultValues[353], 353, 20);
        this.fmlBuffer[354] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, defaultValues[354], 354, 20);
        this.fmlBuffer[355] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, defaultValues[355], 355, 20);
        this.fmlBuffer[356] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, defaultValues[356], 356, 20);
        this.fmlBuffer[357] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, defaultValues[357], 357, 20);
        this.fmlBuffer[358] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, defaultValues[358], 358, 20);
        this.fmlBuffer[359] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, defaultValues[359], 359, 20);
        this.fmlBuffer[360] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, defaultValues[360], 360, 20);
        this.fmlBuffer[361] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, defaultValues[361], 361, 20);
        this.fmlBuffer[362] = new FmlField("SOURCE_BAN_LAST_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[362], 362, 1);
        this.fmlBuffer[363] = new FmlField("SOURCE_BAN_LAST_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[363], 363, 1);
        this.fmlBuffer[364] = new FmlField("PCNCLSRCEBANRECBAN", FmlField.TYPE_INTEGER, -1, defaultValues[364], 364, 1);
        this.fmlBuffer[365] = new FmlField("PCNCLSRCEBANRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, defaultValues[365], 365, 1);
        this.fmlBuffer[366] = new FmlField("PCNCLSRCEBANRECACTIVITY_DATE", FmlField.TYPE_STRING, 9, defaultValues[366], 366, 1);
        this.fmlBuffer[367] = new FmlField("RESTORE_DATE", FmlField.TYPE_STRING, 9, defaultValues[367], 367, 1);
        this.fmlBuffer[368] = new FmlField("DEP_RETURN_METHOD", FmlField.TYPE_BYTE, -1, defaultValues[368], 368, 1);
        this.fmlBuffer[369] = new FmlField("NEW_BAN_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[369], 369, 1);
        this.fmlBuffer[370] = new FmlField("EXP_CYCLE_CODE", FmlField.TYPE_SHORT, -1, defaultValues[370], 370, 1);
        this.fmlBuffer[371] = new FmlField("BAN_WAIVE_IND", FmlField.TYPE_BYTE, -1, defaultValues[371], 371, 1);
        this.fmlBuffer[372] = new FmlField("BAN_WAIVE_RSN", FmlField.TYPE_STRING, 7, defaultValues[372], 372, 1);
        this.fmlBuffer[373] = new FmlField("WAIVER_UID", FmlField.TYPE_STRING, 9, defaultValues[373], 373, 1);
        this.fmlBuffer[374] = new FmlField("HOLD_COLL_TREATMENT", FmlField.TYPE_BYTE, -1, defaultValues[374], 374, 1);
        this.fmlBuffer[375] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, defaultValues[375], 375, 1);
        this.fmlBuffer[376] = new FmlField("CTN", FmlField.TYPE_STRING, 21, defaultValues[376], 376, 100);
        this.fmlBuffer[377] = new FmlField("PCTNCNCLBUFSUB_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[377], 377, 100);
        this.fmlBuffer[378] = new FmlField("COMM_START_DATE", FmlField.TYPE_STRING, 9, defaultValues[378], 378, 100);
        this.fmlBuffer[379] = new FmlField("COMM_END_DATE", FmlField.TYPE_STRING, 9, defaultValues[379], 379, 100);
        this.fmlBuffer[380] = new FmlField("REMAINING_MONTHS", FmlField.TYPE_SHORT, -1, defaultValues[380], 380, 100);
        this.fmlBuffer[381] = new FmlField("DEPOSIT", FmlField.TYPE_DOUBLE, -1, defaultValues[381], 381, 100);
        this.fmlBuffer[382] = new FmlField("DEPOSIT_INTEREST", FmlField.TYPE_DOUBLE, -1, defaultValues[382], 382, 100);
        this.fmlBuffer[383] = new FmlField("PENALTY", FmlField.TYPE_DOUBLE, -1, defaultValues[383], 383, 100);
        this.fmlBuffer[384] = new FmlField("WAIVE_INDICATOR", FmlField.TYPE_BYTE, -1, defaultValues[384], 384, 100);
        this.fmlBuffer[385] = new FmlField("PCTNCNCLBUFWAIVE_REASON", FmlField.TYPE_STRING, 7, defaultValues[385], 385, 100);
        this.fmlBuffer[386] = new FmlField("ACTIVITY_CTN_FEE", FmlField.TYPE_DOUBLE, -1, defaultValues[386], 386, 1);
        this.fmlBuffer[387] = new FmlField("NUMBER_LOCATION", FmlField.TYPE_STRING, 4, defaultValues[387], 387, 1);
        this.fmlBuffer[388] = new FmlField("DEPOSITTERMSIND", FmlField.TYPE_BYTE, -1, defaultValues[388], 388, 1);
        this.fmlBuffer[389] = new FmlField("WAIVING_IND", FmlField.TYPE_BYTE, -1, defaultValues[389], 389, 1);
        this.fmlBuffer[390] = new FmlField("WAIVING_REASON_CODE", FmlField.TYPE_STRING, 5, defaultValues[390], 390, 1);
        this.fmlBuffer[391] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[391], 391, 1);
        this.fmlBuffer[392] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[392], 392, 2);
        this.fmlBuffer[393] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, defaultValues[393], 393, 2);
    }
    ...
    public String get_MEMO_SOURCE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[156].getValue(0)));
    }
    ...
    public void set_MEMO_SOURCE(String value) throws FMLManipulationException {
        this.fmlBuffer[156].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_MEMO_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[168].getValue(0));
    }
    ...
    public Double get_CHARGE_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[170].getValue(0));
    }
    ...
    public String get_CHARGE_AMT_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[171].getValue(0)));
    }
    ...
    public void set_CHARGE_AMT_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[171].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    /**
     * Retrieves the value of the 'PMKTPROGBUFROWCOUNT' field in the FML buffer.
     *
     * @return Value of 'PMKTPROGBUFROWCOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PMKTPROGBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[174].getValue(0));
    }

    /**
     * Sets the value of the 'PMKTPROGBUFROWCOUNT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PMKTPROGBUFROWCOUNT(Integer value) throws FMLManipulationException {
        this.fmlBuffer[174].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'MP_MODE' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 5).
     * @return Value of 'MP_MODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_MP_MODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[175].getValue(nIndex)));
    }

    /**
     * Sets the value of the 'MP_MODE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 5).
     * @throws FMLManipulationException
     */
    public void set_MP_MODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[175].setValue(nIndex, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves number of values defined for 'MP_MODE' field in the FML buffer.
     *
     * @return Number of values defined for 'MP_MODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_MP_MODE_size() throws FMLManipulationException {
        return (this.fmlBuffer[175].getCount());
    }

    /**
     * Retrieves the value of the 'SUB_MKTPR_ENT_NO' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 5).
     * @return Value of 'SUB_MKTPR_ENT_NO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_SUB_MKTPR_ENT_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[176].getValue(nIndex));
    }

    /**
     * Sets the value of the 'SUB_MKTPR_ENT_NO' field in the FML buffer.
     *
     * @param value Default value: null.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 5).
     * @throws FMLManipulationException
     */
    public void set_SUB_MKTPR_ENT_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[176].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'SUB_MKTPR_ENT_NO' field in the FML buffer.
     *
     * @return Number of values defined for 'SUB_MKTPR_ENT_NO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_SUB_MKTPR_ENT_NO_size() throws FMLManipulationException {
        return (this.fmlBuffer[176].getCount());
    }

    /**
     * Retrieves the value of the 'SUB_MKTPR_CODE' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 5).
     * @return Value of 'SUB_MKTPR_CODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_SUB_MKTPR_CODE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[177].getValue(nIndex));
    }

    /**
     * Sets the value of the 'SUB_MKTPR_CODE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 7.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 5).
     * @throws FMLManipulationException
     */
    public void set_SUB_MKTPR_CODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[177].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'SUB_MKTPR_CODE' field in the FML buffer.
     *
     * @return Number of values defined for 'SUB_MKTPR_CODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_SUB_MKTPR_CODE_size() throws FMLManipulationException {
        return (this.fmlBuffer[177].getCount());
    }

    /**
     * Retrieves the value of the 'SUB_MKTPR_EFF_DATE' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 5).
     * @return Value of 'SUB_MKTPR_EFF_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_SUB_MKTPR_EFF_DATE(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[178].getValue(nIndex));
    }

    /**
     * Sets the value of the 'SUB_MKTPR_EFF_DATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 5).
     * @throws FMLManipulationException
     */
    public void set_SUB_MKTPR_EFF_DATE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[178].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'SUB_MKTPR_EFF_DATE' field in the FML buffer.
     *
     * @return Number of values defined for 'SUB_MKTPR_EFF_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_SUB_MKTPR_EFF_DATE_size() throws FMLManipulationException {
        return (this.fmlBuffer[178].getCount());
    }

    /**
     * Retrieves the value of the 'PTARCTNROWID' field in the FML buffer.
     *
     * @return Value of 'PTARCTNROWID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PTARCTNROWID() throws FMLManipulationException {
        return ((String) this.fmlBuffer[179].getValue(0));
    }

    /**
     * Sets the value of the 'PTARCTNROWID' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 19.
     * @throws FMLManipulationException
     */
    public void set_PTARCTNROWID(String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'PTARCTNOPERATOR_ID' field in the FML buffer.
     *
     * @return Value of 'PTARCTNOPERATOR_ID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PTARCTNOPERATOR_ID() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[184].getValue(0));
    }

    /**
     * Sets the value of the 'PTARCTNOPERATOR_ID' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PTARCTNOPERATOR_ID(Integer value) throws FMLManipulationException {
        this.fmlBuffer[184].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PTARCTNAPPLICATION_ID' field in the FML buffer.
     *
     * @return Value of 'PTARCTNAPPLICATION_ID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PTARCTNAPPLICATION_ID() throws FMLManipulationException {
        return ((String) this.fmlBuffer[185].getValue(0));
    }

    /**
     * Sets the value of the 'PTARCTNAPPLICATION_ID' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 7.
     * @throws FMLManipulationException
     */
    public void set_PTARCTNAPPLICATION_ID(String value) throws FMLManipulationException {
    ...
    public Integer get_DL_UPDATE_STAMP() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[187].getValue(0)));
    }
    ...
    public void set_DL_UPDATE_STAMP(Integer value) throws FMLManipulationException {
        this.fmlBuffer[187].setValue(0, TypeConverter.integerToShort(value));
    }

    /**
     * Retrieves the value of the 'PTARCTNEFFECTIVE_DATE' field in the FML buffer.
     *
     * @return Value of 'PTARCTNEFFECTIVE_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PTARCTNEFFECTIVE_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[188].getValue(0));
    }

    /**
     * Sets the value of the 'PTARCTNEFFECTIVE_DATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 15.
     * @throws FMLManipulationException
     */
    public void set_PTARCTNEFFECTIVE_DATE(String value) throws FMLManipulationException {
    ...
    public String get_SUB_STATUS() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[190].getValue(0)));
    }
    ...
    public void set_SUB_STATUS(String value) throws FMLManipulationException {
        this.fmlBuffer[190].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    /**
     * Retrieves the value of the 'PTARCTNPRODUCT_TYPE' field in the FML buffer.
     *
     * @return Value of 'PTARCTNPRODUCT_TYPE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PTARCTNPRODUCT_TYPE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[195].getValue(0));
    }

    /**
     * Sets the value of the 'PTARCTNPRODUCT_TYPE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_PTARCTNPRODUCT_TYPE(String value) throws FMLManipulationException {
    ...
    public Integer get_CUSTOMER_BAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[196].getValue(0));
    }
    ...
    /**
     * Retrieves the value of the 'PTARCTNCOMMIT_ORIG_NO_MONTH' field in the FML buffer.
     *
     * @return Value of 'PTARCTNCOMMIT_ORIG_NO_MONTH' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PTARCTNCOMMIT_ORIG_NO_MONTH() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[203].getValue(0)));
    }

    /**
     * Sets the value of the 'PTARCTNCOMMIT_ORIG_NO_MONTH' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PTARCTNCOMMIT_ORIG_NO_MONTH(Integer value) throws FMLManipulationException {
        this.fmlBuffer[203].setValue(0, TypeConverter.integerToShort(value));
    }

    /**
     * Retrieves the value of the 'PTARCTNSUSP_RC_RATE_TYPE' field in the FML buffer.
     *
     * @return Value of 'PTARCTNSUSP_RC_RATE_TYPE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PTARCTNSUSP_RC_RATE_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[204].getValue(0)));
    }

    /**
     * Sets the value of the 'PTARCTNSUSP_RC_RATE_TYPE' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PTARCTNSUSP_RC_RATE_TYPE(String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'PTARCTNDEALER_CODE' field in the FML buffer.
     *
     * @return Value of 'PTARCTNDEALER_CODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PTARCTNDEALER_CODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[207].getValue(0));
    }

    /**
     * Sets the value of the 'PTARCTNDEALER_CODE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 6.
     * @throws FMLManipulationException
     */
    public void set_PTARCTNDEALER_CODE(String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'PTARCTNSALES_AGENT' field in the FML buffer.
     *
     * @return Value of 'PTARCTNSALES_AGENT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PTARCTNSALES_AGENT() throws FMLManipulationException {
        return ((String) this.fmlBuffer[209].getValue(0));
    }

    /**
     * Sets the value of the 'PTARCTNSALES_AGENT' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 6.
     * @throws FMLManipulationException
     */
    public void set_PTARCTNSALES_AGENT(String value) throws FMLManipulationException {
    ...
    public Double get_REQ_DEPOSIT_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[211].getValue(0));
    }
    ...
    public String get_PABX_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[213].getValue(0)));
    }
    ...
    public void set_PABX_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[213].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PRV_BAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[220].getValue(0));
    }
    ...
    public Double get_BASIC_WATCH_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[228].getValue(0));
    }
    ...
    public Integer get_CREDIT_WATCH_PIN_CD() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[229].getValue(0)));
    }
    ...
    public void set_CREDIT_WATCH_PIN_CD(Integer value) throws FMLManipulationException {
        this.fmlBuffer[229].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_LIMIT_RESERVED_DAYS() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[231].getValue(0)));
    }
    ...
    public void set_LIMIT_RESERVED_DAYS(Integer value) throws FMLManipulationException {
        this.fmlBuffer[231].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_FLEX_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[233].getValue(0)));
    }
    ...
    public void set_FLEX_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[233].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_LAST_SUBSCR_DISC_SN() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[239].getValue(0)));
    }
    ...
    public void set_LAST_SUBSCR_DISC_SN(Integer value) throws FMLManipulationException {
        this.fmlBuffer[239].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_LAST_SUBSCR_DISC_SN_UD() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[240].getValue(0)));
    }
    ...
    public void set_LAST_SUBSCR_DISC_SN_UD(Integer value) throws FMLManipulationException {
        this.fmlBuffer[240].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_RMS_REF_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[243].getValue(0)));
    }
    ...
    public void set_RMS_REF_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[243].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_RMS_REF_OD() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[244].getValue(0));
    }
    ...
    public Double get_DLR_ACT_FEE() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[245].getValue(0));
    }
    ...
    public Double get_PREP_AMOUNT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[246].getValue(0));
    }
    ...
    public Integer get_CONV_RUN_NO() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[250].getValue(0)));
    }
    ...
    public void set_CONV_RUN_NO(Integer value) throws FMLManipulationException {
        this.fmlBuffer[250].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_IVR_WRONG_ACCESS_NO() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[252].getValue(0)));
    }
    ...
    public void set_IVR_WRONG_ACCESS_NO(Integer value) throws FMLManipulationException {
        this.fmlBuffer[252].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_THRESHOLD_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[253].getValue(0));
    }
    ...
    public String get_CUST_WATCH_EFF_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[256].getValue(0));
    }
    ...
    public void set_CUST_WATCH_EFF_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[256].setValue(0, value);
    }
    ...
    public String get_CUST_WATCH_EXP_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[257].getValue(0));
    }
    ...
    public Double get_OPERATOR_CW_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[258].getValue(0));
    }
    ...
    public String get_CPS_STATUS() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[260].getValue(0)));
    }
    ...
    public void set_CPS_STATUS(String value) throws FMLManipulationException {
        this.fmlBuffer[260].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public void set_OPERATOR_TMP_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[265].setValue(0, value);
    }
    ...
    public Double get_OPERATOR_TMP_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[266].getValue(0));
    }
    ...
    public String get_LINK_MODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[270].getValue(nIndex)));
    }
    ...
    public void set_LINK_MODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[270].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_LINK_BAN(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[271].getValue(nIndex));
    }
    ...
    public Integer get_BAN(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[276].getValue(nIndex));
    }
    ...
    public Integer get_NAMERECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[297].getValue(nIndex)));
    }
    ...
    public void set_NAMERECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[297].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_KOB(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[307].getValue(nIndex));
    }
    ...
    public Integer get_NAMERECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[310].getValue(nIndex)));
    }
    ...
    public void set_NAMERECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[310].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_ADDRESS_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[320].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[326].getValue(nIndex)));
    }
    ...
    public void set_ADDRESSRECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[326].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public String get_CO_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[345].getValue(nIndex)));
    }
    ...
    public void set_CO_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[345].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_ADDRESSRECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[346].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    /**
     * Retrieves the value of the 'SOURCE_BAN_LAST_UPDATE_DATE' field in the FML buffer.
     *
     * @return Value of 'SOURCE_BAN_LAST_UPDATE_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_SOURCE_BAN_LAST_UPDATE_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[362].getValue(0));
    }

    /**
     * Sets the value of the 'SOURCE_BAN_LAST_UPDATE_DATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 15.
     * @throws FMLManipulationException
     */
    public void set_SOURCE_BAN_LAST_UPDATE_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[362].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'SOURCE_BAN_LAST_UPDATE_STAMP' field in the FML buffer.
     *
     * @return Value of 'SOURCE_BAN_LAST_UPDATE_STAMP' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_SOURCE_BAN_LAST_UPDATE_STAMP() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[363].getValue(0)));
    }

    /**
     * Sets the value of the 'SOURCE_BAN_LAST_UPDATE_STAMP' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_SOURCE_BAN_LAST_UPDATE_STAMP(Integer value) throws FMLManipulationException {
        this.fmlBuffer[363].setValue(0, TypeConverter.integerToShort(value));
    }

    /**
     * Retrieves the value of the 'PCNCLSRCEBANRECBAN' field in the FML buffer.
     *
     * @return Value of 'PCNCLSRCEBANRECBAN' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PCNCLSRCEBANRECBAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[364].getValue(0));
    }

    /**
     * Sets the value of the 'PCNCLSRCEBANRECBAN' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PCNCLSRCEBANRECBAN(Integer value) throws FMLManipulationException {
        this.fmlBuffer[364].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PCNCLSRCEBANRECCUSTOMER_ID' field in the FML buffer.
     *
     * @return Value of 'PCNCLSRCEBANRECCUSTOMER_ID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PCNCLSRCEBANRECCUSTOMER_ID() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[365].getValue(0));
    }

    /**
     * Sets the value of the 'PCNCLSRCEBANRECCUSTOMER_ID' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PCNCLSRCEBANRECCUSTOMER_ID(Integer value) throws FMLManipulationException {
        this.fmlBuffer[365].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PCNCLSRCEBANRECACTIVITY_DATE' field in the FML buffer.
     *
     * @return Value of 'PCNCLSRCEBANRECACTIVITY_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PCNCLSRCEBANRECACTIVITY_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[366].getValue(0));
    }

    /**
     * Sets the value of the 'PCNCLSRCEBANRECACTIVITY_DATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @throws FMLManipulationException
     */
    public void set_PCNCLSRCEBANRECACTIVITY_DATE(String value) throws FMLManipulationException {
    ...
    public String get_RESTORE_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[367].getValue(0));
    }
    ...
    public String get_DEP_RETURN_METHOD() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[368].getValue(0)));
    }
    ...
    public void set_DEP_RETURN_METHOD(String value) throws FMLManipulationException {
        this.fmlBuffer[368].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_NEW_BAN_STATUS() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[369].getValue(0)));
    }
    ...
    public void set_NEW_BAN_STATUS(String value) throws FMLManipulationException {
        this.fmlBuffer[369].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_EXP_CYCLE_CODE() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[370].getValue(0)));
    }
    ...
    public void set_EXP_CYCLE_CODE(Integer value) throws FMLManipulationException {
        this.fmlBuffer[370].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_BAN_WAIVE_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[371].getValue(0)));
    }
    ...
    public void set_BAN_WAIVE_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[371].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_ROW_COUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[375].getValue(0));
    }
    ...
    /**
     * Retrieves the value of the 'PCTNCNCLBUFSUB_STATUS' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PCTNCNCLBUFSUB_STATUS' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PCTNCNCLBUFSUB_STATUS(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[377].getValue(nIndex)));
    }

    /**
     * Sets the value of the 'PCTNCNCLBUFSUB_STATUS' field in the FML buffer.
     *
     * @param value Default value: null.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_PCTNCNCLBUFSUB_STATUS(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[377].setValue(nIndex, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves number of values defined for 'PCTNCNCLBUFSUB_STATUS' field in the FML buffer.
     *
     * @return Number of values defined for 'PCTNCNCLBUFSUB_STATUS' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PCTNCNCLBUFSUB_STATUS_size() throws FMLManipulationException {
    ...
    public Double get_DEPOSIT_INTEREST(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[382].getValue(nIndex));
    }
    ...
    public Double get_PENALTY(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[383].getValue(nIndex));
    }
    ...
    /**
     * Retrieves the value of the 'PCTNCNCLBUFWAIVE_REASON' field in the FML buffer.
     *
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @return Value of 'PCTNCNCLBUFWAIVE_REASON' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PCTNCNCLBUFWAIVE_REASON(int nIndex) throws FMLManipulationException {
        return ((String) this.fmlBuffer[385].getValue(nIndex));
    }

    /**
     * Sets the value of the 'PCTNCNCLBUFWAIVE_REASON' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 7.
     * @param nIndex Sequence of value to be returned (valid values: 0 to 100).
     * @throws FMLManipulationException
     */
    public void set_PCTNCNCLBUFWAIVE_REASON(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[385].setValue(nIndex, value);
    }

    /**
     * Retrieves number of values defined for 'PCTNCNCLBUFWAIVE_REASON' field in the FML buffer.
     *
     * @return Number of values defined for 'PCTNCNCLBUFWAIVE_REASON' field in FML buffer.
     * @throws FMLManipulationException
     */
    public int get_PCTNCNCLBUFWAIVE_REASON_size() throws FMLManipulationException {
    ...
    public String get_NUMBER_LOCATION() throws FMLManipulationException {
        return ((String) this.fmlBuffer[387].getValue(0));
    }
    ...
    public void set_NUMBER_LOCATION(String value) throws FMLManipulationException {
        this.fmlBuffer[387].setValue(0, value);
    }
    ...
    public String get_DEPOSITTERMSIND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[388].getValue(0)));
    }
    ...
    public void set_DEPOSITTERMSIND(String value) throws FMLManipulationException {
        this.fmlBuffer[388].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_WAIVING_REASON_CODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[390].getValue(0));
    }
    ...
    public void set_WAIVING_REASON_CODE(String value) throws FMLManipulationException {
        this.fmlBuffer[390].setValue(0, value);
    }
    ...
    public Integer get_PFTRDEPBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[391].getValue(0));
    }
    ...
    public void set_PFTRDEPBUFROWCOUNT(Integer value) throws FMLManipulationException {
        this.fmlBuffer[391].setValue(0, value);
    }
    ...
    public Double get_DEPOSIT_AMOUNT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[393].getValue(nIndex));
    }
