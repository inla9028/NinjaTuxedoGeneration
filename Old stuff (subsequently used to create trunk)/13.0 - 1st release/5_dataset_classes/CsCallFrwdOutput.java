 ...
 * @author  Ninja
 *
 * CsCallFrwdOutput class.
 */
public class CsCallFrwdOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsCallFrwdOutput.
     *
     * @throws FMLManipulationException
     */
    public CsCallFrwdOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsCallFrwdOutput() {
    }

    /**
     * Creates a new instance of CsCallFrwdOutput.
     *
     * @param ds Output dataset from CsCallFrwd service.
     * @throws FMLManipulationException
     */
    public CsCallFrwdOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
