...
public class ArInCstBanInput extends ServiceInput {
    ...
    public ArInCstBanInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[250] = new FmlField("PSVBLPRMBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[250], 250, 1);
        this.fmlBuffer[251] = new FmlField("BPMODE", FmlField.TYPE_BYTE, -1, defaultValues[251], 251, 20);
        this.fmlBuffer[252] = new FmlField("BPSEQNO", FmlField.TYPE_INTEGER, -1, defaultValues[252], 252, 20);
        this.fmlBuffer[253] = new FmlField("BPEFFDATE", FmlField.TYPE_STRING, 9, defaultValues[253], 253, 20);
        this.fmlBuffer[254] = new FmlField("BPEXPDATE", FmlField.TYPE_STRING, 9, defaultValues[254], 254, 20);
        this.fmlBuffer[255] = new FmlField("BPFORMAT", FmlField.TYPE_STRING, 3, defaultValues[255], 255, 20);
        this.fmlBuffer[256] = new FmlField("BPMEDIA", FmlField.TYPE_STRING, 3, defaultValues[256], 256, 20);
        this.fmlBuffer[257] = new FmlField("BPPRINTCATEGORY", FmlField.TYPE_STRING, 3, defaultValues[257], 257, 20);
        this.fmlBuffer[258] = new FmlField("BPNOOFCOPIES", FmlField.TYPE_SHORT, -1, defaultValues[258], 258, 20);
        this.fmlBuffer[259] = new FmlField("BP_LANGUAGE", FmlField.TYPE_STRING, 3, defaultValues[259], 259, 20);
        this.fmlBuffer[260] = new FmlField("BP_CALL_DETAILS_MEDIA", FmlField.TYPE_BYTE, -1, defaultValues[260], 260, 20);
    }
