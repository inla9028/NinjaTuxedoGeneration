...
public class ArSvBanSvcInput extends ServiceInput {
    ...
    public ArSvBanSvcInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[84] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, defaultValues[84], 84, 2);
        this.fmlBuffer[85] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, defaultValues[85], 85, 2);
        this.fmlBuffer[86] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[86], 86, 2);
        this.fmlBuffer[87] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, defaultValues[87], 87, 2);
        this.fmlBuffer[88] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, defaultValues[88], 88, 2);
        this.fmlBuffer[89] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, defaultValues[89], 89, 2);
        this.fmlBuffer[90] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, defaultValues[90], 90, 2);
        this.fmlBuffer[91] = new FmlField("P1", FmlField.TYPE_STRING, 21, defaultValues[91], 91, 2);
        this.fmlBuffer[92] = new FmlField("P2", FmlField.TYPE_STRING, 21, defaultValues[92], 92, 2);
        this.fmlBuffer[93] = new FmlField("P3", FmlField.TYPE_STRING, 21, defaultValues[93], 93, 2);
        this.fmlBuffer[94] = new FmlField("P4", FmlField.TYPE_STRING, 21, defaultValues[94], 94, 2);
        this.fmlBuffer[95] = new FmlField("P5", FmlField.TYPE_STRING, 21, defaultValues[95], 95, 2);
        this.fmlBuffer[96] = new FmlField("P6", FmlField.TYPE_STRING, 21, defaultValues[96], 96, 2);
        this.fmlBuffer[97] = new FmlField("P7", FmlField.TYPE_STRING, 21, defaultValues[97], 97, 2);
        this.fmlBuffer[98] = new FmlField("P8", FmlField.TYPE_STRING, 21, defaultValues[98], 98, 2);
        this.fmlBuffer[99] = new FmlField("P9", FmlField.TYPE_STRING, 21, defaultValues[99], 99, 2);
        this.fmlBuffer[100] = new FmlField("P10", FmlField.TYPE_STRING, 21, defaultValues[100], 100, 2);
        this.fmlBuffer[101] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[101], 101, 2);
        this.fmlBuffer[102] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, defaultValues[102], 102, 2);
        this.fmlBuffer[103] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[103], 103, 2);
        this.fmlBuffer[104] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, defaultValues[104], 104, 2);
        this.fmlBuffer[105] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, defaultValues[105], 105, 2);
        this.fmlBuffer[106] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, defaultValues[106], 106, 2);
