 ...
 * @author  Ninja
 *
 * CsRsCanCtnOutput class.
 */
public class CsRsCanCtnOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsRsCanCtnOutput.
     *
     * @throws FMLManipulationException
     */
    public CsRsCanCtnOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsRsCanCtnOutput() {
    }

    /**
     * Creates a new instance of CsRsCanCtnOutput.
     *
     * @param ds Output dataset from CsRsCanCtn service.
     * @throws FMLManipulationException
     */
    public CsRsCanCtnOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
