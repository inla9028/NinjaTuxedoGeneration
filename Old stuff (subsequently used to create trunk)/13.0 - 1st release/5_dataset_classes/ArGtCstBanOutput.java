...
public class ArGtCstBanOutput extends ServiceOutput {
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[279];
        ...
        this.fmlBuffer[261] = new FmlField("PCNTRTINFROWID", FmlField.TYPE_STRING, 19, null, 261, 1);
        this.fmlBuffer[262] = new FmlField("PCNTRTINFSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, null, 262, 1);
        this.fmlBuffer[263] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, null, 263, 1);
        this.fmlBuffer[264] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, null, 264, 1);
        this.fmlBuffer[265] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, null, 265, 1);
        this.fmlBuffer[266] = new FmlField("PW_DESCRIPTION", FmlField.TYPE_STRING, 21, null, 266, 1);
        this.fmlBuffer[267] = new FmlField("MOREROWS", FmlField.TYPE_SHORT, -1, null, 267, 1);
        this.fmlBuffer[268] = new FmlField("CTNSTSCOUNTROWCOUNT", FmlField.TYPE_INTEGER, -1, null, 268, 1);
        this.fmlBuffer[269] = new FmlField("PRODUCT_TYPE", FmlField.TYPE_STRING, 4, null, 269, 10);
        this.fmlBuffer[270] = new FmlField("CTN_RESERVED", FmlField.TYPE_INTEGER, -1, null, 270, 10);
        this.fmlBuffer[271] = new FmlField("CTN_OPEN", FmlField.TYPE_INTEGER, -1, null, 271, 10);
        this.fmlBuffer[272] = new FmlField("CTN_SUSPENDED", FmlField.TYPE_INTEGER, -1, null, 272, 10);
        this.fmlBuffer[273] = new FmlField("CTN_CANCELLED", FmlField.TYPE_INTEGER, -1, null, 273, 10);
        this.fmlBuffer[274] = new FmlField("FUTURE_REQ_COUNT", FmlField.TYPE_INTEGER, -1, null, 274, 1);
        this.fmlBuffer[275] = new FmlField("FU_COUNT", FmlField.TYPE_INTEGER, -1, null, 275, 1);
        this.fmlBuffer[276] = new FmlField("LINKED_IND", FmlField.TYPE_BYTE, -1, null, 276, 1);
        this.fmlBuffer[277] = new FmlField("BP_LANGUAGE", FmlField.TYPE_STRING, 3, null, 277, 1);
        this.fmlBuffer[278] = new FmlField("FNF_FAMILIES_COUNT", FmlField.TYPE_INTEGER, -1, null, 278, 1);
    }
    ...
    public Integer get_CTNSTSCOUNTROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[268].getValue(0));
    }
    ...
    public Integer get_CTN_RESERVED(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[270].getValue(nIndex));
    }
    /**
    ...
    public Integer get_FNF_FAMILIES_COUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[278].getValue(0));
    }
}