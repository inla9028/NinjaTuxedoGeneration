 ...
 * @author  Ninja
 *
 * CsChgCtnOutput class.
 */
public class CsChgCtnOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsChgCtnOutput.
     *
     * @throws FMLManipulationException
     */
    public CsChgCtnOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsChgCtnOutput() {
    }

    /**
     * Creates a new instance of CsChgCtnOutput.
     *
     * @param ds Output dataset from CsChgCtn service.
     * @throws FMLManipulationException
     */
    public CsChgCtnOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
