 ...
 * @author  Ninja
 *
 * CsCallFrwdInput class.
 */
public class CsCallFrwdInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsCallFrwdInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsCallFrwdInput() throws EnvironmentException, FMLManipulationException {
        // Initialize FML buffer
        fmlBuffer = new FmlField[48];

        // Get default values from DB
        synchronized (this.defaultValuesPopulated) {
            if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
                defaultValues = getDefaultValues("csCallFrwd", 48);
        ...
        this.fmlBuffer[17] = new FmlField("TN", FmlField.TYPE_STRING, 21, defaultValues[17], 17, 1);
        this.fmlBuffer[18] = new FmlField("SRV_TRX_TP_CD", FmlField.TYPE_STRING, 4, defaultValues[18], 18, 1);
        this.fmlBuffer[19] = new FmlField("TRX_SRC", FmlField.TYPE_STRING, 4, defaultValues[19], 19, 1);
        this.fmlBuffer[20] = new FmlField("IMSI", FmlField.TYPE_STRING, 16, defaultValues[20], 20, 1);
        this.fmlBuffer[21] = new FmlField("HLR_ID", FmlField.TYPE_STRING, 4, defaultValues[21], 21, 1);
        this.fmlBuffer[22] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, defaultValues[22], 22, 1);
        this.fmlBuffer[23] = new FmlField("FEATURES", FmlField.TYPE_STRING, 2001, defaultValues[23], 23, 1);
        this.fmlBuffer[24] = new FmlField("PRODUCT_TYPE", FmlField.TYPE_STRING, 4, defaultValues[24], 24, 1);
        this.fmlBuffer[25] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, defaultValues[25], 25, 1);
        this.fmlBuffer[26] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, defaultValues[26], 26, 1);
        this.fmlBuffer[27] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[27], 27, 1);
        this.fmlBuffer[28] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, defaultValues[28], 28, 1);
        this.fmlBuffer[29] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, defaultValues[29], 29, 1);
        this.fmlBuffer[30] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, defaultValues[30], 30, 1);
        this.fmlBuffer[31] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, defaultValues[31], 31, 1);
        this.fmlBuffer[32] = new FmlField("P1", FmlField.TYPE_STRING, 21, defaultValues[32], 32, 1);
        this.fmlBuffer[33] = new FmlField("P2", FmlField.TYPE_STRING, 21, defaultValues[33], 33, 1);
        this.fmlBuffer[34] = new FmlField("P3", FmlField.TYPE_STRING, 21, defaultValues[34], 34, 1);
        this.fmlBuffer[35] = new FmlField("P4", FmlField.TYPE_STRING, 21, defaultValues[35], 35, 1);
        this.fmlBuffer[36] = new FmlField("P5", FmlField.TYPE_STRING, 21, defaultValues[36], 36, 1);
        this.fmlBuffer[37] = new FmlField("P6", FmlField.TYPE_STRING, 21, defaultValues[37], 37, 1);
        this.fmlBuffer[38] = new FmlField("P7", FmlField.TYPE_STRING, 21, defaultValues[38], 38, 1);
        this.fmlBuffer[39] = new FmlField("P8", FmlField.TYPE_STRING, 21, defaultValues[39], 39, 1);
        this.fmlBuffer[40] = new FmlField("P9", FmlField.TYPE_STRING, 21, defaultValues[40], 40, 1);
        this.fmlBuffer[41] = new FmlField("P10", FmlField.TYPE_STRING, 21, defaultValues[41], 41, 1);
        this.fmlBuffer[42] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[42], 42, 1);
        this.fmlBuffer[43] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, defaultValues[43], 43, 1);
        this.fmlBuffer[44] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[44], 44, 1);
        this.fmlBuffer[45] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, defaultValues[45], 45, 1);
        this.fmlBuffer[46] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, defaultValues[46], 46, 1);
        this.fmlBuffer[47] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, defaultValues[47], 47, 1);
    }
     ...
     * @throws FMLManipulationException
     */
    public String get_TN() throws FMLManipulationException {
        return ((String) this.fmlBuffer[17].getValue(0));
    }

    /**
     * Sets the value of the 'TN' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_TN(String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public String get_SRV_TRX_TP_CD() throws FMLManipulationException {
        return ((String) this.fmlBuffer[18].getValue(0));
    }

    /**
     * Sets the value of the 'SRV_TRX_TP_CD' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_SRV_TRX_TP_CD(String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public String get_TRX_SRC() throws FMLManipulationException {
        return ((String) this.fmlBuffer[19].getValue(0));
    }

    /**
     * Sets the value of the 'TRX_SRC' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_TRX_SRC(String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public String get_IMSI() throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public void set_IMSI(String value) throws FMLManipulationException {
     ...
     * @throws FMLManipulationException
     */
    public String get_HLR_ID() throws FMLManipulationException {
        return ((String) this.fmlBuffer[21].getValue(0));
    }

    /**
     * Sets the value of the 'HLR_ID' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_HLR_ID(String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'FEATURES' field in the FML buffer.
     *
     * @return Value of 'FEATURES' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_FEATURES() throws FMLManipulationException {
        return ((String) this.fmlBuffer[23].getValue(0));
    }

    /**
     * Sets the value of the 'FEATURES' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 2001.
     * @throws FMLManipulationException
     */
    public void set_FEATURES(String value) throws FMLManipulationException {
