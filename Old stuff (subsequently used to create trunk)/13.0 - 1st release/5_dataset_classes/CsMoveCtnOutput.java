 ...
 * @author  Ninja
 *
 * CsMoveCtnOutput class.
 */
public class CsMoveCtnOutput extends ServiceOutput {

    /**
     * Creates a new instance of CsMoveCtnOutput.
     *
     * @throws FMLManipulationException
     */
    public CsMoveCtnOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public CsMoveCtnOutput() {
    }

    /**
     * Creates a new instance of CsMoveCtnOutput.
     *
     * @param ds Output dataset from CsMoveCtn service.
     * @throws FMLManipulationException
     */
    public CsMoveCtnOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
