...
public class CsRsCanCtnInput extends ServiceInput {
     ...
     */
    public CsRsCanCtnInput() throws EnvironmentException, FMLManipulationException {
        // Initialize FML buffer
        fmlBuffer = new FmlField[379];

        // Get default values from DB
        synchronized (this.defaultValuesPopulated) {
            if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
                defaultValues = getDefaultValues("csRsCanCtn", 379);
        ...
        this.fmlBuffer[16] = new FmlField("DEPOSITTERMSIND", FmlField.TYPE_BYTE, -1, defaultValues[16], 16, 1);
        this.fmlBuffer[17] = new FmlField("ACTVFEEIND", FmlField.TYPE_BYTE, -1, defaultValues[17], 17, 1);
        this.fmlBuffer[18] = new FmlField("ACTIVATIONFEE", FmlField.TYPE_DOUBLE, -1, defaultValues[18], 18, 1);
        this.fmlBuffer[19] = new FmlField("CHANGEIND", FmlField.TYPE_BYTE, -1, defaultValues[19], 19, 1);
        this.fmlBuffer[20] = new FmlField("WAIVERSNIND", FmlField.TYPE_BYTE, -1, defaultValues[20], 20, 1);
        this.fmlBuffer[21] = new FmlField("WAIVERSN", FmlField.TYPE_STRING, 7, defaultValues[21], 21, 1);
        this.fmlBuffer[22] = new FmlField("NUMLOC", FmlField.TYPE_STRING, 4, defaultValues[22], 22, 1);
        this.fmlBuffer[23] = new FmlField("PPRWRK_STS_CD", FmlField.TYPE_STRING, 3, defaultValues[23], 23, 1);
        this.fmlBuffer[24] = new FmlField("ACTIVITY_DATE", FmlField.TYPE_STRING, 9, defaultValues[24], 24, 1);
        this.fmlBuffer[25] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[25], 25, 1);
        this.fmlBuffer[26] = new FmlField("ROWID", FmlField.TYPE_STRING, 19, defaultValues[26], 26, 50);
        this.fmlBuffer[27] = new FmlField("SOC", FmlField.TYPE_STRING, 10, defaultValues[27], 27, 50);
        this.fmlBuffer[28] = new FmlField("SOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[28], 28, 50);
        this.fmlBuffer[29] = new FmlField("COMMITMENT_END_DATE", FmlField.TYPE_STRING, 9, defaultValues[29], 29, 50);
        this.fmlBuffer[30] = new FmlField("SERVICE_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[30], 30, 50);
        this.fmlBuffer[31] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[31], 31, 50);
        this.fmlBuffer[32] = new FmlField("EXPIRATION_DATE", FmlField.TYPE_STRING, 9, defaultValues[32], 32, 50);
        this.fmlBuffer[33] = new FmlField("SOC_LEVEL_CODE", FmlField.TYPE_BYTE, -1, defaultValues[33], 33, 50);
        this.fmlBuffer[34] = new FmlField("DEALER_CODE", FmlField.TYPE_STRING, 6, defaultValues[34], 34, 50);
        this.fmlBuffer[35] = new FmlField("SALES_AGENT", FmlField.TYPE_STRING, 6, defaultValues[35], 35, 50);
        this.fmlBuffer[36] = new FmlField("SRV_MODE", FmlField.TYPE_BYTE, -1, defaultValues[36], 36, 50);
        this.fmlBuffer[37] = new FmlField("SRV_SUB_MODE", FmlField.TYPE_BYTE, -1, defaultValues[37], 37, 50);
        this.fmlBuffer[38] = new FmlField("SOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[38], 38, 50);
        this.fmlBuffer[39] = new FmlField("SRV_TRX_ID", FmlField.TYPE_INTEGER, -1, defaultValues[39], 39, 50);
        this.fmlBuffer[40] = new FmlField("CAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, defaultValues[40], 40, 50);
        this.fmlBuffer[41] = new FmlField("CAMPAIGN", FmlField.TYPE_STRING, 10, defaultValues[41], 41, 50);
        this.fmlBuffer[42] = new FmlField("COMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, defaultValues[42], 42, 50);
        this.fmlBuffer[43] = new FmlField("PRODUCT_TYPE", FmlField.TYPE_STRING, 4, defaultValues[43], 43, 50);
        this.fmlBuffer[44] = new FmlField("LOAN_VER_NO", FmlField.TYPE_INTEGER, -1, defaultValues[44], 44, 50);
        this.fmlBuffer[45] = new FmlField("LOAN_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[45], 45, 50);
        this.fmlBuffer[46] = new FmlField("SOC_ACTV_FEE", FmlField.TYPE_DOUBLE, -1, defaultValues[46], 46, 50);
        this.fmlBuffer[47] = new FmlField("PROMOTIONAL_SOC", FmlField.TYPE_STRING, 10, defaultValues[47], 47, 50);
        this.fmlBuffer[48] = new FmlField("REASON_CODE", FmlField.TYPE_STRING, 5, defaultValues[48], 48, 50);
        this.fmlBuffer[49] = new FmlField("SOC_START_RC_DATE", FmlField.TYPE_STRING, 9, defaultValues[49], 49, 50);
        this.fmlBuffer[50] = new FmlField("RC_DATE_COPY_IND", FmlField.TYPE_BYTE, -1, defaultValues[50], 50, 50);
        this.fmlBuffer[51] = new FmlField("PAGRRECROWID", FmlField.TYPE_STRING, 19, defaultValues[51], 51, 1);
        this.fmlBuffer[52] = new FmlField("PAGRRECSOC", FmlField.TYPE_STRING, 10, defaultValues[52], 52, 1);
        this.fmlBuffer[53] = new FmlField("PAGRRECSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[53], 53, 1);
        this.fmlBuffer[54] = new FmlField("PAGRRECCOMMITMENT_END_DATE", FmlField.TYPE_STRING, 9, defaultValues[54], 54, 1);
        this.fmlBuffer[55] = new FmlField("PAGRRECSERVICE_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[55], 55, 1);
        this.fmlBuffer[56] = new FmlField("PAGRRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[56], 56, 1);
        this.fmlBuffer[57] = new FmlField("PAGRRECEXPIRATION_DATE", FmlField.TYPE_STRING, 9, defaultValues[57], 57, 1);
        this.fmlBuffer[58] = new FmlField("PAGRRECSOC_LEVEL_CODE", FmlField.TYPE_BYTE, -1, defaultValues[58], 58, 1);
        this.fmlBuffer[59] = new FmlField("PAGRRECDEALER_CODE", FmlField.TYPE_STRING, 6, defaultValues[59], 59, 1);
        this.fmlBuffer[60] = new FmlField("PAGRRECSALES_AGENT", FmlField.TYPE_STRING, 6, defaultValues[60], 60, 1);
        this.fmlBuffer[61] = new FmlField("PAGRRECSRV_MODE", FmlField.TYPE_BYTE, -1, defaultValues[61], 61, 1);
        this.fmlBuffer[62] = new FmlField("PAGRRECSRV_SUB_MODE", FmlField.TYPE_BYTE, -1, defaultValues[62], 62, 1);
        this.fmlBuffer[63] = new FmlField("PAGRRECSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[63], 63, 1);
        this.fmlBuffer[64] = new FmlField("PAGRRECSRV_TRX_ID", FmlField.TYPE_INTEGER, -1, defaultValues[64], 64, 1);
        this.fmlBuffer[65] = new FmlField("PAGRRECCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, defaultValues[65], 65, 1);
        this.fmlBuffer[66] = new FmlField("PAGRRECCAMPAIGN", FmlField.TYPE_STRING, 10, defaultValues[66], 66, 1);
        this.fmlBuffer[67] = new FmlField("PAGRRECCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, defaultValues[67], 67, 1);
        this.fmlBuffer[68] = new FmlField("PAGRRECPRODUCT_TYPE", FmlField.TYPE_STRING, 4, defaultValues[68], 68, 1);
        this.fmlBuffer[69] = new FmlField("PAGRRECLOAN_VER_NO", FmlField.TYPE_INTEGER, -1, defaultValues[69], 69, 1);
        this.fmlBuffer[70] = new FmlField("PAGRRECLOAN_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[70], 70, 1);
        this.fmlBuffer[71] = new FmlField("PAGRRECSOC_ACTV_FEE", FmlField.TYPE_DOUBLE, -1, defaultValues[71], 71, 1);
        this.fmlBuffer[72] = new FmlField("PAGRRECPROMOTIONAL_SOC", FmlField.TYPE_STRING, 10, defaultValues[72], 72, 1);
        this.fmlBuffer[73] = new FmlField("PAGRRECREASON_CODE", FmlField.TYPE_STRING, 5, defaultValues[73], 73, 1);
        this.fmlBuffer[74] = new FmlField("PAGRRECSOC_START_RC_DATE", FmlField.TYPE_STRING, 9, defaultValues[74], 74, 1);
        this.fmlBuffer[75] = new FmlField("PAGRRECRC_DATE_COPY_IND", FmlField.TYPE_BYTE, -1, defaultValues[75], 75, 1);
        this.fmlBuffer[76] = new FmlField("PSOCFTRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[76], 76, 1);
        this.fmlBuffer[77] = new FmlField("PSOCFTRBUFROWID", FmlField.TYPE_STRING, 19, defaultValues[77], 77, 200);
        this.fmlBuffer[78] = new FmlField("PSOCFTRBUFSOC", FmlField.TYPE_STRING, 10, defaultValues[78], 78, 200);
        this.fmlBuffer[79] = new FmlField("PSOCFTRBUFSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[79], 79, 200);
        this.fmlBuffer[80] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, defaultValues[80], 80, 200);
        this.fmlBuffer[81] = new FmlField("MPS_FTR_CODE", FmlField.TYPE_STRING, 7, defaultValues[81], 81, 200);
        this.fmlBuffer[82] = new FmlField("FTR_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[82], 82, 200);
        this.fmlBuffer[83] = new FmlField("FTR_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, defaultValues[83], 83, 200);
        this.fmlBuffer[84] = new FmlField("FTR_EFF_RSN_CODE", FmlField.TYPE_BYTE, -1, defaultValues[84], 84, 200);
        this.fmlBuffer[85] = new FmlField("FTR_EXP_RSN_CODE", FmlField.TYPE_BYTE, -1, defaultValues[85], 85, 200);
        this.fmlBuffer[86] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[86], 86, 200);
        this.fmlBuffer[87] = new FmlField("FTR_MODE", FmlField.TYPE_BYTE, -1, defaultValues[87], 87, 200);
        this.fmlBuffer[88] = new FmlField("PSOCFTRBUFSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[88], 88, 200);
        this.fmlBuffer[89] = new FmlField("FTR_SUB_MODE", FmlField.TYPE_BYTE, -1, defaultValues[89], 89, 200);
        this.fmlBuffer[90] = new FmlField("FTR_ADD_PARAM", FmlField.TYPE_STRING, 301, defaultValues[90], 90, 200);
        this.fmlBuffer[91] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, defaultValues[91], 91, 200);
        this.fmlBuffer[92] = new FmlField("PSOCFTRBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, defaultValues[92], 92, 200);
        this.fmlBuffer[93] = new FmlField("PSOCFTRBUFCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, defaultValues[93], 93, 200);
        this.fmlBuffer[94] = new FmlField("FTR_SPECIAL_TELNO", FmlField.TYPE_STRING, 21, defaultValues[94], 94, 200);
        this.fmlBuffer[95] = new FmlField("SWITCH_ACT_NEEDED", FmlField.TYPE_BYTE, -1, defaultValues[95], 95, 200);
        this.fmlBuffer[96] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, defaultValues[96], 96, 200);
        this.fmlBuffer[97] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, defaultValues[97], 97, 200);
        this.fmlBuffer[98] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, defaultValues[98], 98, 200);
        this.fmlBuffer[99] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, defaultValues[99], 99, 200);
        this.fmlBuffer[100] = new FmlField("MANUAL_RC_RATE", FmlField.TYPE_DOUBLE, -1, defaultValues[100], 100, 200);
        this.fmlBuffer[101] = new FmlField("MANUAL_RC_EXP_DATE", FmlField.TYPE_STRING, 9, defaultValues[101], 101, 200);
        this.fmlBuffer[102] = new FmlField("PCSFRNDFMLROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[102], 102, 1);
        this.fmlBuffer[103] = new FmlField("ACTIONIND", FmlField.TYPE_BYTE, -1, defaultValues[103], 103, 10000);
        this.fmlBuffer[104] = new FmlField("PCSFANDFRECROWID", FmlField.TYPE_STRING, 19, defaultValues[104], 104, 10000);
        this.fmlBuffer[105] = new FmlField("PCSFANDFRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, defaultValues[105], 105, 10000);
        this.fmlBuffer[106] = new FmlField("PCSFANDFRECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[106], 106, 10000);
        this.fmlBuffer[107] = new FmlField("PERSONAL_TEL", FmlField.TYPE_STRING, 21, defaultValues[107], 107, 10000);
        this.fmlBuffer[108] = new FmlField("PERSONAL_TEL_TO", FmlField.TYPE_STRING, 21, defaultValues[108], 108, 10000);
        this.fmlBuffer[109] = new FmlField("FF_SOC", FmlField.TYPE_STRING, 10, defaultValues[109], 109, 10000);
        this.fmlBuffer[110] = new FmlField("PLAN_CODE", FmlField.TYPE_STRING, 10, defaultValues[110], 110, 10000);
        this.fmlBuffer[111] = new FmlField("DISCOUNT_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[111], 111, 10000);
        this.fmlBuffer[112] = new FmlField("START_HOUR", FmlField.TYPE_STRING, 7, defaultValues[112], 112, 10000);
        this.fmlBuffer[113] = new FmlField("DURATION", FmlField.TYPE_DOUBLE, -1, defaultValues[113], 113, 10000);
        this.fmlBuffer[114] = new FmlField("PESNBUFFERROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[114], 114, 1);
        this.fmlBuffer[115] = new FmlField("EQUIPMENT_NO", FmlField.TYPE_STRING, 21, defaultValues[115], 115, 50);
        this.fmlBuffer[116] = new FmlField("PHD_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[116], 116, 50);
        this.fmlBuffer[117] = new FmlField("EQUIPMENT_LEVEL", FmlField.TYPE_SHORT, -1, defaultValues[117], 117, 50);
        this.fmlBuffer[118] = new FmlField("IMSI", FmlField.TYPE_STRING, 16, defaultValues[118], 118, 50);
        this.fmlBuffer[119] = new FmlField("PHYDEVARRAYEXPIRATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[119], 119, 50);
        this.fmlBuffer[120] = new FmlField("PHYDEVARRAYEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, defaultValues[120], 120, 50);
        this.fmlBuffer[121] = new FmlField("OWNERSHIP_CODE", FmlField.TYPE_STRING, 3, defaultValues[121], 121, 50);
        this.fmlBuffer[122] = new FmlField("SW_STATE_IND", FmlField.TYPE_BYTE, -1, defaultValues[122], 122, 50);
        this.fmlBuffer[123] = new FmlField("LAST_SW_ACTV_DATE", FmlField.TYPE_STRING, 9, defaultValues[123], 123, 50);
        this.fmlBuffer[124] = new FmlField("NEXT_ACTV_CODE", FmlField.TYPE_BYTE, -1, defaultValues[124], 124, 50);
        this.fmlBuffer[125] = new FmlField("NEXT_ACTV_DATE", FmlField.TYPE_STRING, 9, defaultValues[125], 125, 50);
        this.fmlBuffer[126] = new FmlField("NEXT_ACTV_ISSUE_DT", FmlField.TYPE_STRING, 9, defaultValues[126], 126, 50);
        this.fmlBuffer[127] = new FmlField("DEVICE_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[127], 127, 50);
        this.fmlBuffer[128] = new FmlField("ESN_MODE", FmlField.TYPE_BYTE, -1, defaultValues[128], 128, 50);
        this.fmlBuffer[129] = new FmlField("ITEM_ID", FmlField.TYPE_STRING, 16, defaultValues[129], 129, 50);
        this.fmlBuffer[130] = new FmlField("POOL", FmlField.TYPE_STRING, 3, defaultValues[130], 130, 50);
        this.fmlBuffer[131] = new FmlField("LOCATION_ID", FmlField.TYPE_STRING, 5, defaultValues[131], 131, 50);
        this.fmlBuffer[132] = new FmlField("ACTIVITY_CODE", FmlField.TYPE_STRING, 5, defaultValues[132], 132, 50);
        this.fmlBuffer[133] = new FmlField("PHYDEVARRAYACTIVITY_DATE", FmlField.TYPE_STRING, 15, defaultValues[133], 133, 50);
        this.fmlBuffer[134] = new FmlField("OPERATION_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[134], 134, 50);
        this.fmlBuffer[135] = new FmlField("ITEM_OWNERSHIP", FmlField.TYPE_BYTE, -1, defaultValues[135], 135, 50);
        this.fmlBuffer[136] = new FmlField("ITEM_OWNERSHIP_DT", FmlField.TYPE_STRING, 15, defaultValues[136], 136, 50);
        this.fmlBuffer[137] = new FmlField("CURR_POSSESSION", FmlField.TYPE_BYTE, -1, defaultValues[137], 137, 50);
        this.fmlBuffer[138] = new FmlField("CURR_POSSESSION_DT", FmlField.TYPE_STRING, 15, defaultValues[138], 138, 50);
        this.fmlBuffer[139] = new FmlField("MISSING_IND", FmlField.TYPE_BYTE, -1, defaultValues[139], 139, 50);
        this.fmlBuffer[140] = new FmlField("IN_REPAIR_IND", FmlField.TYPE_BYTE, -1, defaultValues[140], 140, 50);
        this.fmlBuffer[141] = new FmlField("IN_TRANSIT_IND", FmlField.TYPE_BYTE, -1, defaultValues[141], 141, 50);
        this.fmlBuffer[142] = new FmlField("COMITED_TO_POS_IND", FmlField.TYPE_BYTE, -1, defaultValues[142], 142, 50);
        this.fmlBuffer[143] = new FmlField("COMITED_DATE", FmlField.TYPE_STRING, 15, defaultValues[143], 143, 50);
        this.fmlBuffer[144] = new FmlField("ACTIVITY_REASON", FmlField.TYPE_STRING, 4, defaultValues[144], 144, 50);
        this.fmlBuffer[145] = new FmlField("UPGRADE_IND", FmlField.TYPE_BYTE, -1, defaultValues[145], 145, 50);
        this.fmlBuffer[146] = new FmlField("EXPECTED_RTRN_DATE", FmlField.TYPE_STRING, 15, defaultValues[146], 146, 50);
        this.fmlBuffer[147] = new FmlField("POLICE_REPORT_NO", FmlField.TYPE_STRING, 16, defaultValues[147], 147, 50);
        this.fmlBuffer[148] = new FmlField("POLICE_REPORT_DATE", FmlField.TYPE_STRING, 15, defaultValues[148], 148, 50);
        this.fmlBuffer[149] = new FmlField("POLICE_STATION", FmlField.TYPE_STRING, 31, defaultValues[149], 149, 50);
        this.fmlBuffer[150] = new FmlField("PUK", FmlField.TYPE_INTEGER, -1, defaultValues[150], 150, 50);
        this.fmlBuffer[151] = new FmlField("PUK2", FmlField.TYPE_INTEGER, -1, defaultValues[151], 151, 50);
        this.fmlBuffer[152] = new FmlField("FIRST_USED_DATE", FmlField.TYPE_STRING, 15, defaultValues[152], 152, 50);
        this.fmlBuffer[153] = new FmlField("SIM_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[153], 153, 50);
        this.fmlBuffer[154] = new FmlField("SUSPEND_IND", FmlField.TYPE_BYTE, -1, defaultValues[154], 154, 50);
        this.fmlBuffer[155] = new FmlField("SUSPEND_DATE", FmlField.TYPE_STRING, 15, defaultValues[155], 155, 50);
        this.fmlBuffer[156] = new FmlField("SENT_TO_AUC_IND", FmlField.TYPE_BYTE, -1, defaultValues[156], 156, 50);
        this.fmlBuffer[157] = new FmlField("HLR_CD", FmlField.TYPE_STRING, 4, defaultValues[157], 157, 50);
        this.fmlBuffer[158] = new FmlField("K4ID", FmlField.TYPE_STRING, 41, defaultValues[158], 158, 50);
        this.fmlBuffer[159] = new FmlField("PHYDEVARRAYDEALER_CODE", FmlField.TYPE_STRING, 6, defaultValues[159], 159, 50);
        this.fmlBuffer[160] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, defaultValues[160], 160, 1);
        this.fmlBuffer[161] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, defaultValues[161], 161, 1);
        this.fmlBuffer[162] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[162], 162, 1);
        this.fmlBuffer[163] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, defaultValues[163], 163, 1);
        this.fmlBuffer[164] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, defaultValues[164], 164, 1);
        this.fmlBuffer[165] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, defaultValues[165], 165, 1);
        this.fmlBuffer[166] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, defaultValues[166], 166, 1);
        this.fmlBuffer[167] = new FmlField("P1", FmlField.TYPE_STRING, 21, defaultValues[167], 167, 1);
        this.fmlBuffer[168] = new FmlField("P2", FmlField.TYPE_STRING, 21, defaultValues[168], 168, 1);
        this.fmlBuffer[169] = new FmlField("P3", FmlField.TYPE_STRING, 21, defaultValues[169], 169, 1);
        this.fmlBuffer[170] = new FmlField("P4", FmlField.TYPE_STRING, 21, defaultValues[170], 170, 1);
        this.fmlBuffer[171] = new FmlField("P5", FmlField.TYPE_STRING, 21, defaultValues[171], 171, 1);
        this.fmlBuffer[172] = new FmlField("P6", FmlField.TYPE_STRING, 21, defaultValues[172], 172, 1);
        this.fmlBuffer[173] = new FmlField("P7", FmlField.TYPE_STRING, 21, defaultValues[173], 173, 1);
        this.fmlBuffer[174] = new FmlField("P8", FmlField.TYPE_STRING, 21, defaultValues[174], 174, 1);
        this.fmlBuffer[175] = new FmlField("P9", FmlField.TYPE_STRING, 21, defaultValues[175], 175, 1);
        this.fmlBuffer[176] = new FmlField("P10", FmlField.TYPE_STRING, 21, defaultValues[176], 176, 1);
        this.fmlBuffer[177] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[177], 177, 1);
        this.fmlBuffer[178] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, defaultValues[178], 178, 1);
        this.fmlBuffer[179] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[179], 179, 1);
        this.fmlBuffer[180] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, defaultValues[180], 180, 1);
        this.fmlBuffer[181] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, defaultValues[181], 181, 1);
        this.fmlBuffer[182] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, defaultValues[182], 182, 1);
        ...
        this.fmlBuffer[273] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, defaultValues[273], 273, 1);
        this.fmlBuffer[274] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, defaultValues[274], 274, 1);
        this.fmlBuffer[275] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, defaultValues[275], 275, 1);
        this.fmlBuffer[276] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, defaultValues[276], 276, 1);
        this.fmlBuffer[277] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, defaultValues[277], 277, 1);
        this.fmlBuffer[278] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, defaultValues[278], 278, 1);
        this.fmlBuffer[279] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[279], 279, 1);
        this.fmlBuffer[280] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[280], 280, 1);
        this.fmlBuffer[281] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, defaultValues[281], 281, 20);
        this.fmlBuffer[282] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, defaultValues[282], 282, 20);
        this.fmlBuffer[283] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, defaultValues[283], 283, 20);
        this.fmlBuffer[284] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, defaultValues[284], 284, 20);
        this.fmlBuffer[285] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[285], 285, 20);
        this.fmlBuffer[286] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, defaultValues[286], 286, 20);
        this.fmlBuffer[287] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, defaultValues[287], 287, 20);
        this.fmlBuffer[288] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, defaultValues[288], 288, 20);
        this.fmlBuffer[289] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[289], 289, 20);
        this.fmlBuffer[290] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[290], 290, 20);
        this.fmlBuffer[291] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[291], 291, 20);
        this.fmlBuffer[292] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, defaultValues[292], 292, 20);
        this.fmlBuffer[293] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, defaultValues[293], 293, 20);
        this.fmlBuffer[294] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, defaultValues[294], 294, 20);
        this.fmlBuffer[295] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, defaultValues[295], 295, 20);
        this.fmlBuffer[296] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, defaultValues[296], 296, 20);
        this.fmlBuffer[297] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, defaultValues[297], 297, 20);
        this.fmlBuffer[298] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, defaultValues[298], 298, 20);
        this.fmlBuffer[299] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[299], 299, 20);
        this.fmlBuffer[300] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, defaultValues[300], 300, 20);
        this.fmlBuffer[301] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, defaultValues[301], 301, 20);
        this.fmlBuffer[302] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, defaultValues[302], 302, 20);
        this.fmlBuffer[303] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[303], 303, 20);
        this.fmlBuffer[304] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[304], 304, 20);
        this.fmlBuffer[305] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, defaultValues[305], 305, 20);
        this.fmlBuffer[306] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, defaultValues[306], 306, 20);
        this.fmlBuffer[307] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, defaultValues[307], 307, 20);
        this.fmlBuffer[308] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[308], 308, 20);
        this.fmlBuffer[309] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, defaultValues[309], 309, 20);
        this.fmlBuffer[310] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, defaultValues[310], 310, 20);
        this.fmlBuffer[311] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, defaultValues[311], 311, 20);
        this.fmlBuffer[312] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, defaultValues[312], 312, 20);
        this.fmlBuffer[313] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, defaultValues[313], 313, 20);
        this.fmlBuffer[314] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, defaultValues[314], 314, 20);
        this.fmlBuffer[315] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, defaultValues[315], 315, 20);
        this.fmlBuffer[316] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, defaultValues[316], 316, 20);
        this.fmlBuffer[317] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, defaultValues[317], 317, 20);
        this.fmlBuffer[318] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, defaultValues[318], 318, 20);
        this.fmlBuffer[319] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, defaultValues[319], 319, 20);
        this.fmlBuffer[320] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, defaultValues[320], 320, 20);
        this.fmlBuffer[321] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, defaultValues[321], 321, 20);
        this.fmlBuffer[322] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, defaultValues[322], 322, 20);
        this.fmlBuffer[323] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, defaultValues[323], 323, 20);
        this.fmlBuffer[324] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, defaultValues[324], 324, 20);
        this.fmlBuffer[325] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, defaultValues[325], 325, 20);
        this.fmlBuffer[326] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, defaultValues[326], 326, 20);
        this.fmlBuffer[327] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, defaultValues[327], 327, 20);
        this.fmlBuffer[328] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[328], 328, 20);
        this.fmlBuffer[329] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, defaultValues[329], 329, 20);
        this.fmlBuffer[330] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, defaultValues[330], 330, 20);
        this.fmlBuffer[331] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, defaultValues[331], 331, 20);
        this.fmlBuffer[332] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[332], 332, 20);
        this.fmlBuffer[333] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[333], 333, 20);
        this.fmlBuffer[334] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, defaultValues[334], 334, 20);
        this.fmlBuffer[335] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, defaultValues[335], 335, 20);
        this.fmlBuffer[336] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, defaultValues[336], 336, 20);
        this.fmlBuffer[337] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[337], 337, 20);
        this.fmlBuffer[338] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[338], 338, 20);
        this.fmlBuffer[339] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[339], 339, 20);
        this.fmlBuffer[340] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, defaultValues[340], 340, 20);
        this.fmlBuffer[341] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, defaultValues[341], 341, 20);
        this.fmlBuffer[342] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, defaultValues[342], 342, 20);
        this.fmlBuffer[343] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, defaultValues[343], 343, 20);
        this.fmlBuffer[344] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, defaultValues[344], 344, 20);
        this.fmlBuffer[345] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, defaultValues[345], 345, 20);
        this.fmlBuffer[346] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, defaultValues[346], 346, 20);
        this.fmlBuffer[347] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, defaultValues[347], 347, 20);
        this.fmlBuffer[348] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, defaultValues[348], 348, 20);
        this.fmlBuffer[349] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, defaultValues[349], 349, 20);
        this.fmlBuffer[350] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, defaultValues[350], 350, 20);
        this.fmlBuffer[351] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, defaultValues[351], 351, 20);
        this.fmlBuffer[352] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, defaultValues[352], 352, 20);
        this.fmlBuffer[353] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, defaultValues[353], 353, 20);
        this.fmlBuffer[354] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, defaultValues[354], 354, 20);
        this.fmlBuffer[355] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, defaultValues[355], 355, 20);
        this.fmlBuffer[356] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, defaultValues[356], 356, 20);
        this.fmlBuffer[357] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, defaultValues[357], 357, 20);
        this.fmlBuffer[358] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, defaultValues[358], 358, 20);
        this.fmlBuffer[359] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, defaultValues[359], 359, 20);
        this.fmlBuffer[360] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, defaultValues[360], 360, 20);
        this.fmlBuffer[361] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, defaultValues[361], 361, 20);
        this.fmlBuffer[362] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, defaultValues[362], 362, 20);
        this.fmlBuffer[363] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, defaultValues[363], 363, 20);
        this.fmlBuffer[364] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, defaultValues[364], 364, 20);
        this.fmlBuffer[365] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, defaultValues[365], 365, 20);
        this.fmlBuffer[366] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, defaultValues[366], 366, 20);
        this.fmlBuffer[367] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, defaultValues[367], 367, 20);
        this.fmlBuffer[368] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, defaultValues[368], 368, 20);
        this.fmlBuffer[369] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, defaultValues[369], 369, 20);
        this.fmlBuffer[370] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, defaultValues[370], 370, 20);
        this.fmlBuffer[371] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, defaultValues[371], 371, 20);
        this.fmlBuffer[372] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, defaultValues[372], 372, 20);
        this.fmlBuffer[373] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, defaultValues[373], 373, 1);
        this.fmlBuffer[374] = new FmlField("INSTALLMENT_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[374], 374, 12);
        this.fmlBuffer[375] = new FmlField("INSTALLMENT_DATE", FmlField.TYPE_STRING, 9, defaultValues[375], 375, 12);
        this.fmlBuffer[376] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[376], 376, 1);
        this.fmlBuffer[377] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[377], 377, 2);
        this.fmlBuffer[378] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, defaultValues[378], 378, 2);
    }
    ...
    public String get_PAPER_WORK_REF_NO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[277].getValue(0));
    }
    ...
    public String get_DELIVERY_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[279].getValue(0)));
    }
    ...
    public void set_DELIVERY_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[279].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_FOREIGN_SEQ_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[291].getValue(nIndex));
    }
    ...
    public String get_NM_UP_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[299].getValue(nIndex)));
    }
    ...
    public void set_NM_UP_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[299].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_NAMERECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[308].getValue(nIndex)));
    }
    ...
    public void set_NAMERECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[308].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_KOB(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[318].getValue(nIndex));
    }
    ...
    public Integer get_NAMERECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[321].getValue(nIndex)));
    }
    ...
    public void set_NAMERECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[321].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public String get_ADR_UP_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[328].getValue(nIndex)));
    }
    ...
    public void set_ADR_UP_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[328].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_ADDRESSRECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[334].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[337].getValue(nIndex)));
    }
    ...
    public void set_ADDRESSRECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[337].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public String get_ADR_STATUS(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[339].getValue(nIndex)));
    }
    ...
    public void set_ADR_STATUS(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[339].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_ADDRESSRECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[357].getValue(nIndex)));
    }
    ...
    public void set_ADDRESSRECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[357].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_ROW_COUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[373].getValue(0));
    }
    ...
    public Double get_INSTALLMENT_AMT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[374].getValue(nIndex));
    }
    ...
    public String get_DEPOSIT_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[377].getValue(nIndex)));
    }
    ...
    public void set_DEPOSIT_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[377].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_DEPOSIT_AMOUNT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[378].getValue(nIndex));
    }
