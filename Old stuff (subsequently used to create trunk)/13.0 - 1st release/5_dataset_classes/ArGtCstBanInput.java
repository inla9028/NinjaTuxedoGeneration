 ...
 * @author  Ninja
 *
 * ArGtCstBanInput class.
 */
public class ArGtCstBanInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of ArGtCstBanInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public ArGtCstBanInput() throws EnvironmentException, FMLManipulationException {
        // Initialize FML buffer
        fmlBuffer = new FmlField[28];

        // Get default values from DB
        synchronized (this.defaultValuesPopulated) {
            if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
                defaultValues = getDefaultValues("arGtCstBan", 28);
        ...
        this.fmlBuffer[16] = new FmlField("CUSTID", FmlField.TYPE_INTEGER, -1, defaultValues[16], 16, 1);
        this.fmlBuffer[17] = new FmlField("ROWID", FmlField.TYPE_STRING, 19, defaultValues[17], 17, 1);
        this.fmlBuffer[18] = new FmlField("PBANKEYROWID", FmlField.TYPE_STRING, 19, defaultValues[18], 18, 1);
        this.fmlBuffer[19] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, defaultValues[19], 19, 1);
        this.fmlBuffer[20] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, defaultValues[20], 20, 1);
        this.fmlBuffer[21] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[21], 21, 1);
        this.fmlBuffer[22] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, defaultValues[22], 22, 1);
        this.fmlBuffer[23] = new FmlField("PGTPARAMRECBAN", FmlField.TYPE_INTEGER, -1, defaultValues[23], 23, 1);
        this.fmlBuffer[24] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, defaultValues[24], 24, 1);
        this.fmlBuffer[25] = new FmlField("LINK_TYPE_STR", FmlField.TYPE_STRING, 21, defaultValues[25], 25, 1);
        this.fmlBuffer[26] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[26], 26, 1);
        this.fmlBuffer[27] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[27], 27, 1);
    }
    ...
    /**
     * Retrieves the value of the 'CUSTID' field in the FML buffer.
     *
     * @return Value of 'CUSTID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_CUSTID() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[16].getValue(0));
    }

    /**
     * Sets the value of the 'CUSTID' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_CUSTID(Integer value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'PBANKEYROWID' field in the FML buffer.
     *
     * @return Value of 'PBANKEYROWID' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PBANKEYROWID() throws FMLManipulationException {
        return ((String) this.fmlBuffer[18].getValue(0));
    }

    /**
     * Sets the value of the 'PBANKEYROWID' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 19.
     * @throws FMLManipulationException
     */
    public void set_PBANKEYROWID(String value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'PGTPARAMRECBAN' field in the FML buffer.
     *
     * @return Value of 'PGTPARAMRECBAN' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PGTPARAMRECBAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[23].getValue(0));
    }

    /**
     * Sets the value of the 'PGTPARAMRECBAN' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PGTPARAMRECBAN(Integer value) throws FMLManipulationException {
    ...
    /**
     * Retrieves the value of the 'LINK_TYPE_STR' field in the FML buffer.
     *
     * @return Value of 'LINK_TYPE_STR' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_LINK_TYPE_STR() throws FMLManipulationException {
        return ((String) this.fmlBuffer[25].getValue(0));
    }

    /**
     * Sets the value of the 'LINK_TYPE_STR' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_LINK_TYPE_STR(String value) throws FMLManipulationException {
