 ...
 * @author  Ninja
 *
 * CsActvCtnInput class.
 */
public class CsActvCtnInput extends ServiceInput {
    ...
    /**
     * Creates a new instance of CsActvCtnInput
     *
     * @throws EnvironmentException
     * @throws FMLManipulationException
     */
    public CsActvCtnInput() throws EnvironmentException, FMLManipulationException {
        // Initialize FML buffer
        fmlBuffer = new FmlField[396];

        // Get default values from DB
        synchronized (this.defaultValuesPopulated) {
            if (this.defaultValuesPopulated.equals(Boolean.FALSE)) {
                defaultValues = getDefaultValues("csActvCtn", 396);
        ...
        this.fmlBuffer[16] = new FmlField("ACTVFEEIND", FmlField.TYPE_BYTE, -1, defaultValues[16], 16, 1);
        this.fmlBuffer[17] = new FmlField("ACTIVATIONFEE", FmlField.TYPE_DOUBLE, -1, defaultValues[17], 17, 1);
        this.fmlBuffer[18] = new FmlField("CHANGEIND", FmlField.TYPE_BYTE, -1, defaultValues[18], 18, 1);
        this.fmlBuffer[19] = new FmlField("WAIVERSNIND", FmlField.TYPE_BYTE, -1, defaultValues[19], 19, 1);
        this.fmlBuffer[20] = new FmlField("WAIVERSN", FmlField.TYPE_STRING, 7, defaultValues[20], 20, 1);
        this.fmlBuffer[21] = new FmlField("NUMLOC", FmlField.TYPE_STRING, 4, defaultValues[21], 21, 1);
        this.fmlBuffer[22] = new FmlField("PPRWRK_STS_CD", FmlField.TYPE_STRING, 3, defaultValues[22], 22, 1);
        this.fmlBuffer[23] = new FmlField("RMSACTVIND", FmlField.TYPE_BYTE, -1, defaultValues[23], 23, 1);
        this.fmlBuffer[24] = new FmlField("ROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[24], 24, 1);
        this.fmlBuffer[25] = new FmlField("ROWID", FmlField.TYPE_STRING, 19, defaultValues[25], 25, 50);
        this.fmlBuffer[26] = new FmlField("SOC", FmlField.TYPE_STRING, 10, defaultValues[26], 26, 50);
        this.fmlBuffer[27] = new FmlField("SOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[27], 27, 50);
        this.fmlBuffer[28] = new FmlField("COMMITMENT_END_DATE", FmlField.TYPE_STRING, 9, defaultValues[28], 28, 50);
        this.fmlBuffer[29] = new FmlField("SERVICE_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[29], 29, 50);
        this.fmlBuffer[30] = new FmlField("EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[30], 30, 50);
        this.fmlBuffer[31] = new FmlField("EXPIRATION_DATE", FmlField.TYPE_STRING, 9, defaultValues[31], 31, 50);
        this.fmlBuffer[32] = new FmlField("SOC_LEVEL_CODE", FmlField.TYPE_BYTE, -1, defaultValues[32], 32, 50);
        this.fmlBuffer[33] = new FmlField("DEALER_CODE", FmlField.TYPE_STRING, 6, defaultValues[33], 33, 50);
        this.fmlBuffer[34] = new FmlField("SALES_AGENT", FmlField.TYPE_STRING, 6, defaultValues[34], 34, 50);
        this.fmlBuffer[35] = new FmlField("SRV_MODE", FmlField.TYPE_BYTE, -1, defaultValues[35], 35, 50);
        this.fmlBuffer[36] = new FmlField("SRV_SUB_MODE", FmlField.TYPE_BYTE, -1, defaultValues[36], 36, 50);
        this.fmlBuffer[37] = new FmlField("SOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[37], 37, 50);
        this.fmlBuffer[38] = new FmlField("SRV_TRX_ID", FmlField.TYPE_INTEGER, -1, defaultValues[38], 38, 50);
        this.fmlBuffer[39] = new FmlField("CAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, defaultValues[39], 39, 50);
        this.fmlBuffer[40] = new FmlField("CAMPAIGN", FmlField.TYPE_STRING, 10, defaultValues[40], 40, 50);
        this.fmlBuffer[41] = new FmlField("COMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, defaultValues[41], 41, 50);
        this.fmlBuffer[42] = new FmlField("PRODUCT_TYPE", FmlField.TYPE_STRING, 4, defaultValues[42], 42, 50);
        this.fmlBuffer[43] = new FmlField("LOAN_VER_NO", FmlField.TYPE_INTEGER, -1, defaultValues[43], 43, 50);
        this.fmlBuffer[44] = new FmlField("LOAN_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[44], 44, 50);
        this.fmlBuffer[45] = new FmlField("SOC_ACTV_FEE", FmlField.TYPE_DOUBLE, -1, defaultValues[45], 45, 50);
        this.fmlBuffer[46] = new FmlField("PROMOTIONAL_SOC", FmlField.TYPE_STRING, 10, defaultValues[46], 46, 50);
        this.fmlBuffer[47] = new FmlField("REASON_CODE", FmlField.TYPE_STRING, 5, defaultValues[47], 47, 50);
        this.fmlBuffer[48] = new FmlField("SOC_START_RC_DATE", FmlField.TYPE_STRING, 9, defaultValues[48], 48, 50);
        this.fmlBuffer[49] = new FmlField("RC_DATE_COPY_IND", FmlField.TYPE_BYTE, -1, defaultValues[49], 49, 50);
        this.fmlBuffer[50] = new FmlField("PAGRRECROWID", FmlField.TYPE_STRING, 19, defaultValues[50], 50, 1);
        this.fmlBuffer[51] = new FmlField("PAGRRECSOC", FmlField.TYPE_STRING, 10, defaultValues[51], 51, 1);
        this.fmlBuffer[52] = new FmlField("PAGRRECSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[52], 52, 1);
        this.fmlBuffer[53] = new FmlField("PAGRRECCOMMITMENT_END_DATE", FmlField.TYPE_STRING, 9, defaultValues[53], 53, 1);
        this.fmlBuffer[54] = new FmlField("PAGRRECSERVICE_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[54], 54, 1);
        this.fmlBuffer[55] = new FmlField("PAGRRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[55], 55, 1);
        this.fmlBuffer[56] = new FmlField("PAGRRECEXPIRATION_DATE", FmlField.TYPE_STRING, 9, defaultValues[56], 56, 1);
        this.fmlBuffer[57] = new FmlField("PAGRRECSOC_LEVEL_CODE", FmlField.TYPE_BYTE, -1, defaultValues[57], 57, 1);
        this.fmlBuffer[58] = new FmlField("PAGRRECDEALER_CODE", FmlField.TYPE_STRING, 6, defaultValues[58], 58, 1);
        this.fmlBuffer[59] = new FmlField("PAGRRECSALES_AGENT", FmlField.TYPE_STRING, 6, defaultValues[59], 59, 1);
        this.fmlBuffer[60] = new FmlField("PAGRRECSRV_MODE", FmlField.TYPE_BYTE, -1, defaultValues[60], 60, 1);
        this.fmlBuffer[61] = new FmlField("PAGRRECSRV_SUB_MODE", FmlField.TYPE_BYTE, -1, defaultValues[61], 61, 1);
        this.fmlBuffer[62] = new FmlField("PAGRRECSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[62], 62, 1);
        this.fmlBuffer[63] = new FmlField("PAGRRECSRV_TRX_ID", FmlField.TYPE_INTEGER, -1, defaultValues[63], 63, 1);
        this.fmlBuffer[64] = new FmlField("PAGRRECCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, defaultValues[64], 64, 1);
        this.fmlBuffer[65] = new FmlField("PAGRRECCAMPAIGN", FmlField.TYPE_STRING, 10, defaultValues[65], 65, 1);
        this.fmlBuffer[66] = new FmlField("PAGRRECCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, defaultValues[66], 66, 1);
        this.fmlBuffer[67] = new FmlField("PAGRRECPRODUCT_TYPE", FmlField.TYPE_STRING, 4, defaultValues[67], 67, 1);
        this.fmlBuffer[68] = new FmlField("PAGRRECLOAN_VER_NO", FmlField.TYPE_INTEGER, -1, defaultValues[68], 68, 1);
        this.fmlBuffer[69] = new FmlField("PAGRRECLOAN_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[69], 69, 1);
        this.fmlBuffer[70] = new FmlField("PAGRRECSOC_ACTV_FEE", FmlField.TYPE_DOUBLE, -1, defaultValues[70], 70, 1);
        this.fmlBuffer[71] = new FmlField("PAGRRECPROMOTIONAL_SOC", FmlField.TYPE_STRING, 10, defaultValues[71], 71, 1);
        this.fmlBuffer[72] = new FmlField("PAGRRECREASON_CODE", FmlField.TYPE_STRING, 5, defaultValues[72], 72, 1);
        this.fmlBuffer[73] = new FmlField("PAGRRECSOC_START_RC_DATE", FmlField.TYPE_STRING, 9, defaultValues[73], 73, 1);
        this.fmlBuffer[74] = new FmlField("PAGRRECRC_DATE_COPY_IND", FmlField.TYPE_BYTE, -1, defaultValues[74], 74, 1);
        this.fmlBuffer[75] = new FmlField("PSOCFTRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[75], 75, 1);
        this.fmlBuffer[76] = new FmlField("PSOCFTRBUFROWID", FmlField.TYPE_STRING, 19, defaultValues[76], 76, 200);
        this.fmlBuffer[77] = new FmlField("PSOCFTRBUFSOC", FmlField.TYPE_STRING, 10, defaultValues[77], 77, 200);
        this.fmlBuffer[78] = new FmlField("PSOCFTRBUFSOC_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[78], 78, 200);
        this.fmlBuffer[79] = new FmlField("FEATURE_CODE", FmlField.TYPE_STRING, 7, defaultValues[79], 79, 200);
        this.fmlBuffer[80] = new FmlField("MPS_FTR_CODE", FmlField.TYPE_STRING, 7, defaultValues[80], 80, 200);
        this.fmlBuffer[81] = new FmlField("FTR_EFFECTIVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[81], 81, 200);
        this.fmlBuffer[82] = new FmlField("FTR_EXPIRATION_DATE", FmlField.TYPE_STRING, 9, defaultValues[82], 82, 200);
        this.fmlBuffer[83] = new FmlField("FTR_EFF_RSN_CODE", FmlField.TYPE_BYTE, -1, defaultValues[83], 83, 200);
        this.fmlBuffer[84] = new FmlField("FTR_EXP_RSN_CODE", FmlField.TYPE_BYTE, -1, defaultValues[84], 84, 200);
        this.fmlBuffer[85] = new FmlField("SERVICE_FTR_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[85], 85, 200);
        this.fmlBuffer[86] = new FmlField("FTR_MODE", FmlField.TYPE_BYTE, -1, defaultValues[86], 86, 200);
        this.fmlBuffer[87] = new FmlField("PSOCFTRBUFSOC_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[87], 87, 200);
        this.fmlBuffer[88] = new FmlField("FTR_SUB_MODE", FmlField.TYPE_BYTE, -1, defaultValues[88], 88, 200);
        this.fmlBuffer[89] = new FmlField("FTR_ADD_PARAM", FmlField.TYPE_STRING, 301, defaultValues[89], 89, 200);
        this.fmlBuffer[90] = new FmlField("FEATURE_TYPE", FmlField.TYPE_STRING, 4, defaultValues[90], 90, 200);
        this.fmlBuffer[91] = new FmlField("PSOCFTRBUFPRODUCT_TYPE", FmlField.TYPE_STRING, 4, defaultValues[91], 91, 200);
        this.fmlBuffer[92] = new FmlField("PSOCFTRBUFCAMPAIGN_SEQ", FmlField.TYPE_INTEGER, -1, defaultValues[92], 92, 200);
        this.fmlBuffer[93] = new FmlField("FTR_SPECIAL_TELNO", FmlField.TYPE_STRING, 21, defaultValues[93], 93, 200);
        this.fmlBuffer[94] = new FmlField("SWITCH_ACT_NEEDED", FmlField.TYPE_BYTE, -1, defaultValues[94], 94, 200);
        this.fmlBuffer[95] = new FmlField("SWITCH_CODE", FmlField.TYPE_STRING, 7, defaultValues[95], 95, 200);
        this.fmlBuffer[96] = new FmlField("MSISDN_CRITERIA", FmlField.TYPE_BYTE, -1, defaultValues[96], 96, 200);
        this.fmlBuffer[97] = new FmlField("TN_CLASS_CD", FmlField.TYPE_STRING, 4, defaultValues[97], 97, 200);
        this.fmlBuffer[98] = new FmlField("ACTION_MODE", FmlField.TYPE_BYTE, -1, defaultValues[98], 98, 200);
        this.fmlBuffer[99] = new FmlField("MANUAL_RC_RATE", FmlField.TYPE_DOUBLE, -1, defaultValues[99], 99, 200);
        this.fmlBuffer[100] = new FmlField("MANUAL_RC_EXP_DATE", FmlField.TYPE_STRING, 9, defaultValues[100], 100, 200);
        this.fmlBuffer[101] = new FmlField("PCSFRNDFMLROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[101], 101, 1);
        this.fmlBuffer[102] = new FmlField("ACTIONIND", FmlField.TYPE_BYTE, -1, defaultValues[102], 102, 10000);
        this.fmlBuffer[103] = new FmlField("PCSFANDFRECROWID", FmlField.TYPE_STRING, 19, defaultValues[103], 103, 10000);
        this.fmlBuffer[104] = new FmlField("PCSFANDFRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, defaultValues[104], 104, 10000);
        this.fmlBuffer[105] = new FmlField("PCSFANDFRECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[105], 105, 10000);
        this.fmlBuffer[106] = new FmlField("PERSONAL_TEL", FmlField.TYPE_STRING, 21, defaultValues[106], 106, 10000);
        this.fmlBuffer[107] = new FmlField("PERSONAL_TEL_TO", FmlField.TYPE_STRING, 21, defaultValues[107], 107, 10000);
        this.fmlBuffer[108] = new FmlField("FF_SOC", FmlField.TYPE_STRING, 10, defaultValues[108], 108, 10000);
        this.fmlBuffer[109] = new FmlField("PLAN_CODE", FmlField.TYPE_STRING, 10, defaultValues[109], 109, 10000);
        this.fmlBuffer[110] = new FmlField("DISCOUNT_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[110], 110, 10000);
        this.fmlBuffer[111] = new FmlField("START_HOUR", FmlField.TYPE_STRING, 7, defaultValues[111], 111, 10000);
        this.fmlBuffer[112] = new FmlField("DURATION", FmlField.TYPE_DOUBLE, -1, defaultValues[112], 112, 10000);
        this.fmlBuffer[113] = new FmlField("PESNBUFFERROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[113], 113, 1);
        this.fmlBuffer[114] = new FmlField("EQUIPMENT_NO", FmlField.TYPE_STRING, 21, defaultValues[114], 114, 50);
        this.fmlBuffer[115] = new FmlField("PHD_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[115], 115, 50);
        this.fmlBuffer[116] = new FmlField("EQUIPMENT_LEVEL", FmlField.TYPE_SHORT, -1, defaultValues[116], 116, 50);
        this.fmlBuffer[117] = new FmlField("IMSI", FmlField.TYPE_STRING, 16, defaultValues[117], 117, 50);
        this.fmlBuffer[118] = new FmlField("PHYDEVARRAYEXPIRATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[118], 118, 50);
        this.fmlBuffer[119] = new FmlField("PHYDEVARRAYEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, defaultValues[119], 119, 50);
        this.fmlBuffer[120] = new FmlField("OWNERSHIP_CODE", FmlField.TYPE_STRING, 3, defaultValues[120], 120, 50);
        this.fmlBuffer[121] = new FmlField("SW_STATE_IND", FmlField.TYPE_BYTE, -1, defaultValues[121], 121, 50);
        this.fmlBuffer[122] = new FmlField("LAST_SW_ACTV_DATE", FmlField.TYPE_STRING, 9, defaultValues[122], 122, 50);
        this.fmlBuffer[123] = new FmlField("NEXT_ACTV_CODE", FmlField.TYPE_BYTE, -1, defaultValues[123], 123, 50);
        this.fmlBuffer[124] = new FmlField("NEXT_ACTV_DATE", FmlField.TYPE_STRING, 9, defaultValues[124], 124, 50);
        this.fmlBuffer[125] = new FmlField("NEXT_ACTV_ISSUE_DT", FmlField.TYPE_STRING, 9, defaultValues[125], 125, 50);
        this.fmlBuffer[126] = new FmlField("DEVICE_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[126], 126, 50);
        this.fmlBuffer[127] = new FmlField("ESN_MODE", FmlField.TYPE_BYTE, -1, defaultValues[127], 127, 50);
        this.fmlBuffer[128] = new FmlField("ITEM_ID", FmlField.TYPE_STRING, 16, defaultValues[128], 128, 50);
        this.fmlBuffer[129] = new FmlField("POOL", FmlField.TYPE_STRING, 3, defaultValues[129], 129, 50);
        this.fmlBuffer[130] = new FmlField("LOCATION_ID", FmlField.TYPE_STRING, 5, defaultValues[130], 130, 50);
        this.fmlBuffer[131] = new FmlField("ACTIVITY_CODE", FmlField.TYPE_STRING, 5, defaultValues[131], 131, 50);
        this.fmlBuffer[132] = new FmlField("ACTIVITY_DATE", FmlField.TYPE_STRING, 15, defaultValues[132], 132, 50);
        this.fmlBuffer[133] = new FmlField("OPERATION_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[133], 133, 50);
        this.fmlBuffer[134] = new FmlField("ITEM_OWNERSHIP", FmlField.TYPE_BYTE, -1, defaultValues[134], 134, 50);
        this.fmlBuffer[135] = new FmlField("ITEM_OWNERSHIP_DT", FmlField.TYPE_STRING, 15, defaultValues[135], 135, 50);
        this.fmlBuffer[136] = new FmlField("CURR_POSSESSION", FmlField.TYPE_BYTE, -1, defaultValues[136], 136, 50);
        this.fmlBuffer[137] = new FmlField("CURR_POSSESSION_DT", FmlField.TYPE_STRING, 15, defaultValues[137], 137, 50);
        this.fmlBuffer[138] = new FmlField("MISSING_IND", FmlField.TYPE_BYTE, -1, defaultValues[138], 138, 50);
        this.fmlBuffer[139] = new FmlField("IN_REPAIR_IND", FmlField.TYPE_BYTE, -1, defaultValues[139], 139, 50);
        this.fmlBuffer[140] = new FmlField("IN_TRANSIT_IND", FmlField.TYPE_BYTE, -1, defaultValues[140], 140, 50);
        this.fmlBuffer[141] = new FmlField("COMITED_TO_POS_IND", FmlField.TYPE_BYTE, -1, defaultValues[141], 141, 50);
        this.fmlBuffer[142] = new FmlField("COMITED_DATE", FmlField.TYPE_STRING, 15, defaultValues[142], 142, 50);
        this.fmlBuffer[143] = new FmlField("ACTIVITY_REASON", FmlField.TYPE_STRING, 4, defaultValues[143], 143, 50);
        this.fmlBuffer[144] = new FmlField("UPGRADE_IND", FmlField.TYPE_BYTE, -1, defaultValues[144], 144, 50);
        this.fmlBuffer[145] = new FmlField("EXPECTED_RTRN_DATE", FmlField.TYPE_STRING, 15, defaultValues[145], 145, 50);
        this.fmlBuffer[146] = new FmlField("POLICE_REPORT_NO", FmlField.TYPE_STRING, 16, defaultValues[146], 146, 50);
        this.fmlBuffer[147] = new FmlField("POLICE_REPORT_DATE", FmlField.TYPE_STRING, 15, defaultValues[147], 147, 50);
        this.fmlBuffer[148] = new FmlField("POLICE_STATION", FmlField.TYPE_STRING, 31, defaultValues[148], 148, 50);
        this.fmlBuffer[149] = new FmlField("PUK", FmlField.TYPE_INTEGER, -1, defaultValues[149], 149, 50);
        this.fmlBuffer[150] = new FmlField("PUK2", FmlField.TYPE_INTEGER, -1, defaultValues[150], 150, 50);
        this.fmlBuffer[151] = new FmlField("FIRST_USED_DATE", FmlField.TYPE_STRING, 15, defaultValues[151], 151, 50);
        this.fmlBuffer[152] = new FmlField("SIM_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[152], 152, 50);
        this.fmlBuffer[153] = new FmlField("SUSPEND_IND", FmlField.TYPE_BYTE, -1, defaultValues[153], 153, 50);
        this.fmlBuffer[154] = new FmlField("SUSPEND_DATE", FmlField.TYPE_STRING, 15, defaultValues[154], 154, 50);
        this.fmlBuffer[155] = new FmlField("SENT_TO_AUC_IND", FmlField.TYPE_BYTE, -1, defaultValues[155], 155, 50);
        this.fmlBuffer[156] = new FmlField("HLR_CD", FmlField.TYPE_STRING, 4, defaultValues[156], 156, 50);
        this.fmlBuffer[157] = new FmlField("K4ID", FmlField.TYPE_STRING, 41, defaultValues[157], 157, 50);
        this.fmlBuffer[158] = new FmlField("PHYDEVARRAYDEALER_CODE", FmlField.TYPE_STRING, 6, defaultValues[158], 158, 50);
        this.fmlBuffer[159] = new FmlField("ROW_COUNT", FmlField.TYPE_INTEGER, -1, defaultValues[159], 159, 1);
        this.fmlBuffer[160] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, defaultValues[160], 160, 25);
        this.fmlBuffer[161] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, defaultValues[161], 161, 25);
        this.fmlBuffer[162] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[162], 162, 25);
        this.fmlBuffer[163] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, defaultValues[163], 163, 25);
        this.fmlBuffer[164] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, defaultValues[164], 164, 25);
        this.fmlBuffer[165] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, defaultValues[165], 165, 25);
        this.fmlBuffer[166] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, defaultValues[166], 166, 25);
        this.fmlBuffer[167] = new FmlField("P1", FmlField.TYPE_STRING, 21, defaultValues[167], 167, 25);
        this.fmlBuffer[168] = new FmlField("P2", FmlField.TYPE_STRING, 21, defaultValues[168], 168, 25);
        this.fmlBuffer[169] = new FmlField("P3", FmlField.TYPE_STRING, 21, defaultValues[169], 169, 25);
        this.fmlBuffer[170] = new FmlField("P4", FmlField.TYPE_STRING, 21, defaultValues[170], 170, 25);
        this.fmlBuffer[171] = new FmlField("P5", FmlField.TYPE_STRING, 21, defaultValues[171], 171, 25);
        this.fmlBuffer[172] = new FmlField("P6", FmlField.TYPE_STRING, 21, defaultValues[172], 172, 25);
        this.fmlBuffer[173] = new FmlField("P7", FmlField.TYPE_STRING, 21, defaultValues[173], 173, 25);
        this.fmlBuffer[174] = new FmlField("P8", FmlField.TYPE_STRING, 21, defaultValues[174], 174, 25);
        this.fmlBuffer[175] = new FmlField("P9", FmlField.TYPE_STRING, 21, defaultValues[175], 175, 25);
        this.fmlBuffer[176] = new FmlField("P10", FmlField.TYPE_STRING, 21, defaultValues[176], 176, 25);
        this.fmlBuffer[177] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[177], 177, 25);
        this.fmlBuffer[178] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, defaultValues[178], 178, 25);
        this.fmlBuffer[179] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[179], 179, 25);
        this.fmlBuffer[180] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, defaultValues[180], 180, 25);
        this.fmlBuffer[181] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, defaultValues[181], 181, 25);
        this.fmlBuffer[182] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, defaultValues[182], 182, 25);
        this.fmlBuffer[183] = new FmlField("PCTNRECROWID", FmlField.TYPE_STRING, 19, defaultValues[183], 183, 1);
        this.fmlBuffer[184] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, defaultValues[184], 184, 1);
        this.fmlBuffer[185] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, defaultValues[185], 185, 1);
        this.fmlBuffer[186] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[186], 186, 1);
        this.fmlBuffer[187] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[187], 187, 1);
        this.fmlBuffer[188] = new FmlField("PCTNRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, defaultValues[188], 188, 1);
        this.fmlBuffer[189] = new FmlField("PCTNRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, defaultValues[189], 189, 1);
        this.fmlBuffer[190] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, defaultValues[190], 190, 1);
        this.fmlBuffer[191] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[191], 191, 1);
        this.fmlBuffer[192] = new FmlField("PCTNRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, defaultValues[192], 192, 1);
        this.fmlBuffer[193] = new FmlField("INIT_ACTIVATION_DATE", FmlField.TYPE_STRING, 9, defaultValues[193], 193, 1);
        this.fmlBuffer[194] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[194], 194, 1);
        this.fmlBuffer[195] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, defaultValues[195], 195, 1);
        this.fmlBuffer[196] = new FmlField("ORIGINAL_INIT_DATE", FmlField.TYPE_STRING, 15, defaultValues[196], 196, 1);
        this.fmlBuffer[197] = new FmlField("SUB_STATUS_LAST_ACT", FmlField.TYPE_STRING, 4, defaultValues[197], 197, 1);
        this.fmlBuffer[198] = new FmlField("SUB_STATUS_RSN_CODE", FmlField.TYPE_STRING, 5, defaultValues[198], 198, 1);
        this.fmlBuffer[199] = new FmlField("PCTNRECPRODUCT_TYPE", FmlField.TYPE_STRING, 4, defaultValues[199], 199, 1);
        this.fmlBuffer[200] = new FmlField("CUSTOMER_BAN", FmlField.TYPE_INTEGER, -1, defaultValues[200], 200, 1);
        this.fmlBuffer[201] = new FmlField("CTN_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[201], 201, 1);
        this.fmlBuffer[202] = new FmlField("REQ_ST_GRACE_PERIOD", FmlField.TYPE_STRING, 9, defaultValues[202], 202, 1);
        this.fmlBuffer[203] = new FmlField("REQ_END_GRACE_PERIOD", FmlField.TYPE_STRING, 9, defaultValues[203], 203, 1);
        this.fmlBuffer[204] = new FmlField("COMMIT_START_DATE", FmlField.TYPE_STRING, 9, defaultValues[204], 204, 1);
        this.fmlBuffer[205] = new FmlField("COMMIT_END_DATE", FmlField.TYPE_STRING, 9, defaultValues[205], 205, 1);
        this.fmlBuffer[206] = new FmlField("COMMIT_REASON_CODE", FmlField.TYPE_STRING, 4, defaultValues[206], 206, 1);
        this.fmlBuffer[207] = new FmlField("PCTNRECCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, defaultValues[207], 207, 1);
        this.fmlBuffer[208] = new FmlField("PCTNRECSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[208], 208, 1);
        this.fmlBuffer[209] = new FmlField("CONTRACT_NO", FmlField.TYPE_STRING, 11, defaultValues[209], 209, 1);
        this.fmlBuffer[210] = new FmlField("CNT_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[210], 210, 1);
        this.fmlBuffer[211] = new FmlField("PCTNRECDEALER_CODE", FmlField.TYPE_STRING, 6, defaultValues[211], 211, 1);
        this.fmlBuffer[212] = new FmlField("ORG_DEALER_CODE", FmlField.TYPE_STRING, 6, defaultValues[212], 212, 1);
        this.fmlBuffer[213] = new FmlField("PCTNRECSALES_AGENT", FmlField.TYPE_STRING, 6, defaultValues[213], 213, 1);
        this.fmlBuffer[214] = new FmlField("ORG_SALES_AGENT", FmlField.TYPE_STRING, 6, defaultValues[214], 214, 1);
        this.fmlBuffer[215] = new FmlField("REQ_DEPOSIT_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[215], 215, 1);
        this.fmlBuffer[216] = new FmlField("LEADING_NUMBER", FmlField.TYPE_STRING, 21, defaultValues[216], 216, 1);
        this.fmlBuffer[217] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, defaultValues[217], 217, 1);
        this.fmlBuffer[218] = new FmlField("NEXT_CTN", FmlField.TYPE_STRING, 21, defaultValues[218], 218, 1);
        this.fmlBuffer[219] = new FmlField("NEXT_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, defaultValues[219], 219, 1);
        this.fmlBuffer[220] = new FmlField("PRV_CTN", FmlField.TYPE_STRING, 21, defaultValues[220], 220, 1);
        this.fmlBuffer[221] = new FmlField("PRV_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, defaultValues[221], 221, 1);
        this.fmlBuffer[222] = new FmlField("NEXT_BAN", FmlField.TYPE_INTEGER, -1, defaultValues[222], 222, 1);
        this.fmlBuffer[223] = new FmlField("NEXT_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[223], 223, 1);
        this.fmlBuffer[224] = new FmlField("PRV_BAN", FmlField.TYPE_INTEGER, -1, defaultValues[224], 224, 1);
        this.fmlBuffer[225] = new FmlField("PRV_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[225], 225, 1);
        this.fmlBuffer[226] = new FmlField("SUB_STS_ISSUE_DATE", FmlField.TYPE_STRING, 9, defaultValues[226], 226, 1);
        this.fmlBuffer[227] = new FmlField("ACTIVATE_WAIVE_RSN", FmlField.TYPE_STRING, 7, defaultValues[227], 227, 1);
        this.fmlBuffer[228] = new FmlField("EARLIEST_ACTV_DATE", FmlField.TYPE_STRING, 9, defaultValues[228], 228, 1);
        this.fmlBuffer[229] = new FmlField("SUB_ACTV_LOCATION", FmlField.TYPE_STRING, 5, defaultValues[229], 229, 1);
        this.fmlBuffer[230] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, defaultValues[230], 230, 1);
        this.fmlBuffer[231] = new FmlField("CUST_WATCH_DATE", FmlField.TYPE_STRING, 9, defaultValues[231], 231, 1);
        this.fmlBuffer[232] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, defaultValues[232], 232, 1);
        this.fmlBuffer[233] = new FmlField("CREDIT_WATCH_PIN_CD", FmlField.TYPE_SHORT, -1, defaultValues[233], 233, 1);
        this.fmlBuffer[234] = new FmlField("SUB_MARKET_CODE", FmlField.TYPE_STRING, 4, defaultValues[234], 234, 1);
        this.fmlBuffer[235] = new FmlField("LIMIT_RESERVED_DAYS", FmlField.TYPE_SHORT, -1, defaultValues[235], 235, 1);
        this.fmlBuffer[236] = new FmlField("FF_EXPIRATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[236], 236, 1);
        this.fmlBuffer[237] = new FmlField("FLEX_IND", FmlField.TYPE_BYTE, -1, defaultValues[237], 237, 1);
        this.fmlBuffer[238] = new FmlField("DUO_IND", FmlField.TYPE_BYTE, -1, defaultValues[238], 238, 1);
        this.fmlBuffer[239] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, defaultValues[239], 239, 1);
        this.fmlBuffer[240] = new FmlField("SUB_DEPARTMENT_CD", FmlField.TYPE_STRING, 5, defaultValues[240], 240, 1);
        this.fmlBuffer[241] = new FmlField("LAST_SUBS_DISC_DT", FmlField.TYPE_STRING, 9, defaultValues[241], 241, 1);
        this.fmlBuffer[242] = new FmlField("LAST_SUBS_DISC_DT_UD", FmlField.TYPE_STRING, 9, defaultValues[242], 242, 1);
        this.fmlBuffer[243] = new FmlField("LAST_SUBSCR_DISC_SN", FmlField.TYPE_SHORT, -1, defaultValues[243], 243, 1);
        this.fmlBuffer[244] = new FmlField("LAST_SUBSCR_DISC_SN_UD", FmlField.TYPE_SHORT, -1, defaultValues[244], 244, 1);
        this.fmlBuffer[245] = new FmlField("PNI", FmlField.TYPE_STRING, 11, defaultValues[245], 245, 1);
        this.fmlBuffer[246] = new FmlField("RMS_REF_STORE_ID", FmlField.TYPE_STRING, 5, defaultValues[246], 246, 1);
        this.fmlBuffer[247] = new FmlField("RMS_REF_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[247], 247, 1);
        this.fmlBuffer[248] = new FmlField("RMS_REF_OD", FmlField.TYPE_INTEGER, -1, defaultValues[248], 248, 1);
        this.fmlBuffer[249] = new FmlField("DLR_ACT_FEE", FmlField.TYPE_DOUBLE, -1, defaultValues[249], 249, 1);
        this.fmlBuffer[250] = new FmlField("PREP_AMOUNT", FmlField.TYPE_DOUBLE, -1, defaultValues[250], 250, 1);
        this.fmlBuffer[251] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, defaultValues[251], 251, 1);
        this.fmlBuffer[252] = new FmlField("SUB_LANG", FmlField.TYPE_STRING, 3, defaultValues[252], 252, 1);
        this.fmlBuffer[253] = new FmlField("SMS_RCV_STYLE_CODE", FmlField.TYPE_STRING, 3, defaultValues[253], 253, 1);
        this.fmlBuffer[254] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, defaultValues[254], 254, 1);
        this.fmlBuffer[255] = new FmlField("ALLOW_ADVERTISING_IND", FmlField.TYPE_BYTE, -1, defaultValues[255], 255, 1);
        this.fmlBuffer[256] = new FmlField("IVR_WRONG_ACCESS_NO", FmlField.TYPE_SHORT, -1, defaultValues[256], 256, 1);
        this.fmlBuffer[257] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[257], 257, 1);
        this.fmlBuffer[258] = new FmlField("PUBLISH_LEVEL", FmlField.TYPE_STRING, 31, defaultValues[258], 258, 1);
        this.fmlBuffer[259] = new FmlField("AUTO_RELEASE_IND", FmlField.TYPE_BYTE, -1, defaultValues[259], 259, 1);
        this.fmlBuffer[260] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, defaultValues[260], 260, 1);
        this.fmlBuffer[261] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, defaultValues[261], 261, 1);
        this.fmlBuffer[262] = new FmlField("OPERATOR_CW_LMT", FmlField.TYPE_DOUBLE, -1, defaultValues[262], 262, 1);
        this.fmlBuffer[263] = new FmlField("SEND_SMS_FOR_MATCH", FmlField.TYPE_BYTE, -1, defaultValues[263], 263, 1);
        this.fmlBuffer[264] = new FmlField("CPS_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[264], 264, 1);
        this.fmlBuffer[265] = new FmlField("CPS_TRANSACTION", FmlField.TYPE_SHORT, -1, defaultValues[265], 265, 1);
        this.fmlBuffer[266] = new FmlField("CPS_TYPE", FmlField.TYPE_SHORT, -1, defaultValues[266], 266, 1);
        this.fmlBuffer[267] = new FmlField("ISP_PASS", FmlField.TYPE_STRING, 31, defaultValues[267], 267, 1);
        this.fmlBuffer[268] = new FmlField("ISP_TYPE", FmlField.TYPE_STRING, 3, defaultValues[268], 268, 1);
        this.fmlBuffer[269] = new FmlField("OPERATOR_TMP_DATE", FmlField.TYPE_STRING, 9, defaultValues[269], 269, 1);
        this.fmlBuffer[270] = new FmlField("OPERATOR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, defaultValues[270], 270, 1);
        this.fmlBuffer[271] = new FmlField("SUB_ORG_CD", FmlField.TYPE_STRING, 11, defaultValues[271], 271, 1);
        this.fmlBuffer[272] = new FmlField("ORG_MEMBER_NO", FmlField.TYPE_STRING, 21, defaultValues[272], 272, 1);
        this.fmlBuffer[273] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[273], 273, 1);
        this.fmlBuffer[274] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, defaultValues[274], 274, 20);
        this.fmlBuffer[275] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, defaultValues[275], 275, 20);
        this.fmlBuffer[276] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, defaultValues[276], 276, 20);
        this.fmlBuffer[277] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, defaultValues[277], 277, 20);
        this.fmlBuffer[278] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[278], 278, 20);
        this.fmlBuffer[279] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, defaultValues[279], 279, 20);
        this.fmlBuffer[280] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, defaultValues[280], 280, 20);
        this.fmlBuffer[281] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, defaultValues[281], 281, 20);
        this.fmlBuffer[282] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[282], 282, 20);
        this.fmlBuffer[283] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[283], 283, 20);
        this.fmlBuffer[284] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[284], 284, 20);
        this.fmlBuffer[285] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, defaultValues[285], 285, 20);
        this.fmlBuffer[286] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, defaultValues[286], 286, 20);
        this.fmlBuffer[287] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, defaultValues[287], 287, 20);
        this.fmlBuffer[288] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, defaultValues[288], 288, 20);
        this.fmlBuffer[289] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, defaultValues[289], 289, 20);
        this.fmlBuffer[290] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, defaultValues[290], 290, 20);
        this.fmlBuffer[291] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, defaultValues[291], 291, 20);
        this.fmlBuffer[292] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[292], 292, 20);
        this.fmlBuffer[293] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, defaultValues[293], 293, 20);
        this.fmlBuffer[294] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, defaultValues[294], 294, 20);
        this.fmlBuffer[295] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, defaultValues[295], 295, 20);
        this.fmlBuffer[296] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[296], 296, 20);
        this.fmlBuffer[297] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[297], 297, 20);
        this.fmlBuffer[298] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, defaultValues[298], 298, 20);
        this.fmlBuffer[299] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, defaultValues[299], 299, 20);
        this.fmlBuffer[300] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, defaultValues[300], 300, 20);
        this.fmlBuffer[301] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[301], 301, 20);
        this.fmlBuffer[302] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, defaultValues[302], 302, 20);
        this.fmlBuffer[303] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, defaultValues[303], 303, 20);
        this.fmlBuffer[304] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, defaultValues[304], 304, 20);
        this.fmlBuffer[305] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, defaultValues[305], 305, 20);
        this.fmlBuffer[306] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, defaultValues[306], 306, 20);
        this.fmlBuffer[307] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, defaultValues[307], 307, 20);
        this.fmlBuffer[308] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, defaultValues[308], 308, 20);
        this.fmlBuffer[309] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, defaultValues[309], 309, 20);
        this.fmlBuffer[310] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, defaultValues[310], 310, 20);
        this.fmlBuffer[311] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, defaultValues[311], 311, 20);
        this.fmlBuffer[312] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, defaultValues[312], 312, 20);
        this.fmlBuffer[313] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, defaultValues[313], 313, 20);
        this.fmlBuffer[314] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, defaultValues[314], 314, 20);
        this.fmlBuffer[315] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, defaultValues[315], 315, 20);
        this.fmlBuffer[316] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, defaultValues[316], 316, 20);
        this.fmlBuffer[317] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, defaultValues[317], 317, 20);
        this.fmlBuffer[318] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, defaultValues[318], 318, 20);
        this.fmlBuffer[319] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, defaultValues[319], 319, 20);
        this.fmlBuffer[320] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, defaultValues[320], 320, 20);
        this.fmlBuffer[321] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[321], 321, 20);
        this.fmlBuffer[322] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, defaultValues[322], 322, 20);
        this.fmlBuffer[323] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, defaultValues[323], 323, 20);
        this.fmlBuffer[324] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, defaultValues[324], 324, 20);
        this.fmlBuffer[325] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[325], 325, 20);
        this.fmlBuffer[326] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[326], 326, 20);
        this.fmlBuffer[327] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, defaultValues[327], 327, 20);
        this.fmlBuffer[328] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, defaultValues[328], 328, 20);
        this.fmlBuffer[329] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, defaultValues[329], 329, 20);
        this.fmlBuffer[330] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[330], 330, 20);
        this.fmlBuffer[331] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[331], 331, 20);
        this.fmlBuffer[332] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[332], 332, 20);
        this.fmlBuffer[333] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, defaultValues[333], 333, 20);
        this.fmlBuffer[334] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, defaultValues[334], 334, 20);
        this.fmlBuffer[335] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, defaultValues[335], 335, 20);
        this.fmlBuffer[336] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, defaultValues[336], 336, 20);
        this.fmlBuffer[337] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, defaultValues[337], 337, 20);
        this.fmlBuffer[338] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, defaultValues[338], 338, 20);
        this.fmlBuffer[339] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, defaultValues[339], 339, 20);
        this.fmlBuffer[340] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, defaultValues[340], 340, 20);
        this.fmlBuffer[341] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, defaultValues[341], 341, 20);
        this.fmlBuffer[342] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, defaultValues[342], 342, 20);
        this.fmlBuffer[343] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, defaultValues[343], 343, 20);
        this.fmlBuffer[344] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, defaultValues[344], 344, 20);
        this.fmlBuffer[345] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, defaultValues[345], 345, 20);
        this.fmlBuffer[346] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, defaultValues[346], 346, 20);
        this.fmlBuffer[347] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, defaultValues[347], 347, 20);
        this.fmlBuffer[348] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, defaultValues[348], 348, 20);
        this.fmlBuffer[349] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, defaultValues[349], 349, 20);
        this.fmlBuffer[350] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, defaultValues[350], 350, 20);
        this.fmlBuffer[351] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, defaultValues[351], 351, 20);
        this.fmlBuffer[352] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, defaultValues[352], 352, 20);
        this.fmlBuffer[353] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, defaultValues[353], 353, 20);
        this.fmlBuffer[354] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, defaultValues[354], 354, 20);
        this.fmlBuffer[355] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, defaultValues[355], 355, 20);
        this.fmlBuffer[356] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, defaultValues[356], 356, 20);
        this.fmlBuffer[357] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, defaultValues[357], 357, 20);
        this.fmlBuffer[358] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, defaultValues[358], 358, 20);
        this.fmlBuffer[359] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, defaultValues[359], 359, 20);
        this.fmlBuffer[360] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, defaultValues[360], 360, 20);
        this.fmlBuffer[361] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, defaultValues[361], 361, 20);
        this.fmlBuffer[362] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, defaultValues[362], 362, 20);
        this.fmlBuffer[363] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, defaultValues[363], 363, 20);
        this.fmlBuffer[364] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, defaultValues[364], 364, 20);
        this.fmlBuffer[365] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, defaultValues[365], 365, 20);
        this.fmlBuffer[366] = new FmlField("PINSTLBUFROW_COUNT", FmlField.TYPE_INTEGER, -1, defaultValues[366], 366, 1);
        this.fmlBuffer[367] = new FmlField("INSTALLMENT_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[367], 367, 12);
        this.fmlBuffer[368] = new FmlField("INSTALLMENT_DATE", FmlField.TYPE_STRING, 9, defaultValues[368], 368, 12);
        this.fmlBuffer[369] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[369], 369, 1);
        this.fmlBuffer[370] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[370], 370, 2);
        this.fmlBuffer[371] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, defaultValues[371], 371, 2);
        this.fmlBuffer[372] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, defaultValues[372], 372, 1);
        this.fmlBuffer[373] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, defaultValues[373], 373, 1);
        this.fmlBuffer[374] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, defaultValues[374], 374, 1);
        this.fmlBuffer[375] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, defaultValues[375], 375, 1);
        this.fmlBuffer[376] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, defaultValues[376], 376, 1);
        this.fmlBuffer[377] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, defaultValues[377], 377, 1);
        this.fmlBuffer[378] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[378], 378, 1);
        this.fmlBuffer[379] = new FmlField("PARINPBAN", FmlField.TYPE_INTEGER, -1, defaultValues[379], 379, 1);
        this.fmlBuffer[380] = new FmlField("PARTITION_ROOT_BAN", FmlField.TYPE_INTEGER, -1, defaultValues[380], 380, 1);
        this.fmlBuffer[381] = new FmlField("PARINPSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, defaultValues[381], 381, 1);
        this.fmlBuffer[382] = new FmlField("PARINPSUB_MARKET_CODE", FmlField.TYPE_STRING, 4, defaultValues[382], 382, 1);
        this.fmlBuffer[383] = new FmlField("REQUIREMENT_DATE", FmlField.TYPE_STRING, 9, defaultValues[383], 383, 1);
        this.fmlBuffer[384] = new FmlField("ACTIVATION_AMOUNT", FmlField.TYPE_DOUBLE, -1, defaultValues[384], 384, 1);
        this.fmlBuffer[385] = new FmlField("PREPAYMENT_AMOUNT", FmlField.TYPE_DOUBLE, -1, defaultValues[385], 385, 1);
        this.fmlBuffer[386] = new FmlField("PREP_ACTV_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[386], 386, 1);
        this.fmlBuffer[387] = new FmlField("RC_ONLY_IND", FmlField.TYPE_BYTE, -1, defaultValues[387], 387, 1);
        this.fmlBuffer[388] = new FmlField("PARINPDEALER_CODE", FmlField.TYPE_STRING, 6, defaultValues[388], 388, 1);
        this.fmlBuffer[389] = new FmlField("ACTV_EXMP_IND", FmlField.TYPE_BYTE, -1, defaultValues[389], 389, 1);
        this.fmlBuffer[390] = new FmlField("PREP_EXMP_IND", FmlField.TYPE_BYTE, -1, defaultValues[390], 390, 1);
        this.fmlBuffer[391] = new FmlField("SOURCE_APPL_CODE", FmlField.TYPE_BYTE, -1, defaultValues[391], 391, 1);
        this.fmlBuffer[392] = new FmlField("PARINPFEATURE_CODE", FmlField.TYPE_STRING, 7, defaultValues[392], 392, 1);
        this.fmlBuffer[393] = new FmlField("PARINPSOC", FmlField.TYPE_STRING, 10, defaultValues[393], 393, 1);
        this.fmlBuffer[394] = new FmlField("SOC_DATE", FmlField.TYPE_STRING, 9, defaultValues[394], 394, 1);
        this.fmlBuffer[395] = new FmlField("CAS_PT_REQ", FmlField.TYPE_BYTE, -1, defaultValues[395], 395, 1);
    }
    ...
    public void set_COMMIT_ORIG_NO_MONTH(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[41].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_PSOCFTRBUFCAMPAIGN_SEQ(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[92].getValue(nIndex));
    }
    ...
    public Integer get_PCSFRNDFMLROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[101].getValue(0));
    }
    ...
    public Double get_DURATION(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[112].getValue(nIndex));
    }
    ...
    public Integer get_PESNBUFFERROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[113].getValue(0));
    }
    ...
    public Integer get_PHD_SEQ_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[115].getValue(nIndex));
    }
    ...
    public Integer get_EQUIPMENT_LEVEL(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[116].getValue(nIndex)));
    }
    ...
    public void set_EQUIPMENT_LEVEL(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[116].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public void set_SW_STATE_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[121].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_NEXT_ACTV_CODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[123].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_MISSING_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[138].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PUK(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[149].getValue(nIndex));
    }
    ...
    public Integer get_ROW_COUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[159].getValue(0));
    }
    ...
    public void set_MEMO_SOURCE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[165].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_MEMO_AMT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[177].getValue(nIndex));
    }
    ...
    public void set_WAIVE_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[182].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PNAMEADRBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[273].getValue(0));
    }
    ...
    public String get_LINK_MODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[274].getValue(nIndex)));
    }
    ...
    public void set_LINK_MODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[274].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_BAN(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[280].getValue(nIndex));
    }
    ...
    public String get_LINK_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[282].getValue(nIndex)));
    }
    ...
    public void set_LINK_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[282].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_NAME_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[295].getValue(nIndex));
    }
    ...
    public Integer get_NAMERECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[298].getValue(nIndex));
    }
    ...
    public Integer get_NAMERECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[301].getValue(nIndex)));
    }
    ...
    public void set_NAMERECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[301].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public void set_NAME_FORMAT(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[306].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_KOB(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[311].getValue(nIndex));
    }
    ...
    public Integer get_NAMERECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[314].getValue(nIndex)));
    }
    ...
    public void set_NAMERECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[314].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_ADDRESS_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[324].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[327].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[330].getValue(nIndex)));
    }
    ...
    public void set_ADDRESSRECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[330].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public String get_ADR_STATUS(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[332].getValue(nIndex)));
    }
    ...
    public void set_ADR_STATUS(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[332].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_ADDRESSRECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[350].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_PINSTLBUFROW_COUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[366].getValue(0));
    }
    ...
    public Double get_INSTALLMENT_AMT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[367].getValue(nIndex));
    }
    ...
    public Integer get_PFTRDEPBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[369].getValue(0));
    }
    ...
    public String get_DEPOSIT_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[370].getValue(nIndex)));
    }
    ...
    public void set_DEPOSIT_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[370].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_DEPOSIT_AMOUNT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[371].getValue(nIndex));
    }
    ...
    /**
     * Retrieves the value of the 'PARINPBAN' field in the FML buffer.
     *
     * @return Value of 'PARINPBAN' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PARINPBAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[379].getValue(0));
    }

    /**
     * Sets the value of the 'PARINPBAN' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PARINPBAN(Integer value) throws FMLManipulationException {
    ...
    public Integer get_PARTITION_ROOT_BAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[380].getValue(0));
    }
    ...
    public void set_PARTITION_ROOT_BAN(Integer value) throws FMLManipulationException {
        this.fmlBuffer[380].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PARINPSUBSCRIBER_NO' field in the FML buffer.
     *
     * @return Value of 'PARINPSUBSCRIBER_NO' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PARINPSUBSCRIBER_NO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[381].getValue(0));
    }

    /**
     * Sets the value of the 'PARINPSUBSCRIBER_NO' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 21.
     * @throws FMLManipulationException
     */
    public void set_PARINPSUBSCRIBER_NO(String value) throws FMLManipulationException {
        this.fmlBuffer[381].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PARINPSUB_MARKET_CODE' field in the FML buffer.
     *
     * @return Value of 'PARINPSUB_MARKET_CODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PARINPSUB_MARKET_CODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[382].getValue(0));
    }

    /**
     * Sets the value of the 'PARINPSUB_MARKET_CODE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 4.
     * @throws FMLManipulationException
     */
    public void set_PARINPSUB_MARKET_CODE(String value) throws FMLManipulationException {
        this.fmlBuffer[382].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'REQUIREMENT_DATE' field in the FML buffer.
     *
     * @return Value of 'REQUIREMENT_DATE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_REQUIREMENT_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[383].getValue(0));
    }

    /**
     * Sets the value of the 'REQUIREMENT_DATE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 9.
     * @throws FMLManipulationException
     */
    public void set_REQUIREMENT_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[383].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'ACTIVATION_AMOUNT' field in the FML buffer.
     *
     * @return Value of 'ACTIVATION_AMOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Double get_ACTIVATION_AMOUNT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[384].getValue(0));
    }

    /**
     * Sets the value of the 'ACTIVATION_AMOUNT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_ACTIVATION_AMOUNT(Double value) throws FMLManipulationException {
        this.fmlBuffer[384].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PREPAYMENT_AMOUNT' field in the FML buffer.
     *
     * @return Value of 'PREPAYMENT_AMOUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Double get_PREPAYMENT_AMOUNT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[385].getValue(0));
    }

    /**
     * Sets the value of the 'PREPAYMENT_AMOUNT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PREPAYMENT_AMOUNT(Double value) throws FMLManipulationException {
        this.fmlBuffer[385].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PREP_ACTV_AMT' field in the FML buffer.
     *
     * @return Value of 'PREP_ACTV_AMT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Double get_PREP_ACTV_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[386].getValue(0));
    }

    /**
     * Sets the value of the 'PREP_ACTV_AMT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PREP_ACTV_AMT(Double value) throws FMLManipulationException {
        this.fmlBuffer[386].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'RC_ONLY_IND' field in the FML buffer.
     *
     * @return Value of 'RC_ONLY_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_RC_ONLY_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[387].getValue(0)));
    }

    /**
     * Sets the value of the 'RC_ONLY_IND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_RC_ONLY_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[387].setValue(0, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves the value of the 'PARINPDEALER_CODE' field in the FML buffer.
     *
     * @return Value of 'PARINPDEALER_CODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PARINPDEALER_CODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[388].getValue(0));
    }

    /**
     * Sets the value of the 'PARINPDEALER_CODE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 6.
     * @throws FMLManipulationException
     */
    public void set_PARINPDEALER_CODE(String value) throws FMLManipulationException {
        this.fmlBuffer[388].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'ACTV_EXMP_IND' field in the FML buffer.
     *
     * @return Value of 'ACTV_EXMP_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_ACTV_EXMP_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[389].getValue(0)));
    }

    /**
     * Sets the value of the 'ACTV_EXMP_IND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_ACTV_EXMP_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[389].setValue(0, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves the value of the 'PREP_EXMP_IND' field in the FML buffer.
     *
     * @return Value of 'PREP_EXMP_IND' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PREP_EXMP_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[390].getValue(0)));
    }

    /**
     * Sets the value of the 'PREP_EXMP_IND' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PREP_EXMP_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[390].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_SOURCE_APPL_CODE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[391].getValue(0)));
    }
    ...
    public void set_SOURCE_APPL_CODE(String value) throws FMLManipulationException {
        this.fmlBuffer[391].setValue(0, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves the value of the 'PARINPFEATURE_CODE' field in the FML buffer.
     *
     * @return Value of 'PARINPFEATURE_CODE' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PARINPFEATURE_CODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[392].getValue(0));
    }

    /**
     * Sets the value of the 'PARINPFEATURE_CODE' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 7.
     * @throws FMLManipulationException
     */
    public void set_PARINPFEATURE_CODE(String value) throws FMLManipulationException {
        this.fmlBuffer[392].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'PARINPSOC' field in the FML buffer.
     *
     * @return Value of 'PARINPSOC' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_PARINPSOC() throws FMLManipulationException {
        return ((String) this.fmlBuffer[393].getValue(0));
    }

    /**
     * Sets the value of the 'PARINPSOC' field in the FML buffer.
     *
     * @param value Default value: null, Maximum length: 10.
     * @throws FMLManipulationException
     */
    public void set_PARINPSOC(String value) throws FMLManipulationException {
        this.fmlBuffer[393].setValue(0, value);
    }
    ...
    public String get_SOC_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[394].getValue(0));
    }
    ...
    public void set_SOC_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[394].setValue(0, value);
    }

    /**
     * Retrieves the value of the 'CAS_PT_REQ' field in the FML buffer.
     *
     * @return Value of 'CAS_PT_REQ' field in FML buffer.
     * @throws FMLManipulationException
     */
    public String get_CAS_PT_REQ() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[395].getValue(0)));
    }

    /**
     * Sets the value of the 'CAS_PT_REQ' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_CAS_PT_REQ(String value) throws FMLManipulationException {
        this.fmlBuffer[395].setValue(0, TypeConverter.stringToByte(value));
    }
}