...
public class CsCrCtnInput extends ServiceInput {
    ...
    public CsCrCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[159] = new FmlField("ACT_CODE", FmlField.TYPE_STRING, 4, defaultValues[159], 159, 1);
        this.fmlBuffer[160] = new FmlField("ACT_REASON", FmlField.TYPE_STRING, 5, defaultValues[160], 160, 1);
        this.fmlBuffer[161] = new FmlField("SUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[161], 161, 1);
        this.fmlBuffer[162] = new FmlField("MEMO_CTN", FmlField.TYPE_STRING, 21, defaultValues[162], 162, 1);
        this.fmlBuffer[163] = new FmlField("USER_TEXT", FmlField.TYPE_STRING, 2001, defaultValues[163], 163, 1);
        this.fmlBuffer[164] = new FmlField("MEMO_SOURCE", FmlField.TYPE_BYTE, -1, defaultValues[164], 164, 1);
        this.fmlBuffer[165] = new FmlField("PARAM_COUNT", FmlField.TYPE_INTEGER, -1, defaultValues[165], 165, 1);
        this.fmlBuffer[166] = new FmlField("P1", FmlField.TYPE_STRING, 21, defaultValues[166], 166, 1);
        this.fmlBuffer[167] = new FmlField("P2", FmlField.TYPE_STRING, 21, defaultValues[167], 167, 1);
        this.fmlBuffer[168] = new FmlField("P3", FmlField.TYPE_STRING, 21, defaultValues[168], 168, 1);
        this.fmlBuffer[169] = new FmlField("P4", FmlField.TYPE_STRING, 21, defaultValues[169], 169, 1);
        this.fmlBuffer[170] = new FmlField("P5", FmlField.TYPE_STRING, 21, defaultValues[170], 170, 1);
        this.fmlBuffer[171] = new FmlField("P6", FmlField.TYPE_STRING, 21, defaultValues[171], 171, 1);
        this.fmlBuffer[172] = new FmlField("P7", FmlField.TYPE_STRING, 21, defaultValues[172], 172, 1);
        this.fmlBuffer[173] = new FmlField("P8", FmlField.TYPE_STRING, 21, defaultValues[173], 173, 1);
        this.fmlBuffer[174] = new FmlField("P9", FmlField.TYPE_STRING, 21, defaultValues[174], 174, 1);
        this.fmlBuffer[175] = new FmlField("P10", FmlField.TYPE_STRING, 21, defaultValues[175], 175, 1);
        this.fmlBuffer[176] = new FmlField("MEMO_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[176], 176, 1);
        this.fmlBuffer[177] = new FmlField("RMS_ACT_CODE", FmlField.TYPE_STRING, 5, defaultValues[177], 177, 1);
        this.fmlBuffer[178] = new FmlField("CHARGE_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[178], 178, 1);
        this.fmlBuffer[179] = new FmlField("CHARGE_AMT_IND", FmlField.TYPE_BYTE, -1, defaultValues[179], 179, 1);
        this.fmlBuffer[180] = new FmlField("WAIVE_REASON", FmlField.TYPE_STRING, 7, defaultValues[180], 180, 1);
        this.fmlBuffer[181] = new FmlField("WAIVE_IND", FmlField.TYPE_BYTE, -1, defaultValues[181], 181, 1);
        this.fmlBuffer[182] = new FmlField("PCTNRECROWID", FmlField.TYPE_STRING, 19, defaultValues[182], 182, 1);
        this.fmlBuffer[183] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, defaultValues[183], 183, 1);
        this.fmlBuffer[184] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, defaultValues[184], 184, 1);
        this.fmlBuffer[185] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[185], 185, 1);
        this.fmlBuffer[186] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[186], 186, 1);
        this.fmlBuffer[187] = new FmlField("PCTNRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, defaultValues[187], 187, 1);
        this.fmlBuffer[188] = new FmlField("PCTNRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, defaultValues[188], 188, 1);
        this.fmlBuffer[189] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, defaultValues[189], 189, 1);
        this.fmlBuffer[190] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[190], 190, 1);
        this.fmlBuffer[191] = new FmlField("PCTNRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, defaultValues[191], 191, 1);
        this.fmlBuffer[192] = new FmlField("INIT_ACTIVATION_DATE", FmlField.TYPE_STRING, 9, defaultValues[192], 192, 1);
        this.fmlBuffer[193] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[193], 193, 1);
        this.fmlBuffer[194] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, defaultValues[194], 194, 1);
        this.fmlBuffer[195] = new FmlField("ORIGINAL_INIT_DATE", FmlField.TYPE_STRING, 15, defaultValues[195], 195, 1);
        this.fmlBuffer[196] = new FmlField("SUB_STATUS_LAST_ACT", FmlField.TYPE_STRING, 4, defaultValues[196], 196, 1);
        this.fmlBuffer[197] = new FmlField("SUB_STATUS_RSN_CODE", FmlField.TYPE_STRING, 5, defaultValues[197], 197, 1);
        this.fmlBuffer[198] = new FmlField("PCTNRECPRODUCT_TYPE", FmlField.TYPE_STRING, 4, defaultValues[198], 198, 1);
        this.fmlBuffer[199] = new FmlField("CUSTOMER_BAN", FmlField.TYPE_INTEGER, -1, defaultValues[199], 199, 1);
        this.fmlBuffer[200] = new FmlField("CTN_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[200], 200, 1);
        this.fmlBuffer[201] = new FmlField("REQ_ST_GRACE_PERIOD", FmlField.TYPE_STRING, 9, defaultValues[201], 201, 1);
        this.fmlBuffer[202] = new FmlField("REQ_END_GRACE_PERIOD", FmlField.TYPE_STRING, 9, defaultValues[202], 202, 1);
        this.fmlBuffer[203] = new FmlField("COMMIT_START_DATE", FmlField.TYPE_STRING, 9, defaultValues[203], 203, 1);
        this.fmlBuffer[204] = new FmlField("COMMIT_END_DATE", FmlField.TYPE_STRING, 9, defaultValues[204], 204, 1);
        this.fmlBuffer[205] = new FmlField("COMMIT_REASON_CODE", FmlField.TYPE_STRING, 4, defaultValues[205], 205, 1);
        this.fmlBuffer[206] = new FmlField("PCTNRECCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, defaultValues[206], 206, 1);
        this.fmlBuffer[207] = new FmlField("PCTNRECSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[207], 207, 1);
        this.fmlBuffer[208] = new FmlField("CONTRACT_NO", FmlField.TYPE_STRING, 11, defaultValues[208], 208, 1);
        this.fmlBuffer[209] = new FmlField("CNT_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[209], 209, 1);
        this.fmlBuffer[210] = new FmlField("PCTNRECDEALER_CODE", FmlField.TYPE_STRING, 6, defaultValues[210], 210, 1);
        this.fmlBuffer[211] = new FmlField("ORG_DEALER_CODE", FmlField.TYPE_STRING, 6, defaultValues[211], 211, 1);
        this.fmlBuffer[212] = new FmlField("PCTNRECSALES_AGENT", FmlField.TYPE_STRING, 6, defaultValues[212], 212, 1);
        this.fmlBuffer[213] = new FmlField("ORG_SALES_AGENT", FmlField.TYPE_STRING, 6, defaultValues[213], 213, 1);
        this.fmlBuffer[214] = new FmlField("REQ_DEPOSIT_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[214], 214, 1);
        this.fmlBuffer[215] = new FmlField("LEADING_NUMBER", FmlField.TYPE_STRING, 21, defaultValues[215], 215, 1);
        this.fmlBuffer[216] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, defaultValues[216], 216, 1);
        this.fmlBuffer[217] = new FmlField("NEXT_CTN", FmlField.TYPE_STRING, 21, defaultValues[217], 217, 1);
        this.fmlBuffer[218] = new FmlField("NEXT_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, defaultValues[218], 218, 1);
        this.fmlBuffer[219] = new FmlField("PRV_CTN", FmlField.TYPE_STRING, 21, defaultValues[219], 219, 1);
        this.fmlBuffer[220] = new FmlField("PRV_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, defaultValues[220], 220, 1);
        this.fmlBuffer[221] = new FmlField("NEXT_BAN", FmlField.TYPE_INTEGER, -1, defaultValues[221], 221, 1);
        this.fmlBuffer[222] = new FmlField("NEXT_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[222], 222, 1);
        this.fmlBuffer[223] = new FmlField("PRV_BAN", FmlField.TYPE_INTEGER, -1, defaultValues[223], 223, 1);
        this.fmlBuffer[224] = new FmlField("PRV_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[224], 224, 1);
        this.fmlBuffer[225] = new FmlField("SUB_STS_ISSUE_DATE", FmlField.TYPE_STRING, 9, defaultValues[225], 225, 1);
        this.fmlBuffer[226] = new FmlField("ACTIVATE_WAIVE_RSN", FmlField.TYPE_STRING, 7, defaultValues[226], 226, 1);
        this.fmlBuffer[227] = new FmlField("EARLIEST_ACTV_DATE", FmlField.TYPE_STRING, 9, defaultValues[227], 227, 1);
        this.fmlBuffer[228] = new FmlField("SUB_ACTV_LOCATION", FmlField.TYPE_STRING, 5, defaultValues[228], 228, 1);
        this.fmlBuffer[229] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, defaultValues[229], 229, 1);
        this.fmlBuffer[230] = new FmlField("CUST_WATCH_DATE", FmlField.TYPE_STRING, 9, defaultValues[230], 230, 1);
        this.fmlBuffer[231] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, defaultValues[231], 231, 1);
        this.fmlBuffer[232] = new FmlField("CREDIT_WATCH_PIN_CD", FmlField.TYPE_SHORT, -1, defaultValues[232], 232, 1);
        this.fmlBuffer[233] = new FmlField("SUB_MARKET_CODE", FmlField.TYPE_STRING, 4, defaultValues[233], 233, 1);
        this.fmlBuffer[234] = new FmlField("LIMIT_RESERVED_DAYS", FmlField.TYPE_SHORT, -1, defaultValues[234], 234, 1);
        this.fmlBuffer[235] = new FmlField("FF_EXPIRATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[235], 235, 1);
        this.fmlBuffer[236] = new FmlField("FLEX_IND", FmlField.TYPE_BYTE, -1, defaultValues[236], 236, 1);
        this.fmlBuffer[237] = new FmlField("DUO_IND", FmlField.TYPE_BYTE, -1, defaultValues[237], 237, 1);
        this.fmlBuffer[238] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, defaultValues[238], 238, 1);
        this.fmlBuffer[239] = new FmlField("SUB_DEPARTMENT_CD", FmlField.TYPE_STRING, 5, defaultValues[239], 239, 1);
        this.fmlBuffer[240] = new FmlField("LAST_SUBS_DISC_DT", FmlField.TYPE_STRING, 9, defaultValues[240], 240, 1);
        this.fmlBuffer[241] = new FmlField("LAST_SUBS_DISC_DT_UD", FmlField.TYPE_STRING, 9, defaultValues[241], 241, 1);
        this.fmlBuffer[242] = new FmlField("LAST_SUBSCR_DISC_SN", FmlField.TYPE_SHORT, -1, defaultValues[242], 242, 1);
        this.fmlBuffer[243] = new FmlField("LAST_SUBSCR_DISC_SN_UD", FmlField.TYPE_SHORT, -1, defaultValues[243], 243, 1);
        this.fmlBuffer[244] = new FmlField("PNI", FmlField.TYPE_STRING, 11, defaultValues[244], 244, 1);
        this.fmlBuffer[245] = new FmlField("RMS_REF_STORE_ID", FmlField.TYPE_STRING, 5, defaultValues[245], 245, 1);
        this.fmlBuffer[246] = new FmlField("RMS_REF_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[246], 246, 1);
        this.fmlBuffer[247] = new FmlField("RMS_REF_OD", FmlField.TYPE_INTEGER, -1, defaultValues[247], 247, 1);
        this.fmlBuffer[248] = new FmlField("DLR_ACT_FEE", FmlField.TYPE_DOUBLE, -1, defaultValues[248], 248, 1);
        this.fmlBuffer[249] = new FmlField("PREP_AMOUNT", FmlField.TYPE_DOUBLE, -1, defaultValues[249], 249, 1);
        this.fmlBuffer[250] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, defaultValues[250], 250, 1);
        this.fmlBuffer[251] = new FmlField("SUB_LANG", FmlField.TYPE_STRING, 3, defaultValues[251], 251, 1);
        this.fmlBuffer[252] = new FmlField("SMS_RCV_STYLE_CODE", FmlField.TYPE_STRING, 3, defaultValues[252], 252, 1);
        this.fmlBuffer[253] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, defaultValues[253], 253, 1);
        this.fmlBuffer[254] = new FmlField("ALLOW_ADVERTISING_IND", FmlField.TYPE_BYTE, -1, defaultValues[254], 254, 1);
        this.fmlBuffer[255] = new FmlField("IVR_WRONG_ACCESS_NO", FmlField.TYPE_SHORT, -1, defaultValues[255], 255, 1);
        this.fmlBuffer[256] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[256], 256, 1);
        this.fmlBuffer[257] = new FmlField("PUBLISH_LEVEL", FmlField.TYPE_STRING, 31, defaultValues[257], 257, 1);
        this.fmlBuffer[258] = new FmlField("AUTO_RELEASE_IND", FmlField.TYPE_BYTE, -1, defaultValues[258], 258, 1);
        this.fmlBuffer[259] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, defaultValues[259], 259, 1);
        this.fmlBuffer[260] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, defaultValues[260], 260, 1);
        this.fmlBuffer[261] = new FmlField("OPERATOR_CW_LMT", FmlField.TYPE_DOUBLE, -1, defaultValues[261], 261, 1);
        this.fmlBuffer[262] = new FmlField("SEND_SMS_FOR_MATCH", FmlField.TYPE_BYTE, -1, defaultValues[262], 262, 1);
        this.fmlBuffer[263] = new FmlField("CPS_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[263], 263, 1);
        this.fmlBuffer[264] = new FmlField("CPS_TRANSACTION", FmlField.TYPE_SHORT, -1, defaultValues[264], 264, 1);
        this.fmlBuffer[265] = new FmlField("CPS_TYPE", FmlField.TYPE_SHORT, -1, defaultValues[265], 265, 1);
        this.fmlBuffer[266] = new FmlField("ISP_PASS", FmlField.TYPE_STRING, 31, defaultValues[266], 266, 1);
        this.fmlBuffer[267] = new FmlField("ISP_TYPE", FmlField.TYPE_STRING, 3, defaultValues[267], 267, 1);
        this.fmlBuffer[268] = new FmlField("OPERATOR_TMP_DATE", FmlField.TYPE_STRING, 9, defaultValues[268], 268, 1);
        this.fmlBuffer[269] = new FmlField("OPERATOR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, defaultValues[269], 269, 1);
        this.fmlBuffer[270] = new FmlField("SUB_ORG_CD", FmlField.TYPE_STRING, 11, defaultValues[270], 270, 1);
        this.fmlBuffer[271] = new FmlField("ORG_MEMBER_NO", FmlField.TYPE_STRING, 21, defaultValues[271], 271, 1);
        ...
        this.fmlBuffer[365] = new FmlField("FULLTABLE", FmlField.TYPE_BYTE, -1, defaultValues[365], 365, 1);
        this.fmlBuffer[366] = new FmlField("PAPER_WORK_STATUS", FmlField.TYPE_STRING, 3, defaultValues[366], 366, 1);
        this.fmlBuffer[367] = new FmlField("PAPER_WORK_REQUIRED", FmlField.TYPE_BYTE, -1, defaultValues[367], 367, 1);
        this.fmlBuffer[368] = new FmlField("PAPER_WORK_DATE", FmlField.TYPE_STRING, 9, defaultValues[368], 368, 1);
        this.fmlBuffer[369] = new FmlField("PAPER_WORK_REF_NO", FmlField.TYPE_STRING, 12, defaultValues[369], 369, 1);
        this.fmlBuffer[370] = new FmlField("PAPER_WORK_TRNS_NO", FmlField.TYPE_STRING, 26, defaultValues[370], 370, 1);
        this.fmlBuffer[371] = new FmlField("DELIVERY_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[371], 371, 1);
        this.fmlBuffer[372] = new FmlField("PNPINFOBUFFROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[372], 372, 1);
        this.fmlBuffer[373] = new FmlField("NPNUMINFORECROWID", FmlField.TYPE_STRING, 19, defaultValues[373], 373, 500);
        this.fmlBuffer[374] = new FmlField("PORT_NUMBER", FmlField.TYPE_STRING, 21, defaultValues[374], 374, 500);
        this.fmlBuffer[375] = new FmlField("NPNUMINFORECEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, defaultValues[375], 375, 500);
        this.fmlBuffer[376] = new FmlField("NPNUMINFORECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[376], 376, 500);
        this.fmlBuffer[377] = new FmlField("NPNUMINFORECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[377], 377, 500);
        this.fmlBuffer[378] = new FmlField("NPNUMINFORECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, defaultValues[378], 378, 500);
        this.fmlBuffer[379] = new FmlField("NPNUMINFORECAPPLICATION_ID", FmlField.TYPE_STRING, 7, defaultValues[379], 379, 500);
        this.fmlBuffer[380] = new FmlField("NPNUMINFORECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, defaultValues[380], 380, 500);
        this.fmlBuffer[381] = new FmlField("NPNUMINFORECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[381], 381, 500);
        this.fmlBuffer[382] = new FmlField("NPNUMINFORECEXPIRATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[382], 382, 500);
        this.fmlBuffer[383] = new FmlField("INT_ORDER_ID", FmlField.TYPE_DOUBLE, -1, defaultValues[383], 383, 500);
        this.fmlBuffer[384] = new FmlField("ORG_CUSTOMER_ID", FmlField.TYPE_STRING, 61, defaultValues[384], 384, 500);
        this.fmlBuffer[385] = new FmlField("PORT_IND", FmlField.TYPE_BYTE, -1, defaultValues[385], 385, 500);
        this.fmlBuffer[386] = new FmlField("NUMBER_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[386], 386, 500);
        this.fmlBuffer[387] = new FmlField("PORT_REQUEST_DATE", FmlField.TYPE_STRING, 15, defaultValues[387], 387, 500);
        this.fmlBuffer[388] = new FmlField("ORG_OPERATOR", FmlField.TYPE_STRING, 6, defaultValues[388], 388, 500);
        this.fmlBuffer[389] = new FmlField("NPNUMINFORECSUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, defaultValues[389], 389, 500);
        this.fmlBuffer[390] = new FmlField("LAST_INT_ORD_ID", FmlField.TYPE_DOUBLE, -1, defaultValues[390], 390, 500);
        this.fmlBuffer[391] = new FmlField("FUNCTION_PORT_IND", FmlField.TYPE_BYTE, -1, defaultValues[391], 391, 500);
        this.fmlBuffer[392] = new FmlField("PASSIVE_IND", FmlField.TYPE_BYTE, -1, defaultValues[392], 392, 500);
        this.fmlBuffer[393] = new FmlField("AUTO_CONFIRM", FmlField.TYPE_BYTE, -1, defaultValues[393], 393, 500);
        this.fmlBuffer[394] = new FmlField("TEMPORARY_MSISDN", FmlField.TYPE_STRING, 21, defaultValues[394], 394, 500);
        this.fmlBuffer[395] = new FmlField("HANDLE_MODE", FmlField.TYPE_BYTE, -1, defaultValues[395], 395, 500);
        this.fmlBuffer[396] = new FmlField("SEND_IND", FmlField.TYPE_BYTE, -1, defaultValues[396], 396, 500);
        this.fmlBuffer[397] = new FmlField("ORDID_STR", FmlField.TYPE_STRING, 21, defaultValues[397], 397, 500);
        this.fmlBuffer[398] = new FmlField("LAST_ORDID_STR", FmlField.TYPE_STRING, 21, defaultValues[398], 398, 500);
        this.fmlBuffer[399] = new FmlField("ICC", FmlField.TYPE_STRING, 61, defaultValues[399], 399, 500);
        this.fmlBuffer[400] = new FmlField("CUSTOMER_NAME", FmlField.TYPE_STRING, 255, defaultValues[400], 400, 500);
        this.fmlBuffer[401] = new FmlField("NPINFOBUFFCUSTOMER_ID", FmlField.TYPE_STRING, 61, defaultValues[401], 401, 500);
        this.fmlBuffer[402] = new FmlField("SERVICE_PROVIDER", FmlField.TYPE_STRING, 6, defaultValues[402], 402, 500);
        this.fmlBuffer[403] = new FmlField("MUNICIPALITY", FmlField.TYPE_STRING, 4, defaultValues[403], 403, 1);
        this.fmlBuffer[404] = new FmlField("RECIP_SERV_OPER", FmlField.TYPE_STRING, 6, defaultValues[404], 404, 1);
        this.fmlBuffer[405] = new FmlField("POINT_OF_CONNECTION", FmlField.TYPE_STRING, 61, defaultValues[405], 405, 1);
        this.fmlBuffer[406] = new FmlField("CSNPSPC", FmlField.TYPE_STRING, 7, defaultValues[406], 406, 1);
        this.fmlBuffer[407] = new FmlField("EIDNODSIGN", FmlField.TYPE_STRING, 7, defaultValues[407], 407, 1);
        this.fmlBuffer[408] = new FmlField("NPEIDNTYP", FmlField.TYPE_STRING, 5, defaultValues[408], 408, 1);
        this.fmlBuffer[409] = new FmlField("EIDNTYPNUMB", FmlField.TYPE_STRING, 5, defaultValues[409], 409, 1);
        this.fmlBuffer[410] = new FmlField("NPNEIDNODSIGN", FmlField.TYPE_STRING, 7, defaultValues[410], 410, 1);
        this.fmlBuffer[411] = new FmlField("NEIDNTYP", FmlField.TYPE_STRING, 5, defaultValues[411], 411, 1);
        this.fmlBuffer[412] = new FmlField("NEIDNTYPNUMB", FmlField.TYPE_STRING, 5, defaultValues[412], 412, 1);
        this.fmlBuffer[413] = new FmlField("CURR_SERV_OPER", FmlField.TYPE_STRING, 6, defaultValues[413], 413, 1);
    }
    ...
    public String get_SUSP_RC_RATE_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[161].getValue(0)));
    }
    ...
    public void set_SUSP_RC_RATE_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[161].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PARAM_COUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[165].getValue(0));
    }
    ...
    public Double get_MEMO_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[176].getValue(0));
    }
    ...
    public Double get_CHARGE_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[178].getValue(0));
    }
    ...
    public String get_CHARGE_AMT_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[179].getValue(0)));
    }
    ...
    public void set_CHARGE_AMT_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[179].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_WAIVE_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[181].getValue(0)));
    }
    ...
    public void set_WAIVE_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[181].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_CUSTOMER_BAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[199].getValue(0));
    }
    ...
    public Integer get_PCTNRECCOMMIT_ORIG_NO_MONTH() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[206].getValue(0)));
    }
    ...
    public void set_PCTNRECCOMMIT_ORIG_NO_MONTH(Integer value) throws FMLManipulationException {
        this.fmlBuffer[206].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_PCTNRECSUSP_RC_RATE_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[207].getValue(0)));
    }
    ...
    public void set_PCTNRECSUSP_RC_RATE_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[207].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_CNT_SEQ_NO() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[209].getValue(0));
    }
    ...
    public Double get_BASIC_WATCH_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[231].getValue(0));
    }
    ...
    public Integer get_LIMIT_RESERVED_DAYS() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[234].getValue(0)));
    }
    ...
    public void set_LIMIT_RESERVED_DAYS(Integer value) throws FMLManipulationException {
        this.fmlBuffer[234].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_LAST_SUBSCR_DISC_SN() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[242].getValue(0)));
    }
    ...
    public void set_LAST_SUBSCR_DISC_SN(Integer value) throws FMLManipulationException {
        this.fmlBuffer[242].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_RMS_REF_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[246].getValue(0)));
    }
    ...
    public void set_RMS_REF_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[246].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_ALLOW_ADVERTISING_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[254].getValue(0)));
    }
    ...
    public void set_ALLOW_ADVERTISING_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[254].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_IVR_WRONG_ACCESS_NO() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[255].getValue(0)));
    }
    ...
    public void set_IVR_WRONG_ACCESS_NO(Integer value) throws FMLManipulationException {
        this.fmlBuffer[255].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_THRESHOLD_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[256].getValue(0));
    }
    ...
    public void set_AUTO_RELEASE_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[258].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_OPERATOR_CW_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[261].getValue(0));
    }
    ...
    public void set_SEND_SMS_FOR_MATCH(String value) throws FMLManipulationException {
        this.fmlBuffer[262].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_CPS_TRANSACTION() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[264].getValue(0)));
    }
    ...
    public void set_CPS_TRANSACTION(Integer value) throws FMLManipulationException {
        this.fmlBuffer[264].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_OPERATOR_TMP_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[269].getValue(0));
    }
    ...
    public String get_FULLTABLE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[365].getValue(0)));
    }
    ...
    public void set_FULLTABLE(String value) throws FMLManipulationException {
        this.fmlBuffer[365].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_PAPER_WORK_REQUIRED() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[367].getValue(0)));
    }
    ...
    public void set_PAPER_WORK_REQUIRED(String value) throws FMLManipulationException {
        this.fmlBuffer[367].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public String get_PAPER_WORK_TRNS_NO() throws FMLManipulationException {
        return ((String) this.fmlBuffer[370].getValue(0));
    }
    ...
    public Integer get_PNPINFOBUFFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[372].getValue(0));
    }
    ...
    public Integer get_NPNUMINFORECOPERATOR_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[378].getValue(nIndex));
    }
    ...
    public String get_NUMBER_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[386].getValue(nIndex)));
    }
    ...
    public void set_NUMBER_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[386].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_NPNUMINFORECSUBSCRIBER_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[389].getValue(nIndex));
    }
    ...
    public String get_HANDLE_MODE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[395].getValue(nIndex)));
    }
    ...
    public void set_HANDLE_MODE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[395].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_MUNICIPALITY() throws FMLManipulationException {
        return ((String) this.fmlBuffer[403].getValue(0));
    }
    ...
    public void set_MUNICIPALITY(String value) throws FMLManipulationException {
        this.fmlBuffer[403].setValue(0, value);
    }
    ...
    public String get_RECIP_SERV_OPER() throws FMLManipulationException {
        return ((String) this.fmlBuffer[404].getValue(0));
    }
    ...
    public void set_RECIP_SERV_OPER(String value) throws FMLManipulationException {
        this.fmlBuffer[404].setValue(0, value);
    }
    ...
    public String get_POINT_OF_CONNECTION() throws FMLManipulationException {
        return ((String) this.fmlBuffer[405].getValue(0));
    }
    ...
    public void set_POINT_OF_CONNECTION(String value) throws FMLManipulationException {
        this.fmlBuffer[405].setValue(0, value);
    }
    ...
    public String get_CSNPSPC() throws FMLManipulationException {
        return ((String) this.fmlBuffer[406].getValue(0));
    }
    ...
    public void set_CSNPSPC(String value) throws FMLManipulationException {
        this.fmlBuffer[406].setValue(0, value);
    }
    ...
    public String get_EIDNODSIGN() throws FMLManipulationException {
        return ((String) this.fmlBuffer[407].getValue(0));
    }
    ...
    public void set_EIDNODSIGN(String value) throws FMLManipulationException {
        this.fmlBuffer[407].setValue(0, value);
    }
