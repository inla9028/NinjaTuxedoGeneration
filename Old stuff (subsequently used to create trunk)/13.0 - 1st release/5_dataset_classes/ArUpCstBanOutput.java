 ...
 * @author  Ninja
 *
 * ArUpCstBanOutput class.
 */
public class ArUpCstBanOutput extends ServiceOutput {

    /**
     * Creates a new instance of ArUpCstBanOutput.
     *
     * @throws FMLManipulationException
     */
    public ArUpCstBanOutput(int nApplicationStatus) throws FMLManipulationException {
        createFmlBuffer();
        setApplicationCode(nApplicationStatus);
    }

    public ArUpCstBanOutput() {
    }

    /**
     * Creates a new instance of ArUpCstBanOutput.
     *
     * @param ds Output dataset from ArUpCstBan service.
     * @throws FMLManipulationException
     */
    public ArUpCstBanOutput(Result ds) throws FMLManipulationException {
        createFmlBuffer();
    ...
    private void createFmlBuffer() throws FMLManipulationException {
        this.fmlBuffer = new FmlField[223];
