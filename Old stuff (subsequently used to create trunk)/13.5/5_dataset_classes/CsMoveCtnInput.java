...
public class CsMoveCtnInput extends ServiceInput {
    ...
    public CsMoveCtnInput() throws EnvironmentException, FMLManipulationException {
        ...
        this.fmlBuffer[175] = new FmlField("PMKTPROGBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[175], 175, 1);
        this.fmlBuffer[176] = new FmlField("MP_MODE", FmlField.TYPE_BYTE, -1, defaultValues[176], 176, 5);
        this.fmlBuffer[177] = new FmlField("SUB_MKTPR_ENT_NO", FmlField.TYPE_INTEGER, -1, defaultValues[177], 177, 5);
        this.fmlBuffer[178] = new FmlField("SUB_MKTPR_CODE", FmlField.TYPE_STRING, 7, defaultValues[178], 178, 5);
        this.fmlBuffer[179] = new FmlField("SUB_MKTPR_EFF_DATE", FmlField.TYPE_STRING, 9, defaultValues[179], 179, 5);
        this.fmlBuffer[180] = new FmlField("PTARCTNROWID", FmlField.TYPE_STRING, 19, defaultValues[180], 180, 1);
        this.fmlBuffer[181] = new FmlField("SUBSCRIBER_NO", FmlField.TYPE_STRING, 21, defaultValues[181], 181, 1);
        this.fmlBuffer[182] = new FmlField("CUSTOMER_ID", FmlField.TYPE_INTEGER, -1, defaultValues[182], 182, 1);
        this.fmlBuffer[183] = new FmlField("SYS_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[183], 183, 1);
        this.fmlBuffer[184] = new FmlField("SYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[184], 184, 1);
        this.fmlBuffer[185] = new FmlField("PTARCTNOPERATOR_ID", FmlField.TYPE_INTEGER, -1, defaultValues[185], 185, 1);
        this.fmlBuffer[186] = new FmlField("PTARCTNAPPLICATION_ID", FmlField.TYPE_STRING, 7, defaultValues[186], 186, 1);
        this.fmlBuffer[187] = new FmlField("DL_SERVICE_CODE", FmlField.TYPE_STRING, 6, defaultValues[187], 187, 1);
        this.fmlBuffer[188] = new FmlField("DL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[188], 188, 1);
        this.fmlBuffer[189] = new FmlField("PTARCTNEFFECTIVE_DATE", FmlField.TYPE_STRING, 15, defaultValues[189], 189, 1);
        this.fmlBuffer[190] = new FmlField("INIT_ACTIVATION_DATE", FmlField.TYPE_STRING, 9, defaultValues[190], 190, 1);
        this.fmlBuffer[191] = new FmlField("SUB_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[191], 191, 1);
        this.fmlBuffer[192] = new FmlField("SUB_STATUS_DATE", FmlField.TYPE_STRING, 9, defaultValues[192], 192, 1);
        this.fmlBuffer[193] = new FmlField("ORIGINAL_INIT_DATE", FmlField.TYPE_STRING, 15, defaultValues[193], 193, 1);
        this.fmlBuffer[194] = new FmlField("SUB_STATUS_LAST_ACT", FmlField.TYPE_STRING, 4, defaultValues[194], 194, 1);
        this.fmlBuffer[195] = new FmlField("SUB_STATUS_RSN_CODE", FmlField.TYPE_STRING, 5, defaultValues[195], 195, 1);
        this.fmlBuffer[196] = new FmlField("PTARCTNPRODUCT_TYPE", FmlField.TYPE_STRING, 4, defaultValues[196], 196, 1);
        this.fmlBuffer[197] = new FmlField("CUSTOMER_BAN", FmlField.TYPE_INTEGER, -1, defaultValues[197], 197, 1);
        this.fmlBuffer[198] = new FmlField("CTN_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[198], 198, 1);
        this.fmlBuffer[199] = new FmlField("REQ_ST_GRACE_PERIOD", FmlField.TYPE_STRING, 9, defaultValues[199], 199, 1);
        this.fmlBuffer[200] = new FmlField("REQ_END_GRACE_PERIOD", FmlField.TYPE_STRING, 9, defaultValues[200], 200, 1);
        this.fmlBuffer[201] = new FmlField("COMMIT_START_DATE", FmlField.TYPE_STRING, 9, defaultValues[201], 201, 1);
        this.fmlBuffer[202] = new FmlField("COMMIT_END_DATE", FmlField.TYPE_STRING, 9, defaultValues[202], 202, 1);
        this.fmlBuffer[203] = new FmlField("COMMIT_REASON_CODE", FmlField.TYPE_STRING, 4, defaultValues[203], 203, 1);
        this.fmlBuffer[204] = new FmlField("PTARCTNCOMMIT_ORIG_NO_MONTH", FmlField.TYPE_SHORT, -1, defaultValues[204], 204, 1);
        this.fmlBuffer[205] = new FmlField("PTARCTNSUSP_RC_RATE_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[205], 205, 1);
        this.fmlBuffer[206] = new FmlField("CONTRACT_NO", FmlField.TYPE_STRING, 11, defaultValues[206], 206, 1);
        this.fmlBuffer[207] = new FmlField("CNT_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[207], 207, 1);
        this.fmlBuffer[208] = new FmlField("PTARCTNDEALER_CODE", FmlField.TYPE_STRING, 6, defaultValues[208], 208, 1);
        this.fmlBuffer[209] = new FmlField("ORG_DEALER_CODE", FmlField.TYPE_STRING, 6, defaultValues[209], 209, 1);
        this.fmlBuffer[210] = new FmlField("PTARCTNSALES_AGENT", FmlField.TYPE_STRING, 6, defaultValues[210], 210, 1);
        this.fmlBuffer[211] = new FmlField("ORG_SALES_AGENT", FmlField.TYPE_STRING, 6, defaultValues[211], 211, 1);
        this.fmlBuffer[212] = new FmlField("REQ_DEPOSIT_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[212], 212, 1);
        this.fmlBuffer[213] = new FmlField("LEADING_NUMBER", FmlField.TYPE_STRING, 21, defaultValues[213], 213, 1);
        this.fmlBuffer[214] = new FmlField("PABX_IND", FmlField.TYPE_BYTE, -1, defaultValues[214], 214, 1);
        this.fmlBuffer[215] = new FmlField("NEXT_CTN", FmlField.TYPE_STRING, 21, defaultValues[215], 215, 1);
        this.fmlBuffer[216] = new FmlField("NEXT_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, defaultValues[216], 216, 1);
        this.fmlBuffer[217] = new FmlField("PRV_CTN", FmlField.TYPE_STRING, 21, defaultValues[217], 217, 1);
        this.fmlBuffer[218] = new FmlField("PRV_CTN_CHG_DATE", FmlField.TYPE_STRING, 9, defaultValues[218], 218, 1);
        this.fmlBuffer[219] = new FmlField("NEXT_BAN", FmlField.TYPE_INTEGER, -1, defaultValues[219], 219, 1);
        this.fmlBuffer[220] = new FmlField("NEXT_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[220], 220, 1);
        this.fmlBuffer[221] = new FmlField("PRV_BAN", FmlField.TYPE_INTEGER, -1, defaultValues[221], 221, 1);
        this.fmlBuffer[222] = new FmlField("PRV_BAN_MOVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[222], 222, 1);
        this.fmlBuffer[223] = new FmlField("SUB_STS_ISSUE_DATE", FmlField.TYPE_STRING, 9, defaultValues[223], 223, 1);
        this.fmlBuffer[224] = new FmlField("ACTIVATE_WAIVE_RSN", FmlField.TYPE_STRING, 7, defaultValues[224], 224, 1);
        this.fmlBuffer[225] = new FmlField("EARLIEST_ACTV_DATE", FmlField.TYPE_STRING, 9, defaultValues[225], 225, 1);
        this.fmlBuffer[226] = new FmlField("SUB_ACTV_LOCATION", FmlField.TYPE_STRING, 5, defaultValues[226], 226, 1);
        this.fmlBuffer[227] = new FmlField("CUST_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, defaultValues[227], 227, 1);
        this.fmlBuffer[228] = new FmlField("CUST_WATCH_DATE", FmlField.TYPE_STRING, 9, defaultValues[228], 228, 1);
        this.fmlBuffer[229] = new FmlField("BASIC_WATCH_LMT", FmlField.TYPE_DOUBLE, -1, defaultValues[229], 229, 1);
        this.fmlBuffer[230] = new FmlField("CREDIT_WATCH_PIN_CD", FmlField.TYPE_SHORT, -1, defaultValues[230], 230, 1);
        this.fmlBuffer[231] = new FmlField("SUB_MARKET_CODE", FmlField.TYPE_STRING, 4, defaultValues[231], 231, 1);
        this.fmlBuffer[232] = new FmlField("LIMIT_RESERVED_DAYS", FmlField.TYPE_SHORT, -1, defaultValues[232], 232, 1);
        this.fmlBuffer[233] = new FmlField("FF_EXPIRATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[233], 233, 1);
        this.fmlBuffer[234] = new FmlField("FLEX_IND", FmlField.TYPE_BYTE, -1, defaultValues[234], 234, 1);
        this.fmlBuffer[235] = new FmlField("DUO_IND", FmlField.TYPE_BYTE, -1, defaultValues[235], 235, 1);
        this.fmlBuffer[236] = new FmlField("LISTED_IND", FmlField.TYPE_BYTE, -1, defaultValues[236], 236, 1);
        this.fmlBuffer[237] = new FmlField("SUB_DEPARTMENT_CD", FmlField.TYPE_STRING, 5, defaultValues[237], 237, 1);
        this.fmlBuffer[238] = new FmlField("LAST_SUBS_DISC_DT", FmlField.TYPE_STRING, 9, defaultValues[238], 238, 1);
        this.fmlBuffer[239] = new FmlField("LAST_SUBS_DISC_DT_UD", FmlField.TYPE_STRING, 9, defaultValues[239], 239, 1);
        this.fmlBuffer[240] = new FmlField("LAST_SUBSCR_DISC_SN", FmlField.TYPE_SHORT, -1, defaultValues[240], 240, 1);
        this.fmlBuffer[241] = new FmlField("LAST_SUBSCR_DISC_SN_UD", FmlField.TYPE_SHORT, -1, defaultValues[241], 241, 1);
        this.fmlBuffer[242] = new FmlField("PNI", FmlField.TYPE_STRING, 11, defaultValues[242], 242, 1);
        this.fmlBuffer[243] = new FmlField("RMS_REF_STORE_ID", FmlField.TYPE_STRING, 5, defaultValues[243], 243, 1);
        this.fmlBuffer[244] = new FmlField("RMS_REF_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[244], 244, 1);
        this.fmlBuffer[245] = new FmlField("RMS_REF_OD", FmlField.TYPE_INTEGER, -1, defaultValues[245], 245, 1);
        this.fmlBuffer[246] = new FmlField("DLR_ACT_FEE", FmlField.TYPE_DOUBLE, -1, defaultValues[246], 246, 1);
        this.fmlBuffer[247] = new FmlField("PREP_AMOUNT", FmlField.TYPE_DOUBLE, -1, defaultValues[247], 247, 1);
        this.fmlBuffer[248] = new FmlField("SUBSCRIBER_ID", FmlField.TYPE_INTEGER, -1, defaultValues[248], 248, 1);
        this.fmlBuffer[249] = new FmlField("SUB_LANG", FmlField.TYPE_STRING, 3, defaultValues[249], 249, 1);
        this.fmlBuffer[250] = new FmlField("SMS_RCV_STYLE_CODE", FmlField.TYPE_STRING, 3, defaultValues[250], 250, 1);
        this.fmlBuffer[251] = new FmlField("CONV_RUN_NO", FmlField.TYPE_SHORT, -1, defaultValues[251], 251, 1);
        this.fmlBuffer[252] = new FmlField("ALLOW_ADVERTISING_IND", FmlField.TYPE_BYTE, -1, defaultValues[252], 252, 1);
        this.fmlBuffer[253] = new FmlField("IVR_WRONG_ACCESS_NO", FmlField.TYPE_SHORT, -1, defaultValues[253], 253, 1);
        this.fmlBuffer[254] = new FmlField("THRESHOLD_AMT", FmlField.TYPE_DOUBLE, -1, defaultValues[254], 254, 1);
        this.fmlBuffer[255] = new FmlField("PUBLISH_LEVEL", FmlField.TYPE_STRING, 31, defaultValues[255], 255, 1);
        this.fmlBuffer[256] = new FmlField("AUTO_RELEASE_IND", FmlField.TYPE_BYTE, -1, defaultValues[256], 256, 1);
        this.fmlBuffer[257] = new FmlField("CUST_WATCH_EFF_DATE", FmlField.TYPE_STRING, 9, defaultValues[257], 257, 1);
        this.fmlBuffer[258] = new FmlField("CUST_WATCH_EXP_DATE", FmlField.TYPE_STRING, 9, defaultValues[258], 258, 1);
        this.fmlBuffer[259] = new FmlField("OPERATOR_CW_LMT", FmlField.TYPE_DOUBLE, -1, defaultValues[259], 259, 1);
        this.fmlBuffer[260] = new FmlField("SEND_SMS_FOR_MATCH", FmlField.TYPE_BYTE, -1, defaultValues[260], 260, 1);
        this.fmlBuffer[261] = new FmlField("CPS_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[261], 261, 1);
        this.fmlBuffer[262] = new FmlField("CPS_TRANSACTION", FmlField.TYPE_SHORT, -1, defaultValues[262], 262, 1);
        this.fmlBuffer[263] = new FmlField("CPS_TYPE", FmlField.TYPE_SHORT, -1, defaultValues[263], 263, 1);
        this.fmlBuffer[264] = new FmlField("ISP_PASS", FmlField.TYPE_STRING, 31, defaultValues[264], 264, 1);
        this.fmlBuffer[265] = new FmlField("ISP_TYPE", FmlField.TYPE_STRING, 3, defaultValues[265], 265, 1);
        this.fmlBuffer[266] = new FmlField("OPERATOR_TMP_DATE", FmlField.TYPE_STRING, 9, defaultValues[266], 266, 1);
        this.fmlBuffer[267] = new FmlField("OPERATOR_TMP_LMT", FmlField.TYPE_DOUBLE, -1, defaultValues[267], 267, 1);
        this.fmlBuffer[268] = new FmlField("SUB_ORG_CD", FmlField.TYPE_STRING, 11, defaultValues[268], 268, 1);
        this.fmlBuffer[269] = new FmlField("ORG_MEMBER_NO", FmlField.TYPE_STRING, 21, defaultValues[269], 269, 1);
        this.fmlBuffer[270] = new FmlField("PNAMEADRBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[270], 270, 1);
        this.fmlBuffer[271] = new FmlField("LINK_MODE", FmlField.TYPE_BYTE, -1, defaultValues[271], 271, 20);
        this.fmlBuffer[272] = new FmlField("LINK_BAN", FmlField.TYPE_INTEGER, -1, defaultValues[272], 272, 20);
        this.fmlBuffer[273] = new FmlField("LINK_SUBSCRIBER", FmlField.TYPE_STRING, 21, defaultValues[273], 273, 20);
        this.fmlBuffer[274] = new FmlField("LINK_ROW_ID", FmlField.TYPE_STRING, 19, defaultValues[274], 274, 20);
        this.fmlBuffer[275] = new FmlField("LINK_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[275], 275, 20);
        this.fmlBuffer[276] = new FmlField("LNKRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, defaultValues[276], 276, 20);
        this.fmlBuffer[277] = new FmlField("BAN", FmlField.TYPE_INTEGER, -1, defaultValues[277], 277, 20);
        this.fmlBuffer[278] = new FmlField("LNKRECSUBSCRIBER_NO", FmlField.TYPE_STRING, 21, defaultValues[278], 278, 20);
        this.fmlBuffer[279] = new FmlField("LINK_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[279], 279, 20);
        this.fmlBuffer[280] = new FmlField("LNKRECEFFECTIVE_DATE", FmlField.TYPE_STRING, 9, defaultValues[280], 280, 20);
        this.fmlBuffer[281] = new FmlField("FOREIGN_SEQ_NO", FmlField.TYPE_INTEGER, -1, defaultValues[281], 281, 20);
        this.fmlBuffer[282] = new FmlField("BILLING_IND", FmlField.TYPE_BYTE, -1, defaultValues[282], 282, 20);
        this.fmlBuffer[283] = new FmlField("MAILING_IND", FmlField.TYPE_BYTE, -1, defaultValues[283], 283, 20);
        this.fmlBuffer[284] = new FmlField("USER_IND", FmlField.TYPE_BYTE, -1, defaultValues[284], 284, 20);
        this.fmlBuffer[285] = new FmlField("LINK_BILLING_IND", FmlField.TYPE_BYTE, -1, defaultValues[285], 285, 20);
        this.fmlBuffer[286] = new FmlField("LINK_MAILING_IND", FmlField.TYPE_BYTE, -1, defaultValues[286], 286, 20);
        this.fmlBuffer[287] = new FmlField("LINK_USER_IND", FmlField.TYPE_BYTE, -1, defaultValues[287], 287, 20);
        this.fmlBuffer[288] = new FmlField("NM_MODE", FmlField.TYPE_BYTE, -1, defaultValues[288], 288, 20);
        this.fmlBuffer[289] = new FmlField("NM_UP_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[289], 289, 20);
        this.fmlBuffer[290] = new FmlField("NM_EXPIRE_DATE", FmlField.TYPE_STRING, 9, defaultValues[290], 290, 20);
        this.fmlBuffer[291] = new FmlField("NAMERECROWID", FmlField.TYPE_STRING, 19, defaultValues[291], 291, 20);
        this.fmlBuffer[292] = new FmlField("NAME_ID", FmlField.TYPE_INTEGER, -1, defaultValues[292], 292, 20);
        this.fmlBuffer[293] = new FmlField("NAMERECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[293], 293, 20);
        this.fmlBuffer[294] = new FmlField("NAMERECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[294], 294, 20);
        this.fmlBuffer[295] = new FmlField("NAMERECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, defaultValues[295], 295, 20);
        this.fmlBuffer[296] = new FmlField("NAMERECAPPLICATION_ID", FmlField.TYPE_STRING, 7, defaultValues[296], 296, 20);
        this.fmlBuffer[297] = new FmlField("NAMERECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, defaultValues[297], 297, 20);
        this.fmlBuffer[298] = new FmlField("NAMERECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[298], 298, 20);
        this.fmlBuffer[299] = new FmlField("CONTROL_NAME", FmlField.TYPE_STRING, 41, defaultValues[299], 299, 20);
        this.fmlBuffer[300] = new FmlField("LAST_BUSINESS_NAME", FmlField.TYPE_STRING, 61, defaultValues[300], 300, 20);
        this.fmlBuffer[301] = new FmlField("FIRST_NAME", FmlField.TYPE_STRING, 33, defaultValues[301], 301, 20);
        this.fmlBuffer[302] = new FmlField("ADDITIONAL_TITLE", FmlField.TYPE_STRING, 61, defaultValues[302], 302, 20);
        this.fmlBuffer[303] = new FmlField("NAME_FORMAT", FmlField.TYPE_BYTE, -1, defaultValues[303], 303, 20);
        this.fmlBuffer[304] = new FmlField("BIRTH_DATE", FmlField.TYPE_STRING, 9, defaultValues[304], 304, 20);
        this.fmlBuffer[305] = new FmlField("IDENTIFY", FmlField.TYPE_STRING, 21, defaultValues[305], 305, 20);
        this.fmlBuffer[306] = new FmlField("ID_TYPE", FmlField.TYPE_STRING, 5, defaultValues[306], 306, 20);
        this.fmlBuffer[307] = new FmlField("COMP_REG_ID", FmlField.TYPE_STRING, 21, defaultValues[307], 307, 20);
        this.fmlBuffer[308] = new FmlField("KOB", FmlField.TYPE_DOUBLE, -1, defaultValues[308], 308, 20);
        this.fmlBuffer[309] = new FmlField("MIDDLE_INITIAL", FmlField.TYPE_STRING, 33, defaultValues[309], 309, 20);
        this.fmlBuffer[310] = new FmlField("TELEMARKET_ID", FmlField.TYPE_STRING, 11, defaultValues[310], 310, 20);
        this.fmlBuffer[311] = new FmlField("NAMERECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, defaultValues[311], 311, 20);
        this.fmlBuffer[312] = new FmlField("NAME_TITLE_SALUTATION", FmlField.TYPE_STRING, 21, defaultValues[312], 312, 20);
        this.fmlBuffer[313] = new FmlField("NATIONALITY_CD", FmlField.TYPE_STRING, 4, defaultValues[313], 313, 20);
        this.fmlBuffer[314] = new FmlField("GENDER", FmlField.TYPE_BYTE, -1, defaultValues[314], 314, 20);
        this.fmlBuffer[315] = new FmlField("MARITAL_STATUS", FmlField.TYPE_STRING, 5, defaultValues[315], 315, 20);
        this.fmlBuffer[316] = new FmlField("ROLE_IND", FmlField.TYPE_BYTE, -1, defaultValues[316], 316, 20);
        this.fmlBuffer[317] = new FmlField("ADR_MODE", FmlField.TYPE_BYTE, -1, defaultValues[317], 317, 20);
        this.fmlBuffer[318] = new FmlField("ADR_UP_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[318], 318, 20);
        this.fmlBuffer[319] = new FmlField("ADR_EXPIRE_DATE", FmlField.TYPE_STRING, 9, defaultValues[319], 319, 20);
        this.fmlBuffer[320] = new FmlField("ADDRESSRECROWID", FmlField.TYPE_STRING, 19, defaultValues[320], 320, 20);
        this.fmlBuffer[321] = new FmlField("ADDRESS_ID", FmlField.TYPE_INTEGER, -1, defaultValues[321], 321, 20);
        this.fmlBuffer[322] = new FmlField("ADDRESSRECSYS_CREATION_DATE", FmlField.TYPE_STRING, 15, defaultValues[322], 322, 20);
        this.fmlBuffer[323] = new FmlField("ADDRESSRECSYS_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[323], 323, 20);
        this.fmlBuffer[324] = new FmlField("ADDRESSRECOPERATOR_ID", FmlField.TYPE_INTEGER, -1, defaultValues[324], 324, 20);
        this.fmlBuffer[325] = new FmlField("ADDRESSRECAPPLICATION_ID", FmlField.TYPE_STRING, 7, defaultValues[325], 325, 20);
        this.fmlBuffer[326] = new FmlField("ADDRESSRECDL_SERVICE_CODE", FmlField.TYPE_STRING, 6, defaultValues[326], 326, 20);
        this.fmlBuffer[327] = new FmlField("ADDRESSRECDL_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[327], 327, 20);
        this.fmlBuffer[328] = new FmlField("ADR_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[328], 328, 20);
        this.fmlBuffer[329] = new FmlField("ADR_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[329], 329, 20);
        this.fmlBuffer[330] = new FmlField("ADR_STATUS_DATE", FmlField.TYPE_STRING, 9, defaultValues[330], 330, 20);
        this.fmlBuffer[331] = new FmlField("ADR_SECONDARY_LN", FmlField.TYPE_STRING, 101, defaultValues[331], 331, 20);
        this.fmlBuffer[332] = new FmlField("ADR_PRIMARY_LN", FmlField.TYPE_STRING, 101, defaultValues[332], 332, 20);
        this.fmlBuffer[333] = new FmlField("ADR_CITY", FmlField.TYPE_STRING, 40, defaultValues[333], 333, 20);
        this.fmlBuffer[334] = new FmlField("ADR_ZIP", FmlField.TYPE_STRING, 10, defaultValues[334], 334, 20);
        this.fmlBuffer[335] = new FmlField("ADR_HOUSE_NO", FmlField.TYPE_STRING, 21, defaultValues[335], 335, 20);
        this.fmlBuffer[336] = new FmlField("ADR_STREET_NAME", FmlField.TYPE_STRING, 61, defaultValues[336], 336, 20);
        this.fmlBuffer[337] = new FmlField("ADR_DIRECTION", FmlField.TYPE_STRING, 3, defaultValues[337], 337, 20);
        this.fmlBuffer[338] = new FmlField("ADR_POB", FmlField.TYPE_STRING, 11, defaultValues[338], 338, 20);
        this.fmlBuffer[339] = new FmlField("ADR_COUNTRY", FmlField.TYPE_STRING, 4, defaultValues[339], 339, 20);
        this.fmlBuffer[340] = new FmlField("ADR_HOUSE_LETTER", FmlField.TYPE_STRING, 3, defaultValues[340], 340, 20);
        this.fmlBuffer[341] = new FmlField("ADR_STORY", FmlField.TYPE_STRING, 3, defaultValues[341], 341, 20);
        this.fmlBuffer[342] = new FmlField("ADR_DOOR_NO", FmlField.TYPE_STRING, 5, defaultValues[342], 342, 20);
        this.fmlBuffer[343] = new FmlField("ADR_EMAIL", FmlField.TYPE_STRING, 151, defaultValues[343], 343, 20);
        this.fmlBuffer[344] = new FmlField("SINCE_DATE", FmlField.TYPE_STRING, 9, defaultValues[344], 344, 20);
        this.fmlBuffer[345] = new FmlField("ADR_DISTRICT", FmlField.TYPE_STRING, 41, defaultValues[345], 345, 20);
        this.fmlBuffer[346] = new FmlField("CO_IND", FmlField.TYPE_BYTE, -1, defaultValues[346], 346, 20);
        this.fmlBuffer[347] = new FmlField("ADDRESSRECCONV_RUN_NO", FmlField.TYPE_SHORT, -1, defaultValues[347], 347, 20);
        this.fmlBuffer[348] = new FmlField("ACCOMMODATION_TYPE", FmlField.TYPE_STRING, 5, defaultValues[348], 348, 20);
        this.fmlBuffer[349] = new FmlField("COUNTY_CODE", FmlField.TYPE_STRING, 3, defaultValues[349], 349, 20);
        this.fmlBuffer[350] = new FmlField("COMMUNITY_NAME", FmlField.TYPE_STRING, 31, defaultValues[350], 350, 20);
        this.fmlBuffer[351] = new FmlField("ADR_CO_NAME", FmlField.TYPE_STRING, 61, defaultValues[351], 351, 20);
        this.fmlBuffer[352] = new FmlField("ADR_HOUSE_NAME", FmlField.TYPE_STRING, 61, defaultValues[352], 352, 20);
        this.fmlBuffer[353] = new FmlField("ADR_P1", FmlField.TYPE_STRING, 61, defaultValues[353], 353, 20);
        this.fmlBuffer[354] = new FmlField("ADR_P2", FmlField.TYPE_STRING, 61, defaultValues[354], 354, 20);
        this.fmlBuffer[355] = new FmlField("ADR_P3", FmlField.TYPE_STRING, 61, defaultValues[355], 355, 20);
        this.fmlBuffer[356] = new FmlField("ADR_P4", FmlField.TYPE_STRING, 61, defaultValues[356], 356, 20);
        this.fmlBuffer[357] = new FmlField("ADR_P5", FmlField.TYPE_STRING, 61, defaultValues[357], 357, 20);
        this.fmlBuffer[358] = new FmlField("ADR_P6", FmlField.TYPE_STRING, 61, defaultValues[358], 358, 20);
        this.fmlBuffer[359] = new FmlField("ADR_P7", FmlField.TYPE_STRING, 61, defaultValues[359], 359, 20);
        this.fmlBuffer[360] = new FmlField("ADR_P8", FmlField.TYPE_STRING, 61, defaultValues[360], 360, 20);
        this.fmlBuffer[361] = new FmlField("ADR_P9", FmlField.TYPE_STRING, 61, defaultValues[361], 361, 20);
        this.fmlBuffer[362] = new FmlField("ADR_P10", FmlField.TYPE_STRING, 61, defaultValues[362], 362, 20);
        this.fmlBuffer[363] = new FmlField("SOURCE_BAN_LAST_UPDATE_DATE", FmlField.TYPE_STRING, 15, defaultValues[363], 363, 1);
        this.fmlBuffer[364] = new FmlField("SOURCE_BAN_LAST_UPDATE_STAMP", FmlField.TYPE_SHORT, -1, defaultValues[364], 364, 1);
        this.fmlBuffer[365] = new FmlField("PCNCLSRCEBANRECBAN", FmlField.TYPE_INTEGER, -1, defaultValues[365], 365, 1);
        this.fmlBuffer[366] = new FmlField("PCNCLSRCEBANRECCUSTOMER_ID", FmlField.TYPE_INTEGER, -1, defaultValues[366], 366, 1);
        this.fmlBuffer[367] = new FmlField("PCNCLSRCEBANRECACTIVITY_DATE", FmlField.TYPE_STRING, 9, defaultValues[367], 367, 1);
        this.fmlBuffer[368] = new FmlField("RESTORE_DATE", FmlField.TYPE_STRING, 9, defaultValues[368], 368, 1);
        this.fmlBuffer[369] = new FmlField("DEP_RETURN_METHOD", FmlField.TYPE_BYTE, -1, defaultValues[369], 369, 1);
        this.fmlBuffer[370] = new FmlField("NEW_BAN_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[370], 370, 1);
        this.fmlBuffer[371] = new FmlField("EXP_CYCLE_CODE", FmlField.TYPE_SHORT, -1, defaultValues[371], 371, 1);
        this.fmlBuffer[372] = new FmlField("BAN_WAIVE_IND", FmlField.TYPE_BYTE, -1, defaultValues[372], 372, 1);
        this.fmlBuffer[373] = new FmlField("BAN_WAIVE_RSN", FmlField.TYPE_STRING, 7, defaultValues[373], 373, 1);
        this.fmlBuffer[374] = new FmlField("WAIVER_UID", FmlField.TYPE_STRING, 9, defaultValues[374], 374, 1);
        this.fmlBuffer[375] = new FmlField("HOLD_COLL_TREATMENT", FmlField.TYPE_BYTE, -1, defaultValues[375], 375, 1);
        this.fmlBuffer[376] = new FmlField("PCTNCNCLBUFROW_COUNT", FmlField.TYPE_INTEGER, -1, defaultValues[376], 376, 1);
        this.fmlBuffer[377] = new FmlField("CTN", FmlField.TYPE_STRING, 21, defaultValues[377], 377, 100);
        this.fmlBuffer[378] = new FmlField("PCTNCNCLBUFSUB_STATUS", FmlField.TYPE_BYTE, -1, defaultValues[378], 378, 100);
        this.fmlBuffer[379] = new FmlField("COMM_START_DATE", FmlField.TYPE_STRING, 9, defaultValues[379], 379, 100);
        this.fmlBuffer[380] = new FmlField("COMM_END_DATE", FmlField.TYPE_STRING, 9, defaultValues[380], 380, 100);
        this.fmlBuffer[381] = new FmlField("REMAINING_MONTHS", FmlField.TYPE_SHORT, -1, defaultValues[381], 381, 100);
        this.fmlBuffer[382] = new FmlField("DEPOSIT", FmlField.TYPE_DOUBLE, -1, defaultValues[382], 382, 100);
        this.fmlBuffer[383] = new FmlField("DEPOSIT_INTEREST", FmlField.TYPE_DOUBLE, -1, defaultValues[383], 383, 100);
        this.fmlBuffer[384] = new FmlField("PENALTY", FmlField.TYPE_DOUBLE, -1, defaultValues[384], 384, 100);
        this.fmlBuffer[385] = new FmlField("WAIVE_INDICATOR", FmlField.TYPE_BYTE, -1, defaultValues[385], 385, 100);
        this.fmlBuffer[386] = new FmlField("PCTNCNCLBUFWAIVE_REASON", FmlField.TYPE_STRING, 7, defaultValues[386], 386, 100);
        this.fmlBuffer[387] = new FmlField("ACTIVITY_CTN_FEE", FmlField.TYPE_DOUBLE, -1, defaultValues[387], 387, 1);
        this.fmlBuffer[388] = new FmlField("NUMBER_LOCATION", FmlField.TYPE_STRING, 4, defaultValues[388], 388, 1);
        this.fmlBuffer[389] = new FmlField("DEPOSITTERMSIND", FmlField.TYPE_BYTE, -1, defaultValues[389], 389, 1);
        this.fmlBuffer[390] = new FmlField("WAIVING_IND", FmlField.TYPE_BYTE, -1, defaultValues[390], 390, 1);
        this.fmlBuffer[391] = new FmlField("WAIVING_REASON_CODE", FmlField.TYPE_STRING, 5, defaultValues[391], 391, 1);
        this.fmlBuffer[392] = new FmlField("PFTRDEPBUFROWCOUNT", FmlField.TYPE_INTEGER, -1, defaultValues[392], 392, 1);
        this.fmlBuffer[393] = new FmlField("DEPOSIT_TYPE", FmlField.TYPE_BYTE, -1, defaultValues[393], 393, 2);
        this.fmlBuffer[394] = new FmlField("DEPOSIT_AMOUNT", FmlField.TYPE_DOUBLE, -1, defaultValues[394], 394, 2);
    }
    ...
    public Integer get_PMKTPROGBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[175].getValue(0));
    }
    ...
    public Integer get_SUB_MKTPR_ENT_NO(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[177].getValue(nIndex));
    }
    ...
    public Integer get_CUSTOMER_ID() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[182].getValue(0));
    }
    ...
    public Integer get_DL_UPDATE_STAMP() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[188].getValue(0)));
    }
    ...
    public void set_DL_UPDATE_STAMP(Integer value) throws FMLManipulationException {
        this.fmlBuffer[188].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_SUB_STATUS() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[191].getValue(0)));
    }
    ...
    public void set_SUB_STATUS(String value) throws FMLManipulationException {
        this.fmlBuffer[191].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_CTN_SEQ_NO() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[198].getValue(0));
    }
    ...
    public Integer get_PTARCTNCOMMIT_ORIG_NO_MONTH() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[204].getValue(0)));
    }
    ...
    public void set_PTARCTNCOMMIT_ORIG_NO_MONTH(Integer value) throws FMLManipulationException {
        this.fmlBuffer[204].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_PTARCTNSUSP_RC_RATE_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[205].getValue(0)));
    }
    ...
    public void set_PTARCTNSUSP_RC_RATE_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[205].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_REQ_DEPOSIT_AMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[212].getValue(0));
    }
    ...
    public String get_PABX_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[214].getValue(0)));
    }
    ...
    public void set_PABX_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[214].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_PRV_BAN() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[221].getValue(0));
    }
    ...
    public Double get_BASIC_WATCH_LMT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[229].getValue(0));
    }
    ...
    public Integer get_CREDIT_WATCH_PIN_CD() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[230].getValue(0)));
    }
    ...
    public void set_CREDIT_WATCH_PIN_CD(Integer value) throws FMLManipulationException {
        this.fmlBuffer[230].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_LIMIT_RESERVED_DAYS() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[232].getValue(0)));
    }
    ...
    public void set_LIMIT_RESERVED_DAYS(Integer value) throws FMLManipulationException {
        this.fmlBuffer[232].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_LAST_SUBSCR_DISC_SN_UD() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[241].getValue(0)));
    }
    ...
    public void set_LAST_SUBSCR_DISC_SN_UD(Integer value) throws FMLManipulationException {
        this.fmlBuffer[241].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_RMS_REF_TYPE() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[244].getValue(0)));
    }
    ...
    public void set_RMS_REF_TYPE(String value) throws FMLManipulationException {
        this.fmlBuffer[244].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_PREP_AMOUNT() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[247].getValue(0));
    }
    ...
    public String get_ALLOW_ADVERTISING_IND() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[252].getValue(0)));
    }
    ...
    public void set_ALLOW_ADVERTISING_IND(String value) throws FMLManipulationException {
        this.fmlBuffer[252].setValue(0, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_CPS_TYPE() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[263].getValue(0)));
    }
    ...
    public void set_CPS_TYPE(Integer value) throws FMLManipulationException {
        this.fmlBuffer[263].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_LINK_TYPE(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[279].getValue(nIndex)));
    }
    ...
    public void set_LINK_TYPE(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[279].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_NAME_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[292].getValue(nIndex));
    }
    ...
    public Integer get_NAMERECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[298].getValue(nIndex)));
    }
    ...
    public void set_NAMERECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[298].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_KOB(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[308].getValue(nIndex));
    }
    ...
    public Integer get_NAMERECCONV_RUN_NO(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[311].getValue(nIndex)));
    }
    ...
    public void set_NAMERECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[311].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public String get_GENDER(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[314].getValue(nIndex)));
    }
    ...
    public void set_GENDER(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[314].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_ADDRESS_ID(int nIndex) throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[321].getValue(nIndex));
    }
    ...
    public Integer get_ADDRESSRECDL_UPDATE_STAMP(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[327].getValue(nIndex)));
    }
    ...
    public void set_ADDRESSRECDL_UPDATE_STAMP(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[327].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public String get_ADR_STATUS(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[329].getValue(nIndex)));
    }
    ...
    public void set_ADR_STATUS(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[329].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public String get_CO_IND(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[346].getValue(nIndex)));
    }
    ...
    public void set_CO_IND(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[346].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public void set_ADDRESSRECCONV_RUN_NO(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[347].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public String get_SOURCE_BAN_LAST_UPDATE_DATE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[363].getValue(0));
    }
    ...
    public void set_SOURCE_BAN_LAST_UPDATE_DATE(String value) throws FMLManipulationException {
        this.fmlBuffer[363].setValue(0, value);
    }
    ...
    public Integer get_SOURCE_BAN_LAST_UPDATE_STAMP() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[364].getValue(0)));
    }
    ...
    public void set_SOURCE_BAN_LAST_UPDATE_STAMP(Integer value) throws FMLManipulationException {
        this.fmlBuffer[364].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public Integer get_EXP_CYCLE_CODE() throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[371].getValue(0)));
    }
    ...
    public void set_EXP_CYCLE_CODE(Integer value) throws FMLManipulationException {
        this.fmlBuffer[371].setValue(0, TypeConverter.integerToShort(value));
    }
    ...
    public String get_HOLD_COLL_TREATMENT() throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[375].getValue(0)));
    }
    ...
    public void set_HOLD_COLL_TREATMENT(String value) throws FMLManipulationException {
        this.fmlBuffer[375].setValue(0, TypeConverter.stringToByte(value));
    }

    /**
     * Retrieves the value of the 'PCTNCNCLBUFROW_COUNT' field in the FML buffer.
     *
     * @return Value of 'PCTNCNCLBUFROW_COUNT' field in FML buffer.
     * @throws FMLManipulationException
     */
    public Integer get_PCTNCNCLBUFROW_COUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[376].getValue(0));
    }

    /**
     * Sets the value of the 'PCTNCNCLBUFROW_COUNT' field in the FML buffer.
     *
     * @param value Default value: null.
     * @throws FMLManipulationException
     */
    public void set_PCTNCNCLBUFROW_COUNT(Integer value) throws FMLManipulationException {
    ...
    public String get_PCTNCNCLBUFSUB_STATUS(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[378].getValue(nIndex)));
    }
    ...
    public void set_PCTNCNCLBUFSUB_STATUS(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[378].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Integer get_REMAINING_MONTHS(int nIndex) throws FMLManipulationException {
        return (TypeConverter.shortToInteger((Short) this.fmlBuffer[381].getValue(nIndex)));
    }
    ...
    public void set_REMAINING_MONTHS(int nIndex, Integer value) throws FMLManipulationException {
        this.fmlBuffer[381].setValue(nIndex, TypeConverter.integerToShort(value));
    }
    ...
    public Double get_PENALTY(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[384].getValue(nIndex));
    }
    ...
    public String get_WAIVE_INDICATOR(int nIndex) throws FMLManipulationException {
        return (TypeConverter.byteToString((Byte) this.fmlBuffer[385].getValue(nIndex)));
    }
    ...
    public void set_WAIVE_INDICATOR(int nIndex, String value) throws FMLManipulationException {
        this.fmlBuffer[385].setValue(nIndex, TypeConverter.stringToByte(value));
    }
    ...
    public Double get_ACTIVITY_CTN_FEE() throws FMLManipulationException {
        return ((Double) this.fmlBuffer[387].getValue(0));
    }
    ...
    public String get_WAIVING_REASON_CODE() throws FMLManipulationException {
        return ((String) this.fmlBuffer[391].getValue(0));
    }
    ...
    public Integer get_PFTRDEPBUFROWCOUNT() throws FMLManipulationException {
        return ((Integer) this.fmlBuffer[392].getValue(0));
    }
    ...
    public Double get_DEPOSIT_AMOUNT(int nIndex) throws FMLManipulationException {
        return ((Double) this.fmlBuffer[394].getValue(nIndex));
    }
